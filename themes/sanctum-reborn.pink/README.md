...
[Open live preview (Quartz)](https://quartz-themes.github.io/sanctum-reborn.pink/)

[Open live preview (Publish)](https://publish.saberzero.one/sanctum-reborn.pink)
...
```yaml
env:
  THEME_NAME: sanctum-reborn.pink
```
