...
[Open live preview (Quartz)](https://quartz-themes.github.io/vanilla-palettes.tokyo-night-moon/)

[Open live preview (Publish)](https://publish.saberzero.one/vanilla-palettes.tokyo-night-moon)
...
```yaml
env:
  THEME_NAME: vanilla-palettes.tokyo-night-moon
```
...
./action.sh vanilla-palettes.tokyo-night-moon
```
