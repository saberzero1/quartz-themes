...
[Open live preview (Quartz)](https://quartz-themes.github.io/sanctum-reborn.viridian/)

[Open live preview (Publish)](https://publish.saberzero.one/sanctum-reborn.viridian)
...
```yaml
env:
  THEME_NAME: sanctum-reborn.viridian
```
...
./action.sh sanctum-reborn.viridian
```
