...
[Open live preview (Quartz)](https://quartz-themes.github.io/vanilla-palettes.catppuccin-macchiato/)

[Open live preview (Publish)](https://publish.saberzero.one/vanilla-palettes.catppuccin-macchiato)
...
```yaml
env:
  THEME_NAME: vanilla-palettes.catppuccin-macchiato
```
...
./action.sh vanilla-palettes.catppuccin-macchiato
```
