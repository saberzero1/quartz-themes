...
[Open live preview (Quartz)](https://quartz-themes.github.io/vanilla-palettes.gruvbox-medium/)

[Open live preview (Publish)](https://publish.saberzero.one/vanilla-palettes.gruvbox-medium)
...
```yaml
env:
  THEME_NAME: vanilla-palettes.gruvbox-medium
```
...
./action.sh vanilla-palettes.gruvbox-medium
```
