...
[Open live preview (Quartz)](https://quartz-themes.github.io/retroma.monochromatic/)

[Open live preview (Publish)](https://publish.saberzero.one/retroma.monochromatic)
...
```yaml
env:
  THEME_NAME: retroma.monochromatic
```
...
./action.sh retroma.monochromatic
```
