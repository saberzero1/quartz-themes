...
[Open live preview (Quartz)](https://quartz-themes.github.io/vanilla-palettes.rose-pine/)

[Open live preview (Publish)](https://publish.saberzero.one/vanilla-palettes.rose-pine)
...
```yaml
env:
  THEME_NAME: vanilla-palettes.rose-pine
```
...
./action.sh vanilla-palettes.rose-pine
```
