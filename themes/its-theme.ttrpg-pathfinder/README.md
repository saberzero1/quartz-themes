...
[Open live preview (Quartz)](https://quartz-themes.github.io/its-theme.ttrpg-pathfinder/)

[Open live preview (Publish)](https://publish.saberzero.one/its-theme.ttrpg-pathfinder)
...
```yaml
env:
  THEME_NAME: its-theme.ttrpg-pathfinder
```
...
./action.sh its-theme.ttrpg-pathfinder
```
