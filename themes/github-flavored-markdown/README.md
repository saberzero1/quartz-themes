...
[Open live preview (Quartz)](https://quartz-themes.github.io/github-flavored-markdown/)

[Open live preview (Publish)](https://publish.saberzero.one/github-flavored-markdown)
...
```yaml
env:
  THEME_NAME: github-flavored-markdown
```
...
./action.sh github-flavored-markdown
```
