...
[Open live preview (Quartz)](https://quartz-themes.github.io/poimandres-extended/)

[Open live preview (Publish)](https://publish.saberzero.one/poimandres-extended)
...
```yaml
env:
  THEME_NAME: poimandres-extended
```
