...
[Open live preview (Quartz)](https://quartz-themes.github.io/minimalists-paradise/)

[Open live preview (Publish)](https://publish.saberzero.one/minimalists-paradise)
...
```yaml
env:
  THEME_NAME: minimalists-paradise
```
...
./action.sh minimalists-paradise
```
