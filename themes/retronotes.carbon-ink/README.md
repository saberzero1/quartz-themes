...
[Open live preview (Quartz)](https://quartz-themes.github.io/retronotes.carbon-ink/)

[Open live preview (Publish)](https://publish.saberzero.one/retronotes.carbon-ink)
...
```yaml
env:
  THEME_NAME: retronotes.carbon-ink
```
...
./action.sh retronotes.carbon-ink
```
