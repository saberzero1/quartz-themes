...
[Open live preview (Quartz)](https://quartz-themes.github.io/its-theme.ttrpg-pathfinder-remastered/)

[Open live preview (Publish)](https://publish.saberzero.one/its-theme.ttrpg-pathfinder-remastered)
...
```yaml
env:
  THEME_NAME: its-theme.ttrpg-pathfinder-remastered
```
...
./action.sh its-theme.ttrpg-pathfinder-remastered
```
