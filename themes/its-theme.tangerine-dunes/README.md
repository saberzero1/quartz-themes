...
[Open live preview (Quartz)](https://quartz-themes.github.io/its-theme.tangerine-dunes/)

[Open live preview (Publish)](https://publish.saberzero.one/its-theme.tangerine-dunes)
...
```yaml
env:
  THEME_NAME: its-theme.tangerine-dunes
```
...
./action.sh its-theme.tangerine-dunes
```
