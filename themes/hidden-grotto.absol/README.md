...
[Open live preview (Quartz)](https://quartz-themes.github.io/hidden-grotto.absol/)

[Open live preview (Publish)](https://publish.saberzero.one/hidden-grotto.absol)
...
```yaml
env:
  THEME_NAME: hidden-grotto.absol
```
