...
[Open live preview (Quartz)](https://quartz-themes.github.io/retronotes.misty-mirage/)

[Open live preview (Publish)](https://publish.saberzero.one/retronotes.misty-mirage)
...
```yaml
env:
  THEME_NAME: retronotes.misty-mirage
```
...
./action.sh retronotes.misty-mirage
```
