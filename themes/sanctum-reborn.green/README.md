...
[Open live preview (Quartz)](https://quartz-themes.github.io/sanctum-reborn.green/)

[Open live preview (Publish)](https://publish.saberzero.one/sanctum-reborn.green)
...
```yaml
env:
  THEME_NAME: sanctum-reborn.green
```
...
./action.sh sanctum-reborn.green
```
