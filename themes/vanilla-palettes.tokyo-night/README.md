...
[Open live preview (Quartz)](https://quartz-themes.github.io/vanilla-palettes.tokyo-night/)

[Open live preview (Publish)](https://publish.saberzero.one/vanilla-palettes.tokyo-night)
...
```yaml
env:
  THEME_NAME: vanilla-palettes.tokyo-night
```
...
./action.sh vanilla-palettes.tokyo-night
```
