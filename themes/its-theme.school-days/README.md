...
[Open live preview (Quartz)](https://quartz-themes.github.io/its-theme.school-days/)

[Open live preview (Publish)](https://publish.saberzero.one/its-theme.school-days)
...
```yaml
env:
  THEME_NAME: its-theme.school-days
```
...
./action.sh its-theme.school-days
```
