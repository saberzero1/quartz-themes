...
[Open live preview (Quartz)](https://quartz-themes.github.io/its-theme.minimalist/)

[Open live preview (Publish)](https://publish.saberzero.one/its-theme.minimalist)
...
```yaml
env:
  THEME_NAME: its-theme.minimalist
```
...
./action.sh its-theme.minimalist
```
