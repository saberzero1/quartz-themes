...
[Open live preview (Quartz)](https://quartz-themes.github.io/vanilla-palettes.kanagawa-wave/)

[Open live preview (Publish)](https://publish.saberzero.one/vanilla-palettes.kanagawa-wave)
...
```yaml
env:
  THEME_NAME: vanilla-palettes.kanagawa-wave
```
...
./action.sh vanilla-palettes.kanagawa-wave
```
