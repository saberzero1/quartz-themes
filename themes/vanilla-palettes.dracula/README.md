...
[Open live preview (Quartz)](https://quartz-themes.github.io/vanilla-palettes.dracula/)

[Open live preview (Publish)](https://publish.saberzero.one/vanilla-palettes.dracula)
...
```yaml
env:
  THEME_NAME: vanilla-palettes.dracula
```
...
./action.sh vanilla-palettes.dracula
```
