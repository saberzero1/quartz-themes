...
[Open live preview (Quartz)](https://quartz-themes.github.io/vanilla-palettes.kanagawa-dragon/)

[Open live preview (Publish)](https://publish.saberzero.one/vanilla-palettes.kanagawa-dragon)
...
```yaml
env:
  THEME_NAME: vanilla-palettes.kanagawa-dragon
```
...
./action.sh vanilla-palettes.kanagawa-dragon
```
