...
[Open live preview (Quartz)](https://quartz-themes.github.io/vanilla-palettes.tokyo-night-storm/)

[Open live preview (Publish)](https://publish.saberzero.one/vanilla-palettes.tokyo-night-storm)
...
```yaml
env:
  THEME_NAME: vanilla-palettes.tokyo-night-storm
```
...
./action.sh vanilla-palettes.tokyo-night-storm
```
