...
[Open live preview (Quartz)](https://quartz-themes.github.io/vanilla-palettes.gruvbox-soft/)

[Open live preview (Publish)](https://publish.saberzero.one/vanilla-palettes.gruvbox-soft)
...
```yaml
env:
  THEME_NAME: vanilla-palettes.gruvbox-soft
```
...
./action.sh vanilla-palettes.gruvbox-soft
```
