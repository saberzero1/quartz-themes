...
[Open live preview (Quartz)](https://quartz-themes.github.io/vanilla-palettes.catppuccin-frappe/)

[Open live preview (Publish)](https://publish.saberzero.one/vanilla-palettes.catppuccin-frappe)
...
```yaml
env:
  THEME_NAME: vanilla-palettes.catppuccin-frappe
```
...
./action.sh vanilla-palettes.catppuccin-frappe
```
