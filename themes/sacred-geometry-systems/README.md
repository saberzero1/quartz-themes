...
[Open live preview (Quartz)](https://quartz-themes.github.io/sacred-geometry-systems/)

[Open live preview (Publish)](https://publish.saberzero.one/sacred-geometry-systems)
...
```yaml
env:
  THEME_NAME: sacred-geometry-systems
```
...
./action.sh sacred-geometry-systems
```
