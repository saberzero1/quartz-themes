...
[Open live preview (Quartz)](https://quartz-themes.github.io/vanilla-palettes.gruvbox-hard/)

[Open live preview (Publish)](https://publish.saberzero.one/vanilla-palettes.gruvbox-hard)
...
```yaml
env:
  THEME_NAME: vanilla-palettes.gruvbox-hard
```
...
./action.sh vanilla-palettes.gruvbox-hard
```
