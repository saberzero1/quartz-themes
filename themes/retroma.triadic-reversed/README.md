...
[Open live preview (Quartz)](https://quartz-themes.github.io/retroma.triadic-reversed/)

[Open live preview (Publish)](https://publish.saberzero.one/retroma.triadic-reversed)
...
```yaml
env:
  THEME_NAME: retroma.triadic-reversed
```
...
./action.sh retroma.triadic-reversed
```
