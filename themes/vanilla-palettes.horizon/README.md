...
[Open live preview (Quartz)](https://quartz-themes.github.io/vanilla-palettes.horizon/)

[Open live preview (Publish)](https://publish.saberzero.one/vanilla-palettes.horizon)
...
```yaml
env:
  THEME_NAME: vanilla-palettes.horizon
```
...
./action.sh vanilla-palettes.horizon
```
