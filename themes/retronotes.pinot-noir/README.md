...
[Open live preview (Quartz)](https://quartz-themes.github.io/retronotes.pinot-noir/)

[Open live preview (Publish)](https://publish.saberzero.one/retronotes.pinot-noir)
...
```yaml
env:
  THEME_NAME: retronotes.pinot-noir
```
...
./action.sh retronotes.pinot-noir
```
