...
[Open live preview (Quartz)](https://quartz-themes.github.io/retroma.split-complementary-reversed/)

[Open live preview (Publish)](https://publish.saberzero.one/retroma.split-complementary-reversed)
...
```yaml
env:
  THEME_NAME: retroma.split-complementary-reversed
```
...
./action.sh retroma.split-complementary-reversed
```
