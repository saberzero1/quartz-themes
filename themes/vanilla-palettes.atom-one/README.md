...
[Open live preview (Quartz)](https://quartz-themes.github.io/vanilla-palettes.atom-one/)

[Open live preview (Publish)](https://publish.saberzero.one/vanilla-palettes.atom-one)
...
```yaml
env:
  THEME_NAME: vanilla-palettes.atom-one
```
...
./action.sh vanilla-palettes.atom-one
```
