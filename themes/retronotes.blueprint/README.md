...
[Open live preview (Quartz)](https://quartz-themes.github.io/retronotes.blueprint/)

[Open live preview (Publish)](https://publish.saberzero.one/retronotes.blueprint)
...
```yaml
env:
  THEME_NAME: retronotes.blueprint
```
...
./action.sh retronotes.blueprint
```
