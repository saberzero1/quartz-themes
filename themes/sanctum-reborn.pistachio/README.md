...
[Open live preview (Quartz)](https://quartz-themes.github.io/sanctum-reborn.pistachio/)

[Open live preview (Publish)](https://publish.saberzero.one/sanctum-reborn.pistachio)
...
```yaml
env:
  THEME_NAME: sanctum-reborn.pistachio
```
...
./action.sh sanctum-reborn.pistachio
```
