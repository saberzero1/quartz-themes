...
[Open live preview (Quartz)](https://quartz-themes.github.io/retroma.monochromatic-reversed/)

[Open live preview (Publish)](https://publish.saberzero.one/retroma.monochromatic-reversed)
...
```yaml
env:
  THEME_NAME: retroma.monochromatic-reversed
```
...
./action.sh retroma.monochromatic-reversed
```
