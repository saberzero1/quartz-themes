...
[Open live preview (Quartz)](https://quartz-themes.github.io/sanctum-reborn.orange/)

[Open live preview (Publish)](https://publish.saberzero.one/sanctum-reborn.orange)
...
```yaml
env:
  THEME_NAME: sanctum-reborn.orange
```
...
./action.sh sanctum-reborn.orange
```
