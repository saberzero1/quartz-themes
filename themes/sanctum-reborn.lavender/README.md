...
[Open live preview (Quartz)](https://quartz-themes.github.io/sanctum-reborn.lavender/)

[Open live preview (Publish)](https://publish.saberzero.one/sanctum-reborn.lavender)
...
```yaml
env:
  THEME_NAME: sanctum-reborn.lavender
```
...
./action.sh sanctum-reborn.lavender
```
