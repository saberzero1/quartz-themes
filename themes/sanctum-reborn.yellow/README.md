...
[Open live preview (Quartz)](https://quartz-themes.github.io/sanctum-reborn.yellow/)

[Open live preview (Publish)](https://publish.saberzero.one/sanctum-reborn.yellow)
...
```yaml
env:
  THEME_NAME: sanctum-reborn.yellow
```
...
./action.sh sanctum-reborn.yellow
```
