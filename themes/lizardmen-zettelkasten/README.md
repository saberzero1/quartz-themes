...
[Open live preview (Quartz)](https://quartz-themes.github.io/lizardmen-zettelkasten/)

[Open live preview (Publish)](https://publish.saberzero.one/lizardmen-zettelkasten)
...
```yaml
env:
  THEME_NAME: lizardmen-zettelkasten
```
...
./action.sh lizardmen-zettelkasten
```
