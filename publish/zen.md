...
- Theme author: <a href="https://github.com/laughmaker" target="_blank" rel="noopener noreferrer">laughmaker</a>
- Support the author: Author did not provide funding links in `manifest.json`
- <a href="https://github.com/saberzero1/quartz-themes/tree/master/themes/zen/README.md">Install instructions</a>

| Name  | Modes                     | Compatibility                                                                                     | License                                                                                                                                    |
| ----- | ------------------------- | ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| `zen` | ![[media/both.svg\|BOTH]] | <img src="media/checking.svg" alt="CHECKING"/> <img src="media/collection.svg" alt="COLLECTION"/> | <a href="https://github.com/saberzero1/quartz-themes/tree/master/obsidian/zen/LICENSE.md"><img src="media/license/mit.svg" alt="MIT"/></a> |
