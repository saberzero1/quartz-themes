...
- [[https://github.com/saberzero1/quartz-themes/tree/master/themes/trace-labs|Install instructions]]

| Name         | Modes                     | Compatibility                                  | License                                                                                                                                           |
| ------------ | ------------------------- | ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| `trace-labs` | ![[media/dark.svg\|DARK]] | <img src="media/checking.svg" alt="CHECKING"/> | <a href="https://github.com/saberzero1/quartz-themes/tree/master/obsidian/trace-labs/LICENSE.md"><img src="media/license/mit.svg" alt="MIT"/></a> |
