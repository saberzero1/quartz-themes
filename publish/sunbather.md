...
- [[https://github.com/saberzero1/quartz-themes/tree/master/themes/sunbather|Install instructions]]

| Name        | Modes                     | Compatibility                                  | License                                                                                                                                          |
| ----------- | ------------------------- | ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| `sunbather` | ![[media/both.svg\|BOTH]] | <img src="media/checking.svg" alt="CHECKING"/> | <a href="https://github.com/saberzero1/quartz-themes/tree/master/obsidian/sunbather/LICENSE.md"><img src="media/license/mit.svg" alt="MIT"/></a> |
