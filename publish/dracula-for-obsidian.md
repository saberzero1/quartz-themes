...
- [[https://github.com/saberzero1/quartz-themes/tree/master/themes/dracula-for-obsidian|Install instructions]]

| Name                   | Modes                     | Compatibility                                  | License                                                                                                                                                     |
| ---------------------- | ------------------------- | ---------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `dracula-for-obsidian` | ![[media/dark.svg\|DARK]] | <img src="media/checking.svg" alt="CHECKING"/> | <a href="https://github.com/saberzero1/quartz-themes/tree/master/obsidian/dracula-for-obsidian/LICENSE.md"><img src="media/license/mit.svg" alt="MIT"/></a> |
