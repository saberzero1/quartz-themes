...
- Theme author: niedzielawieczur
- Support the author: Author did not provide funding links in `manifest.json`
- <a href="https://github.com/saberzero1/quartz-themes/tree/master/themes/anarchy/README.md">Install instructions</a>

| Name      | Modes                     | Compatibility                                | License                                                                                                                                        |
| --------- | ------------------------- | -------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| `anarchy` | ![[media/both.svg\|BOTH]] | <img src="media/partial.svg" alt="PARTIAL"/> | <a href="https://github.com/saberzero1/quartz-themes/tree/master/obsidian/anarchy/LICENSE.md"><img src="media/license/mit.svg" alt="MIT"/></a> |
