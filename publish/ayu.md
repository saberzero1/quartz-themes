...
- <a href="https://github.com/saberzero1/quartz-themes/tree/master/themes/ayu/README.md">Install instructions</a>

| Name  | Modes                     | Compatibility                                  | License                                                                                                                                                              |
| ----- | ------------------------- | ---------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ayu` | ![[media/both.svg\|BOTH]] | <img src="media/checking.svg" alt="CHECKING"/> | <a href="https://github.com/saberzero1/quartz-themes/tree/master/obsidian/ayu/LICENSE.md"><img src="media/license/no spdx id found.svg" alt="NO SPDX ID FOUND"/></a> |
