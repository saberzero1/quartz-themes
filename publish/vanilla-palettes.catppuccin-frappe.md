...
- <a href="https://github.com/saberzero1/quartz-themes/tree/master/themes/vanilla-palettes.catppuccin-frappe/README.md">Install instructions</a>

| Name                                 | Modes                     | Compatibility                                                                                   | License                                                                                                                                                                   |
| ------------------------------------ | ------------------------- | ----------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `vanilla-palettes.catppuccin-frappe` | ![[media/both.svg\|BOTH]] | <img src="media/partial.svg" alt="PARTIAL"/> <img src="media/collection.svg" alt="COLLECTION"/> | <a href="https://github.com/saberzero1/quartz-themes/tree/master/obsidian/vanilla-palettes.catppuccin-frappe/LICENSE.md"><img src="media/license/mit.svg" alt="MIT"/></a> |
