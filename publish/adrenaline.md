...
- <a href="https://github.com/saberzero1/quartz-themes/tree/master/themes/adrenaline/README.md">Install instructions</a>

| Name         | Modes                     | Compatibility                                                                             | License                                                                                                                                           |
| ------------ | ------------------------- | ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| `adrenaline` | ![[media/both.svg\|BOTH]] | <img src="media/full.svg" alt="FULL"/> <img src="media/collection.svg" alt="COLLECTION"/> | <a href="https://github.com/saberzero1/quartz-themes/tree/master/obsidian/adrenaline/LICENSE.md"><img src="media/license/mit.svg" alt="MIT"/></a> |
