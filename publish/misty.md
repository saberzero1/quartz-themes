...
- Theme author: Patrick
- Support the author: Author did not provide funding links in `manifest.json`
- <a href="https://github.com/saberzero1/quartz-themes/tree/master/themes/misty/README.md">Install instructions</a>

| Name    | Modes                     | Compatibility                                | License                                                                                                                                      |
| ------- | ------------------------- | -------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| `misty` | ![[media/both.svg\|BOTH]] | <img src="media/partial.svg" alt="PARTIAL"/> | <a href="https://github.com/saberzero1/quartz-themes/tree/master/obsidian/misty/LICENSE.md"><img src="media/license/mit.svg" alt="MIT"/></a> |
