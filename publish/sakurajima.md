...
- [[https://github.com/saberzero1/quartz-themes/tree/master/themes/sakurajima|Install instructions]]

| Name         | Modes                     | Compatibility                                  | License                                                                                                                                           |
| ------------ | ------------------------- | ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| `sakurajima` | ![[media/dark.svg\|DARK]] | <img src="media/checking.svg" alt="CHECKING"/> | <a href="https://github.com/saberzero1/quartz-themes/tree/master/obsidian/sakurajima/LICENSE.md"><img src="media/license/mit.svg" alt="MIT"/></a> |
