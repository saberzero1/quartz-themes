...
- [[https://github.com/saberzero1/quartz-themes/tree/master/themes/wyrd|Install instructions]]

| Name   | Modes                     | Compatibility                                  | License                                                                                                                                     |
| ------ | ------------------------- | ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| `wyrd` | ![[media/both.svg\|BOTH]] | <img src="media/checking.svg" alt="CHECKING"/> | <a href="https://github.com/saberzero1/quartz-themes/tree/master/obsidian/wyrd/LICENSE.md"><img src="media/license/mit.svg" alt="MIT"/></a> |
