...
- <a href="https://github.com/saberzero1/quartz-themes/tree/master/themes/origami.heckhound/README.md">Install instructions</a>

| Name                | Modes                     | Compatibility                                                                                   | License                                                                                                                                                  |
| ------------------- | ------------------------- | ----------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `origami.heckhound` | ![[media/dark.svg\|DARK]] | <img src="media/partial.svg" alt="PARTIAL"/> <img src="media/collection.svg" alt="COLLECTION"/> | <a href="https://github.com/saberzero1/quartz-themes/tree/master/obsidian/origami.heckhound/LICENSE.md"><img src="media/license/mit.svg" alt="MIT"/></a> |
