...
- [[https://github.com/saberzero1/quartz-themes/tree/master/themes/novadust|Install instructions]]

| Name       | Modes                     | Compatibility                                  | License                                                                                                                                         |
| ---------- | ------------------------- | ---------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| `novadust` | ![[media/dark.svg\|DARK]] | <img src="media/checking.svg" alt="CHECKING"/> | <a href="https://github.com/saberzero1/quartz-themes/tree/master/obsidian/novadust/LICENSE.md"><img src="media/license/mit.svg" alt="MIT"/></a> |
