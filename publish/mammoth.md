...
- [[https://github.com/saberzero1/quartz-themes/tree/master/themes/mammoth|Install instructions]]

| Name      | Modes                     | Compatibility                                  | License                                                                                                                                                |
| --------- | ------------------------- | ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `mammoth` | ![[media/dark.svg\|DARK]] | <img src="media/checking.svg" alt="CHECKING"/> | <a href="https://github.com/saberzero1/quartz-themes/tree/master/obsidian/mammoth/LICENSE.md"><img src="media/license/gpl-3.0.svg" alt="GPL-3.0"/></a> |
