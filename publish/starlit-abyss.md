...
- Theme author: jpcranford
- Support the author: <a href="https://buymeacoffee.com/zfnqsc9dynl" target="_blank" rel="noopener noreferrer">Donate</a>
- <a href="https://github.com/saberzero1/quartz-themes/tree/master/themes/starlit-abyss/README.md">Install instructions</a>

| Name            | Modes                     | Compatibility                                                                                     | License                                                                                                                                              |
| --------------- | ------------------------- | ------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| `starlit-abyss` | ![[media/both.svg\|BOTH]] | <img src="media/checking.svg" alt="CHECKING"/> <img src="media/collection.svg" alt="COLLECTION"/> | <a href="https://github.com/saberzero1/quartz-themes/tree/master/obsidian/starlit-abyss/LICENSE.md"><img src="media/license/mit.svg" alt="MIT"/></a> |
