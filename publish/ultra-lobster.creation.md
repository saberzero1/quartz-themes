...
- <a href="https://github.com/saberzero1/quartz-themes/tree/master/themes/ultra-lobster.creation/README.md">Install instructions</a>

| Name                     | Modes                       | Compatibility                                                                                   | License                                                                                                                                                       |
| ------------------------ | --------------------------- | ----------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ultra-lobster.creation` | ![[media/light.svg\|LIGHT]] | <img src="media/partial.svg" alt="PARTIAL"/> <img src="media/collection.svg" alt="COLLECTION"/> | <a href="https://github.com/saberzero1/quartz-themes/tree/master/obsidian/ultra-lobster.creation/LICENSE.md"><img src="media/license/mit.svg" alt="MIT"/></a> |
