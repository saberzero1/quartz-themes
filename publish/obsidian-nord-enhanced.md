...
- <a href="https://github.com/saberzero1/quartz-themes/tree/master/themes/obsidian-nord-enhanced/README.md">Install instructions</a>

| Name                     | Modes                     | Compatibility                                                                               | License                                                                                                                                                                                 |
| ------------------------ | ------------------------- | ------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `obsidian-nord-enhanced` | ![[media/dark.svg\|DARK]] | <img src="media/removed.svg" alt="REMOVED"/> <img src="media/checking.svg" alt="CHECKING"/> | <a href="https://github.com/saberzero1/quartz-themes/tree/master/obsidian/obsidian-nord-enhanced/LICENSE.md"><img src="media/license/no spdx id found.svg" alt="NO SPDX ID FOUND"/></a> |
