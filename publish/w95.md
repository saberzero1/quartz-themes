...
- Theme author: <a href="https://github.com/phchang" target="_blank" rel="noopener noreferrer">@phchang</a>
- Support the author: <a href="https://buymeacoffee.com/phchang" target="_blank" rel="noopener noreferrer">Donate</a>
- <a href="https://github.com/saberzero1/quartz-themes/tree/master/themes/w95/README.md">Install instructions</a>

| Name  | Modes                       | Compatibility                                                                                     | License                                                                                                                                    |
| ----- | --------------------------- | ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| `w95` | ![[media/light.svg\|LIGHT]] | <img src="media/checking.svg" alt="CHECKING"/> <img src="media/collection.svg" alt="COLLECTION"/> | <a href="https://github.com/saberzero1/quartz-themes/tree/master/obsidian/w95/LICENSE.md"><img src="media/license/mit.svg" alt="MIT"/></a> |
