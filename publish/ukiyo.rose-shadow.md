...
- <a href="https://github.com/saberzero1/quartz-themes/tree/master/themes/ukiyo.rose-shadow/README.md">Install instructions</a>

| Name                | Modes                     | Compatibility                                                                                   | License                                                                                                                                                  |
| ------------------- | ------------------------- | ----------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ukiyo.rose-shadow` | ![[media/both.svg\|BOTH]] | <img src="media/removed.svg" alt="REMOVED"/> <img src="media/collection.svg" alt="COLLECTION"/> | <a href="https://github.com/saberzero1/quartz-themes/tree/master/obsidian/ukiyo.rose-shadow/LICENSE.md"><img src="media/license/mit.svg" alt="MIT"/></a> |
