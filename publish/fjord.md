...
- Theme author: <a href="https://github.com/jshuntley/fjord-obsidian" target="_blank" rel="noopener noreferrer">jshuntley</a>
- Support the author: Author did not provide funding links in `manifest.json`
- <a href="https://github.com/saberzero1/quartz-themes/tree/master/themes/fjord/README.md">Install instructions</a>

| Name    | Modes                     | Compatibility                                  | License                                                                                                                                      |
| ------- | ------------------------- | ---------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| `fjord` | ![[media/both.svg\|BOTH]] | <img src="media/checking.svg" alt="CHECKING"/> | <a href="https://github.com/saberzero1/quartz-themes/tree/master/obsidian/fjord/LICENSE.md"><img src="media/license/mit.svg" alt="MIT"/></a> |
