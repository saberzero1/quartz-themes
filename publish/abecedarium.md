...
- Theme author: <a href="https://notes.zacklenza.com" target="_blank" rel="noopener noreferrer">zalenza</a>
- Support the author: Author did not provide funding links in `manifest.json`
- <a href="https://github.com/saberzero1/quartz-themes/tree/master/themes/abecedarium/README.md">Install instructions</a>

| Name          | Modes                     | Compatibility                          | License                                                                                                                                            |
| ------------- | ------------------------- | -------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| `abecedarium` | ![[media/both.svg\|BOTH]] | <img src="media/full.svg" alt="FULL"/> | <a href="https://github.com/saberzero1/quartz-themes/tree/master/obsidian/abecedarium/LICENSE.md"><img src="media/license/mit.svg" alt="MIT"/></a> |
