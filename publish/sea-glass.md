...
- [[https://github.com/saberzero1/quartz-themes/tree/master/themes/sea-glass|Install instructions]]

| Name        | Modes                     | Compatibility                                  | License                                                                                                                                          |
| ----------- | ------------------------- | ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| `sea-glass` | ![[media/dark.svg\|DARK]] | <img src="media/checking.svg" alt="CHECKING"/> | <a href="https://github.com/saberzero1/quartz-themes/tree/master/obsidian/sea-glass/LICENSE.md"><img src="media/license/mit.svg" alt="MIT"/></a> |
