...
- <a href="https://github.com/saberzero1/quartz-themes/tree/master/themes/pure/README.md">Install instructions</a>

| Name   | Modes                     | Compatibility                                  | License                                                                                                                                     |
| ------ | ------------------------- | ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| `pure` | ![[media/both.svg\|BOTH]] | <img src="media/checking.svg" alt="CHECKING"/> | <a href="https://github.com/saberzero1/quartz-themes/tree/master/obsidian/pure/LICENSE.md"><img src="media/license/mit.svg" alt="MIT"/></a> |
