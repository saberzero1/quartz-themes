...
- <a href="https://github.com/saberzero1/quartz-themes/tree/master/themes/molecule/README.md">Install instructions</a>

| Name       | Modes                     | Compatibility                                                                               | License                                                                                                                                                                   |
| ---------- | ------------------------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `molecule` | ![[media/dark.svg\|DARK]] | <img src="media/removed.svg" alt="REMOVED"/> <img src="media/checking.svg" alt="CHECKING"/> | <a href="https://github.com/saberzero1/quartz-themes/tree/master/obsidian/molecule/LICENSE.md"><img src="media/license/no spdx id found.svg" alt="NO SPDX ID FOUND"/></a> |
