...
- <a href="https://github.com/saberzero1/quartz-themes/tree/master/themes/sanctum-reborn.yellow/README.md">Install instructions</a>

| Name                    | Modes                     | Compatibility                                                                                   | License                                                                                                                                                      |
| ----------------------- | ------------------------- | ----------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `sanctum-reborn.yellow` | ![[media/both.svg\|BOTH]] | <img src="media/partial.svg" alt="PARTIAL"/> <img src="media/collection.svg" alt="COLLECTION"/> | <a href="https://github.com/saberzero1/quartz-themes/tree/master/obsidian/sanctum-reborn.yellow/LICENSE.md"><img src="media/license/mit.svg" alt="MIT"/></a> |
