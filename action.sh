...
CHECK_INDEX=$(echo $(check_file "$THEME_DIR/_index.scss"; echo $?))
...
CHECK_DARK=$(echo $(check_file "$THEME_DIR/_dark.scss"; echo $?))
...
CHECK_LIGHT=$(echo $(check_file "$THEME_DIR/_light.scss"; echo $?))
