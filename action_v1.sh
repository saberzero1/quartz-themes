...
#
# curl -s -S https://raw.githubusercontent.com/saberzero1/quartz-themes/master/action_v1.sh | bash -s -- <THEME_NAME>
...
git clone -b v1 -n --depth=1 --filter=tree:0 https://github.com/saberzero1/quartz-themes.git &>/dev/null
