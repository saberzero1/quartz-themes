...
export const theme: ThemeData = {
  ...
  --accent-l: 65%;
  --accent-s: 94%;
  --background-modifier-active-hover: hsla(135, 94%, 65%, 0.1);
  ...
  --bases-table-cell-background-selected: hsla(135, 94%, 65%, 0.1);
  ...
  --bodyFont: var(--font-text, -apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  ...
  --checkbox-color-hover: hsl(135, 94%, 61.2%);
  ...
  --codeFont: var(--font-monospace, Hack Nerd Font, Source Code Pro, ui-monospace, SFMono-Regular, SF Mono, Menlo, Consolas, Liberation Mono, monospace, ui-monospace, SFMono-Regular, "Cascadia Mono", "Roboto Mono", "DejaVu Sans Mono", "Liberation Mono", Menlo, Monaco, "Consolas", "Source Code Pro", monospace);
  --collapse-icon-color-collapsed: hsl(135, 94%, 61.2%);
  --color-accent: hsl(135, 94%, 65%);
  --color-accent-1: hsl(135, 94%, 61.2%);
  --color-accent-2: hsl(135, 94%, 68.8%);
  --color-accent-hsl: 135, 94%, 65%;
  ...
  --graph-line: #976262;
  --graph-node: #bababa;
  --graph-node-focused: hsl(135, 94%, 61.2%);
  --graph-text: #f8f8f2;
  --gray: var(--text-muted, #bababa);
  --green: #b0f078;
  --headerFont: var(--font-text, -apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  --highlight: var(--background-modifier-active-hover, hsla(135, 94%, 65%, 0.1));
  --icon-color: #bababa;
  --icon-color-active: hsl(135, 94%, 61.2%);
  ...
  --interactive-accent-hover: hsl(135, 94%, 61.2%);
  --interactive-accent-hsl: 135, 94%, 65%;
  --interactive-accent-rgb: #f1fa8c;
  --interactive-hover: #976262;
  --light: var(--background-primary, linear-gradient(45deg, rgb(36, 10, 0) 0%, rgb(121, 9, 31) 35%, rgb(3, 3, 3) 100%));
  --light0: #ff8a8a;
  --light1: #fce6e4;
  --light2: #fdf8ec;
  --light3: #5fa57a;
  --lightgray: var(--background-secondary, #560000);
  --link-color: hsl(135, 94%, 61.2%);
  --link-color-hover: hsl(135, 94%, 68.8%);
  --link-external-color: hsl(135, 94%, 61.2%);
  --link-external-color-hover: hsl(135, 94%, 68.8%);
  --link-unresolved-color: hsl(135, 94%, 61.2%);
  --link-unresolved-decoration-color: hsla(135, 94%, 65%, 0.3);
  --list-marker-color-collapsed: hsl(135, 94%, 61.2%);
  ...
  --nav-item-background-selected: hsla(135, 94%, 65%, 0.15);
  --nav-item-color: #bababa;
  --nav-item-color-active: #f8f8f2;
  --nav-item-color-highlighted: hsl(135, 94%, 61.2%);
  ...
  --pill-color-remove-hover: hsl(135, 94%, 61.2%);
  ...
  --secondary: var(--text-accent, hsl(135, 94%, 61.2%));
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(135, 94%, 65%);
  ...
  --tab-text-color-focused-highlighted: hsl(135, 94%, 61.2%);
  --table-drag-handle-background-active: #50fa7b;
  --table-drag-handle-color-active: #282a36;
  --table-header-color: #f8f8f2;
  --table-selection: hsla(135, 94%, 65%, 0.1);
  --table-selection-border-color: #50fa7b;
  --tag-background: hsla(135, 94%, 65%, 0.1);
  --tag-background-hover: hsla(135, 94%, 65%, 0.2);
  --tag-border-color: hsla(135, 94%, 65%, 0.15);
  --tag-border-color-hover: hsla(135, 94%, 65%, 0.15);
  --tag-color: hsl(135, 94%, 61.2%);
  --tag-color-hover: hsl(135, 94%, 61.2%);
  --tertiary: var(--text-accent-hover, hsl(135, 94%, 68.8%));
  --text-a: #ff79c6;
  --text-a-hover: #ff79c0;
  --text-accent: hsl(135, 94%, 61.2%);
  --text-accent-hover: hsl(135, 94%, 68.8%);
  --text-link: #b0f078;
  --text-mark: #a1ad1dcf;
  --text-muted: #bababa;
  --text-normal: #f8f8f2;
  --text-on-accent: #282a36;
  --text-selection: hsla(135, 94%, 65%, 0.5);
  --text-tag: #50fa7b;
  ...
  --textHighlight: var(--background-modifier-active-hover, hsla(135, 94%, 65%, 0.1));
  --titleFont: var(--font-text, -apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
