...
export const theme: ThemeData = {
  ...
  --accent-l: 65%;
  --accent-s: 94%;
  --background-modifier-border-hover: var(--color-base-35, #976262);
  --background-primary: var(--dark-linear-gradient, linear-gradient(45deg, rgb(36, 10, 0) 0%, rgb(121, 9, 31) 35%, rgb(3, 3, 3) 100%));
  --background-primary-alt: var(--color-base-10, #6e021a81);
  --background-red: #6c0808;
  --background-secondary: var(--color-base-20, #560000);
  --background-secondary-alt: var(--color-base-30, #560000b7);
  --bases-cards-background: var(--background-primary, linear-gradient(45deg, rgb(36, 10, 0) 0%, rgb(121, 9, 31) 35%, rgb(3, 3, 3) 100%));
  --bases-cards-cover-background: var(--background-primary-alt, #6e021a81);
  --bases-group-heading-property-color: var(--text-muted, #bababa);
  --bases-table-cell-background-active: var(--background-primary, linear-gradient(45deg, rgb(36, 10, 0) 0%, rgb(121, 9, 31) 35%, rgb(3, 3, 3) 100%));
  --bases-table-cell-background-disabled: var(--background-primary-alt, #6e021a81);
  --bases-table-cell-background-selected: var(--table-selection, hsla(135, 94%, 65%, 0.1));
  --bases-table-group-background: var(--background-primary-alt, #6e021a81);
  --bases-table-header-background: var(--background-primary, linear-gradient(45deg, rgb(36, 10, 0) 0%, rgb(121, 9, 31) 35%, rgb(3, 3, 3) 100%));
  --bases-table-header-color: var(--text-muted, #bababa);
  --bases-table-summary-background: var(--background-primary, linear-gradient(45deg, rgb(36, 10, 0) 0%, rgb(121, 9, 31) 35%, rgb(3, 3, 3) 100%));
  --blockquote-border: #b294bb;
  --blockquote-border-color: var(--interactive-accent, #50fa7b);
  ...
  --canvas-background: var(--background-primary, linear-gradient(45deg, rgb(36, 10, 0) 0%, rgb(121, 9, 31) 35%, rgb(3, 3, 3) 100%));
  ...
  --canvas-color-4: var(--color-green-rgb, 82, 250, 124);
  --canvas-color-5: var(--color-cyan-rgb, 139, 233, 253);
  --canvas-color-6: var(--color-purple-rgb, 189, 147, 244);
  --caret-color: var(--text-normal, #f8f8f2);
  --checkbox-border-color-hover: var(--text-muted, #bababa);
  --checkbox-color: var(--interactive-accent, #50fa7b);
  --checkbox-color-hover: var(--interactive-accent-hover, hsl(135, 94%, 61.2%));
  --checkbox-marker-color: var(--background-primary, linear-gradient(45deg, rgb(36, 10, 0) 0%, rgb(121, 9, 31) 35%, rgb(3, 3, 3) 100%));
  --checklist-done-color: var(--text-muted, #bababa);
  ...
  --collapse-icon-color-collapsed: var(--text-accent, hsl(135, 94%, 61.2%));
  ...
  --divider-color-hover: var(--interactive-accent, #50fa7b);
  ...
  --dropdown-background-hover: var(--interactive-hover, #976262);
  --file-header-background: var(--background-primary, linear-gradient(45deg, rgb(36, 10, 0) 0%, rgb(121, 9, 31) 35%, rgb(3, 3, 3) 100%));
  --file-header-background-focused: var(--background-primary, linear-gradient(45deg, rgb(36, 10, 0) 0%, rgb(121, 9, 31) 35%, rgb(3, 3, 3) 100%));
  ...
  --graph-node-focused: var(--text-accent, hsl(135, 94%, 61.2%));
  ...
  --icon-color-active: var(--text-accent, hsl(135, 94%, 61.2%));
  --icon-color-focused: var(--text-normal, #f8f8f2);
  --icon-color-hover: var(--text-muted, #bababa);
  ...
  --interactive-accent: var(--color-accent, #50fa7b);
  --interactive-accent-hover: var(--color-accent-1, hsl(135, 94%, 61.2%));
  --interactive-accent-hsl: var(--color-accent-hsl, 135, 94%, 65%);
  --interactive-accent-rgb: #f1fa8c;
  --interactive-hover: var(--color-base-35, #976262);
  --light: var(--background-primary, var(--dark-linear-gradient, linear-gradient(45deg, rgb(36, 10, 0) 0%, rgb(121, 9, 31) 35%, rgb(3, 3, 3) 100%)));
  --light0: #ff8a8a;
  --light1: #fce6e4;
  --light2: #fdf8ec;
  --light3: #5fa57a;
  --lightgray: var(--background-secondary, var(--color-base-20, #560000));
  --link-color: var(--text-accent, hsl(135, 94%, 61.2%));
  --link-color-hover: var(--text-accent-hover, hsl(135, 94%, 68.8%));
  --link-external-color: var(--text-accent, hsl(135, 94%, 61.2%));
  --link-external-color-hover: var(--text-accent-hover, hsl(135, 94%, 68.8%));
  --link-unresolved-color: var(--text-accent, hsl(135, 94%, 61.2%));
  --list-marker-color-collapsed: var(--text-accent, hsl(135, 94%, 61.2%));
  --list-marker-color-hover: var(--text-muted, #bababa);
  --markup-code: #ffb86c;
  --menu-background: var(--background-secondary, #560000);
  --menu-border-color: var(--background-modifier-border-hover, #976262);
  ...
  --modal-background: var(--background-primary, linear-gradient(45deg, rgb(36, 10, 0) 0%, rgb(121, 9, 31) 35%, rgb(3, 3, 3) 100%));
  ...
  --nav-item-color-highlighted: var(--text-accent, hsl(135, 94%, 61.2%));
  ...
  --orange: #f3ad6b;
  --pdf-background: var(--background-primary, linear-gradient(45deg, rgb(36, 10, 0) 0%, rgb(121, 9, 31) 35%, rgb(3, 3, 3) 100%));
  --pdf-page-background: var(--background-primary, linear-gradient(45deg, rgb(36, 10, 0) 0%, rgb(121, 9, 31) 35%, rgb(3, 3, 3) 100%));
  --pdf-sidebar-background: var(--background-primary, linear-gradient(45deg, rgb(36, 10, 0) 0%, rgb(121, 9, 31) 35%, rgb(3, 3, 3) 100%));
  --pill-border-color-hover: var(--background-modifier-border-hover, #976262);
  --pill-color: var(--text-muted, #bababa);
  --pill-color-hover: var(--text-normal, #f8f8f2);
  --pill-color-remove-hover: var(--text-accent, hsl(135, 94%, 61.2%));
  --prompt-background: var(--background-primary, linear-gradient(45deg, rgb(36, 10, 0) 0%, rgb(121, 9, 31) 35%, rgb(3, 3, 3) 100%));
  --purple: #f899e7;
  --red: #d63f4e;
  --ribbon-background: var(--background-secondary, #560000);
  --ribbon-background-collapsed: var(--background-primary, linear-gradient(45deg, rgb(36, 10, 0) 0%, rgb(121, 9, 31) 35%, rgb(3, 3, 3) 100%));
  --search-clear-button-color: var(--text-muted, #bababa);
  --search-icon-color: var(--text-muted, #bababa);
  --search-result-background: var(--background-primary, linear-gradient(45deg, rgb(36, 10, 0) 0%, rgb(121, 9, 31) 35%, rgb(3, 3, 3) 100%));
  --secondary: var(--text-accent, var(--color-accent-1, hsl(135, 94%, 61.2%)));
  --setting-group-heading-color: var(--text-normal, #f8f8f2);
  --setting-items-background: var(--background-primary-alt, #6e021a81);
  ...
  --sideRed: #910b0bcc;
  --slider-thumb-border-color: var(--background-modifier-border-hover, #976262);
  --status-bar-background: var(--background-secondary, #560000);
  --status-bar-text-color: var(--text-muted, #bababa);
  --suggestion-background: var(--background-primary, linear-gradient(45deg, rgb(36, 10, 0) 0%, rgb(121, 9, 31) 35%, rgb(3, 3, 3) 100%));
  --tab-background-active: var(--background-primary, linear-gradient(45deg, rgb(36, 10, 0) 0%, rgb(121, 9, 31) 35%, rgb(3, 3, 3) 100%));
  --tab-container-background: var(--background-secondary, #560000);
  --tab-divider-color: var(--background-modifier-border-hover, #976262);
  --tab-switcher-background: var(--background-secondary, #560000);
  --tab-text-color-active: var(--text-muted, #bababa);
  --tab-text-color-focused: var(--text-muted, #bababa);
  --tab-text-color-focused-active: var(--text-muted, #bababa);
  --tab-text-color-focused-active-current: var(--text-normal, #f8f8f2);
  --tab-text-color-focused-highlighted: var(--text-accent, hsl(135, 94%, 61.2%));
  --table-drag-handle-background-active: var(--table-selection-border-color, #50fa7b);
  --table-drag-handle-color-active: var(--text-on-accent, #282a36);
  --table-header-color: var(--text-normal, #f8f8f2);
  --table-selection-border-color: var(--interactive-accent, #50fa7b);
  --tag-color: var(--text-accent, hsl(135, 94%, 61.2%));
  --tag-color-hover: var(--text-accent, hsl(135, 94%, 61.2%));
  --tertiary: var(--text-accent-hover, var(--color-accent-2, hsl(135, 94%, 68.8%)));
  --text-a: #ff79c6;
  --text-a-hover: #ff79c0;
  --text-accent: var(--color-accent-1, hsl(135, 94%, 61.2%));
  --text-accent-hover: var(--color-accent-2, hsl(135, 94%, 68.8%));
  --text-link: #b0f078;
  --text-mark: #a1ad1dcf;
  ...
  --titlebar-background: var(--background-secondary, #560000);
  --titlebar-background-focused: var(--background-secondary-alt, #560000b7);
...
html body[data-slug] div#quartz-root.page, html .page > div#quartz-body div.sidebar.left, html .page > div#quartz-body div.sidebar.left:has(.explorer), html .page > div#quartz-body div.sidebar.left .explorer .explorer-content {
  --bases-table-header-background: var(--background-secondary, #560000);
  background-color: var(--tab-container-background, rgb(86, 0, 0));
...
html body .page > div#quartz-body div.sidebar {
  background-color: var(--background-secondary, rgb(86, 0, 0));
  color: rgb(248, 248, 242);
}
...
html body html {
  ...
  color: var(--markup-code, rgb(255, 184, 108));
...
html body .markdown-rendered p > em, html em {
  color: var(--interactive-accent, rgb(80, 250, 123));
  font-family: "??", -apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
...
html body .text-highlight {
  background-color: var(--background-primary-alt, rgba(110, 2, 26, 0.506));
  color: var(--text-link, rgb(176, 240, 120));
  font-family: "??", -apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
...
html body li.task-list-item input[type="checkbox"]:checked {
  background-color: var(--checkbox-color, rgb(80, 250, 123));
...
html body a.internal-link, html .breadcrumb-container .breadcrumb-element > a {
  color: var(--link-color, rgb(63, 249, 110));
  font-family: "??", -apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
...
html body a.internal-link.broken {
  color: var(--link-unresolved-color, rgb(63, 249, 110));
  font-family: "??", -apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  outline: rgb(63, 249, 110) none 0px;
  text-decoration: underline rgba(82, 250, 124, 0.3);
  text-decoration-color: var(--link-unresolved-decoration-color, rgba(82, 250, 124, 0.3));
}`,
    lists: `html body dd {
...
html body .search > .search-container > .search-space > .search-layout > .results-container > .result-card:hover, html .search > .search-container > .search-space > .search-layout > .results-container > .result-card:focus, html .search > .search-container > .search-space > .search-layout > .results-container > .result-card.focus:not(:has(~ .result-card:hover, html ~ .result-card:focus)) {
  background-color: var(--blockquote-border, rgb(178, 148, 187));
  color: rgb(248, 248, 242);
}
...
html body a.internal-link.tag-link, html .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  --pill-background: var(--tag-background, hsla(135, 94%, 65%, 0.1));
  --pill-background-hover: var(--tag-background-hover, hsla(135, 94%, 65%, 0.2));
  --pill-border-color: var(--tag-border-color, hsla(135, 94%, 65%, 0.15));
  --pill-border-color-hover: var(--tag-border-color-hover, hsla(135, 94%, 65%, 0.15));
  --pill-color: var(--tag-color, hsl(135, 94%, 61.2%));
  --pill-color-hover: var(--tag-color-hover, hsl(135, 94%, 61.2%));
  --pill-color-remove: var(--tag-color, hsl(135, 94%, 61.2%));
  --pill-color-remove-hover: var(--tag-color-hover, hsl(135, 94%, 61.2%));
  background-color: var(--pill-background, rgba(82, 250, 124, 0.1));
  ...
  color: var(--pill-color, rgb(63, 249, 110));
}
...
html body h1 {
  ...
  color: var(--text-title-h1, rgb(189, 147, 249));
...
html body h2 {
  ...
  color: var(--text-title-h2, rgb(255, 184, 108));
...
html body h3 {
  ...
  color: var(--text-title-h3, rgb(80, 250, 123));
...
html body h4 {
  border-bottom-color: rgb(204, 53, 218);
  border-left-color: rgb(204, 53, 218);
  border-right-color: rgb(204, 53, 218);
  border-top-color: rgb(204, 53, 218);
  color: var(--text-title-h4, rgb(204, 53, 218));
...
html body h5 {
  ...
  color: var(--text-title-h5, rgb(241, 250, 140));
...
html body h6 {
  border-bottom-color: rgb(60, 164, 224);
  border-left-color: rgb(60, 164, 224);
  border-right-color: rgb(60, 164, 224);
  border-top-color: rgb(60, 164, 224);
  color: var(--text-title-h6, rgb(60, 164, 224));
...
html body .explorer .nav-files-container .is-active {
  ...
  background-color: var(--background-secondary-alt, rgba(86, 0, 0, 0.718));
...
html body .stacked-page-header {
  background-color: var(--background-red, rgb(108, 8, 8));
}
...
html body ul.tags > li {
  background-color: var(--tag-background, rgba(82, 250, 124, 0.1));
  border-bottom-color: rgba(82, 250, 124, 0.15);
  border-left-color: rgba(82, 250, 124, 0.15);
  border-right-color: rgba(82, 250, 124, 0.15);
  border-top-color: rgba(82, 250, 124, 0.15);
  color: var(--text-tag, rgb(80, 250, 123));
}`,
  },
  light: {},
};
