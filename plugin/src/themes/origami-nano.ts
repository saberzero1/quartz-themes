...
export const theme: ThemeData = {
  ...
  --accent-l: 62%;
  --accent-s: 92%;
  --ancestor-editor-color: var(--text-normal, #c5c5c5);
  --aside-background: transparent;
  --aside-background-hover: var(--background-modifier-hover, rgba(255, 255, 255, 0.075));
  --aside-border-color: var(--background-modifier-border, #ffffff);
  --aside-text-color: var(--text-muted, #a7a7a7);
  --background-modifier-active-hover: hsla(var(--interactive-accent-hsl), 0.15);
  --background-modifier-border: var(--color-base-30, #ffffff);
  --background-modifier-border-focus: var(--color-base-40, #292929);
  --background-modifier-border-hover: var(--color-base-35, #383838);
  --background-modifier-error: var(--color-red, #E76F51);
  --background-modifier-error-hover: var(--color-red, #E76F51);
  --background-modifier-error-rgb: var(--color-red-rgb, 231, 111, 81);
  --background-modifier-form-field: var(--color-base-00, #666666);
  --background-modifier-form-field-hover: var(--background-modifier-form-field, #666666);
  --background-modifier-hover: rgba(var(--mono-rgb-100), 0.075);
  --background-modifier-success: var(--color-green, #B5E48C);
  --background-modifier-success-rgb: var(--color-green-rgb, 181, 228, 140);
  --background-primary: var(--color-base-00, #000000);
  --background-primary-alt: var(--color-base-10, #000000);
  --background-primary-pre-alt: var(--color-base-05, #000000);
  --background-secondary: var(--color-base-20, #424242);
  --background-secondary-alt: var(--color-base-30, #ffffff);
  ...
  --bases-group-heading-property-color: var(--text-muted, #a7a7a7);
  ...
  --bases-table-header-color: var(--text-muted, #a7a7a7);
  ...
  --callout-bug: var(--color-red-rgb, 231, 111, 81);
  --callout-cite: 87, 61, 132;
  --callout-default: var(--color-blue-rgb, 0, 166, 251);
  --callout-error: var(--color-red-rgb, 231, 111, 81);
  --callout-example: var(--color-purple-rgb, 160, 108, 213);
  --callout-fail: var(--color-red-rgb, 231, 111, 81);
  --callout-important: var(--color-cyan-rgb, 100, 223, 223);
  --callout-info: var(--color-blue-rgb, 0, 166, 251);
  --callout-question: var(--color-orange-rgb, 244, 162, 97);
  --callout-quote: var(--callout-quote, 158, 158, 158);
  --callout-radius: var(--radius-s, 0px);
  --callout-success: var(--color-green-rgb, 181, 228, 140);
  --callout-summary: var(--color-cyan-rgb, 100, 223, 223);
  --callout-tip: var(--color-cyan-rgb, 100, 223, 223);
  --callout-todo: var(--color-blue-rgb, 0, 166, 251);
  --callout-warning: var(--color-orange-rgb, 244, 162, 97);
  --canvas-background: var(--background-primary, #000000);
  --canvas-card-label-color: var(--text-faint, #7c7c7c);
  --canvas-color: 114, 114, 114;
  --canvas-color-1: var(--color-red-rgb, 231, 111, 81);
  --canvas-color-2: var(--color-orange-rgb, 244, 162, 97);
  --canvas-color-3: var(--color-yellow-rgb, 233, 196, 106);
  --canvas-color-4: var(--color-green-rgb, 181, 228, 140);
  --canvas-color-5: var(--color-cyan-rgb, 100, 223, 223);
  --canvas-color-6: var(--color-purple-rgb, 160, 108, 213);
  --canvas-controls-radius: var(--radius-s, 0px);
  --canvas-dot-pattern: var(--color-base-50, #7c7c7c);
  --caret-color: var(--text-normal, #c5c5c5);
  --checkbox-border-color: var(--text-faint, #7c7c7c);
  --checkbox-border-color-hover: var(--text-muted, #a7a7a7);
  ...
  --checklist-done-color: var(--text-muted, #a7a7a7);
  ...
  --code-comment: var(--text-faint, #7c7c7c);
  --code-function: var(--color-yellow, #E9C46A);
  --code-important: var(--color-orange, #F4A261);
  --code-keyword: var(--color-pink, #E5989B);
  --code-normal: var(--text-muted, #a7a7a7);
  --code-operator: var(--color-red, #E76F51);
  --code-property: var(--color-cyan, #64DFDF);
  --code-punctuation: var(--text-muted, #a7a7a7);
  --code-radius: var(--radius-s, 0px);
  --code-string: var(--color-green, #B5E48C);
  --code-tag: var(--color-red, #E76F51);
  --code-value: var(--color-purple, #A06CD5);
  --collapse-icon-color: var(--text-faint, #7c7c7c);
  ...
  --color-accent-hsl: var(--accent-h),
        var(--accent-s),
        var(--accent-l);
  --color-accent-rgb: var(--color-red-rgb, 231, 111, 81);
  ...
  --dark: var(--text-normal, var(--color-base-70, #c5c5c5));
  --darkgray: var(--text-normal, var(--color-base-70, #c5c5c5));
  ...
  --flair-color: var(--text-normal, #c5c5c5);
  --font-interface-theme: "Aspekta", sans-serif;
  --font-ui-medium: 16px;
  --font-ui-small: 14px;
  --footnote-divider-color: var(--metadata-divider-color, #ffffff);
  --footnote-id-color: var(--text-muted, #a7a7a7);
  --footnote-id-color-no-occurrences: var(--text-faint, #7c7c7c);
  ...
  --graph-node: var(--text-muted, #a7a7a7);
  --graph-node-attachment: var(--color-accent-1, hsl(-3, 93.84%, 71.3%));
  --graph-node-focused: var(--background-modifier-border-focus, #292929);
  --graph-node-tag: var(--color-accent, hsl(0, 92%, 62%));
  --graph-node-unresolved: var(--text-faint, #7c7c7c);
  --graph-text: var(--text-normal, #c5c5c5);
  --gray: var(--text-muted, var(--color-base-60, #a7a7a7));
  ...
  --input-date-separator: var(--text-faint, #7c7c7c);
  --input-placeholder-color: var(--text-faint, #7c7c7c);
  ...
  --interactive-hover: var(--color-base-10, #383838);
  --interactive-normal: var(--color-base-00, #ffffff);
  --light: var(--background-primary, var(--color-base-00, #000000));
  --lightgray: var(--background-secondary, var(--color-base-20, #424242));
  ...
  --list-marker-color: var(--text-faint, #7c7c7c);
  --list-marker-color-collapsed: var(--text-accent, hsl(0, 92%, 62%));
  --list-marker-color-hover: var(--text-muted, #a7a7a7);
  --menu-background: var(--background-secondary, #424242);
  ...
  --metadata-input-text-color: var(--text-normal, #c5c5c5);
  ...
  --metadata-label-text-color: var(--text-muted, #a7a7a7);
  --metadata-label-text-color-hover: var(--text-muted, #a7a7a7);
  ...
  --nav-collapse-icon-color: var(--collapse-icon-color, #7c7c7c);
  --nav-collapse-icon-color-collapsed: var(--text-faint, #7c7c7c);
  --nav-heading-color: var(--text-normal, #c5c5c5);
  --nav-heading-color-collapsed: var(--text-faint, #7c7c7c);
  --nav-heading-color-collapsed-hover: var(--text-muted, #a7a7a7);
  --nav-heading-color-hover: var(--text-normal, #c5c5c5);
  ...
  --nav-item-color: var(--text-muted, #a7a7a7);
  --nav-item-color-active: var(--text-normal, #c5c5c5);
  --nav-item-color-highlighted: var(--text-accent, hsl(0, 92%, 62%));
  --nav-item-color-hover: var(--text-normal, #c5c5c5);
  --nav-item-color-selected: var(--text-normal, #c5c5c5);
  --nav-item-radius: var(--radius-s, 0px);
  --nav-item-size: var(--font-ui-small, 14px);
  --nav-tag-color: var(--text-faint, #7c7c7c);
  --nav-tag-color-active: var(--text-muted, #a7a7a7);
  --nav-tag-color-hover: var(--text-muted, #a7a7a7);
  --nav-tag-radius: var(--radius-s, 0px);
  --o-h1-color: var(--background-modifier-border, #ffffff);
  --o-h2-color: var(--background-modifier-border, #ffffff);
  --o-h3-color: var(--background-modifier-border, #ffffff);
  --o-h4-color: var(--background-modifier-border, #ffffff);
  --o-h5-color: var(--background-modifier-border, #ffffff);
  --o-h6-color: var(--background-modifier-border, #ffffff);
  ...
  --pill-color: var(--text-muted, #a7a7a7);
  --pill-color-hover: var(--text-normal, #c5c5c5);
  --pill-color-remove: var(--text-faint, #7c7c7c);
  ...
  --ribbon-background: var(--background-secondary, #424242);
  ...
  --search-clear-button-color: var(--text-muted, #a7a7a7);
  --search-icon-color: var(--text-muted, #a7a7a7);
  --search-result-background: var(--background-primary, #000000);
  --secondary: var(--text-accent, var(--color-accent, hsl(0, 92%, 62%)));
  --setting-group-heading-color: var(--text-normal, #c5c5c5);
  ...
  --shiki-active-tab-border-color: var(--shiki-highlight-neutral, #a7a7a7);
  --shiki-code-background: var(--code-background, #000000);
  --shiki-code-block-border-radius: var(--code-radius, 0px);
  --shiki-code-comment: var(--text-faint, #7c7c7c);
  --shiki-code-function: var(--color-green, #B5E48C);
  --shiki-code-important: var(--color-orange, #F4A261);
  --shiki-code-keyword: var(--color-pink, #E5989B);
  --shiki-code-normal: var(--text-muted, #a7a7a7);
  --shiki-code-property: var(--color-cyan, #64DFDF);
  --shiki-code-punctuation: var(--text-muted, #a7a7a7);
  --shiki-code-string: var(--color-yellow, #E9C46A);
  --shiki-code-value: var(--color-purple, #A06CD5);
  --shiki-gutter-border-color: var(--background-modifier-border, #ffffff);
  --shiki-gutter-text-color: var(--text-faint, #7c7c7c);
  --shiki-gutter-text-color-highlight: var(--shiki-code-normal, #a7a7a7);
  --shiki-highlight-neutral: var(--shiki-code-normal, #a7a7a7);
  --shiki-terminal-dots-color: var(--text-faint, #7c7c7c);
  ...
  --status-bar-background: var(--background-secondary, #424242);
  ...
  --status-bar-text-color: var(--text-muted, #a7a7a7);
  --suggestion-background: var(--background-primary, #000000);
  --swatch-height: 24px;
  --swatch-width: 24px;
  --sync-avatar-color-1: var(--color-red, #E76F51);
  --sync-avatar-color-2: var(--color-orange, #F4A261);
  --sync-avatar-color-3: var(--color-yellow, #E9C46A);
  --sync-avatar-color-4: var(--color-green, #B5E48C);
  --sync-avatar-color-5: var(--color-cyan, #64DFDF);
  --sync-avatar-color-6: var(--color-blue, #00A6FB);
  --sync-avatar-color-7: var(--color-purple, #A06CD5);
  --sync-avatar-color-8: var(--color-pink, #E5989B);
  --tab-background-active: var(--background-primary, #000000);
  --tab-container-background: var(--background-secondary, #424242);
  ...
  --tab-switcher-background: var(--background-secondary, #424242);
  --tab-text-color: var(--text-faint, #7c7c7c);
  --tab-text-color-active: var(--text-muted, #a7a7a7);
  --tab-text-color-focused: var(--text-muted, #a7a7a7);
  --tab-text-color-focused-active: var(--text-muted, #a7a7a7);
  --tab-text-color-focused-active-current: var(--text-normal, #c5c5c5);
  ...
  --text-error: var(--color-red, #E76F51);
  --text-faint: var(--color-base-50, #7c7c7c);
  --text-muted: var(--color-base-60, #a7a7a7);
  --text-normal: var(--color-base-70, #c5c5c5);
  --text-on-accent: var(--color-base-100, #ffffff);
  --text-on-button: var(--color-base-00, #000000);
  --text-selection: hsla(var(--color-accent-hsl), 0.2);
  --text-success: var(--color-green, #B5E48C);
  --text-warning: var(--color-orange, #F4A261);
  --textHighlight: var(--background-modifier-hover, rgba(var(--mono-rgb-100), 0.075));
  --titlebar-background: var(--background-secondary, #424242);
  ...
  --titlebar-text-color: var(--text-muted, #a7a7a7);
  --titlebar-text-color-focused: var(--text-normal, #c5c5c5);
  ...
  --vault-name-color: var(--text-normal, #c5c5c5);
  --vault-name-font-size: var(--font-ui-small, 14px);
  --vault-name-font-weight: var(--font-medium, 500);
  --vault-profile-color: var(--text-normal, #c5c5c5);
  --vault-profile-color-hover: var(--vault-profile-color, #c5c5c5);
...
html body[data-slug] div#quartz-root.page, html .page > div#quartz-body div.sidebar.left, html .page > div#quartz-body div.sidebar.left:has(.explorer), html .page > div#quartz-body div.sidebar.left .explorer .explorer-content {
  --bases-table-header-background: var(--background-secondary, #424242);
...
html body del {
  ...
  font-family: "??", Aspekta, sans-serif, "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  font-weight: 500;
  outline: rgb(197, 197, 197) none 0px;
  text-decoration-color: rgb(197, 197, 197);
}
...
html body p {
  color: var(--text-muted, rgb(167, 167, 167));
  font-family: "??", Aspekta, sans-serif, "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
...
html body a.internal-link.broken {
  ...
  font-weight: var(--link-weight, 700);
  outline: rgb(167, 167, 167) none 0px;
  text-decoration-color: var(--link-unresolved-decoration-color, rgb(167, 167, 167));
  transition: 0.7s;
}`,
    lists: `html body dd {
...
html body ul.overflow {
  ...
  color: var(--text-faint, rgb(124, 124, 124));
}

html body blockquote {
  background-color: var(--blockquote-background-color, rgb(66, 66, 66));
  color: var(--text-normal, rgb(197, 197, 197));
  font-family: "??", Aspekta, sans-serif, "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  font-weight: 500;
  padding-bottom: 18px;
  padding-left: 0px;
...
html body td {
  ...
  border-top-right-radius: var(--radius-l, 0px);
  border-top-width: 0px;
  color: var(--table-text-color, rgb(197, 197, 197));
  font-weight: 500;
}
...
html body th {
  ...
  border-top-right-radius: var(--radius-l, 0px);
  border-top-width: 0px;
  color: var(--table-header-color, rgb(197, 197, 197));
}
...
html body tr {
  ...
  border-top-right-radius: var(--radius-l, 0px);
  border-top-width: 0px;
  color: var(--ec-codeFg, rgb(167, 167, 167));
...
html body .callout .callout-title > .callout-title-inner > p {
  color: var(--callout-title-color, rgb(0, 166, 251));
...
html body .callout[data-callout="abstract"] {
  --callout-color: var(--callout-summary, 100, 223, 223);
...
html body .callout[data-callout="bug"] {
  --callout-color: var(--callout-bug, 231, 111, 81);
...
html body .callout[data-callout="danger"] {
  --callout-color: var(--callout-error, 231, 111, 81);
  background: rgba(231, 111, 81, 0.1) none repeat scroll 0% 0% / auto padding-box border-box;
  border-bottom-color: rgb(231, 111, 81);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
...
html body .callout[data-callout="example"] {
  --callout-color: var(--callout-example, 160, 108, 213);
...
html body .callout[data-callout="failure"] {
  --callout-color: var(--callout-fail, 231, 111, 81);
  background: rgba(231, 111, 81, 0.1) none repeat scroll 0% 0% / auto padding-box border-box;
  border-bottom-color: rgb(231, 111, 81);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
...
html body .callout[data-callout="info"] {
  --callout-color: var(--callout-info, 0, 166, 251);
...
html body .callout[data-callout="note"] {
  --callout-color: var(--callout-default, 0, 166, 251);
  background: rgba(0, 166, 251, 0.1) none repeat scroll 0% 0% / auto padding-box border-box;
  border-bottom-color: rgb(0, 166, 251);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
...
html body .callout[data-callout="success"] {
  --callout-color: var(--callout-success, 181, 228, 140);
...
html body .callout[data-callout="tip"] {
  --callout-color: var(--callout-tip, 100, 223, 223);
  background: rgba(100, 223, 223, 0.1) none repeat scroll 0% 0% / auto padding-box border-box;
  border-bottom-color: rgb(100, 223, 223);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
...
html body .callout[data-callout="todo"] {
  --callout-color: var(--callout-todo, 0, 166, 251);
  background: rgba(0, 166, 251, 0.1) none repeat scroll 0% 0% / auto padding-box border-box;
  border-bottom-color: rgb(0, 166, 251);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
...
html body .search > .search-container > .search-space > .search-layout > .results-container > .result-card:hover, html .search > .search-container > .search-space > .search-layout > .results-container > .result-card:focus, html .search > .search-container > .search-space > .search-layout > .results-container > .result-card.focus:not(:has(~ .result-card:hover, html ~ .result-card:focus)) {
  background-color: var(--background-secondary, rgb(66, 66, 66));
  color: rgb(197, 197, 197);
  font-weight: 500;
}
...
html body h2 {
  ...
  border-top-right-radius: var(--radius-l, 0px);
  border-top-width: 0px;
  color: var(--h2-color, rgb(197, 197, 197));
...
html body h3 {
  ...
  border-top-right-radius: var(--radius-l, 0px);
  border-top-width: 0px;
  color: var(--h3-color, rgb(197, 197, 197));
...
html body h4 {
  ...
  border-top-right-radius: var(--radius-l, 0px);
  border-top-width: 0px;
  color: var(--h4-color, rgb(197, 197, 197));
...
html body h5 {
  ...
  border-top-right-radius: var(--radius-l, 0px);
  border-top-width: 0px;
  color: var(--h5-color, rgb(197, 197, 197));
...
html body h6 {
  ...
  border-top-right-radius: var(--radius-l, 0px);
  border-top-width: 0px;
  color: var(--h6-color, rgb(197, 197, 197));
...
html body hr {
  ...
  color: var(--nav-item-color, rgb(167, 167, 167));
  font-family: "??", Aspekta, sans-serif, "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
}
...
html body .explorer .nav-files-container .collapse-icon svg {
  ...
  background-color: var(--status-bar-background, rgb(66, 66, 66));
  border-bottom-color: rgb(102, 102, 102);
  border-bottom-width: 1px;
  border-left-color: rgb(102, 102, 102);
  border-left-width: 0px;
  ...
  border-top-right-radius: var(--radius-l, 0px);
  border-top-width: 0px;
  color: var(--status-bar-text-color, rgb(167, 167, 167));
  font-family: "??", Aspekta, sans-serif, "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
}
