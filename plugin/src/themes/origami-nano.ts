...
export const theme: ThemeData = {
  ...
  --ancestor-editor-color: #c5c5c5 !important;
  --aside-background: transparent !important;
  --aside-background-hover: rgba(255, 255, 255, 0.075) !important;
  --aside-border-color: #ffffff !important;
  --aside-text-color: #a7a7a7 !important;
  ...
  --background-modifier-form-field: #666666 !important;
  --background-modifier-form-field-hover: #666666 !important;
  ...
  --background-primary-pre-alt: #000000 !important;
  ...
  --bases-group-heading-property-color: #a7a7a7 !important;
  ...
  --bases-table-header-color: #a7a7a7 !important;
  ...
  --bb-border-alt: 1px solid #666666 !important;
  --bb-border-dashed: 1px dashed #ffffff !important;
  --bb-border-high-contrast: 1px solid #a7a7a7 !important;
  ...
  --canvas-card-label-color: #7c7c7c !important;
  ...
  --canvas-dot-pattern: #7c7c7c !important;
  --caret-color: #c5c5c5 !important;
  --checkbox-border-color: #7c7c7c !important;
  --checkbox-border-color-hover: #a7a7a7 !important;
  ...
  --checklist-done-color: #a7a7a7 !important;
  ...
  --collapse-icon-color: #7c7c7c !important;
  ...
  --color-base-20: #424242 !important;
  --color-base-25: #666666 !important;
  --color-base-30: #ffffff !important;
  --color-base-35: #383838 !important;
  --color-base-40: #292929 !important;
  --color-base-50: #7c7c7c !important;
  --color-base-60: #a7a7a7 !important;
  --color-base-70: #c5c5c5 !important;
  ...
  --dark: #c5c5c5 !important;
  --darkgray: #c5c5c5 !important;
  ...
  --embed-block-shadow-hover: 0 0 0 1px #ffffff,
  ...
  --footnote-id-color: #a7a7a7 !important;
  --footnote-id-color-no-occurrences: #7c7c7c !important;
  ...
  --heading-formatting: #7c7c7c !important;
  --highlight: rgba(255, 255, 255, 0.075) !important;
  --hr-color: #ffffff !important;
  --icon-color: #a7a7a7 !important;
  --icon-color-active: hsl(0, 92%, 62%) !important;
  --icon-color-focused: #c5c5c5 !important;
  --icon-color-hover: #a7a7a7 !important;
  ...
  --input-date-separator: #7c7c7c !important;
  ...
  --list-marker-color: #7c7c7c !important;
  --list-marker-color-collapsed: hsl(0, 92%, 62%) !important;
  --list-marker-color-hover: #a7a7a7 !important;
  --menu-background: #424242 !important;
  ...
  --metadata-input-text-color: #c5c5c5 !important;
  ...
  --metadata-label-text-color: #a7a7a7 !important;
  --metadata-label-text-color-hover: #a7a7a7 !important;
  ...
  --nav-collapse-icon-color: #7c7c7c !important;
  --nav-collapse-icon-color-collapsed: #7c7c7c !important;
  --nav-heading-color: #c5c5c5 !important;
  --nav-heading-color-collapsed: #7c7c7c !important;
  --nav-heading-color-collapsed-hover: #a7a7a7 !important;
  --nav-heading-color-hover: #c5c5c5 !important;
  ...
  --nav-item-color: #a7a7a7 !important;
  --nav-item-color-active: #c5c5c5 !important;
  --nav-item-color-highlighted: hsl(0, 92%, 62%) !important;
  --nav-item-color-hover: #c5c5c5 !important;
  --nav-item-color-selected: #c5c5c5 !important;
  --nav-item-radius: 0px !important;
  --nav-item-size: 14px !important;
  --nav-tag-color: #7c7c7c !important;
  --nav-tag-color-active: #a7a7a7 !important;
  --nav-tag-color-hover: #a7a7a7 !important;
  --nav-tag-radius: 0px !important;
  --o-h1-color: #ffffff !important;
  --o-h2-color: #ffffff !important;
  --o-h3-color: #ffffff !important;
  --o-h4-color: #ffffff !important;
  --o-h5-color: #ffffff !important;
  --o-h6-color: #ffffff !important;
  ...
  --pill-color: #a7a7a7 !important;
  --pill-color-hover: #c5c5c5 !important;
  --pill-color-remove: #7c7c7c !important;
  ...
  --ribbon-background: #424242 !important;
  ...
  --search-clear-button-color: #a7a7a7 !important;
  --search-icon-color: #a7a7a7 !important;
  --search-result-background: #000000 !important;
  --secondary: hsl(0, 92%, 62%) !important;
  --setting-group-heading-color: #c5c5c5 !important;
  ...
  --shiki-active-tab-border-color: #a7a7a7 !important;
  --shiki-code-background: #000000 !important;
  --shiki-code-block-border-radius: 0px !important;
  --shiki-code-comment: #7c7c7c !important;
  --shiki-code-function: #B5E48C !important;
  --shiki-code-important: #F4A261 !important;
  --shiki-code-keyword: #E5989B !important;
  --shiki-code-normal: #a7a7a7 !important;
  --shiki-code-property: #64DFDF !important;
  --shiki-code-punctuation: #a7a7a7 !important;
  --shiki-code-string: #E9C46A !important;
  --shiki-code-value: #A06CD5 !important;
  --shiki-gutter-border-color: #ffffff !important;
  --shiki-gutter-text-color: #7c7c7c !important;
  --shiki-gutter-text-color-highlight: #a7a7a7 !important;
  --shiki-highlight-green: rgba(181, 228, 140, 0.5) !important;
  --shiki-highlight-green-background: rgba(181, 228, 140, 0.1) !important;
  --shiki-highlight-neutral: #a7a7a7 !important;
  --shiki-highlight-red: rgba(231, 111, 81, 0.5) !important;
  --shiki-highlight-red-background: rgba(231, 111, 81, 0.1) !important;
  --shiki-terminal-dots-color: #7c7c7c !important;
  --slider-thumb-border-color: #383838 !important;
  --slider-thumb-radius: 50% !important;
  --slider-track-background: #ffffff !important;
  --status-bar-background: #424242 !important;
  --status-bar-border-color: #ffffff !important;
  --status-bar-radius: 0px 0 0 0 !important;
  --status-bar-scroll-padding: 30px !important;
  --status-bar-text-color: #a7a7a7 !important;
  ...
  --tab-container-background: #424242 !important;
  ...
  --tab-switcher-background: #424242 !important;
  --tab-switcher-menubar-background: linear-gradient(to top, #424242, transparent) !important;
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(0, 92%, 62%) !important;
  --tab-text-color: #7c7c7c !important;
  --tab-text-color-active: #a7a7a7 !important;
  --tab-text-color-focused: #a7a7a7 !important;
  --tab-text-color-focused-active: #a7a7a7 !important;
  --tab-text-color-focused-active-current: #c5c5c5 !important;
  ...
  --text-faint: #7c7c7c !important;
  --text-muted: #a7a7a7 !important;
  --text-normal: #c5c5c5 !important;
  ...
  --titlebar-background: #424242 !important;
  --titlebar-background-focused: transparent !important;
  --titlebar-border-color: #ffffff !important;
  --titlebar-text-color: #a7a7a7 !important;
  --titlebar-text-color-focused: #c5c5c5 !important;
  ...
  --vault-name-color: #c5c5c5 !important;
  --vault-name-font-size: 14px !important;
  --vault-name-font-weight: 500 !important;
  --vault-profile-color: #c5c5c5 !important;
  --vault-profile-color-hover: #c5c5c5 !important;
...
html body .breadcrumb-element p {
  ...
  box-shadow: rgb(197, 197, 197) 0px 0px 0px 4px;
}
