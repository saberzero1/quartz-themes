...
export const theme: ThemeData = {
  ...
  --accent-l: 62%;
  --accent-s: 92%;
  --ancestor-editor-color: #c5c5c5;
  --aside-background: transparent;
  --aside-background-hover: rgba(255, 255, 255, 0.075);
  --aside-border-color: #ffffff;
  --aside-text-color: #a7a7a7;
  --background-modifier-active-hover: hsla(0, 92%, 62%, 0.15);
  --background-modifier-border: #ffffff;
  --background-modifier-border-focus: #292929;
  --background-modifier-border-hover: #383838;
  --background-modifier-error: #E76F51;
  --background-modifier-error-hover: #E76F51;
  --background-modifier-error-rgb: 231, 111, 81;
  --background-modifier-form-field: #666666;
  --background-modifier-form-field-hover: #666666;
  --background-modifier-hover: rgba(255, 255, 255, 0.075);
  --background-modifier-success: #B5E48C;
  --background-modifier-success-rgb: 181, 228, 140;
  --background-primary: #000000;
  --background-primary-alt: #000000;
  --background-primary-pre-alt: #000000;
  ...
  --bases-group-heading-property-color: #a7a7a7;
  ...
  --bases-table-cell-shadow-active: 0 0 0 2px #292929;
  ...
  --bases-table-header-color: #a7a7a7;
  ...
  --bb-border-alt: 1px solid #666666;
  --bb-border-dashed: 1px dashed #ffffff;
  --bb-border-high-contrast: 1px solid #a7a7a7;
  ...
  --canvas-card-label-color: #7c7c7c;
  --canvas-color: 114, 114, 114;
  --canvas-color-1: 231, 111, 81;
  --canvas-color-2: 244, 162, 97;
  --canvas-color-3: 233, 196, 106;
  --canvas-color-4: 181, 228, 140;
  --canvas-color-5: 100, 223, 223;
  --canvas-color-6: 160, 108, 213;
  --canvas-controls-radius: 0px;
  --canvas-dot-pattern: #7c7c7c;
  --caret-color: #c5c5c5;
  --checkbox-border-color: #7c7c7c;
  --checkbox-border-color-hover: #a7a7a7;
  --checkbox-color: hsl(0, 92%, 62%);
  --checkbox-color-hover: hsl(-3, 93.84%, 71.3%);
  --checkbox-marker-color: #000000;
  --checkbox-radius: 0px;
  --checklist-done-color: #a7a7a7;
  --clickable-icon-radius: 0px;
  --code-background: #000000;
  --code-border-color: #ffffff;
  --code-bracket-background: rgba(255, 255, 255, 0.075);
  --code-comment: #7c7c7c;
  --code-function: #E9C46A;
  --code-important: #F4A261;
  --code-keyword: #E5989B;
  --code-normal: #a7a7a7;
  --code-operator: #E76F51;
  --code-property: #64DFDF;
  --code-punctuation: #a7a7a7;
  --code-radius: 0px;
  --code-string: #B5E48C;
  --code-tag: #E76F51;
  --code-value: #A06CD5;
  --codeFont: var(--font-monospace, "Monaspace", monospace);
  --collapse-icon-color: #7c7c7c;
  ...
  --dark: var(--text-normal, #c5c5c5);
  --darkgray: var(--text-normal, #c5c5c5);
  ...
  --footnote-id-color: #a7a7a7;
  --footnote-id-color-no-occurrences: #7c7c7c;
  --footnote-input-background-active: rgba(255, 255, 255, 0.075);
  --footnote-radius: 0px;
  --graph-line: #383838;
  --graph-node: #a7a7a7;
  --graph-node-attachment: hsl(-3, 93.84%, 71.3%);
  --graph-node-focused: #292929;
  --graph-node-tag: hsl(0, 92%, 62%);
  --graph-node-unresolved: #7c7c7c;
  --graph-text: #c5c5c5;
  --gray: var(--text-muted, #a7a7a7);
  --h1-color: #ffffff;
  --h1-size: 3.5em;
  --h1-weight: 900;
  --h2-size: 1.842em;
  ...
  --lightgray: var(--background-secondary, #424242);
  ...
  --list-indent: 2.25em;
  --list-marker-color: #7c7c7c;
  --list-marker-color-collapsed: hsl(0, 92%, 62%);
  --list-marker-color-hover: #a7a7a7;
  ...
  --metadata-input-text-color: #c5c5c5;
  ...
  --metadata-label-text-color: #a7a7a7;
  --metadata-label-text-color-hover: #a7a7a7;
  --metadata-property-background-active: rgba(255, 255, 255, 0.075);
  --metadata-property-box-shadow-focus: 0 0 0 2px #292929;
  ...
  --modal-radius: 0px;
  --nav-collapse-icon-color: #7c7c7c;
  --nav-collapse-icon-color-collapsed: #7c7c7c;
  --nav-heading-color: #c5c5c5;
  --nav-heading-color-collapsed: #7c7c7c;
  --nav-heading-color-collapsed-hover: #a7a7a7;
  --nav-heading-color-hover: #c5c5c5;
  ...
  --nav-item-color: #a7a7a7;
  --nav-item-color-active: #c5c5c5;
  --nav-item-color-highlighted: hsl(0, 92%, 62%);
  --nav-item-color-hover: #c5c5c5;
  --nav-item-color-selected: #c5c5c5;
  --nav-item-radius: 0px;
  --nav-item-size: 14px;
  --nav-tag-color: #7c7c7c;
  --nav-tag-color-active: #a7a7a7;
  --nav-tag-color-hover: #a7a7a7;
  --nav-tag-radius: 0px;
  --o-h1-color: #ffffff;
  --o-h2-color: #ffffff;
  --o-h3-color: #ffffff;
  ...
  --shiki-active-tab-border-color: #a7a7a7;
  --shiki-code-background: #000000;
  --shiki-code-block-border-radius: 0px;
  --shiki-code-comment: #7c7c7c;
  --shiki-code-function: #B5E48C;
  --shiki-code-important: #F4A261;
  --shiki-code-keyword: #E5989B;
  --shiki-code-normal: #a7a7a7;
  --shiki-code-property: #64DFDF;
  --shiki-code-punctuation: #a7a7a7;
  --shiki-code-string: #E9C46A;
  --shiki-code-value: #A06CD5;
  --shiki-gutter-border-color: #ffffff;
  --shiki-gutter-text-color: #7c7c7c;
  --shiki-gutter-text-color-highlight: #a7a7a7;
  --shiki-highlight-green: rgba(181, 228, 140, 0.5);
  --shiki-highlight-green-background: rgba(181, 228, 140, 0.1);
  --shiki-highlight-neutral: #a7a7a7;
  --shiki-highlight-red: rgba(231, 111, 81, 0.5);
  --shiki-highlight-red-background: rgba(231, 111, 81, 0.1);
  --shiki-terminal-dots-color: #7c7c7c;
  --slider-thumb-border-color: #383838;
  --slider-thumb-radius: 50%;
  --slider-track-background: #ffffff;
  --status-bar-background: #424242;
  --status-bar-border-color: #ffffff;
  --status-bar-radius: 0px 0 0 0;
  --status-bar-scroll-padding: 30px;
  --status-bar-text-color: #a7a7a7;
  --suggestion-background: #000000;
  --swatch-height: 24px;
  --swatch-width: 24px;
  --sync-avatar-color-1: #E76F51;
  --sync-avatar-color-2: #F4A261;
  --sync-avatar-color-3: #E9C46A;
  --sync-avatar-color-4: #B5E48C;
  --sync-avatar-color-5: #64DFDF;
  --sync-avatar-color-6: #00A6FB;
  --sync-avatar-color-7: #A06CD5;
  --sync-avatar-color-8: #E5989B;
  --tab-background-active: #000000;
  --tab-container-background: #424242;
  --tab-divider-color: #383838;
  --tab-font-size: 14px;
  --tab-outline-color: #ffffff;
  --tab-radius: 0px;
  --tab-stacked-font-size: 14px;
  --tab-switcher-background: #424242;
  --tab-switcher-menubar-background: linear-gradient(to top, #424242, transparent);
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(0, 92%, 62%);
  --tab-text-color: #7c7c7c;
  --tab-text-color-active: #a7a7a7;
  --tab-text-color-focused: #a7a7a7;
  --tab-text-color-focused-active: #a7a7a7;
  --tab-text-color-focused-active-current: #c5c5c5;
  ...
  --titlebar-background: #424242;
  --titlebar-background-focused: transparent;
  --titlebar-border-color: #ffffff;
  --titlebar-text-color: #a7a7a7;
  --titlebar-text-color-focused: #c5c5c5;
  ...
  --transition-props: background 700ms, 
                        border 700ms, 
                        color 700ms;
  --vault-name-color: #c5c5c5;
  --vault-name-font-size: 14px;
  --vault-name-font-weight: 500;
  --vault-profile-color: #c5c5c5;
  --vault-profile-color-hover: #c5c5c5;
