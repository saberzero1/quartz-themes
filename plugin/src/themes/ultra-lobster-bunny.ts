...
export const theme: ThemeData = {
  ...
  --ancestor-editor-color: var(
        --text-normal
    , #e3d8d1);
  --background-modifier-border: var(--color-base-30, #362922);
  --background-modifier-border-alt: #42322a;
  --background-modifier-border-focus: var(--color-base-40, #d68d54);
  --background-modifier-border-hover: var(--color-base-35, #c29f8c);
  --background-modifier-form-field: var(--color-base-25, #42322a);
  --background-modifier-form-field-hover: var(--background-modifier-form-field, #42322a);
  --background-primary: var(--color-base-00, #3b2c24);
  --background-primary-alt: var(--color-base-10, #30241d);
  --background-secondary: var(--color-base-20, #30241d);
  --background-secondary-alt: var(--color-base-30, #362922);
  --bases-cards-background: var(--background-primary, #3b2c24);
  --bases-cards-cover-background: var(--background-primary-alt, #30241d);
  --bases-embed-border-color: var(--background-modifier-border, #362922);
  --bases-group-heading-property-color: var(--text-muted, #a3897a);
  --bases-table-border-color: var(--table-border-color, #362922);
  --bases-table-cell-background-active: var(--background-primary, #3b2c24);
  --bases-table-cell-background-disabled: var(--background-primary-alt, #30241d);
  --bases-table-cell-background-selected: var(--table-selection, hsla(212, 100%, 50%, 0.1));
  --bases-table-group-background: var(--background-primary-alt, #30241d);
  --bases-table-header-background: var(--background-primary, #3b2c24);
  --bases-table-header-background-hover: var(--background-modifier-hover, rgba(#ffffff, 0.067));
  --bases-table-header-color: var(--text-muted, #a3897a);
  --bases-table-summary-background: var(--background-primary, #3b2c24);
  ...
  --canvas-background: var(--background-primary, #3b2c24);
  --canvas-card-label-color: var(--text-faint, #d68d54);
  --canvas-color: var(--background-modifier-border, #362922);
  --canvas-dot-pattern: var(--color-base-30, #362922);
  --caret-color: var(--text-normal, #e3d8d1);
  --checkbox-border-color: var(--text-faint, #d68d54);
  --checkbox-border-color-hover: var(--text-muted, #a3897a);
  --checkbox-color: var(--interactive-accent, hsl(212, 100%, 50%));
  --checkbox-color-hover: var(--interactive-accent-hover, #fa99cd);
  --checkbox-marker-color: var(--background-primary, #3b2c24);
  --checklist-done-color: var(--text-muted, #a3897a);
  --code-background: var(--background-primary-alt, #30241d);
  --code-border-color: var(--background-modifier-border, #362922);
  --code-bracket-background: var(--background-modifier-hover, rgba(#ffffff, 0.067));
  --code-comment: var(--text-faint, #d68d54);
  --code-normal: var(--text-normal, #e3d8d1);
  --code-punctuation: var(--text-muted, #a3897a);
  --collapse-icon-color: var(--text-faint, #d68d54);
  ...
  --color-base-00: var(--proxy-00, #3b2c24);
  --color-base-10: var(--proxy-10, #30241d);
  --color-base-100: #ffffff;
  --color-base-20: var(--proxy-20, #30241d);
  ...
  --dark: var(--text-normal, var(--color-base-70, #e3d8d1));
  --darkgray: var(--text-normal, var(--color-base-70, #e3d8d1));
  --divider-color: var(--background-modifier-border, #362922);
  --divider-color-hover: var(--interactive-accent, hsl(212, 100%, 50%));
  --dropdown-background: var(--interactive-normal, #30241d);
  --dropdown-background-hover: var(--interactive-hover, #c29f8c);
  --file-header-background: var(--background-primary, #3b2c24);
  --file-header-background-focused: var(--background-primary, #3b2c24);
  ...
  --flair-background: var(--interactive-normal, #30241d);
  --flair-color: var(--text-normal, #e3d8d1);
  ...
  --footnote-divider-color: var(--metadata-divider-color, #362922);
  --footnote-id-color: var(--text-muted, #a3897a);
  --footnote-id-color-no-occurrences: var(--text-faint, #d68d54);
  ...
  --graph-node: var(--text-muted, #a3897a);
  --graph-node-focused: var(--color-accent, hsl(212, 100%, 50%));
  --graph-node-tag: var(--color-accent, hsl(212, 100%, 50%));
  --graph-node-unresolved: var(--text-faint, #d68d54);
  --graph-text: var(--text-normal, #e3d8d1);
  --gray: var(--text-muted, var(--color-base-50, #a3897a));
  ...
  --heading-formatting: var(--text-faint, #d68d54);
  --hr-color: var(--background-modifier-border, #362922);
  --icon-color: var(--text-muted, #a3897a);
  --icon-color-active: var(--color-accent, hsl(212, 100%, 50%));
  --icon-color-focused: var(--text-normal, #e3d8d1);
  --icon-color-hover: var(--text-muted, #a3897a);
  --inline-title-color: var(--color-base-100, #ffffff);
  ...
  --input-date-separator: var(--text-faint, #d68d54);
  --input-placeholder-color: var(--text-faint, #d68d54);
  ...
  --interactive-hover: var(--color-base-35, #c29f8c);
  --interactive-normal: var(--color-base-20, #30241d);
  --lbs: 0px 20px 30px rgba(0, 0, 5, 0.15);
  --light: var(--background-primary, var(--color-base-00, #3b2c24));
  --lightgray: var(--background-secondary, var(--color-base-20, #30241d));
  --line-height-normal: 1.65;
  --link-color: var(--text-muted, #a3897a);
  --link-color-hover: var(--text-normal, #e3d8d1);
  ...
  --link-unresolved-color: var(--text-muted, #a3897a);
  --list-marker-color: var(--text-faint, #d68d54);
  --list-marker-color-collapsed: var(--color-accent, hsl(212, 100%, 50%));
  --list-marker-color-hover: var(--text-muted, #a3897a);
  --menu-background: var(--background-secondary, #30241d);
  --menu-border-color: var(--background-modifier-border-hover, #c29f8c);
  --menu-shadow: var(--shadow-s, 0px 1px 4px rgba(0, 0, 0, 0.16));
  --metadata-border-color: var(--background-modifier-border, #362922);
  --metadata-divider-color: var(--background-modifier-border, #362922);
  ...
  --metadata-input-text-color: var(--text-normal, #e3d8d1);
  ...
  --metadata-label-text-color: var(--text-muted, #a3897a);
  --metadata-label-text-color-hover: var(--text-muted, #a3897a);
  --metadata-property-background-active: var(--background-modifier-hover, rgba(#ffffff, 0.067));
  --modal-background: var(--background-primary, #3b2c24);
  --mono-rgb-0: #211915;
  --mono-rgb-100: #ffffff;
  --nav-collapse-icon-color: var(--collapse-icon-color, #d68d54);
  --nav-collapse-icon-color-collapsed: var(--text-faint, #d68d54);
  --nav-heading-color: var(--text-normal, #e3d8d1);
  --nav-heading-color-collapsed: var(--text-faint, #d68d54);
  --nav-heading-color-collapsed-hover: var(--text-muted, #a3897a);
  --nav-heading-color-hover: var(--text-normal, #e3d8d1);
  ...
  --nav-item-color: var(--text-muted, #a3897a);
  --nav-item-color-active: var(--text-normal, #e3d8d1);
  --nav-item-color-highlighted: var(--color-accent-hover, hsl(
        26 calc(50% + 180) 55%
    ));
  --nav-item-color-hover: var(--text-normal, #e3d8d1);
  --nav-item-color-selected: var(--text-normal, #e3d8d1);
  --nav-tag-color: var(--text-faint, #d68d54);
  --nav-tag-color-active: var(--text-muted, #a3897a);
  --nav-tag-color-hover: var(--text-muted, #a3897a);
  --pdf-background: var(--background-primary, #3b2c24);
  --pdf-page-background: var(--background-primary, #3b2c24);
  --pdf-sidebar-background: var(--background-primary, #3b2c24);
  --pill-border-color: var(--background-modifier-border, #362922);
  --pill-border-color-hover: var(--background-modifier-border-hover, #c29f8c);
  --pill-color: var(--text-muted, #a3897a);
  --pill-color-hover: var(--text-normal, #e3d8d1);
  --pill-color-remove: var(--text-faint, #d68d54);
  --pill-color-remove-hover: var(--text-accent, hsl(212, 100%, 50%));
  --prompt-background: var(--background-primary, #3b2c24);
  --proxy-00: #3b2c24;
  --proxy-10: #30241d;
  --proxy-20: #30241d;
  --radius-xl: 24px;
  --raised-background: var(--blur-background, color-mix(in srgb, #30241d 65%, transparent) linear-gradient(#30241d, color-mix(in srgb, #30241d 65%, transparent)));
  --ribbon-background: var(--background-secondary, #30241d);
  --ribbon-background-collapsed: var(--background-primary, #3b2c24);
  ...
  --search-clear-button-color: var(--text-muted, #a3897a);
  --search-icon-color: var(--text-muted, #a3897a);
  --search-result-background: var(--background-primary, #3b2c24);
  --secondary: var(--text-accent, var(--color-accent, hsl(212, 100%, 50%)));
  --setting-group-heading-color: var(--text-normal, #e3d8d1);
  --setting-items-background: var(--background-primary-alt, #30241d);
  --setting-items-border-color: var(--background-modifier-border, #362922);
  --shadow-l: 0px 8px 24px rgba(0, 0, 0, 0.2);
  --shadow-lm-only: none;
  --shadow-s: 0px 1px 4px rgba(0, 0, 0, 0.16);
  --shiki-active-tab-border-color: var(--shiki-highlight-neutral, #a3897a);
  --shiki-code-background: var(--code-background, #30241d);
  --shiki-code-comment: var(--text-faint, #d68d54);
  --shiki-code-normal: var(--text-muted, #a3897a);
  --shiki-code-punctuation: var(--text-muted, #a3897a);
  --shiki-gutter-border-color: var(--background-modifier-border, #362922);
  --shiki-gutter-text-color: var(--text-faint, #d68d54);
  --shiki-gutter-text-color-highlight: var(--shiki-code-normal, #a3897a);
  --shiki-highlight-neutral: var(--shiki-code-normal, #a3897a);
  --shiki-terminal-dots-color: var(--text-faint, #d68d54);
  --slider-thumb-border-color: var(--background-modifier-border-hover, #c29f8c);
  --slider-track-background: var(--background-modifier-border, #362922);
  --status-bar-background: var(--background-secondary, #30241d);
  --status-bar-border-color: var(--divider-color, #362922);
  --status-bar-text-color: var(--text-muted, #a3897a);
  --suggestion-background: var(--background-primary, #3b2c24);
  --tab-background-active: var(--background-primary, #3b2c24);
  --tab-container-background: var(--background-secondary, #30241d);
  --tab-divider-color: var(--background-modifier-border-hover, #c29f8c);
  --tab-outline-color: var(--divider-color, #362922);
  --tab-switcher-background: var(--background-secondary, #30241d);
  --tab-switcher-preview-radius: var(--radius-xl, 24px);
  --tab-text-color: var(--text-faint, #d68d54);
  --tab-text-color-active: var(--text-muted, #a3897a);
  --tab-text-color-focused: var(--text-muted, #a3897a);
  --tab-text-color-focused-active: var(--text-muted, #a3897a);
  --tab-text-color-focused-active-current: var(--text-normal, #e3d8d1);
  --tab-text-color-focused-highlighted: var(--color-accent, hsl(212, 100%, 50%));
  --table-add-button-border-color: var(--background-modifier-border, #362922);
  --table-border-color: var(--background-modifier-border, #362922);
  --table-drag-handle-background-active: var(--table-selection-border-color, hsl(212, 100%, 50%));
  --table-drag-handle-color: var(--text-faint, #d68d54);
  --table-header-border-color: var(--table-border-color, #362922);
  --table-header-color: var(--text-normal, #e3d8d1);
  ...
  --text-faint: var(--color-base-60, #d68d54);
  --text-highlight-bg-active: rgba(255, 128, 0, 0.4);
  --text-muted: var(--color-base-50, #a3897a);
  --text-normal: var(--color-base-70, #e3d8d1);
  ...
  --titlebar-border-color: var(--background-modifier-border, #362922);
  --titlebar-text-color: var(--text-muted, #a3897a);
  --titlebar-text-color-focused: var(--text-normal, #e3d8d1);
  ...
  --vault-profile-color: var(--text-normal, #e3d8d1);
  --vault-profile-color-hover: var(--vault-profile-color, #e3d8d1);
...
html body[data-slug] div#quartz-root.page, html .page > div#quartz-body div.sidebar.left, html .page > div#quartz-body div.sidebar.left:has(.explorer), html .page > div#quartz-body div.sidebar.left .explorer .explorer-content {
  --bases-table-header-background: var(--background-secondary, #30241d);
...
html body .page > div#quartz-body div.sidebar.right {
  ...
  color: var(--text-normal, rgb(227, 216, 209));
  ...
  outline: rgb(227, 216, 209) none 0px;
  text-decoration-color: rgb(227, 216, 209);
}
...
html body p {
  color: var(--text-muted, rgb(163, 137, 122));
  font-family: "??", Instrument, sans-serif, "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  outline: rgb(163, 137, 122) none 0px;
  text-decoration-color: rgb(163, 137, 122);
}`,
...
html body a.internal-link.broken {
  ...
  color: var(--text-faint, rgb(214, 141, 84));
  font-family: "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  font-weight: var(--link-weight, 500);
  outline: rgb(214, 141, 84) none 0px;
  text-decoration-color: var(--link-unresolved-decoration-color, rgb(214, 141, 84));
  transition: 0.2s cubic-bezier(0.25, 0.8, 0.25, 1);
}`,
    lists: `html body dd {
  border-bottom-color: rgb(227, 216, 209);
  border-bottom-width: 0px;
  border-left-color: rgb(227, 216, 209);
  border-left-width: 0px;
  border-right-color: rgb(227, 216, 209);
  border-right-width: 0px;
  border-top-color: rgb(227, 216, 209);
...
html body blockquote {
  ...
  color: var(--blockquote-color, rgb(227, 216, 209));
  font-family: "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  line-height: 26.4px;
  padding-bottom: 16px;
  padding-left: 0px;
...
html body th {
  border-bottom-color: rgb(163, 137, 122);
  border-bottom-width: 0px;
  border-left-color: rgb(163, 137, 122);
  border-left-width: var(--table-column-first-border-width, 0px);
  border-right-color: rgb(163, 137, 122);
  border-right-width: 0px;
  border-top-color: rgb(163, 137, 122);
...
html body tr {
  ...
  border-top-width: 0px;
  color: var(--ec-codeFg, rgb(163, 137, 122));
...
html body pre:has(> code) {
  background-color: var(--code-background, rgb(48, 36, 29));
  border-bottom-color: rgba(0, 0, 0, 0);
  border-bottom-width: 0px;
  border-left-color: rgba(0, 0, 0, 0);
  border-left-width: 0px;
...
html body figure {
  --code-background: var(--ec-frm-edBg, #30241d);
  border-bottom-color: rgb(227, 216, 209);
  border-bottom-width: 0px;
  border-left-color: rgb(227, 216, 209);
  border-left-width: 0px;
...
html body video {
  ...
  border-bottom-color: rgb(54, 41, 34);
  border-bottom-left-radius: 12px;
  border-bottom-right-radius: 12px;
  border-bottom-style: solid;
  border-bottom-width: 1px;
  border-left-color: rgb(54, 41, 34);
  border-left-style: solid;
  border-left-width: 1px;
  border-radius: 12px;
  border-right-color: rgb(54, 41, 34);
  border-right-style: solid;
  border-right-width: 1px;
  border-top-color: rgb(54, 41, 34);
...
html body .callout-title {
  --ancestor-editor-color: #e3d8d1;
  --background-modifier-active-hover: hsla(212, 100%, 50%, 0.1);
  --background-modifier-border: #362922;
  --background-modifier-border-focus: #d68d54;
  --background-modifier-border-hover: #c29f8c;
  --background-modifier-error: #fb464c;
  --background-modifier-error-hover: #fb464c;
  --background-modifier-error-rgb: 251, 70, 76;
  --background-modifier-form-field: #42322a;
  --background-modifier-form-field-hover: #42322a;
  --background-modifier-hover: rgba(#ffffff, 0.067);
  --background-modifier-success: #44cf6e;
  --background-modifier-success-rgb: 68, 207, 110;
  --background-primary: #3b2c24;
  --background-primary-alt: #30241d;
  --background-secondary: #30241d;
  --background-secondary-alt: #362922;
  --blockquote-border-color: hsl(212, 100%, 50%);
  --blur-background: color-mix(in srgb, #30241d 65%, transparent) linear-gradient(#30241d, color-mix(in srgb, #30241d 65%, transparent));
  ...
  --canvas-background: #3b2c24;
  --canvas-controls-icon-size: 16px;
  --canvas-controls-icon-stroke: 2px;
  --canvas-controls-radius: 4px;
  --canvas-dot-pattern: #362922;
  --caret-color: #e3d8d1;
  --checkbox-border-color: #d68d54;
  --checkbox-border-color-hover: #a3897a;
  --checkbox-color: hsl(212, 100%, 50%);
  --checkbox-color-hover: #fa99cd;
  --checkbox-marker-color: #3b2c24;
  --checkbox-radius: 4px;
  --checkbox-size: 16px;
  --checklist-done-color: #a3897a;
  --clickable-icon-radius: 4px;
  --code-background: #30241d;
  --code-border-color: #362922;
  ...
  --code-punctuation: #a3897a;
  --code-radius: 4px;
  --code-size: 0.875em;
  --code-string: #44cf6e;
  --code-tag: #fb464c;
  --code-value: #a882ff;
  --collapse-icon-color: #d68d54;
  ...
  --color-base-00: #3b2c24;
  --color-base-10: #30241d;
  --color-base-20: #30241d;
  --divider-color: #362922;
  --divider-color-hover: hsl(212, 100%, 50%);
  --divider-vertical-height: 100%;
  --dropdown-background: #30241d;
  --dropdown-background-hover: #c29f8c;
  --dropdown-background-position: right 0.5em top 50%, 0 0;
  --dropdown-background-size: 1em auto, 100%;
  --dropdown-padding: 0 1.9em 0 0.8em;
  --flair-background: #30241d;
  --flair-color: #e3d8d1;
  ...
  --h6-line-height: 1.65;
  --heading-formatting: #d68d54;
  --heading-spacing: 2.5rem;
  --hr-color: #362922;
  --interactive-accent: hsl(212, 100%, 50%);
  --interactive-accent-hover: #fa99cd;
  --interactive-accent-hsl: 212, 100%, 50%;
  --interactive-hover: #c29f8c;
  --interactive-normal: #30241d;
  --link-color: #a3897a;
  --link-color-hover: #e3d8d1;
  --link-external-color: hsl(212, 100%, 50%);
  --link-external-color-hover: hsl(
        26 calc(50% + 180) 55%
    );
  --link-unresolved-color: #a3897a;
  --link-unresolved-decoration-color: transparent;
  --link-weight: 400;
  --list-indent: 2.25em;
  --menu-background: #30241d;
  --menu-border-color: #c29f8c;
  --menu-border-width: 1px;
  --menu-corner-shape: round;
  --menu-padding: 6px;
  --menu-radius: 8px;
  --menu-shadow: 0px 1px 4px rgba(0, 0, 0, 0.16);
  --pdf-background: #3b2c24;
  --pdf-page-background: #3b2c24;
  --pdf-shadow: 0 0 0 1px #362922;
  --pdf-sidebar-background: #3b2c24;
  --pdf-thumbnail-shadow: 0 0 0 1px #362922;
  --popover-font-size: 16px;
  --raised-background: color-mix(in srgb, #30241d 65%, transparent) linear-gradient(#30241d, color-mix(in srgb, #30241d 65%, transparent));
  ...
  --search-clear-button-color: #a3897a;
  --search-icon-color: #a3897a;
  --search-result-background: #3b2c24;
  --setting-group-heading-color: #e3d8d1;
  --setting-group-heading-size: 15px;
  --setting-group-heading-weight: 600;
  --setting-items-background: #30241d;
  --setting-items-border-color: #362922;
  --setting-items-padding: 20px;
  --setting-items-radius: 12px;
  --shiki-active-tab-border-color: #a3897a;
  --shiki-code-background: #30241d;
  --shiki-code-block-border-radius: 4px;
  --shiki-code-block-spacing: 1rem;
  --shiki-code-comment: #d68d54;
  --shiki-code-function: #44cf6e;
  --shiki-code-important: #e9973f;
  --shiki-code-keyword: #fa99cd;
  --shiki-code-normal: #a3897a;
  --shiki-code-property: #53dfdd;
  --shiki-code-punctuation: #a3897a;
  --shiki-code-string: #e0de71;
  --shiki-code-value: #a882ff;
  --shiki-gutter-border-color: #362922;
  --shiki-gutter-border-width: 1px;
  --shiki-gutter-text-color: #d68d54;
  --shiki-gutter-text-color-highlight: #a3897a;
  --shiki-highlight-green: rgba(68, 207, 110, 0.5);
  --shiki-highlight-green-background: rgba(68, 207, 110, 0.1);
  --shiki-highlight-neutral: #a3897a;
  ...
  --shiki-terminal-dots-color: #d68d54;
  --shiki-tooltip-background: rgba(0, 0, 0, 0.9);
  --suggestion-background: #3b2c24;
  ...
  --tab-background-active: #3b2c24;
  --tab-divider-color: #c29f8c;
  --tab-font-size: 13px;
  --tab-outline-color: #362922;
  --tab-radius: 4px;
  --tab-stacked-font-size: 13px;
  --tab-stacked-header-width: 40px;
  --tab-switcher-background: #30241d;
  --tab-switcher-menubar-background: linear-gradient(to top, #30241d, transparent);
  ...
  --tab-text-color: #d68d54;
  --tab-text-color-active: #a3897a;
  --tab-text-color-focused: #a3897a;
  --tab-text-color-focused-active: #a3897a;
  --tab-text-color-focused-active-current: #e3d8d1;
  --tab-text-color-focused-highlighted: hsl(212, 100%, 50%);
  --table-add-button-border-color: #362922;
  ...
  --table-drag-handle-color: #d68d54;
  --table-drag-handle-color-active: white;
  --table-header-background: transparent;
  --table-header-border-color: #362922;
  --table-header-border-width: 1px;
  --table-header-color: #e3d8d1;
...
html body .search > .search-container > .search-space {
  background-color: var(--prompt-background, rgb(59, 44, 36));
...
html body .search > .search-container > .search-space > .search-layout > .results-container > .result-card:hover, html .search > .search-container > .search-space > .search-layout > .results-container > .result-card:focus, html .search > .search-container > .search-space > .search-layout > .results-container > .result-card.focus:not(:has(~ .result-card:hover, html ~ .result-card:focus)) {
  background-color: var(--interactive-hover, rgb(194, 159, 140));
  color: rgb(227, 216, 209);
}
...
html body a.internal-link.tag-link, html .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  --pill-background: var(--tag-background, hsla(212, 100%, 50%, 0.1));
  --pill-background-hover: var(--tag-background-hover, hsla(212, 100%, 50%, 0.2));
  --pill-border-color: var(--tag-border-color, hsla(212, 100%, 50%, 0.15));
  --pill-border-color-hover: var(--tag-border-color-hover, hsla(212, 100%, 50%, 0.15));
  --pill-color: var(--tag-color, hsl(212, 100%, 50%));
  --pill-color-hover: var(--tag-color-hover, hsl(212, 100%, 50%));
  --pill-color-remove: var(--tag-color, hsl(212, 100%, 50%));
  --pill-color-remove-hover: var(--tag-color-hover, hsl(212, 100%, 50%));
...
html body .explorer .nav-files-container .folder-outer > ul {
  ...
  border-top-right-radius: 8px;
  border-top-width: 0px;
  color: var(--status-bar-text-color, rgb(163, 137, 122));
  font-family: "??", Instrument, sans-serif, "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
}
...
html body .breadcrumb-element p {
  ...
  --canvas-card-base: var(--color-blue-rgb, 2, 122, 255);
  border-color: rgb(227, 216, 209);
}
...
html body .note-properties-row {
  border-color: rgb(163, 137, 122) rgb(163, 137, 122) rgba(0, 0, 0, 0);
}
...
html body div#quartz-root {
  background-color: var(--background-primary, rgb(59, 44, 36));
  color: var(--text-normal, rgb(227, 216, 209));
}
...
html body input[type=text] {
  ...
  border-top-right-radius: 50px;
  border-top-width: 0px;
  color: var(--text-normal, rgb(163, 137, 122));
  font-family: "??", Instrument, sans-serif, "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  padding-bottom: 0px;
  padding-left: 28px;
  padding-right: 0px;
