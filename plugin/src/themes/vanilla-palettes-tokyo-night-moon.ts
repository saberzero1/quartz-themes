...
export const theme: ThemeData = {
  ...
  --accent: hsl(263, 100%, 80%);
  --accent-color-dark: #c099ff;
  --accent-color-hover: #fca7ea;
  --accent-color-light: #82aaff;
  --accent-h: 263;
  --accent-l: 80%;
  --accent-s: 100%;
  ...
  --background-modifier-error: #ff757f;
  --background-modifier-error-hover: #ff757f;
  --background-modifier-form-field: #1e2030;
  --background-modifier-form-field-hover: #1e2030;
  --background-modifier-hover: #2f334d;
  --background-modifier-success: #c3e88d;
  ...
  --bases-group-heading-property-color: #c8d3f5;
  --bases-table-border-color: #3b4261;
  --bases-table-cell-background-active: #222436;
  --bases-table-cell-background-selected: #2f334d;
  --bases-table-cell-shadow-active: 0 0 0 2px #3b4261;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(263, 100%, 80%);
  --bases-table-header-background: #222436;
  --bases-table-header-background-hover: #2f334d;
  --bases-table-header-color: #c8d3f5;
  --bases-table-summary-background: #222436;
  --bases-table-summary-background-hover: #2f334d;
  --bg: #222436;
  --bg-dark: #1e2030;
  --bg-highlight: #2f334d;
  --blockquote-border-color: #c099ff;
  --blue: #82aaff;
  --blue0: #3e68d7;
  --blue1: #65bcff;
  --blue2: #0db9d7;
  ...
  --blue6: #b4f9f8;
  --blue7: #394b70;
  --blur-background: color-mix(in srgb, #1e2030 65%, transparent) linear-gradient(#1e2030, color-mix(in srgb, #1e2030 65%, transparent));
  --bold-color: #82aaff;
  --border-color: #3b4261;
  --border-color-primary: #3b4261;
  --border-color-secondary: #3b4261;
  --canvas-background: #222436;
  --canvas-card-label-color: #828bb8;
  --canvas-color: 192, 153, 255;
  --caret-color: #c8d3f5;
  --checkbox-border-color: #828bb8;
  --checkbox-border-color-hover: #fca7ea;
  --checkbox-color: #c099ff;
  --checkbox-color-hover: #fca7ea;
  --checkbox-marker-color: #222436;
  --checklist-done-color: #828bb8;
  --code-background: #1e2030;
  --code-boolean: #ff966c;
  --code-border-color: #3b4261;
  --code-bracket-background: #2f334d;
  --code-builtin: #86e1fc;
  --code-comment: #636da6;
  --code-definition: #82aaff;
  --code-function: #ffc777;
  --code-important: #ffc777;
  --code-keyword: #fca7ea;
  --code-normal: #c8d3f5;
  --code-operator: #86e1fc;
  --code-parentheses: #828bb8;
  --code-property: #82aaff;
  --code-punctuation: #c8d3f5;
  --code-string: #c3e88d;
  --code-tag: #ff757f;
  --code-value: #ff966c;
  --code-variable: #c8d3f5;
  --collapse-icon-color: #828bb8;
  --collapse-icon-color-collapsed: hsl(263, 100%, 80%);
  --color-accent: hsl(263, 100%, 80%);
  --color-accent-1: hsl(260, 102%, 92%);
  --color-accent-2: hsl(258, 105%, 103.2%);
  --color-accent-hsl: 263, 100%, 80%;
  --color-blue: #82aaff;
  --color-cyan: #86e1fc;
  --color-green: #c3e88d;
  ...
  --divider-color-hover: hsl(263, 100%, 80%);
  ...
  --embed-border-start: 2px solid hsl(263, 100%, 80%);
  --fg: #c8d3f5;
  --fg-dark: #828bb8;
  --fg-gutter: #3b4261;
  --file-header-background: #222436;
  --file-header-background-focused: #222436;
  --flair-background: #1e2030;
  --flair-color: #c8d3f5;
  --footnote-divider-color: #3b4261;
  --footnote-id-color: #c8d3f5;
  --footnote-id-color-no-occurrences: #828bb8;
  --footnote-input-background-active: #2f334d;
  --graph-line: #3b4261;
  --graph-node: hsl(263, 100%, 80%);
  --graph-node-attachment: #c099ff;
  --graph-node-focused: #fca7ea;
  --graph-node-tag: #82aaff;
  --graph-node-unresolved: #3b4261;
  --graph-text: #c8d3f5;
  --gray: var(--text-muted, #c8d3f5);
  --green: #c3e88d;
  --green1: #4fd6be;
  --green2: #41a6b5;
  --h1-color: #fca7ea;
  ...
  --h5-color: #ff966c;
  --h6-color: #ff757f;
  --heading-formatting: #828bb8;
  --highlight: var(--text-highlight-bg, hsl(263, 100%, 80%));
  --hr-color: #3b4261;
  --icon-color: #c8d3f5;
  --icon-color-active: hsl(263, 100%, 80%);
  --icon-color-focused: #c8d3f5;
  --icon-color-hover: #c8d3f5;
  --indentation-guide-color: #3b4261;
  --indentation-guide-color-active: #828bb8;
  --inline-title-color: #c8d3f5;
  --input-date-separator: #828bb8;
  --input-placeholder-color: #828bb8;
  --interactive-accent: hsl(263, 100%, 80%);
  --interactive-accent-hover: hsl(260, 102%, 92%);
  --interactive-accent-hsl: 263, 100%, 80%;
  --interactive-hover: #3b4261;
  --interactive-normal: #1e2030;
  --italic-color: #82aaff;
  --light: var(--background-primary, #222436);
  --lightgray: var(--background-secondary, #1e2030);
  --link-color: #c099ff;
  --link-color-hover: #fca7ea;
  --link-external-color: #c099ff;
  --link-external-color-hover: #fca7ea;
  --link-unresolved-color: #ff757f;
  --link-unresolved-color-hover: #ff757f;
  --link-unresolved-decoration-color: hsla(263, 100%, 80%, 0.3);
  --list-marker-color: #c099ff;
  --list-marker-color-collapsed: hsl(263, 100%, 80%);
  --list-marker-color-hover: #c8d3f5;
  --magenta: #c099ff;
  --magenta2: #ff007c;
  ...
  --metadata-input-background-active: #2f334d;
  --metadata-input-text-color: #c8d3f5;
  --metadata-label-background-active: #2f334d;
  --metadata-label-text-color: #c8d3f5;
  --metadata-label-text-color-hover: #c8d3f5;
  --metadata-property-background-active: #2f334d;
  ...
  --nav-heading-color-collapsed: #828bb8;
  --nav-heading-color-collapsed-hover: #c8d3f5;
  --nav-heading-color-hover: #c8d3f5;
  --nav-indentation-guide-color: #3b4261;
  --nav-item-background-active: #c099ff;
  --nav-item-background-hover: #2f334d;
  --nav-item-background-selected: red;
  --nav-item-color: #c8d3f5;
  --nav-item-color-active: white;
  --nav-item-color-highlighted: #82aaff;
  --nav-item-color-hover: white;
  --nav-item-color-selected: red;
  --nav-tag-color: #828bb8;
  --nav-tag-color-active: #c8d3f5;
  --nav-tag-color-hover: #c8d3f5;
  --orange: #ff966c;
  ...
  --pill-color-remove: #828bb8;
  --pill-color-remove-hover: hsl(263, 100%, 80%);
  --prompt-background: #222436;
  --prompt-border-color: #3b4261;
  --purple: #fca7ea;
  --raised-background: color-mix(in srgb, #1e2030 65%, transparent) linear-gradient(#1e2030, color-mix(in srgb, #1e2030 65%, transparent));
  --red: #ff757f;
  --red1: #c53b53;
  --ribbon-background: #1e2030;
  --ribbon-background-collapsed: #222436;
  --search-clear-button-color: #c8d3f5;
  --search-icon-color: #c8d3f5;
  --search-result-background: #222436;
  --secondary: var(--text-accent, hsl(263, 100%, 80%));
  --selection-background-color: #2f334d;
  --selection-border-color: #fca7ea;
  --setting-group-heading-color: #c8d3f5;
  --setting-items-border-color: #3b4261;
  --shiki-active-tab-border-color: #c8d3f5;
  --shiki-code-background: #1e2030;
  --shiki-code-comment: #828bb8;
  --shiki-code-function: #c3e88d;
  --shiki-code-important: #ff966c;
  --shiki-code-keyword: pink;
  --shiki-code-normal: #c8d3f5;
  --shiki-code-property: #86e1fc;
  --shiki-code-punctuation: #c8d3f5;
  --shiki-code-string: #ffc777;
  --shiki-code-value: #fca7ea;
  --shiki-gutter-border-color: #3b4261;
  --shiki-gutter-text-color: #828bb8;
  --shiki-gutter-text-color-highlight: #c8d3f5;
  --shiki-highlight-neutral: #c8d3f5;
  --shiki-terminal-dots-color: #828bb8;
  --slider-track-background: #1e2030;
  --status-bar-background: #1e2030;
  --status-bar-border-color: #3b4261;
  --status-bar-text-color: #c8d3f5;
  --suggestion-background: #222436;
  --sync-avatar-color-1: #ff757f;
  --sync-avatar-color-2: #ff966c;
  --sync-avatar-color-3: #ffc777;
  --sync-avatar-color-4: #c3e88d;
  --sync-avatar-color-5: #86e1fc;
  --sync-avatar-color-6: #82aaff;
  --sync-avatar-color-7: #fca7ea;
  --sync-avatar-color-8: pink;
  --tab-background-active: #222436;
  --tab-container-background: #1e2030;
  --tab-divider-color: #2f334d;
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(263, 100%, 80%);
  --tab-text-color: #3b4261;
  --tab-text-color-active: #c8d3f5;
  --tab-text-color-focused: #c8d3f5;
  --tab-text-color-focused-active: #c8d3f5;
  ...
  --table-drag-handle-background-active: #fca7ea;
  --table-drag-handle-color: #2f334d;
  --table-drag-handle-color-active: #2f334d;
  --table-header-border-color: #3b4261;
  --table-header-color: #c8d3f5;
  --table-selection: #2f334d;
  --table-selection-border-color: #fca7ea;
  --tag-background: #3b4261;
  --tag-background-hover: #828bb8;
  --tag-border-color: hsla(263, 100%, 80%, 0.15);
  --tag-border-color-hover: hsla(263, 100%, 80%, 0.15);
  --tag-color: #c099ff;
  --tag-color-hover: #c099ff;
  --teal: #4fd6be;
  --terminal-black: #444a73;
  --tertiary: var(--text-accent-hover, red);
  --text-accent: hsl(263, 100%, 80%);
  --text-accent-hover: red;
  --text-color: #c8d3f5;
  --text-color-accent: white;
  --text-color-muted-dark: #3b4261;
  --text-color-muted-light: #828bb8;
  --text-error: #ff757f;
  --text-faint: #828bb8;
  --text-highlight-bg: hsl(263, 100%, 80%);
  --text-muted: #c8d3f5;
  --text-normal: #c8d3f5;
  --text-on-accent-inverted: #222436;
  --text-selection: #2f334d;
  --text-success: #c3e88d;
  --text-warning: #ffc777;
  --textHighlight: var(--text-highlight-bg, hsl(263, 100%, 80%));
  --titlebar-background: #1e2030;
  --titlebar-background-focused: #3b4261;
  --titlebar-border-color: #3b4261;
  --titlebar-text-color: #c8d3f5;
