...
export const theme: ThemeData = {
  ...
  --accent-color-dark: var(--magenta, #c099ff);
  --accent-color-hover: var(--purple, #fca7ea);
  --accent-color-light: var(--blue, #82aaff);
  --accent-h: 263;
  --accent-l: 80%;
  --accent-s: 100%;
  ...
  --background-modifier-error: var(--color-red, #ff757f);
  --background-modifier-error-hover: var(--color-red, #ff757f);
  --background-modifier-form-field: var(--background-secondary, #1e2030);
  --background-modifier-form-field-hover: var(--background-modifier-form-field, #1e2030);
  --background-modifier-hover: var(--selection-background-color, #2f334d);
  --background-modifier-success: var(--color-green, #c3e88d);
  --background-primary: var(--bg, #222436);
  --background-secondary: var(--bg-dark, #1e2030);
  --bases-cards-background: var(--background-primary, #222436);
  --bases-embed-border-color: var(--background-modifier-border, #3b4261);
  --bases-group-heading-property-color: var(--text-muted, #c8d3f5);
  --bases-table-border-color: var(--table-border-color, #3b4261);
  --bases-table-cell-background-active: var(--background-primary, #222436);
  --bases-table-cell-background-selected: var(--table-selection, #2f334d);
  --bases-table-header-background: var(--background-primary, #222436);
  --bases-table-header-background-hover: var(--background-modifier-hover, #2f334d);
  --bases-table-header-color: var(--text-muted, #c8d3f5);
  --bases-table-summary-background: var(--background-primary, #222436);
  --bases-table-summary-background-hover: var(--background-modifier-hover, #2f334d);
  --bg: #222436;
  --bg-dark: #1e2030;
  --bg-highlight: #2f334d;
  --blockquote-border-color: var(--accent-color-dark, #c099ff);
  --blue: #82aaff;
  --blue0: #3e68d7;
  --blue1: #65bcff;
  --blue2: #0db9d7;
  ...
  --blue6: #b4f9f8;
  --blue7: #394b70;
  --bold-color: var(--accent-color-light, #82aaff);
  ...
  --canvas-card-label-color: var(--text-faint, #828bb8);
  --canvas-color: 192, 153, 255;
  --caret-color: var(--text-normal, #c8d3f5);
  --checkbox-border-color: var(--text-color-muted-light, #828bb8);
  --checkbox-border-color-hover: var(--accent-color-hover, #fca7ea);
  --checkbox-color: var(--accent-color-dark, #c099ff);
  --checkbox-color-hover: var(--accent-color-hover, #fca7ea);
  --checkbox-marker-color: var(--background-primary, #222436);
  --checklist-done-color: var(--text-color-muted-light, #828bb8);
  --code-background: var(--background-secondary, #1e2030);
  --code-boolean: var(--orange, #ff966c);
  --code-border-color: var(--background-modifier-border, #3b4261);
  --code-bracket-background: var(--background-modifier-hover, #2f334d);
  --code-builtin: var(--color-cyan, #86e1fc);
  --code-comment: var(--comment, #636da6);
  --code-definition: var(--color-blue, #82aaff);
  --code-function: var(--color-yellow, #ffc777);
  --code-important: var(--color-yellow, #ffc777);
  --code-keyword: var(--color-purple, #fca7ea);
  --code-normal: var(--text-normal, #c8d3f5);
  --code-operator: var(--color-cyan, #86e1fc);
  --code-parentheses: var(--fg-dark, #828bb8);
  --code-property: var(--blue, #82aaff);
  --code-punctuation: var(--text-muted, #c8d3f5);
  --code-string: var(--color-green, #c3e88d);
  --code-tag: var(--color-red, #ff757f);
  --code-value: var(--color-orange, #ff966c);
  --code-variable: var(--fg, #c8d3f5);
  --collapse-icon-color: var(--text-faint, #828bb8);
  --collapse-icon-color-collapsed: var(--text-accent, hsl(263, 100%, 80%));
  --color-blue: var(--blue, #82aaff);
  --color-cyan: var(--cyan, #86e1fc);
  --color-green: var(--green, #c3e88d);
  --color-orange: var(--orange, #ff966c);
  --color-pink: pink;
  --color-purple: var(--purple, #fca7ea);
  --color-red: var(--red, #ff757f);
  --color-yellow: var(--yellow, #ffc777);
  --comment: #636da6;
  --cyan: #86e1fc;
  --dark: var(--text-normal, var(--text-color, #c8d3f5));
  --dark3: #545c7e;
  --dark5: #737aa2;
  --darkgray: var(--text-normal, var(--text-color, #c8d3f5));
  --divider-color: var(--background-modifier-border, #3b4261);
  --divider-color-hover: var(--interactive-accent, hsl(263, 100%, 80%));
  --dropdown-background: var(--interactive-normal, #1e2030);
  ...
  --flair-background: var(--interactive-normal, #1e2030);
  --flair-color: var(--text-normal, #c8d3f5);
  --footnote-divider-color: var(--metadata-divider-color, #3b4261);
  --footnote-id-color: var(--text-muted, #c8d3f5);
  --footnote-id-color-no-occurrences: var(--text-faint, #828bb8);
  --footnote-input-background-active: var(--metadata-input-background-active, #2f334d);
  --graph-line: var(--border-color-secondary, #3b4261);
  --graph-node: var(--accent, hsl(263, 100%, 80%));
  --graph-node-attachment: var(--accent-color-dark, #c099ff);
  --graph-node-focused: var(--accent-color-hover, #fca7ea);
  --graph-node-tag: var(--accent-color-light, #82aaff);
  --graph-node-unresolved: var(--border-color-primary, #3b4261);
  --graph-text: var(--text-color, #c8d3f5);
  --gray: var(--text-muted, var(--text-color, #c8d3f5));
  --green: #c3e88d;
  --green1: #4fd6be;
  --green2: #41a6b5;
  --h1-color: var(--color-purple, #fca7ea);
  --h2-color: var(--color-blue, #82aaff);
  --h3-color: var(--color-green, #c3e88d);
  --h4-color: var(--color-yellow, #ffc777);
  --h5-color: var(--color-orange, #ff966c);
  --h6-color: var(--color-red, #ff757f);
  --heading-formatting: var(--text-faint, #828bb8);
  --highlight: var(--text-highlight-bg, var(--accent, hsl(263, 100%, 80%)));
  --hr-color: var(--text-color-muted-dark, #3b4261);
  --icon-color: var(--text-muted, #c8d3f5);
  --icon-color-active: var(--text-accent, hsl(263, 100%, 80%));
  --icon-color-focused: var(--text-normal, #c8d3f5);
  --icon-color-hover: var(--text-muted, #c8d3f5);
  --indentation-guide-color: var(--text-color-muted-dark, #3b4261);
  --indentation-guide-color-active: var(--text-color-muted-light, #828bb8);
  --inline-title-color: var(--text-color, #c8d3f5);
  --input-date-separator: var(--text-faint, #828bb8);
  --input-placeholder-color: var(--text-faint, #828bb8);
  --interactive-accent: var(--accent, hsl(263, 100%, 80%));
  --interactive-accent-hover: var(--color-accent-1, hsl(260, 102%, 92%));
  --interactive-accent-hsl: var(--color-accent-hsl, 263, 100%, 80%);
  --interactive-hover: var(--border-color-primary, #3b4261);
  --interactive-normal: var(--background-secondary, #1e2030);
  --italic-color: var(--accent-color-light, #82aaff);
  --light: var(--background-primary, var(--bg, #222436));
  --lightgray: var(--background-secondary, var(--bg-dark, #1e2030));
  --link-color: var(--accent-color-dark, #c099ff);
  --link-color-hover: var(--accent-color-hover, #fca7ea);
  --link-external-color: var(--accent-color-dark, #c099ff);
  --link-external-color-hover: var(--accent-color-hover, #fca7ea);
  --link-unresolved-color: var(--red, #ff757f);
  --link-unresolved-color-hover: var(--red, #ff757f);
  --list-marker-color: var(--accent-color-dark, #c099ff);
  --list-marker-color-collapsed: var(--text-accent, hsl(263, 100%, 80%));
  --list-marker-color-hover: var(--text-muted, #c8d3f5);
  --magenta: #c099ff;
  --magenta2: #ff007c;
  ...
  --metadata-input-background-active: var(--background-modifier-hover, #2f334d);
  --metadata-input-text-color: var(--text-color, #c8d3f5);
  --metadata-label-background-active: var(--background-modifier-hover, #2f334d);
  --metadata-label-text-color: var(--text-color, #c8d3f5);
  --metadata-label-text-color-hover: var(--text-muted, #c8d3f5);
  --metadata-property-background-active: var(--background-modifier-hover, #2f334d);
  --modal-background: var(--background-secondary, #1e2030);
  ...
  --nav-heading-color-collapsed: var(--text-faint, #828bb8);
  --nav-heading-color-collapsed-hover: var(--text-muted, #c8d3f5);
  --nav-heading-color-hover: var(--text-normal, #c8d3f5);
  --nav-indentation-guide-color: var(--border-color-secondary, #3b4261);
  --nav-item-background-active: var(--accent-color-dark, #c099ff);
  --nav-item-background-hover: var(--selection-background-color, #2f334d);
  --nav-item-color: var(--text-color, #c8d3f5);
  --nav-item-color-active: var(--text-color-accent, white);
  --nav-item-color-highlighted: var(--accent-color-light, #82aaff);
  --nav-item-color-hover: var(--text-color-accent, white);
  --nav-item-color-selected: var(--text-normal, red);
  --nav-tag-color: var(--text-faint, #828bb8);
  --nav-tag-color-active: var(--text-muted, #c8d3f5);
  --nav-tag-color-hover: var(--text-muted, #c8d3f5);
  --orange: #ff966c;
  ...
  --pill-color: var(--text-muted, #c8d3f5);
  --pill-color-hover: var(--text-normal, #c8d3f5);
  --pill-color-remove: var(--text-faint, #828bb8);
  --pill-color-remove-hover: var(--text-accent, hsl(263, 100%, 80%));
  --prompt-background: var(--background-primary, #222436);
  --prompt-border-color: var(--border-color-primary, #3b4261);
  --purple: #fca7ea;
  --raised-background: var(--blur-background, color-mix(in srgb, #1e2030 65%, transparent) linear-gradient(#1e2030, color-mix(in srgb, #1e2030 65%, transparent)));
  --red: #ff757f;
  --red1: #c53b53;
  --ribbon-background: var(--background-secondary, #1e2030);
  --ribbon-background-collapsed: var(--background-primary, #222436);
  --search-clear-button-color: var(--text-muted, #c8d3f5);
  --search-icon-color: var(--text-muted, #c8d3f5);
  --search-result-background: var(--background-primary, #222436);
  --secondary: var(--text-accent, var(--accent, hsl(263, 100%, 80%)));
  --selection-background-color: var(--bg-highlight, #2f334d);
  --selection-border-color: var(--accent-color-hover, #fca7ea);
  --setting-group-heading-color: var(--text-normal, #c8d3f5);
  --setting-items-border-color: var(--background-modifier-border, #3b4261);
  --shiki-active-tab-border-color: var(--shiki-highlight-neutral, #c8d3f5);
  --shiki-code-background: var(--code-background, #1e2030);
  --shiki-code-comment: var(--text-faint, #828bb8);
  --shiki-code-function: var(--color-green, #c3e88d);
  --shiki-code-important: var(--color-orange, #ff966c);
  --shiki-code-keyword: var(--color-pink, pink);
  --shiki-code-normal: var(--text-muted, #c8d3f5);
  --shiki-code-property: var(--color-cyan, #86e1fc);
  --shiki-code-punctuation: var(--text-muted, #c8d3f5);
  --shiki-code-string: var(--color-yellow, #ffc777);
  --shiki-code-value: var(--color-purple, #fca7ea);
  --shiki-gutter-border-color: var(--background-modifier-border, #3b4261);
  --shiki-gutter-text-color: var(--text-faint, #828bb8);
  --shiki-gutter-text-color-highlight: var(--shiki-code-normal, #c8d3f5);
  --shiki-highlight-neutral: var(--shiki-code-normal, #c8d3f5);
  --shiki-terminal-dots-color: var(--text-faint, #828bb8);
  --slider-track-background: var(--background-secondary, #1e2030);
  --status-bar-background: var(--background-secondary, #1e2030);
  --status-bar-border-color: var(--divider-color, #3b4261);
  --status-bar-text-color: var(--text-muted, #c8d3f5);
  --suggestion-background: var(--background-primary, #222436);
  --sync-avatar-color-1: var(--color-red, #ff757f);
  --sync-avatar-color-2: var(--color-orange, #ff966c);
  --sync-avatar-color-3: var(--color-yellow, #ffc777);
  --sync-avatar-color-4: var(--color-green, #c3e88d);
  --sync-avatar-color-5: var(--color-cyan, #86e1fc);
  --sync-avatar-color-6: var(--color-blue, #82aaff);
  --sync-avatar-color-7: var(--color-purple, #fca7ea);
  ...
  --tab-divider-color: var(--selection-background-color, #2f334d);
  ...
  --tab-text-color-active: var(--text-color, #c8d3f5);
  --tab-text-color-focused: var(--text-color, #c8d3f5);
  --tab-text-color-focused-active: var(--text-color, #c8d3f5);
  ...
  --table-drag-handle-background-active: var(--table-selection-border-color, #fca7ea);
  --table-drag-handle-color: var(--selection-background-color, #2f334d);
  --table-drag-handle-color-active: var(--selection-background-color, #2f334d);
  --table-header-border-color: var(--table-border-color, #3b4261);
  --table-header-color: var(--text-color, #c8d3f5);
  --table-selection: var(--selection-background-color, #2f334d);
  --table-selection-border-color: var(--selection-border-color, #fca7ea);
  --tag-background: var(--text-color-muted-dark, #3b4261);
  --tag-background-hover: var(--text-color-muted-light, #828bb8);
  --tag-color: var(--accent-color-dark, #c099ff);
  --tag-color-hover: var(--accent-color-dark, #c099ff);
  --teal: #4fd6be;
  --terminal-black: #444a73;
  --tertiary: var(--text-accent-hover, var(--color-accent-2, red));
  --text-accent: var(--accent, hsl(263, 100%, 80%));
  --text-accent-hover: var(--color-accent-2, red);
  --text-color: var(--fg, #c8d3f5);
  --text-color-accent: white;
  --text-color-muted-dark: var(--fg-gutter, #3b4261);
  --text-color-muted-light: var(--fg-dark, #828bb8);
  --text-error: var(--color-red, #ff757f);
  --text-faint: var(--text-color-muted-light, #828bb8);
  --text-highlight-bg: var(--accent, hsl(263, 100%, 80%));
  --text-muted: var(--text-color, #c8d3f5);
  --text-normal: var(--text-color, #c8d3f5);
  --text-on-accent: var(--text-color-accent, white);
  --text-on-accent-inverted: var(--background-primary, #222436);
  --text-selection: var(--selection-background-color, #2f334d);
  --text-success: var(--color-green, #c3e88d);
  --text-warning: var(--color-yellow, #ffc777);
  --textHighlight: var(--text-highlight-bg, var(--accent, hsl(263, 100%, 80%)));
  ...
  --titlebar-text-color: var(--text-muted, #c8d3f5);
...
html[saved-theme="dark"] body .text-highlight {
  background-color: var(--text-highlight-bg, rgb(192, 153, 255));
...
html[saved-theme="dark"] body li.task-list-item input[type="checkbox"] {
  border-color: rgb(130, 139, 184);
}

html[saved-theme="dark"] body li.task-list-item input[type="checkbox"]:checked {
  background-color: var(--checkbox-color, rgb(192, 153, 255));
  border-color: rgb(192, 153, 255);
}

html[saved-theme="dark"] body p {
  color: var(--text-muted, rgb(200, 211, 245));
  outline: rgb(200, 211, 245) none 0px;
  text-decoration-color: rgb(200, 211, 245);
}`,
    links: `html[saved-theme="dark"] body a.external-link, html[saved-theme="dark"] footer a {
  color: var(--link-external-color, rgb(192, 153, 255));
  outline: rgb(192, 153, 255) none 0px;
  text-decoration-color: rgb(192, 153, 255);
}

html[saved-theme="dark"] body a.internal-link, html[saved-theme="dark"] .breadcrumb-container .breadcrumb-element > a {
  color: var(--link-color, rgb(192, 153, 255));
  outline: rgb(192, 153, 255) none 0px;
  text-decoration-color: rgb(192, 153, 255);
}

html[saved-theme="dark"] body a.internal-link.broken {
  color: var(--link-unresolved-color, rgb(255, 117, 127));
  outline: rgb(255, 117, 127) none 0px;
  text-decoration: underline rgba(192, 153, 255, 0.3);
  text-decoration-color: var(--link-unresolved-decoration-color, rgba(192, 153, 255, 0.3));
}`,
...
html[saved-theme="dark"] body ul.overflow {
  ...
  color: var(--text-faint, rgb(130, 139, 184));
}

html[saved-theme="dark"] body blockquote {
  color: var(--blockquote-color, rgb(200, 211, 245));
}`,
...
html[saved-theme="dark"] body td {
  ...
  border-top-width: 0px;
  color: var(--table-text-color, rgb(200, 211, 245));
}
...
html[saved-theme="dark"] body figure {
  --code-background: var(--ec-frm-edBg, #1e2030);
  border-bottom-color: rgb(200, 211, 245);
  border-bottom-width: 0px;
  border-left-color: rgb(200, 211, 245);
  border-left-width: 0px;
...
html[saved-theme="dark"] body img {
  border-bottom-color: rgb(252, 167, 234);
  border-bottom-width: 0px;
  border-left-color: rgb(252, 167, 234);
  border-left-width: 0px;
  border-right-color: rgb(252, 167, 234);
  border-right-width: 0px;
  border-top-color: rgb(252, 167, 234);
  border-top-width: 0px;
}
...
html[saved-theme="dark"] body .transclude {
  border-bottom-color: rgb(200, 211, 245);
  border-bottom-width: 0px;
  border-left-color: rgb(192, 153, 255);
  border-left-width: 0px;
  border-right-color: rgb(200, 211, 245);
  border-right-width: 0px;
  border-top-color: rgb(200, 211, 245);
...
html[saved-theme="dark"] body .transclude-inner {
  ...
  border-bottom-color: rgb(130, 139, 184);
  border-bottom-width: 0px;
  border-left-color: rgb(130, 139, 184);
  border-left-width: 0px;
  border-right-color: rgb(130, 139, 184);
  border-right-width: 0px;
  border-top-color: rgb(130, 139, 184);
  border-top-width: 0px;
}
...
html[saved-theme="dark"] body li.task-list-item[data-task="<"] input[type="checkbox"]::after {
  ...
  mask-repeat: no-repeat;
  -webkit-mask-repeat: no-repeat;
  background-color: rgb(134, 225, 252);
}
...
html[saved-theme="dark"] body li.task-list-item[data-task="l"] input[type="checkbox"]::after {
  ...
  mask-repeat: no-repeat;
  -webkit-mask-repeat: no-repeat;
  background-color: rgb(252, 167, 234);
}
...
html[saved-theme="dark"] body .search > .search-container > .search-space {
  background-color: var(--prompt-background, rgb(34, 36, 54));
  border-bottom-color: rgb(59, 66, 97);
  border-bottom-width: 0px;
  border-left-color: rgb(59, 66, 97);
  border-left-width: 0px;
...
html[saved-theme="dark"] body .search > .search-container > .search-space > .search-layout > .results-container > .result-card:hover, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container > .result-card:focus, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container > .result-card.focus:not(:has(~ .result-card:hover, html[saved-theme="dark"] ~ .result-card:focus)) {
  background-color: var(--background-modifier-hover, rgb(47, 51, 77));
  color: rgb(200, 211, 245);
}
...
html[saved-theme="dark"] body a.internal-link.tag-link, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  ...
  --pill-background-hover: var(--tag-background-hover, #828bb8);
  --pill-border-color: var(--tag-border-color, hsla(263, 100%, 80%, 0.15));
  --pill-border-color-hover: var(--tag-border-color-hover, hsla(263, 100%, 80%, 0.15));
  --pill-color: var(--tag-color, #c099ff);
  --pill-color-hover: var(--tag-color-hover, #c099ff);
  --pill-color-remove: var(--tag-color, #c099ff);
  --pill-color-remove-hover: var(--tag-color-hover, #c099ff);
  background-color: var(--pill-background, rgb(59, 66, 97));
  border-bottom-color: rgba(192, 153, 255, 0.15);
  border-bottom-width: 0px;
  border-left-color: rgba(192, 153, 255, 0.15);
  border-left-width: 0px;
  border-right-color: rgba(192, 153, 255, 0.15);
  border-right-width: 0px;
  border-top-color: rgba(192, 153, 255, 0.15);
  border-top-width: 0px;
  color: var(--pill-color, rgb(192, 153, 255));
}
...
html[saved-theme="dark"] body h1 {
  ...
  border-top-color: rgb(252, 167, 234);
  border-top-width: 0px;
  color: var(--h1-color, rgb(252, 167, 234));
}

html[saved-theme="dark"] body h1.article-title {
  color: var(--inline-title-color, rgb(200, 211, 245));
}
...
html[saved-theme="dark"] body h2 {
  ...
  border-top-width: 0px;
  color: var(--h2-color, rgb(130, 170, 255));
}
...
html[saved-theme="dark"] body h3 {
  border-bottom-color: rgb(195, 232, 141);
  border-bottom-width: 0px;
  border-left-color: rgb(195, 232, 141);
  border-left-width: 0px;
  border-right-color: rgb(195, 232, 141);
  border-right-width: 0px;
  border-top-color: rgb(195, 232, 141);
  border-top-width: 0px;
  color: var(--h3-color, rgb(195, 232, 141));
}
...
html[saved-theme="dark"] body h4 {
  ...
  border-top-width: 0px;
  color: var(--h4-color, rgb(255, 199, 119));
}

html[saved-theme="dark"] body h5 {
  border-bottom-color: rgb(255, 150, 108);
  border-bottom-width: 0px;
  border-left-color: rgb(255, 150, 108);
  border-left-width: 0px;
  border-right-color: rgb(255, 150, 108);
  border-right-width: 0px;
  border-top-color: rgb(255, 150, 108);
  border-top-width: 0px;
  color: var(--h5-color, rgb(255, 150, 108));
}
...
html[saved-theme="dark"] body h6 {
  ...
  border-top-width: 0px;
  color: var(--h6-color, rgb(255, 117, 127));
}
...
html[saved-theme="dark"] body .nav-files-container li:has(> .folder-outer.open) > .nav-folder-title {
  color: var(--nav-item-color, rgb(200, 211, 245));
}
...
html[saved-theme="dark"] body .explorer .nav-files-container .folder-outer > ul {
  ...
  border-top-color: rgb(200, 211, 245);
  border-top-width: 0px;
  color: var(--icon-color, rgb(200, 211, 245));
}`,
  ...
  border-top-color: rgb(59, 66, 97);
  border-top-width: 0px;
  color: var(--status-bar-text-color, rgb(200, 211, 245));
}
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  border-top-color: rgba(192, 153, 255, 0.15);
  border-top-width: 0px;
  color: var(--tag-color, rgb(192, 153, 255));
}`,
  },
  light: {
    base: `:root:root {
