...
export const theme: ThemeData = {
  ...
  --accent: hsl(263, 100%, 80%) !important;
  --accent-color-dark: #c099ff !important;
  --accent-color-hover: #fca7ea !important;
  --accent-color-light: #82aaff !important;
  ...
  --background-modifier-error: #ff757f !important;
  --background-modifier-error-hover: #ff757f !important;
  --background-modifier-form-field: #1e2030 !important;
  --background-modifier-form-field-hover: #1e2030 !important;
  --background-modifier-hover: #2f334d !important;
  --background-modifier-success: #c3e88d !important;
  ...
  --bases-group-heading-property-color: #c8d3f5 !important;
  --bases-table-border-color: #3b4261 !important;
  --bases-table-cell-background-active: #222436 !important;
  --bases-table-cell-background-selected: #2f334d !important;
  --bases-table-cell-shadow-active: 0 0 0 2px #3b4261 !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(263, 100%, 80%) !important;
  --bases-table-header-background: #222436 !important;
  --bases-table-header-background-hover: #2f334d !important;
  --bases-table-header-color: #c8d3f5 !important;
  --bases-table-summary-background: #222436 !important;
  --bases-table-summary-background-hover: #2f334d !important;
  --bg: #222436 !important;
  --bg-dark: #1e2030 !important;
  --bg-highlight: #2f334d !important;
  --blockquote-border-color: #c099ff !important;
  --blue: #82aaff !important;
  --blue0: #3e68d7 !important;
  --blue1: #65bcff !important;
  --blue2: #0db9d7 !important;
  --blue5: #89ddff !important;
  --blue6: #b4f9f8 !important;
  --blue7: #394b70 !important;
  --blur-background: color-mix(in srgb, #1e2030 65%, transparent) linear-gradient(#1e2030, color-mix(in srgb, #1e2030 65%, transparent)) !important;
  --bold-color: #82aaff !important;
  ...
  --canvas-card-label-color: #828bb8 !important;
  --canvas-color: 192, 153, 255 !important;
  --caret-color: #c8d3f5 !important;
  --checkbox-border-color: #828bb8 !important;
  --checkbox-border-color-hover: #fca7ea !important;
  --checkbox-color: #c099ff !important;
  --checkbox-color-hover: #fca7ea !important;
  --checkbox-marker-color: #222436 !important;
  --checklist-done-color: #828bb8 !important;
  --code-background: #1e2030 !important;
  --code-boolean: #ff966c !important;
  --code-border-color: #3b4261 !important;
  --code-bracket-background: #2f334d !important;
  --code-builtin: #86e1fc !important;
  --code-comment: #636da6 !important;
  --code-definition: #82aaff !important;
  --code-function: #ffc777 !important;
  --code-important: #ffc777 !important;
  --code-keyword: #fca7ea !important;
  --code-normal: #c8d3f5 !important;
  --code-operator: #86e1fc !important;
  --code-parentheses: #828bb8 !important;
  --code-property: #82aaff !important;
  --code-punctuation: #c8d3f5 !important;
  --code-string: #c3e88d !important;
  --code-tag: #ff757f !important;
  --code-value: #ff966c !important;
  --code-variable: #c8d3f5 !important;
  --collapse-icon-color: #828bb8 !important;
  --collapse-icon-color-collapsed: hsl(263, 100%, 80%) !important;
  --color-accent: hsl(263, 100%, 80%) !important;
  --color-accent-1: hsl(260, 102%, 92%) !important;
  --color-accent-2: hsl(258, 105%, 103.2%) !important;
  --color-accent-hsl: 263, 100%, 80% !important;
  --color-blue: #82aaff !important;
  --color-cyan: #86e1fc !important;
  --color-green: #c3e88d !important;
  --color-orange: #ff966c !important;
  --color-pink: pink !important;
  --color-purple: #fca7ea !important;
  --color-red: #ff757f !important;
  --color-yellow: #ffc777 !important;
  --comment: #636da6 !important;
  --cyan: #86e1fc !important;
  --dark: #c8d3f5 !important;
  --dark3: #545c7e !important;
  --dark5: #737aa2 !important;
  --darkgray: #c8d3f5 !important;
  --divider-color: #3b4261 !important;
  --divider-color-hover: hsl(263, 100%, 80%) !important;
  --dropdown-background: #1e2030 !important;
  --dropdown-background-hover: #3b4261 !important;
  --embed-block-shadow-hover: 0 0 0 1px #3b4261, inset 0 0 0 1px #3b4261 !important;
  --embed-border-start: 2px solid hsl(263, 100%, 80%) !important;
  --fg: #c8d3f5 !important;
  --fg-dark: #828bb8 !important;
  --fg-gutter: #3b4261 !important;
  --file-header-background: #222436 !important;
  --file-header-background-focused: #222436 !important;
  --flair-background: #1e2030 !important;
  --flair-color: #c8d3f5 !important;
  --footnote-divider-color: #3b4261 !important;
  --footnote-id-color: #c8d3f5 !important;
  --footnote-id-color-no-occurrences: #828bb8 !important;
  --footnote-input-background-active: #2f334d !important;
  --graph-line: #3b4261 !important;
  --graph-node: hsl(263, 100%, 80%) !important;
  --graph-node-attachment: #c099ff !important;
  --graph-node-focused: #fca7ea !important;
  --graph-node-tag: #82aaff !important;
  --graph-node-unresolved: #3b4261 !important;
  --graph-text: #c8d3f5 !important;
  --gray: #c8d3f5 !important;
  --green: #c3e88d !important;
  --green1: #4fd6be !important;
  --green2: #41a6b5 !important;
  --h1-color: #fca7ea !important;
  --h2-color: #82aaff !important;
  --h3-color: #c3e88d !important;
  --h4-color: #ffc777 !important;
  --h5-color: #ff966c !important;
  --h6-color: #ff757f !important;
  --heading-formatting: #828bb8 !important;
  --highlight: hsl(263, 100%, 80%) !important;
  --hr-color: #3b4261 !important;
  --icon-color: #c8d3f5 !important;
  --icon-color-active: hsl(263, 100%, 80%) !important;
  --icon-color-focused: #c8d3f5 !important;
  --icon-color-hover: #c8d3f5 !important;
  --indentation-guide-color: #3b4261 !important;
  --indentation-guide-color-active: #828bb8 !important;
  --inline-title-color: #c8d3f5 !important;
  --input-date-separator: #828bb8 !important;
  --input-placeholder-color: #828bb8 !important;
  --interactive-accent: hsl(263, 100%, 80%) !important;
  --interactive-accent-hover: hsl(260, 102%, 92%) !important;
  --interactive-accent-hsl: 263, 100%, 80% !important;
  --interactive-hover: #3b4261 !important;
  --interactive-normal: #1e2030 !important;
  --italic-color: #82aaff !important;
  --light: #222436 !important;
  --lightgray: #1e2030 !important;
  --link-color: #c099ff !important;
  --link-color-hover: #fca7ea !important;
  --link-external-color: #c099ff !important;
  --link-external-color-hover: #fca7ea !important;
  --link-unresolved-color: #ff757f !important;
  --link-unresolved-color-hover: #ff757f !important;
  --link-unresolved-decoration-color: hsla(263, 100%, 80%, 0.3) !important;
  --list-marker-color: #c099ff !important;
  --list-marker-color-collapsed: hsl(263, 100%, 80%) !important;
  --list-marker-color-hover: #c8d3f5 !important;
  --magenta: #c099ff !important;
  ...
  --metadata-input-background-active: #2f334d !important;
  --metadata-input-text-color: #c8d3f5 !important;
  --metadata-label-background-active: #2f334d !important;
  --metadata-label-text-color: #c8d3f5 !important;
  --metadata-label-text-color-hover: #c8d3f5 !important;
  --metadata-property-background-active: #2f334d !important;
  ...
  --modal-background: #1e2030 !important;
  ...
  --nav-heading-color-collapsed: #828bb8 !important;
  --nav-heading-color-collapsed-hover: #c8d3f5 !important;
  --nav-heading-color-hover: #c8d3f5 !important;
  --nav-indentation-guide-color: #3b4261 !important;
  --nav-item-background-active: #c099ff !important;
  --nav-item-background-hover: #2f334d !important;
  --nav-item-background-selected: red !important;
  --nav-item-color: #c8d3f5 !important;
  ...
  --nav-tag-color: #828bb8 !important;
  --nav-tag-color-active: #c8d3f5 !important;
  --nav-tag-color-hover: #c8d3f5 !important;
  --orange: #ff966c !important;
  ...
  --pill-color: #c8d3f5 !important;
  --pill-color-hover: #c8d3f5 !important;
  --pill-color-remove: #828bb8 !important;
  --pill-color-remove-hover: hsl(263, 100%, 80%) !important;
  --prompt-background: #222436 !important;
  --prompt-border-color: #3b4261 !important;
  --purple: #fca7ea !important;
  --raised-background: color-mix(in srgb, #1e2030 65%, transparent) linear-gradient(#1e2030, color-mix(in srgb, #1e2030 65%, transparent)) !important;
  --red: #ff757f !important;
  --red1: #c53b53 !important;
  --ribbon-background: #1e2030 !important;
  --ribbon-background-collapsed: #222436 !important;
  --search-clear-button-color: #c8d3f5 !important;
  --search-icon-color: #c8d3f5 !important;
  --search-result-background: #222436 !important;
  --secondary: hsl(263, 100%, 80%) !important;
  --selection-background-color: #2f334d !important;
  --selection-border-color: #fca7ea !important;
  --setting-group-heading-color: #c8d3f5 !important;
  --setting-items-border-color: #3b4261 !important;
  --shiki-active-tab-border-color: #c8d3f5 !important;
  --shiki-code-background: #1e2030 !important;
  --shiki-code-comment: #828bb8 !important;
  --shiki-code-function: #c3e88d !important;
  --shiki-code-important: #ff966c !important;
  --shiki-code-keyword: pink !important;
  --shiki-code-normal: #c8d3f5 !important;
  --shiki-code-property: #86e1fc !important;
  --shiki-code-punctuation: #c8d3f5 !important;
  --shiki-code-string: #ffc777 !important;
  --shiki-code-value: #fca7ea !important;
  --shiki-gutter-border-color: #3b4261 !important;
  --shiki-gutter-text-color: #828bb8 !important;
  --shiki-gutter-text-color-highlight: #c8d3f5 !important;
  --shiki-highlight-neutral: #c8d3f5 !important;
  --shiki-terminal-dots-color: #828bb8 !important;
  --slider-track-background: #1e2030 !important;
  --status-bar-background: #1e2030 !important;
  --status-bar-border-color: #3b4261 !important;
  --status-bar-text-color: #c8d3f5 !important;
  --suggestion-background: #222436 !important;
  --sync-avatar-color-1: #ff757f !important;
  --sync-avatar-color-2: #ff966c !important;
  --sync-avatar-color-3: #ffc777 !important;
  --sync-avatar-color-4: #c3e88d !important;
  --sync-avatar-color-5: #86e1fc !important;
  --sync-avatar-color-6: #82aaff !important;
  --sync-avatar-color-7: #fca7ea !important;
  --sync-avatar-color-8: pink !important;
  --tab-background-active: #222436 !important;
  --tab-container-background: #1e2030 !important;
  --tab-divider-color: #2f334d !important;
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(263, 100%, 80%) !important;
  --tab-text-color: #3b4261 !important;
  --tab-text-color-active: #c8d3f5 !important;
  --tab-text-color-focused: #c8d3f5 !important;
  --tab-text-color-focused-active: #c8d3f5 !important;
  ...
  --table-drag-handle-background-active: #fca7ea !important;
  --table-drag-handle-color: #2f334d !important;
  --table-drag-handle-color-active: #2f334d !important;
  --table-header-border-color: #3b4261 !important;
  --table-header-color: #c8d3f5 !important;
  --table-selection: #2f334d !important;
  --table-selection-border-color: #fca7ea !important;
  --tag-background: #3b4261 !important;
  --tag-background-hover: #828bb8 !important;
  --tag-border-color: hsla(263, 100%, 80%, 0.15) !important;
  --tag-border-color-hover: hsla(263, 100%, 80%, 0.15) !important;
  --tag-color: #c099ff !important;
  --tag-color-hover: #c099ff !important;
  --teal: #4fd6be !important;
  --terminal-black: #444a73 !important;
  --tertiary: red !important;
  --text-accent: hsl(263, 100%, 80%) !important;
  --text-accent-hover: red !important;
  --text-color: #c8d3f5 !important;
  --text-color-accent: white !important;
  --text-color-muted-dark: #3b4261 !important;
  --text-color-muted-light: #828bb8 !important;
  --text-error: #ff757f !important;
  --text-faint: #828bb8 !important;
  --text-highlight-bg: hsl(263, 100%, 80%) !important;
  --text-muted: #c8d3f5 !important;
  --text-normal: #c8d3f5 !important;
  --text-on-accent-inverted: #222436 !important;
  --text-selection: #2f334d !important;
  --text-success: #c3e88d !important;
  --text-warning: #ffc777 !important;
  --textHighlight: hsl(263, 100%, 80%) !important;
  --titlebar-background: #1e2030 !important;
  --titlebar-background-focused: #3b4261 !important;
  --titlebar-border-color: #3b4261 !important;
  --titlebar-text-color: #c8d3f5 !important;
...
html[saved-theme="dark"] body a.internal-link.broken {
  ...
  text-decoration-color: rgba(192, 153, 255, 0.3);
}`,
