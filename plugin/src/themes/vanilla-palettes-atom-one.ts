...
html[saved-theme="dark"] body[data-slug] div#quartz-root.page, html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left, html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left:has(.explorer), html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left .explorer .explorer-content {
  --bases-table-header-background: var(--background-secondary, #21252b);
...
html[saved-theme="dark"] body blockquote {
  color: var(--blockquote-color, rgb(171, 178, 191));
}`,
...
html[saved-theme="dark"] body figure {
  --code-background: var(--ec-frm-edBg, #21252b);
  border-bottom-color: rgb(171, 178, 191);
  border-bottom-width: 0px;
  border-left-color: rgb(171, 178, 191);
  border-left-width: 0px;
...
html[saved-theme="dark"] body a.internal-link.tag-link, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  --pill-background: var(--tag-background, #393f4a);
  --pill-background-hover: var(--tag-background-hover, #5c6370);
  --pill-border-color: var(--tag-border-color, hsla(207, 82%, 66%, 0.15));
  --pill-border-color-hover: var(--tag-border-color-hover, hsla(207, 82%, 66%, 0.15));
  --pill-color: var(--tag-color, #61afef);
  --pill-color-hover: var(--tag-color-hover, #61afef);
  --pill-color-remove: var(--tag-color, #61afef);
  --pill-color-remove-hover: var(--tag-color-hover, #61afef);
...
html[saved-theme="dark"] body h6 {
  border-bottom-color: rgb(232, 102, 113);
  border-bottom-width: 0px;
  border-left-color: rgb(232, 102, 113);
  border-left-width: 0px;
  border-right-color: rgb(232, 102, 113);
  border-right-width: 0px;
  border-top-color: rgb(232, 102, 113);
  border-top-width: 0px;
