...
export const theme: ThemeData = {
  ...
  --bases-table-cell-background-selected: hsla(210, 77%, 51%, 0.1);
  ...
  --bodyFont: var(--font-text, system, BlinkMacSystemFont, "Segoe UI", Helvetica, "Apple Color Emoji", Arial, sans-serif, "Segoe UI Emoji", "Segoe UI Symbol");
  ...
  --codeFont: var(--font-monospace, iA Writer Duospace, Nitti, Menlo, Courier, monospace);
  ...
  --gray: var(--text-muted, rgba(255, 255, 255, 0.7));
  --h-bg: transparent;
  ...
  --headerFont: var(--font-text, system, BlinkMacSystemFont, "Segoe UI", Helvetica, "Apple Color Emoji", Arial, sans-serif, "Segoe UI Emoji", "Segoe UI Symbol");
  ...
  --nav-item-background-selected: hsla(210, 77%, 51%, 0.15);
  ...
  --titleFont: var(--font-text, system, BlinkMacSystemFont, "Segoe UI", Helvetica, "Apple Color Emoji", Arial, sans-serif, "Segoe UI Emoji", "Segoe UI Symbol");
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --bases-cards-cover-background: hsl(203, 8%, 90%);
  ...
  --bases-table-cell-background-disabled: hsl(203, 8%, 90%);
  --bases-table-cell-background-selected: hsla(210, 77%, 51%, 0.1);
  --bases-table-cell-shadow-active: 0 0 0 2px #afafaf;
  --bases-table-cell-shadow-focus: 0 0 0 2px rgb(46, 170, 220);
  --bases-table-container-border-radius: 3px;
  --bases-table-group-background: hsl(203, 8%, 90%);
  --bases-table-header-background: hsl(203, 8%, 100%);
  --bases-table-header-background-hover: hsl(60, 3%, 0%, 4%);
  --bases-table-header-color: rgba(55, 53, 47, 0.7);
  --bases-table-summary-background: hsl(203, 8%, 100%);
  --bases-table-summary-background-hover: hsl(60, 3%, 0%, 4%);
  ...
  --footnote-input-background-active: hsl(60, 3%, 0%, 4%);
  --footnote-radius: 3px;
  ...
  --gray: var(--text-muted, rgba(55, 53, 47, 0.7));
  --h-bg: transparent;
  ...
  --metadata-input-background-active: hsl(60, 3%, 0%, 4%);
  --metadata-input-font: -apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, "Apple Color Emoji", Arial, sans-serif, "Segoe UI Emoji", "Segoe UI Symbol";
  --metadata-input-text-color: rgba(55, 53, 47, 0.9);
  --metadata-label-background-active: hsl(60, 3%, 0%, 4%);
  --metadata-label-font: -apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, "Apple Color Emoji", Arial, sans-serif, "Segoe UI Emoji", "Segoe UI Symbol";
  --metadata-label-text-color: rgba(55, 53, 47, 0.7);
  --metadata-label-text-color-hover: rgba(55, 53, 47, 0.7);
  --metadata-property-background-active: hsl(60, 3%, 0%, 4%);
  ...
  --nav-indentation-guide-color: transparent;
  --nav-item-background-active: hsl(60, 3%, 0%, 4%);
  --nav-item-background-hover: hsl(60, 3%, 0%, 4%);
  --nav-item-background-selected: hsla(210, 77%, 51%, 0.15);
...
html[saved-theme="light"] body a.internal-link.broken {
  ...
  --shadow-stationary: 0px 0.5px 1px 0.5px rgba(0, 0, 0, 0.1);
  --zoom-multiplier: 1;
  background-color: rgba(55, 53, 47, 0.7);
...
html[saved-theme="light"] body ul.tags > li {
  ...
  classSettings: {
    "notation-colors": `body.theme-light, body.theme-dark {
...
--interactive-accent-hover: rgba(var(--interactive-accent-rgb), 0.8);
    ...
    "hide-new-folder": `.hide-new-folder .clickable-icon[aria-label="New folder"] {
display: none;
}
...
width: 100%;
    ...
    "hide-other-icons": `.hide-other-icons .clickable-icon[aria-label="Change sort order"], .hide-other-icons .clickable-icon[aria-label="Collapse all"], .hide-other-icons .clickable-icon[aria-label="Expand all"] {
display: none;
}`,
    "notation-titlebar": `.notation-titlebar .view-header {
max-width: unset;
margin-left: auto;
margin-right: auto;
padding: 0;
...
font-size: 0;
    ...
    "headings-red": `.headings-red-text {
...
--h-bg: rgb(var(--color-red-rgb));
    ...
    "headings-orange": `.headings-orange-text {
...
--h-bg: rgb(var(--color-orange-rgb));
    ...
    "headings-yellow": `.headings-yellow-text {
...
--h-bg: rgb(var(--color-yellow-rgb));
    ...
    "headings-green": `.headings-green-text {
...
--h-bg: rgb(var(--color-green-rgb));
    ...
    "headings-blue": `.headings-blue-text {
...
--h-bg: rgb(var(--color-blue-rgb));
    ...
    "headings-purple": `.headings-purple-text {
...
--h-bg: rgb(var(--color-purple-rgb));
    ...
    "headings-pink": `.headings-pink-text {
...
--h-bg: rgb(var(--color-pink-rgb));
    ...
    "headings-brown": `.headings-brown-text {
...
--h-bg: rgb(var(--color-brown-rgb));
    ...
    "headings-gray": `.headings-gray-text {
...
--h-bg: rgb(var(--color-gray-rgb));
    ...
    "headings-rainbow": `.headings-rainbow-text {
...
--h6-bg: rgb(var(--color-purple-rgb));
    ...
    "headings-red-text": `.headings-red-text {
--h-color: var(--color-red);
}`,
    "headings-orange-text": `.headings-orange-text {
--h-color: var(--color-orange);
}`,
    "headings-yellow-text": `.headings-yellow-text {
--h-color: var(--color-yellow);
}`,
    "headings-green-text": `.headings-green-text {
--h-color: var(--color-green);
}`,
    "headings-blue-text": `.headings-blue-text {
--h-color: var(--color-blue);
}`,
    "headings-purple-text": `.headings-purple-text {
--h-color: var(--color-purple);
}`,
    "headings-pink-text": `.headings-pink-text {
--h-color: var(--color-pink);
}`,
    "headings-brown-text": `.headings-brown-text {
--h-color: var(--color-brown);
}`,
    "headings-gray-text": `.headings-gray-text {
--h-color: var(--color-gray);
}`,
    "headings-rainbow-text": `.headings-rainbow-text {
--h1-color: var(--color-red);
--h2-color: var(--color-orange);
--h3-color: var(--color-yellow);
--h4-color: var(--color-green);
...
padding: 0px 2px !important;
    ...
    "banner-default": `.banner-default .cover-img img[alt*="banner"] {
...
z-index: 1;
    ...
    "banner-gradient": `.banner-gradient .cover-img .inline-title {
position: relative;
...
mask-image: linear-gradient(to bottom, rgba(0,0,0,1), rgba(0,0,0,0));
    ...
    "banner-glow": `.banner-glow .cover-img img[alt*="banner"] {
-webkit-mask-image: none;
mask-image: none;
