...
export const theme: ThemeData = {
  ...
  --aside-border-color: #000000 !important;
  --aside-text-color: #999 !important;
  --background-modifier-active-hover: hsla(0, 92%, 62%, 0.15) !important;
  --background-modifier-border: #000000 !important;
  --background-modifier-border-focus: #000000 !important;
  ...
  --background-primary-pre-alt: #0f0f0f !important;
  ...
  --bases-table-cell-shadow-active: 0 0 0 2px #000000 !important;
  ...
  --bb-border: 1px solid #000000 !important;
  --bb-border-alt: 1px solid #222222 !important;
  --bb-border-dashed: 1px dashed #000000 !important;
  --bb-border-high-contrast: 1px solid #999 !important;
  ...
  --canvas-dot-pattern: #666 !important;
  ...
  --color-accent-3: hsl(-175,
        ...
        79.98%) !important;
  --color-accent-hsl: 0, 92%, 62% !important;
  --color-accent-rgb: 251, 70, 76 !important;
  --color-base-00: #0c0c0c !important;
  --color-base-05: #0f0f0f !important;
  --color-base-10: #161616 !important;
  ...
  --embed-block-shadow-hover: 0 0 0 1px #000000,
  ...
  --metadata-property-box-shadow-focus: 0 0 0 2px #000000 !important;
  ...
  --o-h1-color: #000000 !important;
  --o-h2-color: #000000 !important;
  --o-h3-color: #000000 !important;
  --o-h4-color: #000000 !important;
  --o-h5-color: #000000 !important;
  --o-h6-color: #000000 !important;
  --pdf-background: #0c0c0c !important;
  --pdf-page-background: #0c0c0c !important;
  --pdf-shadow: 0 0 0 1px #000000 !important;
  --pdf-sidebar-background: #0c0c0c !important;
  --pdf-thumbnail-shadow: 0 0 0 1px #000000 !important;
  ...
  --prompt-border-color: #000000 !important;
  ...
  --text-on-button: #0c0c0c !important;
...
html[saved-theme="dark"] body .canvas-node {
  ...
  box-shadow: rgb(186, 186, 186) 0px 0px 0px 4px;
}
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --aside-border-color: #dfdfdf !important;
  --aside-text-color: #707070 !important;
  --background-modifier-active-hover: hsla(5, 90%, 56%, 0.15) !important;
  --background-modifier-border: #dfdfdf !important;
  --background-modifier-border-focus: #f6f6f6 !important;
  ...
  --background-primary-pre-alt: #ffffff !important;
  --background-scondary-alt: #707070 !important;
  --background-secondary-alt: #ffffff !important;
  --bases-cards-cover-background: #ffffff !important;
  --bases-cards-shadow: 0 0 0 1px #dfdfdf !important;
  --bases-embed-border-color: #dfdfdf !important;
  --bases-group-heading-property-color: #707070 !important;
  --bases-table-border-color: #dfdfdf !important;
  --bases-table-cell-background-disabled: #ffffff !important;
  --bases-table-cell-background-selected: hsla(5, 90%, 56%, 0.1) !important;
  --bases-table-cell-shadow-active: 0 0 0 2px #f6f6f6 !important;
  ...
  --bb-border: 1px solid #dfdfdf !important;
  --bb-border-alt: 1px solid #ffffff !important;
  --bb-border-dashed: 1px dashed #dfdfdf !important;
  --bb-border-high-contrast: 1px solid #707070 !important;
  --bb-border-transparent: 1px solid transparent !important;
  ...
  --bodyFont: "Aspekta", sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif !important;
  --callout-cite: 87, 61, 132;
  --canvas-card-label-color: #969696 !important;
  --canvas-color: 51, 51, 49 !important;
  --canvas-dot-pattern: #969696 !important;
  --caret-color: #5a5a5a !important;
  --checkbox-border-color: #969696 !important;
  ...
  --code-border-color: #dfdfdf !important;
  --code-bracket-background: rgba(0, 0, 0, 0.075) !important;
  --code-comment: #969696 !important;
  ...
  --codeFont: "Monaspace", monospace !important;
  --collapse-icon-color: #969696 !important;
  ...
  --divider-color: #dfdfdf !important;
  --divider-color-hover: hsl(4, 90.9%, 60.2%) !important;
  --dropdown-background-hover: #ffffff !important;
  --embed-block-shadow-hover: 0 0 0 1px #dfdfdf,
        inset 0 0 0 1px #dfdfdf !important;
  ...
  --font-ui-medium: 16px !important;
  --font-ui-small: 14px !important;
  --footnote-divider-color: #dfdfdf !important;
  --footnote-id-color: #707070 !important;
  --footnote-id-color-no-occurrences: #969696 !important;
  ...
  --graph-node-focused: #f6f6f6 !important;
  --graph-node-tag: hsl(5, 90%, 56%) !important;
  --graph-node-unresolved: #969696 !important;
  ...
  --h6-weight: 500 !important;
  --headerFont: "Aspekta", sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif !important;
  --heading-formatting: #969696 !important;
  --highlight: rgba(0, 0, 0, 0.075) !important;
  --hr-color: #dfdfdf !important;
  ...
  --inline-title-size: clamp(2.5rem, 8vw - 4rem, 5rem) !important;
  --inline-title-weight: 900 !important;
  --input-date-separator: #969696 !important;
  ...
  --list-indent: 2.25em !important;
  --list-marker-color: #969696 !important;
  ...
  --metadata-border-color: #dfdfdf !important;
  --metadata-divider-color: #dfdfdf !important;
  ...
  --metadata-property-box-shadow-focus: 0 0 0 2px #f6f6f6 !important;
  --metadata-sidebar-input-font-size: 14px !important;
  --metadata-sidebar-label-font-size: 14px !important;
  --modal-border-color: #f6f6f6 !important;
  --nav-collapse-icon-color: #969696 !important;
  --nav-collapse-icon-color-collapsed: #969696 !important;
  --nav-heading-color: #5a5a5a !important;
  --nav-heading-color-collapsed: #969696 !important;
  ...
  --nav-item-size: 14px !important;
  --nav-tag-color: #969696 !important;
  --nav-tag-color-active: #707070 !important;
  --nav-tag-color-hover: #707070 !important;
  --o-h1-color: #dfdfdf !important;
  --o-h2-color: #dfdfdf !important;
  --o-h3-color: #dfdfdf !important;
  --o-h4-color: #dfdfdf !important;
  --o-h5-color: #dfdfdf !important;
  --o-h6-color: #dfdfdf !important;
  --pill-border-color: #dfdfdf !important;
  --pill-color: #707070 !important;
  --pill-color-hover: #5a5a5a !important;
  --pill-color-remove: #969696 !important;
  --pill-color-remove-hover: hsl(5, 90%, 56%) !important;
  --prompt-border-color: #f6f6f6 !important;
  ...
  --setting-items-border-color: #dfdfdf !important;
  ...
  --slider-thumb-radius: 50% !important;
  --slider-track-background: #dfdfdf !important;
  --status-bar-border-color: #dfdfdf !important;
  --status-bar-scroll-padding: 30px !important;
  ...
  --table-add-button-border-color: #dfdfdf !important;
  --table-border-color: #dfdfdf !important;
  --table-drag-handle-background-active: hsl(4, 90.9%, 60.2%) !important;
  --table-drag-handle-color: #969696 !important;
  --table-drag-handle-color-active: #222222 !important;
  --table-header-border-color: #dfdfdf !important;
  ...
  --text-faint: #969696 !important;
  --text-muted: #707070 !important;
  --text-normal: #5a5a5a !important;
  --text-on-accent: #222222 !important;
  --text-on-button: #ffffff !important;
  ...
  --titleFont: "Aspekta", sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif !important;
  --titlebar-background-focused: transparent !important;
  --titlebar-border-color: #dfdfdf !important;
...
html[saved-theme="light"] body .canvas-node {
  ...
  box-shadow: rgb(90, 90, 90) 0px 0px 0px 4px;
}
