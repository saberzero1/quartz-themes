...
export const theme: ThemeData = {
  ...
  light: {
    base: `:root:root {
  --accent: #42b38d;
  --background-primary: var(--color-base-00, #f8fcfb);
  --bases-cards-background: var(--background-primary, #f8fcfb);
  --bases-cards-radius: var(--radius-m, 12px);
  --bases-embed-border-radius: var(--radius-s, 8px);
  --bases-table-cell-background-active: var(--background-primary, #f8fcfb);
  --bases-table-container-border-radius: var(--radius-s, 8px);
  --bases-table-header-background: var(--background-primary, #f8fcfb);
  --bases-table-summary-background: var(--background-primary, #f8fcfb);
  --bodyFont: var(--font-text-theme, 'Noto Serif KR', serif);
  --bold-color: var(--accent, #42b38d);
  ...
  --canvas-background: var(--background-primary, #f8fcfb);
  --canvas-controls-radius: var(--radius-s, 8px);
  --checkbox-marker-color: var(--background-primary, #f8fcfb);
  --checkbox-radius: var(--radius-s, 12px);
  --clickable-icon-radius: var(--radius-s, 8px);
  --code-radius: var(--radius-s, 8px);
  --file-header-background: var(--background-primary, #f8fcfb);
  --file-header-background-focused: var(--background-primary, #f8fcfb);
  ...
  --h1-color: var(--accent, #42b38d);
  --h2-color: var(--accent, #42b38d);
  --h3-color: var(--accent, #42b38d);
  --h4-color: var(--accent, #42b38d);
  --h5-color: var(--accent, #42b38d);
  --h6-color: var(--accent, #42b38d);
  --headerFont: var(--font-text-theme, 'Noto Serif KR', serif);
  --highlight-hue: 30;
  --inline-title-color: var(--h1-color, #42b38d);
  --input-radius: 12px;
  --italic-color: var(--accent, #42b38d);
  --light: var(--background-primary, var(--color-base-00, #f8fcfb));
  --menu-radius: var(--radius-m, 12px);
  --modal-background: var(--background-primary, #f8fcfb);
  --modal-radius: var(--radius-l, 16px);
  --nav-item-radius: var(--radius-s, 8px);
  --nav-tag-radius: var(--radius-s, 8px);
  --pdf-background: var(--background-primary, #f8fcfb);
  --pdf-page-background: var(--background-primary, #f8fcfb);
  --pdf-sidebar-background: var(--background-primary, #f8fcfb);
  --primary: #2a5a4a;
  --prompt-background: var(--background-primary, #f8fcfb);
  --radius-l: 16px;
  --radius-m: 12px;
  --radius-s: 8px;
  --raised-background: var(--blur-background, color-mix(in srgb, #f8fcfb 65%, transparent) linear-gradient(#f8fcfb, color-mix(in srgb, #f8fcfb 65%, transparent)));
  --ribbon-background-collapsed: var(--background-primary, #f8fcfb);
  --scrollbar-radius: var(--radius-l, 16px);
  --search-result-background: var(--background-primary, #f8fcfb);
  --secondary: #8ccfb9;
  ...
  --suggestion-background: var(--background-primary, #f8fcfb);
  --tab-background-active: var(--background-primary, #f8fcfb);
...
html body[data-slug], html body[data-slug] .page > div#quartz-body, html .page > div#quartz-body div.center, html .page > div#quartz-body footer {
  background-color: var(--background-primary, rgb(248, 252, 251));
  color: rgb(19, 32, 28);
}
...
html body .page > div#quartz-body div.sidebar.right {
  ...
  color: var(--bold-color, rgb(66, 179, 141));
...
html body .markdown-rendered p > em, html em {
  color: var(--italic-color, rgb(66, 179, 141));
  font-family: "??", "Noto Serif KR", serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  outline: rgb(66, 179, 141) none 0px;
  text-decoration-color: rgb(66, 179, 141);
}
...
html body .search > .search-container > .search-space {
  background-color: var(--prompt-background, rgb(248, 252, 251));
...
html body h1 {
  ...
  border-right-color: rgb(66, 179, 141);
  border-top-color: rgb(66, 179, 141);
  color: var(--h1-color, rgb(66, 179, 141));
...
html body h1.article-title {
  color: var(--inline-title-color, rgb(66, 179, 141));
}
...
html body h2 {
  ...
  border-right-color: rgb(66, 179, 141);
  border-top-color: rgb(66, 179, 141);
  color: var(--h2-color, rgb(66, 179, 141));
...
html body h3 {
  ...
  border-right-color: rgb(66, 179, 141);
  border-top-color: rgb(66, 179, 141);
  color: var(--h3-color, rgb(66, 179, 141));
...
html body h4 {
  ...
  border-right-color: rgb(66, 179, 141);
  border-top-color: rgb(66, 179, 141);
  color: var(--h4-color, rgb(66, 179, 141));
...
html body h5 {
  ...
  border-right-color: rgb(66, 179, 141);
  border-top-color: rgb(66, 179, 141);
  color: var(--h5-color, rgb(66, 179, 141));
...
html body h6 {
  ...
  border-right-color: rgb(66, 179, 141);
  border-top-color: rgb(66, 179, 141);
  color: var(--h6-color, rgb(66, 179, 141));
