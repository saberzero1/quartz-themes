...
export const theme: ThemeData = {
  ...
  --mu-text-title: rgb(175, 71, 235) !important;
  ...
  --nav-item-color-highlighted: rgb(206, 199, 250) !important;
  ...
  --tag-color: rgb(170, 153, 245) !important;
  --tag-color-hover: rgb(206, 199, 250) !important;
  ...
  --tertiary: rgb(206, 199, 250) !important;
  --text-accent: rgb(170, 153, 245) !important;
  --text-accent-hover: rgb(206, 199, 250) !important;
...
html[saved-theme="dark"] body kbd {
  ...
  --bases-table-cell-background-selected: rgba(139, 108, 239, 0.1) !important;
  --bases-table-cell-shadow-active: 0 0 0 2px #007fff !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px rgb(155, 130, 242) !important;
  ...
  --embed-border-left: 2px solid #0072d348 !important;
  --embed-border-right: none !important;
  --embed-border-start: 2px solid rgb(155, 130, 242) !important;
  ...
  --inline-title-size: 2em !important;
  --inline-title-weight: 800 !important;
  --interactive-accent: rgb(155, 130, 242) !important;
  --interactive-accent-hover: rgb(170, 153, 245) !important;
  --interactive-accent-hsl: 254, 80%, 68% !important;
  --interactive-hover: #007fff38 !important;
  --interactive-normal: #007fff18 !important;
  ...
  --nav-item-color-highlighted: rgb(170, 153, 245) !important;
  ...
  --table-column-first-border-width: 0 !important;
  --table-column-last-border-width: 0 !important;
  --table-drag-handle-background-active: rgb(155, 130, 242) !important;
  ...
  --table-selection: rgba(139, 108, 239, 0.1) !important;
  --table-selection-blend-mode: normal !important;
  --table-selection-border-color: rgb(155, 130, 242) !important;
  --table-white-space: normal !important;
  --tag-background: rgba(139, 108, 239, 0.1) !important;
  --tag-background-hover: rgba(139, 108, 239, 0.2) !important;
  --tag-border-color: #0072d33f !important;
  ...
  --tag-color-hover: rgb(170, 153, 245) !important;
  --tag-padding-x: 8px !important;
  --tag-padding-y: 4px !important;
  --tag-radius: 1em !important;
  --tag-radius-value: 1 !important;
  --tag-size: 0.933em !important;
  --tertiary: rgb(170, 153, 245) !important;
  --text-accent: rgb(139, 108, 239) !important;
  --text-accent-hover: rgb(170, 153, 245) !important;
  --text-highlight-bg: #ffff0088 !important;
