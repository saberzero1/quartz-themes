...
export const theme: ThemeData = {
  ...
  --background-accent: rgba(14, 210, 247, 0.25) !important;
  ...
  --background-primary: hsl(207deg, 95%, 5%) !important;
  --background-primary-alt: hsl(210deg, 95%, 6%) !important;
  --background-secondary: hsl(200deg, 95%, 5%) !important;
  --background-secondary-alt: hsl(203deg, 95%, 6%) !important;
  --bases-cards-background: hsl(207deg, 95%, 5%) !important;
  --bases-cards-cover-background: hsl(210deg, 95%, 6%) !important;
  ...
  --bases-table-cell-background-active: hsl(207deg, 95%, 5%) !important;
  --bases-table-cell-background-disabled: hsl(210deg, 95%, 6%) !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px rgba(14, 210, 247, 0.5) !important;
  --bases-table-group-background: hsl(210deg, 95%, 6%) !important;
  --bases-table-header-background: hsl(207deg, 95%, 5%) !important;
  --bases-table-header-color: #f8f8f2 !important;
  --bases-table-summary-background: hsl(207deg, 95%, 5%) !important;
  --blockquote-border-color: rgba(14, 210, 247, 0.5) !important;
  --blue: #00588E !important;
  --border-color: #2b2727 !important;
  --border-color-alt: #101014 !important;
  --canvas-background: hsl(207deg, 95%, 5%) !important;
  --canvas-card-label-color: #7fdbca !important;
  --caret-color: #f8f8f2 !important;
  --checkbox-border-color: #7fdbca !important;
  ...
  --checkbox-marker-color: hsl(207deg, 95%, 5%) !important;
  --checklist-done-color: #f8f8f2 !important;
  --code-background: hsl(210deg, 95%, 6%) !important;
  --code-block: #8be9fd !important;
  --code-border-color: rgba(14, 210, 247, 0.05) !important;
  --code-comment: #7fdbca !important;
  --code-normal: #f8f8f2 !important;
  --code-punctuation: #f8f8f2 !important;
  --code-size-code: 16px !important;
  --collapse-icon-color: #7fdbca !important;
  --collapse-icon-color-collapsed: #ffeb95 !important;
  --cyan: #81FFEA !important;
  --cyan-transparent: rgba(129, 255, 234, 0.3) !important;
  ...
  --file-header-background: hsl(207deg, 95%, 5%) !important;
  --file-header-background-focused: hsl(207deg, 95%, 5%) !important;
  --file-header-font-size: 18px !important;
  --flair-color: #f8f8f2 !important;
  --font-family-editor: IBM Plex Mono, Menlo, Monaco, "Courier New", monospace !important;
  --font-family-preview: Karla, "Avenir Next", Helvetica, Arial, sans-serif !important;
  --font-family-preview-heading: Rubik, "Avenir Next", Helvetica, Arial, sans-serif !important;
  ...
  --font-size-side-dock: 18px !important;
  --font-size-side-dock-title: 18px !important;
  --font-size-status-bar: 18px !important;
  --footnote-divider-color: rgba(14, 210, 247, 0.05) !important;
  --footnote-id-color: #f8f8f2 !important;
  --footnote-id-color-no-occurrences: #7fdbca !important;
  --graph-node: #f8f8f2 !important;
  --graph-node-focused: #ffeb95 !important;
  --graph-node-unresolved: #7fdbca !important;
  --graph-text: #f8f8f2 !important;
  --gray: #f8f8f2 !important;
  --gray-1: #586e75 !important;
  --gray-2: #D5D4DE !important;
  --green: #8AFF7F !important;
  --heading-formatting: #7fdbca !important;
  --highlight: hsla(101deg, 100%, 12%, 0.8) !important;
  --hr-color: rgba(14, 210, 247, 0.05) !important;
  --icon-color: #f8f8f2 !important;
  --icon-color-active: #ffeb95 !important;
  --icon-color-focused: #f8f8f2 !important;
  --icon-color-hover: #f8f8f2 !important;
  --inline-code: #bd93f9 !important;
  --input-date-separator: #7fdbca !important;
  --input-placeholder-color: #7fdbca !important;
  --interactive-accent: rgba(14, 210, 247, 0.5) !important;
  --interactive-accent-hover: rgba(14, 210, 247, 0.8) !important;
  --lavender: #b380fb !important;
  --light: hsl(207deg, 95%, 5%) !important;
  --lightgray: hsl(200deg, 95%, 5%) !important;
  --line-width: 900px !important;
  --link-color: #ffeb95 !important;
  --link-color-hover: #8be9fd !important;
  --link-external-color: #ffeb95 !important;
  --link-external-color-hover: #8be9fd !important;
  --link-unresolved-color: #ffeb95 !important;
  --list-marker-color: #7fdbca !important;
  --list-marker-color-collapsed: #ffeb95 !important;
  --list-marker-color-hover: #f8f8f2 !important;
  --menu-background: hsl(200deg, 95%, 5%) !important;
  ...
  --modal-background: hsl(207deg, 95%, 5%) !important;
  --nav-collapse-icon-color: #7fdbca !important;
  --nav-collapse-icon-color-collapsed: #7fdbca !important;
  --nav-heading-color: #f8f8f2 !important;
  --nav-heading-color-collapsed: #7fdbca !important;
  ...
  --nav-item-color-highlighted: #ffeb95 !important;
  --nav-item-color-hover: #f8f8f2 !important;
  --nav-item-color-selected: #f8f8f2 !important;
  --nav-item-size: 18px !important;
  --nav-tag-color: #7fdbca !important;
  --nav-tag-color-active: #f8f8f2 !important;
  --nav-tag-color-hover: #f8f8f2 !important;
  --orange: #FE9580 !important;
  --pdf-background: hsl(207deg, 95%, 5%) !important;
  --pdf-page-background: hsl(207deg, 95%, 5%) !important;
  --pdf-shadow: 0 0 0 1px rgba(14, 210, 247, 0.05) !important;
  --pdf-sidebar-background: hsl(207deg, 95%, 5%) !important;
  ...
  --pill-color-remove: #7fdbca !important;
  --pill-color-remove-hover: #ffeb95 !important;
  --pink: #FE7FBF !important;
  --popover-font-size: 14px !important;
  --pre-code: #44475a !important;
  --prompt-background: hsl(207deg, 95%, 5%) !important;
  --purple: #9580FF !important;
  --purple-transparent: rgba(149, 128, 255, 0.5) !important;
  --red: #FF5555 !important;
  --ribbon-background: hsl(200deg, 95%, 5%) !important;
  --ribbon-background-collapsed: hsl(207deg, 95%, 5%) !important;
  --search-clear-button-color: #f8f8f2 !important;
  --search-icon-color: #f8f8f2 !important;
  --search-result-background: hsl(207deg, 95%, 5%) !important;
  --secondary: #ffeb95 !important;
  --setting-group-heading-color: #f8f8f2 !important;
  --setting-items-background: hsl(210deg, 95%, 6%) !important;
  --setting-items-border-color: rgba(14, 210, 247, 0.05) !important;
  --shiki-active-tab-border-color: #f8f8f2 !important;
  --shiki-code-background: hsl(210deg, 95%, 6%) !important;
  --shiki-code-comment: #7fdbca !important;
  --shiki-code-normal: #f8f8f2 !important;
  --shiki-code-punctuation: #f8f8f2 !important;
  --shiki-gutter-border-color: rgba(14, 210, 247, 0.05) !important;
  --shiki-gutter-text-color: #7fdbca !important;
  --shiki-gutter-text-color-highlight: #f8f8f2 !important;
  --shiki-highlight-neutral: #f8f8f2 !important;
  --shiki-terminal-dots-color: #7fdbca !important;
  --slider-track-background: rgba(14, 210, 247, 0.05) !important;
  --status-bar-background: hsl(200deg, 95%, 5%) !important;
  --status-bar-border-color: rgba(14, 210, 247, 0.05) !important;
  --status-bar-text-color: #f8f8f2 !important;
  --suggestion-background: hsl(207deg, 95%, 5%) !important;
  --tab-background-active: hsl(207deg, 95%, 5%) !important;
  --tab-container-background: hsl(200deg, 95%, 5%) !important;
  --tab-outline-color: rgba(14, 210, 247, 0.05) !important;
  --tab-switcher-background: hsl(200deg, 95%, 5%) !important;
  --tab-switcher-menubar-background: linear-gradient(to top, hsl(200deg, 95%, 5%), transparent) !important;
  --tab-text-color: #7fdbca !important;
  ...
  --tab-text-color-focused-highlighted: #ffeb95 !important;
  ...
  --table-drag-handle-color: #7fdbca !important;
  ...
  --tag-color: #ffeb95 !important;
  --tag-color-hover: #ffeb95 !important;
  --tertiary: #8be9fd !important;
  --text-accent: #ffeb95 !important;
  --text-accent-hover: #8be9fd !important;
  --text-bold-color: #50fa7b !important;
  --text-faint: #7fdbca !important;
  --text-highlight-bg: hsla(101deg, 100%, 12%, 0.8) !important;
  --text-italic-bold-color: #b380fb !important;
  --text-italic-color: #ffeb95 !important;
  ...
  --text-title-h2: #82aaff !important;
  --text-title-h3: #c5e478 !important;
  --text-title-h4: #ffb86c !important;
  --text-title-h5: #50fa7b !important;
  --text-title-h6: #8be9fd !important;
  --textHighlight: hsla(101deg, 100%, 12%, 0.8) !important;
  --titlebar-background: hsl(200deg, 95%, 5%) !important;
  --titlebar-background-focused: hsl(203deg, 95%, 6%) !important;
  ...
  --white: #F8F8F3 !important;
  --yellow: #FEFF7F !important;
...
html[saved-theme="dark"] body .text-highlight {
  background-color: rgba(19, 61, 0, 0.8);
  color: rgb(248, 248, 242);
...
html[saved-theme="dark"] body h1 {
  ...
  font-family: Rubik, "Avenir Next", Helvetica, Arial, sans-serif;
}
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --blockquote-border-color: rgba(14, 210, 247, 0.5) !important;
  --blue: #00588E !important;
  --blur-background: color-mix(in srgb, hsl(207deg, 95%, 5%) 65%, transparent) linear-gradient(hsl(207deg, 95%, 5%), color-mix(in srgb, hsl(207deg, 95%, 5%) 65%, transparent)) !important;
  --border-color: #2b2727 !important;
  --border-color-alt: #101014 !important;
  --canvas-background: hsl(207deg, 95%, 5%) !important;
  --canvas-card-label-color: #7fdbca !important;
  ...
  --purple: #9580FF !important;
  --purple-transparent: rgba(149, 128, 255, 0.5) !important;
  --raised-background: color-mix(in srgb, hsl(207deg, 95%, 5%) 65%, transparent) linear-gradient(hsl(207deg, 95%, 5%), color-mix(in srgb, hsl(207deg, 95%, 5%) 65%, transparent)) !important;
  --red: #FF5555 !important;
  --ribbon-background: hsl(200deg, 95%, 5%) !important;
  --ribbon-background-collapsed: hsl(207deg, 95%, 5%) !important;
  --search-clear-button-color: #f8f8f2 !important;
