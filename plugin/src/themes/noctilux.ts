...
export const theme: ThemeData = {
  ...
  --background-primary: var(--color-base-00, #0e0e0e);
  --background-primary-alt: var(--color-base-20, #1a1a1a);
  --background-secondary: var(--color-base-10, #111111);
  --background-secondary-alt: var(--color-base-30, #333);
  --bases-cards-background: var(--background-primary, #0e0e0e);
  ...
  --bases-table-cell-background-active: var(--background-primary, #0e0e0e);
  ...
  --bases-table-header-background: var(--background-primary, #0e0e0e);
  --bases-table-header-color: var(--text-muted, #bbb);
  --bases-table-summary-background: var(--background-primary, #0e0e0e);
  --blockquote-border-color: var(--text-accent, #58a6ff);
  ...
  --canvas-background: var(--background-primary, #0e0e0e);
  ...
  --checkbox-color: var(--interactive-accent, #5e5cff);
  --checkbox-color-hover: var(--interactive-accent-hover, #ffffff);
  --checkbox-marker-color: var(--background-primary, #0e0e0e);
  ...
  --collapse-icon-color-collapsed: var(--text-accent, #58a6ff);
  ...
  --divider-color-hover: var(--interactive-accent, #5e5cff);
  --dropdown-background: var(--interactive-normal, #333);
  --dropdown-background-hover: var(--interactive-hover, #363636);
  --file-header-background: var(--background-primary, #0e0e0e);
  --file-header-background-focused: var(--background-primary, #0e0e0e);
  ...
  --graph-node-focused: var(--text-accent, #58a6ff);
  ...
  --icon-color-active: var(--text-accent, #58a6ff);
  --icon-color-focused: var(--text-normal, #fff);
  --icon-color-hover: var(--text-muted, #bbb);
  --inline-title-color: var(--h1-color, #0fb6d6);
  --input-date-separator: var(--text-faint, #666);
  --input-placeholder-color: var(--text-faint, #666);
  --interactive-accent: var(--focus-color, #5e5cff);
  --interactive-accent-hover: var(--color-accent-1, #ffffff);
  --interactive-hover: var(--color-base-35, #363636);
  --interactive-normal: var(--color-base-30, #333);
  --light: var(--background-primary, var(--color-base-00, #0e0e0e));
  --lightgray: var(--background-secondary, var(--color-base-10, #111111));
  --line-height-normal: 1.6;
  --link-color: var(--text-accent, #58a6ff);
  --link-color-hover: var(--text-accent-hover, #ffffff);
  --link-external-color: var(--text-accent, #58a6ff);
  --link-external-color-hover: var(--text-accent-hover, #ffffff);
  --link-unresolved-color: var(--text-accent, #58a6ff);
  --list-marker-color: var(--text-faint, #666);
  --list-marker-color-collapsed: var(--text-accent, #58a6ff);
  ...
  --modal-background: var(--background-primary, #0e0e0e);
  ...
  --nav-item-color-highlighted: var(--text-accent, #58a6ff);
  ...
  --pdf-background: var(--background-primary, #0e0e0e);
  --pdf-page-background: var(--background-primary, #0e0e0e);
  --pdf-sidebar-background: var(--background-primary, #0e0e0e);
  ...
  --pill-color-remove-hover: var(--text-accent, #58a6ff);
  --prompt-background: var(--background-primary, #0e0e0e);
  ...
  --ribbon-background-collapsed: var(--background-primary, #0e0e0e);
  --search-clear-button-color: var(--text-muted, #bbb);
  --search-icon-color: var(--text-muted, #bbb);
  --search-result-background: var(--background-primary, #0e0e0e);
  --secondary: var(--text-accent, var(--color-accent-1, #58a6ff));
  ...
  --suggestion-background: var(--background-primary, #0e0e0e);
  --tab-background-active: var(--background-primary, #0e0e0e);
  ...
  --tab-text-color-focused-highlighted: var(--text-accent, #58a6ff);
  --table-add-button-border-color: var(--background-modifier-border, #333);
  --table-border-color: var(--background-modifier-border, #333);
  --table-drag-handle-background-active: var(--table-selection-border-color, #5e5cff);
  ...
  --table-selection-border-color: var(--interactive-accent, #5e5cff);
  --tag-color: var(--text-accent, #58a6ff);
  --tag-color-hover: var(--text-accent, #58a6ff);
  --tertiary: var(--text-accent-hover, var(--color-accent-2, #ffffff));
  --text-accent: var(--color-accent-1, #58a6ff);
  ...
  --titlebar-background-focused: var(--background-secondary-alt, #333);
...
html body[data-slug], html body[data-slug] .page > div#quartz-body, html .page > div#quartz-body div.center, html .page > div#quartz-body footer {
  background-color: var(--background-primary, rgb(14, 14, 14));
  color: rgb(255, 255, 255);
}
...
html body p {
  ...
  color: var(--link-external-color, rgb(88, 166, 255));
  outline: rgb(88, 166, 255) none 0px;
  text-decoration-color: rgb(88, 166, 255);
}

html body a.internal-link, html .breadcrumb-container .breadcrumb-element > a {
  color: var(--link-color, rgb(88, 166, 255));
  outline: rgb(88, 166, 255) none 0px;
  text-decoration-color: rgb(88, 166, 255);
}

html body a.internal-link.broken {
  color: var(--link-unresolved-color, rgb(88, 166, 255));
  outline: rgb(88, 166, 255) none 0px;
}`,
    lists: `html body dd {
...
html body .search > .search-container > .search-space {
  background-color: var(--prompt-background, rgb(14, 14, 14));
...
html body a.internal-link.tag-link, html .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  --pill-background: var(--tag-background, rgba(88, 166, 255, 0.15));
  --pill-color: var(--tag-color, #58a6ff);
  --pill-color-hover: var(--tag-color-hover, #58a6ff);
  --pill-color-remove: var(--tag-color, #58a6ff);
  --pill-color-remove-hover: var(--tag-color-hover, #58a6ff);
  background-color: var(--pill-background, rgba(88, 166, 255, 0.15));
...
html body h1 {
  ...
  border-top-color: rgb(15, 182, 214);
  border-top-width: 0px;
  color: var(--h1-color, rgb(15, 182, 214));
...
html body h1.article-title {
  color: var(--inline-title-color, rgb(15, 182, 214));
}

html body h2 {
  border-bottom-color: rgb(203, 219, 229);
  border-bottom-style: solid;
  border-bottom-width: 1px;
  border-left-color: rgb(203, 219, 229);
  border-left-width: 0px;
  border-right-color: rgb(203, 219, 229);
  border-right-width: 0px;
  border-top-color: rgb(203, 219, 229);
  border-top-width: 0px;
  color: var(--h2-color, rgb(203, 219, 229));
  margin-bottom: 20px;
  margin-left: 0px;
  margin-right: 0px;
  margin-top: 0px;
...
html body h3 {
  ...
  border-top-color: rgb(203, 219, 229);
  border-top-width: 0px;
  color: var(--h3-color, rgb(203, 219, 229));
  margin-bottom: 20px;
  margin-left: 0px;
  margin-right: 0px;
...
html body h4 {
  ...
  border-top-color: rgb(203, 219, 229);
  border-top-width: 0px;
  color: var(--h4-color, rgb(203, 219, 229));
  margin-bottom: 20px;
  margin-left: 0px;
  margin-right: 0px;
  margin-top: var(--heading-spacing, 45px);
...
html body h5 {
  ...
  border-top-color: rgb(203, 219, 229);
  border-top-width: 0px;
  color: var(--h5-color, rgb(203, 219, 229));
...
html body h6 {
  ...
  border-top-color: rgb(203, 219, 229);
  border-top-width: 0px;
  color: var(--h6-color, rgb(203, 219, 229));
...
html body hr {
  ...
  color: var(--nav-item-color, rgb(187, 187, 187));
  font-family: system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif;
}
...
html body .stacked-page-header {
  background-color: var(--tab-container-background, rgb(51, 51, 51));
}
...
html body ul.tags > li {
  background-color: var(--tag-background, rgba(88, 166, 255, 0.15));
