...
export const theme: ThemeData = {
  ...
  --accent-1: oklch(from oklch(from hsl(258, 88%, 66%) l c h) l c calc(h + 150)) !important;
  --accent-2: oklch(from oklch(from hsl(258, 88%, 66%) l c h) l c calc(h + 210)) !important;
  ...
  --highlight: oklch(from oklch(from oklch(from hsl(258, 88%, 66%) l c h) l c calc(h + 150)) 50% 20% h / 75%) !important;
  ...
  --nav-item-background-selected: oklch(from oklch(from oklch(from hsl(258, 88%, 66%) l c h) l c calc(h + 210)) 45% c h / 75%) !important;
  ...
  --retroma-folder-border: 1px solid
    oklch(from oklch(from oklch(from hsl(258, 88%, 66%) l c h) l c calc(h + 210)) 55% 20% h / 50%) !important;
  ...
  --rotation-1: 150 !important;
  --rotation-2: 210 !important;
  ...
  --table-header-background: oklch(from oklch(from oklch(from hsl(258, 88%, 66%) l c h) l c calc(h + 150)) 50% c h / 30%) !important;
  ...
  --text-highlight-bg: oklch(from oklch(from oklch(from hsl(258, 88%, 66%) l c h) l c calc(h + 150)) 50% 20% h / 75%) !important;
  --text-selection: oklch(from oklch(from oklch(from hsl(258, 88%, 66%) l c h) l c calc(h + 210)) 45% c h / 75%) !important;
  --text-success: oklch(
    from #4caf50 70% 20% h
  ) !important;
  --text-warning: oklch(
  ...
  --textHighlight: oklch(from oklch(from oklch(from hsl(258, 88%, 66%) l c h) l c calc(h + 150)) 50% 20% h / 75%) !important;
...
html[saved-theme="dark"] body[data-slug], html[saved-theme="dark"] body[data-slug] .page > div#quartz-body, html[saved-theme="dark"] .page > div#quartz-body div.center, html[saved-theme="dark"] .page > div#quartz-body footer {
  background-color: oklch(0.24 0.0651659 142.489);
}

html[saved-theme="dark"] body .page > div#quartz-body div.sidebar {
  background-color: oklch(0.22 0.0651659 142.489);
}
...
html[saved-theme="dark"] body .text-highlight {
  background-color: oklch(0.5 0.08 82.4895 / 0.75);
  font-family: "??", "??", "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
}
...
html[saved-theme="dark"] body tr {
  background-color: oklch(0.5 0.21722 82.4895 / 0.3);
  border-bottom-color: oklch(0.22 0.0651659 142.489);
  border-left-color: oklch(0.22 0.0651659 142.489);
  border-right-color: oklch(0.22 0.0651659 142.489);
  border-top-color: oklch(0.22 0.0651659 142.489);
...
html[saved-theme="dark"] body .nav-files-container li:has(> .folder-outer:not(.open)) > .nav-folder-title {
  ...
  background-color: oklch(0.14 0.0651659 142.489);
  border-bottom-color: oklch(0.12 0.0651659 82.4895);
  border-left-color: oklch(0.12 0.0651659 82.4895);
...
html[saved-theme="dark"] body .stacked-page-header {
  background-color: oklch(0.12 0.0651659 82.4895);
}
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  light: {
    base: `:root:root {
  --accent-1: oklch(from oklch(from hsl(calc(258 - 1), calc(88% * 1.01), calc(66% * 1.075)) l c h) l c calc(h + 150)) !important;
  --accent-2: oklch(from oklch(from hsl(calc(258 - 1), calc(88% * 1.01), calc(66% * 1.075)) l c h) l c calc(h + 210)) !important;
  --background-modifier-border: oklch(from oklch(
  ...
  --header-height: 48px !important;
  --highlight: oklch(from oklch(from oklch(from hsl(calc(258 - 1), calc(88% * 1.01), calc(66% * 1.075)) l c h) l c calc(h + 150)) 80% 30% h / 75%) !important;
  ...
  --nav-indentation-guide-width: 2px !important;
  --nav-item-background-selected: oklch(from oklch(from oklch(from hsl(calc(258 - 1), calc(88% * 1.01), calc(66% * 1.075)) l c h) l c calc(h + 210)) 80% 30% h / 75%) !important;
  --nav-item-radius: 8px !important;
  ...
  --retroma-folder-border: 1px solid
    oklch(from oklch(from oklch(from hsl(calc(258 - 1), calc(88% * 1.01), calc(66% * 1.075)) l c h) l c calc(h + 210)) 55% 30% h / 50%) !important;
  --retroma-folder-box-shadow: -1px 1px 0px oklch(
    from oklch(from oklch(from hsl(calc(258 - 1), calc(88% * 1.01), calc(66% * 1.075)) l c h) l c calc(h + 210)) 60% calc(c * 0.4) h
  ) !important;
  --ribbon-background: oklch(
  ...
  --table-header-background: oklch(from oklch(from oklch(from hsl(calc(258 - 1), calc(88% * 1.01), calc(66% * 1.075)) l c h) l c calc(h + 150)) 50% c h / 30%) !important;
  ...
  --text-highlight-bg: oklch(from oklch(from oklch(from hsl(calc(258 - 1), calc(88% * 1.01), calc(66% * 1.075)) l c h) l c calc(h + 150)) 80% 30% h / 75%) !important;
  --text-selection: oklch(from oklch(from oklch(from hsl(calc(258 - 1), calc(88% * 1.01), calc(66% * 1.075)) l c h) l c calc(h + 210)) 80% 30% h / 75%) !important;
  --text-success: oklch(
    from #4caf50 50% 30% h
  ) !important;
  --text-warning: oklch(
  ...
  --textHighlight: oklch(from oklch(from oklch(from hsl(calc(258 - 1), calc(88% * 1.01), calc(66% * 1.075)) l c h) l c calc(h + 150)) 80% 30% h / 75%) !important;
  --titlebar-background: oklch(
    from oklch(from oklch(from hsl(calc(258 - 1), calc(88% * 1.01), calc(66% * 1.075)) l c h) l c calc(h + 150)) 65% calc(c * 0.4) h
  ) !important;
  --titlebar-background-focused: oklch(
...
html[saved-theme="light"] body[data-slug], html[saved-theme="light"] body[data-slug] .page > div#quartz-body, html[saved-theme="light"] .page > div#quartz-body div.center, html[saved-theme="light"] .page > div#quartz-body footer {
  background-color: oklch(0.98 0.0756873 143.559);
}

html[saved-theme="light"] body .page > div#quartz-body div.sidebar {
  background-color: oklch(0.93 0.0756873 143.559);
}
...
html[saved-theme="light"] body .text-highlight {
  background-color: oklch(0.8 0.12 83.5585 / 0.75);
  font-family: "??", "??", "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
}
...
html[saved-theme="light"] body tr {
  background-color: oklch(0.5 0.189218 83.5585 / 0.3);
  border-bottom-color: oklch(0.93 0.0756873 143.559);
  border-left-color: oklch(0.93 0.0756873 143.559);
  border-right-color: oklch(0.93 0.0756873 143.559);
  border-top-color: oklch(0.93 0.0756873 143.559);
...
html[saved-theme="light"] body .nav-files-container li:has(> .folder-outer:not(.open)) > .nav-folder-title {
  ...
  background-color: oklch(0.6 0.0756873 143.559);
  border-bottom-color: oklch(0.65 0.0756873 83.5585);
  border-left-color: oklch(0.65 0.0756873 83.5585);
  border-left-width: 0px;
  border-right-color: oklch(0.65 0.0756873 83.5585);
...
html[saved-theme="light"] body .stacked-page-header {
  background-color: oklch(0.65 0.0756873 83.5585);
}
