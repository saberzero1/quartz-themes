...
export const theme: ThemeData = {
  ...
  --accent-1: oklch(from oklch(from hsl(258, 88%, 66%) l c h) l c calc(h + 150));
  --accent-2: oklch(from oklch(from hsl(258, 88%, 66%) l c h) l c calc(h + 210));
  ...
  --header-height: 48px;
  --highlight: var(--text-highlight-bg, oklch(from oklch(from oklch(from hsl(258, 88%, 66%) l c h) l c calc(h + 150)) 50% 20% h / 75%));
  ...
  --nav-item-background-selected: oklch(from oklch(from oklch(from hsl(258, 88%, 66%) l c h) l c calc(h + 210)) 45% c h / 75%);
  --nav-item-radius: 8px;
  ...
  --retroma-folder-border: 1px solid
    oklch(from oklch(from oklch(from hsl(258, 88%, 66%) l c h) l c calc(h + 210)) 55% 20% h / 50%);
  ...
  --table-header-background: oklch(from oklch(from oklch(from hsl(258, 88%, 66%) l c h) l c calc(h + 150)) 50% c h / 30%);
  ...
  --text-highlight-bg: oklch(from oklch(from oklch(from hsl(258, 88%, 66%) l c h) l c calc(h + 150)) 50% 20% h / 75%);
  --text-selection: oklch(from oklch(from oklch(from hsl(258, 88%, 66%) l c h) l c calc(h + 210)) 45% c h / 75%);
  --text-success: oklch(
    from #4caf50 70% 20% h
  );
  --text-warning: oklch(
  ...
  --textHighlight: var(--text-highlight-bg, oklch(from oklch(from oklch(from hsl(258, 88%, 66%) l c h) l c calc(h + 150)) 50% 20% h / 75%));
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  light: {
    base: `:root:root {
  --accent-1: oklch(from oklch(from hsl(calc(258 - 1), calc(88% * 1.01), calc(66% * 1.075)) l c h) l c calc(h + 150));
  --accent-2: oklch(from oklch(from hsl(calc(258 - 1), calc(88% * 1.01), calc(66% * 1.075)) l c h) l c calc(h + 210));
  --background-modifier-border: oklch(from oklch(
  ...
  --header-height: 48px;
  --highlight: var(--text-highlight-bg, oklch(from oklch(from oklch(from hsl(calc(258 - 1), calc(88% * 1.01), calc(66% * 1.075)) l c h) l c calc(h + 150)) 80% 30% h / 75%));
  ...
  --nav-indentation-guide-width: 2px;
  --nav-item-background-selected: oklch(from oklch(from oklch(from hsl(calc(258 - 1), calc(88% * 1.01), calc(66% * 1.075)) l c h) l c calc(h + 210)) 80% 30% h / 75%);
  --nav-item-radius: 8px;
  ...
  --retroma-folder-border: 1px solid
    oklch(from oklch(from oklch(from hsl(calc(258 - 1), calc(88% * 1.01), calc(66% * 1.075)) l c h) l c calc(h + 210)) 55% 30% h / 50%);
  --retroma-folder-box-shadow: -1px 1px 0px oklch(
    from oklch(from oklch(from hsl(calc(258 - 1), calc(88% * 1.01), calc(66% * 1.075)) l c h) l c calc(h + 210)) 60% calc(c * 0.4) h
  );
  --ribbon-background: oklch(
  ...
  --table-header-background: oklch(from oklch(from oklch(from hsl(calc(258 - 1), calc(88% * 1.01), calc(66% * 1.075)) l c h) l c calc(h + 150)) 50% c h / 30%);
  ...
  --text-highlight-bg: oklch(from oklch(from oklch(from hsl(calc(258 - 1), calc(88% * 1.01), calc(66% * 1.075)) l c h) l c calc(h + 150)) 80% 30% h / 75%);
  --text-selection: oklch(from oklch(from oklch(from hsl(calc(258 - 1), calc(88% * 1.01), calc(66% * 1.075)) l c h) l c calc(h + 210)) 80% 30% h / 75%);
  --text-success: oklch(
    from #4caf50 50% 30% h
  );
  --text-warning: oklch(
  ...
  --textHighlight: var(--text-highlight-bg, oklch(from oklch(from oklch(from hsl(calc(258 - 1), calc(88% * 1.01), calc(66% * 1.075)) l c h) l c calc(h + 150)) 80% 30% h / 75%));
  --titlebar-background: oklch(
    from oklch(from oklch(from hsl(calc(258 - 1), calc(88% * 1.01), calc(66% * 1.075)) l c h) l c calc(h + 150)) 65% calc(c * 0.4) h
  );
  --titlebar-background-focused: oklch(
...
html[saved-theme="light"] body .nav-files-container li:has(> .folder-outer:not(.open)) > .nav-folder-title {
  ...
  border-top-left-radius: 0px;
  border-top-width: 0px;
  color: oklch(from var(--background-paper) 100% c h, oklch(1 0.0756873 143.559));
}
