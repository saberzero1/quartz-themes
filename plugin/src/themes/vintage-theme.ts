...
export const theme: ThemeData = {
  ...
  dark: {
    base: `:root:root {
  --background-primary: #333333 !important;
  --background-primary-alt: #474747 !important;
  --background-secondary: #5b5b5b !important;
  --background-secondary-alt: #707070 !important;
  --bases-cards-background: #333333 !important;
  --bases-cards-cover-background: #474747 !important;
  --bases-group-heading-property-color: #ECEFF4 !important;
  --bases-table-cell-background-active: #333333 !important;
  --bases-table-cell-background-disabled: #474747 !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px #e3dacf !important;
  --bases-table-group-background: #474747 !important;
  --bases-table-header-background: #333333 !important;
  --bases-table-header-color: #ECEFF4 !important;
  --bases-table-summary-background: #333333 !important;
  --blockquote-border-color: #e3dacf !important;
  --blue: #5E81AC !important;
  --blue2: #88C0D0 !important;
  --canvas-background: #333333 !important;
  --canvas-card-label-color: #ECEFF4 !important;
  --caret-color: #e3dacf !important;
  --checkbox-border-color: #ECEFF4 !important;
  --checkbox-border-color-hover: #ECEFF4 !important;
  --checkbox-color: #e3dacf !important;
  --checkbox-marker-color: #333333 !important;
  --checklist-done-color: #ECEFF4 !important;
  --code-background: #474747 !important;
  --code-comment: #ECEFF4 !important;
  --code-normal: #e3dacf !important;
  --code-punctuation: #ECEFF4 !important;
  --collapse-icon-color: #ECEFF4 !important;
  --dark: #e3dacf !important;
  --dark0: #333333 !important;
  --dark1: #474747 !important;
  --dark2: #5b5b5b !important;
  --dark3: #707070 !important;
  --darkgray: #e3dacf !important;
  --default-font-size: 20px !important;
  --default-line-height: 34px !important;
  --divider-color-hover: #e3dacf !important;
  --editor-font-size-override: 18px !important;
  --editor-line-height: 29px !important;
  --embed-border-start: 2px solid #e3dacf !important;
  --file-header-background: #333333 !important;
  --file-header-background-focused: #333333 !important;
  --flair-color: #e3dacf !important;
  --font-sans-serif: "Lato", "Helvetica Neue", Helvetica, sans-serif !important;
  --font-serif: 'Newsreader', Georgia, serif !important;
  --footnote-id-color: #ECEFF4 !important;
  --footnote-id-color-no-occurrences: #ECEFF4 !important;
  --graph-node: #ECEFF4 !important;
  --graph-node-unresolved: #ECEFF4 !important;
  --graph-text: #e3dacf !important;
  --gray: #999999 !important;
  --gray-dark: #4C566A !important;
  --gray-light: #ECEFF4 !important;
  --heading-formatting: #ECEFF4 !important;
  --icon-color: #ECEFF4 !important;
  --icon-color-focused: #e3dacf !important;
  --icon-color-hover: #ECEFF4 !important;
  --input-date-separator: #ECEFF4 !important;
  --input-placeholder-color: #ECEFF4 !important;
  --interactive-accent: #e3dacf !important;
  --light: #333333 !important;
  --light0: #fdf3e7 !important;
  --light1: #e3dacf !important;
  --light2: #fdf7f0 !important;
  --light3: #fefcfa !important;
  --lightgray: #5b5b5b !important;
  --list-marker-color: #ECEFF4 !important;
  --list-marker-color-hover: #ECEFF4 !important;
  --menu-background: #5b5b5b !important;
  --metadata-input-text-color: #e3dacf !important;
  ...
  --monospace-font-size: 18px !important;
  --monospace-line-height: 26px !important;
  --nav-collapse-icon-color: #ECEFF4 !important;
  --nav-collapse-icon-color-collapsed: #ECEFF4 !important;
  --nav-heading-color: #e3dacf !important;
  --nav-heading-color-collapsed: #ECEFF4 !important;
  --nav-heading-color-collapsed-hover: #ECEFF4 !important;
  --nav-heading-color-hover: #e3dacf !important;
  --nav-item-color: #ECEFF4 !important;
  --nav-item-color-active: #e3dacf !important;
  --nav-item-color-hover: #e3dacf !important;
  --nav-item-color-selected: #e3dacf !important;
  --nav-tag-color: #ECEFF4 !important;
  --nav-tag-color-active: #ECEFF4 !important;
  --nav-tag-color-hover: #ECEFF4 !important;
  --pdf-background: #333333 !important;
  --pdf-page-background: #333333 !important;
  --pdf-sidebar-background: #333333 !important;
  --pill-color: #ECEFF4 !important;
  --pill-color-hover: #e3dacf !important;
  --pill-color-remove: #ECEFF4 !important;
  --prompt-background: #333333 !important;
  --red: #c63d0f !important;
  --red1: #cb5026 !important;
  --red2: #d1633e !important;
  --ribbon-background: #5b5b5b !important;
  --ribbon-background-collapsed: #333333 !important;
  --search-clear-button-color: #ECEFF4 !important;
  --search-icon-color: #ECEFF4 !important;
  --search-result-background: #333333 !important;
  --secondary: #e3dacf !important;
  --setting-group-heading-color: #e3dacf !important;
  --setting-items-background: #474747 !important;
  --shiki-active-tab-border-color: #ECEFF4 !important;
  --shiki-code-background: #474747 !important;
  --shiki-code-comment: #ECEFF4 !important;
  --shiki-code-normal: #ECEFF4 !important;
  --shiki-code-punctuation: #ECEFF4 !important;
  --shiki-gutter-text-color: #ECEFF4 !important;
  --shiki-gutter-text-color-highlight: #ECEFF4 !important;
  --shiki-highlight-neutral: #ECEFF4 !important;
  --shiki-terminal-dots-color: #ECEFF4 !important;
  --small-font-size: 16px !important;
  --small-line-height: 24px !important;
  --status-bar-background: #5b5b5b !important;
  --status-bar-text-color: #ECEFF4 !important;
  --suggestion-background: #333333 !important;
  --tab-background-active: #333333 !important;
  --tab-container-background: #5b5b5b !important;
  --tab-switcher-background: #5b5b5b !important;
  --tab-switcher-menubar-background: linear-gradient(to top, #5b5b5b, transparent) !important;
  ...
  --tab-text-color-focused-active-current: #e3dacf !important;
  --table-drag-handle-background-active: #e3dacf !important;
  --table-drag-handle-color: #ECEFF4 !important;
  --table-drag-handle-color-active: #333333 !important;
  --table-header-color: #e3dacf !important;
  --table-selection-border-color: #e3dacf !important;
  --text-faint: #ECEFF4 !important;
  --text-muted: #ECEFF4 !important;
  --text-normal: #e3dacf !important;
  --text-on-accent: #333333 !important;
  --titlebar-background: #5b5b5b !important;
  --titlebar-background-focused: #707070 !important;
  --titlebar-text-color: #ECEFF4 !important;
  --titlebar-text-color-focused: #e3dacf !important;
  --vault-profile-color: #e3dacf !important;
  --vault-profile-color-hover: #e3dacf !important;
  --yellow: #ebc06c !important;
  --yellow2: #b49c5f !important;
...
html body .text-highlight {
  background-color: rgb(235, 192, 108);
  color: rgb(253, 243, 231);
  font-family: Newsreader, Georgia, serif;
  outline: rgb(253, 243, 231) none 0px;
  text-decoration-color: rgb(253, 243, 231);
...
html body li.task-list-item input[type="checkbox"]:checked {
  background-color: rgb(227, 218, 207);
