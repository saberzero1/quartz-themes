...
export const theme: ThemeData = {
  ...
  --dark: var(--text-normal, #bebebe);
  --darkgray: var(--text-normal, #bebebe);
  ...
  --highlight: var(--text-highlight-bg, rgba(244, 86, 157, 0.25));
  ...
  --light: var(--background-primary, #100e17);
  --lightgray: var(--background-secondary, #191621);
  --link-color: #0fb6d6;
  ...
  --secondary: var(--text-accent, #0fb6d6);
  ...
  --tertiary: var(--interactive-accent-hover, rgba(14, 210, 247, 0.8));
  ...
  --textHighlight: var(--text-highlight-bg, rgba(244, 86, 157, 0.25));
