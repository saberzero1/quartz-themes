...
export const theme: ThemeData = {
  ...
  --background-primary: var(--color-base-00, #100e17);
  --background-primary-alt: var(--color-base-10, #0d0b12);
  --background-secondary: var(--color-base-20, #191621);
  --background-secondary-alt: var(--color-base-30, #0d0b12);
  --bases-cards-background: var(--background-primary, #100e17);
  ...
  --bases-table-border-color: var(--table-border-color, rgb(14, 210, 247, 0.15));
  --bases-table-cell-background-active: var(--background-primary, #100e17);
  ...
  --bases-table-header-background: var(--background-primary, #100e17);
  --bases-table-summary-background: var(--background-primary, #100e17);
  ...
  --canvas-background: var(--background-primary, #100e17);
  --canvas-card-label-color: var(--text-faint, #7aa2f7);
  --caret-color: var(--text-normal, #bebebe);
  --checkbox-border-color: var(--text-faint, #7aa2f7);
  ...
  --checkbox-marker-color: var(--background-primary, #100e17);
  --code-background: var(--background-secondary, #191621);
  --code-border-color: var(--background-modifier-border, rgba(14, 210, 247, 0.05));
  --code-comment: var(--text-faint, #7aa2f7);
  --code-mono-font: 'OperatorMonoSSmLig-Book';
  --code-normal: var(--text-normal, #bebebe);
  --collapse-icon-color: var(--text-faint, #7aa2f7);
  --collapse-icon-color-collapsed: var(--text-accent, #0fb6d6);
  --dark: var(--text-normal, var(--color-base-100, #bebebe));
  --darkgray: var(--text-normal, var(--color-base-100, #bebebe));
  ...
  --file-header-background: var(--background-primary, #100e17);
  --file-header-background-focused: var(--background-primary, #100e17);
  ...
  --flair-color: var(--text-normal, #bebebe);
  --font-family-editor: 'Rubik';
  --font-family-preview: 'Rubik';
  --footnote-divider-color: var(--metadata-divider-color, rgba(14, 210, 247, 0.05));
  --footnote-id-color-no-occurrences: var(--text-faint, #7aa2f7);
  --graph-node-focused: var(--text-accent, #0fb6d6);
  --graph-node-unresolved: var(--text-faint, #7aa2f7);
  --graph-text: var(--text-normal, #bebebe);
  --gray: var(--text-faint, var(--color-base-50, #7aa2f7));
  --heading-formatting: var(--text-faint, #7aa2f7);
  --hr-color: var(--background-modifier-border, rgba(14, 210, 247, 0.05));
  --icon-color-active: var(--text-accent, #0fb6d6);
  --icon-color-focused: var(--text-normal, #bebebe);
  --input-date-separator: var(--text-faint, #7aa2f7);
  --input-placeholder-color: var(--text-faint, #7aa2f7);
  ...
  --light: var(--background-primary, var(--color-base-00, #100e17));
  --lightgray: var(--background-secondary, var(--color-base-20, #191621));
  --link-color: var(--text-accent, #0fb6d6);
  --link-external-color: var(--text-accent, #0fb6d6);
  --link-unresolved-color: var(--text-accent, #0fb6d6);
  --list-marker-color: var(--text-faint, #7aa2f7);
  --list-marker-color-collapsed: var(--text-accent, #0fb6d6);
  --menu-background: var(--background-secondary, #191621);
  ...
  --metadata-input-font: var(--font-interface, Rubik, Glow Sans SC, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto,
    Helvetica, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  --metadata-input-text-color: var(--text-normal, #bebebe);
  --metadata-label-font: var(--font-interface, Rubik, Glow Sans SC, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto,
    Helvetica, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  --modal-background: var(--background-primary, #100e17);
  --nav-collapse-icon-color: var(--collapse-icon-color, #7aa2f7);
  --nav-collapse-icon-color-collapsed: var(--text-faint, #7aa2f7);
  --nav-heading-color: var(--text-normal, #bebebe);
  --nav-heading-color-collapsed: var(--text-faint, #7aa2f7);
  --nav-heading-color-hover: var(--text-normal, #bebebe);
  --nav-item-color-active: var(--text-normal, #bebebe);
  --nav-item-color-highlighted: var(--text-accent, #0fb6d6);
  --nav-item-color-hover: var(--text-normal, #bebebe);
  --nav-item-color-selected: var(--text-normal, #bebebe);
  --nav-tag-color: var(--text-faint, #7aa2f7);
  --pdf-background: var(--background-primary, #100e17);
  --pdf-page-background: var(--background-primary, #100e17);
  --pdf-sidebar-background: var(--background-primary, #100e17);
  --pill-border-color: var(--background-modifier-border, rgba(14, 210, 247, 0.05));
  --pill-color-hover: var(--text-normal, #bebebe);
  --pill-color-remove: var(--text-faint, #7aa2f7);
  --pill-color-remove-hover: var(--text-accent, #0fb6d6);
  --prompt-background: var(--background-primary, #100e17);
  --ribbon-background: var(--background-secondary, #191621);
  --ribbon-background-collapsed: var(--background-primary, #100e17);
  --search-result-background: var(--background-primary, #100e17);
  --secondary: var(--text-accent, var(--color-accent-1, #0fb6d6));
  --setting-group-heading-color: var(--text-normal, #bebebe);
  ...
  --shiki-code-background: var(--code-background, #191621);
  --shiki-code-comment: var(--text-faint, #7aa2f7);
  --shiki-gutter-border-color: var(--background-modifier-border, rgba(14, 210, 247, 0.05));
  --shiki-gutter-text-color: var(--text-faint, #7aa2f7);
  --shiki-terminal-dots-color: var(--text-faint, #7aa2f7);
  --slider-track-background: var(--background-modifier-border, rgba(14, 210, 247, 0.05));
  --status-bar-background: var(--background-secondary, #191621);
  --status-bar-border-color: var(--divider-color, rgba(14, 210, 247, 0.05));
  --suggestion-background: var(--background-primary, #100e17);
  --tab-background-active: var(--background-primary, #100e17);
  --tab-container-background: var(--background-secondary, #191621);
  --tab-outline-color: var(--divider-color, rgba(14, 210, 247, 0.05));
  --tab-switcher-background: var(--background-secondary, #191621);
  --tab-text-color: var(--text-faint, #7aa2f7);
  --tab-text-color-focused-active-current: var(--text-normal, #bebebe);
  --tab-text-color-focused-highlighted: var(--text-accent, #0fb6d6);
  --table-add-button-border-color: var(--background-modifier-border, rgba(14, 210, 247, 0.05));
  --table-border-color: var(--background-modifier-border, rgb(14, 210, 247, 0.15));
  --table-drag-handle-background-active: var(--table-selection-border-color, rgba(14, 210, 247, 0.5));
  --table-drag-handle-color: var(--text-faint, #7aa2f7);
  --table-header-border-color: var(--table-border-color, rgb(14, 210, 247, 0.15));
  --table-header-color: var(--text-normal, #bebebe);
  --table-selection-border-color: var(--interactive-accent, rgba(14, 210, 247, 0.5));
  --tag-color: var(--text-accent, #0fb6d6);
  --tag-color-hover: var(--text-accent, #0fb6d6);
  ...
  --tertiary: var(--interactive-accent-hover, var(--color-accent-1, rgba(14, 210, 247, 0.8)));
  --test-color: rgb(122, 162, 247);
  --text-a: #6bcafb;
  --text-a-hover: #6bcafb;
  --text-accent: var(--color-accent-1, #0fb6d6);
  --text-dim: #45aaff;
  --text-faint: var(--color-base-50, #7aa2f7);
  --text-link: #b4b4b4;
  --text-mark: #263d92;
  --text-normal: var(--color-base-100, #bebebe);
  --text-sub-accent: #f4569d;
  --text-title-h1: var(--text-accent, #0fb6d6);
  --text-title-h2: #cbdbe5;
  --text-title-h3: #cbdbe5;
  --text-title-h4: #cbdbe5;
  --text-title-h5: #cbdbe5;
  --titlebar-background: var(--background-secondary, #191621);
  ...
  --titlebar-text-color-focused: var(--text-normal, #bebebe);
  --vault-profile-color: var(--text-normal, #bebebe);
  --vault-profile-color-hover: var(--vault-profile-color, #bebebe);
...
html body[data-slug] div#quartz-root.page, html .page > div#quartz-body div.sidebar.left, html .page > div#quartz-body div.sidebar.left:has(.explorer), html .page > div#quartz-body div.sidebar.left .explorer .explorer-content {
  --bases-table-header-background: var(--background-secondary, #191621);
  background-color: var(--tab-container-background, rgb(25, 22, 33));
  color: rgb(190, 190, 190);
}

html body[data-slug], html body[data-slug] .page > div#quartz-body, html .page > div#quartz-body div.center, html .page > div#quartz-body footer {
  background-color: var(--background-primary, rgb(16, 14, 23));
  color: rgb(190, 190, 190);
}

html body .page > div#quartz-body div.sidebar {
  background-color: var(--background-secondary, rgb(25, 22, 33));
  color: rgb(190, 190, 190);
}
...
html body .text-highlight {
  background-color: var(--text-highlight-bg, rgba(244, 86, 157, 0.25));
  color: var(--text-normal, rgb(190, 190, 190));
...
html body a.internal-link, html .breadcrumb-container .breadcrumb-element > a {
  color: var(--link-color, rgb(15, 182, 214));
  outline: rgb(15, 182, 214) none 0px;
  text-decoration-color: rgb(15, 182, 214);
}

html body a.internal-link.broken {
  color: var(--link-unresolved-color, rgb(15, 182, 214));
  outline: rgb(15, 182, 214) none 0px;
  text-decoration-color: var(--link-unresolved-decoration-color, rgb(15, 182, 214));
}`,
    lists: `html body dd {
  color: rgb(190, 190, 190);
}
...
html body ul.overflow {
  ...
  color: var(--text-faint, rgb(122, 162, 247));
}
...
html body td {
  ...
  color: var(--table-text-color, rgb(190, 190, 190));
}
...
html body th {
  ...
  border-right-color: rgba(14, 210, 247, 0.15);
  border-top-color: rgba(14, 210, 247, 0.15);
  color: var(--table-header-color, rgb(190, 190, 190));
}`,
    code: `html body code {
...
html body pre:has(> code) {
  background-color: var(--code-background, rgb(25, 22, 33));
...
html body figure {
  --code-background: var(--ec-frm-edBg, #191621);
  border-bottom-color: rgb(190, 190, 190);
  border-left-color: rgb(190, 190, 190);
  border-right-color: rgb(190, 190, 190);
  border-top-color: rgb(190, 190, 190);
...
html body li.task-list-item[data-task="!"] {
  ...
  --shiki-gutter-text-color: #7aa2f7;
  ...
  --shiki-terminal-dots-color: #7aa2f7;
  ...
  color: var(--interactive-accent, rgba(14, 210, 247, 0.5));
  content: "";
...
html body .search > .search-container > .search-space {
  background-color: var(--prompt-background, rgb(16, 14, 23));
}
...
html body a.internal-link.tag-link, html .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  ...
  --pill-color: var(--tag-color, #0fb6d6);
  --pill-color-hover: var(--tag-color-hover, #0fb6d6);
  --pill-color-remove: var(--tag-color, #0fb6d6);
  --pill-color-remove-hover: var(--tag-color-hover, #0fb6d6);
...
html body h1 {
  color: var(--text-title-h1, rgb(15, 182, 214));
}

html body h1.article-title {
  color: var(--inline-title-color, rgb(190, 190, 190));
}

html body h2 {
  color: var(--text-title-h2, rgb(203, 219, 229));
}
...
html body h3 {
  color: var(--text-title-h3, rgb(203, 219, 229));
}

html body h4 {
  color: var(--text-title-h4, rgb(203, 219, 229));
}

html body h5 {
  color: var(--text-title-h5, rgb(203, 219, 229));
}
...
html body .note-properties-tags {
  ...
  --pill-color-remove-hover: var(--tag-color-hover, #0fb6d6);
  background-color: var(--pill-background, rgba(14, 210, 247, 0.15));
  color: var(--pill-color, rgb(15, 182, 214));
}
...
html body kbd {
  ...
  border-right-color: rgb(190, 190, 190);
  border-top-color: rgb(190, 190, 190);
  color: var(--code-normal, rgb(190, 190, 190));
}
...
html body ul.tags > li {
  background-color: var(--tag-background, rgba(14, 210, 247, 0.15));
  ...
  color: var(--text-accent, rgb(15, 182, 214));
}`,
  },
  light: {},
};
