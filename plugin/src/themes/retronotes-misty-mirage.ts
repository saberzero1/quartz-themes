...
export const theme: ThemeData = {
  ...
  --shiki-active-tab-border-color: rgba(249, 248, 249, 0.85) !important;
  --shiki-code-background: rgba(145, 129, 170, 0.2) !important;
  --shiki-code-comment: rgba(249, 248, 249, 0.65) !important;
  --shiki-code-function: #5a7a4d !important;
  --shiki-code-important: #b3682a !important;
  --shiki-code-keyword: #b16982 !important;
  --shiki-code-normal: rgba(249, 248, 249, 0.85) !important;
  --shiki-code-property: #438f93 !important;
  --shiki-code-punctuation: rgba(249, 248, 249, 0.85) !important;
  --shiki-code-string: #c29938 !important;
  --shiki-code-value: #5f4a8c !important;
  --shiki-gutter-border-color: #9181aa !important;
  --shiki-gutter-text-color: rgba(249, 248, 249, 0.65) !important;
  --shiki-gutter-text-color-highlight: rgba(249, 248, 249, 0.85) !important;
  --shiki-highlight-green: rgba(90, 122, 77, 0.5) !important;
  --shiki-highlight-green-background: rgba(90, 122, 77, 0.1) !important;
  --shiki-highlight-neutral: rgba(249, 248, 249, 0.85) !important;
  --shiki-highlight-red: rgba(138, 46, 46, 0.5) !important;
  --shiki-highlight-red-background: rgba(138, 46, 46, 0.1) !important;
  --shiki-terminal-dots-color: rgba(249, 248, 249, 0.65) !important;
  --shiki-tooltip-background: #7d699b !important;
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --shiki-active-tab-border-color: rgba(3, 6, 10, 0.85) !important;
  --shiki-code-background: rgba(173, 157, 107, 0.2) !important;
  --shiki-code-comment: rgba(3, 6, 10, 0.65) !important;
  --shiki-code-function: #719461 !important;
  --shiki-code-important: #db8134 !important;
  --shiki-code-keyword: #dc84a3 !important;
  --shiki-code-normal: rgba(3, 6, 10, 0.85) !important;
  --shiki-code-property: #53b3b8 !important;
  --shiki-code-punctuation: rgba(3, 6, 10, 0.85) !important;
  --shiki-code-string: #f2ba44 !important;
  --shiki-code-value: #775cb0 !important;
  --shiki-gutter-border-color: #ad9d6b !important;
  --shiki-gutter-text-color: rgba(3, 6, 10, 0.65) !important;
  --shiki-gutter-text-color-highlight: rgba(3, 6, 10, 0.85) !important;
  --shiki-highlight-green: rgba(113, 148, 97, 0.5) !important;
  --shiki-highlight-green-background: rgba(113, 148, 97, 0.1) !important;
  --shiki-highlight-neutral: rgba(3, 6, 10, 0.85) !important;
  --shiki-highlight-red: rgba(180, 60, 60, 0.5) !important;
  --shiki-highlight-red-background: rgba(180, 60, 60, 0.1) !important;
  --shiki-terminal-dots-color: rgba(3, 6, 10, 0.65) !important;
  --shiki-tooltip-background: #bbad85 !important;
