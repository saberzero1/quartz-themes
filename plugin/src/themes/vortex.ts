...
export const theme: ThemeData = {
  ...
  --bases-cards-shadow: 0 0 0 1px color-mix(in srgb, hsl(258, 88%, 66%) 5%, transparent);
  --bases-embed-border-color: color-mix(in srgb, hsl(258, 88%, 66%) 5%, transparent);
  ...
  --bodyFont: var(--font-interface, Rubik, Segoe UI, Roboto, Arial, sans-serif, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  ...
  --codeFont: var(--font-interface, Rubik, Segoe UI, Roboto, Arial, sans-serif, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  ...
  --embed-block-shadow-hover: 0 0 0 1px color-mix(in srgb, hsl(258, 88%, 66%) 5%, transparent), inset 0 0 0 1px color-mix(in srgb, hsl(258, 88%, 66%) 5%, transparent);
  ...
  --footnote-divider-color: color-mix(in srgb, hsl(258, 88%, 66%) 5%, transparent);
  --gradient-bold: linear-gradient(135deg, #00eaff, #ff008c);
  --headerFont: var(--font-interface, Rubik, Segoe UI, Roboto, Arial, sans-serif, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  ...
  --metadata-border-color: color-mix(in srgb, hsl(258, 88%, 66%) 5%, transparent);
  --metadata-divider-color: color-mix(in srgb, hsl(258, 88%, 66%) 5%, transparent);
  ...
  --pill-border-color: color-mix(in srgb, hsl(258, 88%, 66%) 5%, transparent);
  ...
  --slider-track-background: color-mix(in srgb, hsl(258, 88%, 66%) 40%, transparent);
  --status-bar-background: #1a1a1a;
  --status-bar-border-color: color-mix(in srgb, hsl(258, 88%, 66%) 5%, transparent);
  --sub-accent: #f4569d;
  ...
  --titleFont: var(--font-interface, Rubik, Segoe UI, Roboto, Arial, sans-serif, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  --titlebar-background: #1a1a1a;
  --titlebar-background-focused: #0d0b12;
  --titlebar-border-color: color-mix(in srgb, hsl(258, 88%, 66%) 5%, transparent);
  --vault-profile-color-hover: hsl(258, 88%, 66%);
...
html[saved-theme="dark"] body .callout[data-callout="analysis"] {
  --callout-color: 50, 150, 255;
  --table-border-color: color-mix(in srgb, rgb(50, 150, 255) 25%, #111111 50%);
...
html[saved-theme="dark"] body .callout[data-callout="bookmark"] {
  ...
  --table-border-color: color-mix(in srgb, rgb(255, 150, 50) 25%, #111111 50%);
...
html[saved-theme="dark"] body .callout[data-callout="calendar"] {
  ...
  --table-border-color: color-mix(in srgb, rgb(255, 204, 0) 25%, #111111 50%);
...
html[saved-theme="dark"] body .callout[data-callout="code"] {
  ...
  --table-border-color: color-mix(in srgb, rgb(150, 100, 250) 25%, #111111 50%);
...
html[saved-theme="dark"] body .callout[data-callout="goal"] {
  ...
  --table-border-color: color-mix(in srgb, rgb(50, 200, 100) 25%, #111111 50%);
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --lightgray: var(--background-secondary, #eeeeee);
  --list-bullet-radius: 100%;
  --list-marker-color: hsl(258, 88%, 66%);
...
html[saved-theme="light"] body .callout[data-callout="analysis"] {
  --callout-color: 50, 150, 255;
  --table-border-color: color-mix(in srgb, rgb(50, 150, 255) 25%, #ffffff 50%);
  background-color: rgba(50, 150, 255, 0.2);
  border-bottom-color: rgba(50, 150, 255, 0.25);
  border-bottom-left-radius: 4px;
  border-bottom-right-radius: 4px;
...
html[saved-theme="light"] body .callout[data-callout="bookmark"] {
  --callout-color: 255, 150, 50;
  --table-border-color: color-mix(in srgb, rgb(255, 150, 50) 25%, #ffffff 50%);
  background-color: rgba(255, 150, 50, 0.2);
  border-bottom-color: rgba(255, 150, 50, 0.25);
  border-bottom-left-radius: 4px;
  border-bottom-right-radius: 4px;
...
html[saved-theme="light"] body .callout[data-callout="calendar"] {
  --callout-color: 255, 204, 0;
  --table-border-color: color-mix(in srgb, rgb(255, 204, 0) 25%, #ffffff 50%);
  background-color: rgba(255, 204, 0, 0.2);
  border-bottom-color: rgba(255, 204, 0, 0.25);
  border-bottom-left-radius: 4px;
  border-bottom-right-radius: 4px;
...
html[saved-theme="light"] body .callout[data-callout="code"] {
  --callout-color: 150, 100, 250;
  --table-border-color: color-mix(in srgb, rgb(150, 100, 250) 25%, #ffffff 50%);
  background-color: rgba(150, 100, 250, 0.2);
  border-bottom-color: rgba(150, 100, 250, 0.25);
  border-bottom-left-radius: 4px;
  border-bottom-right-radius: 4px;
...
html[saved-theme="light"] body .callout[data-callout="goal"] {
  --callout-color: 50, 200, 100;
  --table-border-color: color-mix(in srgb, rgb(50, 200, 100) 25%, #ffffff 50%);
  background-color: rgba(50, 200, 100, 0.2);
  border-bottom-color: rgba(50, 200, 100, 0.25);
  border-bottom-left-radius: 4px;
  border-bottom-right-radius: 4px;
