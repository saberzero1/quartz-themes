...
html[saved-theme="dark"] body[data-slug] div#quartz-root.page, html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left, html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left:has(.explorer), html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left .explorer .explorer-content {
  --bases-table-header-background: var(--background-secondary, hsl(225, 15%, 20%));
...
html[saved-theme="dark"] body .markdown-rendered p > strong > em, html[saved-theme="dark"] strong > em {
  color: var(--italic-color, rgb(240, 244, 248));
  outline: rgb(240, 244, 248) none 0px;
  text-decoration-color: rgb(240, 244, 248);
}
...
html[saved-theme="dark"] body ol > li {
  color: rgb(227, 231, 235);
  margin-left: 26px;
  padding-bottom: var(--list-spacing, 3.6px);
  padding-top: var(--list-spacing, 3.6px);
}
...
html[saved-theme="dark"] body blockquote {
  ...
  color: var(--blockquote-color, rgb(207, 197, 175));
...
html[saved-theme="dark"] body figure {
  --code-background: var(--ec-frm-edBg, hsl(215, 18%, 19%));
  border-bottom-color: rgb(227, 231, 235);
  border-left-color: rgb(227, 231, 235);
  border-right-color: rgb(227, 231, 235);
  border-top-color: rgb(227, 231, 235);
...
html[saved-theme="dark"] body a.internal-link.tag-link, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  --pill-background: var(--tag-background, hsla(30, 40%, 65%, 0.1));
  --pill-background-hover: var(--tag-background-hover, hsla(30, 40%, 65%, 0.2));
  --pill-border-color: var(--tag-border-color, hsla(30, 40%, 65%, 0.15));
  --pill-border-color-hover: var(--tag-border-color-hover, hsla(30, 40%, 65%, 0.15));
  --pill-border-width: var(--tag-border-width, 1px);
  --pill-color: var(--tag-color, hsl(27, 40.8%, 74.75%));
  --pill-color-hover: var(--tag-color-hover, hsl(27, 40.8%, 74.75%));
  --pill-color-remove: var(--tag-color, hsl(27, 40.8%, 74.75%));
  --pill-color-remove-hover: var(--tag-color-hover, hsl(27, 40.8%, 74.75%));
...
html[saved-theme="dark"] body h1::before {
  ...
  background: rgb(226, 230, 235) none repeat scroll 0% 0% / auto padding-box border-box;
...
html[saved-theme="dark"] body h2.page-title, html[saved-theme="dark"] h2.page-title a {
  ...
  line-height: var(--inline-title-line-height, 30.72px);
  margin-bottom: 12.8px;
}

html[saved-theme="dark"] body h2::before {
  --font-weight: var(--h2-weight, 680);
  background: rgb(197, 202, 212) none repeat scroll 0% 0% / auto padding-box border-box;
...
html[saved-theme="dark"] body h3::before {
  ...
  background: rgb(168, 174, 185) none repeat scroll 0% 0% / auto padding-box border-box;
...
html[saved-theme="dark"] body h4::before {
  ...
  background: rgb(143, 150, 161) none repeat scroll 0% 0% / auto padding-box border-box;
...
html[saved-theme="dark"] body h5::before {
  ...
  background: rgb(120, 127, 138) none repeat scroll 0% 0% / auto padding-box border-box;
...
html[saved-theme="dark"] body h6::before {
  ...
  background: rgb(102, 109, 120) none repeat scroll 0% 0% / auto padding-box border-box;
...
html[saved-theme="dark"] body .nav-files-container li:has(> .folder-outer.open) > .nav-folder-title {
  --icon-color: var(--nav-collapse-icon-color, rgba(123, 175, 222, 0.85));
  --nav-collapse-icon-color: var(--folder-text-2, rgba(123, 175, 222, 0.85));
...
html[saved-theme="light"] body[data-slug] div#quartz-root.page, html[saved-theme="light"] .page > div#quartz-body div.sidebar.left, html[saved-theme="light"] .page > div#quartz-body div.sidebar.left:has(.explorer), html[saved-theme="light"] .page > div#quartz-body div.sidebar.left .explorer .explorer-content {
  --bases-table-header-background: var(--background-secondary, rgb(232, 223, 217));
  background-color: var(--mod-left-split-background, rgba(0, 0, 0, 0));
  color: rgb(58, 51, 48);
}
...
html[saved-theme="light"] body .markdown-rendered p > strong > em, html[saved-theme="light"] strong > em {
  color: var(--italic-color, rgb(45, 55, 72));
  outline: rgb(45, 55, 72) none 0px;
  text-decoration-color: rgb(45, 55, 72);
}
...
html[saved-theme="light"] body blockquote {
  ...
  color: var(--blockquote-color, rgb(92, 74, 61));
  letter-spacing: 0.56px;
  line-height: 27.2px;
  padding-bottom: 4px;
  padding-top: 4px;
...
html[saved-theme="light"] body figure {
  --code-background: var(--ec-frm-edBg, rgb(238, 230, 225));
  border-bottom-color: rgb(58, 51, 48);
  border-left-color: rgb(58, 51, 48);
  border-right-color: rgb(58, 51, 48);
  border-top-color: rgb(58, 51, 48);
...
html[saved-theme="light"] body a.internal-link.tag-link, html[saved-theme="light"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  --pill-background: var(--tag-background, hsla(12, 31%, 60%, 0.1));
  --pill-background-hover: var(--tag-background-hover, hsla(12, 31%, 60%, 0.2));
  --pill-border-color: var(--tag-border-color, hsla(12, 31%, 60%, 0.15));
  --pill-border-color-hover: var(--tag-border-color-hover, hsla(12, 31%, 60%, 0.15));
  --pill-border-width: var(--tag-border-width, 1px);
  --pill-color: var(--tag-color, hsl(12, 31%, 60%));
  --pill-color-hover: var(--tag-color-hover, hsl(12, 31%, 60%));
  --pill-color-remove: var(--tag-color, hsl(12, 31%, 60%));
  --pill-color-remove-hover: var(--tag-color-hover, hsl(12, 31%, 60%));
  --pill-padding-y: var(--tag-padding-y, 0.2em);
...
html[saved-theme="light"] body h1::before {
  --font-weight: var(--h1-weight, 700);
  background: rgb(45, 55, 72) none repeat scroll 0% 0% / auto padding-box border-box;
...
html[saved-theme="light"] body h2::before {
  --font-weight: var(--h2-weight, 680);
  background: rgb(74, 85, 107) none repeat scroll 0% 0% / auto padding-box border-box;
...
html[saved-theme="light"] body h3::before {
  --font-weight: var(--h3-weight, 660);
  background: rgb(102, 120, 141) none repeat scroll 0% 0% / auto padding-box border-box;
...
html[saved-theme="light"] body h4::before {
  --font-weight: var(--h4-weight, 640);
  background: rgb(127, 138, 155) none repeat scroll 0% 0% / auto padding-box border-box;
...
html[saved-theme="light"] body h5::before {
  --font-weight: var(--h5-weight, 620);
  background: rgb(154, 165, 181) none repeat scroll 0% 0% / auto padding-box border-box;
...
html[saved-theme="light"] body .nav-files-container li:has(> .folder-outer.open) > .nav-folder-title {
  --icon-color: var(--nav-collapse-icon-color, rgba(95, 164, 218, 0.85));
  --nav-collapse-icon-color: var(--folder-text-2, rgba(95, 164, 218, 0.85));
...
--text-highlight-border-radius: 4px;
    ...
    "composer--NiScheme-light": {
      general: `.composer--NiScheme-light {
--lightness-1000: 1;
--lightness-950: 0.95;
--lightness-900: 0.9;
--lightness-850: 0.85;
...
--text-highlight-border-radius: 4px;
    ...
    "composer--NiScheme-dark": {
      general: `.composer--NiScheme-dark {
--lightness-1000: 1;
--lightness-950: 0.95;
--lightness-900: 0.9;
--lightness-850: 0.85;
...
--text-highlight-color: hsl(200, 13%, 91%);
    ...
    "composer--SubtleGridCallout": {
      general: `.composer--SubtleGridCallout .callout {
...
padding: 0px 16px 0px 16px;
    ...
    "composer--CleanLineCallout": {
      general: `.composer--CleanLineCallout .callout {
...
background: linear-gradient(
    ...
    "composer--GithubCallout": {
      general: `.composer--GithubCallout .callout {
border: none;
...
gap: var(--size-4-2);
    ...
    "composer--WindowPanelCallout": {
      general: `.composer--WindowPanelCallout .callout {
...
padding: 0px 16px;
    ...
    "composer--ObsidianTableStyle": {
      general: `.composer--ObsidianTableStyle {
.el-table table th,
	.el-table table td,
    ...
    "composer--BorderlessTableStyle": {
      general: `.composer--BorderlessTableStyle {
.el-table table,
	.table-wrapper table {
    ...
    "composer--AcademicTableStyle": {
      general: `.composer--AcademicTableStyle {
...
.el-table table tbody tr:last-child > td,
    ...
    "composer--ParagraphIndent": {
      general: `.composer--ParagraphIndent {
...
white-space: normal;
    ...
    "composer--EnableHiddenFileTag": {
      general: `body.composer--EnableHiddenFileTag .nav-file-tag {
display: none;
}
...
display: inline;
    ...
    "composer--EnableHiddenFileTagHover": {
      general: `body.composer--EnableHiddenFileTag.composer--EnableHiddenFileTagHover .nav-file:hover .nav-file-tag {
display: inline;
}`,
    },
    "composer--NodeOutlineStyle": {
      general: `.composer--NodeOutlineStyle .workspace-leaf-content[data-type="outline"] .view-content {
...
:is(.tree-item-children, .tree-item-self .tree-item-self) {
    ...
    "composer--ComponentsSimpleTag": {
      dark: `.composer--ComponentsSimpleTag .theme-dark .components--tag, .composer--ComponentsSimpleTag .components--tag {
background-color: transparent;
border: 1px solid var(--background-modifier-border);
}`,
    },
    "composer--ComponentsFilledGallaryCover": {
      general: `.composer--ComponentsFilledGallaryCover .components--DynamicDataView-PageCard {
padding: 0px;
overflow: hidden;
border: 0px;
}
