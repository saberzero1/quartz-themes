...
export const theme: ThemeData = {
  ...
  --activeline: #ead2be;
  --background-modifier-border: var(--color-base-30, #554441);
  --background-modifier-border-focus: var(--color-base-40, #e4cdba);
  --background-modifier-border-hover: var(--color-base-35, #554441);
  ...
  --background-modifier-form-field: var(--color-base-25, #7d645f);
  --background-modifier-form-field-hover: var(--background-modifier-form-field, #7d645f);
  ...
  --background-primary: var(--color-base-00, #f1ddcd);
  --background-primary-alt: var(--color-base-10, #ddc1ab);
  --background-secondary: var(--color-base-20, #64514d);
  --background-secondary-alt: var(--color-base-30, #554441);
  --bases-cards-background: var(--background-primary, #f1ddcd);
  --bases-cards-cover-background: var(--background-primary-alt, #ddc1ab);
  --bases-embed-border-color: var(--background-modifier-border, #554441);
  --bases-group-heading-property-color: var(--text-muted, #a72a2a);
  --bases-group-heading-property-size: var(--font-ui-smaller, 13px);
  --bases-table-border-color: var(--table-border-color, #554441);
  --bases-table-cell-background-active: var(--background-primary, #f1ddcd);
  --bases-table-cell-background-disabled: var(--background-primary-alt, #ddc1ab);
  --bases-table-group-background: var(--background-primary-alt, #ddc1ab);
  --bases-table-header-background: var(--background-primary, #f1ddcd);
  --bases-table-header-color: var(--text-muted, #a72a2a);
  --bases-table-summary-background: var(--background-primary, #f1ddcd);
  --blockquote-border-color: var(--interactive-accent, #ce7726);
  ...
  --canvas-background: var(--background-primary, #f1ddcd);
  --canvas-card-label-color: var(--text-faint, #982222);
  ...
  --canvas-dot-pattern: var(--color-base-30, #554441);
  --caret-color: var(--text-normal, #460c0c);
  --checkbox-border-color: var(--text-faint, #982222);
  --checkbox-border-color-hover: var(--text-muted, #a72a2a);
  --checkbox-color: var(--interactive-accent, #ce7726);
  --checkbox-color-hover: var(--interactive-accent-hover, #ce7726);
  --checkbox-marker-color: var(--background-primary, #f1ddcd);
  --checklist-done-color: var(--text-muted, #a72a2a);
  --clickable-icon-radius: var(--radius-s, 0px);
  --code-background: var(--background-primary-alt, #ddc1ab);
  --code-border-color: var(--background-modifier-border, #554441);
  --code-comment: var(--text-faint, #982222);
  --code-function: var(--color-yellow, #977400);
  --code-important: var(--color-orange, #c16d18);
  --code-keyword: var(--color-pink, #bf206d);
  --code-normal: var(--text-normal, #460c0c);
  --code-operator: var(--color-red, #cf1e33);
  --code-property: var(--color-cyan, #009e9b);
  --code-punctuation: var(--text-muted, #a72a2a);
  --code-string: var(--color-green, #01903b);
  --code-tag: var(--color-red, #cf1e33);
  --code-value: var(--color-purple, #5f38d6);
  --collapse-icon-color: var(--text-faint, #982222);
  --collapse-icon-color-collapsed: var(--text-accent, #ce7726);
  --color-accent-1: var(--color-accent, #ce7726);
  --color-base-00: #f1ddcd;
  --color-base-05: var(--color-base-30, #554441);
  --color-base-10: #ddc1ab;
  --color-base-100: #460c0c;
  --color-base-20: #64514d;
  --color-base-25: #7d645f;
  --color-base-30: #554441;
  --color-base-35: var(--color-base-30, #554441);
  --color-base-40: #e4cdba;
  --color-base-50: #982222;
  --color-base-70: #a72a2a;
  --color-blue: #025fc8;
  --color-blue-rgb: 2, 95, 200;
  --color-bold: var(--color-accent, #460c0c);
  --color-cyan: #009e9b;
  ...
  --dark: var(--text-normal, var(--color-base-100, #460c0c));
  --darkgray: var(--text-normal, var(--color-base-100, #460c0c));
  --default-animation-duration: 150ms;
  --default-border-radius: 4px;
  --divider-color: var(--background-modifier-border, #554441);
  --divider-color-hover: var(--interactive-accent, #ce7726);
  --dropdown-background: var(--interactive-normal, #554441);
  --dropdown-background-hover: var(--interactive-hover, #554441);
  --file-header-background: var(--background-primary, #f1ddcd);
  --file-header-background-focused: var(--background-primary, #f1ddcd);
  --file-header-font: var(--font-interface, "CMU Typewriter Text");
  --file-header-font-size: var(--font-ui-small, 14px);
  --file-line-width: 900px;
  --flair-background: var(--interactive-normal, #554441);
  --flair-color: var(--text-normal, #460c0c);
  ...
  --footnote-divider-color: var(--metadata-divider-color, #554441);
  --footnote-id-color: var(--text-muted, #a72a2a);
  --footnote-id-color-no-occurrences: var(--text-faint, #982222);
  --graph-node: var(--text-muted, #a72a2a);
  --graph-node-attachment: var(--color-yellow, #977400);
  --graph-node-focused: var(--text-accent, #ce7726);
  --graph-node-tag: var(--color-green, #01903b);
  --graph-node-unresolved: var(--text-faint, #982222);
  --graph-text: var(--text-normal, #460c0c);
  --gray: var(--text-muted, var(--color-base-70, #a72a2a));
  --header-height: 30px;
  --heading-formatting: var(--text-faint, #982222);
  --heading-formatting-color: #962a2a;
  --hover-animation-duration: 100ms;
  --hover-faster-animation-duration: 75ms;
  --hr-color: var(--background-modifier-border, #554441);
  --icon-color: var(--text-muted, #a72a2a);
  --icon-color-active: var(--text-accent, #ce7726);
  --icon-color-focused: var(--text-normal, #460c0c);
  --icon-color-hover: var(--text-muted, #a72a2a);
  --in-between-background: #4d3a37;
  --input-date-separator: var(--text-faint, #982222);
  --input-placeholder-color: var(--text-faint, #982222);
  --interactive-accent: var(--color-accent, #ce7726);
  --interactive-accent-hover: var(--color-accent-1, #ce7726);
  --interactive-hover: var(--color-base-35, #554441);
  --interactive-normal: var(--color-base-30, #554441);
  --light: var(--background-primary, var(--color-base-00, #f1ddcd));
  --lightgray: var(--background-secondary, var(--color-base-20, #64514d));
  --link-color: var(--text-accent, #ce7726);
  --link-color-hover: var(--text-accent-hover, #db791e);
  --link-external-color: var(--text-accent, #ce7726);
  --link-external-color-hover: var(--text-accent-hover, #db791e);
  --link-unresolved-color: var(--text-accent, #ce7726);
  --list-marker-color: var(--text-faint, #982222);
  --list-marker-color-collapsed: var(--text-accent, #ce7726);
  --list-marker-color-hover: var(--text-muted, #a72a2a);
  --menu-background: var(--background-secondary, #64514d);
  --menu-border-color: var(--background-modifier-border-hover, #554441);
  --metadata-border-color: var(--background-modifier-border, #554441);
  --metadata-divider-color: var(--background-modifier-border, #554441);
  --metadata-input-font: var(--font-interface, "CMU Typewriter Text");
  --metadata-input-text-color: var(--text-normal, #460c0c);
  --metadata-label-font: var(--font-interface, "CMU Typewriter Text");
  --metadata-label-text-color: var(--text-muted, #a72a2a);
  --metadata-label-text-color-hover: var(--text-muted, #a72a2a);
  --metadata-sidebar-input-font-size: var(--font-ui-small, 14px);
  --metadata-sidebar-label-font-size: var(--font-ui-small, 14px);
  --modal-background: var(--background-primary, #f1ddcd);
  --nav-collapse-icon-color: var(--collapse-icon-color, #982222);
  --nav-collapse-icon-color-collapsed: var(--text-faint, #982222);
  --nav-heading-color: var(--text-normal, #460c0c);
  --nav-heading-color-collapsed: var(--text-faint, #982222);
  --nav-heading-color-collapsed-hover: var(--text-muted, #a72a2a);
  --nav-heading-color-hover: var(--text-normal, #460c0c);
  --nav-item-color: var(--text-muted, #a72a2a);
  --nav-item-color-active: var(--text-normal, #460c0c);
  --nav-item-color-highlighted: var(--text-accent, #ce7726);
  --nav-item-color-hover: var(--text-normal, #460c0c);
  --nav-item-color-selected: var(--text-normal, #460c0c);
  --nav-item-size: var(--font-ui-small, 14px);
  --nav-tag-color: var(--text-faint, #982222);
  --nav-tag-color-active: var(--text-muted, #a72a2a);
  --nav-tag-color-hover: var(--text-muted, #a72a2a);
  --pdf-background: var(--background-primary, #f1ddcd);
  --pdf-page-background: var(--background-primary, #f1ddcd);
  --pdf-sidebar-background: var(--background-primary, #f1ddcd);
  --pill-border-color: var(--background-modifier-border, #554441);
  --pill-border-color-hover: var(--background-modifier-border-hover, #554441);
  --pill-color: var(--text-muted, #a72a2a);
  --pill-color-hover: var(--text-normal, #460c0c);
  --pill-color-remove: var(--text-faint, #982222);
  --pill-color-remove-hover: var(--text-accent, #ce7726);
  --pop-callout-slide-out-duration: 0ms;
  --pop-callout-width: 20px;
  --prompt-background: var(--background-primary, #f1ddcd);
  --raised-background: var(--blur-background, color-mix(in srgb, #554441 65%, transparent) linear-gradient(#554441, color-mix(in srgb, #554441 65%, transparent)));
  --ribbon-background: var(--background-secondary, #64514d);
  --ribbon-background-collapsed: var(--background-primary, #f1ddcd);
  --ribbon-padding: var(--size-4-2) var(--size-4-1) var(--size-4-3, 0px);
  --ribbon-width: 40px;
  --search-clear-button-color: var(--text-muted, #a72a2a);
  --search-icon-color: var(--text-muted, #a72a2a);
  --search-result-background: var(--background-primary, #f1ddcd);
  --secondary: var(--text-accent, var(--color-accent-1, #ce7726));
  --setting-group-heading-color: var(--text-normal, #460c0c);
  --setting-group-heading-size: var(--font-ui-medium, 16px);
  --setting-items-background: var(--background-primary-alt, #ddc1ab);
  --setting-items-border-color: var(--background-modifier-border, #554441);
  --shiki-active-tab-border-color: var(--shiki-highlight-neutral, #a72a2a);
  --shiki-code-background: var(--code-background, #ddc1ab);
  --shiki-code-comment: var(--text-faint, #982222);
  ...
  --shiki-code-normal: var(--text-muted, #a72a2a);
  --shiki-code-property: var(--color-cyan, #009e9b);
  --shiki-code-punctuation: var(--text-muted, #a72a2a);
  --shiki-code-string: var(--color-yellow, #977400);
  --shiki-code-value: var(--color-purple, #5f38d6);
  --shiki-gutter-border-color: var(--background-modifier-border, #554441);
  --shiki-gutter-text-color: var(--text-faint, #982222);
  --shiki-gutter-text-color-highlight: var(--shiki-code-normal, #a72a2a);
  --shiki-highlight-neutral: var(--shiki-code-normal, #a72a2a);
  --shiki-terminal-dots-color: var(--text-faint, #982222);
  --shiki-tooltip-background: var(--background-modifier-message, #43312e);
  --slider-thumb-border-color: var(--background-modifier-border-hover, #554441);
  --slider-track-background: var(--background-modifier-border, #554441);
  --status-bar-background: var(--background-secondary, #64514d);
  --status-bar-border-color: var(--divider-color, #554441);
  --status-bar-font-size: var(--font-ui-smaller, 13px);
  --status-bar-text-color: var(--text-muted, #a72a2a);
  --suggestion-background: var(--background-primary, #f1ddcd);
  ...
  --tab-background-active: var(--background-primary, #f1ddcd);
  --tab-container-background: var(--background-secondary, #64514d);
  --tab-divider-color: var(--background-modifier-border-hover, #554441);
  --tab-font-size: var(--font-ui-small, 14px);
  --tab-outline-color: var(--divider-color, #554441);
  --tab-stacked-font-size: var(--font-ui-small, 14px);
  --tab-stacked-header-width: var(--header-height, 30px);
  --tab-switcher-background: var(--background-secondary, #64514d);
  --tab-text-color: var(--text-faint, #982222);
  --tab-text-color-active: var(--text-muted, #a72a2a);
  --tab-text-color-focused: var(--text-muted, #a72a2a);
  --tab-text-color-focused-active: var(--text-muted, #a72a2a);
  --tab-text-color-focused-active-current: var(--text-normal, #460c0c);
  --tab-text-color-focused-highlighted: var(--text-accent, #ce7726);
  --table-add-button-border-color: var(--background-modifier-border, #554441);
  --table-border-color: var(--background-modifier-border, #554441);
  --table-drag-handle-background-active: var(--table-selection-border-color, #ce7726);
  --table-drag-handle-color: var(--text-faint, #982222);
  --table-header-border-color: var(--table-border-color, #554441);
  --table-header-color: var(--text-normal, #460c0c);
  --table-selection-border-color: var(--interactive-accent, #ce7726);
  --tag-color: var(--text-accent, #ce7726);
  --tag-color-hover: var(--text-accent, #ce7726);
  --tag-radius: 4px;
  --tertiary: var(--text-accent-hover, var(--color-accent-2, #db791e));
  --text-accent: var(--color-accent-1, #ce7726);
  --text-accent-hover: var(--color-accent-2, #db791e);
  --text-error: var(--color-red, #cf1e33);
  --text-faint: var(--color-base-50, #982222);
  --text-highlight-bg-active: var(--text-highlight-bg, #a0632666);
  --text-muted: var(--color-base-70, #a72a2a);
  --text-normal: var(--color-base-100, #460c0c);
  --text-success: var(--color-green, #01903b);
  --text-warning: var(--color-orange, #c16d18);
  --titlebar-background: var(--background-secondary, #64514d);
  --titlebar-background-focused: var(--color-base-20, #64514d);
  --titlebar-border-color: var(--background-modifier-border, #554441);
  --titlebar-text-color: var(--text-muted, #a72a2a);
  --titlebar-text-color-focused: var(--text-normal, #460c0c);
  --traffic-lights-offset-x: var(--header-height, 30px);
  --traffic-lights-offset-y: var(--header-height, 30px);
  --vault-profile-color: var(--text-normal, #460c0c);
  --vault-profile-color-hover: var(--vault-profile-color, #460c0c);
...
html[saved-theme="dark"] body[data-slug] div#quartz-root.page, html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left, html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left:has(.explorer), html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left .explorer .explorer-content {
  --bases-table-header-background: var(--background-secondary, #64514d);
  background-color: var(--background-secondary, rgb(100, 81, 77));
  color: rgb(70, 12, 12);
}

html[saved-theme="dark"] body[data-slug], html[saved-theme="dark"] body[data-slug] .page > div#quartz-body, html[saved-theme="dark"] .page > div#quartz-body div.center, html[saved-theme="dark"] .page > div#quartz-body footer {
  background-color: var(--background-secondary, rgb(241, 221, 205));
  color: rgb(70, 12, 12);
}
...
html[saved-theme="dark"] body html {
  ...
  background-color: var(--background-secondary, rgba(0, 0, 0, 0));
  color: var(--color-bold, rgb(70, 12, 12));
...
html[saved-theme="dark"] body .markdown-rendered p > em, html[saved-theme="dark"] em {
  background-color: var(--background-secondary, rgba(0, 0, 0, 0));
  color: var(--color-italic, rgb(70, 12, 12));
  font-family: "??", "??", "CMU Typewriter Text";
  outline: rgb(70, 12, 12) none 0px;
  text-decoration-color: rgb(70, 12, 12);
  transition: background-color 0.1s ease-in-out;
...
html[saved-theme="dark"] body .text-highlight {
  background-color: var(--background-secondary, rgba(160, 99, 38, 0.4));
  color: var(--text-normal, rgb(70, 12, 12));
  font-family: "??", "??", "CMU Typewriter Text";
  outline: rgb(70, 12, 12) none 0px;
  text-decoration-color: rgb(70, 12, 12);
  transition: background-color 0.1s ease-in-out;
...
html[saved-theme="dark"] body footer {
  --status-bar-text-color: var(--background-primary, #f1ddcd);
  --text-normal: var(--background-primary, #f1ddcd);
  opacity: 0.5;
}
...
html[saved-theme="dark"] body li.task-list-item input[type="checkbox"]:checked {
  background-color: var(--checkbox-color, rgb(206, 119, 38));
  border-color: rgb(206, 119, 38);
}

html[saved-theme="dark"] body p {
  background-color: var(--background-secondary, rgba(0, 0, 0, 0));
  color: var(--text-muted, rgb(167, 42, 42));
  font-family: "??", "??", "??", "CMU Typewriter Text";
  ...
  background-color: var(--background-secondary, rgba(0, 0, 0, 0));
  color: var(--link-external-color, rgb(206, 119, 38));
  font-family: "??", "??", "CMU Typewriter Text";
...
html[saved-theme="dark"] body a.internal-link, html[saved-theme="dark"] .breadcrumb-container .breadcrumb-element > a {
  background-color: var(--background-secondary, rgba(0, 0, 0, 0));
  color: var(--link-color, rgb(206, 119, 38));
  font-family: "??", "??", "CMU Typewriter Text";
  outline: rgb(206, 119, 38) none 0px;
  text-decoration-color: rgb(206, 119, 38);
...
html[saved-theme="dark"] body a.internal-link.broken {
  background-color: var(--background-secondary, rgba(0, 0, 0, 0));
  color: var(--link-unresolved-color, rgb(206, 119, 38));
  font-family: "??", "??", "CMU Typewriter Text";
  outline: rgb(206, 119, 38) none 0px;
...
html[saved-theme="dark"] body ul.overflow {
  ...
  color: var(--text-faint, rgb(152, 34, 34));
}

html[saved-theme="dark"] body blockquote {
  background-color: var(--background-secondary, rgb(228, 205, 186));
  color: var(--blockquote-color, rgb(70, 12, 12));
  font-family: "??", "??", "CMU Typewriter Text";
}`,
...
html[saved-theme="dark"] body table {
  --color-base-40: var(--table-header-border-color, #554441);
  background-color: var(--background-secondary, rgba(0, 0, 0, 0));
  color: rgb(70, 12, 12);
  font-family: "??", "??", "CMU Typewriter Text";
  margin-left: calc(var(--ribbon-width)*-1 + 10px);
...
html[saved-theme="dark"] body td {
  ...
  color: var(--table-text-color, rgb(70, 12, 12));
}
...
html[saved-theme="dark"] body th {
  ...
  border-right-color: rgb(85, 68, 65);
  border-top-color: rgb(85, 68, 65);
  color: var(--table-header-color, rgb(70, 12, 12));
}
...
html[saved-theme="dark"] body tr {
  ...
  background-color: var(--background-secondary, rgb(221, 193, 171));
  border-bottom-color: rgb(85, 68, 65);
  border-left-color: rgb(85, 68, 65);
  border-right-color: rgb(85, 68, 65);
  border-top-color: rgb(85, 68, 65);
  color: var(--code-normal, rgb(70, 12, 12));
...
html[saved-theme="dark"] body figure {
  --code-background: var(--ec-frm-edBg, #ddc1ab);
  background-color: var(--background-secondary, rgba(0, 0, 0, 0));
  border-bottom-color: rgb(70, 12, 12);
  border-left-color: rgb(70, 12, 12);
  border-right-color: rgb(70, 12, 12);
...
html[saved-theme="dark"] body .callout[data-callout="warning"] {
  ...
  background-color: var(--background-secondary, rgb(125, 100, 95));
  border-bottom-color: rgb(85, 68, 65);
  ...
  color: var(--text-normal, rgb(223, 201, 184));
  font-family: "??", "??", "??", "CMU Typewriter Text";
}
...
html[saved-theme="dark"] body .search > .search-container > .search-space > .search-layout > .results-container > .result-card:hover, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container > .result-card:focus, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container > .result-card.focus:not(:has(~ .result-card:hover, html[saved-theme="dark"] ~ .result-card:focus)) {
  background-color: var(--background-secondary, rgba(255, 255, 255, 0.067));
  color: rgb(70, 12, 12);
}
...
html[saved-theme="dark"] body a.internal-link.tag-link, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  --pill-color: var(--tag-color, #ce7726);
  --pill-color-hover: var(--tag-color-hover, #ce7726);
  --pill-color-remove: var(--tag-color, #ce7726);
  --pill-color-remove-hover: var(--tag-color-hover, #ce7726);
  ...
  border-top-left-radius: 4px;
  border-top-right-radius: 4px;
  color: var(--pill-color, rgb(206, 119, 38));
  font-family: "??", "??", "??", "CMU Typewriter Text";
}
...
html[saved-theme="dark"] body h1 {
  ...
  border-right-color: rgb(70, 12, 12);
  border-top-color: rgb(70, 12, 12);
  color: var(--h1-color, rgb(70, 12, 12));
...
html[saved-theme="dark"] body h1.article-title {
  color: var(--inline-title-color, rgb(70, 12, 12));
}
...
html[saved-theme="dark"] body h2 {
  ...
  border-right-color: rgb(70, 12, 12);
  border-top-color: rgb(70, 12, 12);
  color: var(--h2-color, rgb(70, 12, 12));
...
html[saved-theme="dark"] body h3 {
  ...
  border-right-color: rgb(70, 12, 12);
  border-top-color: rgb(70, 12, 12);
  color: var(--h3-color, rgb(70, 12, 12));
...
html[saved-theme="dark"] body h4 {
  ...
  border-right-color: rgb(70, 12, 12);
  border-top-color: rgb(70, 12, 12);
  color: var(--h4-color, rgb(70, 12, 12));
...
html[saved-theme="dark"] body h5 {
  ...
  border-right-color: rgb(70, 12, 12);
  border-top-color: rgb(70, 12, 12);
  color: var(--h5-color, rgb(70, 12, 12));
...
html[saved-theme="dark"] body h6 {
  ...
  border-right-color: rgb(70, 12, 12);
  border-top-color: rgb(70, 12, 12);
  color: var(--h6-color, rgb(70, 12, 12));
...
html[saved-theme="dark"] body .nav-files-container li:has(> .folder-outer.open) > .nav-folder-title {
  color: var(--nav-item-color, rgb(228, 205, 186));
  font-family: "??", "??", "??", "CMU Typewriter Text";
}
...
html[saved-theme="dark"] body .explorer .nav-files-container .collapse-icon svg {
  ...
  color: var(--icon-color, rgb(228, 205, 186));
}`,
  ...
  border-top-left-radius: 4px;
  border-top-right-radius: 4px;
  color: var(--status-bar-text-color, rgb(241, 221, 205));
  font-family: "??", "??", "??", "CMU Typewriter Text";
...
html[saved-theme="dark"] body .canvas-node-file {
  background-color: var(--color-base-00, rgb(241, 221, 205));
  color: var(--text-normal, rgb(70, 12, 12));
}
...
html[saved-theme="dark"] body .stacked-page-header {
  --icon-color: var(--color-base-40, #e4cdba);
  --nav-collapse-icon-color: var(--icon-color, #e4cdba);
  --nav-item-color: var(--color-base-40, #e4cdba);
  --nav-item-color-active: var(--color-base-40, #e4cdba);
  --search-icon-color: var(--icon-color, #e4cdba);
  --vault-name-color: var(--color-base-40, #e4cdba);
  background-color: var(--background-secondary, rgb(100, 81, 77));
}
...
html[saved-theme="dark"] body input[type=text] {
  ...
  border-right-color: rgb(167, 42, 42);
  border-top-color: rgb(167, 42, 42);
  color: var(--text-normal, rgb(167, 42, 42));
  font-family: "??", "??", "??", "CMU Typewriter Text";
  padding-bottom: 0px;
  padding-top: 0px;
}
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  border-top-left-radius: 4px;
  border-top-right-radius: 4px;
  color: var(--tag-color, rgb(206, 119, 38));
}`,
  },
  light: {
    base: `:root:root {
...
html[saved-theme="light"] body blockquote {
  background-color: var(--background-secondary, rgb(218, 187, 154));
  color: var(--blockquote-color, rgb(95, 79, 73));
  font-family: "??", "??", "CMU Typewriter Text";
}`,
