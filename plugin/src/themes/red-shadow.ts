...
export const theme: ThemeData = {
  ...
  --bases-table-cell-background-selected: hsla(0, 68%, 42%, 0.1);
  ...
  --bodyFont: var(--font-interface, Poppins, Oswald, Montserrat, Roboto, Glow Sans SC, -apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  ...
  --code-normal: #e0e0e0;
  --codeFont: var(--font-interface, Poppins, Oswald, Montserrat, Roboto, Glow Sans SC, -apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  ...
  --graph-text: #e0e0e0;
  --gray: var(--text-faint, #bebebe);
  --headerFont: var(--font-interface, Poppins, Oswald, Montserrat, Roboto, Glow Sans SC, -apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  --heading-formatting: #bebebe;
  --highlight: var(--text-highlight-bg, rgba(244, 86, 86, 0.25));
  ...
  --light: var(--background-primary, #0b090a);
  --lightgray: var(--background-secondary, #121212);
  --link-color: #b22222;
  ...
  --nav-item-background-selected: hsla(0, 68%, 42%, 0.15);
  ...
  --secondary: var(--text-accent, #b22222);
  ...
  --tertiary: var(--text-accent-hover, hsl(-5, 71.4%, 54.18%));
  ...
  --textHighlight: var(--text-highlight-bg, rgba(244, 86, 86, 0.25));
  --titleFont: var(--font-interface, Poppins, Oswald, Montserrat, Roboto, Glow Sans SC, -apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
...
html body th {
  ...
  color: rgb(224, 224, 224);
    ...
    code: `html body code {
  background-color: rgba(247, 14, 14, 0.05);
