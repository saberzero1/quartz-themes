...
export const theme: ThemeData = {
  ...
  --shiki-active-tab-border-color: oklch(71.25% 0 0) !important;
  --shiki-code-background: oklch(100% 0 0 / 0.05) !important;
  --shiki-code-block-border-radius: 6px !important;
  --shiki-code-comment: oklch(52.50% 0 0) !important;
  --shiki-code-normal: oklch(71.25% 0 0) !important;
  --shiki-code-punctuation: oklch(71.25% 0 0) !important;
  --shiki-gutter-border-color: oklch(100% 0 0 / 0.0625) !important;
  --shiki-gutter-text-color: oklch(52.50% 0 0) !important;
  --shiki-gutter-text-color-highlight: oklch(71.25% 0 0) !important;
  --shiki-highlight-neutral: oklch(71.25% 0 0) !important;
  --shiki-terminal-dots-color: oklch(52.50% 0 0) !important;
