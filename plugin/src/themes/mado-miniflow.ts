...
export const theme: ThemeData = {
  ...
  --background-modifier-active-hover: rgba(144, 114, 233, 0.1);
  ...
  --bases-table-cell-background-selected: rgba(144, 114, 233, 0.1);
  --bases-table-cell-shadow-focus: 0 0 0 2px rgb(149, 117, 245);
  ...
  --bgcolor-l: 19%;
  --bgcolor-s: 17%;
  --blockquote-border-color: rgb(149, 117, 245);
  ...
  --checkbox-color: rgb(149, 117, 245);
  --checkbox-color-hover: rgb(134, 112, 219);
  ...
  --collapse-icon-color-collapsed: rgb(134, 112, 219);
  --color-accent: rgb(149, 117, 245);
  --color-accent-1: rgb(134, 112, 219);
  --color-accent-2: rgb(148, 117, 240);
  ...
  --divider-color-hover: rgb(149, 117, 245);
  --divider-width: 4px;
  ...
  --embed-border-start: 2px solid rgb(149, 117, 245);
  ...
  --graph-node-focused: rgb(134, 112, 219);
  ...
  --icon-color-active: rgb(134, 112, 219);
  ...
  --interactive-accent: rgb(149, 117, 245);
  --interactive-accent-hover: rgb(134, 112, 219);
  ...
  --link-color: rgb(134, 112, 219);
  --link-color-hover: rgb(148, 117, 240);
  --link-external-color: rgb(134, 112, 219);
  --link-external-color-hover: rgb(148, 117, 240);
  --link-unresolved-color: rgb(134, 112, 219);
  --link-unresolved-decoration-color: rgba(144, 114, 233, 0.3);
  --list-indent: 37px;
  --list-marker-color: rgba(105, 122, 150, 0.7);
  --list-marker-color-collapsed: rgb(134, 112, 219);
  ...
  --nav-item-background-selected: rgba(144, 114, 233, 0.15);
  --nav-item-color: rgb(130, 143, 166);
  --nav-item-color-active: rgb(186, 186, 186);
  --nav-item-color-highlighted: rgb(134, 112, 219);
  ...
  --pill-color-remove-hover: rgb(134, 112, 219);
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px rgb(149, 117, 245);
  ...
  --tab-text-color-focused-highlighted: rgb(134, 112, 219);
  --table-add-button-border-color: rgb(26, 32, 40);
  --table-border-color: rgb(26, 32, 40);
  --table-drag-handle-background-active: rgb(149, 117, 245);
  --table-drag-handle-color: rgba(105, 122, 150, 0.7);
  --table-header-border-color: rgb(26, 32, 40);
  --table-header-color: rgb(186, 186, 186);
  --table-selection: rgba(144, 114, 233, 0.1);
  --table-selection-border-color: rgb(149, 117, 245);
  --tag-background: rgba(144, 114, 233, 0.1);
  --tag-background-hover: rgba(144, 114, 233, 0.2);
  --tag-border-color: rgba(144, 114, 233, 0.15);
  --tag-border-color-hover: rgba(144, 114, 233, 0.15);
  --tag-color: rgb(134, 112, 219);
  --tag-color-hover: rgb(134, 112, 219);
  --tertiary: var(--text-accent-hover);
  --text-accent: rgb(134, 112, 219);
  --text-accent-hover: rgb(148, 117, 240);
  ...
  --text-selection: rgba(144, 114, 233, 0.33);
...
body sup {
  ...
  --background-modifier-active-hover: rgba(139, 108, 239, 0.1);
  ...
  --bases-table-cell-shadow-focus: 0 0 0 2px rgb(175, 154, 244);
  ...
  --bgcolor-l: 97%;
  --bgcolor-s: 45%;
  --blockquote-border-color: rgb(175, 154, 244);
  ...
  --checkbox-color: rgb(175, 154, 244);
  --checkbox-color-hover: rgb(120, 85, 236);
  ...
  --collapse-icon-color-collapsed: rgb(139, 108, 239);
  --color-accent: rgb(139, 108, 239);
  --color-accent-1: rgb(175, 154, 244);
  --color-accent-2: rgb(120, 85, 236);
  ...
  --dark: var(--text-normal);
  --darkgray: var(--text-normal);
  --divider-color-hover: rgb(175, 154, 244);
  --divider-width: 4px;
  --dropdown-background: rgb(244, 248, 251);
  --dropdown-background-hover: rgb(230, 237, 244);
  --embed-border-start: 2px solid rgb(175, 154, 244);
  --embed-padding: 13px 23px;
  ...
  --graph-node-focused: rgb(139, 108, 239);
  ...
  --icon-color-active: rgb(139, 108, 239);
  ...
  --interactive-accent: rgb(175, 154, 244);
  --interactive-accent-hover: rgb(120, 85, 236);
  ...
  --light: var(--background-primary);
  --lightgray: var(--background-secondary);
  --link-color: rgb(139, 108, 239);
  --link-color-hover: rgb(120, 85, 236);
  --link-external-color: rgb(139, 108, 239);
  --link-external-color-hover: rgb(120, 85, 236);
  --link-unresolved-color: rgb(139, 108, 239);
  --link-unresolved-decoration-color: rgba(139, 108, 239, 0.3);
  --list-indent: 37px;
  --list-marker-color: rgb(176, 184, 196);
  --list-marker-color-collapsed: rgb(139, 108, 239);
  ...
  --nav-item-color-highlighted: rgb(139, 108, 239);
  ...
  --tab-text-color-focused-highlighted: rgb(139, 108, 239);
  --table-drag-handle-background-active: rgb(175, 154, 244);
  --table-drag-handle-color: rgb(176, 184, 196);
  --table-header-color: rgb(33, 33, 33);
  --table-selection: rgba(139, 108, 239, 0.1);
  --table-selection-border-color: rgb(175, 154, 244);
  ...
  --tag-color-hover: rgb(139, 108, 239);
  --tertiary: var(--text-accent-hover);
  --text-accent: rgb(139, 108, 239);
  --text-accent-hover: rgb(120, 85, 236);
