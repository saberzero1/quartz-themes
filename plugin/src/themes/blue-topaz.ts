...
export const theme: ThemeData = {
  ...
  --shiki-active-tab-border-color: #8a8a8a !important;
  --shiki-code-background: #1111118c !important;
  --shiki-code-block-border-radius: 5px !important;
  --shiki-code-comment: #797979 !important;
  --shiki-code-normal: #8a8a8a !important;
  --shiki-code-punctuation: #8a8a8a !important;
  --shiki-gutter-border-color: #343434 !important;
  --shiki-gutter-text-color: #797979 !important;
  --shiki-gutter-text-color-highlight: #8a8a8a !important;
  --shiki-highlight-neutral: #8a8a8a !important;
  --shiki-terminal-dots-color: #797979 !important;
...
html[saved-theme="dark"] body th {
  ...
  background-color: rgba(76, 76, 76, 0.69);
  ...
  color: rgb(213, 128, 0);
  font-family: "??", "JetBrains Mono", Consolas, Monaco, "等距更纱黑体 SC", "Source Han Mono", "Microsoft Yahei Mono", "Segoe UI Emoji", "Microsoft YaHei", "Source Code Pro", monospace;
  padding-bottom: 1px;
  padding-left: 2px;
  padding-right: 2px;
  padding-top: 2px;
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --shiki-code-background: #e6e6e671 !important;
  --shiki-code-block-border-radius: 5px !important;
  --shiki-code-comment: #7f7f7f !important;
  --shiki-code-normal: #7f7f7f !important;
  --shiki-code-punctuation: #7f7f7f !important;
  --shiki-gutter-border-color: #dddddd !important;
  --shiki-gutter-text-color: #7f7f7f !important;
  --shiki-gutter-text-color-highlight: #7f7f7f !important;
  --shiki-highlight-neutral: #7f7f7f !important;
  --shiki-terminal-dots-color: #7f7f7f !important;
  --simple-black-1: hsla(0, 0%, 13%, 1) !important;
  --simple-black-2: hsla(220, 20%, 35%, 1) !important;
  --simple-blue-1: hsla(209, 95%, 62%, 1) !important;
  --simple-blue-2: hsla(209, 85%, 72%, 0.5) !important;
