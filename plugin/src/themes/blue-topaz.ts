...
export const theme: ThemeData = {
  ...
  --bases-table-cell-background-selected: hsla(208, 64%, 49%, 0.1);
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(208, 64%, 49%);
  ...
  --bodyFont: var(--font-text, Bookerly, Inter, "Segoe UI", "霞鹜文楷 GB", "LXGW WenKai", "Microsoft YaHei", ui-sans-serif, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Microsoft YaHei Light", sans-serif);
  ...
  --codeFont: var(--font-monospace, JetBrains Mono, Consolas, Monaco, "等距更纱黑体 SC", "Source Han Mono", "Microsoft Yahei Mono", "Segoe UI Emoji", "Microsoft YaHei", "Source Code Pro", monospace, ui-monospace, SFMono-Regular, "Cascadia Mono", "Roboto Mono", "DejaVu Sans Mono", "Liberation Mono", Menlo, Monaco, "Consolas", "Source Code Pro", monospace);
  ...
  --embed-border-start: 2px solid hsl(208, 64%, 49%);
  --embed-color: hsla(208,76.8%,98%,0.055);
  ...
  --headerFont: var(--font-text, Bookerly, Inter, "Segoe UI", "霞鹜文楷 GB", "LXGW WenKai", "Microsoft YaHei", ui-sans-serif, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Microsoft YaHei Light", sans-serif);
  --heading-formatting: #797979;
  --hibox: 24px;
  --highlight: var(--text-highlight-bg, hsla(57, 40%, 38%, 0.541));
  --hr-color: #242424;
  ...
  --icon-color: #8a8a8a;
  --icon-color-active: hsl(208, 64%, 49%);
  --icon-color-focused: #c6c6c6;
  --icon-color-hover: #8a8a8a;
  --image-max-width: 100%;
  --inline-title-bg-color: color-mix(in srgb, hsl(78, 62%, 47%) 15%, transparent);
  --inline-title-color: hsl(78, 62%, 47%);
  ...
  --light-yellow: #cac685;
  --lightgray: var(--background-secondary, #151515);
  --line-height-list: 2;
  ...
  --list-marker-color-collapsed: hsl(208, 64%, 49%);
  ...
  --nav-item-background-selected: hsla(208, 64%, 49%, 0.15);
  --nav-item-color: #8a8a8a;
  --nav-item-color-active: #c6c6c6;
  --nav-item-color-highlighted: hsl(208, 64%, 49%);
  ...
  --pill-color-remove-hover: hsl(208, 64%, 49%);
  --pixel: 20px;
  ...
  --search-text: #e0e0e0;
  --secondary: var(--text-accent, hsl(208, 64%, 49%));
  ...
  --tag5: #5f932e;
  --tape-color: #99999967;
  --tertiary: var(--text-accent-hover, hsl(203, 67.2%, 63.21%));
  ...
  --textHighlight: var(--text-highlight-bg, hsla(57, 40%, 38%, 0.541));
  ...
  --titleFont: var(--font-text, Bookerly, Inter, "Segoe UI", "霞鹜文楷 GB", "LXGW WenKai", "Microsoft YaHei", ui-sans-serif, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Microsoft YaHei Light", sans-serif);
...
html[saved-theme="dark"] body table {
  color: rgb(198, 198, 198);
  font-family: "??", Bookerly, Inter, "Segoe UI", "霞鹜文楷 GB", "LXGW WenKai", "Microsoft YaHei", ui-sans-serif, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Microsoft YaHei Light", sans-serif;
  margin-bottom: calc(var(--p-spacing) * 0.5, 0px);
  margin-top: calc(var(--p-spacing) * 0.5, 20px);
  width: 658px;
}
...
html[saved-theme="dark"] body .callout[data-callout="cloze"] {
  --button-radius: 5px;
  --callout-color: 2, 122, 255;
  --table-border-color: color-mix(in srgb, rgb(2, 122, 255) 25%, #202020 50%);
...
html[saved-theme="dark"] body .callout[data-callout="timeline"] {
  ...
  --table-border-color: color-mix(in srgb, rgb(31, 172, 139) 25%, #202020 50%);
  background-color: rgba(var(--callout-color), 0.1);
...
html[saved-theme="dark"] body .search > .search-container > .search-space {
  ...
  border-top-right-radius: 15px;
  border-top-width: 0px;
  box-shadow: 0 0 10px 1px var(--prompt-box-shadow, rgb(85, 85, 85) 0px 0px 10px 1px);
}
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --bases-table-cell-background-selected: hsla(207, 77%, 54%, 0.1);
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(206, 77.77%, 58.05%);
  --bases-table-container-border-radius: 5px;
  ...
  --dark: var(--text-normal, #0e0e0e);
  --darkblue: #3b84e4;
  --darkgray: var(--text-normal, #0e0e0e);
  --darkgreen: #068a5e;
  ...
  --embed-border-start: 2px solid hsl(206, 77.77%, 58.05%);
  --embed-color: hsla(207,61.6%,54%,0.035);
  --embed-content-height: 600px;
  ...
  --hibox: 24px;
  --highlight: var(--text-highlight-bg, hsla(34, 100%, 80%, 0.847));
  --hr-color: #dddddd;
  ...
  --icon-color: #7f7f7f;
  --icon-color-active: hsl(207, 77%, 54%);
  --icon-color-focused: #0e0e0e;
  --icon-color-hover: #7f7f7f;
  --image-max-width: 100%;
  --inline-title-bg-color: color-mix(in srgb, hsl(216, 88%, 26%) 15%, transparent);
  --inline-title-color: hsl(216, 88%, 26%);
  --inline-title-font: Bookerly, Inter, "Segoe UI", "霞鹜文楷 GB", "LXGW WenKai", "Microsoft YaHei", ui-sans-serif, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Microsoft YaHei Light", sans-serif,ui-sans-serif, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Microsoft YaHei Light", sans-serif;
  --inline-title-size: 1.5625em;
  ...
  --letter-space-code: 0;
  --letter-space-main: 0;
  --light: var(--background-primary-alt, #e9e9e9);
  --light-purple: #b74ff3;
  --light-yellow: #ab9a02;
  ...
  --list-marker-color-collapsed: hsl(206, 77.77%, 58.05%);
  ...
  --nav-item-background-selected: hsla(207, 77%, 54%, 0.15);
  --nav-item-color: #7f7f7f;
  --nav-item-color-active: #0e0e0e;
  --nav-item-color-highlighted: hsl(207, 77%, 54%);
  ...
  --pill-color-remove-hover: hsl(207, 77%, 54%);
  --pixel: 20px;
  --popover-height-factor: 1;
  --popover-width-factor: 1;
  ...
  --search-text: #000000;
  --secondary: var(--text-accent, hsl(207, 77%, 54%));
  ...
  --tag5: #10bdbd;
  --tape-color: #acacac65;
  --tertiary: var(--text-accent-hover, hsl(204, 78.54%, 62.1%));
  ...
  --textHighlight: var(--text-highlight-bg, hsla(34, 100%, 80%, 0.847));
...
html[saved-theme="light"] body .callout[data-callout="timeline"] {
  --button-radius: 5px;
  --callout-color: 31, 172, 139;
  --table-border-color: color-mix(in srgb, rgb(31, 172, 139) 25%, #ffffff 50%);
  background-color: rgba(var(--callout-color), 0.1);
  border-bottom-color: rgba(31, 172, 139, 0.25);
  border-bottom-left-radius: 5px;
  border-bottom-right-radius: 5px;
...
html[saved-theme="light"] body .search > .search-container > .search-space {
  ...
  border-top-right-radius: 15px;
  border-top-width: 0px;
  box-shadow: 0 0 10px 1px var(--prompt-box-shadow, rgb(190, 190, 190) 0px 0px 10px 1px);
}
