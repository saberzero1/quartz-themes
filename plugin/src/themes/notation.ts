...
export const theme: ThemeData = {
  ...
  --shiki-active-tab-border-color: rgba(255, 255, 255, 0.45) !important;
  --shiki-code-background: hsl(203, 8%, 26%) !important;
  --shiki-code-comment: rgba(255, 255, 255, 0.25) !important;
  --shiki-code-normal: rgba(255, 255, 255, 0.45) !important;
  --shiki-code-punctuation: rgba(255, 255, 255, 0.45) !important;
  --shiki-gutter-border-color: rgba(255, 255, 255, 0.14) !important;
  --shiki-gutter-text-color: rgba(255, 255, 255, 0.25) !important;
  --shiki-gutter-text-color-highlight: rgba(255, 255, 255, 0.45) !important;
  --shiki-highlight-neutral: rgba(255, 255, 255, 0.45) !important;
  --shiki-terminal-dots-color: rgba(255, 255, 255, 0.25) !important;
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --shiki-active-tab-border-color: rgba(55, 53, 47, 0.45) !important;
  --shiki-code-background: hsl(203, 8%, 96%) !important;
  --shiki-code-comment: rgba(55, 53, 47, 0.25) !important;
  --shiki-code-normal: rgba(55, 53, 47, 0.45) !important;
  --shiki-code-punctuation: rgba(55, 53, 47, 0.45) !important;
  --shiki-gutter-border-color: rgba(55, 53, 47, 0.14) !important;
  --shiki-gutter-text-color: rgba(55, 53, 47, 0.25) !important;
  --shiki-gutter-text-color-highlight: rgba(55, 53, 47, 0.45) !important;
  --shiki-highlight-neutral: rgba(55, 53, 47, 0.45) !important;
  --shiki-terminal-dots-color: rgba(55, 53, 47, 0.25) !important;
