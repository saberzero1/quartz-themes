...
html[saved-theme="dark"] body .markdown-rendered p > strong > em, html[saved-theme="dark"] strong > em {
  color: var(--interactive-normal, rgb(148, 210, 189));
  font-family: var(--alt-font, "Harlow Solid", serif);
  font-weight: 400;
  outline: rgb(148, 210, 189) none 0px;
  text-decoration-color: rgb(148, 210, 189);
}
...
html[saved-theme="dark"] body blockquote {
  ...
  color: var(--blockquote-color, rgb(233, 216, 166));
...
html[saved-theme="dark"] body .metadata-property-key {
  color: rgb(10, 147, 150);
  font-family: var(--metadata-label-font, "??", "??", "iA Writer Quattro V", monospace, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
}

html[saved-theme="dark"] body .metadata-property-value {
  color: rgb(10, 147, 150);
  font-family: var(--metadata-input-font, "??", "??", "iA Writer Quattro V", monospace, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
}
...
html[saved-theme="light"] body .markdown-rendered p > strong > em, html[saved-theme="light"] strong > em {
  color: var(--interactive-normal, rgb(203, 255, 140));
  font-family: var(--alt-font, "Recursive Sn Csl St", serif);
  font-weight: 700;
  outline: rgb(203, 255, 140) none 0px;
  text-decoration-color: rgb(203, 255, 140);
}
...
html[saved-theme="light"] body .metadata-property-key {
  color: rgb(153, 153, 153);
  font-family: var(--metadata-label-font, "??", "??", "Lexend Deca Light", monospace, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
}

html[saved-theme="light"] body .metadata-property-value {
  color: rgb(153, 153, 153);
  font-family: var(--metadata-input-font, "??", "??", "Lexend Deca Light", monospace, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
}
