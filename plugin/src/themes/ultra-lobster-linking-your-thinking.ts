...
export const theme: ThemeData = {
  ...
  --bases-cards-background: #23242a;
  --bases-cards-cover-background: #1e1f24;
  --bases-cards-shadow: 0 0 0 1px #2a2c33;
  --bases-cards-shadow-hover: 0 0 0 1px #7c849c;
  --bases-embed-border-color: #2a2c33;
  --bases-group-heading-property-color: #b9c3df;
  --bases-table-border-color: #2a2c33;
  --bases-table-cell-background-active: #23242a;
  --bases-table-cell-background-disabled: #1e1f24;
  --bases-table-cell-background-selected: hsla(193.9, 56.6%, 56.7%, 0.1);
  --bases-table-cell-shadow-active: 0 0 0 2px #a0a7bb;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(193.9, 56.6%, 56.7%);
  --bases-table-group-background: #1e1f24;
  --bases-table-header-background: #23242a;
  --bases-table-header-background-hover: rgba(#e8ecf5, 0.067);
  --bases-table-header-color: #b9c3df;
  --bases-table-summary-background: #23242a;
  --bases-table-summary-background-hover: rgba(#e8ecf5, 0.067);
  ...
  --canvas-card-label-color: #dbe2f5;
  --canvas-color: #2a2c33;
  --canvas-color-1: 230, 57, 70;
  --canvas-color-2: 255, 205, 178;
  --canvas-color-3: 242, 204, 143;
  --canvas-color-4: 96, 153, 62;
  --canvas-color-5: 114, 161, 229;
  --canvas-color-6: 144, 151, 192;
  ...
  --dark: var(--text-normal, #72c3d5);
  --darkgray: var(--text-normal, #72c3d5);
  --divider-color: #2a2c33;
  --divider-color-hover: hsl(193.9, 56.6%, 56.7%);
  --dropdown-background: #2d3039;
  --dropdown-background-hover: #7c849c;
  --embed-block-shadow-hover: 0 0 0 1px #2a2c33, inset 0 0 0 1px #2a2c33;
  --embed-border-start: 2px solid hsl(193.9, 56.6%, 56.7%);
  --file-header-background: #23242a;
  --file-header-background-focused: #23242a;
  ...
  --font-title: "Getai";
  --footnote-divider-color: #2a2c33;
  --footnote-id-color: #b9c3df;
  --footnote-id-color-no-occurrences: #dbe2f5;
  --footnote-input-background-active: rgba(#e8ecf5, 0.067);
  ...
  --highlight: var(--background-modifier-hover, rgba(#e8ecf5, 0.067));
  --hr-color: #2a2c33;
  --icon-color: #b9c3df;
  --icon-color-active: hsl(193.9, 56.6%, 56.7%);
  --icon-color-focused: #72c3d5;
  --icon-color-hover: #b9c3df;
  --indentation-guide-color: rgba(#e8ecf5, 0.12);
  --indentation-guide-color-active: rgba(#e8ecf5, 0.3);
  --inline-title-color: #e8ecf5;
  --inline-title-font: "Getai";
  --inline-title-size: clamp(2.5rem, 8vw - 2rem, 3rem);
  --inline-title-weight: 500;
  --input-date-separator: #dbe2f5;
  --input-placeholder-color: #dbe2f5;
  ...
  --light: var(--background-primary, #23242a);
  --lightgray: var(--background-secondary, #2d3039);
  ...
  --list-marker-color: #dbe2f5;
  --list-marker-color-collapsed: hsl(193.9, 56.6%, 56.7%);
  --list-marker-color-hover: #b9c3df;
  --menu-background: #2d3039;
  --menu-border-color: #7c849c;
  --menu-shadow: 0px 1px 4px rgba(0, 0, 0, 0.16);
  --metadata-border-color: #2a2c33;
  --metadata-divider-color: #2a2c33;
  --metadata-input-background-active: rgba(#e8ecf5, 0.067);
  ...
  --metadata-input-text-color: #72c3d5;
  --metadata-label-background-active: rgba(#e8ecf5, 0.067);
  ...
  --metadata-label-text-color: #b9c3df;
  --metadata-label-text-color-hover: #b9c3df;
  --metadata-property-background-active: rgba(#e8ecf5, 0.067);
  --metadata-property-box-shadow-focus: 0 0 0 2px #a0a7bb;
  --metadata-property-box-shadow-hover: 0 0 0 1px #7c849c;
  --modal-background: #23242a;
  --modal-border-color: #a0a7bb;
  --mono-rgb-0: #1e1f24;
  --mono-rgb-100: #e8ecf5;
  --nav-collapse-icon-color: #dbe2f5;
  --nav-collapse-icon-color-collapsed: #dbe2f5;
  --nav-heading-color: #72c3d5;
  --nav-heading-color-collapsed: #dbe2f5;
  --nav-heading-color-collapsed-hover: #b9c3df;
  --nav-heading-color-hover: #72c3d5;
  --nav-indentation-guide-color: rgba(#e8ecf5, 0.12);
  --nav-item-background-active: rgba(#e8ecf5, 0.067);
  --nav-item-background-hover: rgba(#e8ecf5, 0.067);
  --nav-item-background-selected: hsla(193.9, 56.6%, 56.7%, 0.15);
  --nav-item-color: #b9c3df;
  --nav-item-color-active: #72c3d5;
  --nav-item-color-highlighted: hsl(
        191 calc(54% + 180) 64%
    );
  --nav-item-color-hover: #72c3d5;
  --nav-item-color-selected: #72c3d5;
  --nav-tag-color: #dbe2f5;
  --nav-tag-color-active: #b9c3df;
  --nav-tag-color-hover: #b9c3df;
  ...
  --pill-border-color: #2a2c33;
  --pill-border-color-hover: #7c849c;
  --pill-color: #b9c3df;
  --pill-color-hover: #72c3d5;
  --pill-color-remove: #dbe2f5;
  --pill-color-remove-hover: hsl(193.9, 56.6%, 56.7%);
  --prompt-background: #23242a;
  --prompt-border-color: #a0a7bb;
  --proxy-00: #23242a;
  --proxy-10: #1e1f24;
  --proxy-20: #2d3039;
  --radius-xl: 24px;
  --raised-background: color-mix(in srgb, #2d3039 65%, transparent) linear-gradient(#2d3039, color-mix(in srgb, #2d3039 65%, transparent));
  --ribbon-background: #2d3039;
  --ribbon-background-collapsed: #23242a;
  ...
  --secondary: var(--text-accent, hsl(193.9, 56.6%, 56.7%));
  ...
  --slider-thumb-border-color: #7c849c;
  --slider-track-background: #2a2c33;
  --status-bar-background: #2d3039;
  --status-bar-border-color: #2a2c33;
  --status-bar-text-color: #b9c3df;
  ...
  --tab-container-background: #2d3039;
  ...
  --text-success: #60993e;
  --text-warning: #ffcdb2;
  --textHighlight: var(--background-modifier-hover, rgba(#e8ecf5, 0.067));
  ...
  --titlebar-border-color: #2a2c33;
  --titlebar-text-color: #b9c3df;
  --titlebar-text-color-focused: #72c3d5;
  --ulu-font-general: "Instrument", sans-serif;
  --ulu-font-title: "Getai";
  --ulu-kanban-border-color: transparent;
  --ulu-kanban-border-width: 0px;
  --ulu-radius: 8px;
  --vault-profile-color: #72c3d5;
  --vault-profile-color-hover: #72c3d5;
  --view-bottom-fade-mask: none;
  --workspace-background-translucent: rgba(#1e1f24, 0.6);
...
html body li.task-list-item input[type="checkbox"] {
  background-color: rgb(from var(--mono-rgb-100) r g b/0.05, color(srgb 0.909804 0.92549 0.960784 / 0.05));
...
html body blockquote {
  background-color: rgb(from var(--color-base-00) r g b/0.3, color(srgb 0.137255 0.141176 0.164706 / 0.3));
  font-family: "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  padding-bottom: 16px;
  padding-top: 16px;
}`,
...
html body video {
  ...
  background-color: rgb(from var(--color-base-25) r g b/0.6, color(srgb 0.203922 0.227451 0.294118 / 0.6));
...
html body .search > .search-container > .search-space > input {
  background-color: rgb(from var(--color-base-0) r g b/0.3, rgb(52, 58, 75));
  border-bottom-color: rgb(42, 44, 51);
  border-bottom-left-radius: 12px;
  border-bottom-right-radius: 12px;
  border-left-color: rgb(42, 44, 51);
...
html body ul.tags > li {
  background-color: rgb(from var(--color-accent) r g b/0.05, color(srgb 0.321922 0.698525 0.812078 / 0.05));
