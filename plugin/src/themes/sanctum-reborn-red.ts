...
export const theme: ThemeData = {
  ...
  --background-modifier-active-hover: rgba(243, 90, 55, 0.15) !important;
  ...
  --bases-table-cell-shadow-focus: 0 0 0 2px rgb(243, 90, 55) !important;
  ...
  --collapse-icon-color-collapsed: rgb(243, 90, 55) !important;
  --color-accent: rgb(243, 90, 55) !important;
  --color-accent-1: rgb(243, 90, 55) !important;
  --color-accent-2: rgb(243, 90, 55) !important;
  --color-accent-hsl: 24.4, 90.8%, 61.8% !important;
  --color-accent-rgb: 243, 90, 55 !important;
  --color-accent-rgb-d: 243, 90, 55 !important;
  --color-accent-rgb-l: 243, 90, 55 !important;
  ...
  --divider-color-hover: rgb(243, 90, 55) !important;
  ...
  --embed-border-color: rgb(243, 90, 55) !important;
  --embed-border-left: 1px solid rgb(243, 90, 55) !important;
  --embed-border-right: none !important;
  --embed-border-start: 2px solid rgb(243, 90, 55) !important;
  ...
  --graph-node-focused: rgb(243, 90, 55) !important;
  ...
  --interactive: rgb(243, 90, 55) !important;
  --interactive-accent: rgb(243, 90, 55) !important;
  --interactive-accent-hover: rgb(243, 90, 55) !important;
  ...
  --link-color: rgb(243, 90, 55) !important;
  --link-color-hover: rgb(243, 90, 55) !important;
  --link-external-color: rgb(243, 90, 55) !important;
  --link-external-color-hover: rgb(243, 90, 55) !important;
  --link-external-style: normal !important;
  --link-style: normal !important;
  --link-text-transform: none !important;
  --link-unresolved-color: rgb(243, 90, 55) !important;
  ...
  --list-marker-color-collapsed: rgb(243, 90, 55) !important;
  ...
  --nav-item-color-highlighted: rgb(243, 90, 55) !important;
  ...
  --pill-color-remove-hover: rgb(243, 90, 55) !important;
  ...
  --secondary: rgb(243, 90, 55) !important;
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px rgb(243, 90, 55) !important;
  ...
  --tab-text-color-focused-highlighted: rgb(243, 90, 55) !important;
  --table-add-button-border-color: rgb(58, 56, 56) !important;
  --table-border-color: rgb(58, 56, 56) !important;
  --table-drag-handle-background-active: rgb(243, 90, 55) !important;
  ...
  --table-hover-highlight-color: rgb(243, 90, 55 0.15) !important;
  --table-selection: hsla(24.4, 90.8%, 61.8%, 0.1) !important;
  --table-selection-border-color: rgb(243, 90, 55) !important;
  --table-sticky-height: 600px !important;
  --tag-background: rgb(243, 90, 55 0.15) !important;
  --tag-background-hover: rgb(243, 90, 55 0.25) !important;
  --tag-border-color: rgb(243, 90, 55 0.15) !important;
  --tag-border-color-hover: rgb(243, 90, 55 0.25) !important;
  --tag-color: rgb(243, 90, 55) !important;
  --tag-color-hover: rgb(243, 90, 55) !important;
  --tertiary: rgb(243, 90, 55) !important;
  --text-accent: rgb(243, 90, 55) !important;
  --text-accent-hover: rgb(243, 90, 55) !important;
  --text-code: hsl(348.5deg, 79.3%, 63.9%) !important;
  --text-error: hsl(9.6deg, 66.2%, 46.5%) !important;
  --text-faint: rgb(112, 110, 109) !important;
  --text-highlight-bg: rgba(243, 90, 55, 0.7) !important;
  --text-highlight-bg-active: rgba(243, 90, 55, 0.7) !important;
  ...
  --text-selection: rgba(243, 90, 55, 0.5) !important;
  --text-success: hsl(114.6deg, 22.4%, 49%) !important;
  --textHighlight: rgba(243, 90, 55, 0.7) !important;
  ...
  --titlebar-text-color-highlighted: rgb(243, 90, 55) !important;
