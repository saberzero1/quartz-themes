...
export const theme: ThemeData = {
  ...
  --collapse-icon-color-collapsed: var(--text-accent, rgb(243, 90, 55));
  --color-accent: var(--interactive, rgb(243, 90, 55));
  --color-accent-1: var( --interactive , rgb(243, 90, 55));
  --color-accent-2: var(--interactive, rgb(243, 90, 55));
  --color-accent-rgb: var(--color-accent-rgb-d, 243, 90, 55);
  --color-accent-rgb-d: 243, 90, 55;
  --color-accent-rgb-l: 243, 90, 55;
  ...
  --divider-color-hover: var(--interactive-accent, rgb(243, 90, 55));
  ...
  --embed-border-color: var(--interactive-accent, rgb(243, 90, 55));
  --embed-border-left: var(--embed-border-width) solid var(--embed-border-color, 1px solid rgb(243, 90, 55));
  ...
  --icon-color-active: var(--interactive, rgb(243, 90, 55));
  ...
  --interactive-accent: var(--color-accent, rgb(243, 90, 55));
  --interactive-accent-hover: var(--color-accent-1, rgb(243, 90, 55));
  ...
  --link-color: var(--interactive, rgb(243, 90, 55));
  --link-color-hover: var(--interactive, rgb(243, 90, 55));
  --link-external-color: var(--text-accent, rgb(243, 90, 55));
  --link-external-color-hover: var(--text-accent-hover, rgb(243, 90, 55));
  --link-external-style: normal;
  --link-style: normal;
  --link-text-transform: none;
  --link-unresolved-color: var(--text-accent, rgb(243, 90, 55));
  ...
  --list-marker-color-collapsed: var(--interactive, rgb(243, 90, 55));
  ...
  --nav-item-color-highlighted: var(--text-accent-hover, rgb(243, 90, 55));
  ...
  --pill-color-remove-hover: var(--text-accent, rgb(243, 90, 55));
  ...
  --secondary: var(--text-accent, var(--color-accent-1, rgb(243, 90, 55)));
  ...
  --tab-text-color-focused-highlighted: var(--text-accent, rgb(243, 90, 55));
  ...
  --table-drag-handle-background-active: var(--table-selection-border-color, rgb(243, 90, 55));
  ...
  --table-selection-border-color: var(--interactive-accent, rgb(243, 90, 55));
  ...
  --tag-color: var(--text-accent, rgb(243, 90, 55));
  --tag-color-hover: var(--text-accent, rgb(243, 90, 55));
  --tertiary: var(--text-accent-hover, var(--color-accent-2, rgb(243, 90, 55)));
  --text-accent: var(--color-accent-1, rgb(243, 90, 55));
  --text-accent-hover: var(--color-accent-2, rgb(243, 90, 55));
  ...
  --text-highlight-bg: var(--highlight, rgba(243, 90, 55, 0.7));
  --text-highlight-bg-active: var(--highlight, rgba(243, 90, 55, 0.7));
  ...
  --textHighlight: var(--text-highlight-bg, var(--highlight, rgba(243, 90, 55, 0.7)));
  ...
  --titlebar-text-color-highlighted: var(--text-accent-hover, rgb(243, 90, 55));
...
html[saved-theme="dark"] body p {
  ...
  color: var(--link-external-color, rgb(243, 90, 55));
  font-family: "??", inter, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  outline: rgb(243, 90, 55) none 0px;
  text-decoration-color: rgb(243, 90, 55);
}

html[saved-theme="dark"] body a.internal-link, html[saved-theme="dark"] .breadcrumb-container .breadcrumb-element > a {
  color: var(--link-color, rgb(243, 90, 55));
  font-family: "??", inter, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  outline: rgb(243, 90, 55) none 0px;
  text-decoration-color: rgb(243, 90, 55);
}
...
html[saved-theme="dark"] body a.internal-link.broken {
  color: var(--link-unresolved-color, rgb(243, 90, 55));
  font-family: "??", inter, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  outline: rgb(243, 90, 55) none 0px;
  text-decoration: underline;
  text-decoration-color: var(--link-unresolved-decoration-color, rgb(243, 90, 55));
}`,
...
html[saved-theme="dark"] body .transclude {
  border-bottom-color: rgb(244, 244, 240);
  border-left-color: rgb(243, 90, 55);
  border-right-color: rgb(244, 244, 240);
  border-top-color: rgb(244, 244, 240);
}
...
html[saved-theme="dark"] body a.internal-link.tag-link, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  ...
  --pill-background: var(--tag-background, rgb(243, 90, 55 0.15));
  --pill-background-hover: var(--tag-background-hover, rgb(243, 90, 55 0.25));
  --pill-border-color: var(--tag-border-color, rgb(243, 90, 55 0.15));
  --pill-border-color-hover: var(--tag-border-color-hover, rgb(243, 90, 55 0.25));
  --pill-color: var(--tag-color, rgb(243, 90, 55));
  --pill-color-hover: var(--tag-color-hover, rgb(243, 90, 55));
  --pill-color-remove: var(--tag-color, rgb(243, 90, 55));
  --pill-color-remove-hover: var(--tag-color-hover, rgb(243, 90, 55));
  background-color: var(--pill-background, rgba(0, 0, 0, 0));
  border-bottom-color: rgb(243, 90, 55);
  border-left-color: rgb(243, 90, 55);
  border-right-color: rgb(243, 90, 55);
  border-top-color: rgb(243, 90, 55);
  font-family: "??", inter, sans-serif, "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
}
...
html[saved-theme="dark"] body .note-properties-tags {
  ...
  --pill-color-remove-hover: var(--tag-color-hover, rgb(243, 90, 55));
  background-color: var(--pill-background, rgba(0, 0, 0, 0));
  color: var(--pill-color, rgb(243, 90, 55));
}
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  border-right-color: rgb(243, 90, 55);
  border-top-color: rgb(243, 90, 55);
  color: var(--tag-color, rgb(243, 90, 55));
}`,
  },
  light: {
    base: `:root:root {
  ...
  --color-accent-1: var( --interactive , rgb(243, 90, 55));
  --color-accent-2: var(--interactive, rgb(243, 90, 55));
  --color-accent-rgb: var(--color-accent-rgb-l, 243, 90, 55);
  --color-accent-rgb-d: 243, 90, 55;
  --color-accent-rgb-l: 243, 90, 55;
  --color-green-rgb: 102, 153, 97;
  --color-red-rgb: 197, 65, 40;
  ...
  --interactive: rgb(var(--color-accent-rgb));
  --interactive-accent: var(--color-accent-1, rgb(243, 90, 55));
  --interactive-accent-hover: var(--color-accent-2, rgb(243, 90, 55));
  --interactive-accent-hsl: var(--color-accent-hsl, 24.4, 90.8%, 61.8%);
  --lavender: var(--lavender-50, hsl(268deg, 57%, 66%));
  --lavender-10: hsl(264deg, 63%, 97%);
  --lavender-100: hsl(266deg, 100%, 15%);
  ...
  --secondary: var(--text-accent, var(--color-accent, rgb(243, 90, 55)));
  ...
  --tag-color-hover: var(--text-accent, rgb(243, 90, 55));
  --tertiary: var(--text-accent-hover, var(--color-accent-2, rgb(243, 90, 55)));
  --text-accent: var(--color-accent, rgb(243, 90, 55));
  --text-accent-hover: var(--color-accent-2, rgb(243, 90, 55));
