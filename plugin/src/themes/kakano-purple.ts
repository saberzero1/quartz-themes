...
export const theme: ThemeData = {
  ...
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(275, 50%, 40%);
  ...
  --bases-table-header-background-hover: hsl(275, 50%, 40%);
  ...
  --bases-table-summary-background-hover: hsl(275, 50%, 40%);
  ...
  --highlight: var(--background-modifier-hover, hsl(275, 50%, 40%));
  --hr-color: color-mix(
    in srgb,
    hsl(275, 50%, 40%),
    black 25%
  );
  --icon-color: hsl(275, 50%, 40%);
  ...
  --metadata-property-background-active: hsl(275, 50%, 40%);
  ...
  --nav-item-background-active: hsl(275, 50%, 40%);
  ...
  --pill-background-hover: hsl(275, 50%, 40%);
  ...
  --secondary: var(--interactive-accent, hsl(275, 50%, 40%));
  ...
  --textHighlight: var(--background-modifier-hover, hsl(275, 50%, 40%));
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --bases-table-cell-shadow-active: 0 0 0 2px hsl(275, 50%, 40%);
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(275, 50%, 40%);
  --bases-table-container-border-radius: 0.25rem;
  ...
  --metadata-property-box-shadow-focus: 0 0 0 2px hsl(275, 50%, 40%);
  --metadata-property-box-shadow-hover: none;
  --metadata-sidebar-input-font-size: 0.8rem;
  --metadata-sidebar-label-font-size: 0.8rem;
  --modal-background: color-mix(
  ...
  --tag-weight: 400;
  --tertiary: var(--interactive-accent-hover, hsl(275, 50%, 40%));
  --text-error: hsl(from hsl(275, 50%, 40%) 356 s l);
  --text-faint: color-mix(
    in srgb,
    hsl(275, 50%, 40%),
