...
html[saved-theme="dark"] body pre > code > [data-line] {
  border-left-color: color(srgb 0.6 0.58 0.2);
}
...
html[saved-theme="dark"] body pre > code [data-highlighted-chars] {
  border-bottom-color: color(srgb 0.6 0.58 0.2);
  border-left-color: color(srgb 0.6 0.58 0.2);
  border-right-color: color(srgb 0.6 0.58 0.2);
  border-top-color: color(srgb 0.6 0.58 0.2);
}
...
html[saved-theme="dark"] body ::-webkit-scrollbar {
  background: color(srgb 0.0216667 0.01 0.03) none repeat scroll 0% 0% / auto padding-box border-box;
  background-color: color(srgb 0.0216667 0.01 0.03);
}
