...
export const theme: ThemeData = {
  ...
  --collapse-icon-color-collapsed: rgb(41, 153, 138);
  --color-accent: rgb(36, 132, 124);
  --color-accent-1: rgb(41, 153, 138);
  --color-accent-2: rgb(44, 175, 154);
  ...
  --graph-node-focused: rgb(41, 153, 138);
  ...
  --hr-color: #282726;
  --icon-color: #878580;
  --icon-color-active: rgb(41, 153, 138);
  ...
  --link-color: rgb(41, 153, 138);
  --link-color-hover: rgb(44, 175, 154);
  --link-external-color: rgb(41, 153, 138);
  --link-external-color-hover: rgb(44, 175, 154);
  --link-unresolved-color: rgb(41, 153, 138);
  --link-unresolved-decoration-color: rgba(36, 132, 124, 0.3);
  --list-marker-color: #575653;
  --list-marker-color-collapsed: rgb(41, 153, 138);
  ...
  --nav-item-color-highlighted: rgb(41, 153, 138);
  ...
  --pill-color-remove-hover: rgb(41, 153, 138);
  ...
  --tab-text-color-focused-highlighted: rgb(41, 153, 138);
  ...
  --tag-color: rgb(41, 153, 138);
  --tag-color-hover: rgb(41, 153, 138);
  --text-accent: rgb(41, 153, 138);
  --text-accent-hover: rgb(44, 175, 154);
  --text-error: #D14D41;
  --text-faint: #575653;
  --text-muted: #878580;
  --text-normal: #CECDC3;
...
body sup {
  ...
  --bases-table-cell-shadow-focus: 0 0 0 2px rgb(37, 141, 131);
  ...
  --blockquote-border-color: rgb(37, 141, 131);
  ...
  --divider-color-hover: rgb(37, 141, 131);
  ...
  --embed-border-start: 2px solid rgb(37, 141, 131);
  ...
  --table-drag-handle-background-active: rgb(37, 141, 131);
  --table-drag-handle-color: #B7B5AC;
  --table-header-border-color: #E6E4D9;
  --table-header-color: #100F0F;
  --table-selection: rgba(36, 132, 124, 0.1);
  --table-selection-border-color: rgb(37, 141, 131);
  --tag-background: rgba(36, 132, 124, 0.1);
  --tag-background-hover: rgba(36, 132, 124, 0.2);
  --tag-border-color: rgba(36, 132, 124, 0.15);
  --tag-border-color-hover: rgba(36, 132, 124, 0.15);
  ...
  --text-accent-hover: rgb(41, 153, 138);
  --text-error: #AF3029;
  --text-faint: #B7B5AC;
  --text-muted: #6F6E69;
  --text-normal: #100F0F;
