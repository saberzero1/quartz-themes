...
export const theme: ThemeData = {
  ...
  --dark: var(--text-normal, rgb(224, 226, 213));
  --darkgray: var(--text-normal, rgb(224, 226, 213));
  ...
  --highlight: var(--text-highlight-bg, rgba(80, 102, 130, 0.5));
  --hr-color: hsl(0, 0%, 39%);
  --icon-color: #a1a1a1;
  ...
  --light: var(--background-primary, rgb(21, 30, 45));
  --lightgray: var(--background-secondary, rgb(21, 30, 45));
  ...
  --secondary: var(--text-accent, #46b4d3);
  ...
  --tertiary: var(--text-accent-hover, #a1a1a1);
  --text-accent: #46b4d3;
  ...
  --textHighlight: var(--text-highlight-bg, rgba(80, 102, 130, 0.5));
