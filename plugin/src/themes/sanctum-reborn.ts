...
html[saved-theme="dark"] body .callout[data-callout="law"] {
  --callout-color: 243, 189, 79;
  --table-border-color: color-mix(in srgb, rgb(243, 189, 79) 25%, rgb(22, 22, 22) 50%);
  background-color: rgba(243, 189, 79, 0.2);
  border-bottom-color: rgba(243, 189, 79, 0.3);
  border-bottom-left-radius: 4px;
  border-bottom-right-radius: 4px;
  border-bottom-style: solid;
  border-bottom-width: 0px;
  border-left-color: rgba(243, 189, 79, 0.3);
  border-left-style: solid;
  border-left-width: 0px;
  border-right-color: rgba(243, 189, 79, 0.3);
  border-right-style: solid;
  border-right-width: 0px;
  border-top-color: rgba(243, 189, 79, 0.3);
  border-top-left-radius: 4px;
  border-top-right-radius: 4px;
  border-top-style: solid;
  border-top-width: 0px;
...
html[saved-theme="dark"] body .callout[data-callout="proof"] {
  --callout-color: 254, 184, 113;
  --table-border-color: color-mix(in srgb, rgb(254, 184, 113) 25%, rgb(22, 22, 22) 50%);
  background-color: rgba(254, 184, 113, 0.2);
  border-bottom-color: rgba(254, 184, 113, 0.3);
  border-bottom-left-radius: 4px;
  border-bottom-right-radius: 4px;
  border-bottom-style: solid;
  border-bottom-width: 0px;
  border-left-color: rgba(254, 184, 113, 0.3);
  border-left-style: solid;
  border-left-width: 0px;
  border-right-color: rgba(254, 184, 113, 0.3);
  border-right-style: solid;
  border-right-width: 0px;
  border-top-color: rgba(254, 184, 113, 0.3);
  border-top-left-radius: 4px;
  border-top-right-radius: 4px;
  border-top-style: solid;
  border-top-width: 0px;
...
html[saved-theme="dark"] body .callout[data-callout="rule"] {
  --callout-color: 243, 189, 79;
  --table-border-color: color-mix(in srgb, rgb(243, 189, 79) 25%, rgb(22, 22, 22) 50%);
  background-color: rgba(243, 189, 79, 0.2);
  border-bottom-color: rgba(243, 189, 79, 0.3);
...
html[saved-theme="light"] body .callout[data-callout="law"] {
  --callout-color: 243, 189, 79;
  --table-border-color: color-mix(in srgb, rgb(243, 189, 79) 25%, rgb(244, 244, 240) 50%);
  background-color: rgba(243, 189, 79, 0.2);
  border-bottom-color: rgba(243, 189, 79, 0.3);
  border-bottom-left-radius: 4px;
  border-bottom-right-radius: 4px;
...
html[saved-theme="light"] body .callout[data-callout="proof"] {
  --callout-color: 254, 184, 113;
  --table-border-color: color-mix(in srgb, rgb(254, 184, 113) 25%, rgb(244, 244, 240) 50%);
  background-color: rgba(254, 184, 113, 0.2);
  border-bottom-color: rgba(254, 184, 113, 0.3);
  border-bottom-left-radius: 4px;
  border-bottom-right-radius: 4px;
...
html[saved-theme="light"] body .callout[data-callout="rule"] {
  --callout-color: 243, 189, 79;
  --table-border-color: color-mix(in srgb, rgb(243, 189, 79) 25%, rgb(244, 244, 240) 50%);
  background-color: rgba(243, 189, 79, 0.2);
  border-bottom-color: rgba(243, 189, 79, 0.3);
