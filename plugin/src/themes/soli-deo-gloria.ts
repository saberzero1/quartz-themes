...
export const theme: ThemeData = {
  ...
  --background-modifier-active-hover: rgba(0, 0, 0, 0.1) !important;
  ...
  --bases-table-cell-background-selected: rgba(0, 0, 0, 0.1) !important;
  ...
  --color-accent: rgb(0, 0, 0) !important;
  ...
  --highlight: rgba(0, 0, 0, 0.1) !important;
  ...
  --link-unresolved-decoration-color: rgba(0, 0, 0, 0.3) !important;
  ...
  --nav-item-background-selected: rgba(0, 0, 0, 0.15) !important;
  ...
  --text-selection: rgba(0, 0, 0, 0.33) !important;
  --textHighlight: rgba(0, 0, 0, 0.1) !important;
...
html[saved-theme="dark"] body kbd {
  ...
  --text-accent: rgb(0, 0, 0) !important;
  --text-accent-hover: rgb(0, 0, 0) !important;
  --text-selection: rgba(0, 0, 0, 0.2) !important;
  --textHighlight: rgba(0, 0, 0, 0.1) !important;
  --titleFont: '??', Comorant-Garamond, serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif !important;
