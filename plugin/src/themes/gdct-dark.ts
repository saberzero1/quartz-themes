...
export const theme: ThemeData = {
  ...
  --dark: var(--text-normal, #fffdf9);
  --darkgray: var(--text-normal, #fffdf9);
  ...
  --highlight: var(--text-highlight-bg, rgba(250, 250, 250, 0.1));
  --hr-color: hsl(0, 0%, 39%);
  --icon-color: #6f6f6f;
  ...
  --light: var(--background-primary, #313030);
  --lightgray: var(--background-secondary, #313030);
  ...
  --secondary: var(--text-accent, #3daddb);
  ...
  --tertiary: var(--text-accent-hover, #6f6f6f);
  --text-accent: #3daddb;
  ...
  --textHighlight: var(--text-highlight-bg, rgba(250, 250, 250, 0.1));
