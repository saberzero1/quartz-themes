...
export const theme: ThemeData = {
  ...
  --accent: hsl(197, 49%, 38%);
  --accent-color-dark: #31748f;
  --accent-color-hover: #9ccfd8;
  --accent-color-light: #ebbcba;
  --accent-h: 197;
  --accent-l: 38%;
  --accent-s: 49%;
  ...
  --background-modifier-border-hover: #524f67;
  --background-modifier-error: #eb6f92;
  --background-modifier-error-hover: #eb6f92;
  --background-modifier-form-field: #1f1d2e;
  --background-modifier-form-field-hover: #1f1d2e;
  --background-modifier-hover: #26233a;
  ...
  --bases-cards-shadow-hover: 0 0 0 1px #524f67;
  ...
  --bases-table-cell-background-selected: #26233a;
  --bases-table-cell-shadow-active: 0 0 0 2px #524f67;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(197, 49%, 38%);
  --bases-table-header-background: #191724;
  --bases-table-header-background-hover: #26233a;
  --bases-table-header-color: #e0def4;
  --bases-table-summary-background: #191724;
  --bases-table-summary-background-hover: #26233a;
  --blockquote-border-color: #31748f;
  --blur-background: color-mix(in srgb, #1f1d2e 65%, transparent) linear-gradient(#1f1d2e, color-mix(in srgb, #1f1d2e 65%, transparent));
  --bold-color: #ebbcba;
  --border-color: #403d52;
  --border-color-primary: #403d52;
  --border-color-secondary: #524f67;
  ...
  --collapse-icon-color-collapsed: hsl(197, 49%, 38%);
  --color-accent: hsl(197, 49%, 38%);
  --color-accent-1: hsl(194, 49.98%, 43.7%);
  --color-accent-2: hsl(192, 51.45%, 49.02%);
  --color-accent-hsl: 197, 49%, 38%;
  --color-blue: #31748f;
  --color-cyan: #9ccfd8;
  --color-green: #9ccfd8;
  ...
  --highlight: var(--text-highlight-bg, hsl(197, 49%, 38%));
  --highlight-high: #524f67;
  --highlight-low: #21202e;
  --highlight-med: #403d52;
  --hr-color: #26233a;
  --icon-color: #e0def4;
  --icon-color-active: hsl(197, 49%, 38%);
  --icon-color-focused: #e0def4;
  --icon-color-hover: #e0def4;
  --indentation-guide-color: #26233a;
  --indentation-guide-color-active: #6e6a86;
  --inline-title-color: #e0def4;
  --input-date-separator: #6e6a86;
  --input-placeholder-color: #6e6a86;
  --interactive-accent: hsl(197, 49%, 38%);
  --interactive-accent-hover: hsl(194, 49.98%, 43.7%);
  --interactive-accent-hsl: 197, 49%, 38%;
  --interactive-hover: #403d52;
  --interactive-normal: #1f1d2e;
  --iris: #c4a7e7;
  --italic-color: #ebbcba;
  --light: var(--background-primary, #191724);
  --lightgray: var(--background-secondary, #1f1d2e);
  --link-color: #31748f;
  --link-color-hover: #9ccfd8;
  --link-external-color: #31748f;
  --link-external-color-hover: #9ccfd8;
  --link-unresolved-decoration-color: hsla(197, 49%, 38%, 0.3);
  --list-marker-color: #31748f;
  --list-marker-color-collapsed: hsl(197, 49%, 38%);
  --list-marker-color-hover: #e0def4;
  --love: #eb6f92;
  --menu-background: #1f1d2e;
  --menu-border-color: #524f67;
  --metadata-border-color: #403d52;
  --metadata-divider-color: #403d52;
  --metadata-input-background-active: #26233a;
  --metadata-input-text-color: #e0def4;
  --metadata-label-background-active: #26233a;
  --metadata-label-text-color: #e0def4;
  --metadata-label-text-color-hover: #e0def4;
  --metadata-property-background-active: #26233a;
  --metadata-property-box-shadow-focus: 0 0 0 2px #524f67;
  --metadata-property-box-shadow-hover: 0 0 0 1px #524f67;
  --modal-background: #1f1d2e;
  --modal-border-color: #403d52;
  --muted: #6e6a86;
  --nav-collapse-icon-color: #524f67;
  --nav-collapse-icon-color-collapsed: #524f67;
  ...
  --nav-indentation-guide-color: #524f67;
  --nav-item-background-active: #31748f;
  --nav-item-background-hover: #26233a;
  --nav-item-background-selected: red;
  --nav-item-color: #e0def4;
  --nav-item-color-active: white;
  --nav-item-color-highlighted: #ebbcba;
  ...
  --pill-border-color-hover: #524f67;
  --pill-color: #e0def4;
  --pill-color-hover: #e0def4;
  --pill-color-remove: #6e6a86;
  --pill-color-remove-hover: hsl(197, 49%, 38%);
  --pine: #31748f;
  --prompt-background: #191724;
  --prompt-border-color: #403d52;
  --raised-background: color-mix(in srgb, #1f1d2e 65%, transparent) linear-gradient(#1f1d2e, color-mix(in srgb, #1f1d2e 65%, transparent));
  ...
  --secondary: var(--text-accent, hsl(197, 49%, 38%));
  --selection-background-color: #26233a;
  ...
  --shiki-code-background: #1f1d2e;
  --shiki-code-comment: #6e6a86;
  --shiki-code-function: #9ccfd8;
  --shiki-code-important: #ebbcba;
  ...
  --shiki-gutter-border-color: #403d52;
  ...
  --slider-track-background: #1f1d2e;
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(197, 49%, 38%);
  --tab-text-color: #403d52;
  ...
  --table-drag-handle-color: #26233a;
  --table-drag-handle-color-active: #26233a;
  --table-header-border-color: #403d52;
  --table-header-color: #e0def4;
  --table-selection: #26233a;
  --table-selection-border-color: #9ccfd8;
  --tag-background: #26233a;
  --tag-background-hover: #6e6a86;
  --tag-border-color: hsla(197, 49%, 38%, 0.15);
  --tag-border-color-hover: hsla(197, 49%, 38%, 0.15);
  --tag-color: #31748f;
  --tag-color-hover: #31748f;
  --tertiary: var(--text-accent-hover, red);
  --text: #e0def4;
  --text-accent: hsl(197, 49%, 38%);
  --text-accent-hover: red;
  --text-color: #e0def4;
  --text-color-accent: white;
  --text-color-muted-dark: #26233a;
  --text-color-muted-light: #6e6a86;
  --text-error: #eb6f92;
  --text-faint: #6e6a86;
  --text-highlight-bg: hsl(197, 49%, 38%);
  --text-muted: #e0def4;
  --text-normal: #e0def4;
  --text-on-accent-inverted: #191724;
  --text-selection: #26233a;
  --text-success: #9ccfd8;
  --text-warning: #f6c177;
  --textHighlight: var(--text-highlight-bg, hsl(197, 49%, 38%));
  --titlebar-background: #1f1d2e;
  --titlebar-background-focused: #403d52;
