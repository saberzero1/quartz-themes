...
export const theme: ThemeData = {
  ...
  --accent-color-dark: var(--pine, #31748f);
  --accent-color-hover: var(--foam, #9ccfd8);
  --accent-color-light: var(--rose, #ebbcba);
  --accent-h: 197;
  --accent-l: 38%;
  --accent-s: 49%;
  --background-modifier-border: var(--border-color-primary, #403d52);
  --background-modifier-border-focus: var(--border-color-secondary, #524f67);
  --background-modifier-border-hover: var(--border-color-secondary, #524f67);
  --background-modifier-error: var(--color-red, #eb6f92);
  --background-modifier-error-hover: var(--color-red, #eb6f92);
  --background-modifier-form-field: var(--background-secondary, #1f1d2e);
  --background-modifier-form-field-hover: var(--background-modifier-form-field, #1f1d2e);
  --background-modifier-hover: var(--selection-background-color, #26233a);
  --background-modifier-success: var(--color-green, #9ccfd8);
  --background-primary: var(--base, #191724);
  --background-secondary: var(--surface, #1f1d2e);
  --base: #191724;
  --bases-cards-background: var(--background-primary, #191724);
  --bases-embed-border-color: var(--background-modifier-border, #403d52);
  --bases-group-heading-property-color: var(--text-muted, #e0def4);
  --bases-table-border-color: var(--table-border-color, #403d52);
  --bases-table-cell-background-active: var(--background-primary, #191724);
  --bases-table-cell-background-selected: var(--table-selection, #26233a);
  --bases-table-header-background: var(--background-primary, #191724);
  --bases-table-header-background-hover: var(--background-modifier-hover, #26233a);
  --bases-table-header-color: var(--text-muted, #e0def4);
  --bases-table-summary-background: var(--background-primary, #191724);
  --bases-table-summary-background-hover: var(--background-modifier-hover, #26233a);
  --blockquote-border-color: var(--accent-color-dark, #31748f);
  --bold-color: var(--accent-color-light, #ebbcba);
  --border-color: var(--border-color-primary, #403d52);
  --border-color-primary: var(--highlight-med, #403d52);
  --border-color-secondary: var(--highlight-high, #524f67);
  ...
  --canvas-background: var(--background-primary, #191724);
  --canvas-card-label-color: var(--text-faint, #6e6a86);
  --canvas-color: 49, 116, 143;
  --caret-color: var(--text-normal, #e0def4);
  --checkbox-border-color: var(--text-color-muted-light, #6e6a86);
  --checkbox-border-color-hover: var(--accent-color-hover, #9ccfd8);
  --checkbox-color: var(--accent-color-dark, #31748f);
  --checkbox-color-hover: var(--accent-color-hover, #9ccfd8);
  --checkbox-marker-color: var(--background-primary, #191724);
  --checklist-done-color: var(--text-color-muted-light, #6e6a86);
  --code-background: var(--background-secondary, #1f1d2e);
  --code-boolean: var(--rose, #ebbcba);
  --code-border-color: var(--background-modifier-border, #403d52);
  --code-bracket-background: var(--background-modifier-hover, #26233a);
  --code-builtin: var(--love, #eb6f92);
  --code-comment: var(--muted, #6e6a86);
  --code-definition: var(--rose, #ebbcba);
  --code-function: var(--color-yellow, #f6c177);
  --code-important: var(--color-yellow, #f6c177);
  --code-keyword: var(--pine, #31748f);
  --code-normal: var(--text-normal, #e0def4);
  --code-operator: var(--pine, #31748f);
  --code-parentheses: var(--subtle, #908caa);
  --code-property: var(--foam, #9ccfd8);
  --code-punctuation: var(--text-muted, #e0def4);
  --code-string: var(--gold, #f6c177);
  --code-tag: var(--color-red, #eb6f92);
  --code-value: var(--rose, #ebbcba);
  --code-variable: var(--text, #e0def4);
  --collapse-icon-color: var(--text-faint, #6e6a86);
  --collapse-icon-color-collapsed: var(--text-accent, hsl(197, 49%, 38%));
  --color-blue: #31748f;
  --color-cyan: #9ccfd8;
  --color-green: #9ccfd8;
  --color-orange: #ebbcba;
  ...
  --color-red: #eb6f92;
  --color-yellow: #f6c177;
  --dark: var(--text-normal, var(--text-color, #e0def4));
  --darkgray: var(--text-normal, var(--text-color, #e0def4));
  --divider-color: var(--background-modifier-border, #403d52);
  --divider-color-hover: var(--interactive-accent, hsl(197, 49%, 38%));
  --dropdown-background: var(--interactive-normal, #1f1d2e);
  --dropdown-background-hover: var(--interactive-hover, #403d52);
  --file-header-background: var(--background-primary, #191724);
  --file-header-background-focused: var(--background-primary, #191724);
  --flair-background: var(--interactive-normal, #1f1d2e);
  --flair-color: var(--text-normal, #e0def4);
  --foam: #9ccfd8;
  --footnote-divider-color: var(--metadata-divider-color, #403d52);
  --footnote-id-color: var(--text-muted, #e0def4);
  --footnote-id-color-no-occurrences: var(--text-faint, #6e6a86);
  --footnote-input-background-active: var(--metadata-input-background-active, #26233a);
  --gold: #f6c177;
  --graph-line: var(--border-color-secondary, #524f67);
  --graph-node: var(--accent, hsl(197, 49%, 38%));
  --graph-node-attachment: var(--accent-color-dark, #31748f);
  --graph-node-focused: var(--accent-color-hover, #9ccfd8);
  --graph-node-tag: var(--accent-color-light, #ebbcba);
  --graph-node-unresolved: var(--border-color-primary, #403d52);
  --graph-text: var(--text-color, #e0def4);
  --gray: var(--text-muted, var(--text-color, #e0def4));
  --h1-color: var(--color-purple, #c4a7e7);
  --h2-color: var(--color-blue, #31748f);
  --h3-color: var(--color-green, #9ccfd8);
  --h4-color: var(--color-yellow, #f6c177);
  --h5-color: var(--color-orange, #ebbcba);
  --h6-color: var(--color-red, #eb6f92);
  --heading-formatting: var(--text-faint, #6e6a86);
  --highlight: var(--text-highlight-bg, var(--accent, hsl(197, 49%, 38%)));
  --highlight-high: #524f67;
  --highlight-low: #21202e;
  --highlight-med: #403d52;
  --hr-color: var(--text-color-muted-dark, #26233a);
  --icon-color: var(--text-muted, #e0def4);
  --icon-color-active: var(--text-accent, hsl(197, 49%, 38%));
  --icon-color-focused: var(--text-normal, #e0def4);
  --icon-color-hover: var(--text-muted, #e0def4);
  --indentation-guide-color: var(--text-color-muted-dark, #26233a);
  --indentation-guide-color-active: var(--text-color-muted-light, #6e6a86);
  --inline-title-color: var(--text-color, #e0def4);
  --input-date-separator: var(--text-faint, #6e6a86);
  --input-placeholder-color: var(--text-faint, #6e6a86);
  --interactive-accent: var(--accent, hsl(197, 49%, 38%));
  --interactive-accent-hover: var(--color-accent-1, hsl(194, 49.98%, 43.7%));
  --interactive-accent-hsl: var(--color-accent-hsl, 197, 49%, 38%);
  --interactive-hover: var(--border-color-primary, #403d52);
  --interactive-normal: var(--background-secondary, #1f1d2e);
  --iris: #c4a7e7;
  --italic-color: var(--accent-color-light, #ebbcba);
  --light: var(--background-primary, var(--base, #191724));
  --lightgray: var(--background-secondary, var(--surface, #1f1d2e));
  --link-color: var(--accent-color-dark, #31748f);
  --link-color-hover: var(--accent-color-hover, #9ccfd8);
  --link-external-color: var(--accent-color-dark, #31748f);
  --link-external-color-hover: var(--accent-color-hover, #9ccfd8);
  --list-marker-color: var(--accent-color-dark, #31748f);
  --list-marker-color-collapsed: var(--text-accent, hsl(197, 49%, 38%));
  --list-marker-color-hover: var(--text-muted, #e0def4);
  --love: #eb6f92;
  --menu-background: var(--background-secondary, #1f1d2e);
  --menu-border-color: var(--background-modifier-border-hover, #524f67);
  --metadata-border-color: var(--background-modifier-border, #403d52);
  --metadata-divider-color: var(--background-modifier-border, #403d52);
  --metadata-input-background-active: var(--background-modifier-hover, #26233a);
  --metadata-input-text-color: var(--text-color, #e0def4);
  --metadata-label-background-active: var(--background-modifier-hover, #26233a);
  --metadata-label-text-color: var(--text-color, #e0def4);
  --metadata-label-text-color-hover: var(--text-muted, #e0def4);
  --metadata-property-background-active: var(--background-modifier-hover, #26233a);
  --modal-background: var(--background-secondary, #1f1d2e);
  --modal-border-color: var(--border-color-primary, #403d52);
  --muted: #6e6a86;
  --nav-collapse-icon-color: var(--border-color-secondary, #524f67);
  --nav-collapse-icon-color-collapsed: var(--border-color-secondary, #524f67);
  --nav-heading-color: var(--text-normal, #e0def4);
  --nav-heading-color-collapsed: var(--text-faint, #6e6a86);
  --nav-heading-color-collapsed-hover: var(--text-muted, #e0def4);
  --nav-heading-color-hover: var(--text-normal, #e0def4);
  --nav-indentation-guide-color: var(--border-color-secondary, #524f67);
  --nav-item-background-active: var(--accent-color-dark, #31748f);
  --nav-item-background-hover: var(--selection-background-color, #26233a);
  --nav-item-color: var(--text-color, #e0def4);
  --nav-item-color-active: var(--text-color-accent, white);
  --nav-item-color-highlighted: var(--accent-color-light, #ebbcba);
  --nav-item-color-hover: var(--text-color-accent, white);
  --nav-item-color-selected: var(--text-normal, red);
  --nav-tag-color: var(--text-faint, #6e6a86);
  --nav-tag-color-active: var(--text-muted, #e0def4);
  --nav-tag-color-hover: var(--text-muted, #e0def4);
  --nc: #16141f;
  --overlay: #26233a;
  --pdf-background: var(--background-primary, #191724);
  --pdf-page-background: var(--background-primary, #191724);
  --pdf-sidebar-background: var(--background-primary, #191724);
  --pill-border-color: var(--background-modifier-border, #403d52);
  --pill-border-color-hover: var(--background-modifier-border-hover, #524f67);
  --pill-color: var(--text-muted, #e0def4);
  --pill-color-hover: var(--text-normal, #e0def4);
  --pill-color-remove: var(--text-faint, #6e6a86);
  --pill-color-remove-hover: var(--text-accent, hsl(197, 49%, 38%));
  --pine: #31748f;
  --prompt-background: var(--background-primary, #191724);
  --prompt-border-color: var(--border-color-primary, #403d52);
  --raised-background: var(--blur-background, color-mix(in srgb, #1f1d2e 65%, transparent) linear-gradient(#1f1d2e, color-mix(in srgb, #1f1d2e 65%, transparent)));
  --ribbon-background: var(--background-secondary, #1f1d2e);
  --ribbon-background-collapsed: var(--background-primary, #191724);
  --rose: #ebbcba;
  --search-clear-button-color: var(--text-muted, #e0def4);
  --search-icon-color: var(--text-muted, #e0def4);
  --search-result-background: var(--background-primary, #191724);
  --secondary: var(--text-accent, var(--accent, hsl(197, 49%, 38%)));
  --selection-background-color: var(--overlay, #26233a);
  --selection-border-color: var(--accent-color-hover, #9ccfd8);
  --setting-group-heading-color: var(--text-normal, #e0def4);
  --setting-items-border-color: var(--background-modifier-border, #403d52);
  --shiki-active-tab-border-color: var(--shiki-highlight-neutral, #e0def4);
  --shiki-code-background: var(--code-background, #1f1d2e);
  --shiki-code-comment: var(--text-faint, #6e6a86);
  --shiki-code-function: var(--color-green, #9ccfd8);
  --shiki-code-important: var(--color-orange, #ebbcba);
  --shiki-code-keyword: var(--color-pink, pink);
  --shiki-code-normal: var(--text-muted, #e0def4);
  --shiki-code-property: var(--color-cyan, #9ccfd8);
  --shiki-code-punctuation: var(--text-muted, #e0def4);
  --shiki-code-string: var(--color-yellow, #f6c177);
  --shiki-code-value: var(--color-purple, #c4a7e7);
  --shiki-gutter-border-color: var(--background-modifier-border, #403d52);
  --shiki-gutter-text-color: var(--text-faint, #6e6a86);
  --shiki-gutter-text-color-highlight: var(--shiki-code-normal, #e0def4);
  --shiki-highlight-neutral: var(--shiki-code-normal, #e0def4);
  --shiki-terminal-dots-color: var(--text-faint, #6e6a86);
  --slider-track-background: var(--background-secondary, #1f1d2e);
  --status-bar-background: var(--background-secondary, #1f1d2e);
  --status-bar-border-color: var(--divider-color, #403d52);
  --status-bar-text-color: var(--text-muted, #e0def4);
  --subtle: #908caa;
  --suggestion-background: var(--background-primary, #191724);
  --surface: #1f1d2e;
  --sync-avatar-color-1: var(--color-red, #eb6f92);
  --sync-avatar-color-2: var(--color-orange, #ebbcba);
  --sync-avatar-color-3: var(--color-yellow, #f6c177);
  --sync-avatar-color-4: var(--color-green, #9ccfd8);
  --sync-avatar-color-5: var(--color-cyan, #9ccfd8);
  --sync-avatar-color-6: var(--color-blue, #31748f);
  --sync-avatar-color-7: var(--color-purple, #c4a7e7);
  --sync-avatar-color-8: var(--color-pink, pink);
  --tab-background-active: var(--background-primary, #191724);
  --tab-container-background: var(--background-secondary, #1f1d2e);
  --tab-divider-color: var(--selection-background-color, #26233a);
  --tab-outline-color: var(--border-color-primary, #403d52);
  --tab-switcher-background: var(--background-secondary, #1f1d2e);
  --tab-text-color: var(--border-color-primary, #403d52);
  --tab-text-color-active: var(--text-color, #e0def4);
  --tab-text-color-focused: var(--text-color, #e0def4);
  --tab-text-color-focused-active: var(--text-color, #e0def4);
  ...
  --table-border-color: var(--border-color-primary, #403d52);
  --table-drag-handle-background-active: var(--table-selection-border-color, #9ccfd8);
  --table-drag-handle-color: var(--selection-background-color, #26233a);
  --table-drag-handle-color-active: var(--selection-background-color, #26233a);
  --table-header-border-color: var(--table-border-color, #403d52);
  --table-header-color: var(--text-color, #e0def4);
  --table-selection: var(--selection-background-color, #26233a);
  --table-selection-border-color: var(--selection-border-color, #9ccfd8);
  --tag-background: var(--text-color-muted-dark, #26233a);
  --tag-background-hover: var(--text-color-muted-light, #6e6a86);
  --tag-color: var(--accent-color-dark, #31748f);
  --tag-color-hover: var(--accent-color-dark, #31748f);
  --tertiary: var(--text-accent-hover, var(--color-accent-2, red));
  --text: #e0def4;
  --text-accent: var(--accent, hsl(197, 49%, 38%));
  --text-accent-hover: var(--color-accent-2, red);
  --text-color: var(--text, #e0def4);
  --text-color-accent: white;
  --text-color-muted-dark: var(--overlay, #26233a);
  --text-color-muted-light: var(--muted, #6e6a86);
  --text-error: var(--color-red, #eb6f92);
  --text-faint: var(--text-color-muted-light, #6e6a86);
  --text-highlight-bg: var(--accent, hsl(197, 49%, 38%));
  --text-muted: var(--text-color, #e0def4);
  --text-normal: var(--text-color, #e0def4);
  --text-on-accent: var(--text-color-accent, white);
  --text-on-accent-inverted: var(--background-primary, #191724);
  --text-selection: var(--selection-background-color, #26233a);
  --text-success: var(--color-green, #9ccfd8);
  --text-warning: var(--color-yellow, #f6c177);
  --textHighlight: var(--text-highlight-bg, var(--accent, hsl(197, 49%, 38%)));
  --titlebar-background: var(--background-secondary, #1f1d2e);
  --titlebar-background-focused: var(--border-color-primary, #403d52);
  --titlebar-border-color: var(--background-modifier-border, #403d52);
  --titlebar-text-color: var(--text-muted, #e0def4);
...
html[saved-theme="dark"] body[data-slug] div#quartz-root.page, html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left, html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left:has(.explorer), html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left .explorer .explorer-content {
  --bases-table-header-background: var(--background-secondary, #1f1d2e);
  background-color: var(--tab-container-background, rgb(31, 29, 46));
...
html[saved-theme="dark"] body .page > div#quartz-body div.sidebar {
  background-color: var(--background-secondary, rgb(31, 29, 46));
  color: rgb(224, 222, 244);
}
...
html[saved-theme="dark"] body .text-highlight {
  background-color: var(--text-highlight-bg, rgb(49, 117, 144));
...
html[saved-theme="dark"] body li.task-list-item input[type="checkbox"]:checked {
  background-color: var(--checkbox-color, rgb(49, 116, 143));
  border-color: rgb(49, 116, 143);
}

html[saved-theme="dark"] body p {
  color: var(--text-muted, rgb(224, 222, 244));
  outline: rgb(224, 222, 244) none 0px;
  text-decoration-color: rgb(224, 222, 244);
}`,
    links: `html[saved-theme="dark"] body a.external-link, html[saved-theme="dark"] footer a {
  color: var(--link-external-color, rgb(49, 116, 143));
  outline: rgb(49, 116, 143) none 0px;
  text-decoration-color: rgb(49, 116, 143);
}

html[saved-theme="dark"] body a.internal-link, html[saved-theme="dark"] .breadcrumb-container .breadcrumb-element > a {
  color: var(--link-color, rgb(49, 116, 143));
  outline: rgb(49, 116, 143) none 0px;
  text-decoration-color: rgb(49, 116, 143);
}

html[saved-theme="dark"] body a.internal-link.broken {
  color: var(--link-unresolved-color, rgb(224, 222, 244));
  outline: rgb(224, 222, 244) none 0px;
  text-decoration: underline rgba(49, 117, 144, 0.3);
  text-decoration-color: var(--link-unresolved-decoration-color, rgba(49, 117, 144, 0.3));
}`,
...
html[saved-theme="dark"] body ul.overflow {
  ...
  color: var(--text-faint, rgb(110, 106, 134));
}

html[saved-theme="dark"] body blockquote {
  color: var(--blockquote-color, rgb(224, 222, 244));
}`,
...
html[saved-theme="dark"] body th {
  ...
  background-color: var(--code-background, rgb(31, 29, 46));
  border-bottom-color: rgb(64, 61, 82);
  border-bottom-width: 0px;
  border-left-color: rgb(64, 61, 82);
  border-left-width: 0px;
...
html[saved-theme="dark"] body figure {
  --code-background: var(--ec-frm-edBg, #1f1d2e);
  border-bottom-color: rgb(224, 222, 244);
  border-bottom-width: 0px;
  border-left-color: rgb(224, 222, 244);
  border-left-width: 0px;
...
html[saved-theme="dark"] body .search > .search-container > .search-space {
  background-color: var(--prompt-background, rgb(25, 23, 36));
  border-bottom-color: rgb(64, 61, 82);
  border-bottom-width: 0px;
  border-left-color: rgb(64, 61, 82);
  border-left-width: 0px;
...
html[saved-theme="dark"] body .search > .search-container > .search-space > .search-layout > .results-container > .result-card:hover, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container > .result-card:focus, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container > .result-card.focus:not(:has(~ .result-card:hover, html[saved-theme="dark"] ~ .result-card:focus)) {
  background-color: var(--background-modifier-hover, rgb(38, 35, 58));
  color: rgb(224, 222, 244);
}
...
html[saved-theme="dark"] body a.internal-link.tag-link, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  --pill-background: var(--tag-background, #26233a);
  --pill-background-hover: var(--tag-background-hover, #6e6a86);
  --pill-border-color: var(--tag-border-color, hsla(197, 49%, 38%, 0.15));
  --pill-border-color-hover: var(--tag-border-color-hover, hsla(197, 49%, 38%, 0.15));
  --pill-color: var(--tag-color, #31748f);
  --pill-color-hover: var(--tag-color-hover, #31748f);
  --pill-color-remove: var(--tag-color, #31748f);
  --pill-color-remove-hover: var(--tag-color-hover, #31748f);
  background-color: var(--pill-background, rgb(38, 35, 58));
  ...
  border-top-width: 0px;
  color: var(--pill-color, rgb(49, 116, 143));
}
...
html[saved-theme="dark"] body h1 {
  ...
  border-top-color: rgb(196, 167, 231);
  border-top-width: 0px;
  color: var(--h1-color, rgb(196, 167, 231));
}
...
html[saved-theme="dark"] body h2 {
  ...
  border-top-width: 0px;
  color: var(--h2-color, rgb(49, 116, 143));
}
...
html[saved-theme="dark"] body h3 {
  ...
  border-top-width: 0px;
  color: var(--h3-color, rgb(156, 207, 216));
}
...
html[saved-theme="dark"] body h4 {
  ...
  border-top-width: 0px;
  color: var(--h4-color, rgb(246, 193, 119));
}
...
html[saved-theme="dark"] body h5 {
  ...
  border-top-width: 0px;
  color: var(--h5-color, rgb(235, 188, 186));
}
...
html[saved-theme="dark"] body h6 {
  ...
  border-top-width: 0px;
  color: var(--h6-color, rgb(235, 111, 146));
}
...
html[saved-theme="dark"] body .nav-files-container li:has(> .folder-outer.open) > .nav-folder-title {
  color: var(--nav-item-color, rgb(224, 222, 244));
}
...
html[saved-theme="dark"] body .explorer .nav-files-container .folder-outer > ul {
  ...
  background-color: var(--status-bar-background, rgb(31, 29, 46));
  border-bottom-color: rgb(64, 61, 82);
  border-bottom-width: 0px;
  border-left-color: rgb(64, 61, 82);
  border-left-width: 0px;
  ...
  border-top-color: rgb(64, 61, 82);
  border-top-width: 0px;
  color: var(--status-bar-text-color, rgb(224, 222, 244));
}
...
html[saved-theme="dark"] body .stacked-page-header {
  background-color: var(--tab-container-background, rgb(64, 61, 82));
}
...
html[saved-theme="dark"] body ul.tags > li {
  background-color: var(--tag-background, rgb(38, 35, 58));
  border-bottom-color: rgba(49, 117, 144, 0.15);
  border-bottom-width: 0px;
  border-left-color: rgba(49, 117, 144, 0.15);
  border-left-width: 0px;
  ...
  border-top-color: rgba(49, 117, 144, 0.15);
  border-top-width: 0px;
  color: var(--tag-color, rgb(49, 116, 143));
}`,
  },
  light: {
    base: `:root:root {
