...
export const theme: ThemeData = {
  ...
  --accent-color-dark: var(--pine, #3e8fb0);
  --accent-color-hover: var(--foam, #9ccfd8);
  --accent-color-light: var(--rose, #ea9a97);
  --accent-h: 197;
  --accent-l: 47%;
  --accent-s: 48%;
  --background-modifier-border: var(--border-color-primary, #44415a);
  --background-modifier-border-focus: var(--border-color-secondary, #56526e);
  --background-modifier-border-hover: var(--border-color-secondary, #56526e);
  --background-modifier-error: var(--color-red, #eb6f92);
  --background-modifier-error-hover: var(--color-red, #eb6f92);
  --background-modifier-form-field: var(--background-secondary, #2a273f);
  --background-modifier-form-field-hover: var(--background-modifier-form-field, #2a273f);
  --background-modifier-hover: var(--selection-background-color, #393552);
  --background-modifier-success: var(--color-green, #9ccfd8);
  --background-primary: var(--base, #232136);
  --background-secondary: var(--surface, #2a273f);
  --base: #232136;
  --bases-cards-background: var(--background-primary, #232136);
  --bases-embed-border-color: var(--background-modifier-border, #44415a);
  --bases-group-heading-property-color: var(--text-muted, #e0def4);
  --bases-table-border-color: var(--table-border-color, #44415a);
  --bases-table-cell-background-active: var(--background-primary, #232136);
  --bases-table-cell-background-selected: var(--table-selection, #393552);
  --bases-table-header-background: var(--background-primary, #232136);
  --bases-table-header-background-hover: var(--background-modifier-hover, #393552);
  --bases-table-header-color: var(--text-muted, #e0def4);
  --bases-table-summary-background: var(--background-primary, #232136);
  --bases-table-summary-background-hover: var(--background-modifier-hover, #393552);
  --blockquote-border-color: var(--accent-color-dark, #3e8fb0);
  --bold-color: var(--accent-color-light, #ea9a97);
  --border-color: var(--border-color-primary, #44415a);
  --border-color-primary: var(--highlight-med, #44415a);
  --border-color-secondary: var(--highlight-high, #56526e);
  ...
  --checkbox-color: var(--accent-color-dark, #3e8fb0);
  ...
  --code-background: var(--background-secondary, #2a273f);
  --code-boolean: var(--rose, #ea9a97);
  --code-border-color: var(--background-modifier-border, #44415a);
  --code-bracket-background: var(--background-modifier-hover, #393552);
  --code-builtin: var(--love, #eb6f92);
  --code-comment: var(--muted, #6e6a86);
  --code-definition: var(--rose, #ea9a97);
  --code-function: var(--color-yellow, #f6c177);
  --code-important: var(--color-yellow, #f6c177);
  --code-keyword: var(--pine, #3e8fb0);
  --code-normal: var(--text-normal, #e0def4);
  --code-operator: var(--pine, #3e8fb0);
  ...
  --code-value: var(--rose, #ea9a97);
  --code-variable: var(--text, #e0def4);
  --collapse-icon-color: var(--text-faint, #6e6a86);
  --collapse-icon-color-collapsed: var(--text-accent, hsl(197, 48%, 47%));
  --color-blue: #3e8fb0;
  --color-cyan: #9ccfd8;
  --color-green: #9ccfd8;
  --color-orange: #ea9a97;
  ...
  --divider-color: var(--background-modifier-border, #44415a);
  --divider-color-hover: var(--interactive-accent, hsl(197, 48%, 47%));
  --dropdown-background: var(--interactive-normal, #2a273f);
  --dropdown-background-hover: var(--interactive-hover, #44415a);
  --file-header-background: var(--background-primary, #232136);
  --file-header-background-focused: var(--background-primary, #232136);
  --flair-background: var(--interactive-normal, #2a273f);
  --flair-color: var(--text-normal, #e0def4);
  --foam: #9ccfd8;
  --footnote-divider-color: var(--metadata-divider-color, #44415a);
  --footnote-id-color: var(--text-muted, #e0def4);
  --footnote-id-color-no-occurrences: var(--text-faint, #6e6a86);
  --footnote-input-background-active: var(--metadata-input-background-active, #393552);
  --gold: #f6c177;
  --graph-line: var(--border-color-secondary, #56526e);
  --graph-node: var(--accent, hsl(197, 48%, 47%));
  --graph-node-attachment: var(--accent-color-dark, #3e8fb0);
  --graph-node-focused: var(--accent-color-hover, #9ccfd8);
  --graph-node-tag: var(--accent-color-light, #ea9a97);
  --graph-node-unresolved: var(--border-color-primary, #44415a);
  --graph-text: var(--text-color, #e0def4);
  --gray: var(--text-muted, var(--text-color, #e0def4));
  --h1-color: var(--color-purple, #c4a7e7);
  --h2-color: var(--color-blue, #3e8fb0);
  --h3-color: var(--color-green, #9ccfd8);
  --h4-color: var(--color-yellow, #f6c177);
  --h5-color: var(--color-orange, #ea9a97);
  --h6-color: var(--color-red, #eb6f92);
  --heading-formatting: var(--text-faint, #6e6a86);
  --highlight: var(--text-highlight-bg, var(--accent, hsl(197, 48%, 47%)));
  --highlight-high: #56526e;
  --highlight-low: #2a283e;
  --highlight-med: #44415a;
  --hr-color: var(--text-color-muted-dark, #393552);
  --icon-color: var(--text-muted, #e0def4);
  --icon-color-active: var(--text-accent, hsl(197, 48%, 47%));
  --icon-color-focused: var(--text-normal, #e0def4);
  --icon-color-hover: var(--text-muted, #e0def4);
  --indentation-guide-color: var(--text-color-muted-dark, #393552);
  ...
  --interactive-accent: var(--accent, hsl(197, 48%, 47%));
  --interactive-accent-hover: var(--color-accent-1, hsl(194, 48.96%, 54.05%));
  --interactive-accent-hsl: var(--color-accent-hsl, 197, 48%, 47%);
  --interactive-hover: var(--border-color-primary, #44415a);
  --interactive-normal: var(--background-secondary, #2a273f);
  --iris: #c4a7e7;
  --italic-color: var(--accent-color-light, #ea9a97);
  --light: var(--background-primary, var(--base, #232136));
  --lightgray: var(--background-secondary, var(--surface, #2a273f));
  --link-color: var(--accent-color-dark, #3e8fb0);
  --link-color-hover: var(--accent-color-hover, #9ccfd8);
  --link-external-color: var(--accent-color-dark, #3e8fb0);
  --link-external-color-hover: var(--accent-color-hover, #9ccfd8);
  --list-marker-color: var(--accent-color-dark, #3e8fb0);
  --list-marker-color-collapsed: var(--text-accent, hsl(197, 48%, 47%));
  --list-marker-color-hover: var(--text-muted, #e0def4);
  --love: #eb6f92;
  --menu-background: var(--background-secondary, #2a273f);
  --menu-border-color: var(--background-modifier-border-hover, #56526e);
  --metadata-border-color: var(--background-modifier-border, #44415a);
  --metadata-divider-color: var(--background-modifier-border, #44415a);
  --metadata-input-background-active: var(--background-modifier-hover, #393552);
  --metadata-input-text-color: var(--text-color, #e0def4);
  --metadata-label-background-active: var(--background-modifier-hover, #393552);
  --metadata-label-text-color: var(--text-color, #e0def4);
  --metadata-label-text-color-hover: var(--text-muted, #e0def4);
  --metadata-property-background-active: var(--background-modifier-hover, #393552);
  --modal-background: var(--background-secondary, #2a273f);
  --modal-border-color: var(--border-color-primary, #44415a);
  --muted: #6e6a86;
  --nav-collapse-icon-color: var(--border-color-secondary, #56526e);
  --nav-collapse-icon-color-collapsed: var(--border-color-secondary, #56526e);
  ...
  --nav-indentation-guide-color: var(--border-color-secondary, #56526e);
  --nav-item-background-active: var(--accent-color-dark, #3e8fb0);
  --nav-item-background-hover: var(--selection-background-color, #393552);
  --nav-item-color: var(--text-color, #e0def4);
  --nav-item-color-active: var(--text-color-accent, white);
  --nav-item-color-highlighted: var(--accent-color-light, #ea9a97);
  ...
  --pill-border-color: var(--background-modifier-border, #44415a);
  --pill-border-color-hover: var(--background-modifier-border-hover, #56526e);
  --pill-color: var(--text-muted, #e0def4);
  --pill-color-hover: var(--text-normal, #e0def4);
  --pill-color-remove: var(--text-faint, #6e6a86);
  --pill-color-remove-hover: var(--text-accent, hsl(197, 48%, 47%));
  --pine: #3e8fb0;
  --prompt-background: var(--background-primary, #232136);
  --prompt-border-color: var(--border-color-primary, #44415a);
  --raised-background: var(--blur-background, color-mix(in srgb, #2a273f 65%, transparent) linear-gradient(#2a273f, color-mix(in srgb, #2a273f 65%, transparent)));
  --ribbon-background: var(--background-secondary, #2a273f);
  ...
  --secondary: var(--text-accent, var(--accent, hsl(197, 48%, 47%)));
  --selection-background-color: var(--overlay, #393552);
  --selection-border-color: var(--accent-color-hover, #9ccfd8);
  --setting-group-heading-color: var(--text-normal, #e0def4);
  --setting-items-border-color: var(--background-modifier-border, #44415a);
  ...
  --shiki-code-important: var(--color-orange, #ea9a97);
  ...
  --shiki-gutter-border-color: var(--background-modifier-border, #44415a);
  ...
  --slider-track-background: var(--background-secondary, #2a273f);
  --status-bar-background: var(--background-secondary, #2a273f);
  --status-bar-border-color: var(--divider-color, #44415a);
  ...
  --sync-avatar-color-2: var(--color-orange, #ea9a97);
  ...
  --sync-avatar-color-6: var(--color-blue, #3e8fb0);
  ...
  --tab-container-background: var(--background-secondary, #2a273f);
  --tab-divider-color: var(--selection-background-color, #393552);
  --tab-outline-color: var(--border-color-primary, #44415a);
  --tab-switcher-background: var(--background-secondary, #2a273f);
  --tab-text-color: var(--border-color-primary, #44415a);
  ...
  --table-add-button-border-color: var(--background-modifier-border, #44415a);
  --table-border-color: var(--border-color-primary, #44415a);
  --table-drag-handle-background-active: var(--table-selection-border-color, #9ccfd8);
  --table-drag-handle-color: var(--selection-background-color, #393552);
  --table-drag-handle-color-active: var(--selection-background-color, #393552);
  --table-header-border-color: var(--table-border-color, #44415a);
  --table-header-color: var(--text-color, #e0def4);
  --table-selection: var(--selection-background-color, #393552);
  --table-selection-border-color: var(--selection-border-color, #9ccfd8);
  --tag-background: var(--text-color-muted-dark, #393552);
  --tag-background-hover: var(--text-color-muted-light, #6e6a86);
  --tag-color: var(--accent-color-dark, #3e8fb0);
  --tag-color-hover: var(--accent-color-dark, #3e8fb0);
  --tertiary: var(--text-accent-hover, var(--color-accent-2, red));
  --text: #e0def4;
  --text-accent: var(--accent, hsl(197, 48%, 47%));
  --text-accent-hover: var(--color-accent-2, red);
  --text-color: var(--text, #e0def4);
  --text-color-accent: white;
  --text-color-muted-dark: var(--overlay, #393552);
  --text-color-muted-light: var(--muted, #6e6a86);
  --text-error: var(--color-red, #eb6f92);
  --text-faint: var(--text-color-muted-light, #6e6a86);
  --text-highlight-bg: var(--accent, hsl(197, 48%, 47%));
  --text-muted: var(--text-color, #e0def4);
  --text-normal: var(--text-color, #e0def4);
  --text-on-accent: var(--text-color-accent, white);
  --text-on-accent-inverted: var(--background-primary, #232136);
  --text-selection: var(--selection-background-color, #393552);
  --text-success: var(--color-green, #9ccfd8);
  --text-warning: var(--color-yellow, #f6c177);
  --textHighlight: var(--text-highlight-bg, var(--accent, hsl(197, 48%, 47%)));
  --titlebar-background: var(--background-secondary, #2a273f);
  --titlebar-background-focused: var(--border-color-primary, #44415a);
  --titlebar-border-color: var(--background-modifier-border, #44415a);
...
html[saved-theme="dark"] body[data-slug] div#quartz-root.page, html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left, html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left:has(.explorer), html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left .explorer .explorer-content {
  --bases-table-header-background: var(--background-secondary, #2a273f);
  background-color: var(--tab-container-background, rgb(42, 39, 63));
...
html[saved-theme="dark"] body .page > div#quartz-body div.sidebar {
  background-color: var(--background-secondary, rgb(42, 39, 63));
  color: rgb(224, 222, 244);
}
...
html[saved-theme="dark"] body .text-highlight {
  background-color: var(--text-highlight-bg, rgb(62, 145, 177));
...
html[saved-theme="dark"] body li.task-list-item input[type="checkbox"]:checked {
  background-color: var(--checkbox-color, rgb(62, 143, 176));
...
html[saved-theme="dark"] body a.internal-link.broken {
  ...
  text-decoration-color: var(--link-unresolved-decoration-color, rgba(62, 145, 177, 0.3));
}`,
...
html[saved-theme="dark"] body .search > .search-container > .search-space > .search-layout > .results-container > .result-card:hover, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container > .result-card:focus, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container > .result-card.focus:not(:has(~ .result-card:hover, html[saved-theme="dark"] ~ .result-card:focus)) {
  background-color: var(--background-modifier-hover, rgb(57, 53, 82));
  color: rgb(224, 222, 244);
}
...
html[saved-theme="dark"] body a.internal-link.tag-link, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  --pill-background: var(--tag-background, #393552);
  --pill-background-hover: var(--tag-background-hover, #6e6a86);
  --pill-border-color: var(--tag-border-color, hsla(197, 48%, 47%, 0.15));
  --pill-border-color-hover: var(--tag-border-color-hover, hsla(197, 48%, 47%, 0.15));
  --pill-color: var(--tag-color, #3e8fb0);
  --pill-color-hover: var(--tag-color-hover, #3e8fb0);
  --pill-color-remove: var(--tag-color, #3e8fb0);
  --pill-color-remove-hover: var(--tag-color-hover, #3e8fb0);
  background-color: var(--pill-background, rgb(57, 53, 82));
...
html[saved-theme="dark"] body h2 {
  color: var(--h2-color, rgb(62, 143, 176));
}
...
html[saved-theme="dark"] body h5 {
  color: var(--h5-color, rgb(234, 154, 151));
}
...
html[saved-theme="dark"] body .nav-files-container li:has(> .folder-outer:not(.open)) > .nav-folder-title {
  ...
  background-color: var(--status-bar-background, rgb(42, 39, 63));
  border-bottom-color: rgb(68, 65, 90);
  border-left-color: rgb(68, 65, 90);
  border-right-color: rgb(68, 65, 90);
  border-top-color: rgb(68, 65, 90);
...
html[saved-theme="dark"] body .note-properties-tags {
  ...
  --pill-color-remove-hover: var(--tag-color-hover, #3e8fb0);
  background-color: var(--pill-background, rgb(57, 53, 82));
  color: var(--pill-color, rgb(62, 143, 176));
}
...
html[saved-theme="dark"] body .stacked-page-header {
  background-color: var(--tab-container-background, rgb(68, 65, 90));
}
...
html[saved-theme="dark"] body ul.tags > li {
  background-color: var(--tag-background, rgb(57, 53, 82));
  border-bottom-color: rgba(62, 145, 177, 0.15);
  border-left-color: rgba(62, 145, 177, 0.15);
  border-right-color: rgba(62, 145, 177, 0.15);
  border-top-color: rgba(62, 145, 177, 0.15);
  color: var(--tag-color, rgb(62, 143, 176));
}`,
  },
  light: {
    base: `:root:root {
