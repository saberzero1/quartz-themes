...
export const theme: ThemeData = {
  ...
  --background-modifier-error: hsl(from hsl(30, 80%, 50%) 356 s l) !important;
  --background-modifier-error-hover: hsl(from hsl(30, 80%, 50%) 356 s l) !important;
  --background-modifier-hover: hsl(30, 80%, 50%) !important;
  --background-modifier-message: color-mix(
    in srgb,
    hsl(30, 80%, 50%),
    white 95%
  ) !important;
  --background-modifier-success: hsl(from hsl(30, 80%, 50%) 124 s l) !important;
  ...
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(30, 80%, 50%) !important;
  ...
  --bases-table-header-background-hover: hsl(30, 80%, 50%) !important;
  ...
  --bases-table-summary-background-hover: hsl(30, 80%, 50%) !important;
  ...
  --checkbox-border-color: hsl(30, 80%, 50%) !important;
  --checkbox-border-color-hover: hsl(255, 89.76%, 75.9%) !important;
  --checkbox-color: hsl(30, 80%, 50%) !important;
  ...
  --code-bracket-background: hsl(30, 80%, 50%) !important;
  --code-comment: light-dark(
    hsl(from black h s l / 0.5),
    hsl(from white h s l / 0.5)
  ) !important;
  --code-function: hsl(from hsl(30, 80%, 50%) 57 s l) !important;
  --code-important: hsl(from hsl(30, 80%, 50%) 27 s l) !important;
  --code-keyword: hsl(from hsl(30, 80%, 50%) 331 s l) !important;
  --code-normal: color-mix(
    in srgb,
    hsl(30, 80%, 50%),
    white 60%
  ) !important;
  --code-operator: hsl(from hsl(30, 80%, 50%) 356 s l) !important;
  --code-property: hsl(from hsl(30, 80%, 50%) 179 s l) !important;
  ...
  --code-string: hsl(from hsl(30, 80%, 50%) 124 s l) !important;
  --code-tag: hsl(from hsl(30, 80%, 50%) 356 s l) !important;
  --code-value: hsl(from hsl(30, 80%, 50%) 253 s l) !important;
  ...
  --collapse-icon-color: hsl(30, 80%, 50%) !important;
  --collapse-icon-color-collapsed: hsl(30, 80%, 50%) !important;
  --color-blue: hsl(from hsl(30, 80%, 50%) 219 s l) !important;
  --color-cyan: hsl(from hsl(30, 80%, 50%) 179 s l) !important;
  --color-green: hsl(from hsl(30, 80%, 50%) 124 s l) !important;
  --color-orange: hsl(from hsl(30, 80%, 50%) 27 s l) !important;
  --color-pink: hsl(from hsl(30, 80%, 50%) 331 s l) !important;
  --color-purple: hsl(from hsl(30, 80%, 50%) 253 s l) !important;
  --color-red: hsl(from hsl(30, 80%, 50%) 356 s l) !important;
  --color-yellow: hsl(from hsl(30, 80%, 50%) 57 s l) !important;
  --dark: color-mix(
    in srgb,
    hsl(30, 80%, 50%),
    white 60%
  ...
  --divider-color-hover: hsl(30, 80%, 50%) !important;
  ...
  --flair-background: hsl(30, 80%, 50%) !important;
  ...
  --graph-node-attachment: hsl(from hsl(30, 80%, 50%) 57 s l) !important;
  --graph-node-tag: hsl(from hsl(30, 80%, 50%) 124 s l) !important;
  ...
  --highlight: hsl(30, 80%, 50%) !important;
  --hr-color: color-mix(
    in srgb,
    hsl(30, 80%, 50%),
    black 25%
  ) !important;
  --icon-color: hsl(30, 80%, 50%) !important;
  ...
  --interactive-accent: hsl(30, 80%, 50%) !important;
  --light: color-mix(
    in srgb,
    hsl(30, 80%, 50%),
    black 95%
  ...
  --metadata-property-background-active: hsl(30, 80%, 50%) !important;
  ...
  --nav-item-background-active: hsl(30, 80%, 50%) !important;
  ...
  --pill-background-hover: hsl(30, 80%, 50%) !important;
  ...
  --search-clear-button-color: hsl(30, 80%, 50%) !important;
  --search-icon-color: hsl(30, 80%, 50%) !important;
  --search-result-background: color-mix(
    in srgb,
    hsl(30, 80%, 50%),
    black 95%
  ) !important;
  --secondary: hsl(30, 80%, 50%) !important;
  ...
  --shiki-code-function: hsl(from hsl(30, 80%, 50%) 124 s l) !important;
  --shiki-code-important: hsl(from hsl(30, 80%, 50%) 27 s l) !important;
  --shiki-code-keyword: hsl(from hsl(30, 80%, 50%) 331 s l) !important;
  --shiki-code-normal: color-mix(in srgb, color-mix(
    in srgb,
    hsl(30, 80%, 50%),
    white 60%
  ), transparent 30%) !important;
  --shiki-code-property: hsl(from hsl(30, 80%, 50%) 179 s l) !important;
  --shiki-code-punctuation: color-mix(in srgb, color-mix(
    in srgb,
    hsl(30, 80%, 50%),
    white 60%
  ), transparent 30%) !important;
  --shiki-code-string: hsl(from hsl(30, 80%, 50%) 57 s l) !important;
  --shiki-code-value: hsl(from hsl(30, 80%, 50%) 253 s l) !important;
  ...
  --sync-avatar-color-1: hsl(from hsl(30, 80%, 50%) 356 s l) !important;
  --sync-avatar-color-2: hsl(from hsl(30, 80%, 50%) 27 s l) !important;
  --sync-avatar-color-3: hsl(from hsl(30, 80%, 50%) 57 s l) !important;
  --sync-avatar-color-4: hsl(from hsl(30, 80%, 50%) 124 s l) !important;
  --sync-avatar-color-5: hsl(from hsl(30, 80%, 50%) 179 s l) !important;
  --sync-avatar-color-6: hsl(from hsl(30, 80%, 50%) 219 s l) !important;
  --sync-avatar-color-7: hsl(from hsl(30, 80%, 50%) 253 s l) !important;
  --sync-avatar-color-8: hsl(from hsl(30, 80%, 50%) 331 s l) !important;
  ...
  --tab-text-color-focused-highlighted: hsl(30, 80%, 50%) !important;
  ...
  --table-drag-handle-background-active: hsl(30, 80%, 50%) !important;
  ...
  --table-selection-border-color: hsl(30, 80%, 50%) !important;
  ...
  --text-error: hsl(from hsl(30, 80%, 50%) 356 s l) !important;
  ...
  --text-success: hsl(from hsl(30, 80%, 50%) 124 s l) !important;
  --text-warning: hsl(from hsl(30, 80%, 50%) 27 s l) !important;
  --textHighlight: hsl(30, 80%, 50%) !important;
  ...
  --theme-color-base: hsl(30, 80%, 50%) !important;
  ...
  --theme-color-cardBgHover: hsl(30, 80%, 50%) !important;
  ...
  --theme-color-communityItemBgActive: hsl(30, 80%, 50%) !important;
  ...
  --theme-color-contentItemBgActive: hsl(30, 80%, 50%) !important;
  ...
  --theme-color-controlBgActive: hsl(30, 80%, 50%) !important;
  ...
  --theme-color-greenTransparent25: hsl(from hsl(from hsl(30, 80%, 50%) 124 s l) h s l / 0.25) !important;
  --theme-color-greenTransparent75: hsl(from hsl(from hsl(30, 80%, 50%) 124 s l) h s l / 0.75) !important;
  --theme-color-hotkey: hsl(30, 80%, 50%) !important;
  --theme-color-inputBorder: color-mix(
    in srgb,
    hsl(30, 80%, 50%),
    white 25%
  ) !important;
  --theme-color-inputPlaceholder: hsl(30, 80%, 50%) !important;
  ...
  --theme-color-jiraIssueDangerBg: hsl(from hsl(from hsl(30, 80%, 50%) 356 s l) h s l / 0.25) !important;
  --theme-color-jiraIssueDeleteBg: hsl(from hsl(30, 80%, 50%) 356 s l) !important;
  ...
  --theme-color-navigationButtonBgHover: hsl(30, 80%, 50%) !important;
  ...
  --theme-color-orangeTransparent25: hsl(from hsl(from hsl(30, 80%, 50%) 27 s l) h s l / 0.25) !important;
  --theme-color-orangeTransparent75: hsl(from hsl(from hsl(30, 80%, 50%) 27 s l) h s l / 0.75) !important;
  ...
  --theme-color-redTransparent25: hsl(from hsl(from hsl(30, 80%, 50%) 356 s l) h s l / 0.25) !important;
  --theme-color-redTransparent75: hsl(from hsl(from hsl(30, 80%, 50%) 356 s l) h s l / 0.75) !important;
  ...
  --theme-color-switcherBgActive: hsl(30, 80%, 50%) !important;
  ...
  --theme-color-textMeta: hsl(30, 80%, 50%) !important;
  ...
  --theme-color-yellowTransparent25: hsl(from hsl(from hsl(30, 80%, 50%) 57 s l) h s l / 0.25) !important;
  --theme-color-yellowTransparent75: hsl(from hsl(from hsl(30, 80%, 50%) 57 s l) h s l / 0.75) !important;
...
html[saved-theme="dark"] body ul.overflow {
  ...
  color: color(srgb 0.925 0.625 0.325);
}
...
html[saved-theme="dark"] body .search > .search-container > .search-space {
  background-color: color(srgb 0.18 0.1 0.02);
  ...
  border-top-width: 0px;
  box-shadow: color(srgb 0.09 0.05 0.01 / 0.02) 0px 0px 3.2px 0px, color(srgb 0.09 0.05 0.01 / 0.04) 0px 3.2px 6.4px 0px, color(srgb 0.09 0.05 0.01 / 0.06) 0px 6.4px 19.2px 0px, color(srgb 0.09 0.05 0.01 / 0.08) 0px 19.2px 32px 0px, color(srgb 0.09 0.05 0.01 / 0.1) 0px 32px 64px 0px;
}
...
html[saved-theme="dark"] body li.depth-0 {
  ...
  background-color: color(srgb 0.36 0.2 0.04);
  border-bottom-color: color(srgb 0.96 0.8 0.64);
  border-left-color: color(srgb 0.96 0.8 0.64);
  border-left-width: 0px;
  border-right-color: color(srgb 0.96 0.8 0.64);
...
html[saved-theme="dark"] body .canvas-sidebar {
  background-color: color(srgb 0.27 0.15 0.03);
  border-color: color(srgb 0.96 0.8 0.64);
  box-shadow: rgba(18, 13, 8, 0.5) 0px 1px 2px 0px, rgba(23, 13, 3, 0.25) 0px 3.4px 6.7px 0px, rgba(20, 13, 5, 0.15) 0px 15px 30px 0px;
}`,
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --background-modifier-border-focus: hsl(30, 80%, 50%) !important;
  --background-modifier-error: hsl(from hsl(30, 80%, 50%) 356 s l) !important;
  --background-modifier-error-hover: hsl(from hsl(30, 80%, 50%) 356 s l) !important;
  --background-modifier-hover: hsl(30, 80%, 50%) !important;
  --background-modifier-message: color-mix(
  ...
  --bases-table-cell-shadow-active: 0 0 0 2px hsl(30, 80%, 50%) !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(30, 80%, 50%) !important;
  --bases-table-container-border-radius: 0.25rem !important;
  ...
  --checkbox-border-color: hsl(30, 80%, 50%) !important;
  --checkbox-border-color-hover: hsl(30, 80%, 50%) !important;
  --checkbox-color: hsl(30, 80%, 50%) !important;
  --checkbox-color-hover: hsl(30, 80%, 50%) !important;
  ...
  --interactive-accent: hsl(30, 80%, 50%) !important;
  --interactive-accent-hover: hsl(30, 80%, 50%) !important;
  ...
  --metadata-property-box-shadow-focus: 0 0 0 2px hsl(30, 80%, 50%) !important;
  --metadata-property-box-shadow-hover: none !important;
  --metadata-sidebar-input-font-size: 0.8rem !important;
  --metadata-sidebar-label-font-size: 0.8rem !important;
  --modal-background: color-mix(
  ...
  --tag-weight: 400 !important;
  --tertiary: hsl(30, 80%, 50%) !important;
  --text-error: hsl(from hsl(30, 80%, 50%) 356 s l) !important;
  --text-faint: color-mix(
    in srgb,
    hsl(30, 80%, 50%),
  ...
  --theme-color-controlContentArea: hsl(30, 80%, 50%) !important;
  --theme-color-controlContentAreaHover: color-mix(
    in srgb,
    hsl(30, 80%, 50%),
    white 80%
  ...
  --theme-color-navFileTag: hsl(30, 80%, 50%) !important;
  --theme-color-navFileTagActive: color-mix(
    in srgb,
    hsl(30, 80%, 50%),
    white 80%
  ...
  --theme-color-navFileTagBorder: hsl(30, 80%, 50%) !important;
  --theme-color-navigationButtonBgHover: hsl(30, 80%, 50%) !important;
  --theme-color-notice: color-mix(
    in srgb,
    hsl(30, 80%, 50%),
...
html[saved-theme="light"] body .search > .search-container > .search-space {
  background-color: color(srgb 0.995 0.975 0.955);
  border-bottom-color: rgba(0, 0, 0, 0);
  border-bottom-width: 0px;
  border-left-color: rgba(0, 0, 0, 0);
  border-left-width: 0px;
  ...
  border-top-color: rgba(0, 0, 0, 0);
  border-top-width: 0px;
  box-shadow: color(srgb 0.675 0.375 0.075 / 0.02) 0px 0px 3.2px 0px, color(srgb 0.675 0.375 0.075 / 0.04) 0px 3.2px 6.4px 0px, color(srgb 0.675 0.375 0.075 / 0.06) 0px 6.4px 19.2px 0px, color(srgb 0.675 0.375 0.075 / 0.08) 0px 19.2px 32px 0px, color(srgb 0.675 0.375 0.075 / 0.1) 0px 32px 64px 0px;
}
...
html[saved-theme="light"] body .search > .search-container > .search-space > .search-layout > .results-container {
  color: color(srgb 0.995 0.975 0.955);
}
...
html[saved-theme="light"] body .canvas-sidebar {
  background-color: color(srgb 0.98 0.9 0.82);
  border-color: color(srgb 0.09 0.05 0.01);
  box-shadow: rgba(64, 32, 0, 0.2) 0px 1px 2px 0px, rgba(57, 32, 6, 0.15) 0px 3.4px 6.7px 0px, rgba(51, 32, 13, 0.05) 0px 15px 30px 0px;
}`,
...
html[saved-theme="light"] body kbd {
  ...
  border-top-style: solid;
  border-top-width: 1px;
  color: color(srgb 0.98 0.9 0.82);
  font-family: "??", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "??", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol";
  font-size: 11.2px;
  padding-bottom: 2px;
  padding-left: 6px;
