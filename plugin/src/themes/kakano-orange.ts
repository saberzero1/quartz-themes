...
html[saved-theme="dark"] body pre > code > [data-line] {
  border-left-color: color(srgb 0.9 0.86 0.1);
}
...
html[saved-theme="dark"] body pre > code [data-highlighted-chars] {
  border-bottom-color: color(srgb 0.9 0.86 0.1);
  border-left-color: color(srgb 0.9 0.86 0.1);
  border-right-color: color(srgb 0.9 0.86 0.1);
  border-top-color: color(srgb 0.9 0.86 0.1);
}
