...
export const theme: ThemeData = {
  ...
  --ancestor-editor-color: var(
        --text-normal
    , #c6bbb1);
  --background-modifier-border: var(--color-base-30, #4c4843);
  ...
  --background-primary: var(--color-base-00, #33302e);
  --background-secondary: var(--color-base-20, #393633);
  --background-secondary-alt: var(--color-base-30, #4c4843);
  --bases-cards-background: var(--background-primary, #33302e);
  --bases-embed-border-color: var(--background-modifier-border, #4c4843);
  --bases-group-heading-property-color: var(--text-muted, #7f7871);
  --bases-table-border-color: var(--table-border-color, #4c4843);
  --bases-table-cell-background-active: var(--background-primary, #33302e);
  --bases-table-cell-background-selected: var(--table-selection, hsla(177, 60%, 23%, 0.1));
  --bases-table-header-background: var(--background-primary, #33302e);
  --bases-table-header-background-hover: var(--background-modifier-hover, rgba(#fbdfc7, 0.067));
  --bases-table-header-color: var(--text-muted, #7f7871);
  --bases-table-summary-background: var(--background-primary, #33302e);
  --bases-table-summary-background-hover: var(--background-modifier-hover, rgba(#fbdfc7, 0.067));
  ...
  --canvas-background: var(--background-primary, #33302e);
  --canvas-card-label-color: var(--text-faint, #9f968d);
  --canvas-color: var(--background-modifier-border, #4c4843);
  ...
  --canvas-dot-pattern: var(--color-base-30, #4c4843);
  --caret-color: var(--text-normal, #c6bbb1);
  --checkbox-border-color: var(--text-faint, #9f968d);
  --checkbox-border-color-hover: var(--text-muted, #7f7871);
  --checkbox-color: var(--interactive-accent, hsl(177, 60%, 23%));
  --checkbox-color-hover: var(--interactive-accent-hover, #ef796a);
  --checkbox-marker-color: var(--background-primary, #33302e);
  --checklist-done-color: var(--text-muted, #7f7871);
  --code-border-color: var(--background-modifier-border, #4c4843);
  --code-bracket-background: var(--background-modifier-hover, rgba(#fbdfc7, 0.067));
  --code-comment: var(--text-faint, #9f968d);
  --code-function: var(--color-yellow, #e4bc7f);
  --code-important: var(--color-orange, #f1bb8a);
  --code-keyword: var(--color-pink, #ef796a);
  --code-normal: var(--text-normal, #c6bbb1);
  --code-operator: var(--color-red, #9a453c);
  --code-property: var(--color-cyan, #9bc7bd);
  --code-punctuation: var(--text-muted, #7f7871);
  --code-string: var(--color-green, #8ba481);
  --code-tag: var(--color-red, #9a453c);
  --code-value: var(--color-purple, #a69ab5);
  --collapse-icon-color: var(--text-faint, #9f968d);
  ...
  --color-base-00: var(--proxy-00, #33302e);
  --color-base-10: var(--proxy-10, #242424);
  --color-base-100: #ece8e5;
  --color-base-20: var(--proxy-20, #393633);
  ...
  --dark: var(--text-normal, var(--color-base-70, #c6bbb1));
  --darkgray: var(--text-normal, var(--color-base-70, #c6bbb1));
  --divider-color: var(--background-modifier-border, #4c4843);
  --divider-color-hover: var(--interactive-accent, hsl(177, 60%, 23%));
  --dropdown-background: var(--interactive-normal, #393633);
  --dropdown-background-hover: var(--interactive-hover, #635e58);
  --file-header-background: var(--background-primary, #33302e);
  --file-header-background-focused: var(--background-primary, #33302e);
  ...
  --flair-background: var(--interactive-normal, #393633);
  --flair-color: var(--text-normal, #c6bbb1);
  ...
  --footnote-divider-color: var(--metadata-divider-color, #4c4843);
  --footnote-id-color: var(--text-muted, #7f7871);
  --footnote-id-color-no-occurrences: var(--text-faint, #9f968d);
  --footnote-input-background-active: var(--metadata-input-background-active, rgba(#fbdfc7, 0.067));
  ...
  --graph-node: var(--text-muted, #7f7871);
  ...
  --graph-node-unresolved: var(--text-faint, #9f968d);
  --graph-text: var(--text-normal, #c6bbb1);
  --gray: var(--text-muted, var(--color-base-50, #7f7871));
  ...
  --heading-formatting: var(--text-faint, #9f968d);
  --hr-color: var(--background-modifier-border, #4c4843);
  --icon-color: var(--text-muted, #7f7871);
  --icon-color-active: var(--color-accent, hsl(177, 60%, 23%));
  --icon-color-focused: var(--text-normal, #c6bbb1);
  --icon-color-hover: var(--text-muted, #7f7871);
  --inline-title-color: var(--color-base-100, #ece8e5);
  ...
  --input-date-separator: var(--text-faint, #9f968d);
  --input-placeholder-color: var(--text-faint, #9f968d);
  ...
  --interactive-hover: var(--color-base-35, #635e58);
  --interactive-normal: var(--color-base-20, #393633);
  --lbs: 0px 20px 30px rgba(0, 0, 5, 0.15);
  --light: var(--background-primary, var(--color-base-00, #33302e));
  --lightgray: var(--background-secondary, var(--color-base-20, #393633));
  --line-height-normal: 1.65;
  --link-color: var(--text-muted, #7f7871);
  --link-color-hover: var(--text-normal, #c6bbb1);
  ...
  --link-unresolved-color: var(--text-muted, #7f7871);
  --list-marker-color: var(--text-faint, #9f968d);
  --list-marker-color-collapsed: var(--color-accent, hsl(177, 60%, 23%));
  --list-marker-color-hover: var(--text-muted, #7f7871);
  --menu-background: var(--background-secondary, #393633);
  --menu-border-color: var(--background-modifier-border-hover, #635e58);
  --menu-shadow: var(--shadow-s, 0px 1px 4px rgba(0, 0, 0, 0.16));
  --metadata-border-color: var(--background-modifier-border, #4c4843);
  --metadata-divider-color: var(--background-modifier-border, #4c4843);
  --metadata-input-background-active: var(--background-modifier-hover, rgba(#fbdfc7, 0.067));
  ...
  --metadata-input-text-color: var(--text-normal, #c6bbb1);
  --metadata-label-background-active: var(--background-modifier-hover, rgba(#fbdfc7, 0.067));
  ...
  --metadata-label-text-color: var(--text-muted, #7f7871);
  --metadata-label-text-color-hover: var(--text-muted, #7f7871);
  --metadata-property-background-active: var(--background-modifier-hover, rgba(#fbdfc7, 0.067));
  --modal-background: var(--background-primary, #33302e);
  --mono-rgb-0: #696969;
  --mono-rgb-100: #fbdfc7;
  --nav-collapse-icon-color: var(--collapse-icon-color, #9f968d);
  --nav-collapse-icon-color-collapsed: var(--text-faint, #9f968d);
  --nav-heading-color: var(--text-normal, #c6bbb1);
  --nav-heading-color-collapsed: var(--text-faint, #9f968d);
  --nav-heading-color-collapsed-hover: var(--text-muted, #7f7871);
  --nav-heading-color-hover: var(--text-normal, #c6bbb1);
  --nav-indentation-guide-color: var(--indentation-guide-color, rgba(#fbdfc7, 0.12));
  --nav-item-background-active: var(--background-modifier-hover, rgba(#fbdfc7, 0.067));
  --nav-item-background-hover: var(--background-modifier-hover, rgba(#fbdfc7, 0.067));
  --nav-item-color: var(--text-muted, #7f7871);
  --nav-item-color-active: var(--text-normal, #c6bbb1);
  --nav-item-color-highlighted: var(--color-accent-hover, hsl(
        258 calc(88% + 180) 66%
    ));
  --nav-item-color-hover: var(--text-normal, #c6bbb1);
  --nav-item-color-selected: var(--text-normal, #c6bbb1);
  --nav-tag-color: var(--text-faint, #9f968d);
  --nav-tag-color-active: var(--text-muted, #7f7871);
  --nav-tag-color-hover: var(--text-muted, #7f7871);
  --pdf-background: var(--background-primary, #33302e);
  --pdf-page-background: var(--background-primary, #33302e);
  --pdf-sidebar-background: var(--background-primary, #33302e);
  --pill-border-color: var(--background-modifier-border, #4c4843);
  --pill-border-color-hover: var(--background-modifier-border-hover, #635e58);
  --pill-color: var(--text-muted, #7f7871);
  --pill-color-hover: var(--text-normal, #c6bbb1);
  --pill-color-remove: var(--text-faint, #9f968d);
  --pill-color-remove-hover: var(--text-accent, hsl(177, 60%, 23%));
  --prompt-background: var(--background-primary, #33302e);
  --proxy-00: #33302e;
  --proxy-10: #242424;
  --proxy-20: #393633;
  --radius-xl: 24px;
  --raised-background: var(--blur-background, color-mix(in srgb, #393633 65%, transparent) linear-gradient(#393633, color-mix(in srgb, #393633 65%, transparent)));
  --ribbon-background: var(--background-secondary, #393633);
  --ribbon-background-collapsed: var(--background-primary, #33302e);
  ...
  --search-clear-button-color: var(--text-muted, #7f7871);
  --search-icon-color: var(--text-muted, #7f7871);
  --search-result-background: var(--background-primary, #33302e);
  --secondary: var(--text-accent, var(--color-accent, hsl(177, 60%, 23%)));
  --setting-group-heading-color: var(--text-normal, #c6bbb1);
  --setting-items-border-color: var(--background-modifier-border, #4c4843);
  --shadow-l: 0px 8px 24px rgba(0, 0, 0, 0.2);
  --shadow-lm-only: none;
  --shadow-s: 0px 1px 4px rgba(0, 0, 0, 0.16);
  --shiki-active-tab-border-color: var(--shiki-highlight-neutral, #7f7871);
  --shiki-code-comment: var(--text-faint, #9f968d);
  ...
  --shiki-code-normal: var(--text-muted, #7f7871);
  --shiki-code-property: var(--color-cyan, #9bc7bd);
  --shiki-code-punctuation: var(--text-muted, #7f7871);
  --shiki-code-string: var(--color-yellow, #e4bc7f);
  --shiki-code-value: var(--color-purple, #a69ab5);
  --shiki-gutter-border-color: var(--background-modifier-border, #4c4843);
  --shiki-gutter-text-color: var(--text-faint, #9f968d);
  --shiki-gutter-text-color-highlight: var(--shiki-code-normal, #7f7871);
  --shiki-highlight-neutral: var(--shiki-code-normal, #7f7871);
  --shiki-terminal-dots-color: var(--text-faint, #9f968d);
  --slider-thumb-border-color: var(--background-modifier-border-hover, #635e58);
  --slider-track-background: var(--background-modifier-border, #4c4843);
  --status-bar-background: var(--background-secondary, #393633);
  --status-bar-border-color: var(--divider-color, #4c4843);
  --status-bar-text-color: var(--text-muted, #7f7871);
  --suggestion-background: var(--background-primary, #33302e);
  ...
  --tab-background-active: var(--background-primary, #33302e);
  --tab-container-background: var(--background-secondary, #393633);
  --tab-divider-color: var(--background-modifier-border-hover, #635e58);
  --tab-outline-color: var(--divider-color, #4c4843);
  --tab-switcher-background: var(--background-secondary, #393633);
  --tab-switcher-preview-radius: var(--radius-xl, 24px);
  --tab-text-color: var(--text-faint, #9f968d);
  --tab-text-color-active: var(--text-muted, #7f7871);
  --tab-text-color-focused: var(--text-muted, #7f7871);
  --tab-text-color-focused-active: var(--text-muted, #7f7871);
  --tab-text-color-focused-active-current: var(--text-normal, #c6bbb1);
  --tab-text-color-focused-highlighted: var(--color-accent, hsl(177, 60%, 23%));
  --table-add-button-border-color: var(--background-modifier-border, #4c4843);
  --table-border-color: var(--background-modifier-border, #4c4843);
  --table-drag-handle-background-active: var(--table-selection-border-color, hsl(177, 60%, 23%));
  --table-drag-handle-color: var(--text-faint, #9f968d);
  --table-header-border-color: var(--table-border-color, #4c4843);
  --table-header-color: var(--text-normal, #c6bbb1);
  ...
  --text-faint: var(--color-base-60, #9f968d);
  --text-highlight-bg-active: rgba(255, 128, 0, 0.4);
  --text-muted: var(--color-base-50, #7f7871);
  --text-normal: var(--color-base-70, #c6bbb1);
  ...
  --titlebar-border-color: var(--background-modifier-border, #4c4843);
  --titlebar-text-color: var(--text-muted, #7f7871);
  --titlebar-text-color-focused: var(--text-normal, #c6bbb1);
  ...
  --vault-profile-color: var(--text-normal, #c6bbb1);
  --vault-profile-color-hover: var(--vault-profile-color, #c6bbb1);
...
html body[data-slug] div#quartz-root.page, html .page > div#quartz-body div.sidebar.left, html .page > div#quartz-body div.sidebar.left:has(.explorer), html .page > div#quartz-body div.sidebar.left .explorer .explorer-content {
  --bases-table-header-background: var(--background-secondary, #393633);
...
html body .page > div#quartz-body div.sidebar.right {
  ...
  color: var(--text-normal, rgb(198, 187, 177));
...
html body p {
  color: var(--text-muted, rgb(127, 120, 113));
  font-family: "??", Instrument, sans-serif, "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
...
html body a.internal-link.broken {
  ...
  color: var(--text-faint, rgb(159, 150, 141));
  font-family: "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  font-weight: var(--link-weight, 500);
  outline: rgb(159, 150, 141) none 0px;
  text-decoration-color: var(--link-unresolved-decoration-color, rgb(159, 150, 141));
  transition: 0.2s cubic-bezier(0.25, 0.8, 0.25, 1);
}`,
    lists: `html body dd {
...
html body blockquote {
  ...
  color: var(--blockquote-color, rgb(198, 187, 177));
  font-family: "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  line-height: 26.4px;
  padding-bottom: 16px;
  padding-left: 0px;
...
html body tr {
  ...
  border-top-width: 0px;
  color: var(--ec-codeFg, rgb(127, 120, 113));
...
html body .callout-title {
  --ancestor-editor-color: #c6bbb1;
  --background-modifier-active-hover: hsla(177, 60%, 23%, 0.1);
  --background-modifier-border: #4c4843;
  ...
  --background-modifier-hover: rgba(#fbdfc7, 0.067);
  --background-modifier-success: #8ba481;
  --background-modifier-success-rgb: 139, 164, 129;
  --background-primary: #33302e;
  --background-primary-alt: #242424;
  --background-secondary: #393633;
  --background-secondary-alt: #4c4843;
  --blockquote-border-color: hsl(177, 60%, 23%);
  --blur-background: color-mix(in srgb, #393633 65%, transparent) linear-gradient(#393633, color-mix(in srgb, #393633 65%, transparent));
  ...
  --canvas-background: #33302e;
  --canvas-controls-icon-size: 16px;
  --canvas-controls-icon-stroke: 2px;
  --canvas-controls-radius: 4px;
  --canvas-dot-pattern: #4c4843;
  --caret-color: #c6bbb1;
  --checkbox-border-color: #9f968d;
  --checkbox-border-color-hover: #7f7871;
  --checkbox-color: hsl(177, 60%, 23%);
  --checkbox-color-hover: #ef796a;
  --checkbox-marker-color: #33302e;
  --checkbox-radius: 4px;
  --checkbox-size: 16px;
  --checklist-done-color: #7f7871;
  --clickable-icon-radius: 4px;
  --code-background: #242424;
  --code-border-color: #4c4843;
  --code-bracket-background: rgba(#fbdfc7, 0.067);
  --code-comment: #9f968d;
  ...
  --code-punctuation: #7f7871;
  --code-radius: 4px;
  --code-size: 0.875em;
  --code-string: #8ba481;
  --code-tag: #9a453c;
  --code-value: #a69ab5;
  --collapse-icon-color: #9f968d;
  ...
  --pdf-background: #33302e;
  --pdf-page-background: #33302e;
  --pdf-shadow: 0 0 0 1px #4c4843;
  --pdf-sidebar-background: #33302e;
  --pdf-thumbnail-shadow: 0 0 0 1px #4c4843;
  --popover-font-size: 16px;
  --raised-background: color-mix(in srgb, #393633 65%, transparent) linear-gradient(#393633, color-mix(in srgb, #393633 65%, transparent));
  --raised-blur: blur(6px) saturate(1.5) brightness(1.15);
  --scrollbar-active-thumb-bg: hsl(177, 60%, 23%);
  --scrollbar-bg: rgb(from #fbdfc7 r g b / 0.1);
  --scrollbar-radius: 12px;
  --scrollbar-thumb-bg: rgba(#fbdfc7, 0.1);
  --search-clear-button-color: #7f7871;
  --search-icon-color: #7f7871;
  --search-result-background: #33302e;
  --setting-group-heading-color: #c6bbb1;
  --setting-group-heading-size: 15px;
  --setting-group-heading-weight: 600;
  --setting-items-background: #242424;
  --setting-items-border-color: #4c4843;
  --setting-items-padding: 20px;
  --setting-items-radius: 12px;
  --shiki-active-tab-border-color: #7f7871;
  --shiki-code-background: #242424;
  --shiki-code-block-border-radius: 4px;
  --shiki-code-block-spacing: 1rem;
  --shiki-code-comment: #9f968d;
  --shiki-code-function: #8ba481;
  --shiki-code-important: #f1bb8a;
  --shiki-code-keyword: #ef796a;
  --shiki-code-normal: #7f7871;
  --shiki-code-property: #9bc7bd;
  --shiki-code-punctuation: #7f7871;
  --shiki-code-string: #e4bc7f;
  --shiki-code-value: #a69ab5;
  --shiki-gutter-border-color: #4c4843;
  --shiki-gutter-border-width: 1px;
  --shiki-gutter-text-color: #9f968d;
  --shiki-gutter-text-color-highlight: #7f7871;
  --shiki-highlight-green: rgba(139, 164, 129, 0.5);
  --shiki-highlight-green-background: rgba(139, 164, 129, 0.1);
  --shiki-highlight-neutral: #7f7871;
  --shiki-highlight-neutral-background: rgba(#fbdfc7, .05);
  --shiki-highlight-red: rgba(154, 69, 60, 0.5);
  --shiki-highlight-red-background: rgba(154, 69, 60, 0.1);
  --shiki-terminal-dots-color: #9f968d;
  --shiki-tooltip-background: rgba(0, 0, 0, 0.9);
  --suggestion-background: #33302e;
  --swatch-shadow: inset 0 0 0 1px rgba(#fbdfc7, 0.15);
  ...
  --tab-background-active: #33302e;
  --tab-divider-color: #635e58;
  --tab-font-size: 13px;
  --tab-outline-color: #4c4843;
  --tab-radius: 4px;
  --tab-stacked-font-size: 13px;
  --tab-stacked-header-width: 40px;
  --tab-switcher-background: #393633;
  --tab-switcher-menubar-background: linear-gradient(to top, #393633, transparent);
  --tab-switcher-preview-radius: 24px;
  --tab-switcher-preview-shadow: 0 0 0 1px rgba(#fbdfc7, 0.05);
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(177, 60%, 23%);
  --tab-text-color: #9f968d;
  --tab-text-color-active: #7f7871;
  --tab-text-color-focused: #7f7871;
  --tab-text-color-focused-active: #7f7871;
  --tab-text-color-focused-active-current: #c6bbb1;
  --tab-text-color-focused-highlighted: hsl(177, 60%, 23%);
  --table-add-button-border-color: #4c4843;
  --table-add-button-border-width: 1px;
  --table-border-color: color-mix(in srgb, rgb(23, 92, 89) 25%, #33302e 50%);
  ...
  --table-drag-handle-color: #9f968d;
  --table-drag-handle-color-active: white;
  --table-header-background: transparent;
  --table-header-border-color: #4c4843;
  --table-header-border-width: 1px;
  --table-header-color: #c6bbb1;
...
html body .search > .search-container > .search-space {
  background-color: var(--prompt-background, rgb(51, 48, 46));
...
html body .search > .search-container > .search-space > .search-layout > .results-container > .result-card:hover, html .search > .search-container > .search-space > .search-layout > .results-container > .result-card:focus, html .search > .search-container > .search-space > .search-layout > .results-container > .result-card.focus:not(:has(~ .result-card:hover, html ~ .result-card:focus)) {
  background-color: var(--interactive-hover, rgb(99, 94, 88));
  color: rgb(198, 187, 177);
}
...
html body .nav-files-container li:has(> .folder-outer.open) > .nav-folder-title {
  color: var(--nav-item-color, rgb(127, 120, 113));
  font-family: "??", Instrument, sans-serif, "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
}
...
html body .explorer .nav-files-container .folder-outer > ul {
  ...
  border-top-right-radius: 8px;
  border-top-width: 0px;
  color: var(--status-bar-text-color, rgb(127, 120, 113));
  font-family: "??", Instrument, sans-serif, "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
}
...
html body div#quartz-root {
  background-color: var(--background-primary, rgb(51, 48, 46));
  color: var(--text-normal, rgb(198, 187, 177));
}
...
html body input[type=text] {
  ...
  border-top-right-radius: 50px;
  border-top-width: 0px;
  color: var(--text-normal, rgb(127, 120, 113));
  font-family: "??", Instrument, sans-serif, "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  padding-bottom: 0px;
  padding-left: 28px;
  padding-right: 0px;
