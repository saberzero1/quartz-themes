...
export const theme: ThemeData = {
  ...
  --callout-bug: var(--callout-bug, 149, 0, 0);
  --callout-default: var(--accent-color, 55, 0, 255);
  --callout-error: var(--callout-error, 149, 0, 0);
  --callout-example: var(--callout-example, 120, 82, 238);
  --callout-fail: var(--callout-fail, 149, 0, 0);
  --callout-info: var(--callout-info, 8, 109, 221);
  --callout-padding: var(--size-4-3) var(--size-4-3) var(--size-4-3) var(--size-4-6, 15px 20px);
  --callout-question: var(--callout-question, 149, 92, 0);
  --callout-quote: var(--callout-quote, 158, 158, 158);
  --callout-radius: var(--radius-s, 20px);
  --callout-success: var(--callout-success, 0, 124, 37);
  --callout-summary: var(--callout-summary, 0, 142, 123);
  --callout-tip: var(--callout-tip, 0, 142, 123);
  --callout-todo: var(--callout-todo, 8, 109, 221);
  --callout-warning: var(--callout-warning, 149, 92, 0);
...
html body blockquote {
  color: var(--blockquote-color, rgb(20, 20, 20));
  font-family: "??", "Noto Serif KR", serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
...
html body h5 {
  ...
  line-height: var(--h5-line-height, 35.2px);
}
...
html body h6 {
  ...
  font-weight: var(--font-weight, 700);
  line-height: var(--h6-line-height, 32px);
}
...
html body .metadata-property-key {
  font-family: var(--metadata-label-font, "??", Pretendard-Regular, serif, "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
}

html body .metadata-property-value {
  font-family: var(--metadata-input-font, "??", Pretendard-Regular, serif, "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
}
