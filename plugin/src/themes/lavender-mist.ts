...
export const theme: ThemeData = {
  ...
  light: {
    base: `:root:root {
  --accent: #96539d;
  --background-primary: #e7e9f3;
  --bases-cards-background: #e7e9f3;
  --bases-cards-radius: 12px;
  --bases-embed-border-radius: 8px;
  --bases-table-cell-background-active: #e7e9f3;
  --bases-table-container-border-radius: 8px;
  --bases-table-header-background: #e7e9f3;
  --bases-table-summary-background: #e7e9f3;
  --blur-background: color-mix(in srgb, #e7e9f3 65%, transparent) linear-gradient(#e7e9f3, color-mix(in srgb, #e7e9f3 65%, transparent));
  --bodyFont: var(--font-text, Noto Serif KR, serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  --bold-color: #96539d;
  --button-radius: 12px;
  --callout-radius: 8px;
  --canvas-background: #e7e9f3;
  --canvas-controls-radius: 8px;
  --checkbox-marker-color: #e7e9f3;
  --checkbox-radius: 12px;
  --clickable-icon-radius: 8px;
  --code-radius: 8px;
  --codeFont: var(--font-text, Noto Serif KR, serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  --file-header-background: #e7e9f3;
  --file-header-background-focused: #e7e9f3;
  ...
  --h5-color: #96539d;
  --h6-color: #96539d;
  --headerFont: var(--font-text, Noto Serif KR, serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  --highlight-hue: 30;
  --inline-title-color: #96539d;
  --input-radius: 12px;
  --italic-color: #96539d;
  --light: var(--background-primary, #e7e9f3);
  --menu-radius: 12px;
  --modal-background: #e7e9f3;
  --modal-radius: 16px;
  --nav-item-radius: 8px;
  --nav-tag-radius: 8px;
  --pdf-background: #e7e9f3;
  --pdf-page-background: #e7e9f3;
  --pdf-sidebar-background: #e7e9f3;
  --primary: #313a5e;
  --prompt-background: #e7e9f3;
  --radius-l: 16px;
  --radius-m: 12px;
  --radius-s: 8px;
  --raised-background: color-mix(in srgb, #e7e9f3 65%, transparent) linear-gradient(#e7e9f3, color-mix(in srgb, #e7e9f3 65%, transparent));
  --ribbon-background-collapsed: #e7e9f3;
  --scrollbar-radius: 16px;
  --search-result-background: #e7e9f3;
  --secondary: #af8dc3;
  --setting-items-radius: 16px;
  --shiki-code-block-border-radius: 8px;
  --slider-thumb-radius: 12px;
  --status-bar-radius: 12px 0 0 0;
  --suggestion-background: #e7e9f3;
  --tab-background-active: #e7e9f3;
  --tab-radius: 8px;
  --text: #121421;
  --titleFont: var(--font-text, Noto Serif KR, serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  --toggle-radius: 12px;
