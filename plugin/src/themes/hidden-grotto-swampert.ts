...
export const theme: ThemeData = {
  ...
  --shiki-active-tab-border-color: hsl(40, 14%, 76%) !important;
  --shiki-code-background: hsl(210, 30%, 30%) !important;
  --shiki-code-block-spacing: 0rem !important;
  --shiki-code-comment: hsl(40, 14%, 76%) !important;
  --shiki-code-normal: hsl(40, 14%, 76%) !important;
  --shiki-code-punctuation: hsl(40, 14%, 76%) !important;
  --shiki-gutter-text-color: hsl(40, 14%, 76%) !important;
  --shiki-gutter-text-color-highlight: hsl(40, 14%, 76%) !important;
  --shiki-highlight-neutral: hsl(40, 14%, 76%) !important;
  --shiki-terminal-dots-color: hsl(40, 14%, 76%) !important;
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --shadow-s: none !important;
  --shadow-xs: none !important;
  --shiki-active-tab-border-color: hsl(210, 30%, 36%) !important;
  --shiki-code-background: hsl(40, 14%, 86%) !important;
  --shiki-code-block-spacing: 0rem !important;
  --shiki-code-comment: hsl(210, 30%, 36%) !important;
  --shiki-code-normal: hsl(210, 30%, 36%) !important;
  --shiki-code-punctuation: hsl(210, 30%, 36%) !important;
  --shiki-gutter-text-color: hsl(210, 30%, 36%) !important;
  --shiki-gutter-text-color-highlight: hsl(210, 30%, 36%) !important;
  --shiki-highlight-neutral: hsl(210, 30%, 36%) !important;
  --shiki-terminal-dots-color: hsl(210, 30%, 36%) !important;
  --slider-thumb-y: -7px !important;
