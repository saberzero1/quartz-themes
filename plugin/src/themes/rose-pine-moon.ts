...
export const theme: ThemeData = {
  ...
  --highlight: var(--text-highlight-bg, #312f44);
  --hr-color: #e0def4;
  --icon-color: #e0def4;
  ...
  --lightgray: var(--background-secondary, #312f44);
  --link-color: #c4a7e7;
  ...
  --tertiary: var(--text-accent-hover, #9ccfd8);
  --text-accent: #c4a7e7;
  ...
  --textHighlight: var(--text-highlight-bg, #312f44);
