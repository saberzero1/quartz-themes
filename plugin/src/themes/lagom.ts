...
export const theme: ThemeData = {
  ...
  --active-line-font-size: calc(var(--default-font-size) + 1px);
  ...
  --clickable-icon-radius: var(--radius-s, 11.5px);
  --code-radius: var(--radius-s, 11.5px);
  --code-size: var(--font-smaller, 14px);
  --code-size-edit-mode: 13.9px;
  --default-font-size: 16px;
  --dropdown-background-hover: var(--interactive-hover, hsla(258, 88%, 66%, 0.1));
  ...
  --h5-size: 12px;
  --headers-align: left;
  --headers-space-simetry: 1.3em;
  --hide-add-button: none;
  --hide-callout-title: none;
  ...
  --icon-ui-opacity: 0.9;
  --img-align: 0px;
  --inline-code-font-size: calc(var(--default-font-size) - 1.5 px);
  --inline-title-align: center;
  --inline-title-size: var(--h1-size, 20px);
  --input-shadow: var(--background-modifier-border, #363636 0 0 0 1px) 0 0 0 1px;
  --input-shadow-hover: hsla(var(--color-accent-hsl), 0.6) 0 0 0px 1px;
  --interactive-hover: hsla(var(--color-accent-hsl), 0.1);
  --letter-spacing-note: 0.1px;
  --line-height-note: 21px;
  ...
  --metadata-input-font-size: var(--default-font-size, 16px);
  --metadata-label-font-size: calc(var(--default-font-size) - 1px);
  --metadata-property-radius: var(--radius-s, 11.5px);
  --nav-item-radius: var(--radius-s, 11.5px);
  --nav-item-size: var(--font-ui-small, 16.4px);
  --nav-tag-radius: var(--radius-s, 11.5px);
  ...
  --pill-radius: 11.5px;
  --properties-editor-font-size: var(--default-font-size, 16px);
  --quote-font-size: var(--default-font-size, 16px);
  --quote-icon: "“";
  ...
  --scrollbars: none;
  --separator-icon: "o0o";
  --separator-icon-color: #6C6C6C6B
  --show-explorer-buttons: none;
  --setting-items-background: var(--background-primary-alt, none);
  --shiki-code-block-border-radius: var(--code-radius, 11.5px);
  --shiki-code-block-spacing: var(--p-spacing, 8px);
  --show-dotted-line: 1px;
  --show-editor-text-bar: none;
  --show-vault-name: none;
  --tab-radius: var(--radius-s, 11.5px);
  --table-add-button-border-width: var(--table-border-width, 1px solid);
  --table-border-width: 1px solid;
  --table-column-first-border-width: var(--table-border-width, 1px solid);
  --table-column-last-border-width: var(--table-border-width, 1px solid);
  --table-header-border-width: var(--table-border-width, 1px solid);
  --table-row-last-border-width: var(--table-border-width, 1px solid);
  --tabs-height: 300px;
  --text-note-align: justify;
  --theme-dark-opacity: 0.85;
  --theme-light-opacity: 0.90;
  --touch-radius-m: var(--touch-size-m, 11.5px);
  --touch-radius-s: var(--touch-size-s, 11.5px);
  --touch-radius-xl: var(--touch-size-xl, 11.5px);
  --touch-radius-xs: var(--touch-size-xs, 11.5px);
  --touch-radius-xxs: var(--touch-size-xxs, 11.5px);
...
html[saved-theme="dark"] body tr {
  ...
  color: var(--ec-codeFg, rgb(179, 179, 179));
...
html[saved-theme="dark"] body img {
  ...
  border-top-left-radius: 11.5px;
  border-top-right-radius: 11.5px;
  box-shadow: var(--background-modifier-box-shadow, rgba(0, 0, 0, 0.3) 0px 0px 2.5px 0px) 0px 0px 2.5px 0px;
  filter: grayscale(1);
}`,
...
html[saved-theme="dark"] body .callout[data-callout="note-toolbar"] {
  ...
  --dropdown-background-hover: hsla(258, 88%, 66%, 0.1);
  ...
  --shiki-code-block-border-radius: 11.5px;
  ...
  border-top-style: solid;
  border-top-width: 1px;
  box-shadow: var(--background-modifier-box-shadow, rgba(0, 0, 0, 0.3) 0px 0px 0px 0px) 0px 0px 0px 0px;
...
html[saved-theme="dark"] body hr {
  ...
  border-bottom-color: rgba(80, 80, 80, 0.533);
  border-bottom-left-radius: 11.5px;
  border-bottom-right-radius: 11.5px;
  border-bottom-style: solid;
  border-bottom-width: 1px;
  border-left-color: rgba(80, 80, 80, 0.533);
  border-left-style: solid;
  border-left-width: 1px;
  border-right-color: rgba(80, 80, 80, 0.533);
  border-right-style: solid;
  border-right-width: 1px;
  border-top-color: rgba(80, 80, 80, 0.533);
  border-top-left-radius: 11.5px;
  border-top-right-radius: 11.5px;
  border-top-style: solid;
  border-top-width: 1px;
...
html[saved-theme="dark"] body .note-properties-tags {
  ...
  border-radius: 0px;
    ...
    misc: `html[saved-theme="dark"] body input[type=text] {
  border-bottom-left-radius: 11.5px;
  border-bottom-right-radius: 11.5px;
  border-top-left-radius: 11.5px;
  border-top-right-radius: 11.5px;
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --inline-title-align: center;
  --inline-title-size: var(--h1-size, 20px);
  --input-shadow: var(--background-modifier-border, #e0e0e0 0 0 0 1px) 0 0 0 1px;
  --input-shadow-hover: hsla(var(--color-accent-hsl), 0.6) 0 0 0px 1px;
  --interactive-hover: hsla(var(--color-accent-hsl), 0.1);
  --letter-spacing-note: 0.1px;
  --line-height-note: 21px;
...
html[saved-theme="light"] body img {
  ...
  border-top-left-radius: 11.5px;
  border-top-right-radius: 11.5px;
  box-shadow: var(--background-modifier-box-shadow, rgba(0, 0, 0, 0.1) 0px 0px 2.5px 0px) 0px 0px 2.5px 0px;
...
html[saved-theme="light"] body .callout[data-callout="note-toolbar"] {
  ...
  border-top-style: solid;
  border-top-width: 1px;
  box-shadow: var(--background-modifier-box-shadow, rgba(0, 0, 0, 0.1) 0px 0px 0px 0px) 0px 0px 0px 0px;
  color: rgb(34, 34, 34);
  font-family: "??", "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  line-height: 24px;
  margin-bottom: 0px;
