...
export const theme: ThemeData = {
  ...
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(90, 65%, 39%);
  ...
  --bases-table-header-background-hover: hsl(90, 65%, 39%);
  ...
  --bases-table-summary-background-hover: hsl(90, 65%, 39%);
  ...
  --highlight: var(--background-modifier-hover, hsl(90, 65%, 39%));
  --hr-color: color-mix(
    in srgb,
    hsl(90, 65%, 39%),
    black 25%
  );
  --icon-color: hsl(90, 65%, 39%);
  ...
  --metadata-property-background-active: hsl(90, 65%, 39%);
  ...
  --nav-item-background-active: hsl(90, 65%, 39%);
  ...
  --pill-background-hover: hsl(90, 65%, 39%);
  ...
  --secondary: var(--interactive-accent, hsl(90, 65%, 39%));
  ...
  --textHighlight: var(--background-modifier-hover, hsl(90, 65%, 39%));
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --bases-table-cell-shadow-active: 0 0 0 2px hsl(90, 65%, 39%);
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(90, 65%, 39%);
  --bases-table-container-border-radius: 0.25rem;
  ...
  --metadata-property-box-shadow-focus: 0 0 0 2px hsl(90, 65%, 39%);
  --metadata-property-box-shadow-hover: none;
  --metadata-sidebar-input-font-size: 0.8rem;
  --metadata-sidebar-label-font-size: 0.8rem;
  --modal-background: color-mix(
  ...
  --tag-weight: 400;
  --tertiary: var(--interactive-accent-hover, hsl(90, 65%, 39%));
  --text-error: hsl(from hsl(90, 65%, 39%) 356 s l);
  --text-faint: color-mix(
    in srgb,
    hsl(90, 65%, 39%),
