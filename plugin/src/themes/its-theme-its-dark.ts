...
export const theme: ThemeData = {
  ...
  --dark: var(--text-normal, #475569);
  --dark-accent: #04070c;
  --dark-sidebar: #000000;
  --darkgray: var(--text-normal, #475569);
  ...
  --light: var(--background-primary, #070b11);
  ...
  --secondary: var(--text-accent, #c5575b);
  ...
  --tall: 700px;
  --td: #03000054;
  --tertiary: var(--text-accent-hover, #475569);
  --text: #475569;
  --text-accent: #c5575b;
  ...
  --textHighlight: var(--text-highlight-bg, rgba(60, 8, 8, 0.46));
  --th: #571a1a;
  --th-text: #e5ebee;
...
html[saved-theme="dark"] body li.task-list-item[data-task="X"] input[type="checkbox"]::after {
  ...
  border-right-color: rgb(71, 85, 105);
  border-top-color: rgb(71, 85, 105);
  color: rgb(var(--callout-color), rgb(71, 85, 105));
}
