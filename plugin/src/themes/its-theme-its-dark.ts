...
export const theme: ThemeData = {
  ...
  --shiki-active-tab-border-color: #803232 !important;
  --shiki-code-background: #04070c !important;
  --shiki-code-block-border-radius: 0 !important;
  --shiki-code-comment: #4e5b6f !important;
  --shiki-code-normal: #803232 !important;
  --shiki-code-punctuation: #803232 !important;
  --shiki-gutter-border-color: #380b13 !important;
  --shiki-gutter-text-color: #4e5b6f !important;
  --shiki-gutter-text-color-highlight: #803232 !important;
  --shiki-highlight-neutral: #803232 !important;
  --shiki-terminal-dots-color: #4e5b6f !important;
  --shiki-tooltip-background: #04070c !important;
...
html[saved-theme="dark"] body .callout[data-callout="aside"] {
  ...
  --table-border-color: color-mix(in srgb, rgb("") 25%, #070b11 50%);
  background-color: rgb(4, 7, 12);
  border-bottom-color: rgb(71, 85, 105);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
  ...
  border-top-style: solid;
  border-top-width: 0px;
  box-shadow: rgb(128, 50, 50) 4.8px 4.8px 0px 0px, rgb(128, 50, 50) 0px 0px 0px 1px;
  color: rgb(71, 85, 105);
  font-family: "??", Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Microsoft YaHei Light", sans-serif;
  line-height: 24px;
  margin-bottom: 5px;
...
html[saved-theme="dark"] body .callout[data-callout="blank"] {
  ...
  --callout-white: 256, 256, 256;
  --callout-yellow: 208, 181, 48;
  --table-border-color: color-mix(in srgb, rgb(transparent) 25%, #070b11 50%);
  background-color: rgba(0, 0, 0, 0);
  border-bottom-color: rgb(71, 85, 105);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
...
html[saved-theme="dark"] body .callout[data-callout="caption"] {
  ...
  --callout-white: 256, 256, 256;
  --callout-yellow: 208, 181, 48;
  --table-border-color: color-mix(in srgb, rgb(2, 122, 255) 25%, #070b11 50%);
  background-color: rgba(0, 0, 0, 0);
  border-bottom-color: rgb(71, 85, 105);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
...
html[saved-theme="dark"] body .callout[data-callout="column"] {
  ...
  --callout-yellow: 208, 181, 48;
  --columns: 2;
  --table-border-color: color-mix(in srgb, rgb(#475569) 25%, #070b11 50%);
  background-color: rgba(0, 0, 0, 0);
  border-bottom-color: rgb(71, 85, 105);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
...
html[saved-theme="dark"] body .callout[data-callout="infobox"] {
  ...
  --table-border-color: color-mix(in srgb, rgb(#070b11) 25%, #070b11 50%);
  background-color: rgb(7, 11, 17);
  border-bottom-color: rgb(71, 85, 105);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
...
html[saved-theme="dark"] body .callout[data-callout="kith"] {
  ...
  --callout-white: 256, 256, 256;
  --callout-yellow: 208, 181, 48;
  --table-border-color: color-mix(in srgb, rgb(115, 167, 202) 25%, #070b11 50%);
...
html[saved-theme="dark"] body .callout[data-callout="metadata"] {
  ...
  --callout-purple: 153, 97, 218;
  --callout-red: 193, 67, 67;
  --callout-shadow: 0px 0px 0px 1px black;
  --callout-small: 30%;
  --callout-small-med: 40%;
  --callout-tall: 95%;
  --callout-tiny: 20%;
  ...
  --callout-white: 256, 256, 256;
  --callout-yellow: 208, 181, 48;
  --table-border-color: color-mix(in srgb, rgb(82, 139, 212) 25%, #070b11 50%);
...
html[saved-theme="dark"] body .callout[data-callout="recite"] {
  ...
  --callout-white: 256, 256, 256;
  --callout-yellow: 208, 181, 48;
  --table-border-color: color-mix(in srgb, rgb(193, 67, 67) 25%, #070b11 50%);
  background-color: rgb(7, 11, 17);
...
html[saved-theme="dark"] body .callout[data-callout="statblocks"] {
  ...
  box-shadow: rgb(0, 0, 0) 5px 5px 0px 0px, rgb(0, 0, 0) 0px 0px 20px 0px;
  color: rgb(71, 85, 105);
  font-family: "??", Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Microsoft YaHei Light", sans-serif;
  line-height: 24px;
  margin-bottom: 10px;
