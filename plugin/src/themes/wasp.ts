...
export const theme: ThemeData = {
  ...
  --dark: var(--text-normal, #faf2d6);
  --darkgray: var(--text-normal, #faf2d6);
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --secondary: var(--text-accent, #961327);
  --setting-group-heading-color: #1A2023;
  --setting-items-background: #;
  --setting-items-border-color: #D49335;
  --shiki-code-background: #;
  --shiki-code-comment: #DEDEDE;
  --shiki-gutter-border-color: #D49335;
  --shiki-gutter-text-color: #DEDEDE;
  --shiki-terminal-dots-color: #DEDEDE;
