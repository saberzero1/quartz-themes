...
export const theme: ThemeData = {
  ...
  --background-modifier-border: var(--color-base-30, #f8c537);
  --background-primary: var(--color-base-00, #242424);
  --background-secondary: var(--color-base-20, #191919);
  --background-secondary-alt: var(--color-base-30, #3D3D3D);
  --bases-cards-background: var(--background-primary, #242424);
  --bases-embed-border-color: var(--background-modifier-border, #f8c537);
  --bases-table-border-color: var(--table-border-color, #f8c537);
  ...
  --blockquote-border-color: var(--interactive-accent, #f8c537);
  ...
  --footnote-divider-color: var(--metadata-divider-color, #f8c537);
  --footnote-id-color-no-occurrences: var(--text-faint, #bdae93);
  --graph-node-focused: var(--text-accent, #f8c537);
  ...
  --hr-color: var(--background-modifier-border, #f8c537);
  --icon-color-active: var(--text-accent, #f8c537);
  ...
  --interactive-accent: var(--color-accent, #f8c537);
  --interactive-accent-rgb: #f8c537;
  --interactive-before: #7c6f64;
  --light: var(--background-primary, var(--color-base-00, #242424));
  --lightgray: var(--background-secondary, var(--color-base-20, #191919));
  --link-color: var(--text-accent, #f8c537);
  --link-color-hover: var(--text-accent-hover, #D49335);
  --link-external-color: var(--text-accent, #f8c537);
  --link-external-color-hover: var(--text-accent-hover, #D49335);
  --link-unresolved-color: var(--text-accent, #f8c537);
  --list-marker-color: var(--text-faint, #bdae93);
  --list-marker-color-collapsed: var(--text-accent, #f8c537);
  --menu-background: var(--background-secondary, #191919);
  --metadata-border-color: var(--background-modifier-border, #f8c537);
  --metadata-divider-color: var(--background-modifier-border, #f8c537);
  ...
  --nav-item-color-highlighted: var(--text-accent, #f8c537);
  ...
  --pill-border-color: var(--background-modifier-border, #f8c537);
  --pill-color-hover: var(--text-normal, #faf2d6);
  --pill-color-remove: var(--text-faint, #bdae93);
  --pill-color-remove-hover: var(--text-accent, #f8c537);
  --pre-code: #;
  ...
  --secondary: var(--text-accent, var(--color-accent-1, #f8c537));
  --setting-group-heading-color: var(--text-normal, #faf2d6);
  --setting-items-border-color: var(--background-modifier-border, #f8c537);
  --shiki-code-comment: var(--text-faint, #bdae93);
  --shiki-gutter-border-color: var(--background-modifier-border, #f8c537);
  --shiki-gutter-text-color: var(--text-faint, #bdae93);
  --shiki-terminal-dots-color: var(--text-faint, #bdae93);
  --slider-track-background: var(--background-modifier-border, #f8c537);
  --status-bar-background: var(--background-secondary, #191919);
  --status-bar-border-color: var(--divider-color, #f8c537);
  ...
  --tab-outline-color: var(--divider-color, #f8c537);
  ...
  --tab-text-color-focused-highlighted: var(--text-accent, #f8c537);
  --table-add-button-border-color: var(--background-modifier-border, #f8c537);
  --table-border-color: var(--background-modifier-border, #f8c537);
  --table-drag-handle-background-active: var(--table-selection-border-color, #f8c537);
  --table-drag-handle-color: var(--text-faint, #bdae93);
  --table-drag-handle-color-active: var(--text-on-accent, #fff);
  --table-header-border-color: var(--table-border-color, #f8c537);
  --table-header-color: var(--text-normal, #faf2d6);
  --table-selection-border-color: var(--interactive-accent, #f8c537);
  --tag-color: var(--text-accent, #f8c537);
  --tag-color-hover: var(--text-accent, #f8c537);
  --tertiary: var(--text-accent-hover, var(--color-accent-2, #D49335));
  --text-a: #f8c537;
  --text-a-hover: #83a598;
  --text-accent: var(--color-accent-1, #f8c537);
  --text-accent-hover: var(--color-accent-2, #D49335);
  ...
  --titlebar-border-color: var(--background-modifier-border, #f8c537);
...
html[saved-theme="dark"] body li.task-list-item input[type="checkbox"]:checked {
  background-color: var(--checkbox-color, rgb(248, 197, 55));
  border-color: rgb(248, 197, 55);
}`,
    links: `html[saved-theme="dark"] body a.external-link, html[saved-theme="dark"] footer a {
  color: var(--link-external-color, rgb(248, 197, 55));
  outline: rgb(248, 197, 55) none 0px;
  text-decoration-color: rgb(248, 197, 55);
}

html[saved-theme="dark"] body a.internal-link, html[saved-theme="dark"] .breadcrumb-container .breadcrumb-element > a {
  color: var(--link-color, rgb(248, 197, 55));
  outline: rgb(248, 197, 55) none 0px;
  text-decoration-color: rgb(248, 197, 55);
}

html[saved-theme="dark"] body a.internal-link.broken {
  color: var(--link-unresolved-color, rgb(248, 197, 55));
  outline: rgb(248, 197, 55) none 0px;
}`,
...
html[saved-theme="dark"] body blockquote {
  color: var(--blockquote-color, rgb(250, 242, 214));
}`,
...
html[saved-theme="dark"] body a.internal-link.tag-link, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  --pill-color: var(--tag-color, #f8c537);
  --pill-color-hover: var(--tag-color-hover, #f8c537);
  --pill-color-remove: var(--tag-color, #f8c537);
  --pill-color-remove-hover: var(--tag-color-hover, #f8c537);
  color: var(--pill-color, rgb(248, 197, 55));
}
...
html[saved-theme="dark"] body h1 {
  ...
  border-top-width: 0px;
  color: var(--text-title-h1, rgb(224, 224, 224));
...
html[saved-theme="dark"] body h2 {
  ...
  border-top-color: rgb(224, 224, 224);
  border-top-width: 0px;
  color: var(--text-title-h2, rgb(224, 224, 224));
...
html[saved-theme="dark"] body h3 {
  ...
  border-top-color: rgb(224, 224, 224);
  border-top-width: 0px;
  color: var(--text-title-h3, rgb(224, 224, 224));
...
html[saved-theme="dark"] body h4 {
  ...
  border-top-color: rgb(224, 224, 224);
  border-top-width: 0px;
  color: var(--text-title-h4, rgb(224, 224, 224));
...
html[saved-theme="dark"] body h5 {
  ...
  border-top-color: rgb(224, 224, 224);
  border-top-width: 0px;
  color: var(--text-title-h5, rgb(224, 224, 224));
...
html[saved-theme="dark"] body h6 {
  ...
  border-top-color: rgb(224, 224, 224);
  border-top-width: 0px;
  color: var(--text-title-h6, rgb(224, 224, 224));
...
html[saved-theme="dark"] body .explorer .nav-files-container .collapse-icon svg {
  ...
  background-color: var(--status-bar-background, rgb(25, 25, 25));
  border-bottom-color: rgb(248, 197, 55);
  border-bottom-width: 0px;
  border-left-color: rgb(248, 197, 55);
  border-left-width: 0px;
...
html[saved-theme="dark"] body ul.tags > li {
  color: var(--tag-color, rgb(248, 197, 55));
}`,
  },
  light: {
    base: `:root:root {
  --background-modifier-border: var(--color-base-30, #D49335);
  --background-primary: var(--color-base-00, #EDEDED);
  --background-primary-alt: var(--color-base-10, #);
  --background-secondary: var(--color-base-20, #C4C4C4);
  --background-secondary-alt: var(--color-base-05, #707070);
  --bases-cards-background: var(--background-primary, #EDEDED);
  --bases-cards-cover-background: var(--background-primary-alt, #);
  --bases-embed-border-color: var(--background-modifier-border, #D49335);
  --bases-table-border-color: var(--table-border-color, #D49335);
  ...
  --canvas-card-label-color: var(--text-faint, #DEDEDE);
  --caret-color: var(--text-normal, #1A2023);
  --checkbox-border-color: var(--text-faint, #DEDEDE);
  --checkbox-color: var(--interactive-accent, #f8c537);
  --checkbox-marker-color: var(--background-primary, #EDEDED);
  --code-background: var(--background-primary-alt, #);
  --code-border-color: var(--background-modifier-border, #D49335);
  --code-comment: var(--text-faint, #DEDEDE);
  --code-normal: var(--text-normal, #1A2023);
  --collapse-icon-color: var(--text-faint, #DEDEDE);
  --collapse-icon-color-collapsed: var(--text-accent, #961327);
  --dark: var(--text-normal, var(--color-base-100, #1A2023));
  --darkgray: var(--text-normal, var(--color-base-100, #1A2023));
  --divider-color: var(--background-modifier-border, #D49335);
  --divider-color-hover: var(--interactive-accent, #f8c537);
  ...
  --footnote-divider-color: var(--metadata-divider-color, #D49335);
  --footnote-id-color-no-occurrences: var(--text-faint, #DEDEDE);
  --graph-node-focused: var(--text-accent, #961327);
  --graph-node-unresolved: var(--text-faint, #DEDEDE);
  --graph-text: var(--text-normal, #1A2023);
  --gray: var(--text-faint, var(--color-base-50, #DEDEDE));
  --heading-formatting: var(--text-faint, #DEDEDE);
  --hr-color: var(--background-modifier-border, #D49335);
  --icon-color-active: var(--text-accent, #961327);
  --icon-color-focused: var(--text-normal, #1A2023);
  --inline-code: #458588;
  --input-date-separator: var(--text-faint, #DEDEDE);
  --input-placeholder-color: var(--text-faint, #DEDEDE);
  --interactive-accent: var(--color-accent-1, #f8c537);
  --interactive-accent-rgb: #961327;
  --interactive-before: #a89984;
  --light: var(--background-primary, var(--color-base-00, #EDEDED));
  --lightgray: var(--background-secondary, var(--color-base-20, #C4C4C4));
  --link-color: var(--text-accent, #961327);
  --link-color-hover: var(--text-accent-hover, #D49335);
  --link-external-color: var(--text-accent, #961327);
  --link-external-color-hover: var(--text-accent-hover, #D49335);
  --link-unresolved-color: var(--text-accent, #961327);
  --list-marker-color: var(--text-faint, #DEDEDE);
  --list-marker-color-collapsed: var(--text-accent, #961327);
  --menu-background: var(--background-secondary, #C4C4C4);
  --metadata-border-color: var(--background-modifier-border, #D49335);
  --metadata-divider-color: var(--background-modifier-border, #D49335);
  --metadata-input-text-color: var(--text-normal, #1A2023);
  --modal-background: var(--background-primary, #EDEDED);
  --nav-collapse-icon-color: var(--collapse-icon-color, #DEDEDE);
  --nav-collapse-icon-color-collapsed: var(--text-faint, #DEDEDE);
  --nav-heading-color: var(--text-normal, #1A2023);
  --nav-heading-color-collapsed: var(--text-faint, #DEDEDE);
  --nav-heading-color-hover: var(--text-normal, #1A2023);
  --nav-item-color-active: var(--text-normal, #1A2023);
  --nav-item-color-highlighted: var(--text-accent, #961327);
  --nav-item-color-hover: var(--text-normal, #1A2023);
  --nav-item-color-selected: var(--text-normal, #1A2023);
  --nav-tag-color: var(--text-faint, #DEDEDE);
  ...
  --pill-border-color: var(--background-modifier-border, #D49335);
  --pill-color-hover: var(--text-normal, #1A2023);
  --pill-color-remove: var(--text-faint, #DEDEDE);
  --pill-color-remove-hover: var(--text-accent, #961327);
  --pre-code: #bebebe;
  ...
  --secondary: var(--text-accent, var(--color-accent, #961327));
  --setting-group-heading-color: var(--text-normal, #1A2023);
  --setting-items-background: var(--background-primary-alt, #);
  --setting-items-border-color: var(--background-modifier-border, #D49335);
  --shiki-code-background: var(--code-background, #);
  --shiki-code-comment: var(--text-faint, #DEDEDE);
  --shiki-gutter-border-color: var(--background-modifier-border, #D49335);
  --shiki-gutter-text-color: var(--text-faint, #DEDEDE);
  --shiki-terminal-dots-color: var(--text-faint, #DEDEDE);
  --slider-track-background: var(--background-modifier-border, #D49335);
  --status-bar-background: var(--background-secondary, #C4C4C4);
  --status-bar-border-color: var(--divider-color, #D49335);
  ...
  --tab-outline-color: var(--divider-color, #D49335);
  --tab-switcher-background: var(--background-secondary, #C4C4C4);
  --tab-text-color: var(--text-faint, #DEDEDE);
  --tab-text-color-focused-active-current: var(--text-normal, #1A2023);
  --tab-text-color-focused-highlighted: var(--text-accent, #961327);
  --table-add-button-border-color: var(--background-modifier-border, #D49335);
  --table-border-color: var(--background-modifier-border, #D49335);
  --table-drag-handle-background-active: var(--table-selection-border-color, #f8c537);
  --table-drag-handle-color: var(--text-faint, #DEDEDE);
  --table-header-border-color: var(--table-border-color, #D49335);
  --table-header-color: var(--text-normal, #1A2023);
  --table-selection-border-color: var(--interactive-accent, #f8c537);
  --tag-color: var(--text-accent, #961327);
  --tag-color-hover: var(--text-accent, #961327);
  --tertiary: var(--text-accent-hover, var(--color-accent-2, #D49335));
  --text-a: #961327;
  --text-a-hover: #D49335;
  --text-accent: var(--color-accent, #961327);
  --text-accent-hover: var(--color-accent-2, #D49335);
  --text-faint: var(--color-base-50, #DEDEDE);
  --text-link: #D49335;
  ...
  --titlebar-border-color: var(--background-modifier-border, #D49335);
...
html[saved-theme="light"] body li.task-list-item input[type="checkbox"]:checked {
  ...
  color: var(--link-external-color, rgb(150, 19, 39));
  outline: rgb(150, 19, 39) none 0px;
  text-decoration-color: rgb(150, 19, 39);
}

html[saved-theme="light"] body a.internal-link, html[saved-theme="light"] .breadcrumb-container .breadcrumb-element > a {
  color: var(--link-color, rgb(150, 19, 39));
  outline: rgb(150, 19, 39) none 0px;
  text-decoration-color: rgb(150, 19, 39);
}

html[saved-theme="light"] body a.internal-link.broken {
  color: var(--link-unresolved-color, rgb(150, 19, 39));
  outline: rgb(150, 19, 39) none 0px;
}`,
...
html[saved-theme="light"] body ul.overflow {
  ...
  color: var(--text-faint, rgb(222, 222, 222));
}

html[saved-theme="light"] body blockquote {
  color: var(--blockquote-color, rgb(26, 32, 35));
}`,
...
html[saved-theme="light"] body a.internal-link.tag-link, html[saved-theme="light"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  --pill-color: var(--tag-color, #961327);
  --pill-color-hover: var(--tag-color-hover, #961327);
  --pill-color-remove: var(--tag-color, #961327);
  --pill-color-remove-hover: var(--tag-color-hover, #961327);
  color: var(--pill-color, rgb(150, 19, 39));
}
...
html[saved-theme="light"] body h1 {
  ...
  border-top-color: rgb(212, 147, 53);
  border-top-width: 0px;
  color: var(--text-title-h1, rgb(212, 147, 53));
  font-size: var(--h1-size, 20px);
  letter-spacing: var(--h1-letter-spacing, -0.3px);
  line-height: var(--h1-line-height, 24px);
}
...
html[saved-theme="light"] body h2 {
  ...
  border-top-color: rgb(212, 147, 53);
  border-top-width: 0px;
  color: var(--text-title-h2, rgb(212, 147, 53));
  font-size: var(--h2-size, 20px);
  letter-spacing: var(--h2-letter-spacing, -0.22px);
  line-height: var(--h2-line-height, 24px);
}
...
html[saved-theme="light"] body h3 {
  ...
  border-top-color: rgb(212, 147, 53);
  border-top-width: 0px;
  color: var(--text-title-h3, rgb(212, 147, 53));
  font-size: var(--h3-size, 20px);
  letter-spacing: var(--h3-letter-spacing, -0.16px);
  line-height: var(--h3-line-height, 24px);
}
...
html[saved-theme="light"] body h4 {
  ...
  border-top-color: rgb(212, 147, 53);
  border-top-width: 0px;
  color: var(--text-title-h4, rgb(212, 147, 53));
  font-size: var(--h4-size, 20px);
  letter-spacing: var(--h4-letter-spacing, -0.1px);
  line-height: var(--h4-line-height, 24px);
}
...
html[saved-theme="light"] body h5 {
  ...
  border-top-color: rgb(212, 147, 53);
  border-top-width: 0px;
  color: var(--text-title-h5, rgb(212, 147, 53));
  font-size: var(--h5-size, 20px);
  letter-spacing: var(--h5-letter-spacing, -0.04px);
  line-height: var(--h5-line-height, 24px);
}
...
html[saved-theme="light"] body h6 {
  ...
  border-top-color: rgb(26, 32, 35);
  border-top-width: 0px;
  color: var(--text-title-h6, rgb(26, 32, 35));
  font-size: var(--h6-size, 20px);
}
...
html[saved-theme="light"] body .explorer .nav-files-container .collapse-icon svg {
  ...
  background-color: var(--status-bar-background, rgb(196, 196, 196));
  border-bottom-color: rgb(212, 147, 53);
  border-bottom-width: 0px;
  border-left-color: rgb(212, 147, 53);
  border-left-width: 0px;
...
html[saved-theme="light"] body ul.tags > li {
  color: var(--tag-color, rgb(150, 19, 39));
}`,
  },
};
