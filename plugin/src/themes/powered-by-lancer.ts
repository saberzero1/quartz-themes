...
export const theme: ThemeData = {
  ...
  --bodyFont: var(--font-text, "Arimo", sans-serif);
  ...
  --code-normal: #e7e7e7;
  --code-size: 500;
  --codeFont: var(--font-monospace, "Anonymous-Pro-Regular", monospace);
  --collapse-icon-color: #b6ceb2;
  --collapse-icon-color-collapsed: #c76cff;
  --dark: var(--text-normal, #e7e7e7);
  --darkgray: var(--text-normal, #e7e7e7);
  ...
  --graph-text: #e7e7e7;
  --gray: var(--text-faint, #b6ceb2);
  --h1-size: 3em;
  --h2-size: 1.6em;
  --h3-size: 1.4em;
  --h4-size: 1.25em;
  --h5-size: 1.125em;
  --headerFont: var(--font-text, "Arimo", sans-serif);
  --heading-formatting: #b6ceb2;
  --highlight: var(--text-highlight-bg, #9400a1);
  --hr-color: #009200;
  --icon-color: #9aff9f;
  ...
  --light: var(--background-primary, #2b2b2b);
  --lightgray: var(--background-secondary, #126127);
  --link-color: #c76cff;
  ...
  --secondary: var(--text-accent, #c76cff);
  ...
  --tertiary: var(--text-accent-hover, #da9fff);
  --text-a: #c76cff;
  --text-a-hover: #83a598;
  --text-accent: #c76cff;
  ...
  --textHighlight: var(--text-highlight-bg, #9400a1);
  --titleFont: var(--font-text, "Arimo", sans-serif);
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --highlight: var(--text-highlight-bg, #5ea9ff);
  --hr-color: #af303d;
  --icon-color: #bebebe;
  ...
  --light: var(--background-primary, #e7e7e7);
  --lightgray: var(--background-secondary, #991e2a);
  --link-color: #234bff;
  ...
  --secondary: var(--text-accent, #234bff);
  ...
  --tertiary: var(--text-accent-hover, #8e929b);
  --text-a: #ff3e3e;
  --text-a-hover: #8a8e96;
  --text-accent: #234bff;
  ...
  --text-white: #ffffff;
  --textHighlight: var(--text-highlight-bg, #5ea9ff);
  --titleFont: var(--font-text, "Arimo", sans-serif);
