...
html[saved-theme="dark"] body a.internal-link.tag-link, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  ...
  --pill-background: var(--tag-background, rgb(165, 119, 218 0.15));
  --pill-background-hover: var(--tag-background-hover, rgb(165, 119, 218 0.25));
  --pill-border-color: var(--tag-border-color, rgb(165, 119, 218 0.15));
  --pill-border-color-hover: var(--tag-border-color-hover, rgb(165, 119, 218 0.25));
