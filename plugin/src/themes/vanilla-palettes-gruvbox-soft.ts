...
export const theme: ThemeData = {
  ...
  --background-modifier-border: #665c54 !important;
  --background-modifier-border-focus: #7c6f64 !important;
  --background-modifier-border-hover: #7c6f64 !important;
  ...
  --background-primary: #32302f !important;
  --background-secondary: #3c3836 !important;
  --bases-cards-background: #32302f !important;
  --bases-cards-shadow: 0 0 0 1px #665c54 !important;
  --bases-cards-shadow-hover: 0 0 0 1px #7c6f64 !important;
  --bases-embed-border-color: #665c54 !important;
  --bases-group-heading-property-color: #ebdbb2 !important;
  --bases-table-border-color: #665c54 !important;
  --bases-table-cell-background-active: #32302f !important;
  ...
  --bases-table-header-background: #32302f !important;
  --bases-table-header-background-hover: #665c54 !important;
  --bases-table-header-color: #ebdbb2 !important;
  --bases-table-summary-background: #32302f !important;
  ...
  --border-color-primary: #665c54 !important;
  --border-color-secondary: #7c6f64 !important;
  ...
  --collapse-icon-color: #7c6f64 !important;
  ...
  --file-header-background: #32302f !important;
  --file-header-background-focused: #32302f !important;
  --flair-background: #3c3836 !important;
  --flair-color: #ebdbb2 !important;
  --footnote-divider-color: #665c54 !important;
  --footnote-id-color: #ebdbb2 !important;
  --footnote-id-color-no-occurrences: #7c6f64 !important;
  --footnote-input-background-active: #665c54 !important;
  --graph-line: #7c6f64 !important;
  ...
  --heading-formatting: #7c6f64 !important;
  --highlight: hsl(60, 71%, 35%) !important;
  --hr-color: #665c54 !important;
  ...
  --indentation-guide-color: #665c54 !important;
  --indentation-guide-color-active: #7c6f64 !important;
  --inline-title-color: #ebdbb2 !important;
  --input-date-separator: #7c6f64 !important;
  --input-placeholder-color: #7c6f64 !important;
  ...
  --menu-background: #3c3836 !important;
  --menu-border-color: #7c6f64 !important;
  --metadata-border-color: #665c54 !important;
  --metadata-divider-color: #665c54 !important;
  ...
  --metadata-property-box-shadow-hover: 0 0 0 1px #7c6f64 !important;
  --modal-background: #3c3836 !important;
  --modal-border-color: #665c54 !important;
  --nav-collapse-icon-color: #7c6f64 !important;
  --nav-collapse-icon-color-collapsed: #7c6f64 !important;
  --nav-heading-color: #ebdbb2 !important;
  --nav-heading-color-collapsed: #7c6f64 !important;
  --nav-heading-color-collapsed-hover: #ebdbb2 !important;
  --nav-heading-color-hover: #ebdbb2 !important;
  --nav-indentation-guide-color: #7c6f64 !important;
  ...
  --nav-tag-color: #7c6f64 !important;
  ...
  --pdf-background: #32302f !important;
  --pdf-page-background: #32302f !important;
  --pdf-shadow: 0 0 0 1px #665c54 !important;
  --pdf-sidebar-background: #32302f !important;
  --pdf-thumbnail-shadow: 0 0 0 1px #665c54 !important;
  --pill-border-color: #665c54 !important;
  --pill-border-color-hover: #7c6f64 !important;
  --pill-color: #ebdbb2 !important;
  --pill-color-hover: #ebdbb2 !important;
  --pill-color-remove: #7c6f64 !important;
  --pill-color-remove-hover: hsl(60, 71%, 35%) !important;
  --prompt-background: #32302f !important;
  --prompt-border-color: #665c54 !important;
  ...
  --ribbon-background: #3c3836 !important;
  --ribbon-background-collapsed: #32302f !important;
  --search-clear-button-color: #ebdbb2 !important;
  --search-icon-color: #ebdbb2 !important;
  --search-result-background: #32302f !important;
  ...
  --setting-items-border-color: #665c54 !important;
  --shiki-active-tab-border-color: #ebdbb2 !important;
  --shiki-code-background: #3c3836 !important;
  --shiki-code-comment: #7c6f64 !important;
  ...
  --shiki-gutter-border-color: #665c54 !important;
  --shiki-gutter-text-color: #7c6f64 !important;
  --shiki-gutter-text-color-highlight: #ebdbb2 !important;
  --shiki-highlight-neutral: #ebdbb2 !important;
  --shiki-terminal-dots-color: #7c6f64 !important;
  --slider-track-background: #3c3836 !important;
  --status-bar-background: #3c3836 !important;
  --status-bar-border-color: #665c54 !important;
  --status-bar-text-color: #ebdbb2 !important;
  --suggestion-background: #32302f !important;
  ...
  --tab-background-active: #32302f !important;
  --tab-container-background: #3c3836 !important;
  --tab-divider-color: #665c54 !important;
  --tab-outline-color: #665c54 !important;
  --tab-switcher-background: #3c3836 !important;
  --tab-switcher-menubar-background: linear-gradient(to top, #3c3836, transparent) !important;
  ...
  --table-add-button-border-color: #665c54 !important;
  --table-border-color: #665c54 !important;
  ...
  --text-color-muted-dark: #665c54 !important;
  --text-color-muted-light: #7c6f64 !important;
  --text-error: #cc241d !important;
  --text-faint: #7c6f64 !important;
  --text-highlight-bg: hsl(60, 71%, 35%) !important;
  --text-muted: #ebdbb2 !important;
  --text-normal: #ebdbb2 !important;
  --text-on-accent-inverted: #32302f !important;
  ...
  --titlebar-background: #3c3836 !important;
  --titlebar-background-focused: #665c54 !important;
  --titlebar-border-color: #665c54 !important;
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --background-modifier-border-focus: #a89984 !important;
  --background-modifier-border-hover: #a89984 !important;
  --background-modifier-error: #cc241d !important;
  --background-modifier-error-hover: #cc241d !important;
  --background-modifier-form-field: #ebdbb2 !important;
  --background-modifier-form-field-hover: #ebdbb2 !important;
  --background-modifier-hover: #bdae93 !important;
  --background-modifier-success: #98971a !important;
  --background-primary: #f2e5bc !important;
  --background-secondary: #ebdbb2 !important;
  --bases-cards-background: #f2e5bc !important;
  ...
  --bases-table-cell-background-active: #f2e5bc !important;
  --bases-table-cell-background-selected: #bdae93 !important;
  --bases-table-cell-shadow-active: 0 0 0 2px #a89984 !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(60, 71%, 35%) !important;
  --bases-table-header-background: #f2e5bc !important;
  --bases-table-header-background-hover: #bdae93 !important;
  --bases-table-header-color: #3c3836 !important;
  --bases-table-summary-background: #f2e5bc !important;
  --bases-table-summary-background-hover: #bdae93 !important;
  --blockquote-border-color: #98971a !important;
  --blur-background: color-mix(in srgb, #f2e5bc 65%, transparent) linear-gradient(#f2e5bc, color-mix(in srgb, #f2e5bc 65%, transparent)) !important;
  --bold-color: #d79921 !important;
  --border-color: #bdae93 !important;
  --border-color-primary: #bdae93 !important;
  --border-color-secondary: #a89984 !important;
  --bright-aqua: #8ec07c !important;
  --bright-blue: #83a598 !important;
  --bright-green: #b8bb26 !important;
  --bright-orange: #fe8019 !important;
  ...
  --bright-red: #fb4934 !important;
  --bright-yellow: #fabd2f !important;
  --canvas-background: #f2e5bc !important;
  --canvas-card-label-color: #a89984 !important;
  --canvas-color: 152, 151, 26 !important;
  --caret-color: #3c3836 !important;
  --checkbox-border-color: #a89984 !important;
  --checkbox-border-color-hover: #b8bb26 !important;
  --checkbox-color: #98971a !important;
  --checkbox-color-hover: #b8bb26 !important;
  --checkbox-marker-color: #f2e5bc !important;
  --checklist-done-color: #a89984 !important;
  --code-background: #ebdbb2 !important;
  ...
  --collapse-icon-color: #a89984 !important;
  --collapse-icon-color-collapsed: hsl(60, 71%, 35%) !important;
  --color-accent: hsl(60, 71%, 35%) !important;
  ...
  --divider-color-hover: hsl(60, 71%, 35%) !important;
  --dropdown-background: #ebdbb2 !important;
  --dropdown-background-hover: #bdae93 !important;
  --embed-block-shadow-hover: 0 0 0 1px #bdae93, inset 0 0 0 1px #bdae93 !important;
  --embed-border-start: 2px solid hsl(60, 71%, 35%) !important;
  --faded-aqua: #427b58 !important;
  --faded-blue: #076678 !important;
  --faded-green: #79740e !important;
  ...
  --faded-red: #9d0006 !important;
  --faded-yellow: #b57614 !important;
  --file-header-background: #f2e5bc !important;
  --file-header-background-focused: #f2e5bc !important;
  --flair-background: #ebdbb2 !important;
  --flair-color: #3c3836 !important;
  --footnote-divider-color: #bdae93 !important;
  --footnote-id-color: #3c3836 !important;
  --footnote-id-color-no-occurrences: #a89984 !important;
  --footnote-input-background-active: #bdae93 !important;
  --graph-line: #a89984 !important;
  --graph-node: hsl(60, 71%, 35%) !important;
  --graph-node-attachment: #98971a !important;
  --graph-node-focused: #b8bb26 !important;
  --graph-node-tag: #d79921 !important;
  ...
  --h5-color: #d65d0e !important;
  --h6-color: #cc241d !important;
  --heading-formatting: #a89984 !important;
  --highlight: hsl(60, 71%, 35%) !important;
  ...
  --indentation-guide-color: #bdae93 !important;
  --indentation-guide-color-active: #a89984 !important;
  --inline-title-color: #3c3836 !important;
  --input-date-separator: #a89984 !important;
  --input-placeholder-color: #a89984 !important;
  --interactive-accent: hsl(60, 71%, 35%) !important;
  --interactive-accent-hover: hsl(57, 72.42%, 40.25%) !important;
  --interactive-accent-hsl: 60, 71%, 35% !important;
  --interactive-hover: #bdae93 !important;
  --interactive-normal: #ebdbb2 !important;
  --italic-color: #d79921 !important;
  --light: #f2e5bc !important;
  --light-aqua: #e8e5b5 !important;
  --light-aqua-hard: #e6e9c1 !important;
  --light-aqua-soft: #e1dbac !important;
  --light-green: #d5d39b !important;
  ...
  --metadata-property-box-shadow-focus: 0 0 0 2px #a89984 !important;
  --metadata-property-box-shadow-hover: 0 0 0 1px #a89984 !important;
  --modal-background: #ebdbb2 !important;
  --modal-border-color: #bdae93 !important;
  --nav-collapse-icon-color: #a89984 !important;
  --nav-collapse-icon-color-collapsed: #a89984 !important;
  --nav-heading-color: #3c3836 !important;
  --nav-heading-color-collapsed: #a89984 !important;
  --nav-heading-color-collapsed-hover: #3c3836 !important;
  --nav-heading-color-hover: #3c3836 !important;
  --nav-indentation-guide-color: #a89984 !important;
  --nav-item-background-active: #98971a !important;
  ...
  --nav-item-color-hover: white !important;
  --nav-item-color-selected: red !important;
  --nav-tag-color: #a89984 !important;
  ...
  --neutral-red: #cc241d !important;
  --neutral-yellow: #d79921 !important;
  --pdf-background: #f2e5bc !important;
  --pdf-page-background: #f2e5bc !important;
  --pdf-sidebar-background: #f2e5bc !important;
  ...
  --pill-color-remove: #a89984 !important;
  --pill-color-remove-hover: hsl(60, 71%, 35%) !important;
  --prompt-background: #f2e5bc !important;
  --prompt-border-color: #bdae93 !important;
  --raised-background: color-mix(in srgb, #f2e5bc 65%, transparent) linear-gradient(#f2e5bc, color-mix(in srgb, #f2e5bc 65%, transparent)) !important;
  --ribbon-background: #ebdbb2 !important;
  --ribbon-background-collapsed: #f2e5bc !important;
  --search-clear-button-color: #3c3836 !important;
  --search-icon-color: #3c3836 !important;
  --search-result-background: #f2e5bc !important;
  --secondary: hsl(60, 71%, 35%) !important;
  ...
  --shiki-code-background: #ebdbb2 !important;
  --shiki-code-comment: #a89984 !important;
  --shiki-code-function: #98971a !important;
  --shiki-code-important: #d65d0e !important;
  --shiki-code-keyword: pink !important;
  ...
  --sync-avatar-color-7: #b16286 !important;
  --sync-avatar-color-8: pink !important;
  --tab-background-active: #f2e5bc !important;
  ...
  --table-selection-border-color: #b8bb26 !important;
  --tag-background: #bdae93 !important;
  --tag-background-hover: #a89984 !important;
  --tag-border-color: hsla(60, 71%, 35%, 0.15) !important;
  --tag-border-color-hover: hsla(60, 71%, 35%, 0.15) !important;
  --tag-color: #98971a !important;
  --tag-color-hover: #98971a !important;
  ...
  --text-color-accent: white !important;
  --text-color-muted-dark: #bdae93 !important;
  --text-color-muted-light: #a89984 !important;
  --text-error: #cc241d !important;
  --text-faint: #a89984 !important;
  --text-highlight-bg: hsl(60, 71%, 35%) !important;
  --text-muted: #3c3836 !important;
  --text-normal: #3c3836 !important;
  --text-on-accent-inverted: #f2e5bc !important;
  --text-selection: #bdae93 !important;
  --text-success: #98971a !important;
  --text-warning: #d79921 !important;
  --textHighlight: hsl(60, 71%, 35%) !important;
  --titlebar-background: #ebdbb2 !important;
  --titlebar-background-focused: #bdae93 !important;
