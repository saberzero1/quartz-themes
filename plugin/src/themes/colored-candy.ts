...
export const theme: ThemeData = {
  ...
  --shiki-active-tab-border-color: hsl(258, 15%, 68%) !important;
  --shiki-code-background: hsl(258, 35%, 27%) !important;
  --shiki-code-block-border-radius: 20px !important;
  --shiki-code-comment: hsl(258, 20%, 51%) !important;
  --shiki-code-normal: hsl(258, 15%, 68%) !important;
  --shiki-code-punctuation: hsl(258, 15%, 68%) !important;
  --shiki-gutter-border-color: hsl(258, 25%, 15%) !important;
  --shiki-gutter-text-color: hsl(258, 20%, 51%) !important;
  --shiki-gutter-text-color-highlight: hsl(258, 15%, 68%) !important;
  --shiki-highlight-neutral: hsl(258, 15%, 68%) !important;
  --shiki-terminal-dots-color: hsl(258, 20%, 51%) !important;
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --setting-items-radius: 20px !important;
  --shiki-active-tab-border-color: hsl(258, 15%, 33%) !important;
  --shiki-code-background: hsl(258, 35%, 70%) !important;
  --shiki-code-block-border-radius: 20px !important;
  --shiki-code-comment: hsl(258, 20%, 47%) !important;
  --shiki-code-normal: hsl(258, 15%, 33%) !important;
  --shiki-code-punctuation: hsl(258, 15%, 33%) !important;
  --shiki-gutter-border-color: hsl(258, 25%, 90%) !important;
  --shiki-gutter-text-color: hsl(258, 20%, 47%) !important;
  --shiki-gutter-text-color-highlight: hsl(258, 15%, 33%) !important;
  --shiki-highlight-neutral: hsl(258, 15%, 33%) !important;
  --shiki-terminal-dots-color: hsl(258, 20%, 47%) !important;
