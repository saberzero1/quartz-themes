...
export const theme: ThemeData = {
  ...
  --table-hover-highlight-color: rgba(83, 112, 159, 0.15);
  --table-selection: hsla(24.4, 90.8%, 61.8%, 0.1);
  --table-selection-border-color: rgb(83, 112, 159);
  --table-sticky-height: 600px;
  --tag-background: rgba(83, 112, 159, 0.15);
  --tag-background-hover: rgba(83, 112, 159, 0.25);
  --tag-border-color: rgba(83, 112, 159, 0.15);
  --tag-border-color-hover: rgba(83, 112, 159, 0.25);
