...
export const theme: ThemeData = {
  ...
  --link-external-color: var(--text-accent, #5980f7);
  --link-external-color-hover: var(--text-accent-hover, #8aa5f9);
  --link-unresolved-color: var(--text-accent, #5980f7);
...
html[saved-theme="dark"] body .markdown-rendered p > strong, html[saved-theme="dark"] strong {
  ...
  color: var(--link-external-color, rgb(89, 128, 247));
  outline: rgb(89, 128, 247) none 0px;
  text-decoration-color: rgb(89, 128, 247);
}

html[saved-theme="dark"] body a.internal-link, html[saved-theme="dark"] .breadcrumb-container .breadcrumb-element > a {
  color: var(--link-color, rgb(89, 128, 247));
  outline: rgb(89, 128, 247) none 0px;
  text-decoration-color: rgb(89, 128, 247);
}

html[saved-theme="dark"] body a.internal-link.broken {
  color: var(--link-unresolved-color, rgb(89, 128, 247));
  outline: rgb(89, 128, 247) none 0px;
}`,
...
html[saved-theme="dark"] body .bases-table thead th {
  ...
  --link-color-hover: var(--text-accent-hover, #5C7BF5);
  --link-external-color: var(--text-accent, #2C54F2);
  --link-external-color-hover: var(--text-accent-hover, #5C7BF5);
  --link-unresolved-color: var(--text-accent, #2C54F2);
  ...
  --table-column-alt-background: var(--table-background, #ffffff);
  --table-header-background: var(--table-background, #ffffff);
  --table-header-border-color: var(--table-border-color, #222222);
  --table-row-alt-background: var(--table-background, #ffffff);
  --table-row-alt-background-hover: var(--table-background, #ffffff);
  --table-row-background-hover: var(--table-background, #ffffff);
...
html[saved-theme="light"] body .page > div#quartz-body div.sidebar {
  background-color: var(--background-secondary, rgb(250, 250, 250));
}
...
html[saved-theme="light"] body .markdown-rendered p > strong, html[saved-theme="light"] strong {
  ...
  color: var(--link-external-color, rgb(44, 84, 242));
  outline: rgb(44, 84, 242) none 0px;
  text-decoration-color: rgb(44, 84, 242);
}

html[saved-theme="light"] body a.internal-link, html[saved-theme="light"] .breadcrumb-container .breadcrumb-element > a {
  color: var(--link-color, rgb(44, 84, 242));
  outline: rgb(44, 84, 242) none 0px;
  text-decoration-color: rgb(44, 84, 242);
}

html[saved-theme="light"] body a.internal-link.broken {
  color: var(--link-unresolved-color, rgb(44, 84, 242));
  outline: rgb(44, 84, 242) none 0px;
}`,
...
html[saved-theme="light"] body tbody tr:nth-child(even) {
  background-color: var(--table-background, rgb(255, 255, 255));
}

html[saved-theme="light"] body tbody tr:nth-child(odd) {
  background-color: var(--table-row-alt-background, rgb(255, 255, 255));
}
...
html[saved-theme="light"] body tr {
  background-color: var(--table-header-background, rgb(255, 255, 255));
}`,
