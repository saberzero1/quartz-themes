...
export const theme: ThemeData = {
  ...
  --collapse-icon-color-collapsed: hsl(0, 0%, 100%) !important;
  ...
  --graph-node-focused: hsl(0, 0%, 100%) !important;
  --graph-node-tag: hsl(0, 0%, 100%) !important;
  ...
  --icon-color-active: hsl(0, 0%, 100%) !important;
  ...
  --link-external-color: hsl(0, 0%, 100%) !important;
  ...
  --list-marker-color-collapsed: hsl(0, 0%, 100%) !important;
  ...
  --pill-color-remove-hover: hsl(0, 0%, 100%) !important;
  ...
  --scrollbar-active-thumb-bg: hsl(0, 0%, 100%) !important;
  ...
  --secondary: hsl(0, 0%, 100%) !important;
  ...
  --tab-text-color-focused-highlighted: hsl(0, 0%, 100%) !important;
  ...
  --tag-color-hover: hsl(0, 0%, 100%) !important;
  --tertiary: hsl(
        258 calc(88% + 180) 66%
    ) !important;
  --text-accent: hsl(0, 0%, 100%) !important;
  ...
  --text-selection: hsla(0, 0%, 100%, 0.33) !important;
