...
export const theme: ThemeData = {
  ...
  --collapse-icon-color-collapsed: var(--color-accent, hsl(0, 0%, 100%));
  --color-accent: var(--color-accent, hsl(0, 0%, 100%));
  ...
  --graph-node-focused: var(--color-accent, hsl(0, 0%, 100%));
  --graph-node-tag: var(--color-accent, hsl(0, 0%, 100%));
  ...
  --icon-color-active: var(--color-accent, hsl(0, 0%, 100%));
  ...
  --link-external-color: var(--color-accent, hsl(0, 0%, 100%));
  ...
  --list-marker-color-collapsed: var(--color-accent, hsl(0, 0%, 100%));
  ...
  --pill-color-remove-hover: var(--text-accent, hsl(0, 0%, 100%));
  ...
  --scrollbar-active-thumb-bg: var(--color-accent, hsl(0, 0%, 100%));
  ...
  --secondary: var(--text-accent, var(--color-accent, hsl(0, 0%, 100%)));
  ...
  --tab-text-color-focused-highlighted: var(--color-accent, hsl(0, 0%, 100%));
  ...
  --tag-color: var(--color-accent, hsl(0, 0%, 100%));
  --tag-color-hover: var(--color-accent, hsl(0, 0%, 100%));
  --tertiary: var(--text-accent-hover, var(--color-accent-2, hsl(
        258 calc(88% + 180) 66%
    )));
  --text-accent: var(--color-accent, hsl(0, 0%, 100%));
  ...
  --text-selection: var(--background-modifier-border, hsla(0, 0%, 100%, 0.33));
...
html[saved-theme="dark"] body li.task-list-item input[type="checkbox"]:checked {
  background-color: var(--color-accent, rgb(255, 255, 255));
...
html[saved-theme="dark"] body a.internal-link, html[saved-theme="dark"] .breadcrumb-container .breadcrumb-element > a {
  ...
  color: var(--color-accent, rgb(255, 255, 255));
  font-family: "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
...
html[saved-theme="dark"] body .callout-title {
  ...
  --collapse-icon-color-collapsed: hsl(0, 0%, 100%);
  ...
  --graph-node-focused: hsl(0, 0%, 100%);
  --graph-node-tag: hsl(0, 0%, 100%);
  ...
  --link-external-color: hsl(0, 0%, 100%);
  ...
  --scrollbar-active-thumb-bg: hsl(0, 0%, 100%);
  ...
  --tab-text-color-focused-highlighted: hsl(0, 0%, 100%);
  ...
  --tag-color: hsl(0, 0%, 100%);
  --tag-color-hover: hsl(0, 0%, 100%);
  --tag-size: 0.875em;
  ...
  --text-selection: hsla(0, 0%, 100%, 0.33);
  --text-success: #44cf6e;
  --text-warning: #e9973f;
  --touch-radius-l: 52px;
  --touch-radius-m: 44px;
...
html[saved-theme="dark"] body a.internal-link.tag-link, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  ...
  --pill-color: var(--tag-color, hsl(0, 0%, 100%));
  --pill-color-hover: var(--tag-color-hover, hsl(0, 0%, 100%));
  --pill-color-remove: var(--tag-color, hsl(0, 0%, 100%));
  --pill-color-remove-hover: var(--tag-color-hover, hsl(0, 0%, 100%));
  background-color: var(--pill-background, rgba(0, 0, 0, 0));
  border-bottom-color: color(srgb 1 1 1 / 0.4);
  border-bottom-left-radius: 8px;
  border-bottom-right-radius: 8px;
  border-bottom-width: 1px;
  border-left-color: color(srgb 1 1 1 / 0.4);
  border-left-width: 1px;
  border-right-color: color(srgb 1 1 1 / 0.4);
  border-right-width: 1px;
  border-top-color: color(srgb 1 1 1 / 0.4);
  border-top-left-radius: 8px;
  border-top-right-radius: 8px;
  border-top-width: 1px;
  color: var(--text-normal, rgb(186, 186, 186));
...
html[saved-theme="dark"] body h2::after {
  --font-weight: var(--h2-weight, 600);
  background: rgba(0, 0, 0, 0) linear-gradient(90deg, rgb(255, 255, 255) 0%, color(srgb 1 1 1 / 0.2) 60%, rgba(0, 0, 0, 0) 100%) repeat scroll 0% 0% / auto padding-box border-box;
  background-color: rgba(0, 0, 0, 0);
  background-image: linear-gradient(90deg, rgb(255, 255, 255) 0%, color(srgb 1 1 1 / 0.2) 60%, rgba(0, 0, 0, 0) 100%);
  border-bottom-color: rgb(255, 255, 255);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
  border-bottom-width: 0px;
...
html[saved-theme="dark"] body kbd {
  background-color: var(--code-background, color(srgb 1 1 1 / 0.7));
  border-bottom-color: rgb(255, 255, 255);
  border-left-color: rgb(255, 255, 255);
  border-right-color: rgb(255, 255, 255);
  border-top-color: rgb(255, 255, 255);
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  border-bottom-color: color(srgb 1 1 1 / 0.3);
  border-bottom-left-radius: 8px;
  border-bottom-right-radius: 8px;
  border-bottom-width: 1px;
  border-left-color: color(srgb 1 1 1 / 0.3);
  border-left-width: 1px;
  border-right-color: color(srgb 1 1 1 / 0.3);
  border-right-width: 1px;
  border-top-color: color(srgb 1 1 1 / 0.3);
  border-top-left-radius: 8px;
  border-top-right-radius: 8px;
  border-top-width: 1px;
  color: var(--color-accent, rgb(255, 255, 255));
