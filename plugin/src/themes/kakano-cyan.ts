...
html[saved-theme="dark"] body pre > code > [data-line] {
  border-left-color: color(srgb 0.628 0.6052 0.172);
}
...
html[saved-theme="dark"] body pre > code [data-highlighted-chars] {
  border-bottom-color: color(srgb 0.628 0.6052 0.172);
  border-left-color: color(srgb 0.628 0.6052 0.172);
  border-right-color: color(srgb 0.628 0.6052 0.172);
  border-top-color: color(srgb 0.628 0.6052 0.172);
}
...
html[saved-theme="dark"] body ::-webkit-scrollbar {
  background: color(srgb 0.0086 0.0314 0.0295) none repeat scroll 0% 0% / auto padding-box border-box;
  background-color: color(srgb 0.0086 0.0314 0.0295);
}
