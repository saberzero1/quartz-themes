...
export const theme: ThemeData = {
  ...
  --background-modifier-error: hsl(from hsl(175, 57%, 40%) 356 s l) !important;
  --background-modifier-error-hover: hsl(from hsl(175, 57%, 40%) 356 s l) !important;
  --background-modifier-hover: hsl(175, 57%, 40%) !important;
  --background-modifier-message: color-mix(
    in srgb,
    hsl(175, 57%, 40%),
    white 95%
  ) !important;
  --background-modifier-success: hsl(from hsl(175, 57%, 40%) 124 s l) !important;
  ...
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(175, 57%, 40%) !important;
  ...
  --bases-table-header-background-hover: hsl(175, 57%, 40%) !important;
  ...
  --bases-table-summary-background-hover: hsl(175, 57%, 40%) !important;
  ...
  --checkbox-border-color: hsl(175, 57%, 40%) !important;
  --checkbox-border-color-hover: hsl(255, 89.76%, 75.9%) !important;
  --checkbox-color: hsl(175, 57%, 40%) !important;
  ...
  --code-bracket-background: hsl(175, 57%, 40%) !important;
  --code-comment: light-dark(
    hsl(from black h s l / 0.5),
    hsl(from white h s l / 0.5)
  ) !important;
  --code-function: hsl(from hsl(175, 57%, 40%) 57 s l) !important;
  --code-important: hsl(from hsl(175, 57%, 40%) 27 s l) !important;
  --code-keyword: hsl(from hsl(175, 57%, 40%) 331 s l) !important;
  --code-normal: color-mix(
    in srgb,
    hsl(175, 57%, 40%),
    white 60%
  ) !important;
  --code-operator: hsl(from hsl(175, 57%, 40%) 356 s l) !important;
  --code-property: hsl(from hsl(175, 57%, 40%) 179 s l) !important;
  ...
  --code-string: hsl(from hsl(175, 57%, 40%) 124 s l) !important;
  --code-tag: hsl(from hsl(175, 57%, 40%) 356 s l) !important;
  --code-value: hsl(from hsl(175, 57%, 40%) 253 s l) !important;
  ...
  --collapse-icon-color: hsl(175, 57%, 40%) !important;
  --collapse-icon-color-collapsed: hsl(175, 57%, 40%) !important;
  --color-blue: hsl(from hsl(175, 57%, 40%) 219 s l) !important;
  --color-cyan: hsl(from hsl(175, 57%, 40%) 179 s l) !important;
  --color-green: hsl(from hsl(175, 57%, 40%) 124 s l) !important;
  --color-orange: hsl(from hsl(175, 57%, 40%) 27 s l) !important;
  --color-pink: hsl(from hsl(175, 57%, 40%) 331 s l) !important;
  --color-purple: hsl(from hsl(175, 57%, 40%) 253 s l) !important;
  --color-red: hsl(from hsl(175, 57%, 40%) 356 s l) !important;
  --color-yellow: hsl(from hsl(175, 57%, 40%) 57 s l) !important;
  --dark: color-mix(
    in srgb,
    hsl(175, 57%, 40%),
    white 60%
  ...
  --divider-color-hover: hsl(175, 57%, 40%) !important;
  ...
  --flair-background: hsl(175, 57%, 40%) !important;
  ...
  --graph-node-attachment: hsl(from hsl(175, 57%, 40%) 57 s l) !important;
  --graph-node-tag: hsl(from hsl(175, 57%, 40%) 124 s l) !important;
  ...
  --highlight: hsl(175, 57%, 40%) !important;
  --hr-color: color-mix(
    in srgb,
    hsl(175, 57%, 40%),
    black 25%
  ) !important;
  --icon-color: hsl(175, 57%, 40%) !important;
  ...
  --interactive-accent: hsl(175, 57%, 40%) !important;
  --light: color-mix(
    in srgb,
    hsl(175, 57%, 40%),
    black 95%
  ...
  --metadata-property-background-active: hsl(175, 57%, 40%) !important;
  ...
  --nav-item-background-active: hsl(175, 57%, 40%) !important;
  ...
  --pill-background-hover: hsl(175, 57%, 40%) !important;
  ...
  --search-clear-button-color: hsl(175, 57%, 40%) !important;
  --search-icon-color: hsl(175, 57%, 40%) !important;
  --search-result-background: color-mix(
    in srgb,
    hsl(175, 57%, 40%),
    black 95%
  ) !important;
  --secondary: hsl(175, 57%, 40%) !important;
  ...
  --shiki-code-function: hsl(from hsl(175, 57%, 40%) 124 s l) !important;
  --shiki-code-important: hsl(from hsl(175, 57%, 40%) 27 s l) !important;
  --shiki-code-keyword: hsl(from hsl(175, 57%, 40%) 331 s l) !important;
  --shiki-code-normal: color-mix(in srgb, color-mix(
    in srgb,
    hsl(175, 57%, 40%),
    white 60%
  ), transparent 30%) !important;
  --shiki-code-property: hsl(from hsl(175, 57%, 40%) 179 s l) !important;
  --shiki-code-punctuation: color-mix(in srgb, color-mix(
    in srgb,
    hsl(175, 57%, 40%),
    white 60%
  ), transparent 30%) !important;
  --shiki-code-string: hsl(from hsl(175, 57%, 40%) 57 s l) !important;
  --shiki-code-value: hsl(from hsl(175, 57%, 40%) 253 s l) !important;
  ...
  --sync-avatar-color-1: hsl(from hsl(175, 57%, 40%) 356 s l) !important;
  --sync-avatar-color-2: hsl(from hsl(175, 57%, 40%) 27 s l) !important;
  --sync-avatar-color-3: hsl(from hsl(175, 57%, 40%) 57 s l) !important;
  --sync-avatar-color-4: hsl(from hsl(175, 57%, 40%) 124 s l) !important;
  --sync-avatar-color-5: hsl(from hsl(175, 57%, 40%) 179 s l) !important;
  --sync-avatar-color-6: hsl(from hsl(175, 57%, 40%) 219 s l) !important;
  --sync-avatar-color-7: hsl(from hsl(175, 57%, 40%) 253 s l) !important;
  --sync-avatar-color-8: hsl(from hsl(175, 57%, 40%) 331 s l) !important;
  ...
  --tab-text-color-focused-highlighted: hsl(175, 57%, 40%) !important;
  ...
  --table-drag-handle-background-active: hsl(175, 57%, 40%) !important;
  ...
  --table-selection-border-color: hsl(175, 57%, 40%) !important;
  ...
  --text-error: hsl(from hsl(175, 57%, 40%) 356 s l) !important;
  ...
  --text-success: hsl(from hsl(175, 57%, 40%) 124 s l) !important;
  --text-warning: hsl(from hsl(175, 57%, 40%) 27 s l) !important;
  --textHighlight: hsl(175, 57%, 40%) !important;
  ...
  --theme-color-base: hsl(175, 57%, 40%) !important;
  ...
  --theme-color-cardBgHover: hsl(175, 57%, 40%) !important;
  ...
  --theme-color-communityItemBgActive: hsl(175, 57%, 40%) !important;
  ...
  --theme-color-contentItemBgActive: hsl(175, 57%, 40%) !important;
  ...
  --theme-color-controlBgActive: hsl(175, 57%, 40%) !important;
  ...
  --theme-color-greenTransparent25: hsl(from hsl(from hsl(175, 57%, 40%) 124 s l) h s l / 0.25) !important;
  --theme-color-greenTransparent75: hsl(from hsl(from hsl(175, 57%, 40%) 124 s l) h s l / 0.75) !important;
  --theme-color-hotkey: hsl(175, 57%, 40%) !important;
  --theme-color-inputBorder: color-mix(
    in srgb,
    hsl(175, 57%, 40%),
    white 25%
  ) !important;
  --theme-color-inputPlaceholder: hsl(175, 57%, 40%) !important;
  ...
  --theme-color-jiraIssueDangerBg: hsl(from hsl(from hsl(175, 57%, 40%) 356 s l) h s l / 0.25) !important;
  --theme-color-jiraIssueDeleteBg: hsl(from hsl(175, 57%, 40%) 356 s l) !important;
  ...
  --theme-color-navigationButtonBgHover: hsl(175, 57%, 40%) !important;
  ...
  --theme-color-orangeTransparent25: hsl(from hsl(from hsl(175, 57%, 40%) 27 s l) h s l / 0.25) !important;
  --theme-color-orangeTransparent75: hsl(from hsl(from hsl(175, 57%, 40%) 27 s l) h s l / 0.75) !important;
  ...
  --theme-color-redTransparent25: hsl(from hsl(from hsl(175, 57%, 40%) 356 s l) h s l / 0.25) !important;
  --theme-color-redTransparent75: hsl(from hsl(from hsl(175, 57%, 40%) 356 s l) h s l / 0.75) !important;
  ...
  --theme-color-switcherBgActive: hsl(175, 57%, 40%) !important;
  ...
  --theme-color-textMeta: hsl(175, 57%, 40%) !important;
  ...
  --theme-color-yellowTransparent25: hsl(from hsl(from hsl(175, 57%, 40%) 57 s l) h s l / 0.25) !important;
  --theme-color-yellowTransparent75: hsl(from hsl(from hsl(175, 57%, 40%) 57 s l) h s l / 0.75) !important;
...
html[saved-theme="dark"] body p {
  ...
  padding-right: 0px;
  padding-top: 0px;
  scrollbar-color: color(srgb 0.172 0.628 0.59 / 0.25) rgba(0, 0, 0, 0);
...
html[saved-theme="dark"] body ul.overflow {
  ...
  color: color(srgb 0.379 0.721 0.6925);
}
...
html[saved-theme="dark"] body .search > .search-container > .search-space {
  background-color: color(srgb 0.0344 0.1256 0.118);
  ...
  border-top-width: 0px;
  box-shadow: color(srgb 0.0172 0.0628 0.059 / 0.02) 0px 0px 3.2px 0px, color(srgb 0.0172 0.0628 0.059 / 0.04) 0px 3.2px 6.4px 0px, color(srgb 0.0172 0.0628 0.059 / 0.06) 0px 6.4px 19.2px 0px, color(srgb 0.0172 0.0628 0.059 / 0.08) 0px 19.2px 32px 0px, color(srgb 0.0172 0.0628 0.059 / 0.1) 0px 32px 64px 0px;
}
...
html[saved-theme="dark"] body li.depth-0 {
  ...
  background-color: color(srgb 0.0688 0.2512 0.236);
  border-bottom-color: color(srgb 0.6688 0.8512 0.836);
  border-left-color: color(srgb 0.6688 0.8512 0.836);
  border-left-width: 0px;
  border-right-color: color(srgb 0.6688 0.8512 0.836);
...
html[saved-theme="dark"] body .canvas-sidebar {
  background-color: color(srgb 0.0516 0.1884 0.177);
  border-color: color(srgb 0.6688 0.8512 0.836);
  box-shadow: rgba(7, 13, 13, 0.5) 0px 1px 2px 0px, rgba(4, 16, 15, 0.25) 0px 3.4px 6.7px 0px, rgba(6, 15, 14, 0.15) 0px 15px 30px 0px;
}`,
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --background-modifier-border-focus: hsl(175, 57%, 40%) !important;
  --background-modifier-error: hsl(from hsl(175, 57%, 40%) 356 s l) !important;
  --background-modifier-error-hover: hsl(from hsl(175, 57%, 40%) 356 s l) !important;
  --background-modifier-hover: hsl(175, 57%, 40%) !important;
  --background-modifier-message: color-mix(
  ...
  --bases-table-cell-shadow-active: 0 0 0 2px hsl(175, 57%, 40%) !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(175, 57%, 40%) !important;
  --bases-table-container-border-radius: 0.25rem !important;
  ...
  --checkbox-border-color: hsl(175, 57%, 40%) !important;
  --checkbox-border-color-hover: hsl(175, 57%, 40%) !important;
  --checkbox-color: hsl(175, 57%, 40%) !important;
  --checkbox-color-hover: hsl(175, 57%, 40%) !important;
  ...
  --interactive-accent: hsl(175, 57%, 40%) !important;
  --interactive-accent-hover: hsl(175, 57%, 40%) !important;
  ...
  --metadata-property-box-shadow-focus: 0 0 0 2px hsl(175, 57%, 40%) !important;
  --metadata-property-box-shadow-hover: none !important;
  --metadata-sidebar-input-font-size: 0.8rem !important;
  --metadata-sidebar-label-font-size: 0.8rem !important;
  --modal-background: color-mix(
  ...
  --tag-weight: 400 !important;
  --tertiary: hsl(175, 57%, 40%) !important;
  --text-error: hsl(from hsl(175, 57%, 40%) 356 s l) !important;
  --text-faint: color-mix(
    in srgb,
    hsl(175, 57%, 40%),
  ...
  --theme-color-controlContentArea: hsl(175, 57%, 40%) !important;
  --theme-color-controlContentAreaHover: color-mix(
    in srgb,
    hsl(175, 57%, 40%),
    white 80%
  ...
  --theme-color-navFileTag: hsl(175, 57%, 40%) !important;
  --theme-color-navFileTagActive: color-mix(
    in srgb,
    hsl(175, 57%, 40%),
    white 80%
  ...
  --theme-color-navFileTagBorder: hsl(175, 57%, 40%) !important;
  --theme-color-navigationButtonBgHover: hsl(175, 57%, 40%) !important;
  --theme-color-notice: color-mix(
    in srgb,
    hsl(175, 57%, 40%),
...
html[saved-theme="light"] body .search > .search-container > .search-space {
  background-color: color(srgb 0.9586 0.9814 0.9795);
  border-bottom-color: rgba(0, 0, 0, 0);
  border-bottom-width: 0px;
  border-left-color: rgba(0, 0, 0, 0);
  border-left-width: 0px;
  ...
  border-top-color: rgba(0, 0, 0, 0);
  border-top-width: 0px;
  box-shadow: color(srgb 0.129 0.471 0.4425 / 0.02) 0px 0px 3.2px 0px, color(srgb 0.129 0.471 0.4425 / 0.04) 0px 3.2px 6.4px 0px, color(srgb 0.129 0.471 0.4425 / 0.06) 0px 6.4px 19.2px 0px, color(srgb 0.129 0.471 0.4425 / 0.08) 0px 19.2px 32px 0px, color(srgb 0.129 0.471 0.4425 / 0.1) 0px 32px 64px 0px;
}
...
html[saved-theme="light"] body .search > .search-container > .search-space > .search-layout > .results-container {
  color: color(srgb 0.9586 0.9814 0.9795);
}
...
html[saved-theme="light"] body .canvas-sidebar {
  background-color: color(srgb 0.8344 0.9256 0.918);
  border-color: color(srgb 0.0172 0.0628 0.059);
  box-shadow: rgba(4, 47, 44, 0.2) 0px 1px 2px 0px, rgba(11, 40, 38, 0.15) 0px 3.4px 6.7px 0px, rgba(15, 36, 35, 0.05) 0px 15px 30px 0px;
}`,
...
html[saved-theme="light"] body kbd {
  ...
  border-top-style: solid;
  border-top-width: 1px;
  color: color(srgb 0.8344 0.9256 0.918);
  font-family: "??", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "??", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol";
  font-size: 11.2px;
  padding-bottom: 2px;
  padding-left: 6px;
