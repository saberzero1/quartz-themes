...
export const theme: ThemeData = {
  ...
  --background-primary-alt: white !important;
  --background-secondary: #ECEFF2 !important;
  --background-secondary-alt: #020F2B !important;
  --bases-cards-background: white !important;
  --bases-cards-cover-background: white !important;
  ...
  --bases-table-cell-background-disabled: white !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px #020F2B !important;
  --bases-table-group-background: white !important;
  ...
  --blockquote-border-color: #020F2B !important;
  ...
  --checkbox-color: #020F2B !important;
  ...
  --code-normal: rgba(0, 0, 0, 0.87) !important;
  --code-punctuation: rgba(0, 0, 0, 0.5) !important;
  --collapse-icon-color: #999999 !important;
  --collapse-icon-color-collapsed: #AF3541 !important;
  --dark: rgba(0, 0, 0, 0.87) !important;
  --darkgray: rgba(0, 0, 0, 0.87) !important;
  --divider-color: #ddd !important;
  --divider-color-hover: #020F2B !important;
  ...
  --graph-node-focused: #AF3541 !important;
  --graph-node-unresolved: #999999 !important;
  --graph-text: rgba(0, 0, 0, 0.87) !important;
  ...
  --icon-color-active: #AF3541 !important;
  --icon-color-focused: rgba(0, 0, 0, 0.87) !important;
  --icon-color-hover: rgba(0, 0, 0, 0.5) !important;
  --input-date-separator: #999999 !important;
  --input-placeholder-color: #999999 !important;
  --interactive-accent: #020F2B !important;
  --interactive-accent-hover: #8273e6 !important;
  --interactive-accent-rgb: #020F2B !important;
  --interactive-hover: #e9e9e9 !important;
  --interactive-normal: #f2f3f5 !important;
  --light: white !important;
  --lightgray: #ECEFF2 !important;
  --link-color: #AF3541 !important;
  --link-color-hover: #020F2B !important;
  --link-external-color: #AF3541 !important;
  --link-external-color-hover: #020F2B !important;
  --link-unresolved-color: #AF3541 !important;
  --list-marker-color: #999999 !important;
  --list-marker-color-collapsed: #AF3541 !important;
  --list-marker-color-hover: rgba(0, 0, 0, 0.5) !important;
  --menu-background: #ECEFF2 !important;
  --metadata-border-color: #ddd !important;
  --metadata-divider-color: #ddd !important;
  --metadata-input-text-color: rgba(0, 0, 0, 0.87) !important;
  ...
  --nav-heading-color: rgba(0, 0, 0, 0.87) !important;
  --nav-heading-color-collapsed: #999999 !important;
  --nav-heading-color-collapsed-hover: rgba(0, 0, 0, 0.5) !important;
  --nav-heading-color-hover: rgba(0, 0, 0, 0.87) !important;
  --nav-item-color: rgba(0, 0, 0, 0.5) !important;
  --nav-item-color-active: rgba(0, 0, 0, 0.87) !important;
  --nav-item-color-highlighted: #AF3541 !important;
  --nav-item-color-hover: rgba(0, 0, 0, 0.87) !important;
  --nav-item-color-selected: rgba(0, 0, 0, 0.87) !important;
  ...
  --pill-color-hover: rgba(0, 0, 0, 0.87) !important;
  --pill-color-remove: #999999 !important;
  --pill-color-remove-hover: #AF3541 !important;
  ...
  --ribbon-background: #ECEFF2 !important;
  ...
  --secondary: #AF3541 !important;
  --setting-group-heading-color: rgba(0, 0, 0, 0.87) !important;
  --setting-items-background: white !important;
  --setting-items-border-color: #ddd !important;
  --shiki-active-tab-border-color: rgba(0, 0, 0, 0.5) !important;
  --shiki-code-background: white !important;
  ...
  --status-bar-background: #ECEFF2 !important;
  ...
  --tab-container-background: #ECEFF2 !important;
  --tab-outline-color: #ddd !important;
  --tab-switcher-background: #ECEFF2 !important;
  --tab-switcher-menubar-background: linear-gradient(to top, #ECEFF2, transparent) !important;
  ...
  --tab-text-color-focused-active-current: rgba(0, 0, 0, 0.87) !important;
  --tab-text-color-focused-highlighted: #AF3541 !important;
  --table-add-button-border-color: #ddd !important;
  --table-border-color: #ddd !important;
  --table-drag-handle-background-active: #020F2B !important;
  ...
  --table-header-color: rgba(0, 0, 0, 0.87) !important;
  --table-selection-border-color: #020F2B !important;
  --tag-color: #AF3541 !important;
  --tag-color-hover: #AF3541 !important;
  --tertiary: #020F2B !important;
  --text-accent: #AF3541 !important;
  --text-accent-hover: #020F2B !important;
  ...
  --text-normal: rgba(0, 0, 0, 0.87) !important;
  --text-on-accent: #f2f2f2 !important;
  --text-selection: rgba(0, 122, 255, 0.15) !important;
  --textHighlight: rgba(255, 255, 0, 0.4) !important;
  --titlebar-background: #ECEFF2 !important;
  --titlebar-background-focused: #020F2B !important;
  --titlebar-border-color: #ddd !important;
  --titlebar-text-color: rgba(0, 0, 0, 0.5) !important;
  --titlebar-text-color-focused: rgba(0, 0, 0, 0.87) !important;
  --vault-profile-color: rgba(0, 0, 0, 0.87) !important;
  --vault-profile-color-hover: rgba(0, 0, 0, 0.87) !important;
...
html body th {
  ...
  color: rgba(0, 0, 0, 0.87);
    ...
    code: `html body code {
  background-color: rgb(100, 115, 117);
  border-bottom-color: rgb(221, 221, 221);
  border-left-color: rgb(221, 221, 221);
  border-right-color: rgb(221, 221, 221);
  border-top-color: rgb(221, 221, 221);
