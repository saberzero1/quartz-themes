...
export const theme: ThemeData = {
  ...
  --accent-l: 62%;
  --accent-s: 92%;
  --ancestor-editor-color: #FF9B54;
  --aside-background: transparent;
  --aside-background-hover: rgba(255, 255, 255, 0.075);
  --aside-border-color: #640D14;
  --aside-text-color: #AD2831;
  --background-modifier-active-hover: hsla(0, 92%, 62%, 0.15);
  --background-modifier-border: #640D14;
  --background-modifier-border-focus: #800E13;
  --background-modifier-border-hover: #971B22;
  --background-modifier-error: #ff5555;
  --background-modifier-error-hover: #ff5555;
  --background-modifier-error-rgb: 255, 85, 85;
  --background-modifier-form-field: #800E13;
  --background-modifier-form-field-hover: #800E13;
  --background-modifier-hover: rgba(255, 255, 255, 0.075);
  --background-modifier-success: #50FA7B;
  --background-modifier-success-rgb: 80, 250, 123;
  --background-primary: #38040E;
  --background-primary-alt: #4E0911;
  --background-primary-pre-alt: #430710;
  --background-secondary: #640D14;
  --background-secondary-alt: #640D14;
  --background-transparent: #55555599;
  --bases-cards-background: #38040E;
  --bases-cards-cover-background: #4E0911;
  --bases-cards-shadow: 0 0 0 1px #640D14;
  --bases-cards-shadow-hover: 0 0 0 1px #971B22;
  --bases-embed-border-color: #640D14;
  --bases-group-heading-property-color: #AD2831;
  --bases-table-border-color: #640D14;
  --bases-table-cell-background-active: #38040E;
  --bases-table-cell-background-disabled: #4E0911;
  --bases-table-cell-background-selected: hsla(0, 92%, 62%, 0.1);
  --bases-table-cell-shadow-active: 0 0 0 2px #800E13;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(0, 92%, 62%);
  --bases-table-group-background: #4E0911;
  --bases-table-header-background: #38040E;
  --bases-table-header-background-hover: rgba(255, 255, 255, 0.075);
  --bases-table-header-color: #AD2831;
  --bases-table-summary-background: #38040E;
  --bases-table-summary-background-hover: rgba(255, 255, 255, 0.075);
  --bb-border: 1px solid #640D14;
  --bb-border-alt: 1px solid #800E13;
  --bb-border-dashed: 1px dashed #640D14;
  --bb-border-high-contrast: 1px solid #AD2831;
  ...
  --blur-background: color-mix(in srgb, #640D14 65%, transparent) linear-gradient(#640D14, color-mix(in srgb, #640D14 65%, transparent));
  ...
  --canvas-background: #38040E;
  --canvas-card-label-color: #d62828;
  ...
  --canvas-dot-pattern: #d62828;
  --caret-color: #FF9B54;
  --checkbox-border-color: #d62828;
  --checkbox-border-color-hover: #AD2831;
  --checkbox-color: hsl(0, 92%, 62%);
  --checkbox-color-hover: hsl(-3, 93.84%, 71.3%);
  --checkbox-marker-color: #38040E;
  --checklist-done-color: #AD2831;
  --code-background: #4E0911;
  --code-border-color: #640D14;
  ...
  --code-punctuation: #AD2831;
  --code-string: #50FA7B;
  --code-tag: #ff5555;
  --code-value: #BD93F9;
  --codeFont: var(--font-monospace, "Monaspace", monospace);
  --collapse-icon-color: #d62828;
  ...
  --dark: var(--text-normal, #FF9B54);
  --darkgray: var(--text-normal, #FF9B54);
  --divider-color: #640D14;
  --divider-color-hover: hsl(0, 92%, 62%);
  --dropdown-background: #640D14;
  --dropdown-background-hover: #971B22;
  --embed-block-shadow-hover: 0 0 0 1px #640D14,
        inset 0 0 0 1px #640D14;
  --embed-border-start: 2px solid hsl(0, 92%, 62%);
  --file-header-background: #38040E;
  --file-header-background-focused: #38040E;
  ...
  --font-ui-medium: 16px;
  --font-ui-small: 14px;
  --footnote-divider-color: #640D14;
  --footnote-id-color: #AD2831;
  --footnote-id-color-no-occurrences: #d62828;
  --footnote-input-background-active: rgba(255, 255, 255, 0.075);
  --graph-line: #971B22;
  --graph-node: #AD2831;
  --graph-node-attachment: hsl(-3, 93.84%, 71.3%);
  --graph-node-focused: #800E13;
  --graph-node-tag: hsl(0, 92%, 62%);
  --graph-node-unresolved: #d62828;
  --graph-text: #FF9B54;
  --gray: var(--text-muted, #AD2831);
  --h1-color: #FEFEFA;
  --h1-size: 3.5em;
  --h1-weight: 900;
  --h2-size: 1.842em;
  ...
  --heading-formatting: #d62828;
  --highlight: var(--background-modifier-hover, rgba(255, 255, 255, 0.075));
  --hr-color: #640D14;
  --icon-color: #AD2831;
  --icon-color-active: hsl(0, 92%, 62%);
  --icon-color-focused: #FF9B54;
  --icon-color-hover: #AD2831;
  --inline-title-color: #FEFEFA;
  --inline-title-size: clamp(2.5rem, 8vw - 4rem, 5rem);
  --inline-title-weight: 900;
  --input-date-separator: #d62828;
  --input-placeholder-color: #d62828;
  --interactive-accent: hsl(0, 92%, 62%);
  --interactive-accent-hover: hsl(-3, 93.84%, 71.3%);
  --interactive-accent-hsl: 0, 92%, 62%;
  --interactive-hover: #971B22;
  --interactive-normal: #640D14;
  --light: var(--background-primary, #38040E);
  --lightgray: var(--background-secondary, #640D14);
  ...
  --list-indent: 2.25em;
  --list-marker-color: #d62828;
  --list-marker-color-collapsed: hsl(0, 92%, 62%);
  --list-marker-color-hover: #AD2831;
  --menu-background: #640D14;
  --menu-border-color: #971B22;
  --menu-shadow: 0px 10px 21px 13px rgba(0, 0, 0, 0.1);
  --metadata-border-color: #640D14;
  --metadata-divider-color: #640D14;
  ...
  --metadata-input-text-color: #FF9B54;
  ...
  --metadata-label-text-color: #AD2831;
  --metadata-label-text-color-hover: #AD2831;
  --metadata-property-background-active: rgba(255, 255, 255, 0.075);
  --metadata-property-box-shadow-focus: 0 0 0 2px #800E13;
  --metadata-property-box-shadow-hover: 0 0 0 1px #971B22;
  --metadata-sidebar-input-font-size: 14px;
  --metadata-sidebar-label-font-size: 14px;
  --modal-background: #38040E;
  --modal-border-color: #800E13;
  --nav-collapse-icon-color: #d62828;
  --nav-collapse-icon-color-collapsed: #d62828;
  --nav-heading-color: #FF9B54;
  --nav-heading-color-collapsed: #d62828;
  --nav-heading-color-collapsed-hover: #AD2831;
  --nav-heading-color-hover: #FF9B54;
  ...
  --nav-item-color: #AD2831;
  --nav-item-color-active: #FF9B54;
  --nav-item-color-highlighted: hsl(0, 92%, 62%);
  --nav-item-color-hover: #FF9B54;
  --nav-item-color-selected: #FF9B54;
  --nav-item-size: 14px;
  --nav-tag-color: #d62828;
  --nav-tag-color-active: #AD2831;
  --nav-tag-color-hover: #AD2831;
  --o-h1-color: #640D14;
  --o-h2-color: #640D14;
  --o-h3-color: #640D14;
  --o-h4-color: #640D14;
  --o-h5-color: #640D14;
  --o-h6-color: #640D14;
  --pdf-background: #38040E;
  --pdf-page-background: #38040E;
  --pdf-shadow: 0 0 0 1px #640D14;
  --pdf-sidebar-background: #38040E;
  --pdf-thumbnail-shadow: 0 0 0 1px #640D14;
  --pill-border-color: #640D14;
  --pill-border-color-hover: #971B22;
  --pill-color: #AD2831;
  --pill-color-hover: #FF9B54;
  --pill-color-remove: #d62828;
  --pill-color-remove-hover: hsl(0, 92%, 62%);
  --prompt-background: #38040E;
  --prompt-border-color: #800E13;
  --raised-background: color-mix(in srgb, #640D14 65%, transparent) linear-gradient(#640D14, color-mix(in srgb, #640D14 65%, transparent));
  --ribbon-background: #640D14;
  --ribbon-background-collapsed: #38040E;
  --scrollbar-active-thumb-bg: hsla(0, 92%, 62%, 0.2);
  --scrollbar-thumb-bg: rgba(255, 255, 255, 0.05);
  --search-clear-button-color: #AD2831;
  --search-icon-color: #AD2831;
  --search-result-background: #38040E;
  --secondary: var(--text-accent, hsl(0, 92%, 62%));
  --setting-group-heading-color: #FF9B54;
  --setting-group-heading-size: 16px;
  --setting-items-background: #4E0911;
  --setting-items-border-color: #640D14;
  --shadow-l: rgb(0 0 0 / 20%) 0px 8px 24px;
  --shadow-lm-only: none;
  --shadow-s: 0px 10px 21px 13px rgba(0, 0, 0, 0.1);
  --shiki-active-tab-border-color: #AD2831;
  --shiki-code-background: #4E0911;
  --shiki-code-comment: #d62828;
  --shiki-code-function: #50FA7B;
  --shiki-code-important: #FFB86C;
  --shiki-code-keyword: #FF79C6;
  --shiki-code-normal: #AD2831;
  --shiki-code-property: #8BE9FD;
  --shiki-code-punctuation: #AD2831;
  --shiki-code-string: #F1FA8C;
  --shiki-code-value: #BD93F9;
  --shiki-gutter-border-color: #640D14;
  --shiki-gutter-text-color: #d62828;
  --shiki-gutter-text-color-highlight: #AD2831;
  --shiki-highlight-green: rgba(80, 250, 123, 0.5);
  --shiki-highlight-green-background: rgba(80, 250, 123, 0.1);
  --shiki-highlight-neutral: #AD2831;
  --shiki-highlight-red: rgba(255, 85, 85, 0.5);
  --shiki-highlight-red-background: rgba(255, 85, 85, 0.1);
  --shiki-terminal-dots-color: #d62828;
  --slider-thumb-border-color: #971B22;
  --slider-thumb-radius: 50%;
  --slider-track-background: #640D14;
  --status-bar-background: #640D14;
  --status-bar-border-color: #640D14;
  --status-bar-scroll-padding: 30px;
  --status-bar-text-color: #AD2831;
  --suggestion-background: #38040E;
  --swatch-height: 24px;
  --swatch-width: 24px;
  ...
  --tab-background-active: #38040E;
  --tab-container-background: #640D14;
  --tab-divider-color: #971B22;
  --tab-font-size: 14px;
  --tab-outline-color: #640D14;
  --tab-stacked-font-size: 14px;
  --tab-switcher-background: #640D14;
  --tab-switcher-menubar-background: linear-gradient(to top, #640D14, transparent);
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(0, 92%, 62%);
  --tab-text-color: #d62828;
  --tab-text-color-active: #AD2831;
  --tab-text-color-focused: #AD2831;
  --tab-text-color-focused-active: #AD2831;
  --tab-text-color-focused-active-current: #FF9B54;
  --tab-text-color-focused-highlighted: hsl(0, 92%, 62%);
  --table-add-button-border-color: #640D14;
  --table-border-color: #640D14;
  --table-drag-handle-background-active: hsl(0, 92%, 62%);
  --table-drag-handle-color: #d62828;
  --table-drag-handle-color-active: #FEFEFA;
  --table-header-border-color: #640D14;
  --table-header-color: #FF9B54;
  ...
  --text-muted: #AD2831;
  --text-normal: #FF9B54;
  --text-on-accent: #FEFEFA;
  --text-on-button: #38040E;
  ...
  --titlebar-background: #640D14;
  --titlebar-background-focused: transparent;
  --titlebar-border-color: #640D14;
  --titlebar-text-color: #AD2831;
  --titlebar-text-color-focused: #FF9B54;
  ...
  --transition-props: background 700ms, 
                        border 700ms, 
                        color 700ms;
  --vault-name-color: #FF9B54;
  --vault-name-font-size: 14px;
  --vault-name-font-weight: 500;
  --vault-profile-color: #FF9B54;
  --vault-profile-color-hover: #FF9B54;
