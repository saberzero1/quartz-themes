...
export const theme: ThemeData = {
  ...
  --ancestor-editor-color: #FF9B54 !important;
  --aside-background: transparent !important;
  --aside-background-hover: rgba(255, 255, 255, 0.075) !important;
  --aside-border-color: #640D14 !important;
  --aside-text-color: #AD2831 !important;
  --background-modifier-active-hover: hsla(0, 92%, 62%, 0.15) !important;
  --background-modifier-border: #640D14 !important;
  --background-modifier-border-focus: #800E13 !important;
  --background-modifier-border-hover: #971B22 !important;
  ...
  --background-modifier-form-field: #800E13 !important;
  --background-modifier-form-field-hover: #800E13 !important;
  ...
  --background-primary: #38040E !important;
  --background-primary-alt: #4E0911 !important;
  --background-primary-pre-alt: #430710 !important;
  --background-secondary: #640D14 !important;
  --background-secondary-alt: #640D14 !important;
  --background-transparent: #55555599 !important;
  --bases-cards-background: #38040E !important;
  --bases-cards-cover-background: #4E0911 !important;
  --bases-cards-shadow: 0 0 0 1px #640D14 !important;
  --bases-cards-shadow-hover: 0 0 0 1px #971B22 !important;
  --bases-embed-border-color: #640D14 !important;
  --bases-group-heading-property-color: #AD2831 !important;
  --bases-table-border-color: #640D14 !important;
  --bases-table-cell-background-active: #38040E !important;
  --bases-table-cell-background-disabled: #4E0911 !important;
  --bases-table-cell-background-selected: hsla(0, 92%, 62%, 0.1) !important;
  --bases-table-cell-shadow-active: 0 0 0 2px #800E13 !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(0, 92%, 62%) !important;
  --bases-table-group-background: #4E0911 !important;
  --bases-table-header-background: #38040E !important;
  --bases-table-header-background-hover: rgba(255, 255, 255, 0.075) !important;
  --bases-table-header-color: #AD2831 !important;
  --bases-table-summary-background: #38040E !important;
  --bases-table-summary-background-hover: rgba(255, 255, 255, 0.075) !important;
  --bb-border: 1px solid #640D14 !important;
  --bb-border-alt: 1px solid #800E13 !important;
  --bb-border-dashed: 1px dashed #640D14 !important;
  --bb-border-high-contrast: 1px solid #AD2831 !important;
  ...
  --blur-background: color-mix(in srgb, #640D14 65%, transparent) linear-gradient(#640D14, color-mix(in srgb, #640D14 65%, transparent)) !important;
  ...
  --canvas-background: #38040E !important;
  --canvas-card-label-color: #d62828 !important;
  ...
  --canvas-dot-pattern: #d62828 !important;
  --caret-color: #FF9B54 !important;
  --checkbox-border-color: #d62828 !important;
  --checkbox-border-color-hover: #AD2831 !important;
  --checkbox-color: hsl(0, 92%, 62%) !important;
  --checkbox-color-hover: hsl(-3, 93.84%, 71.3%) !important;
  --checkbox-marker-color: #38040E !important;
  --checklist-done-color: #AD2831 !important;
  --code-background: #4E0911 !important;
  --code-border-color: #640D14 !important;
  --code-bracket-background: rgba(255, 255, 255, 0.075) !important;
  --code-comment: #d62828 !important;
  --code-function: #F1FA8C !important;
  --code-important: #FFB86C !important;
  --code-keyword: #FF79C6 !important;
  --code-normal: #AD2831 !important;
  --code-operator: #ff5555 !important;
  --code-property: #8BE9FD !important;
  --code-punctuation: #AD2831 !important;
  --code-string: #50FA7B !important;
  --code-tag: #ff5555 !important;
  --code-value: #BD93F9 !important;
  --codeFont: "Monaspace", monospace !important;
  --collapse-icon-color: #d62828 !important;
  ...
  --color-accent-3: hsl(-175,
        ...
        79.98%) !important;
  --color-accent-hsl: 0, 92%, 62% !important;
  --color-accent-rgb: 255, 85, 85 !important;
  --color-base-00: #38040E !important;
  --color-base-05: #430710 !important;
  --color-base-10: #4E0911 !important;
  --color-base-100: #FEFEFA !important;
  --color-base-20: #640D14 !important;
  --color-base-25: #800E13 !important;
  --color-base-30: #640D14 !important;
  --color-base-35: #971B22 !important;
  --color-base-40: #800E13 !important;
  --color-base-50: #d62828 !important;
  --color-base-60: #AD2831 !important;
  --color-base-70: #FF9B54 !important;
  ...
  --dark: #FF9B54 !important;
  --darkgray: #FF9B54 !important;
  --divider-color: #640D14 !important;
  --divider-color-hover: hsl(0, 92%, 62%) !important;
  --dropdown-background: #640D14 !important;
  --dropdown-background-hover: #971B22 !important;
  --embed-block-shadow-hover: 0 0 0 1px #640D14,
        inset 0 0 0 1px #640D14 !important;
  --embed-border-start: 2px solid hsl(0, 92%, 62%) !important;
  --file-header-background: #38040E !important;
  --file-header-background-focused: #38040E !important;
  ...
  --flair-background: #640D14 !important;
  --flair-color: #FF9B54 !important;
  ...
  --footnote-divider-color: #640D14 !important;
  --footnote-id-color: #AD2831 !important;
  --footnote-id-color-no-occurrences: #d62828 !important;
  --footnote-input-background-active: rgba(255, 255, 255, 0.075) !important;
  --graph-line: #971B22 !important;
  --graph-node: #AD2831 !important;
  --graph-node-attachment: hsl(-3, 93.84%, 71.3%) !important;
  --graph-node-focused: #800E13 !important;
  --graph-node-tag: hsl(0, 92%, 62%) !important;
  --graph-node-unresolved: #d62828 !important;
  --graph-text: #FF9B54 !important;
  --gray: #AD2831 !important;
  --h1-color: #FEFEFA !important;
  ...
  --heading-formatting: #d62828 !important;
  --highlight: rgba(255, 255, 255, 0.075) !important;
  --hr-color: #640D14 !important;
  --icon-color: #AD2831 !important;
  --icon-color-active: hsl(0, 92%, 62%) !important;
  --icon-color-focused: #FF9B54 !important;
  --icon-color-hover: #AD2831 !important;
  ...
  --input-date-separator: #d62828 !important;
  --input-placeholder-color: #d62828 !important;
  --interactive-accent: hsl(0, 92%, 62%) !important;
  --interactive-accent-hover: hsl(-3, 93.84%, 71.3%) !important;
  --interactive-accent-hsl: 0, 92%, 62% !important;
  --interactive-hover: #971B22 !important;
  --interactive-normal: #640D14 !important;
  --light: #38040E !important;
  --lightgray: #640D14 !important;
  ...
  --list-marker-color: #d62828 !important;
  --list-marker-color-collapsed: hsl(0, 92%, 62%) !important;
  --list-marker-color-hover: #AD2831 !important;
  --menu-background: #640D14 !important;
  --menu-border-color: #971B22 !important;
  --menu-shadow: 0px 10px 21px 13px rgba(0, 0, 0, 0.1) !important;
  --metadata-border-color: #640D14 !important;
  --metadata-divider-color: #640D14 !important;
  ...
  --metadata-input-text-color: #FF9B54 !important;
  ...
  --metadata-label-text-color: #AD2831 !important;
  --metadata-label-text-color-hover: #AD2831 !important;
  --metadata-property-background-active: rgba(255, 255, 255, 0.075) !important;
  --metadata-property-box-shadow-focus: 0 0 0 2px #800E13 !important;
  --metadata-property-box-shadow-hover: 0 0 0 1px #971B22 !important;
  --metadata-sidebar-input-font-size: 14px !important;
  --metadata-sidebar-label-font-size: 14px !important;
  --modal-background: #38040E !important;
  --modal-border-color: #800E13 !important;
  --nav-collapse-icon-color: #d62828 !important;
  --nav-collapse-icon-color-collapsed: #d62828 !important;
  --nav-heading-color: #FF9B54 !important;
  --nav-heading-color-collapsed: #d62828 !important;
  --nav-heading-color-collapsed-hover: #AD2831 !important;
  --nav-heading-color-hover: #FF9B54 !important;
  ...
  --nav-item-color: #AD2831 !important;
  --nav-item-color-active: #FF9B54 !important;
  --nav-item-color-highlighted: hsl(0, 92%, 62%) !important;
  --nav-item-color-hover: #FF9B54 !important;
  --nav-item-color-selected: #FF9B54 !important;
  --nav-item-size: 14px !important;
  --nav-tag-color: #d62828 !important;
  --nav-tag-color-active: #AD2831 !important;
  --nav-tag-color-hover: #AD2831 !important;
  --o-h1-color: #640D14 !important;
  --o-h2-color: #640D14 !important;
  --o-h3-color: #640D14 !important;
  --o-h4-color: #640D14 !important;
  --o-h5-color: #640D14 !important;
  --o-h6-color: #640D14 !important;
  --pdf-background: #38040E !important;
  --pdf-page-background: #38040E !important;
  --pdf-shadow: 0 0 0 1px #640D14 !important;
  --pdf-sidebar-background: #38040E !important;
  --pdf-thumbnail-shadow: 0 0 0 1px #640D14 !important;
  --pill-border-color: #640D14 !important;
  --pill-border-color-hover: #971B22 !important;
  --pill-color: #AD2831 !important;
  --pill-color-hover: #FF9B54 !important;
  --pill-color-remove: #d62828 !important;
  --pill-color-remove-hover: hsl(0, 92%, 62%) !important;
  --prompt-background: #38040E !important;
  --prompt-border-color: #800E13 !important;
  --raised-background: color-mix(in srgb, #640D14 65%, transparent) linear-gradient(#640D14, color-mix(in srgb, #640D14 65%, transparent)) !important;
  --ribbon-background: #640D14 !important;
  --ribbon-background-collapsed: #38040E !important;
  --scrollbar-active-thumb-bg: hsla(0, 92%, 62%, 0.2) !important;
  --scrollbar-thumb-bg: rgba(255, 255, 255, 0.05) !important;
  --search-clear-button-color: #AD2831 !important;
  --search-icon-color: #AD2831 !important;
  --search-result-background: #38040E !important;
  --secondary: hsl(0, 92%, 62%) !important;
  --setting-group-heading-color: #FF9B54 !important;
  --setting-group-heading-size: 16px !important;
  --setting-items-background: #4E0911 !important;
  --setting-items-border-color: #640D14 !important;
  ...
  --shiki-active-tab-border-color: #AD2831 !important;
  --shiki-code-background: #4E0911 !important;
  --shiki-code-comment: #d62828 !important;
  --shiki-code-function: #50FA7B !important;
  --shiki-code-important: #FFB86C !important;
  --shiki-code-keyword: #FF79C6 !important;
  --shiki-code-normal: #AD2831 !important;
  --shiki-code-property: #8BE9FD !important;
  --shiki-code-punctuation: #AD2831 !important;
  --shiki-code-string: #F1FA8C !important;
  --shiki-code-value: #BD93F9 !important;
  --shiki-gutter-border-color: #640D14 !important;
  --shiki-gutter-text-color: #d62828 !important;
  --shiki-gutter-text-color-highlight: #AD2831 !important;
  --shiki-highlight-green: rgba(80, 250, 123, 0.5) !important;
  --shiki-highlight-green-background: rgba(80, 250, 123, 0.1) !important;
  --shiki-highlight-neutral: #AD2831 !important;
  --shiki-highlight-red: rgba(255, 85, 85, 0.5) !important;
  --shiki-highlight-red-background: rgba(255, 85, 85, 0.1) !important;
  --shiki-terminal-dots-color: #d62828 !important;
  --slider-thumb-border-color: #971B22 !important;
  --slider-thumb-radius: 50% !important;
  --slider-track-background: #640D14 !important;
  --status-bar-background: #640D14 !important;
  --status-bar-border-color: #640D14 !important;
  --status-bar-scroll-padding: 30px !important;
  --status-bar-text-color: #AD2831 !important;
  --suggestion-background: #38040E !important;
  ...
  --tab-background-active: #38040E !important;
  --tab-container-background: #640D14 !important;
  --tab-divider-color: #971B22 !important;
  --tab-font-size: 14px !important;
  --tab-outline-color: #640D14 !important;
  --tab-stacked-font-size: 14px !important;
  --tab-switcher-background: #640D14 !important;
  --tab-switcher-menubar-background: linear-gradient(to top, #640D14, transparent) !important;
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(0, 92%, 62%) !important;
  --tab-text-color: #d62828 !important;
  --tab-text-color-active: #AD2831 !important;
  --tab-text-color-focused: #AD2831 !important;
  --tab-text-color-focused-active: #AD2831 !important;
  --tab-text-color-focused-active-current: #FF9B54 !important;
  --tab-text-color-focused-highlighted: hsl(0, 92%, 62%) !important;
  --table-add-button-border-color: #640D14 !important;
  --table-border-color: #640D14 !important;
  --table-drag-handle-background-active: hsl(0, 92%, 62%) !important;
  --table-drag-handle-color: #d62828 !important;
  --table-drag-handle-color-active: #FEFEFA !important;
  --table-header-border-color: #640D14 !important;
  --table-header-color: #FF9B54 !important;
  ...
  --text-faint: #d62828 !important;
  --text-muted: #AD2831 !important;
  --text-normal: #FF9B54 !important;
  --text-on-accent: #FEFEFA !important;
  --text-on-button: #38040E !important;
  ...
  --titlebar-background: #640D14 !important;
  --titlebar-background-focused: transparent !important;
  --titlebar-border-color: #640D14 !important;
  --titlebar-text-color: #AD2831 !important;
  --titlebar-text-color-focused: #FF9B54 !important;
  ...
  --vault-name-color: #FF9B54 !important;
  --vault-name-font-size: 14px !important;
  --vault-name-font-weight: 500 !important;
  --vault-profile-color: #FF9B54 !important;
  --vault-profile-color-hover: #FF9B54 !important;
...
html body .callout[data-callout="info"] {
  ...
  background-color: rgba(139, 198, 253, 0.1);
  border-bottom-color: rgb(139, 198, 253);
  border-bottom-left-radius: 12px;
  border-bottom-right-radius: 12px;
  border-bottom-style: dashed;
...
html body .breadcrumb-element p {
  ...
  box-shadow: rgb(255, 155, 84) 0px 0px 0px 4px;
}
