...
export const theme: ThemeData = {
  ...
  --Code--purple: #893cf5;
  --Code--subs: #3f4144;
  --background-modifier-border: var(--color-base-30, #202020);
  ...
  --background-secondary-alt: var(--color-base-30, #161616);
  --bases-cards-background: var(--background-primary, #202020);
  --bases-cards-cover-background: var(--background-primary-alt, #161616);
  --bases-embed-border-color: var(--background-modifier-border, #202020);
  --bases-table-border-color: var(--table-border-color, #202020);
  ...
  --blockquote-border-color: var(--interactive-accent, rgba(137, 60, 245, 0.55));
  ...
  --canvas-card-label-color: var(--text-faint, #893cf5d8);
  --caret-color: var(--text-normal, #cccccc);
  --checkbox-border-color: var(--text-faint, #893cf5d8);
  --checkbox-color: var(--interactive-accent, rgba(137, 60, 245, 0.55));
  --checkbox-color-hover: var(--interactive-accent-hover, rgba(137, 60, 245, 0.8));
  --checkbox-marker-color: var(--background-primary, #202020);
  --code-background: var(--background-primary-alt, #161616);
  --code-border-color: var(--background-modifier-border, #202020);
  --code-comment: var(--text-faint, #893cf5d8);
  --code-mono-font: 'OperatorMonoSSmLig-Book';
  --code-normal: var(--text-normal, #cccccc);
  --collapse-icon-color: var(--text-faint, #893cf5d8);
  --collapse-icon-color-collapsed: var(--text-accent, #893cf5);
  ...
  --divider-color: var(--background-modifier-border, #202020);
  --divider-color-hover: var(--interactive-accent, rgba(137, 60, 245, 0.55));
  ...
  --file-header-font: var(--font-interface, Rubik, Glow Sans SC, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto,
  ...
  --footnote-divider-color: var(--metadata-divider-color, #202020);
  --footnote-id-color-no-occurrences: var(--text-faint, #893cf5d8);
  --graph-node-focused: var(--text-accent, #893cf5);
  --graph-node-unresolved: var(--text-faint, #893cf5d8);
  --graph-text: var(--text-normal, #cccccc);
  --gray: var(--text-faint, var(--color-base-50, #893cf5d8));
  --heading-formatting: var(--text-faint, #893cf5d8);
  --highlight: var(--text-highlight-bg, var(--bg-accent-55, rgba(137, 60, 245, 0.55)));
  --hr-color: var(--background-modifier-border, #202020);
  --icon-color-active: var(--text-accent, #893cf5);
  --icon-color-focused: var(--text-normal, #cccccc);
  --indentation-guide-color: var(--interactive-accent, rgba(137, 60, 245, 0.55));
  --input-date-separator: var(--text-faint, #893cf5d8);
  --input-placeholder-color: var(--text-faint, #893cf5d8);
  --interactive-accent: var(--color-accent, rgba(137, 60, 245, 0.55));
  --interactive-accent-hover: var(--color-accent-1, rgba(137, 60, 245, 0.8));
  ...
  --link-color: var(--text-accent, #893cf5);
  --link-external-color: var(--text-accent, #893cf5);
  --link-unresolved-color: var(--text-accent, #893cf5);
  --list-marker-color: var(--text-faint, #893cf5d8);
  --list-marker-color-collapsed: var(--text-accent, #893cf5);
  --menu-background: var(--background-secondary, #1a1a1a);
  --metadata-border-color: var(--background-modifier-border, #202020);
  --metadata-divider-color: var(--background-modifier-border, #202020);
  --metadata-input-font: var(--font-interface, Rubik, Glow Sans SC, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto,
    Helvetica, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  --metadata-input-text-color: var(--text-normal, #cccccc);
  --metadata-label-font: var(--font-interface, Rubik, Glow Sans SC, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto,
    Helvetica, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  --modal-background: var(--background-primary, #202020);
  --nav-collapse-icon-color: var(--collapse-icon-color, #893cf5d8);
  --nav-collapse-icon-color-collapsed: var(--text-faint, #893cf5d8);
  --nav-heading-color: var(--text-normal, #cccccc);
  --nav-heading-color-collapsed: var(--text-faint, #893cf5d8);
  --nav-heading-color-hover: var(--text-normal, #cccccc);
  --nav-indentation-guide-color: var(--indentation-guide-color, rgba(137, 60, 245, 0.55));
  --nav-item-color-active: var(--text-normal, #cccccc);
  --nav-item-color-highlighted: var(--text-accent, #893cf5);
  --nav-item-color-hover: var(--text-normal, #cccccc);
  --nav-item-color-selected: var(--text-normal, #cccccc);
  --nav-tag-color: var(--text-faint, #893cf5d8);
  ...
  --pill-border-color: var(--background-modifier-border, #202020);
  --pill-color-hover: var(--text-normal, #cccccc);
  --pill-color-remove: var(--text-faint, #893cf5d8);
  --pill-color-remove-hover: var(--text-accent, #893cf5);
  --pre-code: var(--background-secondary, #1a1a1a);
  ...
  --secondary: var(--text-accent, var(--color-accent-1, #893cf5));
  --setting-group-heading-color: var(--text-normal, #cccccc);
  --setting-items-background: var(--background-primary-alt, #161616);
  --setting-items-border-color: var(--background-modifier-border, #202020);
  --shiki-code-background: var(--code-background, #161616);
  --shiki-code-comment: var(--text-faint, #893cf5d8);
  --shiki-gutter-border-color: var(--background-modifier-border, #202020);
  --shiki-gutter-text-color: var(--text-faint, #893cf5d8);
  --shiki-terminal-dots-color: var(--text-faint, #893cf5d8);
  --slider-track-background: var(--background-modifier-border, #202020);
  --status-bar-background: var(--background-secondary, #1a1a1a);
  --status-bar-border-color: var(--divider-color, #202020);
  ...
  --tab-outline-color: var(--divider-color, #202020);
  --tab-switcher-background: var(--background-secondary, #1a1a1a);
  --tab-text-color: var(--text-faint, #893cf5d8);
  --tab-text-color-focused-active-current: var(--text-normal, #cccccc);
  --tab-text-color-focused-highlighted: var(--text-accent, #893cf5);
  --table-add-button-border-color: var(--background-modifier-border, #202020);
  --table-border-color: var(--background-modifier-border, #202020);
  --table-drag-handle-background-active: var(--table-selection-border-color, rgba(137, 60, 245, 0.55));
  --table-drag-handle-color: var(--text-faint, #893cf5d8);
  --table-header-border-color: var(--table-border-color, #202020);
  --table-header-color: var(--text-normal, #cccccc);
  --table-selection-border-color: var(--interactive-accent, rgba(137, 60, 245, 0.55));
  --tag-color: var(--text-accent, #893cf5);
  --tag-color-hover: var(--text-accent, #893cf5);
  ...
  --tertiary: var(--interactive-accent-hover, var(--color-accent-1, rgba(137, 60, 245, 0.8)));
  --test-color: rgb(122, 162, 247);
  --text-a: #61d0ff;
  --text-a-hover: #61d0ff;
  --text-accent: var(--color-accent-1, #893cf5);
  --text-dim: #eb59e0;
  --text-faint: var(--color-base-50, #893cf5d8);
  --text-highlight-bg: var(--bg-accent-55, rgba(137, 60, 245, 0.55));
  --text-link: #6c6d72;
  --text-mark: #263d92;
  --text-normal: var(--color-base-100, #cccccc);
  --text-sub-accent: #eb59e0;
  --text-title-h1: var(--text-accent, #893cf5);
  --text-title-h2: #cccccc;
  --text-title-h3: #cccccc;
  --text-title-h4: #cccccc;
  --text-title-h5: #cccccc;
  --textHighlight: var(--text-highlight-bg, var(--bg-accent-55, rgba(137, 60, 245, 0.55)));
  --titlebar-background: var(--background-secondary, #1a1a1a);
  --titlebar-background-focused: var(--background-secondary-alt, #161616);
  --titlebar-border-color: var(--background-modifier-border, #202020);
...
html body .text-highlight {
  background-color: var(--text-highlight-bg, rgba(137, 60, 245, 0.55));
...
html body li.task-list-item input[type="checkbox"]:checked {
  background-color: var(--checkbox-color, rgba(137, 60, 245, 0.55));
...
html body a.internal-link, html .breadcrumb-container .breadcrumb-element > a {
  color: var(--link-color, rgb(137, 60, 245));
  outline: rgb(137, 60, 245) none 0px;
  text-decoration-color: rgb(137, 60, 245);
}

html body a.internal-link.broken {
  color: var(--link-unresolved-color, rgb(137, 60, 245));
  outline: rgb(137, 60, 245) none 0px;
  text-decoration-color: var(--link-unresolved-decoration-color, rgb(137, 60, 245));
}`,
    lists: `html body dd {
...
html body ul.overflow {
  ...
  color: var(--text-faint, rgba(137, 60, 245, 0.847));
}
...
html body th {
  ...
  color: var(--table-header-color, rgb(204, 204, 204));
    ...
    code: `html body code {
  background-color: var(--code-background, rgba(235, 89, 224, 0.05));
  border-bottom-color: rgb(32, 32, 32);
  ...
  border-top-width: 0px;
  color: var(--text-sub-accent, rgb(235, 89, 224));
  padding-bottom: 0px;
  padding-left: 5px;
  padding-right: 5px;
  padding-top: 0px;
...
html body li.task-list-item[data-task="!"] {
  ...
  --shiki-gutter-border-color: #202020;
  --shiki-gutter-border-width: 1px;
  --shiki-gutter-text-color: #893cf5d8;
  ...
  --shiki-terminal-dots-color: #893cf5d8;
  ...
  color: var(--interactive-accent, rgba(137, 60, 245, 0.55));
  content: "";
...
html body a.internal-link.tag-link, html .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  --pill-background: var(--tag-background, #a7b0b3);
  --pill-color: var(--tag-color, #893cf5);
  --pill-color-hover: var(--tag-color-hover, #893cf5);
  --pill-color-remove: var(--tag-color, #893cf5);
  --pill-color-remove-hover: var(--tag-color-hover, #893cf5);
  background-color: var(--pill-background, rgb(167, 176, 179));
  color: var(--pill-color, rgb(137, 60, 245));
  font-family: "??", "??", Rubik, "Glow Sans SC", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
}
...
html body h1 {
  ...
  line-height: var(--h1-line-height, 61.2px);
}
...
html body h1::after {
  ...
  background: rgba(0, 0, 0, 0) linear-gradient(130deg, rgb(36, 198, 220), rgb(84, 51, 255) 41.07%, rgb(255, 0, 153) 76.05%) repeat scroll 0% 0% / auto padding-box border-box;
  background-color: rgba(0, 0, 0, 0);
  background-image: linear-gradient(130deg, rgb(36, 198, 220), rgb(84, 51, 255) 41.07%, rgb(255, 0, 153) 76.05%);
  border-bottom-color: rgb(137, 60, 245);
...
html body .metadata-property-key {
  font-family: var(--metadata-label-font, "??", "??", Rubik, "Glow Sans SC", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
}

html body .metadata-property-value {
  font-family: var(--metadata-input-font, "??", "??", Rubik, "Glow Sans SC", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
}
...
html body ul.tags > li {
  background-color: var(--tag-background, rgb(137, 60, 245));
