...
export const theme: ThemeData = {
  ...
  dark: {
    base: `:root:root {
  --background-modifier-hover: hsl(258, 88%, 66%) !important;
  --background-ui-current: hsl(258, 88%, 66%) !important;
  --bases-table-header-background-hover: hsl(258, 88%, 66%) !important;
  --bases-table-header-weight: 450 !important;
  --bases-table-summary-background-hover: hsl(258, 88%, 66%) !important;
  ...
  --checkbox-border-color-hover: hsl(60, 100%, 50%) !important;
  --checkbox-marker-color: hsl(48, 100%, 50%) !important;
  --code-background: hsl(258, 20%, 23%) !important;
  --code-bracket-background: hsl(258, 88%, 66%) !important;
  ...
  --color-alt-1: hsl(60, 100%, 50%) !important;
  --color-alt-2: hsl(54, 100%, 50%) !important;
  --color-alt-3: hsl(48, 100%, 50%) !important;
  --color-alt-4: hsl(42, 100%, 50%) !important;
  --color-alt-5: hsl(36, 100%, 50%) !important;
  --color-alt-6: hsl(30, 100%, 50%) !important;
  --color-cm-checkbox: hsl(180, 100%, 50%) !important;
  --color-cm-list: hsl(210, 100%, 60%) !important;
  --color-cm-table: hsl(120, 50%, 60%) !important;
  --color-default: hsl(258, 88%, 66%) !important;
  --color-ui-active: hsl(48, 100%, 50%) !important;
  --color-ui-current: hsl(60, 100%, 50%) !important;
  ...
  --footnote-input-background-active: hsl(258, 88%, 66%) !important;
  --h1: 1.6em !important;
  --h2: 1.3em !important;
  --h3: 1.2em !important;
  --h4: 1.1em !important;
  ...
  --icon-color-focused: hsl(48, 100%, 50%) !important;
  --icon-color-hover: hsl(60, 100%, 50%) !important;
  --inline-title-color: hsl(258, 88%, 66%) !important;
  --link-weight: 450 !important;
  --list-marker-color: hsl(258, 88%, 66%) !important;
  --metadata-input-background-active: hsl(258, 88%, 66%) !important;
  --metadata-label-background-active: hsl(258, 88%, 66%) !important;
  --metadata-property-background-active: hsl(258, 88%, 66%) !important;
  --nav-item-background-active: hsl(258, 88%, 66%) !important;
  --nav-item-background-hover: hsl(258, 88%, 66%) !important;
  --nav-item-color-active: hsl(48, 100%, 50%) !important;
  --nav-item-color-hover: hsl(60, 100%, 50%) !important;
  --ribbon-background: hsl(48, 100%, 50%) !important;
  --shiki-code-background: hsl(258, 20%, 23%) !important;
  --tab-text-color-focused-active: hsl(48, 100%, 50%) !important;
  --tab-text-color-focused-active-current: hsl(60, 100%, 50%) !important;
