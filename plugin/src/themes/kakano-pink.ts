...
html[saved-theme="dark"] body pre > code > [data-line] {
  border-left-color: color(srgb 0.84 0.816 0.36);
}
...
html[saved-theme="dark"] body pre > code [data-highlighted-chars] {
  border-bottom-color: color(srgb 0.84 0.816 0.36);
  border-left-color: color(srgb 0.84 0.816 0.36);
  border-right-color: color(srgb 0.84 0.816 0.36);
  border-top-color: color(srgb 0.84 0.816 0.36);
}
...
html[saved-theme="dark"] body ::-webkit-scrollbar {
  background: color(srgb 0.042 0.018 0.028) none repeat scroll 0% 0% / auto padding-box border-box;
  background-color: color(srgb 0.042 0.018 0.028);
}
