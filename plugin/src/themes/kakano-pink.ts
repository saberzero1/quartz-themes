...
export const theme: ThemeData = {
  ...
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(335, 60%, 60%);
  ...
  --bases-table-header-background-hover: hsl(335, 60%, 60%);
  ...
  --bases-table-summary-background-hover: hsl(335, 60%, 60%);
  ...
  --highlight: var(--background-modifier-hover, hsl(335, 60%, 60%));
  --hr-color: color-mix(
    in srgb,
    hsl(335, 60%, 60%),
    black 25%
  );
  --icon-color: hsl(335, 60%, 60%);
  ...
  --metadata-property-background-active: hsl(335, 60%, 60%);
  ...
  --nav-item-background-active: hsl(335, 60%, 60%);
  ...
  --pill-background-hover: hsl(335, 60%, 60%);
  ...
  --secondary: var(--interactive-accent, hsl(335, 60%, 60%));
  ...
  --textHighlight: var(--background-modifier-hover, hsl(335, 60%, 60%));
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --bases-table-cell-shadow-active: 0 0 0 2px hsl(335, 60%, 60%);
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(335, 60%, 60%);
  --bases-table-container-border-radius: 0.25rem;
  ...
  --metadata-property-box-shadow-focus: 0 0 0 2px hsl(335, 60%, 60%);
  --metadata-property-box-shadow-hover: none;
  --metadata-sidebar-input-font-size: 0.8rem;
  --metadata-sidebar-label-font-size: 0.8rem;
  --modal-background: color-mix(
  ...
  --tag-weight: 400;
  --tertiary: var(--interactive-accent-hover, hsl(335, 60%, 60%));
  --text-error: hsl(from hsl(335, 60%, 60%) 356 s l);
  --text-faint: color-mix(
    in srgb,
    hsl(335, 60%, 60%),
