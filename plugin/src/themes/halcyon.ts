...
export const theme: ThemeData = {
  ...
  --dark: var(--text-normal, #d7dce2);
  --darkgray: var(--text-normal, #d7dce2);
  ...
  --graph-text: #d7dce2;
  --gray: var(--text-muted, color-mix( in hsl, #8695b799, #d7dce2 ));
  --h1-color: #bae67e;
  --h2-color: #bae67e;
  --h2-weight: 675;
  --h3-color: #bae67e;
  ...
  --highlight: var(--text-highlight-bg, rgb(47, 59, 84));
  ...
  --italic-color: #ef6b73;
  --light: var(--background-primary, #1d2433);
  --lightgray: var(--background-secondary, #171c28);
  --link-color: #c3a6ff;
  ...
  --secondary: var(--text-accent, #ffcc66);
  ...
  --shiki-active-tab-border-color: color-mix( in hsl, #8695b799, #d7dce2 );
  --shiki-code-background: #171c28;
  --shiki-code-block-border-radius: 2px;
  --shiki-code-comment: #8695b799;
  --shiki-code-function: #bae67e;
  --shiki-code-important: #ffae57;
  --shiki-code-keyword: #f9cff2;
  --shiki-code-normal: color-mix( in hsl, #8695b799, #d7dce2 );
  --shiki-code-property: #5ccfe6;
  --shiki-code-punctuation: color-mix( in hsl, #8695b799, #d7dce2 );
  --shiki-code-string: #ffd580;
  --shiki-code-value: #c3a6ff;
  --shiki-gutter-border-color: color-mix( in hsl, #1d2433, #2f3b54 );
  --shiki-gutter-text-color: #8695b799;
  --shiki-gutter-text-color-highlight: color-mix( in hsl, #8695b799, #d7dce2 );
  --shiki-highlight-green: rgba(186, 230, 126, 0.5);
  --shiki-highlight-green-background: rgba(186, 230, 126, 0.1);
  --shiki-highlight-neutral: color-mix( in hsl, #8695b799, #d7dce2 );
  --shiki-highlight-red: rgba(239, 107, 115, 0.5);
  --shiki-highlight-red-background: rgba(239, 107, 115, 0.1);
  --shiki-terminal-dots-color: #8695b799;
  --shiki-tooltip-background: color-mix( in hsl, #1d2433, #2f3b54 );
  ...
  --tertiary: var(--text-accent-hover, #ffd580);
  --text-accent: #ffcc66;
  ...
  --text-success: #bae67e;
  --text-warning: #ef6b73;
  --textHighlight: var(--text-highlight-bg, rgb(47, 59, 84));
