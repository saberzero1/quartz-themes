...
export const theme: ThemeData = {
  ...
  --ancestor-editor-color: #cebdbd !important;
  --aside-background: transparent !important;
  --aside-background-hover: rgba(255, 255, 255, 0.075) !important;
  --aside-border-color: #422c2c !important;
  --aside-text-color: #b18a8a !important;
  --background-modifier-active-hover: hsla(0, 92%, 62%, 0.15) !important;
  --background-modifier-border: #422c2c !important;
  --background-modifier-border-focus: #4e3434 !important;
  --background-modifier-border-hover: #635858 !important;
  ...
  --background-modifier-form-field: #462f2f !important;
  --background-modifier-form-field-hover: #462f2f !important;
  ...
  --background-primary: #171212 !important;
  --background-primary-alt: #231a1a !important;
  --background-primary-pre-alt: #201818 !important;
  --background-secondary: #2c2424 !important;
  --background-secondary-alt: #422c2c !important;
  --background-transparent: #55555599 !important;
  --bases-cards-background: #171212 !important;
  --bases-cards-cover-background: #231a1a !important;
  --bases-cards-shadow: 0 0 0 1px #422c2c !important;
  --bases-cards-shadow-hover: 0 0 0 1px #635858 !important;
  --bases-embed-border-color: #422c2c !important;
  --bases-group-heading-property-color: #b18a8a !important;
  --bases-table-border-color: #422c2c !important;
  --bases-table-cell-background-active: #171212 !important;
  --bases-table-cell-background-disabled: #231a1a !important;
  --bases-table-cell-background-selected: hsla(0, 92%, 62%, 0.1) !important;
  --bases-table-cell-shadow-active: 0 0 0 2px #4e3434 !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(0, 92%, 62%) !important;
  --bases-table-group-background: #231a1a !important;
  --bases-table-header-background: #171212 !important;
  --bases-table-header-background-hover: rgba(255, 255, 255, 0.075) !important;
  --bases-table-header-color: #b18a8a !important;
  --bases-table-summary-background: #171212 !important;
  --bases-table-summary-background-hover: rgba(255, 255, 255, 0.075) !important;
  --bb-border: 1px solid #422c2c !important;
  --bb-border-alt: 1px solid #462f2f !important;
  --bb-border-dashed: 1px dashed #422c2c !important;
  --bb-border-high-contrast: 1px solid #b18a8a !important;
  ...
  --blur-background: color-mix(in srgb, #422c2c 65%, transparent) linear-gradient(#422c2c, color-mix(in srgb, #422c2c 65%, transparent)) !important;
  ...
  --canvas-background: #171212 !important;
  --canvas-card-label-color: #815757 !important;
  ...
  --canvas-dot-pattern: #815757 !important;
  --caret-color: #cebdbd !important;
  --checkbox-border-color: #815757 !important;
  --checkbox-border-color-hover: #b18a8a !important;
  --checkbox-color: hsl(0, 92%, 62%) !important;
  --checkbox-color-hover: hsl(-3, 93.84%, 71.3%) !important;
  --checkbox-marker-color: #171212 !important;
  --checklist-done-color: #b18a8a !important;
  --code-background: #231a1a !important;
  --code-border-color: #422c2c !important;
  --code-bracket-background: rgba(255, 255, 255, 0.075) !important;
  --code-comment: #815757 !important;
  --code-function: #E9BF55 !important;
  --code-important: #ED874C !important;
  --code-keyword: #EB6FAF !important;
  --code-normal: #b18a8a !important;
  --code-operator: #EA5E41 !important;
  --code-property: #47AFEB !important;
  --code-punctuation: #b18a8a !important;
  --code-string: #5FB26B !important;
  --code-tag: #EA5E41 !important;
  --code-value: #4B53D1 !important;
  --codeFont: "Monaspace", monospace !important;
  --collapse-icon-color: #815757 !important;
  ...
  --color-accent-3: hsl(-175,
        ...
        79.98%) !important;
  --color-accent-hsl: 0, 92%, 62% !important;
  --color-accent-rgb: 234, 94, 65 !important;
  --color-base-00: #171212 !important;
  --color-base-05: #201818 !important;
  --color-base-10: #231a1a !important;
  --color-base-100: #dacdcd !important;
  --color-base-20: #2c2424 !important;
  --color-base-25: #462f2f !important;
  --color-base-30: #422c2c !important;
  --color-base-35: #635858 !important;
  --color-base-40: #4e3434 !important;
  --color-base-50: #815757 !important;
  --color-base-60: #b18a8a !important;
  --color-base-70: #cebdbd !important;
  ...
  --dark: #cebdbd !important;
  --darkgray: #cebdbd !important;
  --divider-color: #422c2c !important;
  --divider-color-hover: hsl(0, 92%, 62%) !important;
  --dropdown-background: #422c2c !important;
  --dropdown-background-hover: #635858 !important;
  --embed-block-shadow-hover: 0 0 0 1px #422c2c,
        inset 0 0 0 1px #422c2c !important;
  --embed-border-start: 2px solid hsl(0, 92%, 62%) !important;
  --file-header-background: #171212 !important;
  --file-header-background-focused: #171212 !important;
  ...
  --flair-background: #422c2c !important;
  --flair-color: #cebdbd !important;
  ...
  --footnote-divider-color: #422c2c !important;
  --footnote-id-color: #b18a8a !important;
  --footnote-id-color-no-occurrences: #815757 !important;
  --footnote-input-background-active: rgba(255, 255, 255, 0.075) !important;
  --graph-line: #635858 !important;
  --graph-node: #b18a8a !important;
  --graph-node-attachment: hsl(-3, 93.84%, 71.3%) !important;
  --graph-node-focused: #4e3434 !important;
  --graph-node-tag: hsl(0, 92%, 62%) !important;
  --graph-node-unresolved: #815757 !important;
  --graph-text: #cebdbd !important;
  --gray: #b18a8a !important;
  --h1-color: #dacdcd !important;
  ...
  --heading-formatting: #815757 !important;
  --highlight: rgba(255, 255, 255, 0.075) !important;
  --hr-color: #422c2c !important;
  --icon-color: #b18a8a !important;
  --icon-color-active: hsl(0, 92%, 62%) !important;
  --icon-color-focused: #cebdbd !important;
  --icon-color-hover: #b18a8a !important;
  --inline-title-color: #dacdcd !important;
  --inline-title-size: clamp(2.5rem, 8vw - 4rem, 5rem) !important;
  --inline-title-weight: 900 !important;
  --input-date-separator: #815757 !important;
  --input-placeholder-color: #815757 !important;
  --interactive-accent: hsl(0, 92%, 62%) !important;
  --interactive-accent-hover: hsl(-3, 93.84%, 71.3%) !important;
  --interactive-accent-hsl: 0, 92%, 62% !important;
  --interactive-hover: #635858 !important;
  --interactive-normal: #422c2c !important;
  --light: #171212 !important;
  --lightgray: #2c2424 !important;
  ...
  --list-marker-color: #815757 !important;
  --list-marker-color-collapsed: hsl(0, 92%, 62%) !important;
  --list-marker-color-hover: #b18a8a !important;
  --menu-background: #2c2424 !important;
  --menu-border-color: #635858 !important;
  --menu-shadow: 0px 10px 21px 13px rgba(0, 0, 0, 0.1) !important;
  --metadata-border-color: #422c2c !important;
  --metadata-divider-color: #422c2c !important;
  ...
  --metadata-input-text-color: #cebdbd !important;
  ...
  --metadata-label-text-color: #b18a8a !important;
  --metadata-label-text-color-hover: #b18a8a !important;
  --metadata-property-background-active: rgba(255, 255, 255, 0.075) !important;
  --metadata-property-box-shadow-focus: 0 0 0 2px #4e3434 !important;
  --metadata-property-box-shadow-hover: 0 0 0 1px #635858 !important;
  --metadata-sidebar-input-font-size: 14px !important;
  --metadata-sidebar-label-font-size: 14px !important;
  --modal-background: #171212 !important;
  --modal-border-color: #4e3434 !important;
  --nav-collapse-icon-color: #815757 !important;
  --nav-collapse-icon-color-collapsed: #815757 !important;
  --nav-heading-color: #cebdbd !important;
  --nav-heading-color-collapsed: #815757 !important;
  --nav-heading-color-collapsed-hover: #b18a8a !important;
  --nav-heading-color-hover: #cebdbd !important;
  ...
  --nav-item-color: #b18a8a !important;
  --nav-item-color-active: #cebdbd !important;
  --nav-item-color-highlighted: hsl(0, 92%, 62%) !important;
  --nav-item-color-hover: #cebdbd !important;
  --nav-item-color-selected: #cebdbd !important;
  --nav-item-size: 14px !important;
  --nav-tag-color: #815757 !important;
  --nav-tag-color-active: #b18a8a !important;
  --nav-tag-color-hover: #b18a8a !important;
  --o-h1-color: #422c2c !important;
  --o-h2-color: #422c2c !important;
  --o-h3-color: #422c2c !important;
  --o-h4-color: #422c2c !important;
  --o-h5-color: #422c2c !important;
  --o-h6-color: #422c2c !important;
  --pdf-background: #171212 !important;
  --pdf-page-background: #171212 !important;
  --pdf-shadow: 0 0 0 1px #422c2c !important;
  --pdf-sidebar-background: #171212 !important;
  --pdf-thumbnail-shadow: 0 0 0 1px #422c2c !important;
  --pill-border-color: #422c2c !important;
  --pill-border-color-hover: #635858 !important;
  --pill-color: #b18a8a !important;
  --pill-color-hover: #cebdbd !important;
  --pill-color-remove: #815757 !important;
  --pill-color-remove-hover: hsl(0, 92%, 62%) !important;
  --prompt-background: #171212 !important;
  --prompt-border-color: #4e3434 !important;
  --raised-background: color-mix(in srgb, #422c2c 65%, transparent) linear-gradient(#422c2c, color-mix(in srgb, #422c2c 65%, transparent)) !important;
  --ribbon-background: #2c2424 !important;
  --ribbon-background-collapsed: #171212 !important;
  --scrollbar-active-thumb-bg: hsla(0, 92%, 62%, 0.2) !important;
  --scrollbar-thumb-bg: rgba(255, 255, 255, 0.05) !important;
  --search-clear-button-color: #b18a8a !important;
  --search-icon-color: #b18a8a !important;
  --search-result-background: #171212 !important;
  --secondary: hsl(0, 92%, 62%) !important;
  --setting-group-heading-color: #cebdbd !important;
  --setting-group-heading-size: 16px !important;
  --setting-items-background: #231a1a !important;
  --setting-items-border-color: #422c2c !important;
  ...
  --shiki-active-tab-border-color: #b18a8a !important;
  --shiki-code-background: #231a1a !important;
  --shiki-code-comment: #815757 !important;
  --shiki-code-function: #5FB26B !important;
  --shiki-code-important: #ED874C !important;
  --shiki-code-keyword: #EB6FAF !important;
  --shiki-code-normal: #b18a8a !important;
  --shiki-code-property: #47AFEB !important;
  --shiki-code-punctuation: #b18a8a !important;
  --shiki-code-string: #E9BF55 !important;
  --shiki-code-value: #4B53D1 !important;
  --shiki-gutter-border-color: #422c2c !important;
  --shiki-gutter-text-color: #815757 !important;
  --shiki-gutter-text-color-highlight: #b18a8a !important;
  --shiki-highlight-green: rgba(95, 178, 107, 0.5) !important;
  --shiki-highlight-green-background: rgba(95, 178, 107, 0.1) !important;
  --shiki-highlight-neutral: #b18a8a !important;
  --shiki-highlight-red: rgba(234, 94, 65, 0.5) !important;
  --shiki-highlight-red-background: rgba(234, 94, 65, 0.1) !important;
  --shiki-terminal-dots-color: #815757 !important;
  --slider-thumb-border-color: #635858 !important;
  --slider-thumb-radius: 50% !important;
  --slider-track-background: #422c2c !important;
  --status-bar-background: #2c2424 !important;
  --status-bar-border-color: #422c2c !important;
  --status-bar-scroll-padding: 30px !important;
  --status-bar-text-color: #b18a8a !important;
  --suggestion-background: #171212 !important;
  ...
  --tab-background-active: #171212 !important;
  --tab-container-background: #2c2424 !important;
  --tab-divider-color: #635858 !important;
  --tab-font-size: 14px !important;
  --tab-outline-color: #422c2c !important;
  --tab-stacked-font-size: 14px !important;
  --tab-switcher-background: #2c2424 !important;
  --tab-switcher-menubar-background: linear-gradient(to top, #2c2424, transparent) !important;
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(0, 92%, 62%) !important;
  --tab-text-color: #815757 !important;
  --tab-text-color-active: #b18a8a !important;
  --tab-text-color-focused: #b18a8a !important;
  --tab-text-color-focused-active: #b18a8a !important;
  --tab-text-color-focused-active-current: #cebdbd !important;
  --tab-text-color-focused-highlighted: hsl(0, 92%, 62%) !important;
  --table-add-button-border-color: #422c2c !important;
  --table-border-color: #422c2c !important;
  --table-drag-handle-background-active: hsl(0, 92%, 62%) !important;
  --table-drag-handle-color: #815757 !important;
  --table-drag-handle-color-active: #dacdcd !important;
  --table-header-border-color: #422c2c !important;
  --table-header-color: #cebdbd !important;
  ...
  --text-faint: #815757 !important;
  --text-muted: #b18a8a !important;
  --text-normal: #cebdbd !important;
  --text-on-accent: #dacdcd !important;
  --text-on-button: #171212 !important;
  ...
  --titlebar-background: #2c2424 !important;
  --titlebar-background-focused: transparent !important;
  --titlebar-border-color: #422c2c !important;
  --titlebar-text-color: #b18a8a !important;
  --titlebar-text-color-focused: #cebdbd !important;
  ...
  --vault-name-color: #cebdbd !important;
  --vault-name-font-size: 14px !important;
  --vault-name-font-weight: 500 !important;
  --vault-profile-color: #cebdbd !important;
  --vault-profile-color-hover: #cebdbd !important;
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --ancestor-editor-color: #231a1a !important;
  --aside-background: transparent !important;
  --aside-background-hover: rgba(0, 0, 0, 0.075) !important;
  --aside-border-color: #b18a8a !important;
  --aside-text-color: #4e3434 !important;
  --background-modifier-active-hover: hsla(5, 90%, 56%, 0.15) !important;
  --background-modifier-border: #b18a8a !important;
  --background-modifier-border-focus: #b18a8a !important;
  --background-modifier-border-hover: #5a3a3a !important;
  ...
  --background-modifier-form-field: #dacdcd !important;
  --background-modifier-form-field-hover: #dacdcd !important;
  ...
  --background-primary: #dacdcd !important;
  --background-primary-alt: #b39696 !important;
  --background-primary-pre-alt: #cabbbb !important;
  --background-scondary-alt: #4e3434 !important;
  --background-secondary: #b9a5a5 !important;
  --background-secondary-alt: #cabbbb !important;
  --bases-cards-background: #dacdcd !important;
  --bases-cards-cover-background: #b39696 !important;
  --bases-cards-shadow: 0 0 0 1px #b18a8a !important;
  --bases-cards-shadow-hover: 0 0 0 1px #5a3a3a !important;
  --bases-embed-border-color: #b18a8a !important;
  --bases-group-heading-property-color: #4e3434 !important;
  --bases-table-border-color: #b18a8a !important;
  --bases-table-cell-background-active: #dacdcd !important;
  --bases-table-cell-background-disabled: #b39696 !important;
  --bases-table-cell-background-selected: hsla(5, 90%, 56%, 0.1) !important;
  --bases-table-cell-shadow-active: 0 0 0 2px #b18a8a !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(4, 90.9%, 60.2%) !important;
  --bases-table-group-background: #b39696 !important;
  --bases-table-header-background: #dacdcd !important;
  --bases-table-header-background-hover: rgba(0, 0, 0, 0.075) !important;
  --bases-table-header-color: #4e3434 !important;
  --bases-table-summary-background: #dacdcd !important;
  --bases-table-summary-background-hover: rgba(0, 0, 0, 0.075) !important;
  --bb-border: 1px solid #b18a8a !important;
  --bb-border-alt: 1px solid #bd9898 !important;
  --bb-border-dashed: 1px dashed #b18a8a !important;
  --bb-border-high-contrast: 1px solid #4e3434 !important;
  --bb-border-transparent: 1px solid transparent !important;
  ...
  --blur-background: color-mix(in srgb, #dacdcd 65%, transparent) linear-gradient(#dacdcd, color-mix(in srgb, #dacdcd 65%, transparent)) !important;
  --bodyFont: "Aspekta", sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif !important;
  ...
  --canvas-background: #dacdcd !important;
  --canvas-card-label-color: #5a3a3a !important;
  ...
  --canvas-dot-pattern: #5a3a3a !important;
  --caret-color: #231a1a !important;
  --checkbox-border-color: #5a3a3a !important;
  --checkbox-border-color-hover: #4e3434 !important;
  --checkbox-color: hsl(4, 90.9%, 60.2%) !important;
  --checkbox-color-hover: hsl(2, 91.8%, 64.4%) !important;
  --checkbox-marker-color: #dacdcd !important;
  --checklist-done-color: #4e3434 !important;
  --code-background: #b39696 !important;
  --code-border-color: #b18a8a !important;
  --code-bracket-background: rgba(0, 0, 0, 0.075) !important;
  --code-comment: #5a3a3a !important;
  --code-function: #9a8f51 !important;
  --code-important: #a0744b !important;
  --code-keyword: #8d483f !important;
  --code-normal: #4e3434 !important;
  --code-operator: #9a453c !important;
  --code-property: #104d70 !important;
  --code-punctuation: #4e3434 !important;
  --code-string: #61715b !important;
  --code-tag: #9a453c !important;
  --code-value: #5f5170 !important;
  --codeFont: "Monaspace", monospace !important;
  --collapse-icon-color: #5a3a3a !important;
  ...
  --color-base-00: #dacdcd !important;
  --color-base-05: #cabbbb !important;
  --color-base-10: #b39696 !important;
  --color-base-100: #0b0909 !important;
  --color-base-20: #b9a5a5 !important;
  --color-base-25: #bd9898 !important;
  --color-base-30: #b18a8a !important;
  --color-base-35: #5a3a3a !important;
  --color-base-40: #b18a8a !important;
  --color-base-50: #5a3a3a !important;
  --color-base-60: #4e3434 !important;
  --color-base-70: #231a1a !important;
  ...
  --dark: #231a1a !important;
  --darkgray: #231a1a !important;
  --divider-color: #b18a8a !important;
  --divider-color-hover: hsl(4, 90.9%, 60.2%) !important;
  --dropdown-background: #dacdcd !important;
  --dropdown-background-hover: #b39696 !important;
  --embed-block-shadow-hover: 0 0 0 1px #b18a8a,
        inset 0 0 0 1px #b18a8a !important;
  --embed-border-start: 2px solid hsl(4, 90.9%, 60.2%) !important;
  --file-header-background: #dacdcd !important;
  --file-header-background-focused: #dacdcd !important;
  --file-header-font: "Aspekta", sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif !important;
  --file-header-font-size: 14px !important;
  --file-margins: 32px !important;
  --flair-background: #dacdcd !important;
  --flair-color: #231a1a !important;
  --font-interface: "Aspekta", sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif !important;
  --font-interface-theme: "Aspekta", sans-serif !important;
  --font-monospace: "Monaspace", monospace !important;
  --font-ui-medium: 16px !important;
  --font-ui-small: 14px !important;
  --footnote-divider-color: #b18a8a !important;
  --footnote-id-color: #4e3434 !important;
  --footnote-id-color-no-occurrences: #5a3a3a !important;
  --footnote-input-background-active: rgba(0, 0, 0, 0.075) !important;
  --graph-line: #5a3a3a !important;
  --graph-node: #4e3434 !important;
  --graph-node-attachment: hsl(4, 90.9%, 60.2%) !important;
  --graph-node-focused: #b18a8a !important;
  --graph-node-tag: hsl(5, 90%, 56%) !important;
  --graph-node-unresolved: #5a3a3a !important;
  --graph-text: #231a1a !important;
  --gray: #4e3434 !important;
  --h1-color: #0b0909 !important;
  --h1-size: 3.5em !important;
  --h1-weight: 900 !important;
  --h2-size: 1.842em !important;
  --h2-weight: 800 !important;
  ...
  --h6-weight: 500 !important;
  --headerFont: "Aspekta", sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif !important;
  --heading-formatting: #5a3a3a !important;
  --highlight: rgba(0, 0, 0, 0.075) !important;
  --hr-color: #b18a8a !important;
  --icon-color: #4e3434 !important;
  --icon-color-active: hsl(5, 90%, 56%) !important;
  --icon-color-focused: #231a1a !important;
  --icon-color-hover: #4e3434 !important;
  --inline-title-color: #0b0909 !important;
  --inline-title-size: clamp(2.5rem, 8vw - 4rem, 5rem) !important;
  --inline-title-weight: 900 !important;
  --input-date-separator: #5a3a3a !important;
  --input-placeholder-color: #5a3a3a !important;
  ...
  --interactive-hover: #b39696 !important;
  --interactive-normal: #dacdcd !important;
  --light: #dacdcd !important;
  --lightgray: #b9a5a5 !important;
  ...
  --list-indent: 2.25em !important;
  --list-marker-color: #5a3a3a !important;
  --list-marker-color-collapsed: hsl(5, 90%, 56%) !important;
  --list-marker-color-hover: #4e3434 !important;
  --menu-background: #b9a5a5 !important;
  --menu-border-color: #5a3a3a !important;
  --menu-shadow: rgb(0 0 0 / 4%) 0px 3px 5px !important;
  --metadata-border-color: #b18a8a !important;
  --metadata-divider-color: #b18a8a !important;
  --metadata-input-background-active: rgba(0, 0, 0, 0.075) !important;
  --metadata-input-font: "Aspekta", sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif !important;
  --metadata-input-text-color: #231a1a !important;
  --metadata-label-background-active: rgba(0, 0, 0, 0.075) !important;
  --metadata-label-font: "Aspekta", sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif !important;
  --metadata-label-text-color: #4e3434 !important;
  --metadata-label-text-color-hover: #4e3434 !important;
  --metadata-property-background-active: rgba(0, 0, 0, 0.075) !important;
  --metadata-property-box-shadow-focus: 0 0 0 2px #b18a8a !important;
  --metadata-property-box-shadow-hover: 0 0 0 1px #5a3a3a !important;
  --metadata-sidebar-input-font-size: 14px !important;
  --metadata-sidebar-label-font-size: 14px !important;
  --modal-background: #dacdcd !important;
  --modal-border-color: #b18a8a !important;
  --nav-collapse-icon-color: #5a3a3a !important;
  --nav-collapse-icon-color-collapsed: #5a3a3a !important;
  --nav-heading-color: #231a1a !important;
  --nav-heading-color-collapsed: #5a3a3a !important;
  --nav-heading-color-collapsed-hover: #4e3434 !important;
  --nav-heading-color-hover: #231a1a !important;
  ...
  --nav-item-color: #4e3434 !important;
  --nav-item-color-active: #231a1a !important;
  --nav-item-color-highlighted: hsl(5, 90%, 56%) !important;
  --nav-item-color-hover: #231a1a !important;
  --nav-item-color-selected: #231a1a !important;
  --nav-item-size: 14px !important;
  --nav-tag-color: #5a3a3a !important;
  --nav-tag-color-active: #4e3434 !important;
  --nav-tag-color-hover: #4e3434 !important;
  --o-h1-color: #b18a8a !important;
  --o-h2-color: #b18a8a !important;
  --o-h3-color: #b18a8a !important;
  --o-h4-color: #b18a8a !important;
  --o-h5-color: #b18a8a !important;
  --o-h6-color: #b18a8a !important;
  --pdf-background: #dacdcd !important;
  --pdf-page-background: #dacdcd !important;
  --pdf-sidebar-background: #dacdcd !important;
  --pill-border-color: #b18a8a !important;
  --pill-border-color-hover: #5a3a3a !important;
  --pill-color: #4e3434 !important;
  --pill-color-hover: #231a1a !important;
  --pill-color-remove: #5a3a3a !important;
  --pill-color-remove-hover: hsl(5, 90%, 56%) !important;
  --prompt-background: #dacdcd !important;
  --prompt-border-color: #b18a8a !important;
  --raised-background: color-mix(in srgb, #dacdcd 65%, transparent) linear-gradient(#dacdcd, color-mix(in srgb, #dacdcd 65%, transparent)) !important;
  --ribbon-background: #b9a5a5 !important;
  --ribbon-background-collapsed: #dacdcd !important;
  --scrollbar-active-thumb-bg: hsla(5, 90%, 56%, 0.2) !important;
  --scrollbar-thumb-bg: rgba(0, 0, 0, 0.05) !important;
  --search-clear-button-color: #4e3434 !important;
  --search-icon-color: #4e3434 !important;
  --search-result-background: #dacdcd !important;
  --secondary: hsl(5, 90%, 56%) !important;
  --setting-group-heading-color: #231a1a !important;
  --setting-group-heading-size: 16px !important;
  --setting-items-background: #b39696 !important;
  --setting-items-border-color: #b18a8a !important;
  ...
  --shiki-active-tab-border-color: #4e3434 !important;
  --shiki-code-background: #b39696 !important;
  --shiki-code-comment: #5a3a3a !important;
  --shiki-code-function: #61715b !important;
  --shiki-code-important: #a0744b !important;
  --shiki-code-keyword: #8d483f !important;
  --shiki-code-normal: #4e3434 !important;
  --shiki-code-property: #104d70 !important;
  --shiki-code-punctuation: #4e3434 !important;
  --shiki-code-string: #9a8f51 !important;
  --shiki-code-value: #5f5170 !important;
  --shiki-gutter-border-color: #b18a8a !important;
  --shiki-gutter-text-color: #5a3a3a !important;
  --shiki-gutter-text-color-highlight: #4e3434 !important;
  --shiki-highlight-green: rgba(97, 113, 91, 0.5) !important;
  --shiki-highlight-green-background: rgba(97, 113, 91, 0.1) !important;
  --shiki-highlight-neutral: #4e3434 !important;
  --shiki-highlight-red: rgba(154, 69, 60, 0.5) !important;
  --shiki-highlight-red-background: rgba(154, 69, 60, 0.1) !important;
  --shiki-terminal-dots-color: #5a3a3a !important;
  --slider-thumb-border-color: #5a3a3a !important;
  --slider-thumb-radius: 50% !important;
  --slider-track-background: #b18a8a !important;
  --status-bar-background: #b9a5a5 !important;
  --status-bar-border-color: #b18a8a !important;
  --status-bar-scroll-padding: 30px !important;
  --status-bar-text-color: #4e3434 !important;
  --suggestion-background: #dacdcd !important;
  --swatch-height: 24px !important;
  --swatch-width: 24px !important;
  ...
  --tab-background-active: #dacdcd !important;
  --tab-container-background: #b9a5a5 !important;
  --tab-divider-color: #5a3a3a !important;
  --tab-font-size: 14px !important;
  --tab-outline-color: #b18a8a !important;
  --tab-stacked-font-size: 14px !important;
  --tab-switcher-background: #b9a5a5 !important;
  --tab-switcher-menubar-background: linear-gradient(to top, #b9a5a5, transparent) !important;
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(5, 90%, 56%) !important;
  --tab-text-color: #5a3a3a !important;
  --tab-text-color-active: #4e3434 !important;
  --tab-text-color-focused: #4e3434 !important;
  --tab-text-color-focused-active: #4e3434 !important;
  --tab-text-color-focused-active-current: #231a1a !important;
  --tab-text-color-focused-highlighted: hsl(5, 90%, 56%) !important;
  --table-add-button-border-color: #b18a8a !important;
  --table-border-color: #b18a8a !important;
  --table-drag-handle-background-active: hsl(4, 90.9%, 60.2%) !important;
  --table-drag-handle-color: #5a3a3a !important;
  --table-drag-handle-color-active: #0b0909 !important;
  --table-header-border-color: #b18a8a !important;
  --table-header-color: #231a1a !important;
  ...
  --text-faint: #5a3a3a !important;
  --text-muted: #4e3434 !important;
  --text-normal: #231a1a !important;
  --text-on-accent: #0b0909 !important;
  --text-on-button: #dacdcd !important;
  ...
  --titleFont: "Aspekta", sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif !important;
  --titlebar-background: #b9a5a5 !important;
  --titlebar-background-focused: transparent !important;
  --titlebar-border-color: #b18a8a !important;
  --titlebar-text-color: #4e3434 !important;
  --titlebar-text-color-focused: #231a1a !important;
  --transition-duration: 700ms !important;
  --transition-duration-short: 350ms !important;
  --transition-ease: ease !important;
  --transition-props: background 700ms, 
                        border 700ms, 
                        color 700ms !important;
  --vault-name-color: #231a1a !important;
  --vault-name-font-size: 14px !important;
  --vault-name-font-weight: 500 !important;
  --vault-profile-color: #231a1a !important;
  --vault-profile-color-hover: #231a1a !important;
  --vault-profile-font-size: 14px !important;
  --quartz-icon-color: currentColor !important;
}
