...
export const theme: ThemeData = {
  ...
  --light: var(--background-primary, #000);
  --lightgray: var(--background-secondary, #080808);
  ...
  --shiki-code-background: #111;
  --shiki-code-comment: #666;
  --shiki-gutter-border-color: #333;
