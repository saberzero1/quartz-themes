...
html[saved-theme="dark"] body[data-slug] div#quartz-root.page, html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left, html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left:has(.explorer), html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left .explorer .explorer-content {
  --background-modifier-form-field: var(--search-result-background, oklch(from oklch(23.50% 0.0005 190) l 0.0125 h / 0.375));
  --background-modifier-form-field-hover: var(--background-modifier-form-field, oklch(from oklch(23.50% 0.0005 190) l 0.0125 h / 0.375));
  --bases-table-header-background: var(--background-secondary, oklch(27.50% 0.0125 190));
...
html[saved-theme="dark"] body .markdown-rendered p > strong > em, html[saved-theme="dark"] strong > em {
  color: var(--italic-color, oklch(0.9325 0.0005 190));
  font-family: Raveo, Raveo, Inter, ui-sans-serif, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  font-weight: 670;
  outline: oklch(0.9325 0.0005 190) none 0px;
  text-decoration-color: oklch(0.9325 0.0005 190);
...
html[saved-theme="dark"] body del {
  --bold-color: var(--strikethrough-color, oklch(52.50% 0.0200 190));
  --italic-color: var(--strikethrough-color, oklch(52.50% 0.0200 190));
  --text-highlight-bg: var(--hr-color, oklch(100% 0.09375 190 / 0.1));
...
html[saved-theme="dark"] body ol > li {
  --checkbox-color-hover: oklab(from var(--checkbox-color) calc(l * 1.125) a b);
  --list-marker-color: var(--list-bullet-color, oklch(77.50% 0.0125 190));
  color: oklch(0.85 0.0125 190);
  margin-left: 28px;
...
html[saved-theme="dark"] body blockquote {
  --bold-color: var(--blockquote-color, oklch(71.25% 0.0125 190));
  --italic-color: var(--blockquote-color, oklch(71.25% 0.0125 190));
  --math-color: color-mix(in oklab, var(--blockquote-color), var(--color-base-80));
  color: var(--blockquote-color, oklch(0.7125 0.0125 190));
  font-family: Raveo, Raveo, Inter, ui-sans-serif, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  font-weight: 420;
  line-height: 25.6px;
}`,
...
html[saved-theme="dark"] body figure {
  --code-background: var(--ec-frm-edBg, oklch(100% 0.0625 190 / 0.05));
  border-bottom-color: oklch(0.85 0.0125 190);
  border-bottom-left-radius: 6px;
  border-bottom-right-radius: 6px;
  border-left-color: oklch(0.85 0.0125 190);
...
html[saved-theme="dark"] body li.task-list-item[data-task='-'] {
  --bold-color: var(--checklist-done-color, oklch(52.50% 0.0200 190));
  --checkbox-color-hover: oklab(from var(--checkbox-color) calc(l * 1.125) a b);
  --code-normal: var(--checklist-done-color, oklch(52.50% 0.0200 190));
  --italic-color: var(--checklist-done-color, oklch(52.50% 0.0200 190));
  --list-marker-color: var(--list-bullet-color, oklch(77.50% 0.0125 190));
  --text-normal: var(--checklist-done-color, oklch(52.50% 0.0200 190));
  color: oklch(0.525 0.02 190);
...
html[saved-theme="dark"] body .callout > .callout-content {
  ...
  --blockquote-color: var(--color-base-80, oklch(77.50% 0.0125 190));
  --code-background: var(--code-background-alt, oklch(from oklch(23.50% 0.0005 190) l 0.0125 h / 0.375));
  color: oklch(0.85 0.0125 190);
  padding-left: 28px;
}
...
html[saved-theme="dark"] body .callout[data-callout="quote"] {
  ...
  --text-normal: var(--blockquote-color, oklch(71.25% 0.0125 190));
...
html[saved-theme="dark"] body .callout[data-callout="warning"] {
  ...
  --shadow-input: var(--shadow-sidebar, 0px 0px 12px 0px oklch(from oklch(27.50% 0.0125 190) l 0.0125 h / 0.5));
...
html[saved-theme="dark"] body a.internal-link.tag-link, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  --icon-stroke: var(--icon-xs-stroke-width, 2.125px);
  --pill-background: var(--tag-background, hsla(75, 70%, 32%, 0.1));
  --pill-background-hover: var(--tag-background-hover, hsla(75, 70%, 32%, 0.2));
  --pill-border-color: var(--tag-border-color, oklch(from hsl(75, 70%, 32%) l c h / 0.025));
  --pill-border-color-hover: var(--tag-border-color-hover, hsla(75, 70%, 32%, 0.15));
  --pill-color: var(--tag-color, color-mix(in oklab, hsl(75, 70%, 32%) 64%, #fff 36%));
  --pill-color-hover: var(--tag-color-hover, color-mix(in oklab, hsl(75, 70%, 32%) 64%, #fff 36%));
  --pill-color-remove: var(--color-accent-2, color-mix(in oklab, color-mix(in oklab, hsl(75, 70%, 32%) 64%, #fff 36%), transparent 8%));
...
html[saved-theme="dark"] body h1::after {
  --font-weight: var(--h1-weight, 330);
  background: oklch(1 0.09375 190 / 0.1) none repeat scroll 0% 0% / auto padding-box border-box;
...
html[saved-theme="dark"] body h2 {
  ...
  border-bottom-color: oklch(0.8825 0.0005 190);
  border-left-color: oklch(0.8825 0.0005 190);
  border-right-color: oklch(0.8825 0.0005 190);
  border-top-color: oklch(0.8825 0.0005 190);
...
html[saved-theme="dark"] body .nav-files-container li:has(> .folder-outer.open) > .nav-folder-title {
  ...
  --nav-item-color: var(--color-base-80, color-mix(in oklab, hsl(75, 70%, 32%) 64%, #fff 36%));
  --nav-item-color-active: var(--nav-item-color, color-mix(in oklab, hsl(75, 70%, 32%) 64%, #fff 36%));
  --nav-item-color-hover: var(--nav-item-color, color-mix(in oklab, hsl(75, 70%, 32%) 64%, #fff 36%));
...
html[saved-theme="dark"] body footer ul li a {
  --background-modifier-hover: var(--hr-color, oklch(100% 0.09375 190 / 0.1));
