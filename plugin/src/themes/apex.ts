...
export const theme: ThemeData = {
  ...
  --bodyFont: var(--font-text, "Geist Mono", ui-monospace, monospace);
  ...
  --codeFont: var(--font-text, "Geist Mono", ui-monospace, monospace);
  ...
  --h6-line-height: 1.7;
  --h6-size: 16px;
  --headerFont: var(--font-text, "Geist Mono", ui-monospace, monospace);
  --icon-color: #707070;
  ...
  --text-muted: #707070;
  --text-normal: #ccc;
  --titleFont: var(--font-text, "Geist Mono", ui-monospace, monospace);
