...
export const theme: ThemeData = {
  ...
  --shiki-active-tab-border-color: rgba(245, 246, 248, 0.85) !important;
  --shiki-code-background: rgba(79, 145, 232, 0.2) !important;
  --shiki-code-comment: rgba(245, 246, 248, 0.65) !important;
  --shiki-code-function: #5a7a4d !important;
  --shiki-code-important: #b3682a !important;
  --shiki-code-keyword: #b16982 !important;
  --shiki-code-normal: rgba(245, 246, 248, 0.85) !important;
  --shiki-code-property: #438f93 !important;
  --shiki-code-punctuation: rgba(245, 246, 248, 0.85) !important;
  --shiki-code-string: #c29938 !important;
  --shiki-code-value: #5f4a8c !important;
  --shiki-gutter-border-color: #4f91e8 !important;
  --shiki-gutter-text-color: rgba(245, 246, 248, 0.65) !important;
  --shiki-gutter-text-color-highlight: rgba(245, 246, 248, 0.85) !important;
  --shiki-highlight-green: rgba(90, 122, 77, 0.5) !important;
  --shiki-highlight-green-background: rgba(90, 122, 77, 0.1) !important;
  --shiki-highlight-neutral: rgba(245, 246, 248, 0.85) !important;
  --shiki-highlight-red: rgba(138, 46, 46, 0.5) !important;
  --shiki-highlight-red-background: rgba(138, 46, 46, 0.1) !important;
  --shiki-terminal-dots-color: rgba(245, 246, 248, 0.65) !important;
  --shiki-tooltip-background: #2d7be3 !important;
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --shiki-active-tab-border-color: rgba(3, 5, 9, 0.85) !important;
  --shiki-code-background: rgba(110, 110, 236, 0.2) !important;
  --shiki-code-comment: rgba(3, 5, 9, 0.65) !important;
  --shiki-code-function: #719461 !important;
  --shiki-code-important: #db8134 !important;
  --shiki-code-keyword: #dc84a3 !important;
  --shiki-code-normal: rgba(3, 5, 9, 0.85) !important;
  --shiki-code-property: #53b3b8 !important;
  --shiki-code-punctuation: rgba(3, 5, 9, 0.85) !important;
  --shiki-code-string: #f2ba44 !important;
  --shiki-code-value: #775cb0 !important;
  --shiki-gutter-border-color: #6e6eec !important;
  --shiki-gutter-text-color: rgba(3, 5, 9, 0.65) !important;
  --shiki-gutter-text-color-highlight: rgba(3, 5, 9, 0.85) !important;
  --shiki-highlight-green: rgba(113, 148, 97, 0.5) !important;
  --shiki-highlight-green-background: rgba(113, 148, 97, 0.1) !important;
  --shiki-highlight-neutral: rgba(3, 5, 9, 0.85) !important;
  --shiki-highlight-red: rgba(180, 60, 60, 0.5) !important;
  --shiki-highlight-red-background: rgba(180, 60, 60, 0.1) !important;
  --shiki-terminal-dots-color: rgba(3, 5, 9, 0.65) !important;
  --shiki-tooltip-background: #8080ee !important;
