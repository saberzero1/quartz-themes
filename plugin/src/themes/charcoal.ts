...
export const theme: ThemeData = {
  ...
  --dark: var(--text-normal, #959595);
  --darkgray: var(--text-normal, #959595);
  ...
  --graph-text: #959595;
  --gray: var(--text-muted, rgb(109, 109, 109));
  ...
  --highlight: var(--text-highlight-bg, rgba(60, 68, 76, 0.5));
  --hr-color: hsl(0, 0%, 39%);
  ...
  --light: var(--background-primary, #222527);
  --lightgray: var(--background-secondary, #1c1e21);
  ...
  --secondary: var(--text-accent, #9bb7c5);
  ...
  --tertiary: var(--text-accent-hover, rgb(109, 109, 109));
  --text-accent: #9bb7c5;
  ...
  --textHighlight: var(--text-highlight-bg, rgba(60, 68, 76, 0.5));
