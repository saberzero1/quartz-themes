...
export const theme: ThemeData = {
  ...
  --shiki-active-tab-border-color: hsl(48, 40%, 84%) !important;
  --shiki-code-background: hsl(200, 34%, 34%) !important;
  --shiki-code-block-spacing: 0rem !important;
  --shiki-code-comment: hsl(48, 40%, 84%) !important;
  --shiki-code-normal: hsl(48, 40%, 84%) !important;
  --shiki-code-punctuation: hsl(48, 40%, 84%) !important;
  --shiki-gutter-text-color: hsl(48, 40%, 84%) !important;
  --shiki-gutter-text-color-highlight: hsl(48, 40%, 84%) !important;
  --shiki-highlight-neutral: hsl(48, 40%, 84%) !important;
  --shiki-terminal-dots-color: hsl(48, 40%, 84%) !important;
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --shadow-s: none !important;
  --shadow-xs: none !important;
  --shiki-active-tab-border-color: hsl(200, 24%, 24%) !important;
  --shiki-code-background: hsl(48, 30%, 92%) !important;
  --shiki-code-block-spacing: 0rem !important;
  --shiki-code-comment: hsl(200, 24%, 24%) !important;
  --shiki-code-normal: hsl(200, 24%, 24%) !important;
  --shiki-code-punctuation: hsl(200, 24%, 24%) !important;
  --shiki-gutter-text-color: hsl(200, 24%, 24%) !important;
  --shiki-gutter-text-color-highlight: hsl(200, 24%, 24%) !important;
  --shiki-highlight-neutral: hsl(200, 24%, 24%) !important;
  --shiki-terminal-dots-color: hsl(200, 24%, 24%) !important;
  --slider-thumb-y: -7px !important;
