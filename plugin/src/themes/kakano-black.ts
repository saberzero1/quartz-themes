...
html[saved-theme="dark"] body .canvas-sidebar {
  ...
  border-color: color(srgb 0.676 0.676 0.684);
  box-shadow: rgba(5, 5, 5, 0.5) 0px 1px 2px 0px, rgba(5, 5, 5, 0.25) 0px 3.4px 6.7px 0px, rgba(5, 5, 5, 0.15) 0px 15px 30px 0px;
}

html[saved-theme="dark"] body .note-properties {
  background-color: color(srgb 0.038 0.038 0.042);
...
html[saved-theme="dark"] body ul.overflow {
  ...
  color: color(srgb 0.3925 0.3925 0.4075);
}
...
html[saved-theme="dark"] body pre > code > [data-line] {
  border-left-color: color(srgb 0.21 0.209 0.19);
}
...
html[saved-theme="dark"] body pre > code [data-highlighted-chars] {
  border-bottom-color: color(srgb 0.21 0.209 0.19);
  border-left-color: color(srgb 0.21 0.209 0.19);
  border-right-color: color(srgb 0.21 0.209 0.19);
  border-top-color: color(srgb 0.21 0.209 0.19);
}
...
html[saved-theme="dark"] body .search > .search-container > .search-space {
  ...
  border-top-width: 0px;
  box-shadow: color(srgb 0.019 0.019 0.021 / 0.02) 0px 0px 3.2px 0px, color(srgb 0.019 0.019 0.021 / 0.04) 0px 3.2px 6.4px 0px, color(srgb 0.019 0.019 0.021 / 0.06) 0px 6.4px 19.2px 0px, color(srgb 0.019 0.019 0.021 / 0.08) 0px 19.2px 32px 0px, color(srgb 0.019 0.019 0.021 / 0.1) 0px 32px 64px 0px;
}
...
html[saved-theme="dark"] body ::-webkit-scrollbar {
  background: color(srgb 0.0095 0.0095 0.0105) none repeat scroll 0% 0% / auto padding-box border-box;
  background-color: color(srgb 0.0095 0.0095 0.0105);
}
...
html[saved-theme="dark"] body body {
  scrollbar-color: color(srgb 0.19 0.19 0.21 / 0.25) rgba(0, 0, 0, 0);
}`,
...
html[saved-theme="dark"] body li.depth-0 {
  ...
  background-color: color(srgb 0.076 0.076 0.084);
  border-bottom-color: color(srgb 0.676 0.676 0.684);
  border-left-color: color(srgb 0.676 0.676 0.684);
  border-left-width: 0px;
  border-right-color: color(srgb 0.676 0.676 0.684);
...
html[saved-theme="light"] body .canvas-sidebar {
  background-color: color(srgb 0.838 0.838 0.842);
  border-color: color(srgb 0.019 0.019 0.021);
  box-shadow: rgba(12, 12, 14, 0.2) 0px 1px 2px 0px, rgba(12, 12, 13, 0.15) 0px 3.4px 6.7px 0px, rgba(12, 12, 13, 0.05) 0px 15px 30px 0px;
}

html[saved-theme="light"] body .note-properties {
  background-color: color(srgb 0.9595 0.9595 0.9605);
...
html[saved-theme="light"] body .search > .search-container > .search-space {
  ...
  border-top-color: rgba(0, 0, 0, 0);
  border-top-width: 0px;
  box-shadow: color(srgb 0.1425 0.1425 0.1575 / 0.02) 0px 0px 3.2px 0px, color(srgb 0.1425 0.1425 0.1575 / 0.04) 0px 3.2px 6.4px 0px, color(srgb 0.1425 0.1425 0.1575 / 0.06) 0px 6.4px 19.2px 0px, color(srgb 0.1425 0.1425 0.1575 / 0.08) 0px 19.2px 32px 0px, color(srgb 0.1425 0.1425 0.1575 / 0.1) 0px 32px 64px 0px;
}
...
html[saved-theme="light"] body .search > .search-container > .search-space > .search-layout > .results-container {
  color: color(srgb 0.9595 0.9595 0.9605);
}
...
html[saved-theme="light"] body kbd {
  ...
  border-top-style: solid;
  border-top-width: 1px;
  color: color(srgb 0.838 0.838 0.842);
  font-family: "??", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "??", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol";
  font-size: 11.2px;
  padding-bottom: 2px;
  padding-left: 6px;
