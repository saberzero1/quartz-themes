...
export const theme: ThemeData = {
  ...
  --shiki-active-tab-border-color: hsl(260, 97%, 91%) !important;
  --shiki-code-background: hsl(260, 17%, 22%) !important;
  --shiki-code-comment: hsl(260, 97%, 86%) !important;
  --shiki-code-normal: hsl(260, 97%, 91%) !important;
  --shiki-code-punctuation: hsl(260, 97%, 91%) !important;
  --shiki-gutter-border-color: hsl(260, 16%, 35%) !important;
  --shiki-gutter-text-color: hsl(260, 97%, 86%) !important;
  --shiki-gutter-text-color-highlight: hsl(260, 97%, 91%) !important;
  --shiki-highlight-neutral: hsl(260, 97%, 91%) !important;
  --shiki-terminal-dots-color: hsl(260, 97%, 86%) !important;
