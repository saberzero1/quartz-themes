...
export const theme: ThemeData = {
  ...
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(210, 34%, 63%);
  ...
  --color-red: #bf616a;
  --color-yellow: #ebcb8b;
  --dark: var(--text-normal, #d8dee9);
  --dark-gray: #3b4252;
  --darker-white: #e5e9f0;
  --darkest-white: #d8dee9;
  --darkgray: var(--text-normal, #d8dee9);
  ...
  --embed-border-start: 2px solid hsl(210, 34%, 63%);
  ...
  --highlight: var(--text-highlight-bg, hsl(210, 34%, 63%));
  --hr-color: #3b4252;
  --icon-color: #d8dee9;
  --icon-color-active: hsl(210, 34%, 63%);
  ...
  --list-marker-color-collapsed: hsl(210, 34%, 63%);
  ...
  --pill-color-remove-hover: hsl(210, 34%, 63%);
  ...
  --secondary: var(--text-accent, hsl(210, 34%, 63%));
  ...
  --shiki-active-tab-border-color: #d8dee9;
  --shiki-code-background: #3b4252;
  --shiki-code-comment: #616e88;
  --shiki-code-function: #a3be8c;
  --shiki-code-important: #d08770;
  --shiki-code-keyword: pink;
  --shiki-code-normal: #d8dee9;
  --shiki-code-property: #88c0d0;
  --shiki-code-punctuation: #d8dee9;
  --shiki-code-string: #ebcb8b;
  --shiki-code-value: #b48ead;
  --shiki-gutter-border-color: #434c5e;
  --shiki-gutter-text-color: #616e88;
  --shiki-gutter-text-color-highlight: #d8dee9;
  --shiki-highlight-neutral: #d8dee9;
  --shiki-terminal-dots-color: #616e88;
  ...
  --text-error: #bf616a;
  --text-faint: #616e88;
  --text-highlight-bg: hsl(210, 34%, 63%);
  --text-muted: #d8dee9;
  --text-normal: #d8dee9;
  ...
  --text-success: #a3be8c;
  --text-warning: #ebcb8b;
  --textHighlight: var(--text-highlight-bg, hsl(210, 34%, 63%));
