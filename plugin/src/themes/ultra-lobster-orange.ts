...
export const theme: ThemeData = {
  ...
  --bases-table-cell-background-selected: var(--table-selection, hsla(31, 79%, 58%, 0.1));
  ...
  --blockquote-border-color: var(--interactive-accent, hsl(31, 79%, 58%));
  ...
  --checkbox-color: var(--interactive-accent, hsl(31, 79%, 58%));
  --checkbox-color-hover: var(--interactive-accent-hover, #e0de71);
  ...
  --collapse-icon-color-collapsed: var(--color-accent, hsl(31, 79%, 58%));
  --color-accent: hsl(var(--color-orange-hsl));
  --color-accent-1: var(--color-yellow, #e0de71);
  --color-accent-1-rgb: var(--color-yellow-rgb, 224, 222, 113);
  --color-accent-2: hsl(
  ...
  --color-accent-hsl: var(--color-orange-hsl, 31, 79%, 58%);
  --color-accent-rgb: var(--color-orange-rgb, 233, 151, 63);
  ...
  --divider-color-hover: var(--interactive-accent, hsl(31, 79%, 58%));
  ...
  --graph-node-focused: var(--color-accent, hsl(31, 79%, 58%));
  --graph-node-tag: var(--color-accent, hsl(31, 79%, 58%));
  ...
  --icon-color-active: var(--color-accent, hsl(31, 79%, 58%));
  ...
  --interactive-accent: var(--color-accent, hsl(31, 79%, 58%));
  --interactive-accent-hover: var(--color-accent-2, #e0de71);
  --interactive-accent-hsl: var(--color-accent-hsl, 31, 79%, 58%);
  ...
  --link-external-color: var(--color-accent, hsl(31, 79%, 58%));
  ...
  --list-marker-color-collapsed: var(--color-accent, hsl(31, 79%, 58%));
  ...
  --pill-color-remove-hover: var(--text-accent, hsl(31, 79%, 58%));
  ...
  --scrollbar-active-thumb-bg: var(--color-accent, hsl(31, 79%, 58%));
  ...
  --secondary: var(--text-accent, var(--color-accent, hsl(31, 79%, 58%)));
  ...
  --tab-text-color-focused-highlighted: var(--color-accent, hsl(31, 79%, 58%));
  ...
  --table-drag-handle-background-active: var(--table-selection-border-color, hsl(31, 79%, 58%));
  ...
  --table-selection-border-color: var(--interactive-accent, hsl(31, 79%, 58%));
  --tag-color: var(--color-accent, hsl(31, 79%, 58%));
  --tag-color-hover: var(--color-accent, hsl(31, 79%, 58%));
  --tertiary: var(--text-accent-hover, var(--color-accent-2, hsl(
        258 calc(88% + 180) 66%
    )));
  --text-accent: var(--color-accent, hsl(31, 79%, 58%));
  ...
  --text-selection: var(--background-modifier-border, hsla(31, 79%, 58%, 0.33));
...
html[saved-theme="dark"] body li.task-list-item input[type="checkbox"]:checked {
  background-color: var(--color-accent, rgb(233, 151, 63));
...
html[saved-theme="dark"] body p {
  ...
  color: var(--link-external-color, rgb(233, 151, 63));
  font-family: "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  outline: rgb(233, 151, 63) none 0px;
  text-decoration: 13%;
  text-decoration-color: rgb(233, 151, 63);
  text-decoration-thickness: var(--link-decoration-thickness, 13%);
}

html[saved-theme="dark"] body a.internal-link, html[saved-theme="dark"] .breadcrumb-container .breadcrumb-element > a {
  background-color: color(srgb 0.9118 0.59106 0.2482 / 0.1);
  color: var(--color-accent, rgb(233, 151, 63));
  font-family: "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
...
html[saved-theme="dark"] body .callout-title {
  ...
  --background-modifier-active-hover: hsla(31, 79%, 58%, 0.1);
  ...
  --blockquote-border-color: hsl(31, 79%, 58%);
  ...
  --checkbox-color: hsl(31, 79%, 58%);
  --checkbox-color-hover: #e0de71;
  ...
  --collapse-icon-color-collapsed: hsl(31, 79%, 58%);
  --color-accent: hsl(31, 79%, 58%);
  --color-accent-1: #e0de71;
  --color-accent-1-rgb: 224, 222, 113;
  --color-accent-2: hsl(
        258 calc(88% + 180) 66%
    );
  ...
  --graph-node-focused: hsl(31, 79%, 58%);
  --graph-node-tag: hsl(31, 79%, 58%);
  ...
  --hr-color: #313131;
  --interactive-accent: hsl(31, 79%, 58%);
  --interactive-accent-hover: #e0de71;
  --interactive-accent-hsl: 31, 79%, 58%;
  --interactive-hover: #373737;
  --interactive-normal: #1a1a1a;
  --link-color: #666666;
  --link-color-hover: #bababa;
  --link-external-color: hsl(31, 79%, 58%);
  ...
  --scrollbar-active-thumb-bg: hsl(31, 79%, 58%);
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(31, 79%, 58%);
  ...
  --tab-text-color-focused-highlighted: hsl(31, 79%, 58%);
  ...
  --table-drag-handle-background-active: hsl(31, 79%, 58%);
  ...
  --table-selection: hsla(31, 79%, 58%, 0.1);
  --table-selection-blend-mode: lighten;
  --table-selection-border-color: hsl(31, 79%, 58%);
  --table-text-size: 16px;
  --tag-background: hsla(31, 79%, 58%, 0.1);
  --tag-background-hover: hsla(31, 79%, 58%, 0.2);
  --tag-border-color: hsla(31, 79%, 58%, 0.15);
  --tag-border-color-hover: hsla(31, 79%, 58%, 0.15);
  --tag-color: hsl(31, 79%, 58%);
  --tag-color-hover: hsl(31, 79%, 58%);
  --tag-size: 0.875em;
  --text-accent: hsl(31, 79%, 58%);
  ...
  --text-selection: hsla(31, 79%, 58%, 0.33);
  --text-success: #44cf6e;
  --text-warning: #e9973f;
  --touch-radius-l: 52px;
  --touch-radius-m: 44px;
...
html[saved-theme="dark"] body a.internal-link.tag-link, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  --pill-background: var(--tag-background, hsla(31, 79%, 58%, 0.1));
  --pill-background-hover: var(--tag-background-hover, hsla(31, 79%, 58%, 0.2));
  --pill-border-color: var(--tag-border-color, hsla(31, 79%, 58%, 0.15));
  --pill-border-color-hover: var(--tag-border-color-hover, hsla(31, 79%, 58%, 0.15));
  --pill-color: var(--tag-color, hsl(31, 79%, 58%));
  --pill-color-hover: var(--tag-color-hover, hsl(31, 79%, 58%));
  --pill-color-remove: var(--tag-color, hsl(31, 79%, 58%));
  --pill-color-remove-hover: var(--tag-color-hover, hsl(31, 79%, 58%));
  background-color: var(--pill-background, rgba(0, 0, 0, 0));
  border-bottom-color: color(srgb 0.9118 0.59106 0.2482 / 0.4);
  border-bottom-left-radius: 8px;
  border-bottom-right-radius: 8px;
  border-bottom-width: 1px;
  border-left-color: color(srgb 0.9118 0.59106 0.2482 / 0.4);
  border-left-width: 1px;
  border-right-color: color(srgb 0.9118 0.59106 0.2482 / 0.4);
  border-right-width: 1px;
  border-top-color: color(srgb 0.9118 0.59106 0.2482 / 0.4);
  border-top-left-radius: 8px;
  border-top-right-radius: 8px;
  border-top-width: 1px;
  font-family: "??", Instrument, sans-serif, "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
...
html[saved-theme="dark"] body h2::after {
  --focus-ring-color: var(--csstools-light-dark-toggle--23, #0df);
  --font-weight: var(--h2-weight, 600);
  background: rgba(0, 0, 0, 0) linear-gradient(90deg, rgb(233, 151, 63) 0%, color(srgb 0.9118 0.59106 0.2482 / 0.2) 60%, rgba(0, 0, 0, 0) 100%) repeat scroll 0% 0% / auto padding-box border-box;
  background-color: rgba(0, 0, 0, 0);
  background-image: linear-gradient(90deg, rgb(233, 151, 63) 0%, color(srgb 0.9118 0.59106 0.2482 / 0.2) 60%, rgba(0, 0, 0, 0) 100%);
...
html[saved-theme="dark"] body kbd {
  background-color: var(--code-background, color(srgb 0.9118 0.59106 0.2482 / 0.7));
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  border-bottom-color: color(srgb 0.9118 0.59106 0.2482 / 0.3);
  border-bottom-left-radius: 8px;
  border-bottom-right-radius: 8px;
  border-bottom-width: 1px;
  border-left-color: color(srgb 0.9118 0.59106 0.2482 / 0.3);
  border-left-width: 1px;
  border-right-color: color(srgb 0.9118 0.59106 0.2482 / 0.3);
  border-right-width: 1px;
  border-top-color: color(srgb 0.9118 0.59106 0.2482 / 0.3);
  border-top-left-radius: 8px;
  border-top-right-radius: 8px;
  border-top-width: 1px;
  color: var(--color-accent, rgb(233, 151, 63));
  ...
  --bases-table-cell-background-selected: var(--table-selection, hsla(30, 100%, 46%, 0.1));
  ...
  --blockquote-border-color: var(--interactive-accent, hsl(30, 100%, 46%));
  --bodyFont: var(--font-text-theme, var(--ulu-font-general, "Instrument", sans-serif));
  --callout-blend-mode: var(--highlight-mix-blend-mode, normal);
  ...
  --checkbox-color: var(--interactive-accent, hsl(30, 100%, 46%));
  ...
  --collapse-icon-color-collapsed: var(--color-accent, hsl(30, 100%, 46%));
  --color-accent: hsl(var(--color-orange-hsl));
  --color-accent-1: var(--color-yellow, #e0ac00);
  --color-accent-1-rgb: var(--color-yellow-rgb, 224, 172, 0);
  --color-accent-2: hsl(
  ...
  --color-accent-hsl: var(--color-orange-hsl, 30, 100%, 46%);
  --color-accent-rgb: var(--color-orange-rgb, 236, 117, 0);
  ...
  --divider-color-hover: var(--interactive-accent, hsl(30, 100%, 46%));
  ...
  --graph-node-focused: var(--color-accent, hsl(30, 100%, 46%));
  --graph-node-tag: var(--color-accent, hsl(30, 100%, 46%));
  ...
  --icon-color-active: var(--color-accent, hsl(30, 100%, 46%));
  ...
  --interactive-accent: var(--color-accent, hsl(30, 100%, 46%));
  --interactive-accent-hover: var(--color-accent-2, hsl(
        258 88% 71%
    ));
  --interactive-accent-hsl: var(--color-accent-hsl, 30, 100%, 46%);
  ...
  --link-decoration-hover: none;
  --link-decoration-thickness: 13%;
  --link-external-color: var(--color-accent, hsl(30, 100%, 46%));
  --link-external-color-hover: var(--color-accent-hover, hsl(
        258 88% 71%
    ));
  --link-external-decoration: none;
  ...
  --list-marker-color-collapsed: var(--color-accent, hsl(30, 100%, 46%));
  ...
  --pill-color-remove-hover: var(--text-accent, hsl(30, 100%, 46%));
  ...
  --scrollbar-active-thumb-bg: var(--color-accent, hsl(30, 100%, 46%));
  --scrollbar-bg: rgb(from var(--mono-rgb-100) r g b / 0.1);
  ...
  --secondary: var(--text-accent, var(--color-accent, hsl(30, 100%, 46%)));
  ...
  --tab-text-color-focused-highlighted: var(--color-accent, hsl(30, 100%, 46%));
  ...
  --table-drag-handle-background-active: var(--table-selection-border-color, hsl(30, 100%, 46%));
  ...
  --table-selection-border-color: var(--interactive-accent, hsl(30, 100%, 46%));
  --tag-color: var(--color-accent, hsl(30, 100%, 46%));
  --tag-color-hover: var(--color-accent, hsl(30, 100%, 46%));
  --tertiary: var(--text-accent-hover, var(--color-accent-2, hsl(
        258 88% 71%
    )));
  --text-accent: var(--color-accent, hsl(30, 100%, 46%));
  --text-accent-hover: var(--color-accent-2, hsl(
        258 88% 71%
    ));
...
html[saved-theme="light"] body li.task-list-item input[type="checkbox"]:checked {
  background-color: var(--color-accent, rgb(235, 117, 0));
  border-color: rgba(0, 0, 0, 0);
}
...
html[saved-theme="light"] body p {
  ...
  color: var(--link-external-color, rgb(235, 117, 0));
  font-family: "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  outline: rgb(235, 117, 0) none 0px;
  text-decoration: 13%;
  text-decoration-color: rgb(235, 117, 0);
  text-decoration-thickness: var(--link-decoration-thickness, 13%);
}

html[saved-theme="light"] body a.internal-link, html[saved-theme="light"] .breadcrumb-container .breadcrumb-element > a {
  background-color: color(srgb 0.92 0.46 0 / 0.1);
  color: var(--color-accent, rgb(235, 117, 0));
  font-family: "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  font-weight: var(--link-weight, 500);
  outline: rgb(235, 117, 0) none 0px;
  text-decoration-color: rgb(235, 117, 0);
...
html[saved-theme="light"] body .callout-title {
  ...
  --background-modifier-active-hover: hsla(30, 100%, 46%, 0.1);
  ...
  --blockquote-border-color: hsl(30, 100%, 46%);
  ...
  --collapse-icon-color-collapsed: hsl(30, 100%, 46%);
  --color-accent: hsl(30, 100%, 46%);
  --color-accent-1: #e0ac00;
  --color-accent-1-rgb: 224, 172, 0;
  --color-accent-2: hsl(
        258 88% 71%
    );
  --color-accent-hover: hsl(
  ...
  --graph-node-focused: hsl(30, 100%, 46%);
  --graph-node-tag: hsl(30, 100%, 46%);
  ...
  --heading-spacing: 2.5rem;
  --hr-color: #c7c7c7;
  --interactive-accent: hsl(30, 100%, 46%);
  ...
  --link-external-color: hsl(30, 100%, 46%);
  --link-external-color-hover: hsl(
        258 88% 71%
    );
  ...
  --raised-blur: blur(6px) saturate(1.5) brightness(1.15);
  --scrollbar-active-thumb-bg: hsl(30, 100%, 46%);
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(30, 100%, 46%);
  ...
  --tab-text-color-focused-highlighted: hsl(30, 100%, 46%);
  ...
  --table-column-first-border-width: 1px;
  --table-column-last-border-width: 1px;
  --table-drag-handle-background-active: hsl(30, 100%, 46%);
  ...
  --table-row-background-hover: transparent;
  --table-row-last-border-width: 1px;
  --table-selection: hsla(30, 100%, 46%, 0.1);
  --table-selection-blend-mode: darken;
  --table-selection-border-color: hsl(30, 100%, 46%);
  --table-text-size: 16px;
  --tag-background: hsla(30, 100%, 46%, 0.1);
  --tag-background-hover: hsla(30, 100%, 46%, 0.2);
  --tag-border-color: hsla(30, 100%, 46%, 0.15);
  --tag-border-color-hover: hsla(30, 100%, 46%, 0.15);
  --tag-color: hsl(30, 100%, 46%);
  --tag-color-hover: hsl(30, 100%, 46%);
  --tag-size: 0.875em;
  --text-accent: hsl(30, 100%, 46%);
  --text-accent-hover: hsl(
        258 88% 71%
    );
  --text-error: #e93147;
...
html[saved-theme="light"] body a.internal-link.tag-link, html[saved-theme="light"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  --pill-background: var(--tag-background, hsla(30, 100%, 46%, 0.1));
  --pill-background-hover: var(--tag-background-hover, hsla(30, 100%, 46%, 0.2));
  --pill-border-color: var(--tag-border-color, hsla(30, 100%, 46%, 0.15));
  --pill-border-color-hover: var(--tag-border-color-hover, hsla(30, 100%, 46%, 0.15));
  --pill-color: var(--tag-color, hsl(30, 100%, 46%));
  --pill-color-hover: var(--tag-color-hover, hsl(30, 100%, 46%));
  --pill-color-remove: var(--tag-color, hsl(30, 100%, 46%));
  --pill-color-remove-hover: var(--tag-color-hover, hsl(30, 100%, 46%));
  background-color: var(--pill-background, rgba(0, 0, 0, 0));
  border-bottom-color: color(srgb 0.92 0.46 0 / 0.4);
  border-bottom-left-radius: 8px;
  border-bottom-right-radius: 8px;
  border-bottom-width: 1px;
  border-left-color: color(srgb 0.92 0.46 0 / 0.4);
  border-left-width: 1px;
  border-right-color: color(srgb 0.92 0.46 0 / 0.4);
  border-right-width: 1px;
  border-top-color: color(srgb 0.92 0.46 0 / 0.4);
  border-top-left-radius: 8px;
  border-top-right-radius: 8px;
  border-top-width: 1px;
  font-family: "??", Instrument, sans-serif, "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
...
html[saved-theme="light"] body h2::after {
  --focus-ring-color: var(--csstools-light-dark-toggle--23, #0df);
  --font-weight: var(--h2-weight, 600);
  background: rgba(0, 0, 0, 0) linear-gradient(90deg, rgb(235, 117, 0) 0%, color(srgb 0.92 0.46 0 / 0.2) 60%, rgba(0, 0, 0, 0) 100%) repeat scroll 0% 0% / auto padding-box border-box;
  background-color: rgba(0, 0, 0, 0);
  background-image: linear-gradient(90deg, rgb(235, 117, 0) 0%, color(srgb 0.92 0.46 0 / 0.2) 60%, rgba(0, 0, 0, 0) 100%);
  border-bottom-color: rgb(235, 117, 0);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
  border-bottom-width: 0px;
  border-left-color: rgb(235, 117, 0);
  border-left-width: 0px;
  border-right-color: rgb(235, 117, 0);
  border-right-width: 0px;
  border-top-color: rgb(235, 117, 0);
  border-top-left-radius: 0px;
  border-top-right-radius: 0px;
  border-top-width: 0px;
  color: var(--ulu-h2-text-color, var(--h2-color, var(--color-accent)));
...
html[saved-theme="light"] body kbd {
  background-color: var(--code-background, color(srgb 0.92 0.46 0 / 0.7));
  border-bottom-color: rgb(255, 255, 255);
  border-left-color: rgb(255, 255, 255);
  border-right-color: rgb(255, 255, 255);
  border-top-color: rgb(255, 255, 255);
...
html[saved-theme="light"] body ul.tags > li {
  background-color: rgb(from var(--color-accent) r g b/0.05);
  border-bottom-color: color(srgb 0.92 0.46 0 / 0.3);
  border-bottom-left-radius: 8px;
  border-bottom-right-radius: 8px;
  border-bottom-width: 1px;
  border-left-color: color(srgb 0.92 0.46 0 / 0.3);
  border-left-width: 1px;
  border-right-color: color(srgb 0.92 0.46 0 / 0.3);
  border-right-width: 1px;
  border-top-color: color(srgb 0.92 0.46 0 / 0.3);
  border-top-left-radius: 8px;
  border-top-right-radius: 8px;
  border-top-width: 1px;
  color: var(--color-accent, rgb(235, 117, 0));
