...
export const theme: ThemeData = {
  ...
  --bases-table-cell-background-selected: hsla(179, 69%, 60%, 0.1);
  --bases-table-cell-shadow-active: 0 0 0 2px #414141;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(179, 69%, 60%);
  ...
  --embed-border-start: 2px solid hsl(179, 69%, 60%);
  ...
  --hr-color: #313131;
  --icon-color: #666666;
  --icon-color-active: hsl(179, 69%, 60%);
  ...
  --list-marker-color-collapsed: hsl(179, 69%, 60%);
  ...
  --nav-item-background-selected: hsla(179, 69%, 60%, 0.15);
  ...
  --pill-color-remove-hover: hsl(179, 69%, 60%);
  ...
  --secondary: var(--text-accent, hsl(179, 69%, 60%));
...
html[saved-theme="dark"] body ul.tags > li {
  background-color: rgb(from var(--color-accent) r g b/0.05, color(srgb 0.324 0.876 0.8668 / 0.05));
  ...
  --bases-table-cell-background-selected: hsla(179, 100%, 37%, 0.1);
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(179, 100%, 37%);
  ...
  --embed-border-start: 2px solid hsl(179, 100%, 37%);
  ...
  --hr-color: #c7c7c7;
  --icon-color: #ababab;
  --icon-color-active: hsl(179, 100%, 37%);
  ...
  --list-marker-color-collapsed: hsl(179, 100%, 37%);
  ...
  --nav-item-background-selected: hsla(179, 100%, 37%, 0.15);
  ...
  --pill-color-remove-hover: hsl(179, 100%, 37%);
  ...
  --secondary: var(--text-accent, hsl(179, 100%, 37%));
...
html[saved-theme="light"] body ul.tags > li {
  background-color: rgb(from var(--color-accent) r g b/0.05, color(srgb 0 0.74 0.727667 / 0.05));
