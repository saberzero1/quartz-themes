...
export const theme: ThemeData = {
  ...
  --bases-table-cell-background-selected: var(--table-selection, hsla(179, 69%, 60%, 0.1));
  ...
  --blockquote-border-color: var(--interactive-accent, hsl(179, 69%, 60%));
  ...
  --checkbox-color: var(--interactive-accent, hsl(179, 69%, 60%));
  --checkbox-color-hover: var(--interactive-accent-hover, #44cf6e);
  ...
  --collapse-icon-color-collapsed: var(--color-accent, hsl(179, 69%, 60%));
  --color-accent: hsl(var(--color-cyan-hsl));
  --color-accent-1: var(--color-green, #44cf6e);
  --color-accent-1-rgb: var(--color-green-rgb, 68, 207, 110);
  --color-accent-2: hsl(
  ...
  --color-accent-hsl: var(--color-cyan-hsl, 179, 69%, 60%);
  --color-accent-rgb: var(--color-cyan-rgb, 83, 223, 221);
  ...
  --divider-color-hover: var(--interactive-accent, hsl(179, 69%, 60%));
  ...
  --graph-node-focused: var(--color-accent, hsl(179, 69%, 60%));
  --graph-node-tag: var(--color-accent, hsl(179, 69%, 60%));
  ...
  --icon-color-active: var(--color-accent, hsl(179, 69%, 60%));
  ...
  --interactive-accent: var(--color-accent, hsl(179, 69%, 60%));
  --interactive-accent-hover: var(--color-accent-2, #44cf6e);
  --interactive-accent-hsl: var(--color-accent-hsl, 179, 69%, 60%);
  ...
  --link-external-color: var(--color-accent, hsl(179, 69%, 60%));
  ...
  --list-marker-color-collapsed: var(--color-accent, hsl(179, 69%, 60%));
  ...
  --pill-color-remove-hover: var(--text-accent, hsl(179, 69%, 60%));
  ...
  --scrollbar-active-thumb-bg: var(--color-accent, hsl(179, 69%, 60%));
  ...
  --secondary: var(--text-accent, var(--color-accent, hsl(179, 69%, 60%)));
  ...
  --tab-text-color-focused-highlighted: var(--color-accent, hsl(179, 69%, 60%));
  ...
  --table-drag-handle-background-active: var(--table-selection-border-color, hsl(179, 69%, 60%));
  ...
  --table-selection-border-color: var(--interactive-accent, hsl(179, 69%, 60%));
  --tag-color: var(--color-accent, hsl(179, 69%, 60%));
  --tag-color-hover: var(--color-accent, hsl(179, 69%, 60%));
  --tertiary: var(--text-accent-hover, var(--color-accent-2, hsl(
        258 calc(88% + 180) 66%
    )));
  --text-accent: var(--color-accent, hsl(179, 69%, 60%));
  ...
  --text-selection: var(--background-modifier-border, hsla(179, 69%, 60%, 0.33));
...
html[saved-theme="dark"] body li.task-list-item input[type="checkbox"]:checked {
  background-color: var(--color-accent, rgb(83, 223, 221));
...
html[saved-theme="dark"] body p {
  ...
  color: var(--link-external-color, rgb(83, 223, 221));
  font-family: "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
...
html[saved-theme="dark"] body a.internal-link, html[saved-theme="dark"] .breadcrumb-container .breadcrumb-element > a {
  background-color: color(srgb 0.324 0.876 0.8668 / 0.1);
  color: var(--color-accent, rgb(83, 223, 221));
  font-family: "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
...
html[saved-theme="dark"] body .callout-title {
  ...
  --background-modifier-active-hover: hsla(179, 69%, 60%, 0.1);
  ...
  --blockquote-border-color: hsl(179, 69%, 60%);
  ...
  --checkbox-color: hsl(179, 69%, 60%);
  --checkbox-color-hover: #44cf6e;
  ...
  --collapse-icon-color-collapsed: hsl(179, 69%, 60%);
  --color-accent: hsl(179, 69%, 60%);
  --color-accent-1: #44cf6e;
  --color-accent-1-rgb: 68, 207, 110;
  --color-accent-2: hsl(
        258 calc(88% + 180) 66%
    );
  ...
  --graph-node-focused: hsl(179, 69%, 60%);
  --graph-node-tag: hsl(179, 69%, 60%);
  ...
  --hr-color: #313131;
  --interactive-accent: hsl(179, 69%, 60%);
  --interactive-accent-hover: #44cf6e;
  --interactive-accent-hsl: 179, 69%, 60%;
  --interactive-hover: #373737;
  --interactive-normal: #1a1a1a;
  --link-color: #666666;
  --link-color-hover: #bababa;
  --link-external-color: hsl(179, 69%, 60%);
  ...
  --scrollbar-active-thumb-bg: hsl(179, 69%, 60%);
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(179, 69%, 60%);
  ...
  --tab-text-color-focused-highlighted: hsl(179, 69%, 60%);
  ...
  --table-drag-handle-background-active: hsl(179, 69%, 60%);
  ...
  --table-selection: hsla(179, 69%, 60%, 0.1);
  --table-selection-blend-mode: lighten;
  --table-selection-border-color: hsl(179, 69%, 60%);
  --table-text-size: 16px;
  --tag-background: hsla(179, 69%, 60%, 0.1);
  --tag-background-hover: hsla(179, 69%, 60%, 0.2);
  --tag-border-color: hsla(179, 69%, 60%, 0.15);
  --tag-border-color-hover: hsla(179, 69%, 60%, 0.15);
  --tag-color: hsl(179, 69%, 60%);
  --tag-color-hover: hsl(179, 69%, 60%);
  --tag-size: 0.875em;
  --text-accent: hsl(179, 69%, 60%);
  ...
  --text-selection: hsla(179, 69%, 60%, 0.33);
  --text-success: #44cf6e;
  --text-warning: #e9973f;
  --touch-radius-l: 52px;
  --touch-radius-m: 44px;
...
html[saved-theme="dark"] body a.internal-link.tag-link, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  --pill-background: var(--tag-background, hsla(179, 69%, 60%, 0.1));
  --pill-background-hover: var(--tag-background-hover, hsla(179, 69%, 60%, 0.2));
  --pill-border-color: var(--tag-border-color, hsla(179, 69%, 60%, 0.15));
  --pill-border-color-hover: var(--tag-border-color-hover, hsla(179, 69%, 60%, 0.15));
  --pill-color: var(--tag-color, hsl(179, 69%, 60%));
  --pill-color-hover: var(--tag-color-hover, hsl(179, 69%, 60%));
  --pill-color-remove: var(--tag-color, hsl(179, 69%, 60%));
  --pill-color-remove-hover: var(--tag-color-hover, hsl(179, 69%, 60%));
  background-color: var(--pill-background, rgba(0, 0, 0, 0));
  border-bottom-color: color(srgb 0.324 0.876 0.8668 / 0.4);
  border-bottom-left-radius: 8px;
  border-bottom-right-radius: 8px;
  border-bottom-width: 1px;
  border-left-color: color(srgb 0.324 0.876 0.8668 / 0.4);
  border-left-width: 1px;
  border-right-color: color(srgb 0.324 0.876 0.8668 / 0.4);
  border-right-width: 1px;
  border-top-color: color(srgb 0.324 0.876 0.8668 / 0.4);
  border-top-left-radius: 8px;
  border-top-right-radius: 8px;
  border-top-width: 1px;
  color: var(--text-normal, rgb(186, 186, 186));
...
html[saved-theme="dark"] body h2::after {
  --font-weight: var(--h2-weight, 600);
  background: rgba(0, 0, 0, 0) linear-gradient(90deg, rgb(83, 223, 221) 0%, color(srgb 0.324 0.876 0.8668 / 0.2) 60%, rgba(0, 0, 0, 0) 100%) repeat scroll 0% 0% / auto padding-box border-box;
  background-color: rgba(0, 0, 0, 0);
  background-image: linear-gradient(90deg, rgb(83, 223, 221) 0%, color(srgb 0.324 0.876 0.8668 / 0.2) 60%, rgba(0, 0, 0, 0) 100%);
  border-bottom-color: rgb(83, 223, 221);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
  border-bottom-width: 0px;
...
html[saved-theme="dark"] body kbd {
  background-color: var(--code-background, color(srgb 0.324 0.876 0.8668 / 0.7));
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  border-bottom-color: color(srgb 0.324 0.876 0.8668 / 0.3);
  border-bottom-left-radius: 8px;
  border-bottom-right-radius: 8px;
  border-bottom-width: 1px;
  border-left-color: color(srgb 0.324 0.876 0.8668 / 0.3);
  border-left-width: 1px;
  border-right-color: color(srgb 0.324 0.876 0.8668 / 0.3);
  border-right-width: 1px;
  border-top-color: color(srgb 0.324 0.876 0.8668 / 0.3);
  border-top-left-radius: 8px;
  border-top-right-radius: 8px;
  border-top-width: 1px;
  color: var(--color-accent, rgb(83, 223, 221));
  ...
  --bases-table-cell-background-selected: var(--table-selection, hsla(179, 100%, 37%, 0.1));
  ...
  --blockquote-border-color: var(--interactive-accent, hsl(179, 100%, 37%));
  --bodyFont: var(--font-text-theme, var(--ulu-font-general, "Instrument", sans-serif));
  --callout-blend-mode: var(--highlight-mix-blend-mode, normal);
  ...
  --checkbox-color: var(--interactive-accent, hsl(179, 100%, 37%));
  ...
  --collapse-icon-color-collapsed: var(--color-accent, hsl(179, 100%, 37%));
  --color-accent: hsl(var(--color-cyan-hsl));
  --color-accent-1: var(--color-green, #08b94e);
  --color-accent-1-rgb: var(--color-green-rgb, 8, 185, 78);
  --color-accent-2: hsl(
  ...
  --color-accent-hsl: var(--color-cyan-hsl, 179, 100%, 37%);
  --color-accent-rgb: var(--color-cyan-rgb, 0, 191, 188);
  ...
  --divider-color-hover: var(--interactive-accent, hsl(179, 100%, 37%));
  ...
  --graph-node-focused: var(--color-accent, hsl(179, 100%, 37%));
  --graph-node-tag: var(--color-accent, hsl(179, 100%, 37%));
  ...
  --icon-color-active: var(--color-accent, hsl(179, 100%, 37%));
  ...
  --interactive-accent: var(--color-accent, hsl(179, 100%, 37%));
  --interactive-accent-hover: var(--color-accent-2, hsl(
        258 88% 71%
    ));
  --interactive-accent-hsl: var(--color-accent-hsl, 179, 100%, 37%);
  ...
  --link-decoration-hover: none;
  --link-decoration-thickness: 13%;
  --link-external-color: var(--color-accent, hsl(179, 100%, 37%));
  --link-external-color-hover: var(--color-accent-hover, hsl(
        258 88% 71%
    ));
  --link-external-decoration: none;
  ...
  --list-marker-color-collapsed: var(--color-accent, hsl(179, 100%, 37%));
  ...
  --pill-color-remove-hover: var(--text-accent, hsl(179, 100%, 37%));
  ...
  --scrollbar-active-thumb-bg: var(--color-accent, hsl(179, 100%, 37%));
  --scrollbar-bg: rgb(from var(--mono-rgb-100) r g b / 0.1);
  ...
  --secondary: var(--text-accent, var(--color-accent, hsl(179, 100%, 37%)));
  ...
  --tab-text-color-focused-highlighted: var(--color-accent, hsl(179, 100%, 37%));
  ...
  --table-drag-handle-background-active: var(--table-selection-border-color, hsl(179, 100%, 37%));
  ...
  --table-selection-border-color: var(--interactive-accent, hsl(179, 100%, 37%));
  --tag-color: var(--color-accent, hsl(179, 100%, 37%));
  --tag-color-hover: var(--color-accent, hsl(179, 100%, 37%));
  --tertiary: var(--text-accent-hover, var(--color-accent-2, hsl(
        258 88% 71%
    )));
  --text-accent: var(--color-accent, hsl(179, 100%, 37%));
  --text-accent-hover: var(--color-accent-2, hsl(
        258 88% 71%
    ));
...
html[saved-theme="light"] body li.task-list-item input[type="checkbox"]:checked {
  background-color: var(--color-accent, rgb(0, 189, 186));
  border-color: rgba(0, 0, 0, 0);
}
...
html[saved-theme="light"] body p {
  ...
  color: var(--link-external-color, rgb(0, 189, 186));
  font-family: "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  outline: rgb(0, 189, 186) none 0px;
  text-decoration: 13%;
  text-decoration-color: rgb(0, 189, 186);
  text-decoration-thickness: var(--link-decoration-thickness, 13%);
}

html[saved-theme="light"] body a.internal-link, html[saved-theme="light"] .breadcrumb-container .breadcrumb-element > a {
  background-color: color(srgb 0 0.74 0.727667 / 0.1);
  color: var(--color-accent, rgb(0, 189, 186));
  font-family: "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  font-weight: var(--link-weight, 500);
  outline: rgb(0, 189, 186) none 0px;
  text-decoration-color: rgb(0, 189, 186);
...
html[saved-theme="light"] body .callout-title {
  ...
  --background-modifier-active-hover: hsla(179, 100%, 37%, 0.1);
  ...
  --blockquote-border-color: hsl(179, 100%, 37%);
  ...
  --collapse-icon-color-collapsed: hsl(179, 100%, 37%);
  --color-accent: hsl(179, 100%, 37%);
  --color-accent-1: #08b94e;
  --color-accent-1-rgb: 8, 185, 78;
  --color-accent-2: hsl(
        258 88% 71%
    );
  --color-accent-hover: hsl(
  ...
  --color-accent-hsl: 179, 100%, 37%;
  --color-accent-rgb: 0, 191, 188;
  --color-base-00: #fff;
  --color-base-10: #ededed;
  --color-base-20: #f3f3f3;
  --divider-color: #c7c7c7;
  --divider-color-hover: hsl(179, 100%, 37%);
  --divider-vertical-height: 100%;
  ...
  --graph-node-focused: hsl(179, 100%, 37%);
  --graph-node-tag: hsl(179, 100%, 37%);
  ...
  --heading-spacing: 2.5rem;
  --hr-color: #c7c7c7;
  --interactive-accent: hsl(179, 100%, 37%);
  ...
  --link-external-color: hsl(179, 100%, 37%);
  --link-external-color-hover: hsl(
        258 88% 71%
    );
  ...
  --raised-blur: blur(6px) saturate(1.5) brightness(1.15);
  --scrollbar-active-thumb-bg: hsl(179, 100%, 37%);
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(179, 100%, 37%);
  ...
  --tab-text-color-focused-highlighted: hsl(179, 100%, 37%);
  ...
  --table-column-first-border-width: 1px;
  --table-column-last-border-width: 1px;
  --table-drag-handle-background-active: hsl(179, 100%, 37%);
  ...
  --table-row-background-hover: transparent;
  --table-row-last-border-width: 1px;
  --table-selection: hsla(179, 100%, 37%, 0.1);
  --table-selection-blend-mode: darken;
  --table-selection-border-color: hsl(179, 100%, 37%);
  --table-text-size: 16px;
  --tag-background: hsla(179, 100%, 37%, 0.1);
  --tag-background-hover: hsla(179, 100%, 37%, 0.2);
  --tag-border-color: hsla(179, 100%, 37%, 0.15);
  --tag-border-color-hover: hsla(179, 100%, 37%, 0.15);
  --tag-color: hsl(179, 100%, 37%);
  --tag-color-hover: hsl(179, 100%, 37%);
  --tag-size: 0.875em;
  --text-accent: hsl(179, 100%, 37%);
  --text-accent-hover: hsl(
        258 88% 71%
    );
  --text-error: #e93147;
...
html[saved-theme="light"] body a.internal-link.tag-link, html[saved-theme="light"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  --pill-background: var(--tag-background, hsla(179, 100%, 37%, 0.1));
  --pill-background-hover: var(--tag-background-hover, hsla(179, 100%, 37%, 0.2));
  --pill-border-color: var(--tag-border-color, hsla(179, 100%, 37%, 0.15));
  --pill-border-color-hover: var(--tag-border-color-hover, hsla(179, 100%, 37%, 0.15));
  --pill-color: var(--tag-color, hsl(179, 100%, 37%));
  --pill-color-hover: var(--tag-color-hover, hsl(179, 100%, 37%));
  --pill-color-remove: var(--tag-color, hsl(179, 100%, 37%));
  --pill-color-remove-hover: var(--tag-color-hover, hsl(179, 100%, 37%));
  background-color: var(--pill-background, rgba(0, 0, 0, 0));
  border-bottom-color: color(srgb 0 0.74 0.727667 / 0.4);
  border-bottom-left-radius: 8px;
  border-bottom-right-radius: 8px;
  border-bottom-width: 1px;
  border-left-color: color(srgb 0 0.74 0.727667 / 0.4);
  border-left-width: 1px;
  border-right-color: color(srgb 0 0.74 0.727667 / 0.4);
  border-right-width: 1px;
  border-top-color: color(srgb 0 0.74 0.727667 / 0.4);
  border-top-left-radius: 8px;
  border-top-right-radius: 8px;
  border-top-width: 1px;
  color: var(--text-normal, rgb(90, 90, 90));
...
html[saved-theme="light"] body h2 {
  --font-weight: var(--h2-weight, 600);
  border-bottom-color: rgb(0, 189, 186);
  border-left-color: rgb(0, 189, 186);
  border-right-color: rgb(0, 189, 186);
  border-top-color: rgb(0, 189, 186);
  color: var(--ulu-h2-text-color, var(--h2-color, var(--color-accent)));
  font-family: var(--h2-font, "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  font-size: var(--h2-size, 24px);
  font-weight: var(--font-weight, 600);
...
html[saved-theme="light"] body h2::after {
  --font-weight: var(--h2-weight, 600);
  background: rgba(0, 0, 0, 0) linear-gradient(90deg, rgb(0, 189, 186) 0%, color(srgb 0 0.74 0.727667 / 0.2) 60%, rgba(0, 0, 0, 0) 100%) repeat scroll 0% 0% / auto padding-box border-box;
  background-color: rgba(0, 0, 0, 0);
  background-image: linear-gradient(90deg, rgb(0, 189, 186) 0%, color(srgb 0 0.74 0.727667 / 0.2) 60%, rgba(0, 0, 0, 0) 100%);
  border-bottom-color: rgb(0, 189, 186);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
  border-bottom-width: 0px;
...
html[saved-theme="light"] body kbd {
  background-color: var(--code-background, color(srgb 0 0.74 0.727667 / 0.7));
  border-bottom-color: rgb(255, 255, 255);
  border-left-color: rgb(255, 255, 255);
  border-right-color: rgb(255, 255, 255);
  border-top-color: rgb(255, 255, 255);
...
html[saved-theme="light"] body ul.tags > li {
  background-color: rgb(from var(--color-accent) r g b/0.05);
  border-bottom-color: color(srgb 0 0.74 0.727667 / 0.3);
  border-bottom-left-radius: 8px;
  border-bottom-right-radius: 8px;
  border-bottom-width: 1px;
  border-left-color: color(srgb 0 0.74 0.727667 / 0.3);
  border-left-width: 1px;
  border-right-color: color(srgb 0 0.74 0.727667 / 0.3);
  border-right-width: 1px;
  border-top-color: color(srgb 0 0.74 0.727667 / 0.3);
  border-top-left-radius: 8px;
  border-top-right-radius: 8px;
  border-top-width: 1px;
  color: var(--color-accent, rgb(0, 189, 186));
