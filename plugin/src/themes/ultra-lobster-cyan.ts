...
export const theme: ThemeData = {
  ...
  --background-modifier-active-hover: hsla(179, 69%, 60%, 0.1) !important;
  ...
  --bases-table-cell-background-selected: hsla(179, 69%, 60%, 0.1) !important;
  --bases-table-cell-shadow-active: 0 0 0 2px #414141 !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(179, 69%, 60%) !important;
  ...
  --blockquote-border-color: hsl(179, 69%, 60%) !important;
  ...
  --checkbox-color: hsl(179, 69%, 60%) !important;
  --checkbox-color-hover: #44cf6e !important;
  ...
  --collapse-icon-color-collapsed: hsl(179, 69%, 60%) !important;
  --color-accent: hsl(179, 69%, 60%) !important;
  --color-accent-1: #44cf6e !important;
  --color-accent-1-rgb: 68, 207, 110 !important;
  --color-accent-2: hsl(
        258 calc(88% + 180) 66%
    ) !important;
  ...
  --color-accent-hsl: 179, 69%, 60% !important;
  --color-accent-rgb: 83, 223, 221 !important;
  ...
  --divider-color-hover: hsl(179, 69%, 60%) !important;
  ...
  --embed-border-start: 2px solid hsl(179, 69%, 60%) !important;
  ...
  --graph-node-focused: hsl(179, 69%, 60%) !important;
  --graph-node-tag: hsl(179, 69%, 60%) !important;
  ...
  --icon-color-active: hsl(179, 69%, 60%) !important;
  ...
  --interactive-accent: hsl(179, 69%, 60%) !important;
  --interactive-accent-hover: #44cf6e !important;
  --interactive-accent-hsl: 179, 69%, 60% !important;
  ...
  --link-external-color: hsl(179, 69%, 60%) !important;
  ...
  --list-marker-color-collapsed: hsl(179, 69%, 60%) !important;
  ...
  --nav-item-background-selected: hsla(179, 69%, 60%, 0.15) !important;
  ...
  --pill-color-remove-hover: hsl(179, 69%, 60%) !important;
  ...
  --scrollbar-active-thumb-bg: hsl(179, 69%, 60%) !important;
  ...
  --secondary: hsl(179, 69%, 60%) !important;
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(179, 69%, 60%) !important;
  ...
  --tab-text-color-focused-highlighted: hsl(179, 69%, 60%) !important;
  --table-add-button-border-color: #313131 !important;
  --table-border-color: #313131 !important;
  --table-drag-handle-background-active: hsl(179, 69%, 60%) !important;
  --table-drag-handle-color: #999999 !important;
  --table-header-border-color: #313131 !important;
  --table-header-color: #bababa !important;
  --table-selection: hsla(179, 69%, 60%, 0.1) !important;
  --table-selection-border-color: hsl(179, 69%, 60%) !important;
  --tag-background: hsla(179, 69%, 60%, 0.1) !important;
  --tag-background-hover: hsla(179, 69%, 60%, 0.2) !important;
  --tag-border-color: hsla(179, 69%, 60%, 0.15) !important;
  --tag-border-color-hover: hsla(179, 69%, 60%, 0.15) !important;
  --tag-color: hsl(179, 69%, 60%) !important;
  --tag-color-hover: hsl(179, 69%, 60%) !important;
  --tertiary: hsl(
        258 calc(88% + 180) 66%
    ) !important;
  --text-accent: hsl(179, 69%, 60%) !important;
  ...
  --text-selection: hsla(179, 69%, 60%, 0.33) !important;
...
html[saved-theme="dark"] body kbd {
  background-color: color(srgb 0.324 0.876 0.8668 / 0.7);
...
html[saved-theme="dark"] body ul.tags > li {
  background-color: color(srgb 0.324 0.876 0.8668 / 0.05);
  ...
  --background-modifier-active-hover: hsla(179, 100%, 37%, 0.1) !important;
  ...
  --bases-table-cell-background-selected: hsla(179, 100%, 37%, 0.1) !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(179, 100%, 37%) !important;
  ...
  --blockquote-border-color: hsl(179, 100%, 37%) !important;
  ...
  --checkbox-color: hsl(179, 100%, 37%) !important;
  ...
  --collapse-icon-color-collapsed: hsl(179, 100%, 37%) !important;
  --color-accent: hsl(179, 100%, 37%) !important;
  --color-accent-1: #08b94e !important;
  --color-accent-1-rgb: 8, 185, 78 !important;
  --color-accent-2: hsl(
        258 88% 71%
    ) !important;
  --color-accent-hover: hsl(
  ...
  --color-accent-hsl: 179, 100%, 37% !important;
  --color-accent-rgb: 0, 191, 188 !important;
  ...
  --divider-color-hover: hsl(179, 100%, 37%) !important;
  ...
  --embed-border-start: 2px solid hsl(179, 100%, 37%) !important;
  ...
  --graph-node-focused: hsl(179, 100%, 37%) !important;
  --graph-node-tag: hsl(179, 100%, 37%) !important;
  ...
  --icon-color-active: hsl(179, 100%, 37%) !important;
  ...
  --interactive-accent: hsl(179, 100%, 37%) !important;
  ...
  --link-decoration-hover: none !important;
  --link-decoration-thickness: 13% !important;
  --link-external-color: hsl(179, 100%, 37%) !important;
  --link-external-color-hover: hsl(
        258 88% 71%
    ) !important;
  --link-external-decoration: none !important;
  ...
  --list-marker-color-collapsed: hsl(179, 100%, 37%) !important;
  ...
  --nav-item-background-selected: hsla(179, 100%, 37%, 0.15) !important;
  ...
  --pill-color-remove-hover: hsl(179, 100%, 37%) !important;
  ...
  --scrollbar-active-thumb-bg: hsl(179, 100%, 37%) !important;
  ...
  --secondary: hsl(179, 100%, 37%) !important;
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(179, 100%, 37%) !important;
  ...
  --tab-text-color-focused-highlighted: hsl(179, 100%, 37%) !important;
  --table-add-button-border-color: #c7c7c7 !important;
  --table-border-color: #c7c7c7 !important;
  --table-drag-handle-background-active: hsl(179, 100%, 37%) !important;
  --table-drag-handle-color: #707070 !important;
  --table-header-border-color: #c7c7c7 !important;
  --table-header-color: #5a5a5a !important;
  --table-selection: hsla(179, 100%, 37%, 0.1) !important;
  --table-selection-border-color: hsl(179, 100%, 37%) !important;
  --tag-background: hsla(179, 100%, 37%, 0.1) !important;
  --tag-background-hover: hsla(179, 100%, 37%, 0.2) !important;
  --tag-border-color: hsla(179, 100%, 37%, 0.15) !important;
  --tag-border-color-hover: hsla(179, 100%, 37%, 0.15) !important;
  --tag-color: hsl(179, 100%, 37%) !important;
  --tag-color-hover: hsl(179, 100%, 37%) !important;
  --tertiary: hsl(
        258 88% 71%
    ) !important;
  --text-accent: hsl(179, 100%, 37%) !important;
  --text-accent-hover: hsl(
        258 88% 71%
    ) !important;
...
html[saved-theme="light"] body li.task-list-item input[type="checkbox"]:checked {
  background-color: rgb(0, 189, 186);
  border-color: rgba(0, 0, 0, 0);
}
...
html[saved-theme="light"] body kbd {
  background-color: color(srgb 0 0.74 0.727667 / 0.7);
  border-bottom-color: rgb(255, 255, 255);
  border-left-color: rgb(255, 255, 255);
  border-right-color: rgb(255, 255, 255);
  border-top-color: rgb(255, 255, 255);
...
html[saved-theme="light"] body ul.tags > li {
  background-color: color(srgb 0 0.74 0.727667 / 0.05);
