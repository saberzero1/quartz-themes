...
export const theme: ThemeData = {
  ...
  --bodyFont: var(--font-text, Courier New, monospace, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  ...
  --codeFont: var(--font-text, Courier New, monospace, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  --collapse-icon-color: #AA4400;
  --dark: var(--text-normal, #FF6600);
  --dark-gray: #1A1A1A;
  --darkgray: var(--text-normal, #FF6600);
  ...
  --graph-text: #FF6600;
  --gray: var(--text-muted, #CC5500);
  --headerFont: var(--font-text, Courier New, monospace, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  ...
  --light-gray: #4D4D4D;
  --lightgray: var(--background-secondary, #0A0A0A);
  ...
  --secondary: var(--interactive-accent, #FF8533);
  --setting-group-heading-color: #FF6600;
  --setting-items-border-color: #AA4400;
  --shiki-active-tab-border-color: #CC5500;
  --shiki-code-comment: #AA4400;
  --shiki-code-normal: #CC5500;
  --shiki-code-punctuation: #CC5500;
  --shiki-gutter-border-color: #AA4400;
  --shiki-gutter-text-color: #AA4400;
  --shiki-gutter-text-color-highlight: #CC5500;
  --shiki-highlight-neutral: #CC5500;
  --shiki-terminal-dots-color: #AA4400;
  ...
  --text-muted: #CC5500;
  --text-normal: #FF6600;
  --titleFont: var(--font-text, Courier New, monospace, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
...
html[saved-theme="dark"] body sup {
  ...
  --interactive-hover: #FF6600;
  --interactive-normal: #CC5500;
  --light: var(--background-primary, #E5E5E5);
  --light-gray: #4D4D4D;
