...
html[saved-theme="dark"] body pre > code > [data-line] {
  border-left-color: color(srgb 0.765 0.7335 0.135);
}
...
html[saved-theme="dark"] body pre > code [data-highlighted-chars] {
  border-bottom-color: color(srgb 0.765 0.7335 0.135);
  border-left-color: color(srgb 0.765 0.7335 0.135);
  border-right-color: color(srgb 0.765 0.7335 0.135);
  border-top-color: color(srgb 0.765 0.7335 0.135);
}
...
html[saved-theme="dark"] body ::-webkit-scrollbar {
  background: color(srgb 0.03825 0.03405 0.00675) none repeat scroll 0% 0% / auto padding-box border-box;
  background-color: color(srgb 0.03825 0.03405 0.00675);
}
