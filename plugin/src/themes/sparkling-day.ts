...
export const theme: ThemeData = {
  ...
  --cool-gray: #7C809B;
  --dark: var(--text-normal, #121019);
  --dark-purple: #242032;
  --darkgray: var(--text-normal, #121019);
  ...
  --italic: #FF3366;
  --light: var(--background-primary, #FCFCFC);
  ...
  --secondary: var(--text-accent, #FF3366);
  ...
  --tags-color: #FF3366;
  --tertiary: var(--text-accent, #FF3366);
  --text-accent: #FF3366;
  --text-normal: #121019;
