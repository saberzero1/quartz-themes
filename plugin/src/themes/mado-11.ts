...
export const theme: ThemeData = {
  ...
  --background-modifier-active-hover: rgba(68, 158, 248, 0.1) !important;
  ...
  --bases-table-cell-background-selected: rgba(68, 158, 248, 0.1) !important;
  ...
  --checkbox-color-hover: rgb(67, 159, 234) !important;
  ...
  --collapse-icon-color-collapsed: rgb(67, 159, 234) !important;
  --color-accent: hsl(210, 106%, 65%) !important;
  --color-accent-1: rgb(67, 159, 234) !important;
  --color-accent-2: rgb(71, 163, 255) !important;
  ...
  --color-base-00-trans-alt: rgba(28, 32, 39, 0.8) !important;
  ...
  --graph-node-focused: rgb(67, 159, 234) !important;
  ...
  --icon-color-active: rgb(67, 159, 234) !important;
  ...
  --interactive-accent-hover: rgb(67, 159, 234) !important;
  ...
  --link-color: rgb(67, 159, 234) !important;
  --link-color-hover: rgb(71, 163, 255) !important;
  --link-external-color: rgb(67, 159, 234) !important;
  --link-external-color-hover: rgb(71, 163, 255) !important;
  --link-unresolved-color: rgb(67, 159, 234) !important;
  --link-unresolved-decoration-color: rgba(68, 158, 248, 0.3) !important;
  --list-indent: 37px !important;
  --list-marker-color: rgba(105, 122, 150, 0.7) !important;
  --list-marker-color-collapsed: rgb(67, 159, 234) !important;
  ...
  --nav-item-background-selected: rgba(68, 158, 248, 0.15) !important;
  --nav-item-color: rgb(130, 143, 166) !important;
  --nav-item-color-active: rgb(186, 186, 186) !important;
  --nav-item-color-highlighted: rgb(67, 159, 234) !important;
  ...
  --pill-color-remove-hover: rgb(67, 159, 234) !important;
  ...
  --secondary: rgb(67, 159, 234) !important;
  ...
  --tab-text-color-focused-highlighted: rgb(67, 159, 234) !important;
  ...
  --table-selection: rgba(68, 158, 248, 0.1) !important;
  --table-selection-border-color: hsl(210, 106%, 65%) !important;
  --tag-background: rgba(68, 158, 248, 0.1) !important;
  --tag-background-hover: rgba(68, 158, 248, 0.2) !important;
  --tag-border-color: rgba(68, 158, 248, 0.15) !important;
  --tag-border-color-hover: rgba(68, 158, 248, 0.15) !important;
  --tag-color: rgb(67, 159, 234) !important;
  --tag-color-hover: rgb(67, 159, 234) !important;
  --tertiary: rgb(71, 163, 255) !important;
  --text-accent: rgb(67, 159, 234) !important;
  ...
  --text-selection: rgba(68, 158, 248, 0.33) !important;
...
html[saved-theme="dark"] body sup {
  ...
  --bases-table-cell-background-selected: rgba(68, 158, 248, 0.1) !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px rgb(117, 184, 250) !important;
  ...
  --blockquote-border-color: rgb(117, 184, 250) !important;
  ...
  --checkbox-color: rgb(117, 184, 250) !important;
  --checkbox-color-hover: rgb(43, 145, 247) !important;
  ...
  --collapse-icon-color-collapsed: rgb(68, 158, 248) !important;
  --color-accent: rgb(68, 158, 248) !important;
  --color-accent-1: rgb(117, 184, 250) !important;
  --color-accent-2: rgb(43, 145, 247) !important;
  --color-accent-hsl: 210, 93%, 62% !important;
  ...
  --color-base-00-trans-alt: rgba(227, 230, 232, 0.8) !important;
  ...
  --divider-color-hover: rgb(117, 184, 250) !important;
  --divider-width: 4px !important;
  --dropdown-background: rgb(244, 248, 251) !important;
  --dropdown-background-hover: rgb(230, 237, 244) !important;
  --embed-border-start: 2px solid rgb(117, 184, 250) !important;
  --embed-padding: 13px 23px !important;
  ...
  --graph-node-focused: rgb(68, 158, 248) !important;
  ...
  --icon-color-active: rgb(68, 158, 248) !important;
  ...
  --interactive-accent: rgb(117, 184, 250) !important;
  --interactive-accent-hover: rgb(43, 145, 247) !important;
  --interactive-accent-hsl: 210, 93%, 62% !important;
  ...
  --link-color: rgb(68, 158, 248) !important;
  --link-color-hover: rgb(43, 145, 247) !important;
  --link-external-color: rgb(68, 158, 248) !important;
  --link-external-color-hover: rgb(43, 145, 247) !important;
  --link-unresolved-color: rgb(68, 158, 248) !important;
  --link-unresolved-decoration-color: rgba(68, 158, 248, 0.3) !important;
  --list-indent: 37px !important;
  --list-marker-color: rgb(176, 184, 196) !important;
  --list-marker-color-collapsed: rgb(68, 158, 248) !important;
  ...
  --nav-item-color-highlighted: rgb(68, 158, 248) !important;
  ...
  --pill-color-remove-hover: rgb(68, 158, 248) !important;
  ...
  --secondary: rgb(68, 158, 248) !important;
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px rgb(68, 158, 248) !important;
  ...
  --tab-text-color-focused-highlighted: rgb(68, 158, 248) !important;
  --table-drag-handle-background-active: rgb(117, 184, 250) !important;
  --table-drag-handle-color: rgb(176, 184, 196) !important;
  --table-header-color: rgb(33, 33, 33) !important;
  --table-selection: rgba(68, 158, 248, 0.1) !important;
  --table-selection-border-color: rgb(117, 184, 250) !important;
  --tag-background: rgba(68, 158, 248, 0.1) !important;
  --tag-background-hover: rgba(68, 158, 248, 0.2) !important;
  --tag-border-color: rgba(68, 158, 248, 0.15) !important;
  --tag-border-color-hover: rgba(68, 158, 248, 0.15) !important;
  --tag-color: rgb(68, 158, 248) !important;
  --tag-color-hover: rgb(68, 158, 248) !important;
  --tertiary: rgb(43, 145, 247) !important;
  --text-accent: rgb(68, 158, 248) !important;
  --text-accent-hover: rgb(43, 145, 247) !important;
  ...
  --text-selection: rgba(68, 158, 248, 0.2) !important;
