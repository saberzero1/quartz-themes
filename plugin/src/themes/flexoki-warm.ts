...
export const theme: ThemeData = {
  ...
  --checkbox-color-hover: hsl(from rgb(36, 132, 124) calc(h - 3) calc(s * 1.02) calc(l * 1.15)) !important;
  ...
  --collapse-icon-color-collapsed: hsl(from rgb(36, 132, 124) calc(h - 3) calc(s * 1.02) calc(l * 1.15)) !important;
  --color-accent: rgb(36, 132, 124) !important;
  --color-accent-1: hsl(from rgb(36, 132, 124) calc(h - 3) calc(s * 1.02) calc(l * 1.15)) !important;
  --color-accent-2: hsl(from rgb(36, 132, 124) calc(h - 5) calc(s * 1.05) calc(l * 1.29)) !important;
  ...
  --graph-node-focused: hsl(from rgb(36, 132, 124) calc(h - 3) calc(s * 1.02) calc(l * 1.15)) !important;
  ...
  --icon-color-active: hsl(from rgb(36, 132, 124) calc(h - 3) calc(s * 1.02) calc(l * 1.15)) !important;
  ...
  --interactive-accent-hover: hsl(from rgb(36, 132, 124) calc(h - 3) calc(s * 1.02) calc(l * 1.15)) !important;
  ...
  --link-color: hsl(from rgb(36, 132, 124) calc(h - 3) calc(s * 1.02) calc(l * 1.15)) !important;
  --link-color-hover: hsl(from rgb(36, 132, 124) calc(h - 5) calc(s * 1.05) calc(l * 1.29)) !important;
  --link-external-color: hsl(from rgb(36, 132, 124) calc(h - 3) calc(s * 1.02) calc(l * 1.15)) !important;
  --link-external-color-hover: hsl(from rgb(36, 132, 124) calc(h - 5) calc(s * 1.05) calc(l * 1.29)) !important;
  --link-unresolved-color: hsl(from rgb(36, 132, 124) calc(h - 3) calc(s * 1.02) calc(l * 1.15)) !important;
  --link-unresolved-decoration-color: rgba(36, 132, 124, 0.3) !important;
  --list-marker-color: #575653 !important;
  --list-marker-color-collapsed: hsl(from rgb(36, 132, 124) calc(h - 3) calc(s * 1.02) calc(l * 1.15)) !important;
  ...
  --nav-item-color-highlighted: hsl(from rgb(36, 132, 124) calc(h - 3) calc(s * 1.02) calc(l * 1.15)) !important;
  ...
  --pill-color-remove-hover: hsl(from rgb(36, 132, 124) calc(h - 3) calc(s * 1.02) calc(l * 1.15)) !important;
  ...
  --secondary: hsl(from rgb(36, 132, 124) calc(h - 3) calc(s * 1.02) calc(l * 1.15)) !important;
  ...
  --tab-text-color-focused-highlighted: hsl(from rgb(36, 132, 124) calc(h - 3) calc(s * 1.02) calc(l * 1.15)) !important;
  ...
  --tag-color: hsl(from rgb(36, 132, 124) calc(h - 3) calc(s * 1.02) calc(l * 1.15)) !important;
  --tag-color-hover: hsl(from rgb(36, 132, 124) calc(h - 3) calc(s * 1.02) calc(l * 1.15)) !important;
  --tertiary: hsl(from rgb(36, 132, 124) calc(h - 5) calc(s * 1.05) calc(l * 1.29)) !important;
  --text-accent: hsl(from rgb(36, 132, 124) calc(h - 3) calc(s * 1.02) calc(l * 1.15)) !important;
  --text-accent-hover: hsl(from rgb(36, 132, 124) calc(h - 5) calc(s * 1.05) calc(l * 1.29)) !important;
...
html[saved-theme="dark"] body sup {
  ...
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(from rgb(36, 132, 124) calc(h - 3) calc(s * 1.02) calc(l * 1.15)) !important;
  --bases-table-header-color: #6F6E69 !important;
  --blockquote-border-color: hsl(from rgb(36, 132, 124) calc(h - 3) calc(s * 1.02) calc(l * 1.15)) !important;
  ...
  --checkbox-color: hsl(from rgb(36, 132, 124) calc(h - 3) calc(s * 1.02) calc(l * 1.15)) !important;
  --checkbox-color-hover: hsl(from rgb(36, 132, 124) calc(h - 5) calc(s * 1.05) calc(l * 1.29)) !important;
  ...
  --divider-color-hover: hsl(from rgb(36, 132, 124) calc(h - 3) calc(s * 1.02) calc(l * 1.15)) !important;
  --embed-block-shadow-hover: 0 0 0 1px #E6E4D9, inset 0 0 0 1px #E6E4D9 !important;
  --embed-border-start: 2px solid hsl(from rgb(36, 132, 124) calc(h - 3) calc(s * 1.02) calc(l * 1.15)) !important;
  ...
  --interactive-accent: hsl(from rgb(36, 132, 124) calc(h - 3) calc(s * 1.02) calc(l * 1.15)) !important;
  --interactive-accent-hover: hsl(from rgb(36, 132, 124) calc(h - 5) calc(s * 1.05) calc(l * 1.29)) !important;
  --interactive-accent-hsl: 175, 57%, 33% !important;
  ...
  --table-drag-handle-background-active: hsl(from rgb(36, 132, 124) calc(h - 3) calc(s * 1.02) calc(l * 1.15)) !important;
  --table-drag-handle-color: #B7B5AC !important;
  --table-header-border-color: #E6E4D9 !important;
  --table-header-color: #100F0F !important;
  --table-selection: rgba(36, 132, 124, 0.1) !important;
  --table-selection-border-color: hsl(from rgb(36, 132, 124) calc(h - 3) calc(s * 1.02) calc(l * 1.15)) !important;
  --tag-background: rgba(36, 132, 124, 0.1) !important;
  --tag-background-hover: rgba(36, 132, 124, 0.2) !important;
  --tag-border-color: rgba(36, 132, 124, 0.15) !important;
  --tag-border-color-hover: rgba(36, 132, 124, 0.15) !important;
