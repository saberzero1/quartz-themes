...
export const theme: ThemeData = {
  ...
  --background-secondary: var(--color-base-20, #20212B);
  ...
  --lightgray: var(--background-secondary, var(--color-base-20, #20212B));
  ...
  --text-link: var(--text-accent, hsl(135, 94%, 61.2%));
  --text-mark: #f1fa8c;
  ...
  --titlebar-background-focused: var(--titlebar-background, #20212B);
...
html body h4 {
  ...
  color: var(--text-title-h4, rgb(255, 85, 85));
}
...
html body h6 {
  border-bottom-color: rgb(189, 147, 244);
  border-left-color: rgb(189, 147, 244);
  border-right-color: rgb(189, 147, 244);
  border-top-color: rgb(189, 147, 244);
  color: var(--text-title-h6, rgb(189, 147, 244));
}`,
