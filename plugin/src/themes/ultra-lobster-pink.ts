...
export const theme: ThemeData = {
  ...
  --background-modifier-active-hover: hsla(328, 91%, 79%, 0.1) !important;
  ...
  --bases-table-cell-background-selected: hsla(328, 91%, 79%, 0.1) !important;
  --bases-table-cell-shadow-active: 0 0 0 2px #414141 !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(328, 91%, 79%) !important;
  ...
  --blockquote-border-color: hsl(328, 91%, 79%) !important;
  ...
  --checkbox-color: hsl(328, 91%, 79%) !important;
  --checkbox-color-hover: #e9973f !important;
  ...
  --collapse-icon-color-collapsed: hsl(328, 91%, 79%) !important;
  --color-accent: hsl(328, 91%, 79%) !important;
  --color-accent-1: #e9973f !important;
  --color-accent-1-rgb: 233, 151, 63 !important;
  --color-accent-2: hsl(
        258 calc(88% + 180) 66%
    ) !important;
  ...
  --color-accent-hsl: 328, 91%, 79% !important;
  --color-accent-rgb: 250, 153, 205 !important;
  ...
  --divider-color-hover: hsl(328, 91%, 79%) !important;
  ...
  --embed-border-start: 2px solid hsl(328, 91%, 79%) !important;
  ...
  --graph-node-focused: hsl(328, 91%, 79%) !important;
  --graph-node-tag: hsl(328, 91%, 79%) !important;
  ...
  --icon-color-active: hsl(328, 91%, 79%) !important;
  ...
  --interactive-accent: hsl(328, 91%, 79%) !important;
  --interactive-accent-hover: #e9973f !important;
  --interactive-accent-hsl: 328, 91%, 79% !important;
  ...
  --link-external-color: hsl(328, 91%, 79%) !important;
  ...
  --list-marker-color-collapsed: hsl(328, 91%, 79%) !important;
  ...
  --nav-item-background-selected: hsla(328, 91%, 79%, 0.15) !important;
  ...
  --pill-color-remove-hover: hsl(328, 91%, 79%) !important;
  ...
  --scrollbar-active-thumb-bg: hsl(328, 91%, 79%) !important;
  ...
  --secondary: hsl(328, 91%, 79%) !important;
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(328, 91%, 79%) !important;
  ...
  --tab-text-color-focused-highlighted: hsl(328, 91%, 79%) !important;
  --table-add-button-border-color: #313131 !important;
  --table-border-color: #313131 !important;
  --table-drag-handle-background-active: hsl(328, 91%, 79%) !important;
  --table-drag-handle-color: #999999 !important;
  --table-header-border-color: #313131 !important;
  --table-header-color: #bababa !important;
  --table-selection: hsla(328, 91%, 79%, 0.1) !important;
  --table-selection-border-color: hsl(328, 91%, 79%) !important;
  --tag-background: hsla(328, 91%, 79%, 0.1) !important;
  --tag-background-hover: hsla(328, 91%, 79%, 0.2) !important;
  --tag-border-color: hsla(328, 91%, 79%, 0.15) !important;
  --tag-border-color-hover: hsla(328, 91%, 79%, 0.15) !important;
  --tag-color: hsl(328, 91%, 79%) !important;
  --tag-color-hover: hsl(328, 91%, 79%) !important;
  --tertiary: hsl(
        258 calc(88% + 180) 66%
    ) !important;
  --text-accent: hsl(328, 91%, 79%) !important;
  ...
  --text-selection: hsla(328, 91%, 79%, 0.33) !important;
...
html[saved-theme="dark"] body kbd {
  background-color: color(srgb 0.9811 0.5989 0.80274 / 0.7);
...
html[saved-theme="dark"] body ul.tags > li {
  background-color: color(srgb 0.9811 0.5989 0.80274 / 0.05);
  ...
  --background-modifier-active-hover: hsla(348, 83%, 81%, 0.1) !important;
  ...
  --bases-table-cell-background-selected: hsla(348, 83%, 81%, 0.1) !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(348, 83%, 81%) !important;
  ...
  --blockquote-border-color: hsl(348, 83%, 81%) !important;
  ...
  --checkbox-color: hsl(348, 83%, 81%) !important;
  ...
  --collapse-icon-color-collapsed: hsl(348, 83%, 81%) !important;
  --color-accent: hsl(348, 83%, 81%) !important;
  --color-accent-1: #ec7500 !important;
  --color-accent-1-rgb: 236, 117, 0 !important;
  --color-accent-2: hsl(
        258 88% 71%
    ) !important;
  --color-accent-hover: hsl(
  ...
  --color-accent-hsl: 348, 83%, 81% !important;
  --color-accent-rgb: 245, 169, 184 !important;
  ...
  --divider-color-hover: hsl(348, 83%, 81%) !important;
  ...
  --embed-border-start: 2px solid hsl(348, 83%, 81%) !important;
  ...
  --graph-node-focused: hsl(348, 83%, 81%) !important;
  --graph-node-tag: hsl(348, 83%, 81%) !important;
  ...
  --icon-color-active: hsl(348, 83%, 81%) !important;
  ...
  --interactive-accent: hsl(348, 83%, 81%) !important;
  ...
  --link-decoration-hover: none !important;
  --link-decoration-thickness: 13% !important;
  --link-external-color: hsl(348, 83%, 81%) !important;
  --link-external-color-hover: hsl(
        258 88% 71%
    ) !important;
  --link-external-decoration: none !important;
  ...
  --list-marker-color-collapsed: hsl(348, 83%, 81%) !important;
  ...
  --nav-item-background-selected: hsla(348, 83%, 81%, 0.15) !important;
  ...
  --pill-color-remove-hover: hsl(348, 83%, 81%) !important;
  ...
  --scrollbar-active-thumb-bg: hsl(348, 83%, 81%) !important;
  ...
  --secondary: hsl(348, 83%, 81%) !important;
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(348, 83%, 81%) !important;
  ...
  --tab-text-color-focused-highlighted: hsl(348, 83%, 81%) !important;
  --table-add-button-border-color: #c7c7c7 !important;
  --table-border-color: #c7c7c7 !important;
  --table-drag-handle-background-active: hsl(348, 83%, 81%) !important;
  --table-drag-handle-color: #707070 !important;
  --table-header-border-color: #c7c7c7 !important;
  --table-header-color: #5a5a5a !important;
  --table-selection: hsla(348, 83%, 81%, 0.1) !important;
  --table-selection-border-color: hsl(348, 83%, 81%) !important;
  --tag-background: hsla(348, 83%, 81%, 0.1) !important;
  --tag-background-hover: hsla(348, 83%, 81%, 0.2) !important;
  --tag-border-color: hsla(348, 83%, 81%, 0.15) !important;
  --tag-border-color-hover: hsla(348, 83%, 81%, 0.15) !important;
  --tag-color: hsl(348, 83%, 81%) !important;
  --tag-color-hover: hsl(348, 83%, 81%) !important;
  --tertiary: hsl(
        258 88% 71%
    ) !important;
  --text-accent: hsl(348, 83%, 81%) !important;
  --text-accent-hover: hsl(
        258 88% 71%
    ) !important;
...
html[saved-theme="light"] body li.task-list-item input[type="checkbox"]:checked {
  background-color: rgb(247, 166, 182);
  border-color: rgba(0, 0, 0, 0);
}
...
html[saved-theme="light"] body kbd {
  background-color: color(srgb 0.9677 0.6523 0.71538 / 0.7);
  border-bottom-color: rgb(255, 255, 255);
  border-left-color: rgb(255, 255, 255);
  border-right-color: rgb(255, 255, 255);
  border-top-color: rgb(255, 255, 255);
...
html[saved-theme="light"] body ul.tags > li {
  background-color: color(srgb 0.9677 0.6523 0.71538 / 0.05);
