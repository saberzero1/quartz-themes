...
export const theme: ThemeData = {
  ...
  --table-hover-highlight-color: rgba(92, 153, 124, 0.15);
  --table-selection: hsla(24.4, 90.8%, 61.8%, 0.1);
  --table-selection-border-color: rgb(92, 153, 124);
  --table-sticky-height: 600px;
  --tag-background: rgba(92, 153, 124, 0.15);
  --tag-background-hover: rgba(92, 153, 124, 0.25);
  --tag-border-color: rgba(92, 153, 124, 0.15);
  --tag-border-color-hover: rgba(92, 153, 124, 0.25);
