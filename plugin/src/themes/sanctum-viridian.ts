...
html[saved-theme="dark"] body .text-highlight {
  background-color: var(--text-highlight-bg, rgba(92, 153, 124, 0.7));
...
html[saved-theme="dark"] body a.internal-link.tag-link, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  ...
  --pill-background: var(--tag-background, rgba(92, 153, 124, 0.15));
  --pill-background-hover: var(--tag-background-hover, rgba(92, 153, 124, 0.25));
  --pill-border-color: var(--tag-border-color, rgba(92, 153, 124, 0.15));
  --pill-border-color-hover: var(--tag-border-color-hover, rgba(92, 153, 124, 0.25));
  ...
  background-color: var(--pill-background, rgba(92, 153, 124, 0.15));
  border-bottom-color: rgba(92, 153, 124, 0.15);
  border-left-color: rgba(92, 153, 124, 0.15);
  border-right-color: rgba(92, 153, 124, 0.15);
  border-top-color: rgba(92, 153, 124, 0.15);
  font-family: "??", Inter, sans-serif, "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
}
...
html[saved-theme="dark"] body ul.tags > li {
  background-color: var(--tag-background, rgba(92, 153, 124, 0.15));
  border-bottom-color: rgba(92, 153, 124, 0.15);
  border-left-color: rgba(92, 153, 124, 0.15);
  border-right-color: rgba(92, 153, 124, 0.15);
  border-top-color: rgba(92, 153, 124, 0.15);
