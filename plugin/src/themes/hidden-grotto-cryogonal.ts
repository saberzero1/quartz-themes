...
export const theme: ThemeData = {
  ...
  --accent-h: var(--grotto-accent-h, 210);
  ...
  --background-primary: var(--grotto-dark-1, hsl(220, 30%, 32%));
  --background-primary-alt: var(--background-primary, hsl(220, 30%, 32%));
  --background-secondary: var(--grotto-dark-0, hsl(210, 10%, 16%));
  --background-secondary-alt: var(--background-secondary, hsl(210, 10%, 16%));
  --bases-cards-background: var(--background-primary, hsl(220, 30%, 32%));
  --bases-cards-cover-background: var(--background-primary-alt, hsl(220, 30%, 32%));
  ...
  --bases-table-cell-background-active: var(--background-primary, hsl(220, 30%, 32%));
  --bases-table-cell-background-disabled: var(--background-primary-alt, hsl(220, 30%, 32%));
  --bases-table-cell-background-selected: var(--table-selection, hsla(210, 50%, 60%, 0.1));
  --bases-table-container-border-radius: var(--radius-s, 0px);
  --bases-table-group-background: var(--background-primary-alt, hsl(220, 30%, 32%));
  --bases-table-header-background: var(--background-primary, hsl(220, 30%, 32%));
  --bases-table-header-color: var(--text-muted, hsl(40, 0%, 76%));
  --bases-table-summary-background: var(--background-primary, hsl(220, 30%, 32%));
  --blockquote-border-color: var(--grotto-accent, hsl(210, 50%, 60%));
  ...
  --canvas-background: var(--background-primary, hsl(220, 30%, 32%));
  ...
  --checkbox-color: var(--interactive-accent, hsl(210, 50%, 60%));
  --checkbox-color-hover: var(--interactive-accent-hover, hsl(210, 50%, 60%));
  ...
  --code-background: var(--background-primary-alt, hsl(220, 30%, 32%));
  ...
  --collapse-icon-color-collapsed: var(--text-accent, hsl(210, 50%, 60%));
  ...
  --divider-color-hover: var(--interactive-accent, hsl(210, 50%, 60%));
  --divider-width: 0px;
  --divider-width-hover: 2px;
  --file-header-background: var(--background-primary, hsl(220, 30%, 32%));
  --file-header-background-focused: var(--background-primary, hsl(220, 30%, 32%));
  ...
  --graph-node-focused: var(--grotto-accent, hsl(210, 50%, 60%));
  --graph-node-tag: var(--grotto-accent, hsl(210, 50%, 60%));
  ...
  --grotto-accent-l: 60%;
  --grotto-accent-s: 50%;
  --grotto-background-tertiary: var(--grotto-dark-2, hsl(220, 30%, 40%));
  --grotto-backlink-border-color: var(--text-normal, hsl(40, 0%, 86%));
  --grotto-bases-background-color: var(--background-primary, hsl(220, 30%, 32%));
  ...
  --grotto-bases-header-background-color: var(--grotto-background-tertiary, hsl(220, 30%, 40%));
  --grotto-blockquote-background-color: transparent;
  --grotto-blockquote-color: var(--text-normal, hsl(40, 0%, 86%));
  --grotto-blur: 0px;
  --grotto-bold-color: var(--grotto-accent, hsl(210, 50%, 60%));
  --grotto-bold-weight: 800;
  --grotto-button-background-color: var(--grotto-accent, hsl(210, 50%, 60%));
  ...
  --grotto-calendar-today-background-color: var(--grotto-accent, hsl(210, 50%, 60%));
  ...
  --grotto-calendar-year-color: var(--grotto-accent, hsl(210, 50%, 60%));
  --grotto-callout-background-color: var(--background-primary, hsl(220, 30%, 32%));
  ...
  --grotto-canvas-background-color: var(--background-primary, hsl(220, 30%, 32%));
  ...
  --grotto-canvas-controls-background-color: var(--grotto-background-tertiary, hsl(220, 30%, 40%));
  --grotto-canvas-controls-color: var(--text-normal, hsl(40, 0%, 86%));
  --grotto-canvas-path-color: var(--text-normal, hsl(40, 0%, 86%));
  --grotto-canvas-path-node-color: var(--grotto-accent, hsl(210, 50%, 60%));
  ...
  --grotto-code-background-color: var(--grotto-background-tertiary, hsl(220, 30%, 40%));
  ...
  --grotto-dragging-background-color: var(--grotto-accent, hsl(210, 50%, 60%));
  ...
  --grotto-drawer-background-color: var(--grotto-accent, hsl(210, 50%, 60%));
  ...
  --grotto-dropdown-background-color: var(--grotto-accent, hsl(210, 50%, 60%));
  ...
  --grotto-dropdown-option-background-color: var(--background-primary, hsl(220, 30%, 32%));
  ...
  --grotto-graph-sidebar-controls-background-color: var(--grotto-background-tertiary, hsl(220, 30%, 40%));
  ...
  --grotto-header-1-background-color: var(--grotto-accent, hsl(210, 50%, 60%));
  ...
  --grotto-header-2-color: var(--background-primary, hsl(220, 30%, 32%));
  ...
  --grotto-header-5-border-color: var(--grotto-accent, hsl(210, 50%, 60%));
  ...
  --grotto-mobile-toolbar-background-color: var(--grotto-background-tertiary, hsl(220, 30%, 40%));
  ...
  --grotto-modal-background-color: var(--background-primary, hsl(220, 30%, 32%));
  ...
  --grotto-navbar-background-color: var(--grotto-background-tertiary, hsl(220, 30%, 40%));
  ...
  --grotto-notice-background-color: var(--grotto-accent, hsl(210, 50%, 60%));
  ...
  --grotto-progress-color: var(--grotto-accent, hsl(210, 50%, 60%));
  --grotto-progress-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-prompt-background-color: var(--background-primary, hsl(220, 30%, 32%));
  ...
  --grotto-properties-background-color: var(--background-primary, hsl(220, 30%, 32%));
  ...
  --grotto-pull-background-color: var(--grotto-accent, hsl(210, 50%, 60%));
  ...
  --grotto-settings-background-color: var(--background-secondary, hsl(210, 10%, 16%));
  ...
  --grotto-slider-border-color: var(--background-primary, hsl(220, 30%, 32%));
  --grotto-statusbar-background-color: var(--background-secondary, hsl(210, 10%, 16%));
  ...
  --grotto-suggestion-background-color: var(--grotto-background-tertiary, hsl(220, 30%, 40%));
  ...
  --grotto-suggestion-selected-background-color: var(--grotto-accent, hsl(210, 50%, 60%));
  --grotto-suggestion-selected-color: var(--grotto-text-color-on-accent, hsl(40, 0%, 86%));
  --grotto-tab-switcher-background-color: var(--background-primary, hsl(220, 30%, 32%));
  ...
  --grotto-tab-switcher-menu-background-color: var(--grotto-background-tertiary, hsl(220, 30%, 40%));
  --grotto-tab-switcher-selected-tab-background-color: var(--grotto-accent, hsl(210, 50%, 60%));
  ...
  --grotto-tag-color: var(--background-primary, hsl(220, 30%, 32%));
  ...
  --grotto-toggle-background-color: var(--background-primary, hsl(220, 30%, 32%));
  --grotto-toggle-border-color: var(--text-normal, hsl(40, 0%, 86%));
  --grotto-toggle-border-width: var(--grotto-global-border-width, 1px);
  --grotto-toggle-enabled-background-color: var(--grotto-accent, hsl(210, 50%, 60%));
  --grotto-tooltip-background-color: var(--grotto-background-tertiary, hsl(220, 30%, 40%));
  ...
  --grotto-view-header-background-color: var(--grotto-background-tertiary, hsl(220, 30%, 40%));
  ...
  --highlight: var(--text-highlight-bg, var(--grotto-background-tertiary, hsl(220, 30%, 40%)));
  --icon-color: var(--text-muted, hsl(40, 0%, 76%));
  --icon-color-active: var(--text-accent, hsl(210, 50%, 60%));
  ...
  --interactive-accent: var(--color-accent, hsl(210, 50%, 60%));
  --interactive-accent-hover: var(--color-accent-1, hsl(210, 50%, 60%));
  --interactive-accent-hsl: var(--color-accent-hsl, 210, 50%, 60%);
  --light: var(--background-primary, var(--grotto-dark-1, hsl(220, 30%, 32%)));
  --lightgray: var(--background-secondary, var(--grotto-dark-0, hsl(210, 10%, 16%)));
  --link-color: var(--text-accent, hsl(210, 50%, 60%));
  --link-color-hover: var(--text-accent-hover, hsl(210, 50%, 60%));
  --link-external-color: var(--text-accent, hsl(210, 50%, 60%));
  --link-external-color-hover: var(--text-accent-hover, hsl(210, 50%, 60%));
  --link-unresolved-color: var(--text-accent, hsl(210, 50%, 60%));
  ...
  --menu-background: var(--background-secondary, hsl(210, 10%, 16%));
  ...
  --modal-background: var(--background-primary, hsl(220, 30%, 32%));
  ...
  --nav-item-color-highlighted: var(--text-accent, hsl(210, 50%, 60%));
  ...
  --p-spacing: 0rem;
  --pdf-background: var(--background-primary, hsl(220, 30%, 32%));
  --pdf-page-background: var(--background-primary, hsl(220, 30%, 32%));
  --pdf-sidebar-background: var(--background-primary, hsl(220, 30%, 32%));
  ...
  --pill-color-remove-hover: var(--text-accent, hsl(210, 50%, 60%));
  --prompt-background: var(--background-primary, hsl(220, 30%, 32%));
  --radius-l: 0px;
  --radius-m: 0px;
  --radius-s: 0px;
  --radius-xl: 0px;
  ...
  --ribbon-background: var(--background-secondary, hsl(210, 10%, 16%));
  --ribbon-background-collapsed: var(--background-primary, hsl(220, 30%, 32%));
  --scrollbar-active-thumb-bg: var(--grotto-accent, hsl(210, 50%, 60%));
  --scrollbar-bg: var(--grotto-accent, hsl(210, 50%, 60%));
  --scrollbar-border-width: 3px;
  --scrollbar-radius: var(--grotto-global-border-radius, 0rem);
  --scrollbar-thumb-bg: var(--grotto-accent, hsl(210, 50%, 60%));
  --search-clear-button-color: var(--text-muted, hsl(40, 0%, 76%));
  --search-icon-color: var(--text-muted, hsl(40, 0%, 76%));
  --search-result-background: var(--background-primary, hsl(220, 30%, 32%));
  --secondary: var(--text-accent, var(--color-accent-1, hsl(210, 50%, 60%)));
  --setting-group-heading-color: var(--text-normal, hsl(40, 0%, 86%));
  --setting-items-background: var(--background-primary-alt, hsl(220, 30%, 32%));
  ...
  --shiki-code-background: var(--code-background, hsl(220, 30%, 32%));
  ...
  --slider-thumb-y: -7px;
  --status-bar-background: var(--background-secondary, hsl(210, 10%, 16%));
  --status-bar-radius: var(--radius-m, 0px 0 0 0) 0 0 0;
  --status-bar-text-color: var(--text-muted, hsl(40, 0%, 76%));
  --suggestion-background: var(--background-primary, hsl(220, 30%, 32%));
  --tab-background-active: var(--background-primary, hsl(220, 30%, 32%));
  --tab-container-background: var(--background-secondary, hsl(210, 10%, 16%));
  --tab-curve: 0rem;
  --tab-radius: var(--radius-s, 0px);
  --tab-switcher-background: var(--background-secondary, hsl(210, 10%, 16%));
  ...
  --tab-text-color-focused-highlighted: var(--text-accent, hsl(210, 50%, 60%));
  ...
  --table-drag-handle-background-active: var(--table-selection-border-color, hsl(210, 50%, 60%));
  ...
  --table-selection-border-color: var(--interactive-accent, hsl(210, 50%, 60%));
  --table-text-color: var(--grotto-table-color, hsl(40, 0%, 86%));
  --tag-color: var(--text-accent, hsl(210, 50%, 60%));
  --tag-color-hover: var(--text-accent, hsl(210, 50%, 60%));
  --tertiary: var(--text-accent-hover, var(--color-accent-2, hsl(210, 50%, 60%)));
  --text-accent: var(--color-accent-1, hsl(210, 50%, 60%));
  --text-accent-hover: var(--color-accent-2, hsl(210, 50%, 60%));
  --text-error: var(--color-red, hsl(0, 50%, 50%));
  --text-faint: var(--grotto-light-2, hsl(40, 0%, 76%));
  --text-highlight-bg: var(--grotto-background-tertiary, hsl(220, 30%, 40%));
  ...
  --textHighlight: var(--text-highlight-bg, var(--grotto-background-tertiary, hsl(220, 30%, 40%)));
  --titleFont: var(--font-text, var(--grotto-font-main, 'Quicksand'));
  --titlebar-background: var(--background-secondary, hsl(210, 10%, 16%));
  --titlebar-background-focused: var(--background-secondary-alt, hsl(210, 10%, 16%));
...
html[saved-theme="dark"] body[data-slug] div#quartz-root.page, html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left, html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left:has(.explorer), html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left .explorer .explorer-content {
  --bases-table-header-background: var(--background-secondary, hsl(210, 10%, 16%));
  background-color: var(--tab-container-background, rgb(37, 41, 45));
  color: rgb(219, 219, 219);
}

html[saved-theme="dark"] body[data-slug], html[saved-theme="dark"] body[data-slug] .page > div#quartz-body, html[saved-theme="dark"] .page > div#quartz-body div.center, html[saved-theme="dark"] .page > div#quartz-body footer {
  background-color: var(--background-primary, rgb(57, 73, 106));
  color: rgb(219, 219, 219);
}

html[saved-theme="dark"] body .page > div#quartz-body div.sidebar {
  background-color: var(--background-secondary, rgb(37, 41, 45));
  color: rgb(219, 219, 219);
}
...
html[saved-theme="dark"] body .page > div#quartz-body div.sidebar.right {
  ...
  color: var(--grotto-bold-color, rgb(102, 153, 204));
...
html[saved-theme="dark"] body .markdown-rendered p > em, html[saved-theme="dark"] em {
  color: var(--grotto-italic-color, rgb(102, 153, 204));
  font-family: Quicksand;
...
html[saved-theme="dark"] body .text-highlight {
  background-color: var(--text-highlight-bg, rgb(71, 92, 133));
...
html[saved-theme="dark"] body li.task-list-item input[type="checkbox"]:checked {
  background-color: var(--checkbox-color, rgb(102, 153, 204));
  border-color: rgb(219, 219, 219);
}
...
html[saved-theme="dark"] body p {
  ...
  color: var(--grotto-link-color, rgb(102, 153, 204));
  font-family: Quicksand;
...
html[saved-theme="dark"] body a.internal-link.broken {
  color: var(--link-unresolved-color, rgb(102, 153, 204));
  font-family: Quicksand;
  font-weight: var(--grotto-link-weight, 500);
  outline: rgb(102, 153, 204) none 0px;
  text-decoration: underline rgba(102, 153, 204, 0.3);
  text-decoration-color: var(--link-unresolved-decoration-color, rgba(102, 153, 204, 0.3));
}`,
...
html[saved-theme="dark"] body th {
  ...
  background-color: var(--grotto-code-background-color, rgb(71, 92, 133));
  border-bottom-color: rgb(219, 219, 219);
...
html[saved-theme="dark"] body figure {
  --code-background: var(--ec-frm-edBg, hsl(220, 30%, 32%));
  border-bottom-color: rgb(219, 219, 219);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
  border-bottom-width: 0px;
...
html[saved-theme="dark"] body video {
  ...
  background-color: var(--background-primary-alt, rgb(57, 73, 106));
...
html[saved-theme="dark"] body .callout[data-callout="abstract"] {
  ...
  background-color: var(--grotto-callout-background-color, rgb(57, 73, 106));
  border-bottom-color: rgb(219, 219, 219);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
  border-bottom-width: 1px;
...
html[saved-theme="dark"] body .search > .search-container > .search-space {
  background-color: var(--grotto-prompt-background-color, rgb(57, 73, 106));
  border-bottom-color: rgb(219, 219, 219);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
  border-bottom-width: 0px;
...
html[saved-theme="dark"] body .search > .search-container > .search-space > .search-layout > .results-container > .result-card:hover, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container > .result-card:focus, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container > .result-card.focus:not(:has(~ .result-card:hover, html[saved-theme="dark"] ~ .result-card:focus)) {
  background-color: var(--grotto-accent, rgb(102, 153, 204));
  color: var(--grotto-text-color-on-accent, rgb(219, 219, 219));
  font-weight: 500;
}
...
html[saved-theme="dark"] body a.internal-link.tag-link, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  --pill-background: var(--tag-background, hsla(210, 50%, 60%, 0.1));
  --pill-background-hover: var(--tag-background-hover, hsla(210, 50%, 60%, 0.2));
  --pill-border-color: var(--tag-border-color, hsla(210, 50%, 60%, 0.15));
  --pill-border-color-hover: var(--tag-border-color-hover, hsla(210, 50%, 60%, 0.15));
  --pill-color: var(--tag-color, hsl(210, 50%, 60%));
  --pill-color-hover: var(--tag-color-hover, hsl(210, 50%, 60%));
  --pill-color-remove: var(--tag-color, hsl(210, 50%, 60%));
  --pill-color-remove-hover: var(--tag-color-hover, hsl(210, 50%, 60%));
  ...
  border-top-right-radius: 0px;
  border-top-width: 1px;
  color: var(--background-primary, rgb(57, 73, 106));
  font-family: Quicksand;
...
html[saved-theme="dark"] body h1 {
  background: rgb(102, 153, 204) none repeat scroll 0% 0% / auto padding-box border-box;
  background-color: var(--grotto-header-1-background-color, rgb(102, 153, 204));
  border-bottom-color: rgb(219, 219, 219);
  border-bottom-style: solid;
...
html[saved-theme="dark"] body h2 {
  ...
  border-top-style: solid;
  border-top-width: 2px;
  color: var(--grotto-header-2-color, rgb(57, 73, 106));
...
html[saved-theme="dark"] body h4 {
  ...
  padding-right: 7px;
  padding-top: 0px;
  text-decoration: underline 2px rgb(57, 73, 106);
}
...
html[saved-theme="dark"] body h5 {
  ...
  padding-right: 7px;
  padding-top: 0px;
  text-decoration: underline 2px rgb(102, 153, 204);
}
...
html[saved-theme="dark"] body li.depth-0 {
  ...
  background-color: var(--grotto-statusbar-background-color, rgb(37, 41, 45));
  border-bottom-color: rgb(219, 219, 219);
  border-bottom-width: 1px;
  border-left-color: rgb(219, 219, 219);
  border-left-width: 0px;
...
html[saved-theme="dark"] body kbd {
  background-color: var(--code-background, rgb(57, 73, 106));
  border-bottom-color: rgb(219, 219, 219);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
  border-bottom-width: 0px;
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  border-top-right-radius: 0px;
  border-top-width: 1px;
  color: var(--grotto-tag-color, rgb(57, 73, 106));
}`,
  },
  light: {
    base: `:root:root {
  ...
  --background-secondary: var(--grotto-light-0, hsl(40, 0%, 80%));
  --background-secondary-alt: var(--background-secondary, hsl(40, 0%, 80%));
  ...
  --bases-cards-radius: var(--radius-m, 0px);
  --bases-embed-border-radius: var(--radius-s, 0px);
  --bases-group-heading-property-color: var(--text-muted, hsl(220, 30%, 36%));
  --bases-table-border-color: var(--table-border-color, hsl(220, 30%, 28%));
  ...
  --bases-table-header-color: var(--text-muted, hsl(220, 30%, 36%));
  --bases-table-summary-background: var(--background-primary, hsl(40, 0%, 86%));
  --blockquote-border-color: var(--grotto-accent, hsl(210, 50%, 60%));
  --bodyFont: var(--font-text, var(--grotto-font-main, 'Quicksand'));
  --callout-bug: var(--callout-bug, 233, 49, 71);
  --callout-default: var(--grotto-callout-color, hsl(220, 30%, 28%));
  ...
  --canvas-card-label-color: var(--text-faint, hsl(220, 30%, 36%));
  --canvas-controls-radius: var(--radius-s, 0px);
  --caret-color: var(--text-normal, hsl(220, 30%, 28%));
  --checkbox-border-color: var(--text-faint, hsl(220, 30%, 36%));
  --checkbox-border-color-hover: var(--text-muted, hsl(220, 30%, 36%));
  --checkbox-color: var(--interactive-accent, hsl(210, 50%, 60%));
  --checkbox-color-hover: var(--interactive-accent-hover, hsl(210, 50%, 60%));
  --checkbox-marker-color: var(--background-primary, transparent);
  --checkbox-radius: var(--radius-s, 0px);
  --checklist-done-color: var(--text-muted, hsl(220, 30%, 36%));
  --clickable-icon-radius: var(--radius-s, 0px);
  --code-background: var(--background-primary-alt, hsl(40, 0%, 86%));
  --code-border-color: var(--grotto-code-border-color, hsl(220, 30%, 28%));
  --code-border-width: var(--grotto-global-border-width, 1px);
  --code-comment: var(--text-faint, hsl(220, 30%, 36%));
  --code-function: var(--color-yellow, hsl(50, 30%, 45%));
  --code-important: var(--color-orange, hsl(30, 30%, 60%));
  --code-keyword: var(--color-pink, hsl(330, 30%, 60%));
  --code-normal: var(--text-normal, hsl(220, 30%, 28%));
  --code-operator: var(--color-red, hsl(0, 30%, 60%));
  --code-property: var(--color-cyan, hsl(170, 30%, 50%));
  --code-punctuation: var(--text-muted, hsl(220, 30%, 36%));
  --code-string: var(--color-green, hsl(120, 30%, 50%));
  --code-tag: var(--color-red, hsl(0, 30%, 60%));
  --code-value: var(--color-purple, hsl(270, 30%, 60%));
  --codeFont: var(--font-monospace, var(--grotto-font-main, 'Quicksand'));
  --collapse-icon-color: var(--text-faint, hsl(220, 30%, 36%));
  --collapse-icon-color-collapsed: var(--text-accent, hsl(210, 50%, 60%));
  --color-accent: hsl(var(--grotto-accent-h), var(--grotto-accent-s), var(--grotto-accent-l));
  --color-accent-1: hsl(var(--grotto-accent-h), var(--grotto-accent-s), var(--grotto-accent-l));
  --color-accent-2: hsl(var(--grotto-accent-h), var(--grotto-accent-s), var(--grotto-accent-l));
  --color-accent-hsl: var(--grotto-accent-h), var(--grotto-accent-s), var(--grotto-accent-l);
  --dark: var(--text-normal, var(--grotto-dark-1, hsl(220, 30%, 28%)));
  --darkgray: var(--text-normal, var(--grotto-dark-1, hsl(220, 30%, 28%)));
  --divider-color-hover: var(--interactive-accent, hsl(210, 50%, 60%));
  --divider-width: 0px;
  --divider-width-hover: 2px;
  ...
  --file-header-font: var(--font-interface, 'Quicksand');
  --flair-color: var(--text-normal, hsl(220, 30%, 28%));
  --font-interface: var(--grotto-font-main, 'Quicksand');
  --font-interface-override: var(--grotto-font-main, 'Quicksand');
  --font-mermaid: var(--font-text, 'Quicksand');
  --font-monospace: var(--grotto-font-main, 'Quicksand');
  ...
  --font-text: var(--grotto-font-main, 'Quicksand');
  --font-text-override: var(--grotto-font-main, 'Quicksand');
  --footnote-id-color: var(--text-muted, hsl(220, 30%, 36%));
  --footnote-id-color-no-occurrences: var(--text-faint, hsl(220, 30%, 36%));
  --footnote-radius: var(--radius-s, 0px);
  --graph-node: var(--grotto-graph-node-color, hsl(220, 30%, 28%));
  --graph-node-attachment: var(--text-success, hsl(100, 50%, 50%));
  --graph-node-focused: var(--grotto-accent, hsl(210, 50%, 60%));
  --graph-node-tag: var(--grotto-accent, hsl(210, 50%, 60%));
  --graph-node-unresolved: var(--text-faint, hsl(220, 30%, 36%));
  --graph-text: var(--text-normal, hsl(220, 30%, 28%));
  --gray: var(--text-muted, var(--grotto-dark-2, hsl(220, 30%, 36%)));
  --grotto-accent: hsl(210, 50%, 60%);
  --grotto-accent-h: 210;
  --grotto-accent-l: 60%;
  --grotto-accent-s: 50%;
  --grotto-background-tertiary: var(--grotto-light-2, hsl(40, 0%, 76%));
  --grotto-backlink-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-bases-background-color: var(--background-primary, hsl(40, 0%, 86%));
  --grotto-bases-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-bases-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-bases-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-bases-header-background-color: var(--grotto-background-tertiary, hsl(40, 0%, 76%));
  --grotto-blockquote-background-color: transparent;
  --grotto-blockquote-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-blur: 0px;
  --grotto-bold-color: var(--grotto-accent, hsl(210, 50%, 60%));
  --grotto-bold-weight: 800;
  --grotto-button-background-color: var(--grotto-accent, hsl(210, 50%, 60%));
  --grotto-button-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-button-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-button-border-width: var(--grotto-global-border-width, 1px);
  --grotto-button-color: var(--grotto-text-color-on-accent, hsl(40, 0%, 86%));
  --grotto-button-outline-width: 1px;
  --grotto-calendar-background-color: transparent;
  --grotto-calendar-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-calendar-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-calendar-border-width: var(--grotto-global-border-width, 1px);
  --grotto-calendar-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-calendar-day-active-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-calendar-day-border-color: transparent;
  --grotto-calendar-day-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-calendar-day-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-calendar-dayofweek-background-color: transparent;
  --grotto-calendar-dayofweek-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-calendar-dayofweek-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-calendar-dayofweek-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-calendar-dayofweek-outline-color: transparent;
  --grotto-calendar-month-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-calendar-pointer-events: auto;
  --grotto-calendar-today-background-color: var(--grotto-accent, hsl(210, 50%, 60%));
  --grotto-calendar-today-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-calendar-today-color: var(--grotto-text-color-on-accent, hsl(40, 0%, 86%));
  --grotto-calendar-view-height: 0vh;
  --grotto-calendar-weekend-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-calendar-weekend-border-width: 1px;
  --grotto-calendar-year-color: var(--grotto-accent, hsl(210, 50%, 60%));
  --grotto-callout-background-color: var(--background-primary, hsl(40, 0%, 86%));
  --grotto-callout-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-callout-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-callout-icon: none;
  --grotto-callout-padding: 8px 16px;
  --grotto-callout-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-callout-title-size: var(--grotto-header-size, 1.5rem);
  --grotto-canvas-background-color: var(--background-primary, hsl(40, 0%, 86%));
  --grotto-canvas-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-canvas-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-canvas-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-canvas-controls-background-color: var(--grotto-background-tertiary, hsl(40, 0%, 76%));
  --grotto-canvas-controls-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-canvas-path-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-canvas-path-node-color: var(--grotto-accent, hsl(210, 50%, 60%));
  --grotto-checkbox-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-checkbox-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-code-background-color: var(--grotto-background-tertiary, hsl(40, 0%, 76%));
  --grotto-code-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-code-border-radius: 0rem;
  --grotto-code-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-code-weight: 500;
  --grotto-comment-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-comment-weight: 500;
  --grotto-dark-0: hsl(210, 10%, 12%);
  --grotto-dark-1: hsl(220, 30%, 28%);
  --grotto-dark-2: hsl(220, 30%, 36%);
  --grotto-dragging-background-color: var(--grotto-accent, hsl(210, 50%, 60%));
  --grotto-dragging-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-dragging-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-dragging-color: var(--grotto-text-color-on-accent, hsl(40, 0%, 86%));
  --grotto-drawer-background-color: var(--grotto-accent, hsl(210, 50%, 60%));
  --grotto-drawer-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-drawer-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-drawer-color: var(--grotto-text-color-on-accent, hsl(40, 0%, 86%));
  --grotto-dropdown-background-color: var(--grotto-accent, hsl(210, 50%, 60%));
  --grotto-dropdown-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-dropdown-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-dropdown-border-width: var(--grotto-global-border-width, 1px);
  --grotto-dropdown-color: var(--grotto-text-color-on-accent, hsl(40, 0%, 86%));
  --grotto-dropdown-option-background-color: var(--background-primary, hsl(40, 0%, 86%));
  --grotto-dropdown-option-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-dropdown-outline-width: 1px;
  --grotto-embed-background-color: transparent;
  --grotto-embed-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-embed-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-embed-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-embed-title-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-embed-title-size: 1.5rem;
  --grotto-embed-title-visibility: block;
  --grotto-filenav-active-background-color: var(--grotto-accent, hsl(210, 50%, 60%));
  --grotto-filenav-active-color: var(--grotto-text-color-on-accent, hsl(40, 0%, 86%));
  --grotto-filenav-background-color: var(--background-secondary, hsl(40, 0%, 80%));
  --grotto-filenav-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-filenav-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-filenav-button-background-color: var(--grotto-background-tertiary, hsl(40, 0%, 76%));
  --grotto-filenav-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-filenav-tag-background-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-filenav-tag-color: var(--background-secondary, hsl(40, 0%, 80%));
  --grotto-font-main: 'Quicksand';
  --grotto-font-weight: 500;
  --grotto-global-border-radius: 0rem;
  --grotto-global-border-width: 1px;
  --grotto-graph-controls-background-color: var(--grotto-background-tertiary, hsl(40, 0%, 76%));
  --grotto-graph-controls-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-graph-controls-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-graph-controls-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-graph-line-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-graph-node-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-graph-sidebar-controls-background-color: var(--grotto-background-tertiary, hsl(40, 0%, 76%));
  --grotto-graph-sidebar-controls-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-graph-sidebar-controls-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-header-1-background-color: var(--grotto-accent, hsl(210, 50%, 60%));
  --grotto-header-1-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-header-1-border-radius: var(--grotto-header-border-radius, 0rem);
  --grotto-header-1-color: var(--grotto-light-1, hsl(40, 0%, 86%));
  --grotto-header-1-size: var(--grotto-header-size, 1.5rem);
  --grotto-header-2-background-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-header-2-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-header-2-border-radius: var(--grotto-header-border-radius, 0rem);
  --grotto-header-2-color: var(--background-primary, hsl(40, 0%, 86%));
  --grotto-header-2-size: var(--grotto-header-size, 1.5rem);
  --grotto-header-3-background-color: transparent;
  --grotto-header-3-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-header-3-border-radius: var(--grotto-header-border-radius, 0rem);
  --grotto-header-3-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-header-3-size: var(--grotto-header-size, 1.5rem);
  --grotto-header-4-background-color: transparent;
  --grotto-header-4-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-header-4-border-radius: var(--grotto-header-border-radius, 0rem);
  --grotto-header-4-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-header-4-size: var(--grotto-header-size, 1.5rem);
  --grotto-header-5-background-color: transparent;
  --grotto-header-5-border-color: var(--grotto-accent, hsl(210, 50%, 60%));
  --grotto-header-5-border-radius: var(--grotto-header-border-radius, 0rem);
  --grotto-header-5-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-header-5-size: var(--grotto-header-size, 1.5rem);
  --grotto-header-6-background-color: transparent;
  --grotto-header-6-border-color: transparent;
  --grotto-header-6-border-radius: var(--grotto-header-border-radius, 0rem);
  --grotto-header-6-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-header-6-size: var(--grotto-header-size, 1.5rem);
  --grotto-header-border-radius: 0rem;
  --grotto-header-line-height: 2rem;
  --grotto-header-size: 1.5rem;
  --grotto-header-weight: 500;
  --grotto-icon-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-input-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-italic-color: var(--grotto-accent, hsl(210, 50%, 60%));
  --grotto-italic-weight: 500;
  --grotto-light-0: hsl(40, 0%, 80%);
  ...
  --grotto-link-color: var(--grotto-accent, hsl(210, 50%, 60%));
  --grotto-link-weight: 500;
  --grotto-list-marker-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-menu-background-color: var(--background-secondary, hsl(40, 0%, 80%));
  --grotto-menu-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-menu-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-menu-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-mobile-toolbar-background-color: var(--grotto-background-tertiary, hsl(40, 0%, 76%));
  --grotto-mobile-toolbar-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-mobile-toolbar-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-mobile-toolbar-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-modal-background-color: var(--background-primary, hsl(40, 0%, 86%));
  --grotto-modal-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-modal-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-modal-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-navbar-background-color: var(--grotto-background-tertiary, hsl(40, 0%, 76%));
  --grotto-navbar-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-navbar-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-navbar-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-navbar-new-tab-display: auto;
  --grotto-navbar-position-offset: 16px;
  --grotto-notice-background-color: var(--grotto-accent, hsl(210, 50%, 60%));
  --grotto-notice-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-notice-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-notice-border-width: var(--grotto-global-border-width, 1px);
  --grotto-notice-color: var(--grotto-text-color-on-accent, hsl(40, 0%, 86%));
  --grotto-progress-background-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-progress-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-progress-color: var(--grotto-accent, hsl(210, 50%, 60%));
  --grotto-progress-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-prompt-background-color: var(--background-primary, hsl(40, 0%, 86%));
  --grotto-prompt-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-prompt-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-prompt-border-width: var(--grotto-global-border-width, 1px);
  --grotto-prompt-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-properties-background-color: var(--background-primary, hsl(40, 0%, 86%));
  --grotto-properties-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-properties-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-properties-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-pull-background-color: var(--grotto-accent, hsl(210, 50%, 60%));
  --grotto-pull-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-pull-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-pull-color: var(--grotto-text-color-on-accent, hsl(40, 0%, 86%));
  --grotto-redacted: 'Flow Circular';
  --grotto-resize-handle-border-color: transparent;
  --grotto-resize-handle-border-width: var(--grotto-global-border-width, 1px);
  --grotto-resize-handle-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-ribbon-border-color: transparent;
  --grotto-ribbon-border-radius: 0rem;
  --grotto-ribbon-border-width: var(--grotto-global-border-width, 1px);
  --grotto-scrollbar-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-settings-background-color: var(--background-secondary, hsl(40, 0%, 80%));
  --grotto-settings-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-settings-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-settings-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-slider-background-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-slider-border-color: var(--background-primary, hsl(40, 0%, 86%));
  --grotto-statusbar-background-color: var(--background-secondary, hsl(40, 0%, 80%));
  --grotto-statusbar-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-statusbar-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-statusbar-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-strikethrough-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-strikethrough-opacity: 0.5;
  --grotto-strikethrough-weight: 500;
  --grotto-suggestion-background-color: var(--grotto-background-tertiary, hsl(40, 0%, 76%));
  --grotto-suggestion-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-suggestion-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-suggestion-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-suggestion-selected-background-color: var(--grotto-accent, hsl(210, 50%, 60%));
  --grotto-suggestion-selected-color: var(--grotto-text-color-on-accent, hsl(40, 0%, 86%));
  --grotto-tab-switcher-background-color: var(--background-primary, hsl(40, 0%, 86%));
  --grotto-tab-switcher-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-tab-switcher-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-tab-switcher-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-tab-switcher-menu-background-color: var(--grotto-background-tertiary, hsl(40, 0%, 76%));
  --grotto-tab-switcher-selected-tab-background-color: var(--grotto-accent, hsl(210, 50%, 60%));
  --grotto-tab-switcher-tab-height: 200px;
  --grotto-table-background-color: transparent;
  --grotto-table-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-table-border-radius: 0rem;
  --grotto-table-border-style: separate;
  --grotto-table-border-width: var(--grotto-global-border-width, 1px);
  --grotto-table-cell-width: fit-content;
  --grotto-table-cell-width-reading: wrap;
  --grotto-table-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-tag-background-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-tag-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-tag-border-radius: 0rem;
  --grotto-tag-border-width: 1.5px;
  ...
  --grotto-text-color-on-accent: var(--grotto-light-1, hsl(40, 0%, 86%));
  --grotto-titlebar-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-titlebar-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-toggle-background-color: var(--background-primary, hsl(40, 0%, 86%));
  --grotto-toggle-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-toggle-border-width: var(--grotto-global-border-width, 1px);
  --grotto-toggle-enabled-background-color: var(--grotto-accent, hsl(210, 50%, 60%));
  --grotto-tooltip-background-color: var(--grotto-background-tertiary, hsl(40, 0%, 76%));
  --grotto-tooltip-border-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-tooltip-border-radius: var(--grotto-global-border-radius, 0rem);
  --grotto-tooltip-border-width: var(--grotto-global-border-width, 1px);
  --grotto-tooltip-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-view-header-background-color: var(--grotto-background-tertiary, hsl(40, 0%, 76%));
  --grotto-view-header-color: var(--text-normal, hsl(220, 30%, 28%));
  --grotto-view-header-sidebar-toggle-display: none;
  --headerFont: var(--font-text, var(--grotto-font-main, 'Quicksand'));
  --heading-formatting: var(--text-faint, hsl(220, 30%, 36%));
  --highlight: var(--text-highlight-bg, var(--grotto-background-tertiary, hsl(40, 0%, 76%)));
  --icon-color: var(--text-muted, hsl(220, 30%, 36%));
  --icon-color-active: var(--text-accent, hsl(210, 50%, 60%));
  --icon-color-focused: var(--text-normal, hsl(220, 30%, 28%));
  --icon-color-hover: var(--text-muted, hsl(220, 30%, 36%));
  --input-date-separator: var(--text-faint, hsl(220, 30%, 36%));
  --input-placeholder-color: var(--text-faint, hsl(220, 30%, 36%));
  --input-shadow: none;
  --input-shadow-hover: none;
  --interactive-accent: var(--color-accent-1, hsl(210, 50%, 60%));
  --interactive-accent-hover: var(--color-accent-2, hsl(210, 50%, 60%));
  --interactive-accent-hsl: var(--color-accent-hsl, 210, 50%, 60%);
  --light: var(--background-primary, var(--grotto-light-1, hsl(40, 0%, 86%)));
  --lightgray: var(--background-secondary, var(--grotto-light-0, hsl(40, 0%, 80%)));
  --link-color: var(--text-accent, hsl(210, 50%, 60%));
  --link-color-hover: var(--text-accent-hover, hsl(210, 50%, 60%));
  --link-external-color: var(--text-accent, hsl(210, 50%, 60%));
  --link-external-color-hover: var(--text-accent-hover, hsl(210, 50%, 60%));
  --link-unresolved-color: var(--text-accent, hsl(210, 50%, 60%));
  --list-bullet-radius: var(--grotto-global-border-radius, 0rem);
  --list-marker-color: var(--grotto-list-marker-color, hsl(220, 30%, 28%));
  --list-marker-color-collapsed: var(--grotto-list-marker-color, hsl(220, 30%, 28%));
  --list-marker-color-hover: var(--grotto-list-marker-color, hsl(220, 30%, 28%));
  --menu-background: var(--background-secondary, hsl(40, 0%, 80%));
  --menu-radius: var(--radius-m, 0px);
  --menu-shadow: var(--shadow-s, none);
  --metadata-input-font: var(--font-interface, 'Quicksand');
  --metadata-input-text-color: var(--text-normal, hsl(220, 30%, 28%));
  --metadata-label-font: var(--font-interface, 'Quicksand');
  --metadata-label-text-color: var(--text-muted, hsl(220, 30%, 36%));
  --metadata-label-text-color-hover: var(--text-muted, hsl(220, 30%, 36%));
  --modal-background: var(--background-primary, hsl(40, 0%, 86%));
  --modal-radius: var(--radius-l, 0px);
  --nav-collapse-icon-color: var(--collapse-icon-color, hsl(220, 30%, 36%));
  --nav-collapse-icon-color-collapsed: var(--text-faint, hsl(220, 30%, 36%));
  --nav-heading-color: var(--text-normal, hsl(220, 30%, 28%));
  --nav-heading-color-collapsed: var(--text-faint, hsl(220, 30%, 36%));
  --nav-heading-color-collapsed-hover: var(--text-muted, hsl(220, 30%, 36%));
  --nav-heading-color-hover: var(--text-normal, hsl(220, 30%, 28%));
  --nav-item-color: var(--text-muted, hsl(220, 30%, 36%));
  --nav-item-color-active: var(--text-normal, hsl(220, 30%, 28%));
  --nav-item-color-highlighted: var(--text-accent, hsl(210, 50%, 60%));
  --nav-item-color-hover: var(--text-normal, hsl(220, 30%, 28%));
  --nav-item-color-selected: var(--text-normal, hsl(220, 30%, 28%));
  --nav-item-radius: var(--radius-s, 0px);
  --nav-tag-color: var(--text-faint, hsl(220, 30%, 36%));
  --nav-tag-color-active: var(--text-muted, hsl(220, 30%, 36%));
  --nav-tag-color-hover: var(--text-muted, hsl(220, 30%, 36%));
  --nav-tag-radius: var(--radius-s, 0px);
  --p-spacing: 0rem;
  ...
  --pill-color: var(--text-muted, hsl(220, 30%, 36%));
  --pill-color-hover: var(--text-normal, hsl(220, 30%, 28%));
  --pill-color-remove: var(--text-faint, hsl(220, 30%, 36%));
  --pill-color-remove-hover: var(--text-accent, hsl(210, 50%, 60%));
  ...
  --raised-background: var(--blur-background, none);
  --raised-shadow: var(--shadow-xs, none);
  --ribbon-background: var(--background-secondary, hsl(40, 0%, 80%));
  ...
  --scrollbar-radius: var(--grotto-global-border-radius, 0rem);
  --scrollbar-thumb-bg: var(--grotto-accent, hsl(210, 50%, 60%));
  --search-clear-button-color: var(--text-muted, hsl(220, 30%, 36%));
  --search-icon-color: var(--text-muted, hsl(220, 30%, 36%));
  --search-result-background: var(--background-primary, hsl(40, 0%, 86%));
  --secondary: var(--text-accent, var(--color-accent, hsl(210, 50%, 60%)));
  --setting-group-heading-color: var(--text-normal, hsl(220, 30%, 28%));
  --setting-items-background: var(--background-primary-alt, hsl(40, 0%, 86%));
  --setting-items-radius: var(--radius-l, 0px);
  --shadow-edges: none;
  --shadow-l: none;
  --shadow-s: none;
  --shiki-active-tab-border-color: var(--shiki-highlight-neutral, hsl(220, 30%, 36%));
  --shiki-code-background: var(--code-background, hsl(40, 0%, 86%));
  --shiki-code-block-spacing: var(--p-spacing, 0rem);
  --shiki-code-comment: var(--text-faint, hsl(220, 30%, 36%));
  --shiki-code-normal: var(--text-muted, hsl(220, 30%, 36%));
  --shiki-code-punctuation: var(--text-muted, hsl(220, 30%, 36%));
  --shiki-gutter-text-color: var(--text-faint, hsl(220, 30%, 36%));
  --shiki-gutter-text-color-highlight: var(--shiki-code-normal, hsl(220, 30%, 36%));
  --shiki-highlight-neutral: var(--shiki-code-normal, hsl(220, 30%, 36%));
  --shiki-terminal-dots-color: var(--text-faint, hsl(220, 30%, 36%));
  --slider-thumb-y: -7px;
  --status-bar-background: var(--background-secondary, hsl(40, 0%, 80%));
  --status-bar-radius: var(--radius-m, 0px 0 0 0) 0 0 0;
  --status-bar-text-color: var(--text-muted, hsl(220, 30%, 36%));
  --suggestion-background: var(--background-primary, hsl(40, 0%, 86%));
  --tab-background-active: var(--background-primary, hsl(40, 0%, 86%));
  --tab-container-background: var(--background-secondary, hsl(40, 0%, 80%));
  --tab-curve: 0rem;
  --tab-radius: var(--radius-s, 0px);
  --tab-switcher-background: var(--background-secondary, hsl(40, 0%, 80%));
  --tab-switcher-preview-background-shadow: none;
  --tab-switcher-preview-radius: var(--radius-xl, 0px);
  --tab-text-color: var(--text-faint, hsl(220, 30%, 36%));
  --tab-text-color-active: var(--text-muted, hsl(220, 30%, 36%));
  --tab-text-color-focused: var(--text-muted, hsl(220, 30%, 36%));
  --tab-text-color-focused-active: var(--text-muted, hsl(220, 30%, 36%));
  --tab-text-color-focused-active-current: var(--text-normal, hsl(220, 30%, 28%));
  --tab-text-color-focused-highlighted: var(--text-accent, hsl(210, 50%, 60%));
  --table-add-button-border-color: var(--table-border-color, hsl(220, 30%, 28%));
  --table-background: var(--grotto-table-background-color, transparent);
  --table-border-color: var(--grotto-table-border-color, hsl(220, 30%, 28%));
  --table-border-width: var(--grotto-table-border-width, 1px);
  --table-drag-handle-background-active: var(--table-selection-border-color, hsl(210, 50%, 60%));
  --table-drag-handle-color: var(--text-faint, hsl(220, 30%, 36%));
  --table-header-background-hover: var(--table-background, transparent);
  --table-header-border-color: var(--table-border-color, hsl(220, 30%, 28%));
  --table-header-color: var(--text-normal, hsl(220, 30%, 28%));
  --table-selection-border-color: var(--interactive-accent, hsl(210, 50%, 60%));
  --table-text-color: var(--grotto-table-color, hsl(220, 30%, 28%));
  --tag-color: var(--text-accent, hsl(210, 50%, 60%));
  --tag-color-hover: var(--text-accent, hsl(210, 50%, 60%));
  --tertiary: var(--text-accent-hover, var(--color-accent-2, hsl(210, 50%, 60%)));
  --text-accent: var(--color-accent, hsl(210, 50%, 60%));
  --text-accent-hover: var(--color-accent-2, hsl(210, 50%, 60%));
  --text-error: var(--color-red, hsl(0, 50%, 50%));
  --text-faint: var(--grotto-dark-2, hsl(220, 30%, 36%));
  --text-highlight-bg: var(--grotto-background-tertiary, hsl(40, 0%, 76%));
  --text-muted: var(--grotto-dark-2, hsl(220, 30%, 36%));
  --text-normal: var(--grotto-dark-1, hsl(220, 30%, 28%));
  --text-selection: hsla(var(--color-accent-hsl), 1);
  --text-success: var(--color-green, hsl(100, 50%, 50%));
  --text-warning: var(--color-orange, hsl(30, 50%, 50%));
  --textHighlight: var(--text-highlight-bg, var(--grotto-background-tertiary, hsl(40, 0%, 76%)));
  --titleFont: var(--font-text, var(--grotto-font-main, 'Quicksand'));
  --titlebar-background: var(--background-secondary, hsl(40, 0%, 80%));
  --titlebar-background-focused: var(--background-secondary-alt, hsl(40, 0%, 80%));
  --titlebar-text-color: var(--text-muted, hsl(220, 30%, 36%));
  --titlebar-text-color-focused: var(--text-normal, hsl(220, 30%, 28%));
  --touch-radius-l: var(--touch-size-l, 0px);
  --touch-radius-m: var(--touch-size-m, 0px);
  --touch-radius-s: var(--touch-size-s, 0px);
  --touch-radius-xl: var(--touch-size-xl, 0px);
  --touch-radius-xs: var(--touch-size-xs, 0px);
  --touch-radius-xxs: var(--touch-size-xxs, 0px);
  --vault-profile-color: var(--text-normal, hsl(220, 30%, 28%));
  --vault-profile-color-hover: var(--vault-profile-color, hsl(220, 30%, 28%));
  --quartz-icon-color: var(--icon-color, currentColor);
  --collapse-icon-color: var(--nav-collapse-icon-color);
  --collapse-icon-color-collapsed: var(--nav-collapse-icon-color-collapsed);
}
...
html[saved-theme="light"] body[data-slug] div#quartz-root.page, html[saved-theme="light"] .page > div#quartz-body div.sidebar.left, html[saved-theme="light"] .page > div#quartz-body div.sidebar.left:has(.explorer), html[saved-theme="light"] .page > div#quartz-body div.sidebar.left .explorer .explorer-content {
  --bases-table-header-background: var(--background-secondary, hsl(40, 0%, 80%));
  background-color: var(--tab-container-background, rgb(204, 204, 204));
  color: rgb(50, 64, 93);
}
...
html[saved-theme="light"] body .page > div#quartz-body div.sidebar {
  background-color: var(--background-secondary, rgb(204, 204, 204));
  color: rgb(50, 64, 93);
}
...
html[saved-theme="light"] body .text-highlight {
  ...
  color: var(--text-normal, rgb(50, 64, 93));
  font-family: Quicksand;
  font-weight: 500;
...
html[saved-theme="light"] body p {
  color: var(--text-muted, rgb(64, 83, 119));
  font-family: Quicksand;
  font-weight: 500;
...
html[saved-theme="light"] body ul.overflow {
  ...
  color: var(--text-faint, rgb(64, 83, 119));
}

html[saved-theme="light"] body blockquote {
  background-color: var(--grotto-blockquote-background-color, rgba(0, 0, 0, 0));
  color: var(--grotto-blockquote-color, rgb(50, 64, 93));
  font-family: Quicksand;
  font-weight: 500;
}`,
...
html[saved-theme="light"] body td {
  ...
  border-top-color: rgb(50, 64, 93);
  border-top-width: 0px;
  color: var(--table-text-color, rgb(50, 64, 93));
  font-weight: 500;
}
...
html[saved-theme="light"] body th {
  ...
  border-top-color: rgb(50, 64, 93);
  border-top-width: 0px;
  color: var(--table-header-color, rgb(50, 64, 93));
}`,
  ...
  border-top-right-radius: 0px;
  border-top-width: 1px;
  color: var(--grotto-code-color, rgb(50, 64, 93));
  font-family: var(--font-monospace, Quicksand);
  padding-bottom: 1.6px;
  padding-left: 3.2px;
  padding-right: 3.2px;
...
html[saved-theme="light"] body .transclude {
  ...
  border-top-style: solid;
  border-top-width: 1px;
  color: var(--grotto-embed-color, rgb(50, 64, 93));
  padding-bottom: 16px;
  padding-left: 0px;
  padding-right: 0px;
  padding-top: 0px;
...
html[saved-theme="light"] body li.task-list-item[data-task="u"] input[type="checkbox"]::after {
  ...
  border-top-color: rgb(50, 64, 93);
  border-top-width: 0px;
  color: var(--grotto-callout-color, rgb(50, 64, 93));
  gap: 2px;
}

html[saved-theme="light"] body .callout .callout-title > .callout-title-inner > p {
  color: var(--callout-title-color, rgb(50, 64, 93));
}
...
html[saved-theme="light"] body .callout[data-callout="note"] {
  --callout-color: var(--callout-default, hsl(220, 30%, 28%));
  background: rgb(219, 219, 219) none repeat scroll 0% 0% / auto padding-box border-box;
  background-color: var(--grotto-callout-background-color, rgb(219, 219, 219));
  border-bottom-color: rgb(50, 64, 93);
  border-bottom-left-radius: 0px;
...
html[saved-theme="light"] body .search > .search-container > .search-space > input {
  background-color: var(--text-normal, rgb(50, 64, 93));
  border-bottom-color: rgb(50, 64, 93);
  border-bottom-width: 0px;
  border-left-color: rgb(50, 64, 93);
  border-left-style: solid;
...
html[saved-theme="light"] body a.internal-link.tag-link, html[saved-theme="light"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  ...
  --pill-color-remove: var(--tag-color, hsl(210, 50%, 60%));
  --pill-color-remove-hover: var(--tag-color-hover, hsl(210, 50%, 60%));
  background-color: var(--grotto-properties-color, rgb(50, 64, 93));
  border-bottom-color: rgb(50, 64, 93);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
  border-bottom-width: 1px;
...
html[saved-theme="light"] body h1.article-title {
  color: var(--inline-title-color, rgb(50, 64, 93));
}

html[saved-theme="light"] body h2 {
  background: rgb(50, 64, 93) none repeat scroll 0% 0% / auto padding-box border-box;
  background-color: var(--grotto-header-2-background-color, rgb(50, 64, 93));
  border-bottom-color: rgb(50, 64, 93);
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-left-color: rgb(50, 64, 93);
...
html[saved-theme="light"] body h3 {
  ...
  border-top-style: solid;
  border-top-width: 2px;
  color: var(--grotto-header-3-color, rgb(50, 64, 93));
  font-family: var(--h3-font, Quicksand);
  font-size: var(--grotto-header-3-size, 24px);
  font-weight: var(--grotto-header-weight, 500);
  line-height: var(--grotto-header-line-height, 32px);
...
html[saved-theme="light"] body h4 {
  ...
  border-top-color: rgb(50, 64, 93);
  border-top-width: 0px;
  color: var(--grotto-header-4-color, rgb(50, 64, 93));
  font-family: var(--h4-font, Quicksand);
  font-size: var(--grotto-header-4-size, 24px);
  font-weight: var(--grotto-header-weight, 500);
  line-height: var(--grotto-header-line-height, 32px);
...
html[saved-theme="light"] body h5 {
  ...
  border-top-style: solid;
  border-top-width: 2px;
  color: var(--grotto-header-5-color, rgb(50, 64, 93));
  font-family: var(--h5-font, Quicksand);
  font-size: var(--grotto-header-5-size, 24px);
  font-weight: var(--grotto-header-weight, 500);
  line-height: var(--grotto-header-line-height, 32px);
...
html[saved-theme="light"] body h6 {
  ...
  border-top-style: solid;
  border-top-width: 2px;
  color: var(--grotto-header-6-color, rgb(50, 64, 93));
  font-family: var(--h6-font, Quicksand);
  font-size: var(--grotto-header-6-size, 24px);
  font-weight: var(--grotto-header-weight, 500);
  line-height: var(--grotto-header-line-height, 32px);
...
html[saved-theme="light"] body hr {
  ...
  color: var(--grotto-filenav-color, rgb(50, 64, 93));
  font-family: Quicksand;
  font-weight: var(--nav-item-weight, 500);
}
...
html[saved-theme="light"] body li.depth-0 {
  ...
  border-top-right-radius: 0px;
  border-top-width: 0px;
  color: var(--grotto-icon-color, rgb(50, 64, 93));
}`,
    footer: `html[saved-theme="light"] body footer {
  background-color: var(--grotto-statusbar-background-color, rgb(204, 204, 204));
  border-bottom-color: rgb(50, 64, 93);
  border-bottom-width: 1px;
  border-left-color: rgb(50, 64, 93);
  border-left-width: 0px;
  ...
  border-top-left-radius: 0px;
  border-top-width: 0px;
  color: var(--grotto-statusbar-color, rgb(50, 64, 93));
  font-family: Quicksand;
}
...
html[saved-theme="light"] body kbd {
  ...
  border-top-right-radius: 0px;
  border-top-width: 0px;
  color: var(--code-normal, rgb(50, 64, 93));
  font-family: var(--font-monospace, Quicksand);
}
...
html[saved-theme="light"] body ul.tags > li {
  background-color: var(--grotto-tag-background-color, rgb(50, 64, 93));
  border-bottom-color: rgb(50, 64, 93);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
  border-bottom-width: 1px;
