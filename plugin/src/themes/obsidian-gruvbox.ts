...
export const theme: ThemeData = {
  ...
  --dark: var(--text-normal, rgb(251, 241, 199));
  --dark0: rgb(40, 40, 40);
  ...
  --dark4_x: 124,111,100;
  --darkgray: var(--text-normal, rgb(251, 241, 199));
  ...
  --highlight: var(--text-highlight-bg, rgb(215, 153, 33));
  ...
  --secondary: var(--text-accent, rgb(214, 93, 14));
  ...
  --shiki-code-function: rgb(152, 151, 26);
  --shiki-code-important: rgb(214, 93, 14);
  --shiki-code-keyword: rgb(211, 134, 155);
  --shiki-code-normal: rgb(213, 196, 161);
  --shiki-code-property: rgb(69, 133, 136);
  --shiki-code-punctuation: rgb(213, 196, 161);
  --shiki-code-string: rgb(215, 153, 33);
  --shiki-code-value: rgb(177, 98, 134);
  ...
  --tag-padding-y: .2em;
  --tag-radius: .5em;
  --tertiary: var(--text-accent-hover, rgb(142, 192, 124));
  ...
  --textHighlight: var(--text-highlight-bg, rgb(215, 153, 33));
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --dark: var(--text-normal, rgb(40, 40, 40));
  --dark0: rgb(40, 40, 40);
  --dark0-hard: rgb(29, 32, 33);
  --dark0-hard_x: 29,32,33;
  --dark0-soft: rgb(50, 48, 47);
  ...
  --dark4: rgb(124, 111, 100);
  --dark4_x: 124,111,100;
  --darkgray: var(--text-normal, rgb(40, 40, 40));
  ...
  --highlight: var(--text-highlight-bg, rgb(250, 189, 47));
  ...
  --shiki-active-tab-border-color: rgb(80, 73, 69);
  --shiki-code-background: rgb(235, 219, 178);
  --shiki-code-comment: rgb(102, 92, 84);
  --shiki-code-function: rgb(152, 151, 26);
  --shiki-code-important: rgb(214, 93, 14);
  --shiki-code-keyword: rgb(211, 134, 155);
  --shiki-code-normal: rgb(80, 73, 69);
  --shiki-code-property: rgb(69, 133, 136);
  --shiki-code-punctuation: rgb(80, 73, 69);
  --shiki-code-string: rgb(215, 153, 33);
  --shiki-code-value: rgb(177, 98, 134);
  --shiki-gutter-border-color: rgb(213, 196, 161);
  --shiki-gutter-text-color: rgb(102, 92, 84);
  --shiki-gutter-text-color-highlight: rgb(80, 73, 69);
  --shiki-highlight-green: rgba(152, 151, 26, 0.5);
  --shiki-highlight-green-background: rgba(152, 151, 26, 0.1);
  --shiki-highlight-neutral: rgb(80, 73, 69);
  --shiki-highlight-red: rgba(204, 36, 29, 0.5);
  --shiki-highlight-red-background: rgba(204, 36, 29, 0.1);
  --shiki-terminal-dots-color: rgb(102, 92, 84);
  ...
  --text-success: rgb(152, 151, 26);
  --text-warning: rgb(214, 93, 14);
  --textHighlight: var(--text-highlight-bg, rgb(250, 189, 47));
