...
export const theme: ThemeData = {
  ...
  --background-modifier-error: var(--color-red, rgb(204, 36, 29));
  --background-modifier-error-hover: var(--color-red, rgb(204, 36, 29));
  --background-modifier-error-rgb: var(--color-red-rgb, 204,36,29);
  --background-modifier-success: var(--color-green, rgb(152, 151, 26));
  --background-modifier-success-rgb: var(--color-green-rgb, 152,151,26);
  --background-primary: var(--dark0, rgb(40, 40, 40));
  --background-primary-alt: var(--dark0, rgb(40, 40, 40));
  ...
  --bases-cards-cover-background: var(--background-primary-alt, rgb(40, 40, 40));
  ...
  --bases-table-cell-background-disabled: var(--background-primary-alt, rgb(40, 40, 40));
  --bases-table-cell-background-selected: var(--table-selection, hsla(12, 107%, 32%, 0.1));
  --bases-table-group-background: var(--background-primary-alt, rgb(40, 40, 40));
  ...
  --blockquote-border-color: var(--interactive-accent, hsl(12, 107%, 32%));
  --bold-color: var(--neutral-yellow, rgb(215, 153, 33));
  ...
  --calendar-hover: var(--bright-red, rgb(251, 73, 52));
  --calendar-today: var(--neutral-orange, rgb(214, 93, 14));
  --calendar-week: var(--neutral-orange, rgb(214, 93, 14));
  --callout-border-opacity: 0.4;
  --callout-border-width: 1px;
  --callout-bug: var(--neutral-red_x, 204,36,29);
  --callout-default: var(--neutral-blue_x, 69,133,136);
  --callout-error: var(--neutral-red_x, 204,36,29);
  --callout-example: var(--neutral-purple_x, 177,98,134);
  --callout-fail: var(--neutral-red_x, 204,36,29);
  --callout-important: var(--neutral-aqua_x, 104,157,106);
  --callout-info: var(--neutral-blue_x, 69,133,136);
  --callout-note: var(--neutral-blue_x, 69,133,136);
  --callout-question: var(--neutral-yellow_x, 215,153,33);
  --callout-quote: var(--gray_x, 146,131,116);
  --callout-success: var(--neutral-green_x, 152,151,26);
  --callout-summary: var(--neutral-aqua_x, 104,157,106);
  --callout-tip: var(--neutral-aqua_x, 104,157,106);
  --callout-todo: var(--neutral-blue_x, 69,133,136);
  --callout-warning: var(--neutral-orange_x, 214,93,14);
  ...
  --canvas-color-5: var(--color-cyan-rgb, 69,133,136);
  --canvas-color-6: var(--color-purple-rgb, 177,98,134);
  --caret-color: var(--text-normal, rgb(251, 241, 199));
  ...
  --code-function: var(--color-yellow, rgb(215, 153, 33));
  --code-important: var(--color-orange, rgb(214, 93, 14));
  --code-keyword: var(--color-pink, rgb(211, 134, 155));
  --code-normal: var(--bright-blue, rgb(131, 165, 152));
  --code-operator: var(--color-red, rgb(204, 36, 29));
  --code-property: var(--color-cyan, rgb(69, 133, 136));
  --code-punctuation: var(--text-muted, rgb(213, 196, 161));
  --code-string: var(--color-green, rgb(152, 151, 26));
  --code-tag: var(--color-red, rgb(204, 36, 29));
  --code-value: var(--color-purple, rgb(177, 98, 134));
  --collapse-icon-color: var(--text-faint, rgb(235, 219, 178));
  --collapse-icon-color-collapsed: var(--text-accent, rgb(214, 93, 14));
  --color-blue: var(--faded-blue, rgb(7, 102, 120));
  --color-blue-rgb: var(--faded-blue_x, 7,102,120);
  --color-cyan: var(--neutral-blue, rgb(69, 133, 136));
  --color-cyan-rgb: var(--neutral-blue_x, 69,133,136);
  --color-green: var(--neutral-green, rgb(152, 151, 26));
  --color-green-rgb: var(--neutral-green_x, 152,151,26);
  --color-orange: var(--neutral-orange, rgb(214, 93, 14));
  --color-orange-rgb: var(--neutral-orange_x, 214,93,14);
  --color-pink: var(--bright-purple, rgb(211, 134, 155));
  --color-pink-rgb: var(--bright-purple_x, 211,134,155);
  --color-purple: var(--neutral-purple, rgb(177, 98, 134));
  --color-purple-rgb: var(--neutral-purple_x, 177,98,134);
  --color-red: var(--neutral-red, rgb(204, 36, 29));
  --color-red-rgb: var(--neutral-red_x, 204,36,29);
  --color-yellow: var(--neutral-yellow, rgb(215, 153, 33));
  --color-yellow-rgb: var(--neutral-yellow_x, 215,153,33);
  --cursor-line-background: rgba(var(--dark1_x), 0.5);
  --dark: var(--text-normal, var(--light0, rgb(251, 241, 199)));
  --dark0: rgb(40, 40, 40);
  ...
  --dark4_x: 124,111,100;
  --darkgray: var(--text-normal, var(--light0, rgb(251, 241, 199)));
  ...
  --divider-color-hover: var(--interactive-accent, hsl(12, 107%, 32%));
  ...
  --flair-color: var(--text-normal, rgb(251, 241, 199));
  ...
  --graph-node-attachment: var(--neutral-green, rgb(152, 151, 26));
  --graph-node-focused: var(--text-accent, rgb(214, 93, 14));
  --graph-node-tag: var(--neutral-red, rgb(204, 36, 29));
  --graph-node-unresolved: var(--text-faint, rgb(235, 219, 178));
  --graph-text: var(--text-normal, rgb(251, 241, 199));
  --gray: rgb(146, 131, 116);
  --gray_x: 146,131,116;
  --h1-color: var(--neutral-red, rgb(204, 36, 29));
  --h2-color: var(--neutral-yellow, rgb(215, 153, 33));
  --h3-color: var(--neutral-green, rgb(152, 151, 26));
  --h4-color: var(--neutral-aqua, rgb(104, 157, 106));
  --h5-color: var(--neutral-blue, rgb(69, 133, 136));
  --h6-color: var(--neutral-purple, rgb(177, 98, 134));
  --heading-formatting: var(--text-faint, rgb(235, 219, 178));
  --highlight: var(--text-highlight-bg, var(--neutral-yellow, rgb(215, 153, 33)));
  --hr-color: var(--background-modifier-border, rgb(60, 56, 54));
  --icon-color: var(--text-muted, rgb(213, 196, 161));
  --icon-color-active: var(--text-accent, rgb(214, 93, 14));
  --icon-color-focused: var(--bright-blue, rgb(131, 165, 152));
  --icon-color-hover: var(--bright-red, rgb(251, 73, 52));
  --inline-title-color: var(--bright-yellow, rgb(250, 189, 47));
  --input-date-separator: var(--text-faint, rgb(235, 219, 178));
  --input-placeholder-color: var(--text-faint, rgb(235, 219, 178));
  --interactive-accent: var(--color-accent, hsl(12, 107%, 32%));
  --interactive-accent-hover: var(--color-accent-1, hsl(9, 109.14%, 36.8%));
  --interactive-accent-hsl: var(--color-accent-hsl, 12, 107%, 32%);
  --italic-color: var(--neutral-yellow, rgb(215, 153, 33));
  ...
  --link-color: var(--text-accent, rgb(214, 93, 14));
  --link-color-hover: var(--text-accent-hover, rgb(142, 192, 124));
  --link-decoration: none;
  --link-decoration-hover: none;
  --link-external-color: var(--text-accent, rgb(214, 93, 14));
  --link-external-color-hover: var(--text-accent-hover, rgb(142, 192, 124));
  --link-external-decoration: none;
  --link-external-decoration-hover: none;
  --link-unresolved-color: var(--text-accent, rgb(214, 93, 14));
  --link-url: var(--neutral-green, rgb(152, 151, 26));
  --list-marker-color: var(--text-faint, rgb(235, 219, 178));
  --list-marker-color-collapsed: var(--text-accent, rgb(214, 93, 14));
  ...
  --mermaid-exclude: var(--dark4, rgb(124, 111, 100));
  --mermaid-loopline: var(--neutral-blue, rgb(69, 133, 136));
  --mermaid-note: var(--neutral-blue, rgb(69, 133, 136));
  --mermaid-seqnum: var(--dark0, rgb(40, 40, 40));
  ...
  --metadata-input-text-color: var(--text-normal, rgb(251, 241, 199));
  ...
  --nav-heading-color: var(--text-normal, rgb(251, 241, 199));
  ...
  --nav-heading-color-hover: var(--text-normal, rgb(251, 241, 199));
  --nav-item-color: var(--text-muted, rgb(213, 196, 161));
  --nav-item-color-active: var(--bright-aqua, rgb(142, 192, 124));
  --nav-item-color-highlighted: var(--text-accent, rgb(214, 93, 14));
  --nav-item-color-hover: var(--bright-red, rgb(251, 73, 52));
  --nav-item-color-selected: var(--text-normal, rgb(251, 241, 199));
  ...
  --pill-color-hover: var(--text-normal, rgb(251, 241, 199));
  --pill-color-remove: var(--text-faint, rgb(235, 219, 178));
  --pill-color-remove-hover: var(--text-accent, rgb(214, 93, 14));
  ...
  --secondary: var(--text-accent, var(--neutral-orange, rgb(214, 93, 14)));
  --setting-group-heading-color: var(--text-normal, rgb(251, 241, 199));
  --setting-items-background: var(--background-primary-alt, rgb(40, 40, 40));
  ...
  --shiki-code-function: var(--color-green, rgb(152, 151, 26));
  --shiki-code-important: var(--color-orange, rgb(214, 93, 14));
  --shiki-code-keyword: var(--color-pink, rgb(211, 134, 155));
  --shiki-code-normal: var(--text-muted, rgb(213, 196, 161));
  --shiki-code-property: var(--color-cyan, rgb(69, 133, 136));
  --shiki-code-punctuation: var(--text-muted, rgb(213, 196, 161));
  --shiki-code-string: var(--color-yellow, rgb(215, 153, 33));
  --shiki-code-value: var(--color-purple, rgb(177, 98, 134));
  ...
  --sync-avatar-color-1: var(--color-red, rgb(204, 36, 29));
  --sync-avatar-color-2: var(--color-orange, rgb(214, 93, 14));
  --sync-avatar-color-3: var(--color-yellow, rgb(215, 153, 33));
  --sync-avatar-color-4: var(--color-green, rgb(152, 151, 26));
  --sync-avatar-color-5: var(--color-cyan, rgb(69, 133, 136));
  --sync-avatar-color-6: var(--color-blue, rgb(7, 102, 120));
  --sync-avatar-color-7: var(--color-purple, rgb(177, 98, 134));
  ...
  --tab-text-color-focused-active: var(--neutral-yellow, rgb(215, 153, 33));
  --tab-text-color-focused-active-current: var(--bright-red, rgb(251, 73, 52));
  --tab-text-color-focused-highlighted: var(--text-accent, rgb(214, 93, 14));
  ...
  --table-drag-handle-background-active: var(--table-selection-border-color, hsl(12, 107%, 32%));
  ...
  --table-header-color: var(--text-normal, rgb(251, 241, 199));
  ...
  --table-selection-border-color: var(--interactive-accent, hsl(12, 107%, 32%));
  --tag-background: var(--dark2, rgb(80, 73, 69));
  --tag-background-hover: var(--dark1, rgb(60, 56, 54));
  --tag-color: var(--bright-aqua, rgb(142, 192, 124));
  --tag-color-hover: var(--text-accent, rgb(214, 93, 14));
  --tag-decoration-hover: underline;
  --tag-padding-x: .5em;
  --tag-padding-y: .2em;
  --tag-radius: .5em;
  --tertiary: var(--text-accent-hover, var(--bright-aqua, rgb(142, 192, 124)));
  --text-accent: var(--neutral-orange, rgb(214, 93, 14));
  --text-accent-hover: var(--bright-aqua, rgb(142, 192, 124));
  --text-error: var(--color-red, rgb(204, 36, 29));
  --text-faint: var(--light1, rgb(235, 219, 178));
  --text-highlight-bg: var(--neutral-yellow, rgb(215, 153, 33));
  --text-highlight-fg: var(--dark0-hard, rgb(29, 32, 33));
  --text-muted: var(--light2, rgb(213, 196, 161));
  --text-normal: var(--light0, rgb(251, 241, 199));
  --text-selection: rgba(var(--neutral-red_x), 0.6);
  --text-success: var(--color-green, rgb(152, 151, 26));
  --text-warning: var(--color-orange, rgb(214, 93, 14));
  --textHighlight: var(--text-highlight-bg, var(--neutral-yellow, rgb(215, 153, 33)));
  ...
  --titlebar-text-color-focused: var(--bright-red, rgb(251, 73, 52));
  --vault-profile-color: var(--text-normal, rgb(251, 241, 199));
  --vault-profile-color-hover: var(--vault-profile-color, rgb(251, 241, 199));
...
html[saved-theme="dark"] body .text-highlight {
  background-color: var(--text-highlight-bg, rgb(215, 153, 33));
...
html[saved-theme="dark"] body p {
  ...
  color: var(--link-external-color, rgb(214, 93, 14));
  outline: rgb(214, 93, 14) none 0px;
  text-decoration-color: rgb(214, 93, 14);
}

html[saved-theme="dark"] body a.internal-link, html[saved-theme="dark"] .breadcrumb-container .breadcrumb-element > a {
  color: var(--link-color, rgb(214, 93, 14));
  outline: rgb(214, 93, 14) none 0px;
  text-decoration-color: rgb(214, 93, 14);
}

html[saved-theme="dark"] body a.internal-link.broken {
  color: var(--link-unresolved-color, rgb(214, 93, 14));
  outline: rgb(214, 93, 14) none 0px;
  text-decoration: rgba(163, 33, 0, 0.3);
  text-decoration-color: var(--link-unresolved-decoration-color, rgba(163, 33, 0, 0.3));
}`,
...
html[saved-theme="dark"] body .callout[data-callout="abstract"] {
  ...
  background: rgba(104, 157, 106, 0.2) none repeat scroll 0% 0% / auto padding-box border-box;
...
html[saved-theme="dark"] body .callout[data-callout="bug"] {
  ...
  background: rgba(204, 36, 29, 0.2) none repeat scroll 0% 0% / auto padding-box border-box;
  background-color: rgba(var(--callout-color), 0.2);
...
html[saved-theme="dark"] body .callout[data-callout="example"] {
  ...
  background: rgba(177, 98, 134, 0.2) none repeat scroll 0% 0% / auto padding-box border-box;
  background-color: rgba(var(--callout-color), 0.2);
...
html[saved-theme="dark"] body .callout[data-callout="info"] {
  ...
  background: rgba(69, 133, 136, 0.2) none repeat scroll 0% 0% / auto padding-box border-box;
  background-color: rgba(var(--callout-color), 0.2);
...
html[saved-theme="dark"] body .callout[data-callout="question"] {
  --callout-color: var(--callout-question, 215,153,33);
  background: rgba(215, 153, 33, 0.2) none repeat scroll 0% 0% / auto padding-box border-box;
  background-color: rgba(var(--callout-color), 0.2);
...
html[saved-theme="dark"] body .callout[data-callout="quote"] {
  --callout-color: var(--callout-quote, 146,131,116);
  background: rgba(146, 131, 116, 0.2) none repeat scroll 0% 0% / auto padding-box border-box;
  background-color: rgba(var(--callout-color), 0.2);
...
html[saved-theme="dark"] body .callout[data-callout="success"] {
  ...
  background: rgba(152, 151, 26, 0.2) none repeat scroll 0% 0% / auto padding-box border-box;
  background-color: rgba(var(--callout-color), 0.2);
...
html[saved-theme="dark"] body .callout[data-callout="warning"] {
  ...
  background: rgba(214, 93, 14, 0.2) none repeat scroll 0% 0% / auto padding-box border-box;
  background-color: rgba(var(--callout-color), 0.2);
...
html[saved-theme="dark"] body a.internal-link.tag-link, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  ...
  --pill-border-color: var(--tag-border-color, hsla(12, 107%, 32%, 0.15));
  --pill-border-color-hover: var(--tag-border-color-hover, hsla(12, 107%, 32%, 0.15));
  --pill-color: var(--tag-color, rgb(142, 192, 124));
  --pill-color-hover: var(--tag-color-hover, rgb(214, 93, 14));
  --pill-color-remove: var(--tag-color, rgb(142, 192, 124));
  --pill-color-remove-hover: var(--tag-color-hover, rgb(214, 93, 14));
  ...
  border-top-width: 0px;
  color: var(--pill-color, rgb(142, 192, 124));
}
...
html[saved-theme="dark"] body h1 {
  ...
  border-top-color: rgb(204, 36, 29);
  border-top-width: 0px;
  color: var(--h1-color, rgb(204, 36, 29));
}

html[saved-theme="dark"] body h1.article-title {
  color: var(--inline-title-color, rgb(250, 189, 47));
}
...
html[saved-theme="dark"] body h2 {
  ...
  border-top-width: 0px;
  color: var(--h2-color, rgb(215, 153, 33));
}
...
html[saved-theme="dark"] body h4 {
  ...
  border-top-width: 0px;
  color: var(--h4-color, rgb(104, 157, 106));
}
...
html[saved-theme="dark"] body h5 {
  ...
  border-top-color: rgb(69, 133, 136);
  border-top-width: 0px;
  color: var(--h5-color, rgb(69, 133, 136));
}
...
html[saved-theme="dark"] body h6 {
  ...
  border-top-width: 0px;
  color: var(--h6-color, rgb(177, 98, 134));
}
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  border-top-width: 0px;
  color: var(--tag-color, rgb(142, 192, 124));
}`,
  },
  light: {
    base: `:root:root {
  ...
  --bases-group-heading-property-color: var(--text-muted, rgb(80, 73, 69));
  ...
  --bases-table-header-color: var(--text-muted, rgb(80, 73, 69));
  ...
  --blockquote-border-color: var(--interactive-accent, hsl(11, 108.07%, 34.4%));
  --bold-color: var(--neutral-yellow, rgb(215, 153, 33));
  --bright-aqua: rgb(142, 192, 124);
  --bright-aqua_x: 142,192,124;
  --bright-blue: rgb(131, 165, 152);
  ...
  --calendar-hover: var(--bright-red, rgb(251, 73, 52));
  --calendar-today: var(--bright-red, rgb(251, 73, 52));
  --calendar-week: var(--bright-red, rgb(251, 73, 52));
  --callout-border-opacity: 0.4;
  --callout-border-width: 1px;
  --callout-bug: var(--neutral-red_x, 204,36,29);
  --callout-default: var(--neutral-blue_x, 69,133,136);
  ...
  --canvas-card-label-color: var(--text-faint, rgb(102, 92, 84));
  --canvas-color-1: var(--color-red-rgb, 204,36,29);
  --canvas-color-2: var(--color-orange-rgb, 214,93,14);
  --canvas-color-3: var(--color-yellow-rgb, 215,153,33);
  --canvas-color-4: var(--color-green-rgb, 152,151,26);
  --canvas-color-5: var(--color-cyan-rgb, 69,133,136);
  --canvas-color-6: var(--color-purple-rgb, 177,98,134);
  --caret-color: var(--text-normal, rgb(40, 40, 40));
  --checkbox-border-color: var(--light4, rgb(168, 153, 132));
  --checkbox-border-color-hover: var(--light4, rgb(168, 153, 132));
  --checkbox-color: var(--light4, rgb(168, 153, 132));
  --checkbox-color-hover: var(--light4, rgb(168, 153, 132));
  ...
  --code-comment: var(--text-faint, rgb(102, 92, 84));
  --code-function: var(--color-yellow, rgb(215, 153, 33));
  --code-important: var(--color-orange, rgb(214, 93, 14));
  --code-keyword: var(--color-pink, rgb(211, 134, 155));
  --code-normal: var(--bright-blue, rgb(131, 165, 152));
  --code-operator: var(--color-red, rgb(204, 36, 29));
  --code-property: var(--color-cyan, rgb(69, 133, 136));
  --code-punctuation: var(--text-muted, rgb(80, 73, 69));
  --code-string: var(--color-green, rgb(152, 151, 26));
  --code-tag: var(--color-red, rgb(204, 36, 29));
  --code-value: var(--color-purple, rgb(177, 98, 134));
  --collapse-icon-color: var(--text-faint, rgb(102, 92, 84));
  --collapse-icon-color-collapsed: var(--text-accent, rgb(214, 93, 14));
  --color-blue: var(--faded-blue, rgb(7, 102, 120));
  --color-blue-rgb: var(--faded-blue_x, 7,102,120);
  --color-cyan: var(--neutral-blue, rgb(69, 133, 136));
  ...
  --dark: var(--text-normal, var(--dark0, rgb(40, 40, 40)));
  --dark0: rgb(40, 40, 40);
  --dark0-hard: rgb(29, 32, 33);
  --dark0-hard_x: 29,32,33;
  --dark0-soft: rgb(50, 48, 47);
  ...
  --dark4: rgb(124, 111, 100);
  --dark4_x: 124,111,100;
  --darkgray: var(--text-normal, var(--dark0, rgb(40, 40, 40)));
  --dataview-key: var(--text-faint, rgb(102, 92, 84));
  --dataview-key-background: rgba(var(--faded-red_x), 0.3);
  --dataview-value: var(--text-faint, rgb(102, 92, 84));
  --dataview-value-background: rgba(var(--neutral-green_x), 0.2);
  --divider-color: var(--background-modifier-border, rgb(213, 196, 161));
  --divider-color-hover: var(--interactive-accent, hsl(11, 108.07%, 34.4%));
  --embed-border-left: 6px double var(--interactive-accent);
  --faded-aqua: rgb(66, 123, 88);
  --faded-aqua_x: 66,123,88;
  --faded-blue: rgb(7, 102, 120);
  ...
  --flair-color: var(--text-normal, rgb(40, 40, 40));
  --flashing-background: rgba(var(--neutral-red_x), 0.3);
  --footnote-divider-color: var(--metadata-divider-color, rgb(213, 196, 161));
  --footnote-id-color: var(--text-muted, rgb(80, 73, 69));
  --footnote-id-color-no-occurrences: var(--text-faint, rgb(102, 92, 84));
  --graph-line: var(--light1, rgb(235, 219, 178));
  --graph-node: var(--gray, rgb(146, 131, 116));
  --graph-node-attachment: var(--bright-green, rgb(184, 187, 38));
  --graph-node-focused: var(--text-accent, rgb(214, 93, 14));
  --graph-node-tag: var(--neutral-red, rgb(204, 36, 29));
  --graph-node-unresolved: var(--text-faint, rgb(102, 92, 84));
  --graph-text: var(--text-normal, rgb(40, 40, 40));
  --gray: rgb(146, 131, 116);
  --gray_x: 146,131,116;
  --h1-color: var(--neutral-red, rgb(204, 36, 29));
  --h2-color: var(--neutral-yellow, rgb(215, 153, 33));
  ...
  --h5-color: var(--neutral-blue, rgb(69, 133, 136));
  --h6-color: var(--neutral-purple, rgb(177, 98, 134));
  --heading-formatting: var(--text-faint, rgb(102, 92, 84));
  --highlight: var(--text-highlight-bg, var(--bright-yellow, rgb(250, 189, 47)));
  --hr-color: var(--background-modifier-border, rgb(213, 196, 161));
  --icon-color: var(--text-muted, rgb(80, 73, 69));
  --icon-color-active: var(--text-accent, rgb(214, 93, 14));
  --icon-color-focused: var(--bright-blue, rgb(131, 165, 152));
  --icon-color-hover: var(--bright-red, rgb(251, 73, 52));
  --inline-title-color: var(--bright-yellow, rgb(250, 189, 47));
  --input-date-separator: var(--text-faint, rgb(102, 92, 84));
  --input-placeholder-color: var(--text-faint, rgb(102, 92, 84));
  --interactive-accent: var(--color-accent-1, hsl(11, 108.07%, 34.4%));
  --interactive-accent-hover: var(--color-accent-2, hsl(9, 109.14%, 36.8%));
  --interactive-accent-hsl: var(--color-accent-hsl, 12, 107%, 32%);
  --italic-color: var(--neutral-yellow, rgb(215, 153, 33));
  ...
  --link-unresolved-color: var(--text-accent, rgb(214, 93, 14));
  --link-url: var(--neutral-green, rgb(152, 151, 26));
  --list-marker-color: var(--text-faint, rgb(102, 92, 84));
  --list-marker-color-collapsed: var(--text-accent, rgb(214, 93, 14));
  --list-marker-color-hover: var(--text-muted, rgb(80, 73, 69));
  --menu-background: var(--background-secondary, rgb(235, 219, 178));
  --mermaid-actor: var(--light3, rgb(189, 174, 147));
  --mermaid-exclude: var(--light2, rgb(213, 196, 161));
  --mermaid-loopline: var(--neutral-blue, rgb(69, 133, 136));
  --mermaid-note: var(--bright-blue, rgb(131, 165, 152));
  --mermaid-seqnum: var(--light0, rgb(251, 241, 199));
  ...
  --metadata-input-text-color: var(--text-normal, rgb(40, 40, 40));
  --metadata-label-text-color: var(--text-muted, rgb(80, 73, 69));
  --metadata-label-text-color-hover: var(--text-muted, rgb(80, 73, 69));
  --modal-background: var(--background-primary, rgb(249, 245, 215));
  --nav-collapse-icon-color: var(--collapse-icon-color, rgb(102, 92, 84));
  --nav-collapse-icon-color-collapsed: var(--text-faint, rgb(102, 92, 84));
  --nav-file-tag: rgba(var(--neutral-blue_x), 0.9);
  --nav-heading-color: var(--text-normal, rgb(40, 40, 40));
  --nav-heading-color-collapsed: var(--text-faint, rgb(102, 92, 84));
  --nav-heading-color-collapsed-hover: var(--text-muted, rgb(80, 73, 69));
  --nav-heading-color-hover: var(--text-normal, rgb(40, 40, 40));
  --nav-item-color: var(--text-muted, rgb(80, 73, 69));
  --nav-item-color-active: var(--neutral-blue, rgb(69, 133, 136));
  --nav-item-color-highlighted: var(--text-accent, rgb(214, 93, 14));
  --nav-item-color-hover: var(--bright-red, rgb(251, 73, 52));
  --nav-item-color-selected: var(--text-normal, rgb(40, 40, 40));
  --nav-tag-color: var(--text-faint, rgb(102, 92, 84));
  --nav-tag-color-active: var(--text-muted, rgb(80, 73, 69));
  --nav-tag-color-hover: var(--text-muted, rgb(80, 73, 69));
  --neutral-aqua: rgb(104, 157, 106);
  --neutral-aqua_x: 104,157,106;
  --neutral-blue: rgb(69, 133, 136);
  --neutral-blue_x: 69,133,136;
  ...
  --pill-color: var(--text-muted, rgb(80, 73, 69));
  --pill-color-hover: var(--text-normal, rgb(40, 40, 40));
  --pill-color-remove: var(--text-faint, rgb(102, 92, 84));
  --pill-color-remove-hover: var(--text-accent, rgb(214, 93, 14));
  ...
  --search-clear-button-color: var(--text-muted, rgb(80, 73, 69));
  --search-icon-color: var(--text-muted, rgb(80, 73, 69));
  --search-result-background: var(--background-primary, rgb(249, 245, 215));
  --secondary: var(--text-accent, var(--neutral-orange, rgb(214, 93, 14)));
  --setting-group-heading-color: var(--text-normal, rgb(40, 40, 40));
  ...
  --shiki-active-tab-border-color: var(--shiki-highlight-neutral, rgb(80, 73, 69));
  --shiki-code-background: var(--code-background, rgb(235, 219, 178));
  --shiki-code-comment: var(--text-faint, rgb(102, 92, 84));
  --shiki-code-function: var(--color-green, rgb(152, 151, 26));
  --shiki-code-important: var(--color-orange, rgb(214, 93, 14));
  --shiki-code-keyword: var(--color-pink, rgb(211, 134, 155));
  --shiki-code-normal: var(--text-muted, rgb(80, 73, 69));
  --shiki-code-property: var(--color-cyan, rgb(69, 133, 136));
  --shiki-code-punctuation: var(--text-muted, rgb(80, 73, 69));
  --shiki-code-string: var(--color-yellow, rgb(215, 153, 33));
  --shiki-code-value: var(--color-purple, rgb(177, 98, 134));
  --shiki-gutter-border-color: var(--background-modifier-border, rgb(213, 196, 161));
  --shiki-gutter-text-color: var(--text-faint, rgb(102, 92, 84));
  --shiki-gutter-text-color-highlight: var(--shiki-code-normal, rgb(80, 73, 69));
  --shiki-highlight-neutral: var(--shiki-code-normal, rgb(80, 73, 69));
  --shiki-terminal-dots-color: var(--text-faint, rgb(102, 92, 84));
  ...
  --status-bar-text-color: var(--text-muted, rgb(80, 73, 69));
  ...
  --tab-text-color: var(--text-faint, rgb(102, 92, 84));
  --tab-text-color-active: var(--text-muted, rgb(80, 73, 69));
  --tab-text-color-focused: var(--text-muted, rgb(80, 73, 69));
  --tab-text-color-focused-active: var(--neutral-yellow, rgb(215, 153, 33));
  --tab-text-color-focused-active-current: var(--bright-red, rgb(251, 73, 52));
  --tab-text-color-focused-highlighted: var(--text-accent, rgb(214, 93, 14));
  ...
  --table-drag-handle-background-active: var(--table-selection-border-color, hsl(11, 108.07%, 34.4%));
  --table-drag-handle-color: var(--text-faint, rgb(102, 92, 84));
  ...
  --table-header-color: var(--text-normal, rgb(40, 40, 40));
  ...
  --table-selection-border-color: var(--interactive-accent, hsl(11, 108.07%, 34.4%));
  --tag-background: var(--light1, rgb(235, 219, 178));
  --tag-background-hover: rgba(var(--light1_x), 0.6);
  --tag-color: var(--neutral-aqua, rgb(104, 157, 106));
  --tag-color-hover: var(--text-accent, rgb(214, 93, 14));
  --tag-decoration-hover: underline;
  --tag-padding-x: .5em;
  --tag-padding-y: .2em;
  ...
  --text-accent-hover: var(--bright-aqua, rgb(142, 192, 124));
  --text-error: var(--color-red, rgb(204, 36, 29));
  --text-faint: var(--dark3, rgb(102, 92, 84));
  --text-highlight-bg: var(--bright-yellow, rgb(250, 189, 47));
  --text-highlight-fg: var(--dark0, rgb(40, 40, 40));
  --text-muted: var(--dark2, rgb(80, 73, 69));
  --text-normal: var(--dark0, rgb(40, 40, 40));
  --text-selection: rgba(var(--neutral-red_x), 0.6);
  --text-success: var(--color-green, rgb(152, 151, 26));
  --text-warning: var(--color-orange, rgb(214, 93, 14));
  --textHighlight: var(--text-highlight-bg, var(--bright-yellow, rgb(250, 189, 47)));
  ...
  --titlebar-text-color: var(--text-muted, rgb(80, 73, 69));
  --titlebar-text-color-focused: var(--bright-red, rgb(251, 73, 52));
  --vault-profile-color: var(--text-normal, rgb(40, 40, 40));
  --vault-profile-color-hover: var(--vault-profile-color, rgb(40, 40, 40));
  --quartz-icon-color: var(--icon-color, currentColor);
  --collapse-icon-color: var(--nav-collapse-icon-color);
  --collapse-icon-color-collapsed: var(--nav-collapse-icon-color-collapsed);
}
...
html[saved-theme="light"] body .text-highlight {
  background-color: var(--text-highlight-bg, rgb(250, 189, 47));
  color: var(--text-highlight-fg, rgb(40, 40, 40));
...
html[saved-theme="light"] body blockquote {
  color: var(--blockquote-color, rgb(40, 40, 40));
}`,
...
html[saved-theme="light"] body th {
  ...
  border-top-color: rgb(235, 219, 178);
  border-top-width: 0px;
  color: var(--table-header-color, rgb(40, 40, 40));
}
...
html[saved-theme="light"] body a.internal-link.tag-link, html[saved-theme="light"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  ...
  --pill-border-color: var(--tag-border-color, hsla(12, 107%, 32%, 0.15));
  --pill-border-color-hover: var(--tag-border-color-hover, hsla(12, 107%, 32%, 0.15));
  --pill-color: var(--tag-color, rgb(104, 157, 106));
  --pill-color-hover: var(--tag-color-hover, rgb(214, 93, 14));
  --pill-color-remove: var(--tag-color, rgb(104, 157, 106));
  --pill-color-remove-hover: var(--tag-color-hover, rgb(214, 93, 14));
  --pill-decoration-hover: var(--tag-decoration-hover, underline);
  --pill-padding-x: var(--tag-padding-x, .5em);
  --pill-padding-y: var(--tag-padding-y, .2em);
  ...
  border-top-right-radius: 7px;
  border-top-width: 0px;
  color: var(--pill-color, rgb(104, 157, 106));
}
...
html[saved-theme="light"] body .explorer .nav-files-container .collapse-icon svg {
  ...
  border-top-color: rgb(80, 73, 69);
  border-top-width: 0px;
  color: var(--icon-color, rgb(80, 73, 69));
}`,
...
html[saved-theme="light"] body ul.tags > li {
  ...
  border-top-right-radius: 6.125px;
  border-top-width: 0px;
  color: var(--tag-color, rgb(104, 157, 106));
}`,
  },
};
