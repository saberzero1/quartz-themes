...
export const theme: ThemeData = {
  ...
  --accent-l: 24%;
  --accent-s: 27%;
  --active-line-bg: hsla(33, 20%, 17%, 1);
  --alternating-color-1: hsla(40, 78%, 48%, 1);
  --alternating-color-1-hover-active: hsla(38, 76%, 42%, 1);
  --alternating-color-2: hsla(4, 88%, 61%, 1);
  --alternating-color-2-hover-active: hsla(2, 75%, 52%, 1);
  --alternating-color-3: hsla(197, 48%, 49%, 1);
  --alternating-color-3-hover-active: hsla(201, 45%, 40%, 1);
  ...
  --background-modifier-active-hover: hsla(31, 27%, 25%, 1);
  --background-modifier-border: hsla(28, 22%, 19%, 1);
  --background-modifier-border-focus: color-mix(in srgb, hsla(31, 27%, 25%, 1) 40%, hsla(28, 22%, 19%, 1));
  --background-modifier-border-hover: color-mix(in srgb, hsla(31, 27%, 25%, 1) 40%, hsla(28, 22%, 19%, 1));
  --background-modifier-error: hsla(2, 75%, 52%, 1);
  --background-modifier-error-hover: hsla(4, 88%, 61%, 1);
  --background-modifier-error-rgb: 228,87,78;
  --background-modifier-form-field: hsla(24, 18%, 11%, 1);
  --background-modifier-form-field-hover: hsla(24, 18%, 11%, 1);
  --background-modifier-hover: rgba(0, 0, 0, 0.3);
  --background-modifier-message: hsla(31, 27%, 25%, 1);
  --background-modifier-success: hsla(155, 78%, 29%, 1);
  --background-modifier-success-rgb: 100,194,113;
  --background-modifier-warning: hsla(19, 81%, 41%, 1);
  --background-modifier-warning-hover: hsla(22, 82%, 47%, 1);
  --background-primary: hsla(30, 19%, 15%, 1);
  --background-primary-alt: hsla(30, 17%, 14%, 1);
  --background-secondary: hsla(29, 16%, 13%, 1);
  --background-secondary-alt: hsla(29, 16%, 13%, 1);
  --bases-cards-background: hsla(30, 19%, 15%, 1);
  --bases-cards-cover-background: hsla(30, 17%, 14%, 1);
  --bases-cards-shadow: 0 0 0 1px hsla(28, 22%, 19%, 1);
  --bases-cards-shadow-hover: 0 0 0 1px color-mix(in srgb, hsla(31, 27%, 25%, 1) 40%, hsla(28, 22%, 19%, 1));
  --bases-embed-border-color: hsla(28, 22%, 19%, 1);
  --bases-group-heading-property-color: hsla(35, 27%, 55%, 1);
  --bases-group-heading-property-weight: 450;
  --bases-group-heading-value-weight: 650;
  --bases-table-border-color: hsla(28, 22%, 19%, 1);
  --bases-table-cell-background-active: hsla(30, 19%, 15%, 1);
  --bases-table-cell-background-disabled: hsla(30, 17%, 14%, 1);
  --bases-table-cell-background-selected: hsla(31,27%,24%, 0.1);
  --bases-table-cell-shadow-active: 0 0 0 2px color-mix(in srgb, hsla(31, 27%, 25%, 1) 40%, hsla(28, 22%, 19%, 1));
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl( 28, 27.54%, 27.6% );
  --bases-table-group-background: hsla(30, 17%, 14%, 1);
  --bases-table-header-background: hsla(30, 19%, 15%, 1);
  --bases-table-header-background-hover: rgba(0, 0, 0, 0.3);
  --bases-table-header-color: hsla(35, 27%, 55%, 1);
  --bases-table-header-weight: 450;
  --bases-table-row-background-hover: hsla(29, 16%, 13%, 1);
  --bases-table-summary-background: hsla(30, 19%, 15%, 1);
  --bases-table-summary-background-hover: rgba(0, 0, 0, 0.3);
  --blockquote-background-color: hsla(29, 16%, 13%, 1);
  --blockquote-border-color: hsla(28, 22%, 19%, 1);
  --blur-background: color-mix(in srgb, hsla(29, 16%, 13%, 1) 65%, transparent) linear-gradient(hsla(29, 16%, 13%, 1), color-mix(in srgb, hsla(29, 16%, 13%, 1) 65%, transparent));
  ...
  --bold-color: hsla(4, 88%, 61%, 1);
  --bold-highlight-bg: hsla(350, 84%, 63%, 0.2);
  --bold-highlight-color: hsla(34, 39%, 74%, 1);
  --bold-italic-color: hsla(32, 48%, 85%, 1);
  --bold-italic-highlight-bg: hsla(74, 69%, 44%, 0.2);
  --bold-italic-highlight-color: hsla(32, 48%, 85%, 1);
  --bold-italic-strikethrough-color: hsla(35, 27%, 55%, 1);
  --bold-italic-weight: 750;
  --bold-weight: 750;
  --bookmark-chbx-color: hsla(21, 81%, 54%, 1);
  --bookmark-folder-1-bg-color: color-mix(in srgb, hsla(350, 84%, 63%, 0.2) 60%, transparent);
  --bookmark-folder-1-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(350, 84%, 63%, 0.2) 60%, transparent) 70%, transparent);
  --bookmark-folder-1-collapse-color: color-mix(in srgb, hsla(4, 88%, 61%, 1) 50%, transparent);
  --bookmark-folder-1-color: hsla(4, 88%, 61%, 1);
  --bookmark-folder-1-indent-color: color-mix(in srgb, hsla(4, 88%, 61%, 1) 25%, transparent);
  --bookmark-folder-10-bg-color: color-mix(in srgb, hsla(74, 69%, 44%, 0.2) 60%, transparent);
  --bookmark-folder-10-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(74, 69%, 44%, 0.2) 60%, transparent) 70%, transparent);
  --bookmark-folder-10-collapse-color: color-mix(in srgb, hsla(154, 57%, 42%, 1) 50%, transparent);
  --bookmark-folder-10-color: hsla(154, 57%, 42%, 1);
  --bookmark-folder-10-indent-color: color-mix(in srgb, hsla(154, 57%, 42%, 1) 25%, transparent);
  --bookmark-folder-11-bg-color: color-mix(in srgb, hsla(186, 64%, 46%, 0.2) 60%, transparent);
  --bookmark-folder-11-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(186, 64%, 46%, 0.2) 60%, transparent) 70%, transparent);
  --bookmark-folder-11-collapse-color: color-mix(in srgb, hsla(194, 59%, 56%, 1) 50%, transparent);
  --bookmark-folder-11-color: hsla(194, 59%, 56%, 1);
  --bookmark-folder-11-indent-color: color-mix(in srgb, hsla(194, 59%, 56%, 1) 25%, transparent);
  --bookmark-folder-12-bg-color: color-mix(in srgb, hsla(236, 100%, 72%, 0.2) 60%, transparent);
  --bookmark-folder-12-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(236, 100%, 72%, 0.2) 60%, transparent) 70%, transparent);
  --bookmark-folder-12-collapse-color: color-mix(in srgb, hsla(242, 52%, 69%, 1) 50%, transparent);
  --bookmark-folder-12-color: hsla(242, 52%, 69%, 1);
  --bookmark-folder-12-indent-color: color-mix(in srgb, hsla(242, 52%, 69%, 1) 25%, transparent);
  --bookmark-folder-2-bg-color: color-mix(in srgb, hsla(27, 100%, 50%, 0.2) 60%, transparent);
  --bookmark-folder-2-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(27, 100%, 50%, 0.2) 60%, transparent) 70%, transparent);
  --bookmark-folder-2-collapse-color: color-mix(in srgb, hsla(24, 84%, 50%, 1) 50%, transparent);
  --bookmark-folder-2-color: hsla(24, 84%, 50%, 1);
  --bookmark-folder-2-indent-color: color-mix(in srgb, hsla(24, 84%, 50%, 1) 25%, transparent);
  --bookmark-folder-3-bg-color: color-mix(in srgb, hsla(44, 100%, 50%, 0.2) 60%, transparent);
  --bookmark-folder-3-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(44, 100%, 50%, 0.2) 60%, transparent) 70%, transparent);
  --bookmark-folder-3-collapse-color: color-mix(in srgb, hsla(42, 79%, 51%, 1) 50%, transparent);
  --bookmark-folder-3-color: hsla(42, 79%, 51%, 1);
  --bookmark-folder-3-indent-color: color-mix(in srgb, hsla(42, 79%, 51%, 1) 25%, transparent);
  --bookmark-folder-4-bg-color: color-mix(in srgb, hsla(74, 69%, 44%, 0.2) 60%, transparent);
  --bookmark-folder-4-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(74, 69%, 44%, 0.2) 60%, transparent) 70%, transparent);
  --bookmark-folder-4-collapse-color: color-mix(in srgb, hsla(154, 57%, 42%, 1) 50%, transparent);
  --bookmark-folder-4-color: hsla(154, 57%, 42%, 1);
  --bookmark-folder-4-indent-color: color-mix(in srgb, hsla(154, 57%, 42%, 1) 25%, transparent);
  --bookmark-folder-5-bg-color: color-mix(in srgb, hsla(186, 64%, 46%, 0.2) 60%, transparent);
  --bookmark-folder-5-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(186, 64%, 46%, 0.2) 60%, transparent) 70%, transparent);
  --bookmark-folder-5-collapse-color: color-mix(in srgb, hsla(194, 59%, 56%, 1) 50%, transparent);
  --bookmark-folder-5-color: hsla(194, 59%, 56%, 1);
  --bookmark-folder-5-indent-color: color-mix(in srgb, hsla(194, 59%, 56%, 1) 25%, transparent);
  --bookmark-folder-6-bg-color: color-mix(in srgb, hsla(236, 100%, 72%, 0.2) 60%, transparent);
  --bookmark-folder-6-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(236, 100%, 72%, 0.2) 60%, transparent) 70%, transparent);
  --bookmark-folder-6-collapse-color: color-mix(in srgb, hsla(242, 52%, 69%, 1) 50%, transparent);
  --bookmark-folder-6-color: hsla(242, 52%, 69%, 1);
  --bookmark-folder-6-indent-color: color-mix(in srgb, hsla(242, 52%, 69%, 1) 25%, transparent);
  --bookmark-folder-7-bg-color: color-mix(in srgb, hsla(350, 84%, 63%, 0.2) 60%, transparent);
  --bookmark-folder-7-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(350, 84%, 63%, 0.2) 60%, transparent) 70%, transparent);
  --bookmark-folder-7-collapse-color: color-mix(in srgb, hsla(4, 88%, 61%, 1) 50%, transparent);
  --bookmark-folder-7-color: hsla(4, 88%, 61%, 1);
  --bookmark-folder-7-indent-color: color-mix(in srgb, hsla(4, 88%, 61%, 1) 25%, transparent);
  --bookmark-folder-8-bg-color: color-mix(in srgb, hsla(27, 100%, 50%, 0.2) 60%, transparent);
  --bookmark-folder-8-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(27, 100%, 50%, 0.2) 60%, transparent) 70%, transparent);
  --bookmark-folder-8-collapse-color: color-mix(in srgb, hsla(24, 84%, 50%, 1) 50%, transparent);
  --bookmark-folder-8-color: hsla(24, 84%, 50%, 1);
  --bookmark-folder-8-indent-color: color-mix(in srgb, hsla(24, 84%, 50%, 1) 25%, transparent);
  --bookmark-folder-9-bg-color: color-mix(in srgb, hsla(44, 100%, 50%, 0.2) 60%, transparent);
  --bookmark-folder-9-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(44, 100%, 50%, 0.2) 60%, transparent) 70%, transparent);
  --bookmark-folder-9-collapse-color: color-mix(in srgb, hsla(42, 79%, 51%, 1) 50%, transparent);
  --bookmark-folder-9-color: hsla(42, 79%, 51%, 1);
  --bookmark-folder-9-indent-color: color-mix(in srgb, hsla(42, 79%, 51%, 1) 25%, transparent);
  --breadcrumb-bg-hover: hsla(28, 22%, 19%, 1);
  --breadcrumb-color: hsla(34, 24%, 46%, 1);
  --breadcrumb-color-hover: hsla(34, 24%, 46%, 1);
  --breadcrumb-separator-color: hsla(28, 22%, 19%, 1);
  ...
  --button-accent-shadow-focus: inset 0px 1px 0px 0px rgba(255, 255, 255, 0.12),inset 0px 0px 0px 1px rgba(0, 0, 0, 0.28),inset 0px -2px 0px 2px rgba(0, 0, 0, 0.11),inset 0px -2px 4px 0px rgba(0, 0, 0, 0.2),0px 4px 4px -5.6px rgba(0, 0, 0, 0.52),0px 2px 4px -2.7px rgba(0, 0, 0, 0.27),0px 2px 6px -1px rgba(0, 0, 0, 0.24),0px 0px 0px 3px hsla(34, 24%, 40%, 0.2);
  ...
  --button-shadow-focus: inset 0px 1px 0px 0px rgba(255, 255, 255, 0.05),inset 0px 0px 0px 1px rgba(0, 0, 0, 0.3),inset 0px -2px 0px 2px rgba(0, 0, 0, 0.24),inset 0px -2px 4px 0px rgba(0, 0, 0, 0.25),0px 4px 4px -5.6px rgba(0, 0, 0, 0.55),0px 2px 4px -2.7px rgba(0, 0, 0, 0.3),0px 2px 6px -1px rgba(0, 0, 0, 0.25),0px 0px 0px 3px hsla(34, 24%, 40%, 0.2);
  ...
  --cancelled-chbx-text-color: hsla(34, 24%, 46%, 1);
  --cancelled-chbx-text-decoration: line-through;
  --canvas-background: hsla(30, 19%, 15%, 1);
  --canvas-card-label-color: hsla(34, 24%, 46%, 1);
  ...
  --canvas-dot-pattern: hsla(31, 27%, 25%, 1);
  --canvas-icon-color: hsla(34, 24%, 46%, 1);
  --canvas-icon-color-disabled: hsla(31, 27%, 25%, 1);
  --canvas-icon-color-hover: hsla(34, 31%, 68%, 1);
  --canvas-menu-bg: color-mix(in srgb, hsla(33, 20%, 17%, 1) 60%, hsla(30, 19%, 15%, 1));
  --canvas-menu-bg-hover: color-mix(in srgb, hsla(33, 20%, 17%, 1) 10%, hsla(30, 19%, 15%, 1));
  --canvas-menu-border: 1px solid hsla(28, 22%, 19%, 1);
  --canvas-menu-shadow: 0px 1px 2px 1px rgba(0, 0, 0, 0.14),0px 1px 4px -2.1px rgba(0, 0, 0, 0.22),0px 2px 8px -1.2px rgba(0, 0, 0, 0.15);
  --caret-color: hsla(34, 24%, 46%, 1);
  --checkbox-border-color: hsla(31, 27%, 25%, 1);
  --checkbox-border-color-hover: hsla(33, 27%, 33%, 1);
  --checkbox-color: hsla(154, 75%, 26%, 1);
  --checkbox-color-hover: hsla(155, 78%, 29%, 1);
  --checkbox-marker-color: white;
  --checked-border-color: rgba(255, 255, 255, 0.15);
  --checked-border-color-hover: rgba(255, 255, 255, 0.1);
  --checklist-bg: hsla(30, 17%, 14%, 1);
  --checklist-done-color: hsla(34, 24%, 46%, 1);
  ...
  --code-background: hsla(30, 17%, 14%, 1);
  --code-border-color: hsla(28, 22%, 19%, 1);
  --code-bracket-background: rgba(0, 0, 0, 0.3);
  --code-comment: hsla(34, 24%, 46%, 1);
  --code-function: rgb(225, 178, 67);
  --code-important: rgb(203, 128, 53);
  --code-keyword: rgb(180, 100, 100);
  --code-normal: hsla(34, 39%, 74%, 1);
  --code-operator: rgb(192, 78, 78);
  --code-property: rgb(70, 169, 180);
  --code-punctuation: hsla(35, 27%, 55%, 1);
  --code-radius: 8px;
  --code-string: rgb(80, 196, 101);
  --code-tag: rgb(192, 78, 78);
  --code-value: rgb(113, 97, 194);
  --codeFont: var(--font-monospace, "Cascadia Code", ui-monospace, SFMono-Regular, "Cascadia Mono", "Roboto Mono", "DejaVu Sans Mono", "Liberation Mono", Menlo, Monaco, "Consolas", "Source Code Pro", monospace);
  --collapse-icon-color: hsla(33, 27%, 33%, 1);
  --collapse-icon-color-collapsed: hsla(33, 27%, 33%, 1);
  --color-accent: hsl(31, 27%, 24%);
  --color-accent-1: hsl( 28, 27.54%, 27.6% );
  --color-accent-2: hsl( 26, 31.32%, 32.16% );
  --color-accent-hsl: 31,27%,24%;
  --color-base-00: hsla(32, 21%, 9%, 1);
  --color-base-05: hsla(29, 16%, 13%, 1);
  --color-base-10: hsla(30, 19%, 15%, 1);
  --color-base-100: hsla(32, 48%, 85%, 1);
  --color-base-20: hsla(33, 20%, 17%, 1);
  --color-base-25: hsla(28, 22%, 19%, 1);
  --color-base-30: hsla(31, 27%, 25%, 1);
  --color-base-35: hsla(33, 27%, 33%, 1);
  --color-base-40: hsla(34, 24%, 46%, 1);
  --color-base-50: hsla(35, 27%, 55%, 1);
  --color-base-60: hsla(34, 31%, 68%, 1);
  --color-base-70: hsla(34, 39%, 74%, 1);
  ...
  --cursor: pointer;
  --dark: var(--text-normal, hsla(34, 39%, 74%, 1));
  --darkgray: var(--text-normal, hsla(34, 39%, 74%, 1));
  --disabled-component-opacity: 0.3;
  --divider-color: hsla(28, 22%, 19%, 1);
  --divider-color-hover: color-mix(in srgb, hsla(31, 27%, 25%, 1) 40%, hsla(28, 22%, 19%, 1));
  --divider-radius: 8px;
  --divider-width-hover: 4px;
  --down-chbx-color: hsla(4, 56%, 54%, 1);
  --drag-ghost-background: hsl( 28, 27.54%, 27.6% );
  --drag-ghost-text-color: hsla(32, 48%, 85%, 1);
  --dropdown-background: hsla(29, 16%, 13%, 1);
  --dropdown-background-hover: color-mix(in hsl, hsla(30, 19%, 15%, 1) 50%, hsla(29, 16%, 13%, 1));
  --dropdown-height: 31px;
  --editor-bg-color: hsla(30, 19%, 15%, 1);
  --editor-bgpattern-color: hsla(31, 27%, 25%, 1);
  --editor-bgpattern-size: 50px 50px;
  --editor-border-color: hsla(28, 22%, 19%, 1);
  --editor-border-radius: 12px;
  --editor-border-width: 1px;
  --editor-header-icon: 15px;
  --editor-pane-margin: 10px;
  --editor-tab-icon: 15px;
  --embed-background: color-mix( in srgb, hsla(30, 17%, 14%, 1) 50%, hsla(30, 19%, 15%, 1) );
  --embed-bg-color-mix: color-mix( in srgb, hsla(30, 17%, 14%, 1) 50%, hsla(30, 19%, 15%, 1) );
  --embed-block-shadow-hover: none;
  --embed-border-bottom: 1px solid hsla(28, 22%, 19%, 1);
  --embed-border-bottom-color: hsla(28, 22%, 19%, 1);
  --embed-border-bottom-style: solid;
  --embed-border-bottom-width: 1px;
  --embed-border-end: 1px solid hsla(28, 22%, 19%, 1);
  --embed-border-end-color: hsla(28, 22%, 19%, 1);
  --embed-border-end-style: solid;
  --embed-border-end-width: 1px;
  --embed-border-radius: 12px;
  --embed-border-start: 1px solid hsla(28, 22%, 19%, 1);
  --embed-border-start-color: hsla(28, 22%, 19%, 1);
  --embed-border-start-style: solid;
  --embed-border-start-width: 1px;
  --embed-border-top: 1px solid hsla(28, 22%, 19%, 1);
  --embed-border-top-color: hsla(28, 22%, 19%, 1);
  --embed-border-top-style: solid;
  --embed-border-top-width: 1px;
  --embed-edit-btn-bg: color-mix(in srgb, hsla(24, 18%, 11%, 1) 70%, transparent);
  --embed-edit-btn-bg-hover: color-mix(in srgb, hsla(24, 18%, 11%, 1) 100%, transparent);
  ...
  --embed-title-border: 1px solid hsla(28, 22%, 19%, 1);
  --embed-title-border-color: hsla(28, 22%, 19%, 1);
  --embed-title-border-style: solid;
  --embed-title-border-width: 1px;
  --embed-title-color: hsla(34, 24%, 46%, 1);
  ...
  --empty-state-action-btn-bg: hsla(30, 17%, 14%, 1);
  --file-header-background: hsla(30, 19%, 15%, 1);
  --file-header-background-focused: hsla(30, 19%, 15%, 1);
  --file-header-border: 1px solid hsla(28, 22%, 19%, 1);
  --file-header-border-color: hsla(28, 22%, 19%, 1);
  ...
  --file-header-title-color: hsla(35, 27%, 55%, 1);
  --file-line-width: 40rem;
  --file-max-line-width: 88%;
  --file-tab-gap: 0px;
  --flair-background: hsla(29, 16%, 13%, 1);
  --flair-color: hsla(34, 39%, 74%, 1);
  --flair-count-bg-color: hsla(29, 16%, 13%, 1);
  --flair-count-color: hsla(33, 27%, 33%, 1);
  ...
  --font-weight: 450;
  --footnote-divider-color: hsla(28, 22%, 19%, 1);
  --footnote-id-color: hsla(35, 27%, 55%, 1);
  --footnote-id-color-no-occurrences: hsla(34, 24%, 46%, 1);
  --footnote-input-background-active: rgba(0, 0, 0, 0.2);
  --graph-arrow: hsla(34, 24%, 46%, 1);
  --graph-line: hsla(28, 22%, 19%, 1);
  --graph-node: hsla(197, 48%, 49%, 1);
  --graph-node-attachment: hsla(155, 78%, 29%, 1);
  --graph-node-focused: hsla(34, 39%, 74%, 1);
  --graph-node-highlight-fill: hsla(34, 31%, 68%, 1);
  --graph-node-highlight-line: hsla(33, 27%, 33%, 1);
  --graph-node-tag: hsla(4, 88%, 61%, 1);
  --graph-node-unresolved: hsla(42, 79%, 51%, 1);
  --graph-node-unresolved-opacity: 1;
  --graph-text: hsla(34, 24%, 46%, 1);
  --gray: var(--text-muted, hsla(35, 27%, 55%, 1));
  --gutter-color: color-mix(in srgb, hsla(33, 27%, 33%, 1) 40%, hsla(31, 27%, 25%, 1));
  --gutter-color-active: hsla(34, 24%, 46%, 1);
  --h1-bg-color: transparent;
  --h1-border-bottom-color: hsla(28, 22%, 19%, 1);
  --h1-border-left-color: hsla(28, 22%, 19%, 1);
  --h1-border-radius: 0px;
  --h1-border-right-color: hsla(28, 22%, 19%, 1);
  --h1-border-style: solid;
  --h1-border-top-color: hsla(28, 22%, 19%, 1);
  --h1-border-width: 0px;
  --h1-color: hsla(32, 48%, 85%, 1);
  --h1-text-align: left;
  --h1-text-transform: normal;
  --h1-weight: 650;
  --h2-bg-color: transparent;
  --h2-border-bottom-color: hsla(28, 22%, 19%, 1);
  --h2-border-left-color: hsla(28, 22%, 19%, 1);
  --h2-border-radius: 0px;
  --h2-border-right-color: hsla(28, 22%, 19%, 1);
  --h2-border-style: solid;
  --h2-border-top-color: hsla(28, 22%, 19%, 1);
  --h2-border-width: 0px;
  --h2-color: hsla(32, 48%, 85%, 1);
  --h2-text-align: left;
  --h2-text-transform: normal;
  --h2-weight: 650;
  --h3-bg-color: transparent;
  --h3-border-bottom-color: hsla(28, 22%, 19%, 1);
  --h3-border-left-color: hsla(28, 22%, 19%, 1);
  --h3-border-radius: 0px;
  --h3-border-right-color: hsla(28, 22%, 19%, 1);
  --h3-border-style: solid;
  --h3-border-top-color: hsla(28, 22%, 19%, 1);
  --h3-border-width: 0px;
  --h3-color: hsla(32, 48%, 85%, 1);
  --h3-text-align: left;
  --h3-text-transform: normal;
  --h3-weight: 650;
  --h4-bg-color: transparent;
  --h4-border-bottom-color: hsla(28, 22%, 19%, 1);
  --h4-border-left-color: hsla(28, 22%, 19%, 1);
  --h4-border-radius: 0px;
  --h4-border-right-color: hsla(28, 22%, 19%, 1);
  --h4-border-style: solid;
  --h4-border-top-color: hsla(28, 22%, 19%, 1);
  --h4-border-width: 0px;
  --h4-color: hsla(32, 48%, 85%, 1);
  --h4-text-align: left;
  --h4-text-transform: normal;
  --h4-weight: 650;
  --h5-bg-color: transparent;
  --h5-border-bottom-color: hsla(28, 22%, 19%, 1);
  --h5-border-left-color: hsla(28, 22%, 19%, 1);
  --h5-border-radius: 0px;
  --h5-border-right-color: hsla(28, 22%, 19%, 1);
  --h5-border-style: solid;
  --h5-border-top-color: hsla(28, 22%, 19%, 1);
  --h5-border-width: 0px;
  --h5-color: hsla(32, 48%, 85%, 1);
  --h5-text-align: left;
  --h5-text-transform: normal;
  --h5-weight: 650;
  --h6-bg-color: transparent;
  --h6-border-bottom-color: hsla(28, 22%, 19%, 1);
  --h6-border-left-color: hsla(28, 22%, 19%, 1);
  --h6-border-radius: 0px;
  --h6-border-right-color: hsla(28, 22%, 19%, 1);
  --h6-border-style: solid;
  --h6-border-top-color: hsla(28, 22%, 19%, 1);
  --h6-border-width: 0px;
  --h6-color: hsla(32, 48%, 85%, 1);
  --h6-text-align: left;
  ...
  --heading-formatting: hsla(34, 24%, 46%, 1);
  --highlight: var(--text-highlight-bg, hsla(44, 100%, 50%, 0.2));
  --hr-color: hsla(28, 22%, 19%, 1);
  --hr-thickness: 1px;
  --icon-bg: transparent;
  --icon-bg-active: hsla(28, 22%, 19%, 1);
  --icon-bg-active-menu: transparent;
  --icon-bg-hover: transparent;
  --icon-bg-pressed: transparent;
  --icon-color: color-mix(in srgb, hsla(33, 27%, 33%, 1) 30%, hsla(34, 24%, 46%, 1));
  --icon-color-active: hsla(35, 27%, 55%, 1);
  --icon-color-focused: hsla(34, 24%, 46%, 1);
  --icon-color-hover: color-mix(in srgb, hsla(34, 24%, 46%, 1) 70%, hsla(35, 27%, 55%, 1));
  ...
  --indentation-guide-color: hsla(28, 22%, 19%, 1);
  --indentation-guide-color-active: color-mix(in srgb, hsla(31, 27%, 25%, 1) 40%, hsla(28, 22%, 19%, 1));
  --indentation-guide-reading-indent: -1em;
  --info-chbx-color: hsla(178, 31%, 41%, 1);
  --info-chbx-icon-color: white;
  --inline-code-bg: hsla(24, 18%, 11%, 1);
  --inline-code-color: hsla(4, 91%, 67%, 1);
  --inline-code-radius: 4px;
  --inline-query-bg: color-mix(in srgb, hsla(29, 16%, 13%, 1) 25%, hsla(30, 19%, 15%, 1));
  --inline-query-shadow: 0px 1px 10px 0px rgba(0, 0, 0, 0.26);
  --inline-title-color: hsla(32, 48%, 85%, 1);
  --inline-title-weight: 650;
  --inprogress-chbx-border-color: color-mix(in srgb, hsla(31, 85%, 59%, 1) 15%, hsla(34, 31%, 68%, 1));
  --inprogress-chbx-color: hsla(31, 85%, 59%, 1);
  --inprogress-chbx-color-hover: hsla(32, 95%, 65%, 1);
  --input-date-separator: hsla(34, 24%, 46%, 1);
  --input-font-weight: 450;
  --input-height: 32px;
  --input-placeholder-color: hsla(34, 24%, 46%, 1);
  --input-radius: 8px;
  ...
  --interactive-accent: hsl( 28, 27.54%, 27.6% );
  --interactive-accent-hover: hsl( 26, 31.32%, 32.16% );
  --interactive-accent-hsl: 31,27%,24%;
  --interactive-hover: color-mix(in hsl, hsla(30, 19%, 15%, 1) 50%, hsla(29, 16%, 13%, 1));
  --interactive-normal: hsla(29, 16%, 13%, 1);
  --interface-font-feature: "calt" 1,"case" 0,"ccmp" 1,"ss03" 1,"cv01" 1,"cv05" 1,"cv06" 1,"cv08" 0,"cv11" 1,"cv12" 0,"cv13" 0;
  --italic-color: hsla(194, 59%, 56%, 1);
  --italic-highlight-bg: hsla(186, 64%, 46%, 0.2);
  --italic-highlight-color: hsla(34, 39%, 74%, 1);
  ...
  --kanban-item-bg: hsla(33, 20%, 17%, 1);
  ...
  --kanban-lane-bg: color-mix(in srgb, hsla(30, 17%, 14%, 1) 50%, hsla(29, 16%, 13%, 1));
  --kanban-lane-border: 1px solid color-mix(in srgb, hsla(33, 20%, 17%, 1) 40%, hsla(30, 19%, 15%, 1));
  --kanban-lane-shadow: none;
  --kanban-new-item-bg: transparent;
  --kanban-new-item-bg-hover: hsla(30, 19%, 15%, 1);
  --kanban-new-item-color: hsla(34, 24%, 46%, 1);
  --kanban-new-item-color-hover: hsla(35, 27%, 55%, 1);
  ...
  --kanban-title-count-bg: hsla(28, 22%, 19%, 1);
  --kanban-title-count-color: hsla(35, 27%, 55%, 1);
  --kanban-title-count-radius: 12px;
  --kanban-title-text-input-color: hsla(34, 39%, 74%, 1);
  --kbd-background: hsla(30, 17%, 14%, 1);
  --kbd-color: hsla(4, 91%, 67%, 1);
  ...
  --light: var(--background-primary, hsla(30, 19%, 15%, 1));
  --lightgray: var(--background-secondary, hsla(29, 16%, 13%, 1));
  --link-ahref-color: hsla(4, 91%, 67%, 1);
  --link-ahref-color-hover: hsla(5, 94%, 73%, 1);
  --link-ahref-decoration-color: color-mix(in srgb, currentColor 22%, transparent);
  --link-ahref-decoration-color-hover: color-mix(in srgb, hsla(5, 94%, 73%, 1) 22%, transparent);
  --link-color: hsla(42, 79%, 51%, 1);
  --link-color-hover: hsla(43, 69%, 63%, 1);
  --link-decoration-color: color-mix(in srgb, hsla(42, 79%, 51%, 1) 22%, transparent);
  --link-decoration-color-hover: color-mix(in srgb, hsla(43, 69%, 63%, 1) 22%, transparent);
  --link-decoration-opacity: 22%;
  --link-decoration-thickness: 1.5px;
  --link-external-color: hsla(154, 57%, 42%, 1);
  --link-external-color-hover: hsla(152, 51%, 54%, 1);
  --link-external-decoration-color: color-mix(in srgb, hsla(154, 57%, 42%, 1) 22%, transparent);
  --link-external-decoration-color-hover: color-mix(in srgb, hsla(152, 51%, 54%, 1) 22%, transparent);
  --link-opacity-active: 0.5;
  --link-underline-offset: 2px;
  --link-unresolved-color: hsla(34, 24%, 46%, 1);
  --link-unresolved-color-hover: hsla(35, 27%, 55%, 1);
  --link-unresolved-decoration-color: color-mix(in srgb, hsla(34, 24%, 46%, 1) 22%, transparent);
  --link-unresolved-decoration-color-hover: color-mix(in srgb, hsla(35, 27%, 55%, 1) 22%, transparent);
  --link-unresolved-opacity: 1;
  --link-weight: 450;
  --list-bullet-indent-reading: -1em;
  --list-indent-editing: 0.6em;
  --list-marker-color: hsla(34, 24%, 46%, 1);
  --list-marker-color-collapsed: hsla(35, 27%, 55%, 1);
  --list-marker-color-hover: hsla(34, 31%, 68%, 1);
  --loading-line-bg-color: hsla(29, 16%, 13%, 1);
  --loading-line-color: hsla(191, 54%, 62%, 1);
  --loading-line-shadow: inset 0px 0px 0px 1px rgba(255, 255, 255, 0.1);
  --location-chbox-color: hsla(0, 56%, 48%, 1);
  --menu-background: hsla(29, 16%, 13%, 1);
  --menu-border-color: color-mix(in srgb, hsla(31, 27%, 25%, 1) 40%, hsla(28, 22%, 19%, 1));
  --menu-item-bg-active: hsla(24, 18%, 11%, 1);
  --menu-item-bg-hover: rgba(0, 0, 0, 0.25);
  --menu-item-color-active: hsla(33, 27%, 33%, 1);
  --menu-item-icon-color: hsla(34, 24%, 46%, 1);
  --menu-item-icon-color-active: hsla(33, 27%, 33%, 1);
  ...
  --metadata-background: color-mix(in srgb, hsla(30, 19%, 15%, 1) 50%, hsla(30, 17%, 14%, 1));
  --metadata-border-color: hsla(28, 22%, 19%, 1);
  --metadata-border-radius: 8px;
  --metadata-border-width: 1px;
  --metadata-container-padding: 12px 12px;
  --metadata-divider-color: hsla(28, 22%, 19%, 1);
  ...
  --metadata-input-shadow-active: inset 0px 0px 0px 1px hsla(28, 22%, 19%, 1),0px 0px 0px 1px hsla(28, 22%, 19%, 1);
  --metadata-input-shadow-hover: none;
  --metadata-input-text-color: hsla(35, 27%, 55%, 1);
  --metadata-key-input-color: hsla(34, 24%, 46%, 1);
  --metadata-key-input-color-active: hsla(34, 31%, 68%, 1);
  ...
  --metadata-label-text-color: hsla(35, 27%, 55%, 1);
  --metadata-label-text-color-hover: hsla(35, 27%, 55%, 1);
  --metadata-properties-title-color: hsla(33, 27%, 33%, 1);
  --metadata-properties-title-color-collapsed: hsla(33, 27%, 33%, 1);
  --metadata-properties-title-color-hover: hsla(34, 24%, 46%, 1);
  --metadata-property-background-active: rgba(0, 0, 0, 0.3);
  --metadata-property-box-shadow-focus: 0 0 0 2px color-mix(in srgb, hsla(31, 27%, 25%, 1) 40%, hsla(28, 22%, 19%, 1));
  --metadata-property-box-shadow-hover: 0 0 0 1px color-mix(in srgb, hsla(31, 27%, 25%, 1) 40%, hsla(28, 22%, 19%, 1));
  --metadata-property-radius: 7px;
  --metadata-tab-background: hsla(29, 16%, 13%, 1);
  --modal-background: hsla(30, 19%, 15%, 1);
  --modal-border-color: color-mix(in srgb, hsla(31, 27%, 25%, 1) 40%, hsla(28, 22%, 19%, 1));
  --modal-close-button-size: 20px;
  --modal-radius: 16px;
  --monospace-font-feature: "calt" 1,"ss01" 1,"ss02" 1,"ss03" 1,"ss05" 1,"ss19" 1,"zero" 1;
  --nav-collapse-icon-color: hsla(33, 27%, 33%, 1);
  --nav-collapse-icon-color-collapsed: hsla(34, 24%, 46%, 1);
  ...
  --nav-file-tag-color: hsla(33, 27%, 33%, 1);
  --nav-folder-1-bg-color: color-mix(in srgb, hsla(350, 84%, 63%, 0.2) 60%, transparent);
  --nav-folder-1-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(350, 84%, 63%, 0.2) 60%, transparent) 70%, transparent);
  --nav-folder-1-collapse-color: color-mix(in srgb, hsla(4, 88%, 61%, 1) 50%, transparent);
  --nav-folder-1-color: hsla(4, 88%, 61%, 1);
  --nav-folder-1-indent-color: color-mix(in srgb, hsla(4, 88%, 61%, 1) 25%, transparent);
  --nav-folder-10-bg-color: color-mix(in srgb, hsla(74, 69%, 44%, 0.2) 60%, transparent);
  --nav-folder-10-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(74, 69%, 44%, 0.2) 60%, transparent) 70%, transparent);
  --nav-folder-10-collapse-color: color-mix(in srgb, hsla(154, 57%, 42%, 1) 50%, transparent);
  --nav-folder-10-color: hsla(154, 57%, 42%, 1);
  --nav-folder-10-indent-color: color-mix(in srgb, hsla(154, 57%, 42%, 1) 25%, transparent);
  --nav-folder-11-bg-color: color-mix(in srgb, hsla(186, 64%, 46%, 0.2) 60%, transparent);
  --nav-folder-11-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(186, 64%, 46%, 0.2) 60%, transparent) 70%, transparent);
  --nav-folder-11-collapse-color: color-mix(in srgb, hsla(194, 59%, 56%, 1) 50%, transparent);
  --nav-folder-11-color: hsla(194, 59%, 56%, 1);
  --nav-folder-11-indent-color: color-mix(in srgb, hsla(194, 59%, 56%, 1) 25%, transparent);
  --nav-folder-12-bg-color: color-mix(in srgb, hsla(236, 100%, 72%, 0.2) 60%, transparent);
  --nav-folder-12-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(236, 100%, 72%, 0.2) 60%, transparent) 70%, transparent);
  --nav-folder-12-collapse-color: color-mix(in srgb, hsla(242, 52%, 69%, 1) 50%, transparent);
  --nav-folder-12-color: hsla(242, 52%, 69%, 1);
  --nav-folder-12-indent-color: color-mix(in srgb, hsla(242, 52%, 69%, 1) 25%, transparent);
  --nav-folder-2-bg-color: color-mix(in srgb, hsla(27, 100%, 50%, 0.2) 60%, transparent);
  --nav-folder-2-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(27, 100%, 50%, 0.2) 60%, transparent) 70%, transparent);
  --nav-folder-2-collapse-color: color-mix(in srgb, hsla(24, 84%, 50%, 1) 50%, transparent);
  --nav-folder-2-color: hsla(24, 84%, 50%, 1);
  --nav-folder-2-indent-color: color-mix(in srgb, hsla(24, 84%, 50%, 1) 25%, transparent);
  --nav-folder-3-bg-color: color-mix(in srgb, hsla(44, 100%, 50%, 0.2) 60%, transparent);
  --nav-folder-3-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(44, 100%, 50%, 0.2) 60%, transparent) 70%, transparent);
  --nav-folder-3-collapse-color: color-mix(in srgb, hsla(42, 79%, 51%, 1) 50%, transparent);
  --nav-folder-3-color: hsla(42, 79%, 51%, 1);
  --nav-folder-3-indent-color: color-mix(in srgb, hsla(42, 79%, 51%, 1) 25%, transparent);
  --nav-folder-4-bg-color: color-mix(in srgb, hsla(74, 69%, 44%, 0.2) 60%, transparent);
  --nav-folder-4-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(74, 69%, 44%, 0.2) 60%, transparent) 70%, transparent);
  --nav-folder-4-collapse-color: color-mix(in srgb, hsla(154, 57%, 42%, 1) 50%, transparent);
  --nav-folder-4-color: hsla(154, 57%, 42%, 1);
  --nav-folder-4-indent-color: color-mix(in srgb, hsla(154, 57%, 42%, 1) 25%, transparent);
  --nav-folder-5-bg-color: color-mix(in srgb, hsla(186, 64%, 46%, 0.2) 60%, transparent);
  --nav-folder-5-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(186, 64%, 46%, 0.2) 60%, transparent) 70%, transparent);
  --nav-folder-5-collapse-color: color-mix(in srgb, hsla(194, 59%, 56%, 1) 50%, transparent);
  --nav-folder-5-color: hsla(194, 59%, 56%, 1);
  --nav-folder-5-indent-color: color-mix(in srgb, hsla(194, 59%, 56%, 1) 25%, transparent);
  --nav-folder-6-bg-color: color-mix(in srgb, hsla(236, 100%, 72%, 0.2) 60%, transparent);
  --nav-folder-6-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(236, 100%, 72%, 0.2) 60%, transparent) 70%, transparent);
  --nav-folder-6-collapse-color: color-mix(in srgb, hsla(242, 52%, 69%, 1) 50%, transparent);
  --nav-folder-6-color: hsla(242, 52%, 69%, 1);
  --nav-folder-6-indent-color: color-mix(in srgb, hsla(242, 52%, 69%, 1) 25%, transparent);
  --nav-folder-7-bg-color: color-mix(in srgb, hsla(350, 84%, 63%, 0.2) 60%, transparent);
  --nav-folder-7-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(350, 84%, 63%, 0.2) 60%, transparent) 70%, transparent);
  --nav-folder-7-collapse-color: color-mix(in srgb, hsla(4, 88%, 61%, 1) 50%, transparent);
  --nav-folder-7-color: hsla(4, 88%, 61%, 1);
  --nav-folder-7-indent-color: color-mix(in srgb, hsla(4, 88%, 61%, 1) 25%, transparent);
  --nav-folder-8-bg-color: color-mix(in srgb, hsla(27, 100%, 50%, 0.2) 60%, transparent);
  --nav-folder-8-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(27, 100%, 50%, 0.2) 60%, transparent) 70%, transparent);
  --nav-folder-8-collapse-color: color-mix(in srgb, hsla(24, 84%, 50%, 1) 50%, transparent);
  --nav-folder-8-color: hsla(24, 84%, 50%, 1);
  --nav-folder-8-indent-color: color-mix(in srgb, hsla(24, 84%, 50%, 1) 25%, transparent);
  --nav-folder-9-bg-color: color-mix(in srgb, hsla(44, 100%, 50%, 0.2) 60%, transparent);
  --nav-folder-9-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(44, 100%, 50%, 0.2) 60%, transparent) 70%, transparent);
  --nav-folder-9-collapse-color: color-mix(in srgb, hsla(42, 79%, 51%, 1) 50%, transparent);
  --nav-folder-9-color: hsla(42, 79%, 51%, 1);
  --nav-folder-9-indent-color: color-mix(in srgb, hsla(42, 79%, 51%, 1) 25%, transparent);
  --nav-folder-bg-color: transparent;
  --nav-folder-bg-color-hover: rgba(0, 0, 0, 0.125);
  --nav-folder-collapse-color: hsla(33, 27%, 33%, 1);
  --nav-folder-color: hsla(35, 27%, 55%, 1);
  --nav-heading-color: hsla(34, 24%, 46%, 1);
  --nav-heading-color-collapsed: hsla(34, 24%, 46%, 1);
  --nav-heading-color-collapsed-hover: hsla(34, 24%, 46%, 1);
  --nav-heading-color-hover: hsla(34, 24%, 46%, 1);
  --nav-heading-weight: 550;
  --nav-heading-weight-hover: 550;
  --nav-indentation-guide-color: hsla(28, 22%, 19%, 1);
  ...
  --nav-item-color: hsla(35, 27%, 55%, 1);
  --nav-item-color-active: hsla(35, 27%, 55%, 1);
  --nav-item-color-highlighted: hsl( 26, 31.32%, 32.16% );
  --nav-item-color-hover: hsla(35, 27%, 55%, 1);
  --nav-item-color-selected: hsla(34, 39%, 74%, 1);
  ...
  --nav-tag-color: hsla(34, 24%, 46%, 1);
  --nav-tag-color-active: hsla(35, 27%, 55%, 1);
  --nav-tag-color-hover: hsla(35, 27%, 55%, 1);
  --nav-tag-weight: 650;
  --new-tab-btn-radius: 2em;
  --non-alternating-color: hsla(33, 27%, 33%, 1);
  --non-alternating-color-hover-active: hsla(31, 27%, 25%, 1);
  --normal-highlight-bg: hsla(44, 100%, 50%, 0.2);
  --normal-highlight-color: hsla(34, 39%, 74%, 1);
  --note-chbx-color: hsla(8, 51%, 53%, 1);
  --notice-color: hsla(34, 39%, 74%, 1);
  ...
  --pdf-background: hsla(30, 19%, 15%, 1);
  --pdf-page-background: hsla(30, 19%, 15%, 1);
  --pdf-shadow: 0 0 0 1px hsla(28, 22%, 19%, 1);
  --pdf-sidebar-background: hsla(30, 19%, 15%, 1);
  --pdf-thumbnail-shadow: 0 0 0 1px hsla(28, 22%, 19%, 1);
  --pill-background: rgba(0, 0, 0, 0.2);
  --pill-background-hover: rgba(0, 0, 0, 0.2);
  --pill-border-color: color-mix(in srgb, hsla(28, 22%, 19%, 1) 50%, transparent);
  --pill-border-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(31, 27%, 25%, 1) 40%, hsla(28, 22%, 19%, 1)) 50%, transparent);
  --pill-color: hsla(34, 31%, 68%, 1);
  --pill-color-hover: hsla(34, 39%, 74%, 1);
  --pill-color-remove: hsla(33, 27%, 33%, 1);
  --pill-color-remove-hover: hsla(33, 27%, 33%, 1);
  --pill-tag-bg-1: hsla(44, 100%, 50%, 0.2);
  --pill-tag-bg-2: hsla(350, 84%, 63%, 0.2);
  --pill-tag-bg-3: hsla(186, 64%, 46%, 0.2);
  --pill-tag-color-1: hsla(42, 79%, 51%, 1);
  --pill-tag-color-2: hsla(4, 91%, 67%, 1);
  --pill-tag-color-3: hsla(194, 59%, 56%, 1);
  ...
  --progress-background: hsla(29, 16%, 13%, 1);
  --progress-bar-outline: rgba(255, 255, 255, 0.1);
  --progress-border-width: 1px;
  --progress-color-1: hsla(4, 88%, 61%, 1);
  --progress-color-2: hsla(22, 82%, 47%, 1);
  --progress-color-3: hsla(40, 78%, 48%, 1);
  --progress-color-4: hsla(154, 75%, 26%, 1);
  --progress-color-5: linear-gradient(45deg, hsla(4, 88%, 61%, 1), hsla(42, 79%, 51%, 1), hsla(194, 59%, 56%, 1));
  --progress-gradient-1: hsla(4, 88%, 61%, 1);
  --progress-gradient-2: hsla(42, 79%, 51%, 1);
  --progress-gradient-3: hsla(194, 59%, 56%, 1);
  --progress-height: 8px;
  --progress-value-outline: rgba(255, 255, 255, 0.21);
  --progress-value-radius: 8px;
  --progress-width: 220px;
  --prompt-background: hsla(30, 19%, 15%, 1);
  --prompt-border-color: color-mix(in srgb, hsla(31, 27%, 25%, 1) 40%, hsla(28, 22%, 19%, 1));
  --prompt-input-background: hsla(30, 19%, 15%, 1);
  --prompt-instructions-background: color-mix(in hsl, hsla(30, 19%, 15%, 1) 60%, hsla(29, 16%, 13%, 1));
  --prompt-results-background: hsla(30, 19%, 15%, 1);
  --prompt-separator-border: 1px solid hsla(33, 20%, 17%, 1);
  --prompt-suggestion-background-selected: rgba(0, 0, 0, 0.1);
  --prompt-suggestion-color: hsla(35, 27%, 55%, 1);
  --prompt-suggestion-color-selected: hsla(34, 39%, 74%, 1);
  --prompt-suggestion-highlight-color: color-mix(in srgb, hsla(35, 27%, 55%, 1) 70%, white);
  --prompt-suggestion-highlight-color-selected: hsla(34, 39%, 74%, 1);
  ...
  --radius-xs: 2px;
  --raised-background: color-mix(in srgb, hsla(29, 16%, 13%, 1) 65%, transparent) linear-gradient(hsla(29, 16%, 13%, 1), color-mix(in srgb, hsla(29, 16%, 13%, 1) 65%, transparent));
  --resched-chbx-color: hsla(178, 19%, 55%, 1);
  --ribbon-background: hsla(29, 16%, 13%, 1);
  --ribbon-background-collapsed: hsla(30, 19%, 15%, 1);
  --ribbon-border-width: 1px;
  --ribbon-icon: 15px;
  --ribbon-icon-spacing: 4px;
  --ribbon-margin-bottom: 10px;
  --ribbon-radius: 12px;
  --ribbon-slideout-background: hsla(30, 17%, 14%, 1);
  --ribbon-slideout-shadow: 8px 7px 21px -4px rgba(0, 0, 0, 0.35),0px 5px 5px -5px rgba(0, 0, 0, 0.38);
  --sched-chbx-color: hsla(32, 10%, 58%, 1);
  --scrollbar-active-thumb-bg: color-mix(in srgb, hsla(31, 27%, 25%, 1) 40%, hsla(28, 22%, 19%, 1));
  --scrollbar-bg: transparent;
  --scrollbar-thumb-bg: hsla(28, 22%, 19%, 1);
  --search-clear-button-color: color-mix(in srgb, hsla(33, 27%, 33%, 1) 30%, hsla(34, 24%, 46%, 1));
  --search-clear-button-color-hover: hsla(4, 88%, 61%, 1);
  --search-clear-button-size: 12px;
  --search-icon-color: color-mix(in srgb, hsla(33, 27%, 33%, 1) 30%, hsla(34, 24%, 46%, 1));
  --search-icon-size: 14px;
  --search-result-background: hsla(30, 17%, 14%, 1);
  --search-result-background-hover: color-mix(in srgb, hsla(24, 18%, 11%, 1) 50%, hsla(32, 21%, 9%, 1));
  --search-result-dest-file-bg: hsla(29, 16%, 13%, 1);
  --search-result-dest-file-bg-hover: hsla(32, 21%, 9%, 1);
  --search-result-dest-file-color: hsla(34, 24%, 46%, 1);
  --search-result-dest-file-icon-color: hsla(31, 27%, 25%, 1);
  ...
  --secondary: var(--text-accent, hsl(31, 27%, 24%));
  --setting-group-heading-color: hsla(34, 39%, 74%, 1);
  --setting-group-heading-weight: 650;
  --setting-items-background: hsla(30, 17%, 14%, 1);
  --setting-items-border-color: hsla(28, 22%, 19%, 1);
  --settings-nav-group-title-color: hsla(33, 27%, 33%, 1);
  --settings-nav-item-active-color: hsla(30, 19%, 15%, 1);
  --settings-nav-item-bg-active: hsla(24, 18%, 11%, 1);
  ...
  --settings-nav-item-text-color: hsla(35, 27%, 55%, 1);
  --settings-nav-item-text-color-active: hsla(31, 27%, 25%, 1);
  --settings-nav-item-text-color-hover: hsla(34, 39%, 74%, 1);
  ...
  --shiki-active-tab-border-color: hsla(35, 27%, 55%, 1);
  --shiki-code-background: hsla(30, 17%, 14%, 1);
  --shiki-code-block-border-radius: 8px;
  --shiki-code-comment: hsla(34, 24%, 46%, 1);
  --shiki-code-function: rgb(80, 196, 101);
  --shiki-code-important: rgb(203, 128, 53);
  --shiki-code-keyword: rgb(180, 100, 100);
  --shiki-code-normal: hsla(35, 27%, 55%, 1);
  --shiki-code-property: rgb(70, 169, 180);
  --shiki-code-punctuation: hsla(35, 27%, 55%, 1);
  --shiki-code-string: rgb(225, 178, 67);
  --shiki-code-value: rgb(113, 97, 194);
  --shiki-gutter-border-color: hsla(28, 22%, 19%, 1);
  --shiki-gutter-text-color: hsla(34, 24%, 46%, 1);
  --shiki-gutter-text-color-highlight: hsla(35, 27%, 55%, 1);
  --shiki-highlight-green: rgba(100, 194, 113, 0.5);
  --shiki-highlight-green-background: rgba(100, 194, 113, 0.1);
  --shiki-highlight-neutral: hsla(35, 27%, 55%, 1);
  --shiki-highlight-red: rgba(228, 87, 78, 0.5);
  --shiki-highlight-red-background: rgba(228, 87, 78, 0.1);
  --shiki-terminal-dots-color: hsla(34, 24%, 46%, 1);
  --shiki-tooltip-background: hsla(31, 27%, 25%, 1);
  --sidebar-nav-icon: 15px;
  --sidebar-tab-icon: 15px;
  --slider-thumb-bg: hsla(34, 39%, 74%, 1);
  --slider-thumb-border-color: color-mix(in srgb, hsla(31, 27%, 25%, 1) 40%, hsla(28, 22%, 19%, 1));
  ...
  --slider-track-background: hsla(29, 16%, 13%, 1);
  ...
  --status-bar-background: hsla(29, 16%, 13%, 1);
  --status-bar-border-color: hsla(28, 22%, 19%, 1);
  --status-bar-floating-bg: hsla(30, 17%, 14%, 1);
  ...
  --status-bar-item-clickable-color-active: hsla(33, 27%, 33%, 1);
  --status-bar-item-color: hsla(34, 24%, 46%, 1);
  --status-bar-item-color-hover: hsla(34, 31%, 68%, 1);
  --status-bar-text-color: hsla(35, 27%, 55%, 1);
  --strikethrough-color: hsla(34, 24%, 46%, 1);
  --strikethrough-highlight-bg: hsla(44, 100%, 50%, 0.2);
  --strikethrough-highlight-color: hsla(34, 24%, 46%, 1);
  --style-settings-container-bg: color-mix(in srgb, hsla(30, 17%, 14%, 1) 50%, transparent);
  --suggestion-background: hsla(30, 19%, 15%, 1);
  ...
  --sync-icon-success: hsla(154, 75%, 26%, 1);
  --sync-icon-success-active: hsla(33, 27%, 33%, 1);
  --sync-icon-success-hover: hsla(155, 78%, 29%, 1);
  --sync-icon-working: hsla(19, 81%, 41%, 1);
  --sync-icon-working-active: hsla(33, 27%, 33%, 1);
  --sync-icon-working-hover: hsla(22, 82%, 47%, 1);
  --tab-active-bg: hsla(30, 19%, 15%, 1);
  ...
  --tab-background-active: hsla(30, 19%, 15%, 1);
  --tab-bg: transparent;
  --tab-container-background: hsla(29, 16%, 13%, 1);
  --tab-curves-display: none;
  --tab-divider-color: color-mix(in srgb, hsla(31, 27%, 25%, 1) 40%, hsla(28, 22%, 19%, 1));
  ...
  --tab-switcher-background: hsla(29, 16%, 13%, 1);
  --tab-switcher-menubar-background: linear-gradient(to top, hsla(29, 16%, 13%, 1), transparent);
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(31, 27%, 24%);
  --tab-text-color: hsla(34, 24%, 46%, 1);
  --tab-text-color-active: hsla(35, 27%, 55%, 1);
  --tab-text-color-focused: hsla(35, 27%, 55%, 1);
  --tab-text-color-focused-active: hsla(35, 27%, 55%, 1);
  --tab-text-color-focused-active-current: hsla(34, 39%, 74%, 1);
  --tab-text-color-focused-highlighted: hsl(31, 27%, 24%);
  --tab-z-index: 1;
  --table-add-button-border-color: hsla(28, 22%, 19%, 1);
  --table-background: hsla(29, 16%, 13%, 1);
  --table-border-color: hsla(28, 22%, 19%, 1);
  --table-column-alt-background: hsla(24, 18%, 11%, 1);
  --table-drag-handle-background-active: hsl( 28, 27.54%, 27.6% );
  --table-drag-handle-color: hsla(34, 24%, 46%, 1);
  --table-drag-handle-color-active: hsla(32, 48%, 85%, 1);
  --table-header-background: hsla(24, 18%, 11%, 1);
  --table-header-background-hover: hsla(24, 18%, 11%, 1);
  --table-header-border-color: hsla(28, 22%, 19%, 1);
  --table-header-color: hsla(34, 39%, 74%, 1);
  --table-header-weight: 650;
  --table-row-alt-background: hsla(29, 16%, 13%, 1);
  --table-row-alt-background-hover: hsla(29, 16%, 13%, 1);
  --table-row-background-hover: hsla(29, 16%, 13%, 1);
  --table-selection: hsla(31,27%,24%, 0.1);
  --table-selection-border-color: hsl( 28, 27.54%, 27.6% );
  ...
  --tag-color: hsla(197, 48%, 49%, 1);
  --tag-color-hover: hsla(194, 59%, 56%, 1);
  --tag-padding-x: 0.6em;
  ...
  --tertiary: var(--text-accent-hover, hsl( 26, 31.32%, 32.16% ));
  --text-accent: hsl(31, 27%, 24%);
  --text-accent-hover: hsl( 26, 31.32%, 32.16% );
  --text-error: hsla(4, 88%, 61%, 1);
  --text-faint: hsla(34, 24%, 46%, 1);
  --text-font-feature: "calt" 1,"case" 0,"ccmp" 1,"ss03" 1,"cv01" 1,"cv05" 1,"cv06" 1,"cv08" 0,"cv11" 1,"cv12" 0,"cv13" 0;
  --text-highlight-bg: hsla(44, 100%, 50%, 0.2);
  --text-highlight-bg-rgb: 249,207,81;
  --text-input-bg-active: hsla(32, 21%, 9%, 1);
  --text-input-border-color: hsla(32, 21%, 9%, 1);
  --text-input-color: hsla(34, 39%, 74%, 1);
  --text-input-color-focused: hsla(34, 39%, 74%, 1);
  ...
  --text-muted: hsla(35, 27%, 55%, 1);
  --text-normal: hsla(34, 39%, 74%, 1);
  --text-on-accent: hsla(32, 48%, 85%, 1);
  --text-on-accent-inverted: hsla(32, 21%, 9%, 1);
  --text-selection: hsla(34, 24%, 40%, 0.2);
  --text-selection-theme-bg: color-mix(in srgb, hsla(34, 24%, 46%, 1) 30%, transparent);
  --text-selection-theme-text-color: color-mix(in srgb, currentColor 70%, white);
  --text-success: hsla(155, 78%, 29%, 1);
  --text-warning: hsla(22, 82%, 47%, 1);
  --textHighlight: var(--text-highlight-bg, hsla(44, 100%, 50%, 0.2));
  ...
  --titlebar-background: hsla(29, 16%, 13%, 1);
  --titlebar-background-focused: hsla(29, 16%, 13%, 1);
  --titlebar-border-color: hsla(28, 22%, 19%, 1);
  --titlebar-text-color: hsla(31, 27%, 25%, 1);
  --titlebar-text-color-focused: hsla(33, 27%, 33%, 1);
  --titlebar-text-weight: 450;
  --toggle-bg: color-mix(in srgb, hsla(31, 27%, 25%, 1) 50%, hsla(33, 27%, 33%, 1));
  --toggle-bg-enabled: hsla(154, 75%, 26%, 1);
  ...
  --toggle-thumb-color: hsla(32, 48%, 85%, 1);
  ...
  --underline-color: hsla(34, 39%, 74%, 1);
  ...
  --vault-name-background: hsla(30, 17%, 14%, 1);
  --vault-name-border: 1px solid hsla(28, 22%, 19%, 1);
  --vault-name-border-width: 1px;
  --vault-name-color: hsla(35, 27%, 55%, 1);
  --vault-name-color-hover: hsla(34, 31%, 68%, 1);
  --vault-profile-color: hsla(35, 27%, 55%, 1);
  --vault-profile-color-hover: hsla(35, 27%, 55%, 1);
  --vault-profile-font-weight: 650;
  --yaml-atom-color: hsla(191, 54%, 62%, 1);
  --yaml-base-color: hsla(4, 91%, 67%, 1);
  --yaml-def-meta-color: hsla(34, 24%, 46%, 1);
  --yaml-keyword-color: hsla(40, 78%, 48%, 1);
  --yaml-number-color: hsla(4, 91%, 67%, 1);
  --yaml-string-color: hsla(40, 78%, 48%, 1);
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --accent-l: 50%;
  --accent-s: 23%;
  --active-line-bg: hsla(36, 38%, 98%, 1);
  --alternating-color-1: hsla(40, 79%, 47%, 1);
  --alternating-color-1-hover-active: hsla(40, 98%, 36%, 1);
  --alternating-color-2: hsla(4, 56%, 48%, 1);
  --alternating-color-2-hover-active: hsla(4, 72%, 35%, 1);
  --alternating-color-3: hsla(200, 64%, 37%, 1);
  --alternating-color-3-hover-active: hsla(205, 85%, 25%, 1);
  ...
  --anim-popup-alt: 0.335s slideUpAlt forwards;
  --background-anim: background 140ms cubic-bezier(0.45, 0.05, 0.55, 0.95);
  --background-modifier-active-hover: hsla(37, 38%, 83%, 1);
  --background-modifier-border: hsla(37, 38%, 83%, 1);
  --background-modifier-border-focus: color-mix(in hsl, hsla(34, 37%, 70%, 1) 60%, hsla(37, 38%, 83%, 1));
  --background-modifier-border-hover: color-mix(in hsl, hsla(34, 37%, 70%, 1) 60%, hsla(37, 38%, 83%, 1));
  --background-modifier-error: hsla(4, 56%, 48%, 1);
  --background-modifier-error-hover: hsla(4, 72%, 55%, 1);
  --background-modifier-error-rgb: 223,90,90;
  --background-modifier-form-field: hsla(35, 37%, 92%, 1);
  --background-modifier-form-field-hover: hsla(35, 37%, 92%, 1);
  --background-modifier-hover: rgba(255, 255, 255, 0.5);
  --background-modifier-message: hsla(35, 28%, 40%, 1);
  --background-modifier-success: hsla(149, 50%, 39%, 1);
  --background-modifier-success-rgb: 87,185,132;
  --background-modifier-warning: hsla(18, 69%, 50%, 1);
  --background-modifier-warning-hover: hsla(21, 81%, 59%, 1);
  --background-primary: hsla(35, 36%, 96%, 1);
  --background-primary-alt: hsla(35, 37%, 92%, 1);
  --background-secondary: hsla(34, 34%, 90%, 1);
  --background-secondary-alt: hsla(34, 34%, 90%, 1);
  --bases-cards-background: hsla(35, 36%, 96%, 1);
  --bases-cards-cover-background: hsla(35, 37%, 92%, 1);
  --bases-cards-shadow: 0 0 0 1px hsla(37, 38%, 83%, 1);
  --bases-cards-shadow-hover: 0 0 0 1px color-mix(in hsl, hsla(34, 37%, 70%, 1) 60%, hsla(37, 38%, 83%, 1));
  --bases-embed-border-color: hsla(37, 38%, 83%, 1);
  --bases-group-heading-property-color: hsla(35, 28%, 40%, 1);
  --bases-group-heading-property-weight: 450;
  --bases-group-heading-value-weight: 650;
  --bases-table-border-color: hsla(37, 38%, 83%, 1);
  --bases-table-cell-background-active: hsla(35, 36%, 96%, 1);
  --bases-table-cell-background-disabled: hsla(35, 37%, 92%, 1);
  --bases-table-cell-background-selected: hsla(31,23%,50%, 0.1);
  --bases-table-cell-shadow-active: 0 0 0 2px color-mix(in hsl, hsla(34, 37%, 70%, 1) 60%, hsla(37, 38%, 83%, 1));
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl( 30, 23.23%, 53.75% );
  --bases-table-group-background: hsla(35, 37%, 92%, 1);
  --bases-table-header-background: hsla(35, 36%, 96%, 1);
  --bases-table-header-background-hover: rgba(255, 255, 255, 0.5);
  --bases-table-header-color: hsla(35, 28%, 40%, 1);
  --bases-table-header-weight: 450;
  --bases-table-row-background-hover: hsla(36, 38%, 98%, 1);
  --bases-table-summary-background: hsla(35, 36%, 96%, 1);
  --bases-table-summary-background-hover: rgba(255, 255, 255, 0.5);
  --blockquote-background-color: hsla(36, 38%, 98%, 1);
  --blockquote-border-color: hsla(37, 38%, 83%, 1);
  --blur-background: color-mix(in srgb, hsla(35, 36%, 96%, 1) 65%, transparent) linear-gradient(hsla(35, 36%, 96%, 1), color-mix(in srgb, hsla(35, 36%, 96%, 1) 65%, transparent));
  --bodyFont: var(--font-text, "Inter", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  --bold-color: hsla(4, 56%, 48%, 1);
  --bold-highlight-bg: hsla(350, 84%, 63%, 0.2);
  --bold-highlight-color: hsla(31, 45%, 24%, 1);
  --bold-italic-color: hsla(33, 54%, 17%, 1);
  --bold-italic-highlight-bg: hsla(74, 69%, 44%, 0.2);
  --bold-italic-highlight-color: hsla(33, 54%, 17%, 1);
  --bold-italic-strikethrough-color: hsla(31, 23%, 50%, 1);
  --bold-italic-weight: 750;
  --bold-weight: 750;
  --bookmark-chbx-color: hsla(21, 81%, 59%, 1);
  --bookmark-folder-1-bg-color: color-mix(in srgb, hsla(350, 84%, 63%, 0.2) 60%, transparent);
  --bookmark-folder-1-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(350, 84%, 63%, 0.2) 60%, transparent) 70%, transparent);
  --bookmark-folder-1-collapse-color: color-mix(in srgb, hsla(4, 56%, 48%, 1) 50%, transparent);
  --bookmark-folder-1-color: hsla(4, 56%, 48%, 1);
  --bookmark-folder-1-indent-color: color-mix(in srgb, hsla(4, 56%, 48%, 1) 25%, transparent);
  --bookmark-folder-10-bg-color: color-mix(in srgb, hsla(74, 69%, 44%, 0.2) 60%, transparent);
  --bookmark-folder-10-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(74, 69%, 44%, 0.2) 60%, transparent) 70%, transparent);
  --bookmark-folder-10-collapse-color: color-mix(in srgb, hsla(153, 65%, 29%, 1) 50%, transparent);
  --bookmark-folder-10-color: hsla(153, 65%, 29%, 1);
  --bookmark-folder-10-indent-color: color-mix(in srgb, hsla(153, 65%, 29%, 1) 25%, transparent);
  --bookmark-folder-11-bg-color: color-mix(in srgb, hsla(186, 64%, 46%, 0.2) 60%, transparent);
  --bookmark-folder-11-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(186, 64%, 46%, 0.2) 60%, transparent) 70%, transparent);
  --bookmark-folder-11-collapse-color: color-mix(in srgb, hsla(200, 64%, 37%, 1) 50%, transparent);
  --bookmark-folder-11-color: hsla(200, 64%, 37%, 1);
  --bookmark-folder-11-indent-color: color-mix(in srgb, hsla(200, 64%, 37%, 1) 25%, transparent);
  --bookmark-folder-12-bg-color: color-mix(in srgb, hsla(236, 100%, 72%, 0.2) 60%, transparent);
  --bookmark-folder-12-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(236, 100%, 72%, 0.2) 60%, transparent) 70%, transparent);
  --bookmark-folder-12-collapse-color: color-mix(in srgb, hsla(275, 37%, 43%, 1) 50%, transparent);
  --bookmark-folder-12-color: hsla(275, 37%, 43%, 1);
  --bookmark-folder-12-indent-color: color-mix(in srgb, hsla(275, 37%, 43%, 1) 25%, transparent);
  --bookmark-folder-2-bg-color: color-mix(in srgb, hsla(27, 100%, 50%, 0.2) 60%, transparent);
  --bookmark-folder-2-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(27, 100%, 50%, 0.2) 60%, transparent) 70%, transparent);
  --bookmark-folder-2-collapse-color: color-mix(in srgb, hsla(18, 69%, 50%, 1) 50%, transparent);
  --bookmark-folder-2-color: hsla(18, 69%, 50%, 1);
  --bookmark-folder-2-indent-color: color-mix(in srgb, hsla(18, 69%, 50%, 1) 25%, transparent);
  --bookmark-folder-3-bg-color: color-mix(in srgb, hsla(44, 100%, 50%, 0.2) 60%, transparent);
  --bookmark-folder-3-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(44, 100%, 50%, 0.2) 60%, transparent) 70%, transparent);
  --bookmark-folder-3-collapse-color: color-mix(in srgb, hsla(40, 98%, 36%, 1) 50%, transparent);
  --bookmark-folder-3-color: hsla(40, 98%, 36%, 1);
  --bookmark-folder-3-indent-color: color-mix(in srgb, hsla(40, 98%, 36%, 1) 25%, transparent);
  --bookmark-folder-4-bg-color: color-mix(in srgb, hsla(74, 69%, 44%, 0.2) 60%, transparent);
  --bookmark-folder-4-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(74, 69%, 44%, 0.2) 60%, transparent) 70%, transparent);
  --bookmark-folder-4-collapse-color: color-mix(in srgb, hsla(153, 65%, 29%, 1) 50%, transparent);
  --bookmark-folder-4-color: hsla(153, 65%, 29%, 1);
  --bookmark-folder-4-indent-color: color-mix(in srgb, hsla(153, 65%, 29%, 1) 25%, transparent);
  --bookmark-folder-5-bg-color: color-mix(in srgb, hsla(186, 64%, 46%, 0.2) 60%, transparent);
  --bookmark-folder-5-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(186, 64%, 46%, 0.2) 60%, transparent) 70%, transparent);
  --bookmark-folder-5-collapse-color: color-mix(in srgb, hsla(200, 64%, 37%, 1) 50%, transparent);
  --bookmark-folder-5-color: hsla(200, 64%, 37%, 1);
  --bookmark-folder-5-indent-color: color-mix(in srgb, hsla(200, 64%, 37%, 1) 25%, transparent);
  --bookmark-folder-6-bg-color: color-mix(in srgb, hsla(236, 100%, 72%, 0.2) 60%, transparent);
  --bookmark-folder-6-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(236, 100%, 72%, 0.2) 60%, transparent) 70%, transparent);
  --bookmark-folder-6-collapse-color: color-mix(in srgb, hsla(275, 37%, 43%, 1) 50%, transparent);
  --bookmark-folder-6-color: hsla(275, 37%, 43%, 1);
  --bookmark-folder-6-indent-color: color-mix(in srgb, hsla(275, 37%, 43%, 1) 25%, transparent);
  --bookmark-folder-7-bg-color: color-mix(in srgb, hsla(350, 84%, 63%, 0.2) 60%, transparent);
  --bookmark-folder-7-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(350, 84%, 63%, 0.2) 60%, transparent) 70%, transparent);
  --bookmark-folder-7-collapse-color: color-mix(in srgb, hsla(4, 56%, 48%, 1) 50%, transparent);
  --bookmark-folder-7-color: hsla(4, 56%, 48%, 1);
  --bookmark-folder-7-indent-color: color-mix(in srgb, hsla(4, 56%, 48%, 1) 25%, transparent);
  --bookmark-folder-8-bg-color: color-mix(in srgb, hsla(27, 100%, 50%, 0.2) 60%, transparent);
  --bookmark-folder-8-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(27, 100%, 50%, 0.2) 60%, transparent) 70%, transparent);
  --bookmark-folder-8-collapse-color: color-mix(in srgb, hsla(18, 69%, 50%, 1) 50%, transparent);
  --bookmark-folder-8-color: hsla(18, 69%, 50%, 1);
  --bookmark-folder-8-indent-color: color-mix(in srgb, hsla(18, 69%, 50%, 1) 25%, transparent);
  --bookmark-folder-9-bg-color: color-mix(in srgb, hsla(44, 100%, 50%, 0.2) 60%, transparent);
  --bookmark-folder-9-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(44, 100%, 50%, 0.2) 60%, transparent) 70%, transparent);
  --bookmark-folder-9-collapse-color: color-mix(in srgb, hsla(40, 98%, 36%, 1) 50%, transparent);
  --bookmark-folder-9-color: hsla(40, 98%, 36%, 1);
  --bookmark-folder-9-indent-color: color-mix(in srgb, hsla(40, 98%, 36%, 1) 25%, transparent);
  --breadcrumb-bg-hover: hsla(34, 34%, 90%, 1);
  --breadcrumb-color: hsla(31, 23%, 50%, 1);
  --breadcrumb-color-hover: hsla(31, 23%, 50%, 1);
  --breadcrumb-separator-color: hsla(37, 38%, 83%, 1);
  ...
  --cancelled-chbx-text-color: hsla(34, 29%, 60%, 1);
  --cancelled-chbx-text-decoration: line-through;
  --canvas-background: hsla(35, 36%, 96%, 1);
  --canvas-card-label-color: hsla(34, 29%, 60%, 1);
  ...
  --canvas-controls-icon-size: 15px;
  --canvas-dot-pattern: hsla(37, 38%, 83%, 1);
  --canvas-icon-color: hsla(34, 29%, 60%, 1);
  --canvas-icon-color-disabled: hsla(37, 38%, 83%, 1);
  --canvas-icon-color-hover: hsla(36, 32%, 30%, 1);
  --canvas-menu-bg: color-mix(in hsl, hsla(36, 38%, 98%, 1) 50%, hsla(35, 36%, 96%, 1));
  --canvas-menu-bg-hover: hsla(36, 38%, 98%, 1);
  --canvas-menu-border: 1px solid hsla(37, 38%, 83%, 1);
  --canvas-menu-shadow: 0px 1px 2px 1px rgba(0, 0, 0, 0.02),0px 1px 4px -2.1px rgba(0, 0, 0, 0.1),0px 2px 8px -1.2px rgba(0, 0, 0, 0.03);
  --caret-color: hsla(34, 29%, 60%, 1);
  --checkbox-border-color: hsla(37, 38%, 83%, 1);
  --checkbox-border-color-hover: hsla(34, 37%, 70%, 1);
  --checkbox-color: hsla(149, 50%, 39%, 1);
  --checkbox-color-hover: hsla(148, 48%, 47%, 1);
  --checkbox-marker-color: white;
  --checked-border-color: rgba(0, 0, 0, 0.15);
  --checked-border-color-hover: rgba(0, 0, 0, 0.1);
  --checklist-bg: hsla(36, 38%, 98%, 1);
  --checklist-done-color: hsla(34, 29%, 60%, 1);
  --checklist-shadow-hover: 0px 0px 0px 3px rgba(0, 0, 0, 0.07);
  --clickable-icon-radius: 5px;
  --clock-chbx-color: hsla(210, 39%, 49%, 1);
  --close-button-radius: 12px;
  --code-background: hsla(35, 37%, 92%, 1);
  --code-border-color: hsla(37, 38%, 83%, 1);
  --code-bracket-background: rgba(255, 255, 255, 0.5);
  --code-comment: hsla(34, 29%, 60%, 1);
  --code-function: hsla(42, 89%, 46%, 1);
  --code-important: hsla(30, 66%, 52%, 1);
  --code-keyword: hsla(351, 44%, 61%, 1);
  --code-normal: hsla(31, 45%, 24%, 1);
  --code-operator: hsla(0, 58%, 53%, 1);
  --code-property: hsla(178, 39%, 49%, 1);
  --code-punctuation: hsla(35, 28%, 40%, 1);
  --code-radius: 8px;
  --code-string: hsla(146, 37%, 49%, 1);
  --code-tag: hsla(0, 58%, 53%, 1);
  --code-value: hsla(249, 39%, 60%, 1);
  --codeFont: var(--font-monospace, "Cascadia Code", ui-monospace, SFMono-Regular, "Cascadia Mono", "Roboto Mono", "DejaVu Sans Mono", "Liberation Mono", Menlo, Monaco, "Consolas", "Source Code Pro", monospace);
  --collapse-icon-color: hsla(34, 37%, 70%, 1);
  --collapse-icon-color-collapsed: hsla(34, 37%, 70%, 1);
  --color-accent: hsl(31, 23%, 50%);
  --color-accent-1: hsl( 30, 23.23%, 53.75% );
  --color-accent-2: hsl( 28, 30.59%, 59.5% );
  --color-accent-hsl: 31,23%,50%;
  --color-base-00: hsla(36, 38%, 98%, 1);
  --color-base-05: hsla(35, 36%, 96%, 1);
  --color-base-10: hsla(35, 37%, 92%, 1);
  --color-base-100: hsla(33, 54%, 17%, 1);
  --color-base-20: hsla(34, 34%, 90%, 1);
  --color-base-25: hsla(36, 35%, 88%, 1);
  --color-base-30: hsla(37, 38%, 83%, 1);
  --color-base-35: hsla(34, 37%, 70%, 1);
  --color-base-40: hsla(34, 29%, 60%, 1);
  --color-base-50: hsla(31, 23%, 50%, 1);
  --color-base-60: hsla(35, 28%, 40%, 1);
  --color-base-70: hsla(36, 32%, 30%, 1);
  ...
  --copy-code-button-radius: 4px;
  --cursor: pointer;
  --dark: var(--text-normal, hsla(31, 45%, 24%, 1));
  --darkgray: var(--text-normal, hsla(31, 45%, 24%, 1));
  --disabled-component-opacity: 0.3;
  --divider-color: hsla(37, 38%, 83%, 1);
  --divider-color-hover: color-mix(in hsl, hsla(34, 37%, 70%, 1) 60%, hsla(37, 38%, 83%, 1));
  --divider-radius: 8px;
  --divider-width-hover: 4px;
  --down-chbx-color: hsla(4, 56%, 48%, 1);
  --drag-ghost-background: hsl( 30, 23.23%, 53.75% );
  --drag-ghost-text-color: hsla(36, 38%, 98%, 1);
  --dropdown-background: hsla(35, 37%, 92%, 1);
  --dropdown-background-hover: color-mix(in hsl, hsla(36, 38%, 98%, 1) 50%, hsla(35, 37%, 92%, 1));
  --dropdown-height: 31px;
  --editor-bg-color: hsla(35, 36%, 96%, 1);
  --editor-bgpattern-color: hsla(37, 38%, 83%, 1);
  --editor-bgpattern-size: 50px 50px;
  --editor-border-color: hsla(37, 38%, 83%, 1);
  --editor-border-radius: 12px;
  --editor-border-width: 1px;
  --editor-header-icon: 15px;
  --editor-pane-margin: 10px;
  --editor-tab-icon: 15px;
  --embed-background: color-mix( in srgb, hsla(35, 37%, 92%, 1) 50%, hsla(35, 36%, 96%, 1) );
  --embed-bg-color-mix: color-mix( in srgb, hsla(35, 37%, 92%, 1) 50%, hsla(35, 36%, 96%, 1) );
  --embed-block-shadow-hover: none;
  --embed-border-bottom: 1px solid hsla(37, 38%, 83%, 1);
  --embed-border-bottom-color: hsla(37, 38%, 83%, 1);
  --embed-border-bottom-style: solid;
  --embed-border-bottom-width: 1px;
  --embed-border-end: 1px solid hsla(37, 38%, 83%, 1);
  --embed-border-end-color: hsla(37, 38%, 83%, 1);
  --embed-border-end-style: solid;
  --embed-border-end-width: 1px;
  --embed-border-radius: 12px;
  --embed-border-start: 1px solid hsla(37, 38%, 83%, 1);
  --embed-border-start-color: hsla(37, 38%, 83%, 1);
  --embed-border-start-style: solid;
  --embed-border-start-width: 1px;
  --embed-border-top: 1px solid hsla(37, 38%, 83%, 1);
  --embed-border-top-color: hsla(37, 38%, 83%, 1);
  --embed-border-top-style: solid;
  --embed-border-top-width: 1px;
  --embed-edit-btn-bg: color-mix(in srgb, hsla(35, 36%, 96%, 1) 70%, transparent);
  --embed-edit-btn-bg-hover: color-mix(in srgb, hsla(35, 36%, 96%, 1) 100%, transparent);
  ...
  --embed-media-border-radius: 8px;
  --embed-padding: 6px 16px 0px;
  --embed-title-border: 1px solid hsla(37, 38%, 83%, 1);
  --embed-title-border-color: hsla(37, 38%, 83%, 1);
  --embed-title-border-style: solid;
  --embed-title-border-width: 1px;
  --embed-title-color: hsla(31, 23%, 50%, 1);
  --embed-title-font-size: 16px;
  --embed-title-font-weight: 550;
  --embed-title-letter-spacing: normal;
  --embed-title-margin-bottom: 8px;
  --embed-title-text-transform: none;
  --empty-state-action-btn-bg: color-mix(in srgb, hsla(35, 37%, 92%, 1) 50%, transparent);
  --file-header-background: hsla(35, 36%, 96%, 1);
  --file-header-background-focused: hsla(35, 36%, 96%, 1);
  --file-header-border: 1px solid hsla(37, 38%, 83%, 1);
  --file-header-border-color: hsla(37, 38%, 83%, 1);
  --file-header-border-width: 1px;
  --file-header-font: "Inter", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  --file-header-title-color: hsla(36, 32%, 30%, 1);
  --file-line-width: 40rem;
  --file-max-line-width: 88%;
  --file-tab-gap: 0px;
  --flair-background: hsla(35, 37%, 92%, 1);
  --flair-color: hsla(31, 45%, 24%, 1);
  --flair-count-bg-color: hsla(34, 34%, 90%, 1);
  --flair-count-color: hsla(34, 29%, 60%, 1);
  --flair-count-padding: 2px 4px;
  --flair-count-radius: 5px;
  --font-bold: 750;
  --font-extrabold: 850;
  ...
  --font-ui-smallest: 11px;
  --font-weight: 450;
  --footnote-divider-color: hsla(37, 38%, 83%, 1);
  --footnote-id-color: hsla(35, 28%, 40%, 1);
  --footnote-id-color-no-occurrences: hsla(34, 29%, 60%, 1);
  --footnote-input-background-active: rgba(255, 255, 255, 0.45);
  --graph-arrow: hsla(31, 23%, 50%, 1);
  --graph-line: hsla(37, 38%, 83%, 1);
  --graph-node: hsla(202, 66%, 48%, 1);
  --graph-node-attachment: hsla(148, 30%, 65%, 1);
  --graph-node-focused: hsla(31, 45%, 24%, 1);
  --graph-node-highlight-fill: hsla(31, 23%, 50%, 1);
  --graph-node-highlight-line: hsla(34, 37%, 70%, 1);
  --graph-node-tag: hsla(4, 72%, 55%, 1);
  --graph-node-unresolved: hsla(43, 83%, 57%, 1);
  --graph-node-unresolved-opacity: 1;
  --graph-text: hsla(34, 29%, 60%, 1);
  --gray: var(--text-muted, hsla(35, 28%, 40%, 1));
  --gutter-color: color-mix(in hsl, hsla(37, 38%, 83%, 1) 40%, hsla(34, 37%, 70%, 1));
  --gutter-color-active: hsla(31, 23%, 50%, 1);
  --h1-bg-color: transparent;
  --h1-border-bottom-color: hsla(37, 38%, 83%, 1);
  --h1-border-left-color: hsla(37, 38%, 83%, 1);
  --h1-border-radius: 0px;
  --h1-border-right-color: hsla(37, 38%, 83%, 1);
  --h1-border-style: solid;
  --h1-border-top-color: hsla(37, 38%, 83%, 1);
  --h1-border-width: 0px;
  --h1-color: hsla(33, 54%, 17%, 1);
  --h1-text-align: left;
  --h1-text-transform: normal;
  --h1-weight: 650;
  --h2-bg-color: transparent;
  --h2-border-bottom-color: hsla(37, 38%, 83%, 1);
  --h2-border-left-color: hsla(37, 38%, 83%, 1);
  --h2-border-radius: 0px;
  --h2-border-right-color: hsla(37, 38%, 83%, 1);
  --h2-border-style: solid;
  --h2-border-top-color: hsla(37, 38%, 83%, 1);
  --h2-border-width: 0px;
  --h2-color: hsla(33, 54%, 17%, 1);
  --h2-text-align: left;
  --h2-text-transform: normal;
  --h2-weight: 650;
  --h3-bg-color: transparent;
  --h3-border-bottom-color: hsla(37, 38%, 83%, 1);
  --h3-border-left-color: hsla(37, 38%, 83%, 1);
  --h3-border-radius: 0px;
  --h3-border-right-color: hsla(37, 38%, 83%, 1);
  --h3-border-style: solid;
  --h3-border-top-color: hsla(37, 38%, 83%, 1);
  --h3-border-width: 0px;
  --h3-color: hsla(33, 54%, 17%, 1);
  --h3-text-align: left;
  --h3-text-transform: normal;
  --h3-weight: 650;
  --h4-bg-color: transparent;
  --h4-border-bottom-color: hsla(37, 38%, 83%, 1);
  --h4-border-left-color: hsla(37, 38%, 83%, 1);
  --h4-border-radius: 0px;
  --h4-border-right-color: hsla(37, 38%, 83%, 1);
  --h4-border-style: solid;
  --h4-border-top-color: hsla(37, 38%, 83%, 1);
  --h4-border-width: 0px;
  --h4-color: hsla(33, 54%, 17%, 1);
  --h4-text-align: left;
  --h4-text-transform: normal;
  --h4-weight: 650;
  --h5-bg-color: transparent;
  --h5-border-bottom-color: hsla(37, 38%, 83%, 1);
  --h5-border-left-color: hsla(37, 38%, 83%, 1);
  --h5-border-radius: 0px;
  --h5-border-right-color: hsla(37, 38%, 83%, 1);
  --h5-border-style: solid;
  --h5-border-top-color: hsla(37, 38%, 83%, 1);
  --h5-border-width: 0px;
  --h5-color: hsla(33, 54%, 17%, 1);
  --h5-text-align: left;
  --h5-text-transform: normal;
  --h5-weight: 650;
  --h6-bg-color: transparent;
  --h6-border-bottom-color: hsla(37, 38%, 83%, 1);
  --h6-border-left-color: hsla(37, 38%, 83%, 1);
  --h6-border-radius: 0px;
  --h6-border-right-color: hsla(37, 38%, 83%, 1);
  --h6-border-style: solid;
  --h6-border-top-color: hsla(37, 38%, 83%, 1);
  --h6-border-width: 0px;
  --h6-color: hsla(33, 54%, 17%, 1);
  --h6-text-align: left;
  --h6-text-transform: normal;
  --h6-weight: 650;
  --header-height: 46px;
  --headerFont: var(--font-text, "Inter", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  --heading-formatting: hsla(34, 29%, 60%, 1);
  --highlight: var(--text-highlight-bg, hsla(44, 100%, 50%, 0.2));
  --hr-color: hsla(37, 38%, 83%, 1);
  --hr-thickness: 1px;
  --icon-bg: transparent;
  --icon-bg-active: hsla(37, 38%, 83%, 1);
  --icon-bg-active-menu: transparent;
  --icon-bg-hover: transparent;
  --icon-bg-pressed: transparent;
  --icon-color: hsla(34, 29%, 60%, 1);
  --icon-color-active: hsla(35, 28%, 40%, 1);
  --icon-color-focused: hsla(31, 23%, 50%, 1);
  --icon-color-hover: hsla(31, 23%, 50%, 1);
  --icon-container-radius: 0px;
  --icon-m: 16px;
  --icon-opacity: 1;
  --icon-s: 15px;
  ...
  --important-chbx-icon-color: white;
  --important-chbx-radius: 100%;
  --indentation-guide-color: hsla(37, 38%, 83%, 1);
  --indentation-guide-color-active: color-mix(in hsl, hsla(34, 37%, 70%, 1) 60%, hsla(37, 38%, 83%, 1));
  --indentation-guide-reading-indent: -1em;
  --info-chbx-color: hsla(178, 29%, 45%, 1);
  --info-chbx-icon-color: white;
  --inline-code-bg: hsla(36, 38%, 98%, 1);
  --inline-code-color: hsla(4, 59%, 64%, 1);
  --inline-code-radius: 4px;
  --inline-query-bg: color-mix(in srgb, hsla(34, 34%, 90%, 1) 20%, hsla(35, 36%, 96%, 1));
  --inline-query-shadow: 0px 1px 10px 0px rgba(0, 0, 0, 0.06);
  --inline-title-color: hsla(33, 54%, 17%, 1);
  --inline-title-weight: 650;
  --inprogress-chbx-border-color: color-mix(in srgb, hsla(34, 82%, 57%, 1) 65%, hsla(35, 28%, 40%, 1));
  --inprogress-chbx-color: hsla(34, 82%, 57%, 1);
  --inprogress-chbx-color-hover: hsla(34, 82%, 64%, 1);
  --input-date-separator: hsla(34, 29%, 60%, 1);
  --input-font-weight: 450;
  --input-height: 32px;
  --input-placeholder-color: hsla(34, 29%, 60%, 1);
  --input-radius: 8px;
  ...
  --interactive-accent: hsl( 30, 23.23%, 53.75% );
  --interactive-accent-hover: hsl( 28, 30.59%, 59.5% );
  --interactive-accent-hsl: 31,23%,50%;
  --interactive-hover: color-mix(in hsl, hsla(36, 38%, 98%, 1) 50%, hsla(35, 37%, 92%, 1));
  --interactive-normal: hsla(35, 37%, 92%, 1);
  --interface-font-feature: "calt" 1,"case" 0,"ccmp" 1,"ss03" 1,"cv01" 1,"cv05" 1,"cv06" 1,"cv08" 0,"cv11" 1,"cv12" 0,"cv13" 0;
  --italic-color: hsla(200, 64%, 37%, 1);
  --italic-highlight-bg: hsla(186, 64%, 46%, 0.2);
  --italic-highlight-color: hsla(31, 45%, 24%, 1);
  --kanban-drag-item-border: none;
  ...
  --kanban-item-bg: hsla(36, 38%, 98%, 1);
  --kanban-item-border: none;
  ...
  --kanban-lane-bg: color-mix(in srgb, hsla(35, 37%, 92%, 1) 50%, hsla(35, 36%, 96%, 1));
  --kanban-lane-border: 1px solid hsla(34, 34%, 90%, 1);
  --kanban-lane-shadow: none;
  --kanban-new-item-bg: transparent;
  --kanban-new-item-bg-hover: hsla(35, 36%, 96%, 1);
  --kanban-new-item-color: hsla(34, 29%, 60%, 1);
  --kanban-new-item-color-hover: hsla(35, 28%, 40%, 1);
  --kanban-new-item-shadow: none;
  --kanban-new-item-shadow-hover: inset 0px 0px 0px 1px rgba(0, 0, 0, 0.12),0px 2px 4px 0px rgba(0, 0, 0, 0.04);
  --kanban-title-count-bg: hsla(37, 38%, 83%, 1);
  --kanban-title-count-color: hsla(36, 32%, 30%, 1);
  --kanban-title-count-radius: 12px;
  --kanban-title-text-input-color: hsla(31, 45%, 24%, 1);
  --kbd-background: hsla(34, 34%, 90%, 1);
  --kbd-color: hsla(4, 59%, 64%, 1);
  --kbd-shadow: inset 0px 0px 0px 1px rgba(0, 0, 0, 0.03),inset 0px -2px 0px 0px rgba(0, 0, 0, 0.06);
  --language-chbx-color: hsla(7, 59%, 64%, 1);
  --law-chbx-color: hsla(34, 34%, 52%, 1);
  --light: var(--background-primary, hsla(35, 36%, 96%, 1));
  --lightgray: var(--background-secondary, hsla(34, 34%, 90%, 1));
  --link-ahref-color: hsla(4, 72%, 55%, 1);
  --link-ahref-color-hover: hsla(4, 59%, 64%, 1);
  --link-ahref-decoration-color: color-mix(in srgb, currentColor 22%, transparent);
  --link-ahref-decoration-color-hover: color-mix(in srgb, hsla(4, 59%, 64%, 1) 22%, transparent);
  --link-color: hsla(40, 79%, 47%, 1);
  --link-color-hover: hsla(43, 83%, 57%, 1);
  --link-decoration-color: color-mix(in srgb, hsla(40, 79%, 47%, 1) 22%, transparent);
  --link-decoration-color-hover: color-mix(in srgb, hsla(43, 83%, 57%, 1) 22%, transparent);
  --link-decoration-opacity: 22%;
  --link-decoration-thickness: 1.5px;
  --link-external-color: hsla(149, 50%, 39%, 1);
  --link-external-color-hover: hsla(148, 48%, 47%, 1);
  --link-external-decoration-color: color-mix(in srgb, hsla(149, 50%, 39%, 1) 22%, transparent);
  --link-external-decoration-color-hover: color-mix(in srgb, hsla(148, 48%, 47%, 1) 22%, transparent);
  --link-opacity-active: 0.5;
  --link-underline-offset: 2px;
  --link-unresolved-color: hsla(34, 29%, 60%, 1);
  --link-unresolved-color-hover: hsla(34, 37%, 70%, 1);
  --link-unresolved-decoration-color: color-mix(in srgb, hsla(34, 29%, 60%, 1) 22%, transparent);
  --link-unresolved-decoration-color-hover: color-mix(in srgb, hsla(34, 37%, 70%, 1) 22%, transparent);
  --link-unresolved-opacity: 1;
  --link-weight: 450;
  --list-bullet-indent-reading: -1em;
  --list-indent-editing: 0.6em;
  --list-marker-color: hsla(34, 29%, 60%, 1);
  --list-marker-color-collapsed: hsla(31, 23%, 50%, 1);
  --list-marker-color-hover: hsla(35, 28%, 40%, 1);
  --loading-line-bg-color: hsla(34, 34%, 90%, 1);
  --loading-line-color: hsla(197, 39%, 56%, 1);
  --loading-line-shadow: inset 0px 0px 0px 1px rgba(0, 0, 0, 0.1);
  --location-chbox-color: hsla(0, 56%, 48%, 1);
  --menu-background: hsla(34, 34%, 90%, 1);
  --menu-border-color: color-mix(in hsl, hsla(34, 37%, 70%, 1) 60%, hsla(37, 38%, 83%, 1));
  --menu-item-bg-active: hsla(36, 35%, 88%, 1);
  --menu-item-bg-hover: rgba(255, 255, 255, 0.35);
  --menu-item-color-active: hsla(34, 37%, 70%, 1);
  --menu-item-icon-color: hsla(34, 29%, 60%, 1);
  --menu-item-icon-color-active: hsla(34, 37%, 70%, 1);
  --menu-item-radius: 7px;
  --menu-shadow: 0px 1px 2px rgba(0, 0, 0, 0.028),0px 3.4px 6.7px rgba(0, 0, 0, 0.042),0px 15px 30px rgba(0, 0, 0, 0.07);
  --metadata-background: color-mix(in srgb, hsla(35, 36%, 96%, 1) 50%, hsla(35, 37%, 92%, 1));
  --metadata-border-color: hsla(37, 38%, 83%, 1);
  --metadata-border-radius: 8px;
  --metadata-border-width: 1px;
  --metadata-container-padding: 12px 12px;
  --metadata-divider-color: hsla(37, 38%, 83%, 1);
  --metadata-divider-width: 0px;
  --metadata-input-background-active: rgba(255, 255, 255, 0.45);
  --metadata-input-font: "Inter", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  --metadata-input-shadow-active: inset 0px 0px 0px 1px hsla(37, 38%, 83%, 1),0px 0px 0px 1px hsla(37, 38%, 83%, 1);
  --metadata-input-shadow-hover: none;
  --metadata-input-text-color: hsla(36, 32%, 30%, 1);
  --metadata-key-input-color: hsla(35, 28%, 40%, 1);
  --metadata-key-input-color-active: hsla(36, 32%, 30%, 1);
  --metadata-label-background-active: rgba(255, 255, 255, 0.45);
  --metadata-label-font: "Inter", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  --metadata-label-text-color: hsla(35, 28%, 40%, 1);
  --metadata-label-text-color-hover: hsla(35, 28%, 40%, 1);
  --metadata-properties-title-color: hsla(34, 37%, 70%, 1);
  --metadata-properties-title-color-collapsed: hsla(34, 37%, 70%, 1);
  --metadata-properties-title-color-hover: hsla(34, 29%, 60%, 1);
  --metadata-property-background-active: rgba(255, 255, 255, 0.5);
  --metadata-property-box-shadow-focus: 0 0 0 2px color-mix(in hsl, hsla(34, 37%, 70%, 1) 60%, hsla(37, 38%, 83%, 1));
  --metadata-property-box-shadow-hover: 0 0 0 1px color-mix(in hsl, hsla(34, 37%, 70%, 1) 60%, hsla(37, 38%, 83%, 1));
  --metadata-property-radius: 7px;
  --metadata-tab-background: hsla(34, 34%, 90%, 1);
  --modal-background: hsla(35, 36%, 96%, 1);
  --modal-border-color: color-mix(in hsl, hsla(34, 37%, 70%, 1) 60%, hsla(37, 38%, 83%, 1));
  --modal-close-button-size: 20px;
  --modal-radius: 16px;
  --monospace-font-feature: "calt" 1,"ss01" 1,"ss02" 1,"ss03" 1,"ss05" 1,"ss19" 1,"zero" 1;
  --nav-collapse-icon-color: hsla(34, 37%, 70%, 1);
  --nav-collapse-icon-color-collapsed: hsla(34, 29%, 60%, 1);
  --nav-file-padding-active: 4px 8px 6px 24px;
  ...
  --nav-file-tag-bg: transparent;
  --nav-file-tag-color: hsla(31, 23%, 50%, 1);
  --nav-folder-1-bg-color: color-mix(in srgb, hsla(350, 84%, 63%, 0.2) 60%, transparent);
  --nav-folder-1-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(350, 84%, 63%, 0.2) 60%, transparent) 70%, transparent);
  --nav-folder-1-collapse-color: color-mix(in srgb, hsla(4, 56%, 48%, 1) 50%, transparent);
  --nav-folder-1-color: hsla(4, 56%, 48%, 1);
  --nav-folder-1-indent-color: color-mix(in srgb, hsla(4, 56%, 48%, 1) 25%, transparent);
  --nav-folder-10-bg-color: color-mix(in srgb, hsla(74, 69%, 44%, 0.2) 60%, transparent);
  --nav-folder-10-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(74, 69%, 44%, 0.2) 60%, transparent) 70%, transparent);
  --nav-folder-10-collapse-color: color-mix(in srgb, hsla(153, 65%, 29%, 1) 50%, transparent);
  --nav-folder-10-color: hsla(153, 65%, 29%, 1);
  --nav-folder-10-indent-color: color-mix(in srgb, hsla(153, 65%, 29%, 1) 25%, transparent);
  --nav-folder-11-bg-color: color-mix(in srgb, hsla(186, 64%, 46%, 0.2) 60%, transparent);
  --nav-folder-11-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(186, 64%, 46%, 0.2) 60%, transparent) 70%, transparent);
  --nav-folder-11-collapse-color: color-mix(in srgb, hsla(200, 64%, 37%, 1) 50%, transparent);
  --nav-folder-11-color: hsla(200, 64%, 37%, 1);
  --nav-folder-11-indent-color: color-mix(in srgb, hsla(200, 64%, 37%, 1) 25%, transparent);
  --nav-folder-12-bg-color: color-mix(in srgb, hsla(236, 100%, 72%, 0.2) 60%, transparent);
  --nav-folder-12-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(236, 100%, 72%, 0.2) 60%, transparent) 70%, transparent);
  --nav-folder-12-collapse-color: color-mix(in srgb, hsla(275, 37%, 43%, 1) 50%, transparent);
  --nav-folder-12-color: hsla(275, 37%, 43%, 1);
  --nav-folder-12-indent-color: color-mix(in srgb, hsla(275, 37%, 43%, 1) 25%, transparent);
  --nav-folder-2-bg-color: color-mix(in srgb, hsla(27, 100%, 50%, 0.2) 60%, transparent);
  --nav-folder-2-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(27, 100%, 50%, 0.2) 60%, transparent) 70%, transparent);
  --nav-folder-2-collapse-color: color-mix(in srgb, hsla(18, 69%, 50%, 1) 50%, transparent);
  --nav-folder-2-color: hsla(18, 69%, 50%, 1);
  --nav-folder-2-indent-color: color-mix(in srgb, hsla(18, 69%, 50%, 1) 25%, transparent);
  --nav-folder-3-bg-color: color-mix(in srgb, hsla(44, 100%, 50%, 0.2) 60%, transparent);
  --nav-folder-3-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(44, 100%, 50%, 0.2) 60%, transparent) 70%, transparent);
  --nav-folder-3-collapse-color: color-mix(in srgb, hsla(40, 98%, 36%, 1) 50%, transparent);
  --nav-folder-3-color: hsla(40, 98%, 36%, 1);
  --nav-folder-3-indent-color: color-mix(in srgb, hsla(40, 98%, 36%, 1) 25%, transparent);
  --nav-folder-4-bg-color: color-mix(in srgb, hsla(74, 69%, 44%, 0.2) 60%, transparent);
  --nav-folder-4-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(74, 69%, 44%, 0.2) 60%, transparent) 70%, transparent);
  --nav-folder-4-collapse-color: color-mix(in srgb, hsla(153, 65%, 29%, 1) 50%, transparent);
  --nav-folder-4-color: hsla(153, 65%, 29%, 1);
  --nav-folder-4-indent-color: color-mix(in srgb, hsla(153, 65%, 29%, 1) 25%, transparent);
  --nav-folder-5-bg-color: color-mix(in srgb, hsla(186, 64%, 46%, 0.2) 60%, transparent);
  --nav-folder-5-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(186, 64%, 46%, 0.2) 60%, transparent) 70%, transparent);
  --nav-folder-5-collapse-color: color-mix(in srgb, hsla(200, 64%, 37%, 1) 50%, transparent);
  --nav-folder-5-color: hsla(200, 64%, 37%, 1);
  --nav-folder-5-indent-color: color-mix(in srgb, hsla(200, 64%, 37%, 1) 25%, transparent);
  --nav-folder-6-bg-color: color-mix(in srgb, hsla(236, 100%, 72%, 0.2) 60%, transparent);
  --nav-folder-6-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(236, 100%, 72%, 0.2) 60%, transparent) 70%, transparent);
  --nav-folder-6-collapse-color: color-mix(in srgb, hsla(275, 37%, 43%, 1) 50%, transparent);
  --nav-folder-6-color: hsla(275, 37%, 43%, 1);
  --nav-folder-6-indent-color: color-mix(in srgb, hsla(275, 37%, 43%, 1) 25%, transparent);
  --nav-folder-7-bg-color: color-mix(in srgb, hsla(350, 84%, 63%, 0.2) 60%, transparent);
  --nav-folder-7-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(350, 84%, 63%, 0.2) 60%, transparent) 70%, transparent);
  --nav-folder-7-collapse-color: color-mix(in srgb, hsla(4, 56%, 48%, 1) 50%, transparent);
  --nav-folder-7-color: hsla(4, 56%, 48%, 1);
  --nav-folder-7-indent-color: color-mix(in srgb, hsla(4, 56%, 48%, 1) 25%, transparent);
  --nav-folder-8-bg-color: color-mix(in srgb, hsla(27, 100%, 50%, 0.2) 60%, transparent);
  --nav-folder-8-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(27, 100%, 50%, 0.2) 60%, transparent) 70%, transparent);
  --nav-folder-8-collapse-color: color-mix(in srgb, hsla(18, 69%, 50%, 1) 50%, transparent);
  --nav-folder-8-color: hsla(18, 69%, 50%, 1);
  --nav-folder-8-indent-color: color-mix(in srgb, hsla(18, 69%, 50%, 1) 25%, transparent);
  --nav-folder-9-bg-color: color-mix(in srgb, hsla(44, 100%, 50%, 0.2) 60%, transparent);
  --nav-folder-9-bg-color-hover: color-mix(in srgb, color-mix(in srgb, hsla(44, 100%, 50%, 0.2) 60%, transparent) 70%, transparent);
  --nav-folder-9-collapse-color: color-mix(in srgb, hsla(40, 98%, 36%, 1) 50%, transparent);
  --nav-folder-9-color: hsla(40, 98%, 36%, 1);
  --nav-folder-9-indent-color: color-mix(in srgb, hsla(40, 98%, 36%, 1) 25%, transparent);
  --nav-folder-bg-color: transparent;
  --nav-folder-bg-color-hover: rgba(255, 255, 255, 0.25);
  --nav-folder-collapse-color: hsla(34, 37%, 70%, 1);
  --nav-folder-color: hsla(34, 30%, 37%, 1);
  --nav-heading-color: hsla(35, 28%, 40%, 1);
  --nav-heading-color-collapsed: hsla(35, 28%, 40%, 1);
  --nav-heading-color-collapsed-hover: hsla(35, 28%, 40%, 1);
  --nav-heading-color-hover: hsla(35, 28%, 40%, 1);
  --nav-heading-weight: 550;
  --nav-heading-weight-hover: 550;
  --nav-indentation-guide-color: hsla(37, 38%, 83%, 1);
  ...
  --nav-item-color: hsla(34, 30%, 37%, 1);
  --nav-item-color-active: hsla(34, 30%, 37%, 1);
  --nav-item-color-highlighted: hsl( 28, 30.59%, 59.5% );
  --nav-item-color-hover: hsla(34, 30%, 37%, 1);
  --nav-item-color-selected: hsla(35, 36%, 96%, 1);
  --nav-item-padding: 5px 8px 5px 24px;
  --nav-item-parent-padding: 5px 8px 5px 24px;
  --nav-item-radius: 6px;
  --nav-item-shadow-active: inset 0px 0px 0px 1px rgba(0, 0, 0, 0.06);
  --nav-item-white-space: nowrap;
  --nav-tag-color: hsla(34, 29%, 60%, 1);
  --nav-tag-color-active: hsla(35, 28%, 40%, 1);
  --nav-tag-color-hover: hsla(35, 28%, 40%, 1);
  --nav-tag-weight: 650;
  --new-tab-btn-radius: 2em;
  --non-alternating-color: hsla(34, 37%, 70%, 1);
  --non-alternating-color-hover-active: hsla(37, 38%, 83%, 1);
  --normal-highlight-bg: hsla(44, 100%, 50%, 0.2);
  --normal-highlight-color: hsla(31, 45%, 24%, 1);
  --note-chbx-color: hsla(8, 51%, 53%, 1);
  --notice-color: hsla(36, 38%, 98%, 1);
  ...
  --pdf-background: hsla(35, 36%, 96%, 1);
  --pdf-page-background: hsla(35, 36%, 96%, 1);
  --pdf-sidebar-background: hsla(35, 36%, 96%, 1);
  --pill-background: rgba(255, 255, 255, 0.4);
  --pill-background-hover: rgba(255, 255, 255, 0.4);
  --pill-border-color: color-mix(in srgb, hsla(37, 38%, 83%, 1) 50%, transparent);
  --pill-border-color-hover: color-mix(in srgb, color-mix(in hsl, hsla(34, 37%, 70%, 1) 60%, hsla(37, 38%, 83%, 1)) 50%, transparent);
  --pill-color: hsla(36, 32%, 30%, 1);
  --pill-color-hover: hsla(33, 54%, 17%, 1);
  --pill-color-remove: hsla(34, 37%, 70%, 1);
  --pill-color-remove-hover: hsla(34, 37%, 70%, 1);
  --pill-tag-bg-1: hsla(44, 100%, 50%, 0.2);
  --pill-tag-bg-2: hsla(350, 84%, 63%, 0.2);
  --pill-tag-bg-3: hsla(186, 64%, 46%, 0.2);
  --pill-tag-color-1: hsla(40, 98%, 36%, 1);
  --pill-tag-color-2: hsla(4, 72%, 35%, 1);
  --pill-tag-color-3: hsla(205, 85%, 25%, 1);
  ...
  --progress-background: hsla(34, 34%, 90%, 1);
  --progress-bar-outline: rgba(0, 0, 0, 0.1);
  --progress-border-width: 1px;
  --progress-color-1: hsla(4, 72%, 55%, 1);
  --progress-color-2: hsla(21, 81%, 59%, 1);
  --progress-color-3: hsla(43, 83%, 57%, 1);
  --progress-color-4: hsla(149, 50%, 39%, 1);
  --progress-color-5: linear-gradient(45deg, hsla(4, 59%, 64%, 1), hsla(43, 71%, 67%, 1), hsla(197, 39%, 56%, 1));
  --progress-gradient-1: hsla(4, 59%, 64%, 1);
  --progress-gradient-2: hsla(43, 71%, 67%, 1);
  --progress-gradient-3: hsla(197, 39%, 56%, 1);
  --progress-height: 8px;
  --progress-value-outline: rgba(0, 0, 0, 0.18);
  --progress-value-radius: 8px;
  --progress-width: 220px;
  --prompt-background: hsla(35, 36%, 96%, 1);
  --prompt-border-color: color-mix(in hsl, hsla(34, 37%, 70%, 1) 60%, hsla(37, 38%, 83%, 1));
  --prompt-input-background: hsla(35, 36%, 96%, 1);
  --prompt-instructions-background: color-mix(in hsl, hsla(35, 36%, 96%, 1) 60%, hsla(34, 34%, 90%, 1));
  --prompt-results-background: hsla(35, 36%, 96%, 1);
  --prompt-separator-border: 1px solid hsla(34, 34%, 90%, 1);
  --prompt-suggestion-background-selected: rgba(255, 255, 255, 0.35);
  --prompt-suggestion-color: hsla(31, 23%, 50%, 1);
  --prompt-suggestion-color-selected: hsla(31, 45%, 24%, 1);
  --prompt-suggestion-highlight-color: color-mix(in srgb, hsla(31, 23%, 50%, 1) 70%, black);
  --prompt-suggestion-highlight-color-selected: hsla(31, 45%, 24%, 1);
  ...
  --quote-chbx-icon-color: white;
  --radius-xs: 2px;
  --raised-background: color-mix(in srgb, hsla(35, 36%, 96%, 1) 65%, transparent) linear-gradient(hsla(35, 36%, 96%, 1), color-mix(in srgb, hsla(35, 36%, 96%, 1) 65%, transparent));
  --resched-chbx-color: hsla(178, 18%, 59%, 1);
  --ribbon-background: hsla(34, 34%, 90%, 1);
  --ribbon-background-collapsed: hsla(35, 36%, 96%, 1);
  --ribbon-border-width: 1px;
  --ribbon-icon: 15px;
  --ribbon-icon-spacing: 4px;
  --ribbon-margin-bottom: 10px;
  --ribbon-radius: 12px;
  --ribbon-slideout-background: hsla(35, 37%, 92%, 1);
  --ribbon-slideout-shadow: 8px 7px 21px -4px rgba(0, 0, 0, 0.12),0px 5px 5px -5px rgba(0, 0, 0, 0.15);
  --sched-chbx-color: hsla(32, 10%, 68%, 1);
  --scrollbar-active-thumb-bg: color-mix(in hsl, hsla(34, 37%, 70%, 1) 60%, hsla(37, 38%, 83%, 1));
  --scrollbar-bg: transparent;
  --scrollbar-thumb-bg: hsla(37, 38%, 83%, 1);
  --search-clear-button-color: hsla(34, 29%, 60%, 1);
  --search-clear-button-color-hover: hsla(4, 72%, 55%, 1);
  --search-clear-button-size: 12px;
  --search-icon-color: hsla(34, 29%, 60%, 1);
  --search-icon-size: 14px;
  --search-result-background: hsla(35, 37%, 92%, 1);
  --search-result-background-hover: color-mix(in srgb, hsla(36, 38%, 98%, 1) 50%, hsla(35, 36%, 96%, 1));
  --search-result-dest-file-bg: hsla(35, 36%, 96%, 1);
  --search-result-dest-file-bg-hover: color-mix(in srgb, hsla(35, 36%, 96%, 1) 50%, hsla(36, 38%, 98%, 1));
  --search-result-dest-file-color: hsla(35, 28%, 40%, 1);
  --search-result-dest-file-icon-color: hsla(34, 37%, 70%, 1);
  ...
  --secondary: var(--text-accent, hsl(31, 23%, 50%));
  --setting-group-heading-color: hsla(31, 45%, 24%, 1);
  --setting-group-heading-weight: 650;
  --setting-items-background: hsla(35, 37%, 92%, 1);
  --setting-items-border-color: hsla(37, 38%, 83%, 1);
  --settings-nav-group-title-color: hsla(34, 37%, 70%, 1);
  --settings-nav-item-active-color: hsla(36, 38%, 98%, 1);
  --settings-nav-item-bg-hover: transparent;
  --settings-nav-item-padding: 7px 12px 7px 12px;
  --settings-nav-item-padding-active: 6px 12px 8px 20px;
  --settings-nav-item-padding-hover: 7px 12px 7px 20px;
  --settings-nav-item-radius: 7px;
  --settings-nav-item-text-color: hsla(34, 30%, 37%, 1);
  --settings-nav-item-text-color-active: hsla(34, 29%, 60%, 1);
  --settings-nav-item-text-color-hover: hsla(31, 45%, 24%, 1);
  ...
  --shiki-active-tab-border-color: hsla(35, 28%, 40%, 1);
  --shiki-code-background: hsla(35, 37%, 92%, 1);
  --shiki-code-block-border-radius: 8px;
  --shiki-code-comment: hsla(34, 29%, 60%, 1);
  --shiki-code-function: hsla(146, 37%, 49%, 1);
  --shiki-code-important: hsla(30, 66%, 52%, 1);
  --shiki-code-keyword: hsla(351, 44%, 61%, 1);
  --shiki-code-normal: hsla(35, 28%, 40%, 1);
  --shiki-code-property: hsla(178, 39%, 49%, 1);
  --shiki-code-punctuation: hsla(35, 28%, 40%, 1);
  --shiki-code-string: hsla(42, 89%, 46%, 1);
  --shiki-code-value: hsla(249, 39%, 60%, 1);
  --shiki-gutter-border-color: hsla(37, 38%, 83%, 1);
  --shiki-gutter-text-color: hsla(34, 29%, 60%, 1);
  --shiki-gutter-text-color-highlight: hsla(35, 28%, 40%, 1);
  --shiki-highlight-green: rgba(87, 185, 132, 0.5);
  --shiki-highlight-green-background: rgba(87, 185, 132, 0.1);
  --shiki-highlight-neutral: hsla(35, 28%, 40%, 1);
  --shiki-highlight-red: rgba(223, 90, 90, 0.5);
  --shiki-highlight-red-background: rgba(223, 90, 90, 0.1);
  --shiki-terminal-dots-color: hsla(34, 29%, 60%, 1);
  --shiki-tooltip-background: hsla(35, 28%, 40%, 1);
  --sidebar-nav-icon: 15px;
  --sidebar-tab-icon: 15px;
  --slider-thumb-bg: hsla(36, 38%, 98%, 1);
  --slider-thumb-border-color: color-mix(in hsl, hsla(34, 37%, 70%, 1) 60%, hsla(37, 38%, 83%, 1));
  --slider-thumb-border-width: 0px;
  ...
  --slider-track-background: hsla(37, 38%, 83%, 1);
  --slider-track-height: 5px;
  ...
  --star-chbx-icon-color: white;
  --status-bar-background: hsla(34, 34%, 90%, 1);
  --status-bar-border-color: hsla(37, 38%, 83%, 1);
  --status-bar-floating-bg: hsla(35, 37%, 92%, 1);
  --status-bar-floating-offset: 4px;
  --status-bar-floating-opacity: 0.5;
  --status-bar-floating-opacity-hover: 1;
  ...
  --status-bar-item-bg-hover: transparent;
  --status-bar-item-clickable-bg-active: transparent;
  --status-bar-item-clickable-color-active: hsla(34, 37%, 70%, 1);
  --status-bar-item-color: hsla(34, 29%, 60%, 1);
  --status-bar-item-color-hover: hsla(35, 28%, 40%, 1);
  --status-bar-text-color: hsla(35, 28%, 40%, 1);
  --strikethrough-color: hsla(34, 29%, 60%, 1);
  --strikethrough-highlight-bg: hsla(44, 100%, 50%, 0.2);
  --strikethrough-highlight-color: hsla(34, 29%, 60%, 1);
  --style-settings-container-bg: color-mix(in srgb, hsla(35, 37%, 92%, 1) 50%, transparent);
  --suggestion-background: hsla(35, 36%, 96%, 1);
  --swatch-shadow: inset 0px 0px 0px 1px rgba(0, 0, 0, 0.2);
  --sync-avatar-color-1: hsla(0, 58%, 53%, 1);
  --sync-avatar-color-2: hsla(30, 66%, 52%, 1);
  --sync-avatar-color-3: hsla(42, 89%, 46%, 1);
  --sync-avatar-color-4: hsla(146, 37%, 49%, 1);
  --sync-avatar-color-5: hsla(178, 39%, 49%, 1);
  --sync-avatar-color-6: hsla(206, 57%, 44%, 1);
  --sync-avatar-color-7: hsla(249, 39%, 60%, 1);
  --sync-avatar-color-8: hsla(351, 44%, 61%, 1);
  --sync-icon-success: hsla(149, 50%, 39%, 1);
  --sync-icon-success-active: hsla(34, 37%, 70%, 1);
  --sync-icon-success-hover: hsla(148, 48%, 47%, 1);
  --sync-icon-working: hsla(26, 70%, 63%, 1);
  --sync-icon-working-active: hsla(34, 37%, 70%, 1);
  --sync-icon-working-hover: hsla(21, 81%, 59%, 1);
  --tab-active-bg: hsla(35, 36%, 96%, 1);
  ...
  --tab-background-active: hsla(35, 36%, 96%, 1);
  --tab-bg: transparent;
  --tab-container-background: hsla(34, 34%, 90%, 1);
  --tab-curves-display: none;
  --tab-divider-color: color-mix(in hsl, hsla(34, 37%, 70%, 1) 60%, hsla(37, 38%, 83%, 1));
  --tab-header-container-border-bottom: none;
  --tab-header-container-inner-margin: default;
  --tab-header-container-inner-padding: 2px;
  --tab-header-container-padding: 0 12px 4px 12px;
  ...
  --tab-status-radius: 4px;
  --tab-switcher-background: hsla(34, 34%, 90%, 1);
  --tab-switcher-menubar-background: linear-gradient(to top, hsla(34, 34%, 90%, 1), transparent);
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(31, 23%, 50%);
  --tab-text-color: hsla(34, 29%, 60%, 1);
  --tab-text-color-active: hsla(35, 28%, 40%, 1);
  --tab-text-color-focused: hsla(35, 28%, 40%, 1);
  --tab-text-color-focused-active: hsla(35, 28%, 40%, 1);
  --tab-text-color-focused-active-current: hsla(31, 45%, 24%, 1);
  --tab-text-color-focused-highlighted: hsl(31, 23%, 50%);
  --tab-z-index: 1;
  --table-add-button-border-color: hsla(37, 38%, 83%, 1);
  --table-background: hsla(36, 38%, 98%, 1);
  --table-border-color: hsla(37, 38%, 83%, 1);
  --table-column-alt-background: hsla(35, 37%, 92%, 1);
  --table-drag-handle-background-active: hsl( 30, 23.23%, 53.75% );
  --table-drag-handle-color: hsla(34, 29%, 60%, 1);
  --table-drag-handle-color-active: hsla(36, 38%, 98%, 1);
  --table-header-background: hsla(35, 37%, 92%, 1);
  --table-header-background-hover: hsla(35, 37%, 92%, 1);
  --table-header-border-color: hsla(37, 38%, 83%, 1);
  --table-header-color: hsla(31, 45%, 24%, 1);
  --table-header-weight: 650;
  --table-row-alt-background: hsla(36, 38%, 98%, 1);
  --table-row-alt-background-hover: hsla(36, 38%, 98%, 1);
  --table-row-background-hover: hsla(36, 38%, 98%, 1);
  --table-selection: hsla(31,23%,50%, 0.1);
  --table-selection-border-color: hsl( 30, 23.23%, 53.75% );
  ...
  --tag-border-width: 1px;
  --tag-color: hsla(200, 64%, 37%, 1);
  --tag-color-hover: hsla(202, 66%, 48%, 1);
  --tag-padding-x: 0.6em;
  --tag-padding-y: 0.15em;
  --tag-radius: 1em;
  ...
  --tertiary: var(--text-accent-hover, hsl( 28, 30.59%, 59.5% ));
  --text-accent: hsl(31, 23%, 50%);
  --text-accent-hover: hsl( 28, 30.59%, 59.5% );
  --text-error: hsla(4, 56%, 48%, 1);
  --text-faint: hsla(34, 29%, 60%, 1);
  --text-font-feature: "calt" 1,"case" 0,"ccmp" 1,"ss03" 1,"cv01" 1,"cv05" 1,"cv06" 1,"cv08" 0,"cv11" 1,"cv12" 0,"cv13" 0;
  --text-highlight-bg: hsla(44, 100%, 50%, 0.2);
  --text-highlight-bg-rgb: 248,197,46;
  --text-input-bg-active: color-mix(in hsl, hsla(35, 37%, 92%, 1) 40%, hsla(36, 38%, 98%, 1));
  --text-input-border-color: hsla(37, 38%, 83%, 1);
  --text-input-color: hsla(31, 45%, 24%, 1);
  --text-input-color-focused: hsla(31, 45%, 24%, 1);
  ...
  --text-muted: hsla(35, 28%, 40%, 1);
  --text-normal: hsla(31, 45%, 24%, 1);
  --text-on-accent: hsla(36, 38%, 98%, 1);
  --text-on-accent-inverted: hsla(33, 54%, 17%, 1);
  --text-selection: hsla(34, 37%, 70%, 0.15);
  --text-selection-theme-bg: color-mix(in srgb, hsla(34, 37%, 70%, 1) 30%, transparent);
  --text-selection-theme-text-color: color-mix(in srgb, currentColor 70%, black);
  --text-success: hsla(149, 50%, 39%, 1);
  --text-warning: hsla(18, 69%, 50%, 1);
  --textHighlight: var(--text-highlight-bg, hsla(44, 100%, 50%, 0.2));
  --titleFont: var(--font-text, "Inter", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  --titlebar-background: hsla(34, 34%, 90%, 1);
  --titlebar-background-focused: hsla(34, 34%, 90%, 1);
  --titlebar-border-color: hsla(37, 38%, 83%, 1);
  --titlebar-text-color: hsla(37, 38%, 83%, 1);
  --titlebar-text-color-focused: hsla(34, 37%, 70%, 1);
  --titlebar-text-weight: 450;
  --toggle-bg: color-mix(in hsl, hsla(37, 38%, 83%, 1) 80%, hsla(34, 37%, 70%, 1));
  --toggle-bg-enabled: hsla(149, 50%, 39%, 1);
  ...
  --toggle-thumb-color: hsla(36, 38%, 98%, 1);
  ...
  --traffic-lights-offset-x: 46px;
  --traffic-lights-offset-y: 46px;
  --underline-color: hsla(31, 45%, 24%, 1);
  --underline-decoration-color: color-mix(in srgb, currentColor 22%, transparent);
  --underline-decoration-opacity: 22%;
  --up-chbx-color: hsla(146, 37%, 49%, 1);
  --vault-name-background: hsla(35, 37%, 92%, 1);
  --vault-name-border: 1px solid hsla(37, 38%, 83%, 1);
  --vault-name-border-width: 1px;
  --vault-name-color: hsla(35, 28%, 40%, 1);
  --vault-name-color-hover: hsla(36, 32%, 30%, 1);
  --vault-profile-color: hsla(35, 28%, 40%, 1);
  --vault-profile-color-hover: hsla(35, 28%, 40%, 1);
  --vault-profile-font-weight: 650;
  --yaml-atom-color: hsla(197, 39%, 56%, 1);
  --yaml-base-color: hsla(4, 59%, 64%, 1);
  --yaml-def-meta-color: hsla(34, 37%, 70%, 1);
  --yaml-keyword-color: hsla(40, 79%, 47%, 1);
  --yaml-number-color: hsla(4, 59%, 64%, 1);
  --yaml-string-color: hsla(40, 79%, 47%, 1);
  --quartz-icon-color: currentColor;
}
