...
export const theme: ThemeData = {
  ...
  --blockquote-border-color: hsl(254, 80%, 68%) !important;
  ...
  --checkbox-color-hover: hsl(254, 80%, 64.2%) !important;
  ...
  --collapse-icon-color-collapsed: hsl(254, 80%, 64.2%) !important;
  --color-accent: hsl(254, 80%, 68%) !important;
  --color-accent-1: hsl(254, 80%, 64.2%) !important;
  --color-accent-2: hsl(254, 80%, 71.8%) !important;
  ...
  --divider-color-hover: hsl(254, 80%, 68%) !important;
  --dropdown-background: #1F1F1F !important;
  --dropdown-background-hover: #383838 !important;
  --embed-block-shadow-hover: 0 0 0 1px #1F1F1F,
	  inset 0 0 0 1px #1F1F1F !important;
  --embed-border-left: 2px solid hsl(254, 80%, 68%) !important;
  ...
  --interactive-accent-hover: hsl(254, 80%, 64.2%) !important;
  ...
  --link-external-color: hsl(254, 80%, 64.2%) !important;
  --link-external-color-hover: hsl(254, 80%, 71.8%) !important;
  ...
  --list-marker-color-collapsed: hsl(254, 80%, 64.2%) !important;
  ...
  --nav-item-color-highlighted: hsl(254, 80%, 71.8%) !important;
  ...
  --pill-color-remove-hover: hsl(254, 80%, 64.2%) !important;
  ...
  --scrollbar-active-thumb-bg: rgba(255, 255, 255 0.9) !important;
  --scrollbar-bg: rgba(255, 255, 255 0.9) !important;
  --scrollbar-radius: 10px !important;
  --scrollbar-thumb-bg: rgba(255, 255, 255 0.9) !important;
  --search-clear-button-color: #808080 !important;
  --search-icon-color: #808080 !important;
  --search-result-background: #090909 !important;
  --secondary: hsl(254, 80%, 64.2%) !important;
  ...
  --tab-text-color-focused-highlighted: hsl(254, 80%, 64.2%) !important;
  ...
  --tag-background: hsla(254,
			  80%,
			  68%, 0.1) !important;
  --tag-background-hover: hsla(254,
			  80%,
			  68%, 0.2) !important;
  ...
  --tag-border-color-hover: hsla(254,
			  80%,
			  68%, 0.15) !important;
  --tag-color: hsl(254, 80%, 64.2%) !important;
  --tag-color-hover: hsl(254, 80%, 64.2%) !important;
  --tertiary: hsl(254, 80%, 71.8%) !important;
  --text-accent: hsl(254, 80%, 64.2%) !important;
  --text-accent-hover: hsl(254, 80%, 71.8%) !important;
  ...
  --vault-name-color: #bdbdbd !important;
