...
export const theme: ThemeData = {
  ...
  --shiki-code-background: #f6f6f4 !important;
  --shiki-code-comment: #b6b5af !important;
  --shiki-gutter-text-color: #b6b5af !important;
  --shiki-terminal-dots-color: #b6b5af !important;
