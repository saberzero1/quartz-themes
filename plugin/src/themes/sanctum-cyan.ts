...
export const theme: ThemeData = {
  ...
  --collapse-icon-color-collapsed: var(--text-accent, rgb(99, 149, 156));
  --color-accent: var(--interactive, rgb(99, 149, 156));
  --color-accent-1: var(--interactive, rgb(99, 149, 156));
  --color-accent-2: var(--interactive, rgb(99, 149, 156));
  --color-accent-rgb: var(--color-accent-rgb-d, 99, 149, 156);
  --color-accent-rgb-d: 99, 149, 156;
  --color-accent-rgb-l: 99, 149, 156;
  --color-green-rgb: 102,
    153,
    97;
  --color-red-rgb: 197,
  ...
  --divider-color-hover: var(--interactive-accent, rgb(99, 149, 156));
  ...
  --embed-border-color: var(--interactive-accent, rgb(99, 149, 156));
  --embed-border-left: var(--embed-border-width) solid var(--embed-border-color, 1px solid rgb(99, 149, 156));
  ...
  --icon-color-active: var(--interactive, rgb(99, 149, 156));
  ...
  --interactive-accent: var(--color-accent, rgb(99, 149, 156));
  --interactive-accent-hover: var(--color-accent-1, rgb(99, 149, 156));
  ...
  --link-color: var(--interactive, rgb(99, 149, 156));
  --link-color-hover: var(--interactive, rgb(99, 149, 156));
  --link-external-color: var(--text-accent, rgb(99, 149, 156));
  --link-external-color-hover: var(--text-accent-hover, rgb(99, 149, 156));
  --link-external-style: normal;
  --link-style: normal;
  --link-text-transform: none;
  --link-unresolved-color: var(--text-accent, rgb(99, 149, 156));
  ...
  --list-marker-color-collapsed: var(--interactive, rgb(99, 149, 156));
  ...
  --nav-item-color-highlighted: var(--text-accent-hover, rgb(99, 149, 156));
  ...
  --pill-color-remove-hover: var(--text-accent, rgb(99, 149, 156));
  ...
  --secondary: var(--text-accent, var(--color-accent-1, rgb(99, 149, 156)));
  ...
  --tab-text-color-focused-highlighted: var(--text-accent, rgb(99, 149, 156));
  ...
  --table-drag-handle-background-active: var(--table-selection-border-color, rgb(99, 149, 156));
  ...
  --table-selection-border-color: var(--interactive-accent, rgb(99, 149, 156));
  ...
  --tag-color: var(--text-accent, rgb(99, 149, 156));
  --tag-color-hover: var(--text-accent, rgb(99, 149, 156));
  --tertiary: var(--text-accent-hover, var(--color-accent-2, rgb(99, 149, 156)));
  --text-accent: var(--color-accent-1, rgb(99, 149, 156));
  --text-accent-hover: var(--color-accent-2, rgb(99, 149, 156));
  ...
  --text-highlight-bg: var(--highlight, rgba(99, 149, 156, 0.7));
  --text-highlight-bg-active: var(--highlight, rgba(99, 149, 156, 0.7));
  ...
  --textHighlight: var(--text-highlight-bg, var(--highlight, rgba(99, 149, 156, 0.7)));
  ...
  --titlebar-text-color-highlighted: var(--text-accent-hover, rgb(99, 149, 156));
...
html[saved-theme="dark"] body .text-highlight {
  background-color: var(--text-highlight-bg, rgba(99, 149, 156, 0.7));
...
html[saved-theme="dark"] body p {
  ...
  color: var(--link-external-color, rgb(99, 149, 156));
  font-family: "??", Inter, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  outline: rgb(99, 149, 156) none 0px;
  text-decoration-color: rgb(99, 149, 156);
}

html[saved-theme="dark"] body a.internal-link, html[saved-theme="dark"] .breadcrumb-container .breadcrumb-element > a {
  color: var(--link-color, rgb(99, 149, 156));
  font-family: "??", Inter, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  outline: rgb(99, 149, 156) none 0px;
  text-decoration-color: rgb(99, 149, 156);
}
...
html[saved-theme="dark"] body a.internal-link.broken {
  color: var(--link-unresolved-color, rgb(99, 149, 156));
  font-family: "??", Inter, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  outline: rgb(99, 149, 156) none 0px;
  text-decoration: underline;
  text-decoration-color: var(--link-unresolved-decoration-color, rgb(99, 149, 156));
}`,
...
html[saved-theme="dark"] body .transclude {
  border-bottom-color: rgb(244, 244, 240);
  border-left-color: rgb(99, 149, 156);
  border-right-color: rgb(244, 244, 240);
  border-top-color: rgb(244, 244, 240);
}
...
html[saved-theme="dark"] body a.internal-link.tag-link, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  ...
  --pill-background: var(--tag-background, rgba(99, 149, 156, 0.15));
  --pill-background-hover: var(--tag-background-hover, rgba(99, 149, 156, 0.25));
  --pill-border-color: var(--tag-border-color, rgba(99, 149, 156, 0.15));
  --pill-border-color-hover: var(--tag-border-color-hover, rgba(99, 149, 156, 0.25));
  --pill-color: var(--tag-color, rgb(99, 149, 156));
  --pill-color-hover: var(--tag-color-hover, rgb(99, 149, 156));
  --pill-color-remove: var(--tag-color, rgb(99, 149, 156));
  --pill-color-remove-hover: var(--tag-color-hover, rgb(99, 149, 156));
  background-color: var(--pill-background, rgba(99, 149, 156, 0.15));
  border-bottom-color: rgba(99, 149, 156, 0.15);
  border-left-color: rgba(99, 149, 156, 0.15);
  border-right-color: rgba(99, 149, 156, 0.15);
  border-top-color: rgba(99, 149, 156, 0.15);
  font-family: "??", Inter, sans-serif, "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
}
...
html[saved-theme="dark"] body .note-properties-tags {
  ...
  --pill-color-remove-hover: var(--tag-color-hover, rgb(99, 149, 156));
  background-color: var(--pill-background, rgba(99, 149, 156, 0.15));
  color: var(--pill-color, rgb(99, 149, 156));
}
...
html[saved-theme="dark"] body ul.tags > li {
  background-color: var(--tag-background, rgba(99, 149, 156, 0.15));
  border-bottom-color: rgba(99, 149, 156, 0.15);
  border-left-color: rgba(99, 149, 156, 0.15);
  border-right-color: rgba(99, 149, 156, 0.15);
  border-top-color: rgba(99, 149, 156, 0.15);
  color: var(--tag-color, rgb(99, 149, 156));
}`,
  },
  light: {
    base: `:root:root {
  ...
  --color-accent-1: var(--interactive, rgb(99, 149, 156));
  --color-accent-2: var(--interactive, rgb(99, 149, 156));
  --color-accent-rgb: var(--color-accent-rgb-l, 99, 149, 156);
  --color-accent-rgb-d: 99, 149, 156;
  --color-accent-rgb-l: 99, 149, 156;
  --color-green-rgb: 102,
    153,
  ...
  --input-shadow-hover: inset 0 0 0 1px rgba(0, 0, 0, 0.17),
    ...
    0.1px 9.4px 8.5px -4px hsl(var(--shadow-color) / 0.19);
  --interactive: rgb(var(--color-accent-rgb));
  --interactive-accent: var(--color-accent-1, rgb(99, 149, 156));
  --interactive-accent-hover: var(--color-accent-2, rgb(99, 149, 156));
  --interactive-accent-hsl: var(--color-accent-hsl, 24.4, 90.8%, 61.8%);
  --lavender: var(--lavender-50, hsl(268deg, 57%, 66%));
  --lavender-10: hsl(264deg, 63%, 97%);
  --lavender-100: hsl(266deg, 100%, 15%);
  ...
  --secondary: var(--text-accent, var(--color-accent, rgb(99, 149, 156)));
  ...
  --tag-color-hover: var(--text-accent, rgb(99, 149, 156));
  --tertiary: var(--text-accent-hover, var(--color-accent-2, rgb(99, 149, 156)));
  --text-accent: var(--color-accent, rgb(99, 149, 156));
  --text-accent-hover: var(--color-accent-2, rgb(99, 149, 156));
