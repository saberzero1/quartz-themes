...
export const theme: ThemeData = {
  ...
  --background-modifier-active-hover: rgba(99, 149, 156, 0.15);
  ...
  --bases-table-cell-shadow-focus: 0 0 0 2px rgb(99, 149, 156);
  ...
  --collapse-icon-color-collapsed: rgb(99, 149, 156);
  --color-accent: rgb(99, 149, 156);
  --color-accent-1: rgb(99, 149, 156);
  --color-accent-2: rgb(99, 149, 156);
  ...
  --divider-color-hover: rgb(99, 149, 156);
  ...
  --embed-border-color: rgb(99, 149, 156);
  --embed-border-left: 1px solid rgb(99, 149, 156);
  --embed-border-right: none;
  --embed-border-start: 2px solid rgb(99, 149, 156);
  ...
  --graph-node-focused: rgb(99, 149, 156);
  ...
  --highlight: rgba(99, 149, 156, 0.7);
  --hr-color: rgb(58, 56, 56);
  --hr-thickness: 1.5px;
  --icon-color: rgb(112, 110, 109);
  --icon-color-active: rgb(99, 149, 156);
  ...
  --interactive: rgb(99, 149, 156);
  --interactive-accent: rgb(99, 149, 156);
  --interactive-accent-hover: rgb(99, 149, 156);
  ...
  --link-color: rgb(99, 149, 156);
  --link-color-hover: rgb(99, 149, 156);
  --link-external-color: rgb(99, 149, 156);
  --link-external-color-hover: rgb(99, 149, 156);
  --link-external-style: normal;
  --link-style: normal;
  --link-text-transform: none;
  --link-unresolved-color: rgb(99, 149, 156);
  ...
  --list-marker-color-collapsed: rgb(99, 149, 156);
  ...
  --nav-item-color-highlighted: rgb(99, 149, 156);
  ...
  --pill-color-remove-hover: rgb(99, 149, 156);
  ...
  --secondary: var(--text-accent, rgb(99, 149, 156));
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px rgb(99, 149, 156);
  ...
  --tab-text-color-focused-highlighted: rgb(99, 149, 156);
  --table-add-button-border-color: rgb(58, 56, 56);
  --table-border-color: rgb(58, 56, 56);
  --table-drag-handle-background-active: rgb(99, 149, 156);
  ...
  --table-hover-highlight-color: rgba(99, 149, 156, 0.15);
  --table-selection: hsla(24.4, 90.8%, 61.8%, 0.1);
  --table-selection-border-color: rgb(99, 149, 156);
  --table-sticky-height: 600px;
  --tag-background: rgba(99, 149, 156, 0.15);
  --tag-background-hover: rgba(99, 149, 156, 0.25);
  --tag-border-color: rgba(99, 149, 156, 0.15);
  --tag-border-color-hover: rgba(99, 149, 156, 0.25);
  --tag-color: rgb(99, 149, 156);
  --tag-color-hover: rgb(99, 149, 156);
  --tertiary: var(--text-accent-hover, rgb(99, 149, 156));
  --text-accent: rgb(99, 149, 156);
  --text-accent-hover: rgb(99, 149, 156);
  --text-code: hsl(348.5, 79.3%, 63.9%);
  --text-error: hsl(9.6, 66.2%, 46.5%);
  --text-faint: rgb(112, 110, 109);
  --text-highlight-bg: rgba(99, 149, 156, 0.7);
  --text-highlight-bg-active: rgba(99, 149, 156, 0.7);
  ...
  --text-selection: rgba(99, 149, 156, 0.5);
  --text-success: hsl(114.6, 22.4%, 49%);
  --textHighlight: var(--text-highlight-bg, rgba(99, 149, 156, 0.7));
  ...
  --titlebar-text-color-highlighted: rgb(99, 149, 156);
