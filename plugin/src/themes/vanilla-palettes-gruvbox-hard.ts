...
export const theme: ThemeData = {
  ...
  --background-modifier-border: #3c3836 !important;
  --background-modifier-border-focus: #504945 !important;
  --background-modifier-border-hover: #504945 !important;
  ...
  --bases-cards-shadow: 0 0 0 1px #3c3836 !important;
  --bases-cards-shadow-hover: 0 0 0 1px #504945 !important;
  --bases-embed-border-color: #3c3836 !important;
  --bases-group-heading-property-color: #ebdbb2 !important;
  --bases-table-border-color: #3c3836 !important;
  --bases-table-cell-background-active: #1d2021 !important;
  --bases-table-cell-background-selected: #665c54 !important;
  --bases-table-cell-shadow-active: 0 0 0 2px #504945 !important;
  ...
  --border-color-primary: #3c3836 !important;
  --border-color-secondary: #504945 !important;
  ...
  --canvas-card-label-color: #504945 !important;
  --canvas-color: 152, 151, 26 !important;
  --caret-color: #ebdbb2 !important;
  --checkbox-border-color: #504945 !important;
  ...
  --collapse-icon-color: #504945 !important;
  ...
  --divider-color: #3c3836 !important;
  --divider-color-hover: hsl(60, 71%, 35%) !important;
  --dropdown-background: #282828 !important;
  --dropdown-background-hover: #3c3836 !important;
  --embed-block-shadow-hover: 0 0 0 1px #3c3836, inset 0 0 0 1px #3c3836 !important;
  ...
  --footnote-divider-color: #3c3836 !important;
  --footnote-id-color: #ebdbb2 !important;
  --footnote-id-color-no-occurrences: #504945 !important;
  --footnote-input-background-active: #665c54 !important;
  --graph-line: #504945 !important;
  ...
  --graph-node-unresolved: #3c3836 !important;
  ...
  --heading-formatting: #504945 !important;
  --highlight: hsl(60, 71%, 35%) !important;
  --hr-color: #3c3836 !important;
  ...
  --indentation-guide-color: #3c3836 !important;
  --indentation-guide-color-active: #504945 !important;
  --inline-title-color: #ebdbb2 !important;
  --input-date-separator: #504945 !important;
  --input-placeholder-color: #504945 !important;
  --interactive-accent: hsl(60, 71%, 35%) !important;
  --interactive-accent-hover: hsl(57, 72.42%, 40.25%) !important;
  --interactive-accent-hsl: 60, 71%, 35% !important;
  --interactive-hover: #3c3836 !important;
  ...
  --menu-border-color: #504945 !important;
  --metadata-border-color: #3c3836 !important;
  --metadata-divider-color: #3c3836 !important;
  ...
  --metadata-property-box-shadow-focus: 0 0 0 2px #504945 !important;
  --metadata-property-box-shadow-hover: 0 0 0 1px #504945 !important;
  --modal-background: #282828 !important;
  --modal-border-color: #3c3836 !important;
  --nav-collapse-icon-color: #504945 !important;
  --nav-collapse-icon-color-collapsed: #504945 !important;
  --nav-heading-color: #ebdbb2 !important;
  --nav-heading-color-collapsed: #504945 !important;
  --nav-heading-color-collapsed-hover: #ebdbb2 !important;
  --nav-heading-color-hover: #ebdbb2 !important;
  --nav-indentation-guide-color: #504945 !important;
  ...
  --nav-tag-color: #504945 !important;
  ...
  --pdf-shadow: 0 0 0 1px #3c3836 !important;
  --pdf-sidebar-background: #1d2021 !important;
  --pdf-thumbnail-shadow: 0 0 0 1px #3c3836 !important;
  --pill-border-color: #3c3836 !important;
  --pill-border-color-hover: #504945 !important;
  --pill-color: #ebdbb2 !important;
  --pill-color-hover: #ebdbb2 !important;
  --pill-color-remove: #504945 !important;
  --pill-color-remove-hover: hsl(60, 71%, 35%) !important;
  --prompt-background: #1d2021 !important;
  --prompt-border-color: #3c3836 !important;
  ...
  --tab-outline-color: #3c3836 !important;
  ...
  --tab-text-color: #3c3836 !important;
  ...
  --table-add-button-border-color: #3c3836 !important;
  --table-border-color: #3c3836 !important;
  ...
  --text-color-muted-dark: #3c3836 !important;
  --text-color-muted-light: #504945 !important;
  --text-error: #cc241d !important;
  --text-faint: #504945 !important;
  --text-highlight-bg: hsl(60, 71%, 35%) !important;
  --text-muted: #ebdbb2 !important;
  --text-normal: #ebdbb2 !important;
  --text-on-accent-inverted: #1d2021 !important;
  ...
  --titlebar-background-focused: #3c3836 !important;
  --titlebar-border-color: #3c3836 !important;
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --accent-s: 71% !important;
  --background-modifier-active-hover: red !important;
  --background-modifier-border: #ebdbb2 !important;
  --background-modifier-border-focus: #d5c4a1 !important;
  --background-modifier-border-hover: #d5c4a1 !important;
  --background-modifier-error: #cc241d !important;
  --background-modifier-error-hover: #cc241d !important;
  ...
  --background-secondary: #fbf1c7 !important;
  --bases-cards-background: #f9f5d7 !important;
  --bases-cards-shadow: 0 0 0 1px #ebdbb2 !important;
  --bases-cards-shadow-hover: 0 0 0 1px #d5c4a1 !important;
  --bases-embed-border-color: #ebdbb2 !important;
  --bases-group-heading-property-color: #3c3836 !important;
  --bases-table-border-color: #ebdbb2 !important;
  --bases-table-cell-background-active: #f9f5d7 !important;
  --bases-table-cell-background-selected: #bdae93 !important;
  --bases-table-cell-shadow-active: 0 0 0 2px #d5c4a1 !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(60, 71%, 35%) !important;
  ...
  --border-color-primary: #ebdbb2 !important;
  --border-color-secondary: #d5c4a1 !important;
  --bright-aqua: #8ec07c !important;
  --bright-blue: #83a598 !important;
  --bright-green: #b8bb26 !important;
  --bright-orange: #fe8019 !important;
  ...
  --code-border-color: #ebdbb2 !important;
  ...
  --divider-color: #ebdbb2 !important;
  --divider-color-hover: hsl(60, 71%, 35%) !important;
  --dropdown-background: #fbf1c7 !important;
  --dropdown-background-hover: #ebdbb2 !important;
  --embed-block-shadow-hover: 0 0 0 1px #ebdbb2, inset 0 0 0 1px #ebdbb2 !important;
  --embed-border-start: 2px solid hsl(60, 71%, 35%) !important;
  --faded-aqua: #427b58 !important;
  --faded-blue: #076678 !important;
  --faded-green: #79740e !important;
  ...
  --footnote-divider-color: #ebdbb2 !important;
  ...
  --graph-line: #d5c4a1 !important;
  --graph-node: hsl(60, 71%, 35%) !important;
  --graph-node-attachment: #98971a !important;
  --graph-node-focused: #b8bb26 !important;
  --graph-node-tag: #d79921 !important;
  --graph-node-unresolved: #ebdbb2 !important;
  ...
  --highlight: hsl(60, 71%, 35%) !important;
  --hr-color: #ebdbb2 !important;
  --icon-color: #3c3836 !important;
  --icon-color-active: hsl(60, 71%, 35%) !important;
  --icon-color-focused: #3c3836 !important;
  --icon-color-hover: #3c3836 !important;
  --indentation-guide-color: #ebdbb2 !important;
  --indentation-guide-color-active: #d5c4a1 !important;
  ...
  --interactive-accent-hover: hsl(57, 72.42%, 40.25%) !important;
  --interactive-accent-hsl: 60, 71%, 35% !important;
  --interactive-hover: #ebdbb2 !important;
  ...
  --menu-background: #fbf1c7 !important;
  --menu-border-color: #d5c4a1 !important;
  --metadata-border-color: #ebdbb2 !important;
  --metadata-divider-color: #ebdbb2 !important;
  ...
  --metadata-property-box-shadow-focus: 0 0 0 2px #d5c4a1 !important;
  --metadata-property-box-shadow-hover: 0 0 0 1px #d5c4a1 !important;
  --modal-background: #fbf1c7 !important;
  --modal-border-color: #ebdbb2 !important;
  ...
  --nav-indentation-guide-color: #d5c4a1 !important;
  --nav-item-background-active: #98971a !important;
  ...
  --pill-border-color: #ebdbb2 !important;
  --pill-border-color-hover: #d5c4a1 !important;
  ...
  --prompt-border-color: #ebdbb2 !important;
  ...
  --ribbon-background: #fbf1c7 !important;
  ...
  --setting-items-border-color: #ebdbb2 !important;
  --shiki-active-tab-border-color: #3c3836 !important;
  --shiki-code-background: #fbf1c7 !important;
  ...
  --shiki-code-string: #d79921 !important;
  --shiki-code-value: #b16286 !important;
  --shiki-gutter-border-color: #ebdbb2 !important;
  ...
  --slider-track-background: #fbf1c7 !important;
  --status-bar-background: #fbf1c7 !important;
  --status-bar-border-color: #ebdbb2 !important;
  ...
  --tab-container-background: #fbf1c7 !important;
  --tab-divider-color: #bdae93 !important;
  --tab-outline-color: #ebdbb2 !important;
  --tab-switcher-background: #fbf1c7 !important;
  --tab-switcher-menubar-background: linear-gradient(to top, #fbf1c7, transparent) !important;
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(60, 71%, 35%) !important;
  --tab-text-color: #ebdbb2 !important;
  ...
  --tab-text-color-focused-highlighted: red !important;
  --table-add-button-border-color: #ebdbb2 !important;
  --table-border-color: #ebdbb2 !important;
  --table-drag-handle-background-active: #b8bb26 !important;
  --table-drag-handle-color: #bdae93 !important;
  --table-drag-handle-color-active: #bdae93 !important;
  --table-header-border-color: #ebdbb2 !important;
  --table-header-color: #3c3836 !important;
  --table-selection: #bdae93 !important;
  --table-selection-border-color: #b8bb26 !important;
  --tag-background: #ebdbb2 !important;
  --tag-background-hover: #d5c4a1 !important;
  --tag-border-color: hsla(60, 71%, 35%, 0.15) !important;
  --tag-border-color-hover: hsla(60, 71%, 35%, 0.15) !important;
  --tag-color: #98971a !important;
  --tag-color-hover: #98971a !important;
  ...
  --text-color-accent: white !important;
  --text-color-muted-dark: #ebdbb2 !important;
  --text-color-muted-light: #d5c4a1 !important;
  --text-error: #cc241d !important;
  --text-faint: #d5c4a1 !important;
  --text-highlight-bg: hsl(60, 71%, 35%) !important;
  --text-muted: #3c3836 !important;
  --text-normal: #3c3836 !important;
  --text-on-accent-inverted: #f9f5d7 !important;
  --text-selection: #bdae93 !important;
  --text-success: #98971a !important;
  --text-warning: #d79921 !important;
  --textHighlight: hsl(60, 71%, 35%) !important;
  --titlebar-background: #fbf1c7 !important;
  --titlebar-background-focused: #ebdbb2 !important;
  --titlebar-border-color: #ebdbb2 !important;
