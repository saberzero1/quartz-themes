...
export const theme: ThemeData = {
  ...
  --background-modifier-active-hover: rgba(165, 119, 218, 0.15);
  ...
  --bases-table-cell-shadow-focus: 0 0 0 2px rgb(165, 119, 218);
  ...
  --collapse-icon-color-collapsed: rgb(165, 119, 218);
  --color-accent: rgb(165, 119, 218);
  --color-accent-1: rgb(165, 119, 218);
  --color-accent-2: rgb(165, 119, 218);
  ...
  --divider-color-hover: rgb(165, 119, 218);
  ...
  --embed-border-color: rgb(165, 119, 218);
  --embed-border-left: 1px solid rgb(165, 119, 218);
  --embed-border-right: none;
  --embed-border-start: 2px solid rgb(165, 119, 218);
  ...
  --graph-node-focused: rgb(165, 119, 218);
  ...
  --highlight: rgba(165, 119, 218, 0.7);
  --hr-color: rgb(58, 56, 56);
  --hr-thickness: 1.5px;
  --icon-color: rgb(112, 110, 109);
  --icon-color-active: rgb(165, 119, 218);
  ...
  --interactive: rgb(165, 119, 218);
  --interactive-accent: rgb(165, 119, 218);
  --interactive-accent-hover: rgb(165, 119, 218);
  ...
  --link-color: rgb(165, 119, 218);
  --link-color-hover: rgb(165, 119, 218);
  --link-external-color: rgb(165, 119, 218);
  --link-external-color-hover: rgb(165, 119, 218);
  --link-external-style: normal;
  --link-style: normal;
  --link-text-transform: none;
  --link-unresolved-color: rgb(165, 119, 218);
  ...
  --list-marker-color-collapsed: rgb(165, 119, 218);
  ...
  --nav-item-color-highlighted: rgb(165, 119, 218);
  ...
  --pill-color-remove-hover: rgb(165, 119, 218);
  ...
  --secondary: var(--text-accent, rgb(165, 119, 218));
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px rgb(165, 119, 218);
  ...
  --tab-text-color-focused-highlighted: rgb(165, 119, 218);
  --table-add-button-border-color: rgb(58, 56, 56);
  --table-border-color: rgb(58, 56, 56);
  --table-drag-handle-background-active: rgb(165, 119, 218);
  ...
  --table-hover-highlight-color: rgba(165, 119, 218, 0.15);
  --table-selection: hsla(24.4, 90.8%, 61.8%, 0.1);
  --table-selection-border-color: rgb(165, 119, 218);
  --table-sticky-height: 600px;
  --tag-background: rgba(165, 119, 218, 0.15);
  --tag-background-hover: rgba(165, 119, 218, 0.25);
  --tag-border-color: rgba(165, 119, 218, 0.15);
  --tag-border-color-hover: rgba(165, 119, 218, 0.25);
  --tag-color: rgb(165, 119, 218);
  --tag-color-hover: rgb(165, 119, 218);
  --tertiary: var(--text-accent-hover, rgb(165, 119, 218));
  --text-accent: rgb(165, 119, 218);
  --text-accent-hover: rgb(165, 119, 218);
  --text-code: hsl(348.5, 79.3%, 63.9%);
  --text-error: hsl(9.6, 66.2%, 46.5%);
  --text-faint: rgb(112, 110, 109);
  --text-highlight-bg: rgba(165, 119, 218, 0.7);
  --text-highlight-bg-active: rgba(165, 119, 218, 0.7);
  ...
  --text-selection: rgba(165, 119, 218, 0.5);
  --text-success: hsl(114.6, 22.4%, 49%);
  --textHighlight: var(--text-highlight-bg, rgba(165, 119, 218, 0.7));
  ...
  --titlebar-text-color-highlighted: rgb(165, 119, 218);
