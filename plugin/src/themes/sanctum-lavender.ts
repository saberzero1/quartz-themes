...
export const theme: ThemeData = {
  ...
  --background-modifier-active-hover: rgba(165, 119, 218, 0.15) !important;
  ...
  --bases-table-cell-shadow-focus: 0 0 0 2px rgb(165, 119, 218) !important;
  ...
  --collapse-icon-color-collapsed: rgb(165, 119, 218) !important;
  --color-accent: rgb(165, 119, 218) !important;
  --color-accent-1: rgb(165, 119, 218) !important;
  --color-accent-2: rgb(165, 119, 218) !important;
  --color-accent-hsl: 24.4, 90.8%, 61.8% !important;
  --color-accent-rgb: 165, 119, 218 !important;
  --color-accent-rgb-d: 165, 119, 218 !important;
  --color-accent-rgb-l: 165, 119, 218 !important;
  --color-green-rgb: 102,
    153,
    97 !important;
  --color-red-rgb: 197,
  ...
  --divider-color-hover: rgb(165, 119, 218) !important;
  ...
  --embed-border-color: rgb(165, 119, 218) !important;
  --embed-border-left: 1px solid rgb(165, 119, 218) !important;
  --embed-border-right: none !important;
  --embed-border-start: 2px solid rgb(165, 119, 218) !important;
  ...
  --graph-node-focused: rgb(165, 119, 218) !important;
  ...
  --interactive: rgb(165, 119, 218) !important;
  --interactive-accent: rgb(165, 119, 218) !important;
  --interactive-accent-hover: rgb(165, 119, 218) !important;
  ...
  --link-color: rgb(165, 119, 218) !important;
  --link-color-hover: rgb(165, 119, 218) !important;
  --link-external-color: rgb(165, 119, 218) !important;
  --link-external-color-hover: rgb(165, 119, 218) !important;
  --link-external-style: normal !important;
  --link-style: normal !important;
  --link-text-transform: none !important;
  --link-unresolved-color: rgb(165, 119, 218) !important;
  ...
  --list-marker-color-collapsed: rgb(165, 119, 218) !important;
  ...
  --nav-item-color-highlighted: rgb(165, 119, 218) !important;
  ...
  --pill-color-remove-hover: rgb(165, 119, 218) !important;
  ...
  --secondary: rgb(165, 119, 218) !important;
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px rgb(165, 119, 218) !important;
  ...
  --tab-text-color-focused-highlighted: rgb(165, 119, 218) !important;
  --table-add-button-border-color: rgb(58, 56, 56) !important;
  --table-border-color: rgb(58, 56, 56) !important;
  --table-drag-handle-background-active: rgb(165, 119, 218) !important;
  ...
  --table-hover-highlight-color: rgba(165, 119, 218, 0.15) !important;
  --table-selection: hsla(24.4, 90.8%, 61.8%, 0.1) !important;
  --table-selection-border-color: rgb(165, 119, 218) !important;
  --table-sticky-height: 600px !important;
  --tag-background: rgba(165, 119, 218, 0.15) !important;
  --tag-background-hover: rgba(165, 119, 218, 0.25) !important;
  --tag-border-color: rgba(165, 119, 218, 0.15) !important;
  --tag-border-color-hover: rgba(165, 119, 218, 0.25) !important;
  --tag-color: rgb(165, 119, 218) !important;
  --tag-color-hover: rgb(165, 119, 218) !important;
  --tertiary: rgb(165, 119, 218) !important;
  --text-accent: rgb(165, 119, 218) !important;
  --text-accent-hover: rgb(165, 119, 218) !important;
  --text-code: hsl(348.5, 79.3%, 63.9%) !important;
  --text-error: hsl(9.6, 66.2%, 46.5%) !important;
  --text-faint: rgb(112, 110, 109) !important;
  --text-highlight-bg: rgba(165, 119, 218, 0.7) !important;
  --text-highlight-bg-active: rgba(165, 119, 218, 0.7) !important;
  ...
  --text-selection: rgba(165, 119, 218, 0.5) !important;
  --text-success: hsl(114.6, 22.4%, 49%) !important;
  --textHighlight: rgba(165, 119, 218, 0.7) !important;
  ...
  --titlebar-text-color-highlighted: rgb(165, 119, 218) !important;
...
html[saved-theme="dark"] body .note-properties-tags {
  background-color: rgba(165, 119, 218, 0.15);
...
html[saved-theme="dark"] body .text-highlight {
  background-color: rgba(165, 119, 218, 0.7);
  color: rgb(244, 244, 240);
  font-family: "??", Inter, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  outline: rgb(244, 244, 240) none 0px;
  text-decoration-color: rgb(244, 244, 240);
