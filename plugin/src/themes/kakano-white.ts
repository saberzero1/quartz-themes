...
export const theme: ThemeData = {
  ...
  --bases-table-header-background-hover: hsl(50, 0%, 95%);
  ...
  --bases-table-summary-background-hover: hsl(50, 0%, 95%);
  ...
  --highlight: var(--background-modifier-hover, hsl(50, 0%, 95%));
  --hr-color: color-mix(
    in srgb,
    hsl(50, 0%, 95%),
    black 25%
  ...
  --metadata-property-background-active: hsl(50, 0%, 95%);
  ...
  --nav-item-background-active: hsl(50, 0%, 95%);
  ...
  --pill-background-hover: hsl(50, 0%, 95%);
  ...
  --textHighlight: var(--background-modifier-hover, hsl(50, 0%, 95%));
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --bases-table-cell-shadow-active: 0 0 0 2px hsl(50, 0%, 95%);
  --bases-table-cell-shadow-focus: 0 0 0 2px color-mix(
    in srgb,
    hsl(50, 0%, 95%),
    black 25%
  ...
  --metadata-property-box-shadow-focus: 0 0 0 2px hsl(50, 0%, 95%);
  --metadata-property-box-shadow-hover: none;
  --metadata-sidebar-input-font-size: 0.8rem;
  --metadata-sidebar-label-font-size: 0.8rem;
  --modal-background: color-mix(
  ...
  --tag-weight: 400;
  --tertiary: var(--interactive-accent-hover, hsl(50, 0%, 95%));
  --text-error: hsl(from hsl(50, 0%, 95%) 356 s l);
  --text-faint: color-mix(
    in srgb,
    hsl(50, 0%, 95%),
