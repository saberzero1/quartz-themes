...
export const theme: ThemeData = {
  ...
  --background-modifier-error: hsl(from hsl(50, 0%, 95%) 356 s l) !important;
  --background-modifier-error-hover: hsl(from hsl(50, 0%, 95%) 356 s l) !important;
  --background-modifier-hover: hsl(50, 0%, 95%) !important;
  --background-modifier-message: color-mix(
    in srgb,
    hsl(50, 0%, 95%),
    white 95%
  ) !important;
  --background-modifier-success: hsl(from hsl(50, 0%, 95%) 124 s l) !important;
  ...
  --bases-table-header-background-hover: hsl(50, 0%, 95%) !important;
  ...
  --bases-table-summary-background-hover: hsl(50, 0%, 95%) !important;
  ...
  --code-bracket-background: hsl(50, 0%, 95%) !important;
  --code-comment: light-dark(
    hsl(from black h s l / 0.5),
    hsl(from white h s l / 0.5)
  ) !important;
  --code-function: hsl(from hsl(50, 0%, 95%) 57 s l) !important;
  --code-important: hsl(from hsl(50, 0%, 95%) 27 s l) !important;
  --code-keyword: hsl(from hsl(50, 0%, 95%) 331 s l) !important;
  --code-normal: color-mix(
    in srgb,
    hsl(50, 0%, 95%),
    white 60%
  ) !important;
  --code-operator: hsl(from hsl(50, 0%, 95%) 356 s l) !important;
  --code-property: hsl(from hsl(50, 0%, 95%) 179 s l) !important;
  ...
  --code-string: hsl(from hsl(50, 0%, 95%) 124 s l) !important;
  --code-tag: hsl(from hsl(50, 0%, 95%) 356 s l) !important;
  --code-value: hsl(from hsl(50, 0%, 95%) 253 s l) !important;
  ...
  --collapse-icon-color: hsl(50, 0%, 95%) !important;
  --collapse-icon-color-collapsed: hsl(50, 0%, 95%) !important;
  --color-blue: hsl(from hsl(50, 0%, 95%) 219 s l) !important;
  --color-cyan: hsl(from hsl(50, 0%, 95%) 179 s l) !important;
  --color-green: hsl(from hsl(50, 0%, 95%) 124 s l) !important;
  --color-orange: hsl(from hsl(50, 0%, 95%) 27 s l) !important;
  --color-pink: hsl(from hsl(50, 0%, 95%) 331 s l) !important;
  --color-purple: hsl(from hsl(50, 0%, 95%) 253 s l) !important;
  --color-red: hsl(from hsl(50, 0%, 95%) 356 s l) !important;
  --color-yellow: hsl(from hsl(50, 0%, 95%) 57 s l) !important;
  --dark: color-mix(
    in srgb,
    hsl(50, 0%, 95%),
    white 60%
  ...
  --flair-background: hsl(50, 0%, 95%) !important;
  ...
  --graph-node-attachment: hsl(from hsl(50, 0%, 95%) 57 s l) !important;
  --graph-node-tag: hsl(from hsl(50, 0%, 95%) 124 s l) !important;
  ...
  --highlight: hsl(50, 0%, 95%) !important;
  --hr-color: color-mix(
    in srgb,
    hsl(50, 0%, 95%),
    black 25%
  ...
  --metadata-property-background-active: hsl(50, 0%, 95%) !important;
  ...
  --nav-item-background-active: hsl(50, 0%, 95%) !important;
  ...
  --pill-background-hover: hsl(50, 0%, 95%) !important;
  ...
  --search-clear-button-color: hsl(50, 0%, 95%) !important;
  --search-icon-color: hsl(50, 0%, 95%) !important;
  ...
  --shiki-code-function: hsl(from hsl(50, 0%, 95%) 124 s l) !important;
  --shiki-code-important: hsl(from hsl(50, 0%, 95%) 27 s l) !important;
  --shiki-code-keyword: hsl(from hsl(50, 0%, 95%) 331 s l) !important;
  --shiki-code-normal: color-mix(in srgb, color-mix(
    in srgb,
    hsl(50, 0%, 95%),
    white 60%
  ), transparent 30%) !important;
  --shiki-code-property: hsl(from hsl(50, 0%, 95%) 179 s l) !important;
  --shiki-code-punctuation: color-mix(in srgb, color-mix(
    in srgb,
    hsl(50, 0%, 95%),
    white 60%
  ), transparent 30%) !important;
  --shiki-code-string: hsl(from hsl(50, 0%, 95%) 57 s l) !important;
  --shiki-code-value: hsl(from hsl(50, 0%, 95%) 253 s l) !important;
  ...
  --sync-avatar-color-1: hsl(from hsl(50, 0%, 95%) 356 s l) !important;
  --sync-avatar-color-2: hsl(from hsl(50, 0%, 95%) 27 s l) !important;
  --sync-avatar-color-3: hsl(from hsl(50, 0%, 95%) 57 s l) !important;
  --sync-avatar-color-4: hsl(from hsl(50, 0%, 95%) 124 s l) !important;
  --sync-avatar-color-5: hsl(from hsl(50, 0%, 95%) 179 s l) !important;
  --sync-avatar-color-6: hsl(from hsl(50, 0%, 95%) 219 s l) !important;
  --sync-avatar-color-7: hsl(from hsl(50, 0%, 95%) 253 s l) !important;
  --sync-avatar-color-8: hsl(from hsl(50, 0%, 95%) 331 s l) !important;
  ...
  --tab-text-color-focused-highlighted: hsl(50, 0%, 95%) !important;
  ...
  --text-error: hsl(from hsl(50, 0%, 95%) 356 s l) !important;
  ...
  --text-success: hsl(from hsl(50, 0%, 95%) 124 s l) !important;
  --text-warning: hsl(from hsl(50, 0%, 95%) 27 s l) !important;
  --textHighlight: hsl(50, 0%, 95%) !important;
  ...
  --theme-color-base: hsl(50, 0%, 95%) !important;
  ...
  --theme-color-cardBgHover: hsl(50, 0%, 95%) !important;
  ...
  --theme-color-communityItemBgActive: hsl(50, 0%, 95%) !important;
  ...
  --theme-color-contentItemBgActive: hsl(50, 0%, 95%) !important;
  ...
  --theme-color-controlActive: black !important;
  --theme-color-controlBg: color-mix(
    in srgb,
    hsl(50, 0%, 95%),
    black 25%
  ) !important;
  --theme-color-controlBgActive: hsl(50, 0%, 95%) !important;
  ...
  --theme-color-controlHover: black !important;
  --theme-color-controlLightweightActive: black !important;
  ...
  --theme-color-controlTextHover: black !important;
  ...
  --theme-color-greenTransparent25: hsl(from hsl(from hsl(50, 0%, 95%) 124 s l) h s l / 0.25) !important;
  --theme-color-greenTransparent75: hsl(from hsl(from hsl(50, 0%, 95%) 124 s l) h s l / 0.75) !important;
  --theme-color-hotkey: hsl(50, 0%, 95%) !important;
  --theme-color-inputBorder: color-mix(
    in srgb,
    hsl(50, 0%, 95%),
    white 25%
  ) !important;
  --theme-color-inputPlaceholder: hsl(50, 0%, 95%) !important;
  ...
  --theme-color-jiraIssueDangerBg: hsl(from hsl(from hsl(50, 0%, 95%) 356 s l) h s l / 0.25) !important;
  --theme-color-jiraIssueDeleteBg: hsl(from hsl(50, 0%, 95%) 356 s l) !important;
  ...
  --theme-color-navFileTagActive: black !important;
  --theme-color-navFileTagActiveBorder: black !important;
  --theme-color-navFileTagBorder: color-mix(
    in srgb,
    hsl(50, 0%, 95%),
    black 25%
  ) !important;
  --theme-color-navigationButtonBgHover: hsl(50, 0%, 95%) !important;
  ...
  --theme-color-orangeTransparent25: hsl(from hsl(from hsl(50, 0%, 95%) 27 s l) h s l / 0.25) !important;
  --theme-color-orangeTransparent75: hsl(from hsl(from hsl(50, 0%, 95%) 27 s l) h s l / 0.75) !important;
  ...
  --theme-color-redTransparent25: hsl(from hsl(from hsl(50, 0%, 95%) 356 s l) h s l / 0.25) !important;
  --theme-color-redTransparent75: hsl(from hsl(from hsl(50, 0%, 95%) 356 s l) h s l / 0.75) !important;
  ...
  --theme-color-switcherBgActive: hsl(50, 0%, 95%) !important;
  ...
  --theme-color-textMeta: hsl(50, 0%, 95%) !important;
  ...
  --theme-color-yellowTransparent25: hsl(from hsl(from hsl(50, 0%, 95%) 57 s l) h s l / 0.25) !important;
  --theme-color-yellowTransparent75: hsl(from hsl(from hsl(50, 0%, 95%) 57 s l) h s l / 0.75) !important;
...
html[saved-theme="dark"] body p {
  ...
  padding-right: 0px;
  padding-top: 0px;
  scrollbar-color: color(srgb 0.95 0.95 0.95 / 0.25) rgba(0, 0, 0, 0);
...
html[saved-theme="dark"] body ul.overflow {
  ...
  color: color(srgb 0.9625 0.9625 0.9625);
}
...
html[saved-theme="dark"] body .search > .search-container > .search-space {
  background-color: color(srgb 0.19 0.19 0.19);
  ...
  border-top-width: 0px;
  box-shadow: color(srgb 0.095 0.095 0.095 / 0.02) 0px 0px 3.2px 0px, color(srgb 0.095 0.095 0.095 / 0.04) 0px 3.2px 6.4px 0px, color(srgb 0.095 0.095 0.095 / 0.06) 0px 6.4px 19.2px 0px, color(srgb 0.095 0.095 0.095 / 0.08) 0px 19.2px 32px 0px, color(srgb 0.095 0.095 0.095 / 0.1) 0px 32px 64px 0px;
}
...
html[saved-theme="dark"] body li.depth-0 {
  ...
  background-color: color(srgb 0.38 0.38 0.38);
  border-bottom-color: color(srgb 0.98 0.98 0.98);
  border-left-color: color(srgb 0.98 0.98 0.98);
  border-left-width: 0px;
  border-right-color: color(srgb 0.98 0.98 0.98);
...
html[saved-theme="dark"] body .canvas-sidebar {
  background-color: color(srgb 0.285 0.285 0.285);
  border-color: color(srgb 0.98 0.98 0.98);
  box-shadow: rgba(24, 24, 24, 0.5) 0px 1px 2px 0px, rgba(24, 24, 24, 0.25) 0px 3.4px 6.7px 0px, rgba(24, 24, 24, 0.15) 0px 15px 30px 0px;
}`,
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --background-modifier-border-focus: hsl(50, 0%, 95%) !important;
  --background-modifier-error: hsl(from hsl(50, 0%, 95%) 356 s l) !important;
  --background-modifier-error-hover: hsl(from hsl(50, 0%, 95%) 356 s l) !important;
  --background-modifier-hover: hsl(50, 0%, 95%) !important;
  --background-modifier-message: color-mix(
  ...
  --bases-table-cell-shadow-active: 0 0 0 2px hsl(50, 0%, 95%) !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px color-mix(
    in srgb,
    hsl(50, 0%, 95%),
    black 25%
  ...
  --checkbox-border-color-hover: hsl(50, 0%, 95%) !important;
  --checkbox-color: color-mix(
    in srgb,
    hsl(50, 0%, 95%),
    black 25%
  ) !important;
  --checkbox-color-hover: hsl(50, 0%, 95%) !important;
  ...
  --interactive-accent-hover: hsl(50, 0%, 95%) !important;
  ...
  --metadata-property-box-shadow-focus: 0 0 0 2px hsl(50, 0%, 95%) !important;
  --metadata-property-box-shadow-hover: none !important;
  --metadata-sidebar-input-font-size: 0.8rem !important;
  --metadata-sidebar-label-font-size: 0.8rem !important;
  --modal-background: color-mix(
  ...
  --tag-weight: 400 !important;
  --tertiary: hsl(50, 0%, 95%) !important;
  --text-error: hsl(from hsl(50, 0%, 95%) 356 s l) !important;
  --text-faint: color-mix(
    in srgb,
    hsl(50, 0%, 95%),
  ...
  --theme-color-controlContentArea: hsl(50, 0%, 95%) !important;
  --theme-color-controlContentAreaHover: color-mix(
    in srgb,
    hsl(50, 0%, 95%),
    white 80%
  ...
  --theme-color-navFileTag: hsl(50, 0%, 95%) !important;
  --theme-color-navFileTagActive: black !important;
  --theme-color-navFileTagActiveBorder: black !important;
  --theme-color-navFileTagBorder: hsl(50, 0%, 95%) !important;
  --theme-color-navigationButtonBgHover: hsl(50, 0%, 95%) !important;
  --theme-color-notice: color-mix(
    in srgb,
    hsl(50, 0%, 95%),
...
html[saved-theme="light"] body .search > .search-container > .search-space {
  background-color: color(srgb 0.9975 0.9975 0.9975);
  border-bottom-color: rgba(0, 0, 0, 0);
  border-bottom-width: 0px;
  border-left-color: rgba(0, 0, 0, 0);
  border-left-width: 0px;
  ...
  border-top-color: rgba(0, 0, 0, 0);
  border-top-width: 0px;
  box-shadow: color(srgb 0.7125 0.7125 0.7125 / 0.02) 0px 0px 3.2px 0px, color(srgb 0.7125 0.7125 0.7125 / 0.04) 0px 3.2px 6.4px 0px, color(srgb 0.7125 0.7125 0.7125 / 0.06) 0px 6.4px 19.2px 0px, color(srgb 0.7125 0.7125 0.7125 / 0.08) 0px 19.2px 32px 0px, color(srgb 0.7125 0.7125 0.7125 / 0.1) 0px 32px 64px 0px;
}
...
html[saved-theme="light"] body .canvas-sidebar {
  background-color: color(srgb 0.99 0.99 0.99);
  border-color: color(srgb 0.095 0.095 0.095);
  box-shadow: rgba(61, 61, 61, 0.2) 0px 1px 2px 0px, rgba(61, 61, 61, 0.15) 0px 3.4px 6.7px 0px, rgba(61, 61, 61, 0.05) 0px 15px 30px 0px;
}`,
