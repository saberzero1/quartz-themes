...
export const theme: ThemeData = {
  ...
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(219, 56%, 55%);
  ...
  --blockquote-border-color: hsl(219, 56%, 55%);
  --blue: #61afef;
  ...
  --embed-border-start: 2px solid hsl(219, 56%, 55%);
  ...
  --highlight: var(--text-highlight-bg, rgba(255, 255, 0, 0.4));
  --hr-color: #424958;
  --icon-color: #888;
  ...
  --nav-item-background-active: hsl(219, 56%, 55%);
  ...
  --shiki-tooltip-background: #1a1e24;
  ...
  --table-drag-handle-background-active: hsl(219, 56%, 55%);
  ...
  --table-selection-border-color: hsl(219, 56%, 55%);
  ...
  --tag-padding-y: 2px;
  --tag-radius: 4px;
  --tertiary: var(--text-accent-hover, #70bdfc);
  --text-accent: #61afef;
  ...
  --textHighlight: var(--text-highlight-bg, rgba(255, 255, 0, 0.4));
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --background-modifier-active-hover: hsla(230, 83%, 64%, 0.1);
  ...
  --bases-table-cell-background-selected: hsla(230, 83%, 64%, 0.1);
  --bases-table-cell-shadow-active: 0 0 0 2px #dbdbdc;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(229, 83.83%, 68.8%);
  ...
  --blockquote-border-color: hsl(229, 83.83%, 68.8%);
  --blue: #3d74f6;
  ...
  --color-accent-1: hsl(229, 83.83%, 68.8%);
  --color-accent-2: hsl(227, 84.66%, 73.6%);
  --color-accent-hsl: 230, 83%, 64%;
  --dark: var(--text-normal, #383a42);
  --darkgray: var(--text-normal, #383a42);
  --divider-color: transparent;
  --divider-color-hover: hsl(229, 83.83%, 68.8%);
  ...
  --embed-border-start: 2px solid hsl(229, 83.83%, 68.8%);
  --embed-padding: 0 0 0 16px;
  ...
  --interactive-accent: hsl(229, 83.83%, 68.8%);
  --interactive-accent-hover: hsl(230, 73%, 60%);
  ...
  --lightgray: var(--background-secondary, #eaeaeb);
  --link-color: #1592ff;
  ...
  --link-unresolved-decoration-color: hsla(230, 83%, 64%, 0.3);
  ...
  --nav-item-background-active: hsl(229, 83.83%, 68.8%);
  --nav-item-background-selected: hsla(230, 83%, 64%, 0.15);
  --nav-item-color: #8e8e90;
  --nav-item-color-active: #383a42;
  ...
  --secondary: var(--text-accent, #1592ff);
  ...
  --shiki-tooltip-background: #dbdbdc;
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(230, 83%, 64%);
  ...
  --table-drag-handle-background-active: hsl(229, 83.83%, 68.8%);
  ...
  --table-selection: hsla(230, 83%, 64%, 0.1);
  --table-selection-border-color: hsl(229, 83.83%, 68.8%);
  --tag-background: #eaeaeb;
  --tag-background-hover: #eaeaeb;
  --tag-border-color: hsla(230, 83%, 64%, 0.15);
  --tag-border-color-hover: hsla(230, 83%, 64%, 0.15);
  --tag-color: #e35649;
  --tag-color-hover: #e35649;
  --tag-padding-x: 4px;
  --tag-padding-y: 2px;
  --tag-radius: 4px;
  --tertiary: var(--text-accent-hover, #097add);
  --text-accent: #1592ff;
