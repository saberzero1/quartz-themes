...
export const theme: ThemeData = {
  ...
  --codeFont: var(--font-monospace, "Consolas", "Fira Code", "Source Code Pro", "Droid Sans Mono", "Monoid", "Arial", sans-serif);
  --collapse-icon-color-collapsed: hsl(152, 39%, 51%);
  --cyan: #0fb3ff;
  ...
  --graph-node: #bbb;
  --graph-node-focused: hsl(152, 39%, 51%);
  --graph-text: #dedede;
  ...
  --highlight: var(--text-highlight-bg, rgba(190, 30, 150, 0.7));
  --hr-color: #424958;
  --icon-color: #bbb;
  --icon-color-active: hsl(152, 39%, 51%);
  ...
  --link-color: hsl(152, 39%, 51%);
  --link-color-hover: hsl(152, 69%, 61%);
  --link-external-color: hsl(152, 39%, 51%);
  --link-external-color-hover: hsl(152, 69%, 61%);
  --link-unresolved-color: hsl(152, 39%, 51%);
  --list-marker-color-collapsed: hsl(152, 39%, 51%);
  ...
  --nav-item-color-highlighted: hsl(152, 39%, 51%);
  ...
  --pill-color-remove-hover: hsl(152, 39%, 51%);
  ...
  --secondary: var(--text-accent, hsl(152, 39%, 51%));
  ...
  --tab-text-color-focused-highlighted: hsl(152, 39%, 51%);
  ...
  --tag-color: hsl(152, 39%, 51%);
  --tag-color-hover: hsl(152, 39%, 51%);
  ...
  --textHighlight: var(--text-highlight-bg, rgba(190, 30, 150, 0.7));
