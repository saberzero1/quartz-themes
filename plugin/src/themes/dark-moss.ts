...
export const theme: ThemeData = {
  ...
  --collapse-icon-color-collapsed: var(--text-accent, hsl(152, 39%, 51%));
  --cyan: #0fb3ff;
  ...
  --graph-node-focused: var(--text-accent, hsl(152, 39%, 51%));
  ...
  --icon-color-active: var(--text-accent, hsl(152, 39%, 51%));
  ...
  --link-color: var(--text-accent, hsl(152, 39%, 51%));
  --link-color-hover: var(--text-accent-hover, hsl(152, 69%, 61%));
  --link-external-color: var(--text-accent, hsl(152, 39%, 51%));
  --link-external-color-hover: var(--text-accent-hover, hsl(152, 69%, 61%));
  --link-unresolved-color: var(--text-accent, hsl(152, 39%, 51%));
  --list-marker-color-collapsed: var(--text-accent, hsl(152, 39%, 51%));
  ...
  --nav-item-color-highlighted: var(--text-accent, hsl(152, 39%, 51%));
  ...
  --pill-color-remove-hover: var(--text-accent, hsl(152, 39%, 51%));
  ...
  --secondary: var(--text-accent, var(--color-accent-1, hsl(152, 39%, 51%)));
  ...
  --tab-text-color-focused-highlighted: var(--text-accent, hsl(152, 39%, 51%));
  ...
  --tag-color: var(--text-accent, hsl(152, 39%, 51%));
  --tag-color-hover: var(--text-accent, hsl(152, 39%, 51%));
  --tertiary: var(--text-accent-hover, var(--color-accent-2, hsl(152, 69%, 61%)));
  --text-accent: var(--color-accent-1, hsl(152, 39%, 51%));
...
html body .text-highlight {
  background-color: var(--text-highlight-bg, rgba(190, 30, 150, 0.7));
...
html body ul.overflow {
  ...
  color: var(--green-light, rgb(66, 172, 205));
...
html body h1 {
  ...
  color: var(--text-title-h1, rgb(40, 154, 255));
...
html body h2 {
  ...
  color: var(--text-title-h2, rgb(0, 245, 106));
  font-family: var(--font-family-preview, "??", "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  font-weight: var(--font-weight-title, 600);
  line-height: var(--line-height-headers, 23.392px);
}
...
html body h3 {
  ...
  color: var(--text-title-h3, rgb(10, 247, 255));
  font-family: var(--font-family-preview, "??", "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  font-weight: var(--font-weight-title, 600);
  line-height: var(--line-height-headers, 21.088px);
}
...
html body h4 {
  ...
  color: var(--text-title-h4, rgb(249, 248, 113));
  font-family: var(--font-family-preview, "??", "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  font-weight: var(--font-weight-title, 600);
  line-height: var(--line-height-headers, 19.008px);
}
...
html body h5 {
  ...
  color: var(--text-title-h5, rgb(255, 87, 87));
  font-family: var(--font-family-preview, "??", "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  font-weight: var(--font-weight-title, 600);
  line-height: var(--line-height-headers, 17.216px);
}
...
html body h6 {
  ...
  color: var(--text-title-h6, rgb(255, 60, 213));
  font-family: var(--font-family-preview, "??", "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  font-weight: var(--font-weight-title, 600);
  line-height: var(--line-height-headers, 16px);
}
