...
export const theme: ThemeData = {
  ...
  --background-secondary: rgb(42, 45, 45) !important;
  --background-secondary-alt: rgb(54, 56, 56) !important;
  ...
  --bases-table-cell-shadow-focus: 0 0 0 2px #993636 !important;
  ...
  --blockquote-border-color: #993636 !important;
  ...
  --button-bg: rgb(103, 106, 106) !important;
  --button-color: rgb(230, 233, 233) !important;
  --button-hover-bg: rgb(69, 71, 71) !important;
  --button-hover-color: rgb(182, 184, 184) !important;
  --canvas-background: rgb(30, 30, 30) !important;
  --canvas-card-label-color: rgb(126, 127, 127) !important;
  --caret-color: rgb(241, 244, 244) !important;
  --checkbox-border-color: rgb(126, 127, 127) !important;
  --checkbox-border-color-hover: rgb(230, 230, 230) !important;
  --checkbox-color: #993636 !important;
  --checkbox-color-hover: #a63c3c !important;
  --checkbox-marker-color: rgb(30, 30, 30) !important;
  --checklist-done-color: rgb(230, 230, 230) !important;
  ...
  --code-comment: rgb(126, 127, 127) !important;
  --code-normal: rgb(241, 244, 244) !important;
  --code-punctuation: rgb(230, 230, 230) !important;
  --collapse-icon-color: rgb(126, 127, 127) !important;
  --collapse-icon-color-collapsed: rgb(242, 109, 109) !important;
  --dark: rgb(241, 244, 244) !important;
  --darkgray: rgb(241, 244, 244) !important;
  ...
  --embed-border-start: 2px solid #993636 !important;
  ...
  --flair-color: rgb(241, 244, 244) !important;
  --footnote-divider-color: rgb(0, 0, 0) !important;
  --footnote-id-color: rgb(230, 230, 230) !important;
  --footnote-id-color-no-occurrences: rgb(126, 127, 127) !important;
  --footnote-input-background-active: rgba(255, 255, 255, 0.05) !important;
  --graph-node: rgb(230, 230, 230) !important;
  --graph-node-focused: rgb(242, 109, 109) !important;
  --graph-node-unresolved: rgb(126, 127, 127) !important;
  --graph-text: rgb(241, 244, 244) !important;
  --gray: rgb(230, 230, 230) !important;
  --heading-formatting: rgb(126, 127, 127) !important;
  --highlight: rgba(255, 255, 0, 0.4) !important;
  --hr-color: rgb(0, 0, 0) !important;
  --icon-color: rgb(230, 230, 230) !important;
  --icon-color-active: rgb(242, 109, 109) !important;
  --icon-color-focused: rgb(241, 244, 244) !important;
  --icon-color-hover: rgb(230, 230, 230) !important;
  --input-date-separator: rgb(126, 127, 127) !important;
  --input-placeholder-color: rgb(126, 127, 127) !important;
  --interactive-accent: #993636 !important;
  --interactive-accent-hover: #a63c3c !important;
  --interactive-accent-rgb: 153, 54, 54 !important;
  ...
  --lightgray: rgb(42, 45, 45) !important;
  --link-color: rgb(242, 109, 109) !important;
  --link-color-hover: rgb(242, 109, 109) !important;
  --link-external-color: rgb(242, 109, 109) !important;
  --link-external-color-hover: rgb(242, 109, 109) !important;
  --link-unresolved-color: rgb(242, 109, 109) !important;
  --list-marker-color: rgb(126, 127, 127) !important;
  --list-marker-color-collapsed: rgb(242, 109, 109) !important;
  --list-marker-color-hover: rgb(230, 230, 230) !important;
  --menu-background: rgb(42, 45, 45) !important;
  ...
  --metadata-input-text-color: rgb(241, 244, 244) !important;
  ...
  --nav-collapse-icon-color: rgb(126, 127, 127) !important;
  --nav-collapse-icon-color-collapsed: rgb(126, 127, 127) !important;
  --nav-heading-color: rgb(241, 244, 244) !important;
  --nav-heading-color-collapsed: rgb(126, 127, 127) !important;
  --nav-heading-color-collapsed-hover: rgb(230, 230, 230) !important;
  --nav-heading-color-hover: rgb(241, 244, 244) !important;
  ...
  --nav-item-color-active: rgb(241, 244, 244) !important;
  --nav-item-color-highlighted: rgb(242, 109, 109) !important;
  --nav-item-color-hover: rgb(241, 244, 244) !important;
  --nav-item-color-selected: rgb(241, 244, 244) !important;
  --nav-tag-color: rgb(126, 127, 127) !important;
  ...
  --pill-color-hover: rgb(241, 244, 244) !important;
  --pill-color-remove: rgb(126, 127, 127) !important;
  --pill-color-remove-hover: rgb(242, 109, 109) !important;
  ...
  --ribbon-background: rgb(42, 45, 45) !important;
  ...
  --secondary: rgb(242, 109, 109) !important;
  --setting-group-heading-color: rgb(241, 244, 244) !important;
  --setting-items-background: rgb(0, 0, 0) !important;
  --setting-items-border-color: rgb(0, 0, 0) !important;
  --shiki-active-tab-border-color: rgb(230, 230, 230) !important;
  --shiki-code-background: rgb(0, 0, 0) !important;
  --shiki-code-comment: rgb(126, 127, 127) !important;
  --shiki-code-normal: rgb(230, 230, 230) !important;
  --shiki-code-punctuation: rgb(230, 230, 230) !important;
  --shiki-gutter-border-color: rgb(0, 0, 0) !important;
  --shiki-gutter-text-color: rgb(126, 127, 127) !important;
  --shiki-gutter-text-color-highlight: rgb(230, 230, 230) !important;
  --shiki-highlight-neutral: rgb(230, 230, 230) !important;
  --shiki-terminal-dots-color: rgb(126, 127, 127) !important;
  --slider-thumb-border-color: rgb(0, 0, 0) !important;
  --slider-track-background: rgb(0, 0, 0) !important;
  --status-bar-background: rgb(42, 45, 45) !important;
  ...
  --tab-container-background: rgb(42, 45, 45) !important;
  --tab-divider-color: rgb(0, 0, 0) !important;
  --tab-outline-color: rgb(0, 0, 0) !important;
  --tab-switcher-background: rgb(42, 45, 45) !important;
  --tab-switcher-menubar-background: linear-gradient(to top, rgb(42, 45, 45), transparent) !important;
  --tab-text-color: rgb(126, 127, 127) !important;
  --tab-text-color-active: rgb(230, 230, 230) !important;
  --tab-text-color-focused: rgb(230, 230, 230) !important;
  --tab-text-color-focused-active: rgb(230, 230, 230) !important;
  --tab-text-color-focused-active-current: rgb(241, 244, 244) !important;
  --tab-text-color-focused-highlighted: rgb(242, 109, 109) !important;
  --table-add-button-border-color: rgb(0, 0, 0) !important;
  --table-border-color: rgb(0, 0, 0) !important;
  --table-drag-handle-background-active: #993636 !important;
  --table-drag-handle-color: rgb(126, 127, 127) !important;
  --table-drag-handle-color-active: #dcddde !important;
  --table-header-border-color: rgb(0, 0, 0) !important;
  --table-header-color: rgb(241, 244, 244) !important;
  --table-selection-border-color: #993636 !important;
  --tag-color: rgb(242, 109, 109) !important;
  --tag-color-hover: rgb(242, 109, 109) !important;
  --tertiary: rgb(242, 109, 109) !important;
  --text-accent: rgb(242, 109, 109) !important;
  --text-accent-hover: rgb(242, 109, 109) !important;
  --text-error: #ff3333 !important;
  --text-error-hover: #990000 !important;
  --text-faint: rgb(126, 127, 127) !important;
  --text-highlight-bg: rgba(255, 255, 0, 0.4) !important;
  --text-muted: rgb(230, 230, 230) !important;
  --text-normal: rgb(241, 244, 244) !important;
  --text-on-accent: #dcddde !important;
  --text-selection: rgba(23, 48, 77, 0.99) !important;
  --textHighlight: rgba(255, 255, 0, 0.4) !important;
  --titlebar-background: rgb(42, 45, 45) !important;
  --titlebar-background-focused: rgb(54, 56, 56) !important;
  --titlebar-border-color: rgb(0, 0, 0) !important;
  --titlebar-text-color: rgb(230, 230, 230) !important;
  --titlebar-text-color-focused: rgb(241, 244, 244) !important;
  --vault-profile-color: rgb(241, 244, 244) !important;
  --vault-profile-color-hover: rgb(241, 244, 244) !important;
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --background-modifier-border-focus: #ddd !important;
  --background-modifier-border-hover: #ddd !important;
  ...
  --bases-cards-shadow-hover: 0 0 0 1px #ddd !important;
  ...
  --bases-table-cell-shadow-active: 0 0 0 2px #ddd !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px #d96c6c !important;
  ...
  --blockquote-border-color: #d96c6c !important;
  --button-bg: #ddd !important;
  --button-color: #ddd !important;
  --button-hover-bg: #ddd !important;
  --button-hover-color: #666 !important;
  ...
  --checkbox-color: #d96c6c !important;
  --checkbox-color-hover: #e67373 !important;
  ...
  --collapse-icon-color-collapsed: #ef5d5d !important;
  --dark: #2e3338 !important;
  --darkgray: #2e3338 !important;
  --divider-color: rgb(235, 226, 228) !important;
  --divider-color-hover: rgb(235, 226, 228) !important;
  ...
  --embed-border-start: 2px solid #d96c6c !important;
  ...
  --graph-node-focused: #ef5d5d !important;
  ...
  --icon-color-active: #ef5d5d !important;
  ...
  --interactive-accent: #d96c6c !important;
  --interactive-accent-hover: #e67373 !important;
  --interactive-accent-rgb: 217, 108, 108 !important;
  --interactive-hover: #e9e9e9 !important;
  --interactive-normal: #f2f3f5 !important;
  --interactive-success: #A4E7C3 !important;
  --light: #f5f6f8 !important;
  --lightgray: #f2f3f5 !important;
  --link-color: #ef5d5d !important;
  --link-color-hover: #e66a6a !important;
  --link-external-color: #ef5d5d !important;
  --link-external-color-hover: #e66a6a !important;
  --link-unresolved-color: #ef5d5d !important;
  --list-marker-color: #999999 !important;
  --list-marker-color-collapsed: #ef5d5d !important;
  --list-marker-color-hover: #888888 !important;
  --menu-background: #f2f3f5 !important;
  --menu-border-color: #ddd !important;
  ...
  --metadata-property-box-shadow-focus: 0 0 0 2px #ddd !important;
  --metadata-property-box-shadow-hover: 0 0 0 1px #ddd !important;
  ...
  --nav-item-color-highlighted: #ef5d5d !important;
  ...
  --slider-thumb-border-color: #ddd !important;
  --slider-track-background: #ddd !important;
  --status-bar-background: #f2f3f5 !important;
  --status-bar-border-color: rgb(235, 226, 228) !important;
  --status-bar-text-color: #888888 !important;
  --tab-container-background: #f2f3f5 !important;
  --tab-divider-color: #ddd !important;
  --tab-outline-color: rgb(235, 226, 228) !important;
  ...
  --tab-text-color-focused-highlighted: #ef5d5d !important;
  --table-add-button-border-color: #ddd !important;
  --table-border-color: #ddd !important;
  --table-drag-handle-background-active: #d96c6c !important;
  ...
  --table-selection-border-color: #d96c6c !important;
  --tag-color: #ef5d5d !important;
  --tag-color-hover: #ef5d5d !important;
  --tertiary: #e66a6a !important;
  --text-accent: #ef5d5d !important;
  --text-accent-hover: #e66a6a !important;
