...
export const theme: ThemeData = {
  ...
  --background-modifier-active-hover: hsla(138, 59%, 54%, 0.1) !important;
  ...
  --bases-table-cell-background-selected: hsla(138, 59%, 54%, 0.1) !important;
  --bases-table-cell-shadow-active: 0 0 0 2px #414141 !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(138, 59%, 54%) !important;
  ...
  --blockquote-border-color: hsl(138, 59%, 54%) !important;
  ...
  --checkbox-color: hsl(138, 59%, 54%) !important;
  --checkbox-color-hover: #a882ff !important;
  ...
  --collapse-icon-color-collapsed: hsl(138, 59%, 54%) !important;
  --color-accent: hsl(138, 59%, 54%) !important;
  --color-accent-1: #a882ff !important;
  --color-accent-1-rgb: 168, 130, 255 !important;
  --color-accent-2: hsl(
        258 calc(88% + 180) 66%
    ) !important;
  ...
  --color-accent-hsl: 138, 59%, 54% !important;
  --color-accent-rgb: 68, 207, 110 !important;
  ...
  --divider-color-hover: hsl(138, 59%, 54%) !important;
  ...
  --embed-border-start: 2px solid hsl(138, 59%, 54%) !important;
  ...
  --graph-node-focused: hsl(138, 59%, 54%) !important;
  --graph-node-tag: hsl(138, 59%, 54%) !important;
  ...
  --icon-color-active: hsl(138, 59%, 54%) !important;
  ...
  --interactive-accent: hsl(138, 59%, 54%) !important;
  --interactive-accent-hover: #a882ff !important;
  --interactive-accent-hsl: 138, 59%, 54% !important;
  ...
  --link-external-color: hsl(138, 59%, 54%) !important;
  ...
  --list-marker-color-collapsed: hsl(138, 59%, 54%) !important;
  ...
  --nav-item-background-selected: hsla(138, 59%, 54%, 0.15) !important;
  ...
  --pill-color-remove-hover: hsl(138, 59%, 54%) !important;
  ...
  --scrollbar-active-thumb-bg: hsl(138, 59%, 54%) !important;
  ...
  --secondary: hsl(138, 59%, 54%) !important;
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(138, 59%, 54%) !important;
  ...
  --tab-text-color-focused-highlighted: hsl(138, 59%, 54%) !important;
  --table-add-button-border-color: #313131 !important;
  --table-border-color: #313131 !important;
  --table-drag-handle-background-active: hsl(138, 59%, 54%) !important;
  --table-drag-handle-color: #999999 !important;
  --table-header-border-color: #313131 !important;
  --table-header-color: #bababa !important;
  --table-selection: hsla(138, 59%, 54%, 0.1) !important;
  --table-selection-border-color: hsl(138, 59%, 54%) !important;
  --tag-background: hsla(138, 59%, 54%, 0.1) !important;
  --tag-background-hover: hsla(138, 59%, 54%, 0.2) !important;
  --tag-border-color: hsla(138, 59%, 54%, 0.15) !important;
  --tag-border-color-hover: hsla(138, 59%, 54%, 0.15) !important;
  --tag-color: hsl(138, 59%, 54%) !important;
  --tag-color-hover: hsl(138, 59%, 54%) !important;
  --tertiary: hsl(
        258 calc(88% + 180) 66%
    ) !important;
  --text-accent: hsl(138, 59%, 54%) !important;
  ...
  --text-selection: hsla(138, 59%, 54%, 0.33) !important;
...
html[saved-theme="dark"] body kbd {
  background-color: color(srgb 0.2686 0.8114 0.43144 / 0.7);
...
html[saved-theme="dark"] body ul.tags > li {
  background-color: color(srgb 0.2686 0.8114 0.43144 / 0.05);
  ...
  --background-modifier-active-hover: hsla(144, 92%, 38%, 0.1) !important;
  ...
  --bases-table-cell-background-selected: hsla(144, 92%, 38%, 0.1) !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(144, 92%, 38%) !important;
  ...
  --blockquote-border-color: hsl(144, 92%, 38%) !important;
  ...
  --checkbox-color: hsl(144, 92%, 38%) !important;
  ...
  --collapse-icon-color-collapsed: hsl(144, 92%, 38%) !important;
  --color-accent: hsl(144, 92%, 38%) !important;
  --color-accent-1: #7852ee !important;
  --color-accent-1-rgb: 120, 82, 238 !important;
  --color-accent-2: hsl(
        258 88% 71%
    ) !important;
  --color-accent-hover: hsl(
  ...
  --color-accent-hsl: 144, 92%, 38% !important;
  --color-accent-rgb: 8, 185, 78 !important;
  ...
  --divider-color-hover: hsl(144, 92%, 38%) !important;
  ...
  --embed-border-start: 2px solid hsl(144, 92%, 38%) !important;
  ...
  --graph-node-focused: hsl(144, 92%, 38%) !important;
  --graph-node-tag: hsl(144, 92%, 38%) !important;
  ...
  --icon-color-active: hsl(144, 92%, 38%) !important;
  ...
  --interactive-accent: hsl(144, 92%, 38%) !important;
  ...
  --link-decoration-hover: none !important;
  --link-decoration-thickness: 13% !important;
  --link-external-color: hsl(144, 92%, 38%) !important;
  --link-external-color-hover: hsl(
        258 88% 71%
    ) !important;
  --link-external-decoration: none !important;
  ...
  --list-marker-color-collapsed: hsl(144, 92%, 38%) !important;
  ...
  --nav-item-background-selected: hsla(144, 92%, 38%, 0.15) !important;
  ...
  --pill-color-remove-hover: hsl(144, 92%, 38%) !important;
  ...
  --scrollbar-active-thumb-bg: hsl(144, 92%, 38%) !important;
  ...
  --secondary: hsl(144, 92%, 38%) !important;
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(144, 92%, 38%) !important;
  ...
  --tab-text-color-focused-highlighted: hsl(144, 92%, 38%) !important;
  --table-add-button-border-color: #c7c7c7 !important;
  --table-border-color: #c7c7c7 !important;
  --table-drag-handle-background-active: hsl(144, 92%, 38%) !important;
  --table-drag-handle-color: #707070 !important;
  --table-header-border-color: #c7c7c7 !important;
  --table-header-color: #5a5a5a !important;
  --table-selection: hsla(144, 92%, 38%, 0.1) !important;
  --table-selection-border-color: hsl(144, 92%, 38%) !important;
  --tag-background: hsla(144, 92%, 38%, 0.1) !important;
  --tag-background-hover: hsla(144, 92%, 38%, 0.2) !important;
  --tag-border-color: hsla(144, 92%, 38%, 0.15) !important;
  --tag-border-color-hover: hsla(144, 92%, 38%, 0.15) !important;
  --tag-color: hsl(144, 92%, 38%) !important;
  --tag-color-hover: hsl(144, 92%, 38%) !important;
  --tertiary: hsl(
        258 88% 71%
    ) !important;
  --text-accent: hsl(144, 92%, 38%) !important;
  --text-accent-hover: hsl(
        258 88% 71%
    ) !important;
...
html[saved-theme="light"] body kbd {
  background-color: color(srgb 0.0304 0.7296 0.31008 / 0.7);
  border-bottom-color: rgb(255, 255, 255);
  border-left-color: rgb(255, 255, 255);
  border-right-color: rgb(255, 255, 255);
  border-top-color: rgb(255, 255, 255);
...
html[saved-theme="light"] body ul.tags > li {
  background-color: color(srgb 0.0304 0.7296 0.31008 / 0.05);
