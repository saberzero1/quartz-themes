...
export const theme: ThemeData = {
  ...
  --bases-table-cell-background-selected: hsla(138, 59%, 54%, 0.1);
  --bases-table-cell-shadow-active: 0 0 0 2px #414141;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(138, 59%, 54%);
  ...
  --embed-border-start: 2px solid hsl(138, 59%, 54%);
  ...
  --hr-color: #313131;
  --icon-color: #666666;
  --icon-color-active: hsl(138, 59%, 54%);
  ...
  --list-marker-color-collapsed: hsl(138, 59%, 54%);
  ...
  --nav-item-background-selected: hsla(138, 59%, 54%, 0.15);
  ...
  --pill-color-remove-hover: hsl(138, 59%, 54%);
  ...
  --secondary: var(--text-accent, hsl(138, 59%, 54%));
...
html[saved-theme="dark"] body ul.tags > li {
  background-color: rgb(from var(--color-accent) r g b/0.05, color(srgb 0.2686 0.8114 0.43144 / 0.05));
  ...
  --bases-table-cell-background-selected: hsla(144, 92%, 38%, 0.1);
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(144, 92%, 38%);
  ...
  --embed-border-start: 2px solid hsl(144, 92%, 38%);
  ...
  --hr-color: #c7c7c7;
  --icon-color: #ababab;
  --icon-color-active: hsl(144, 92%, 38%);
  ...
  --list-marker-color-collapsed: hsl(144, 92%, 38%);
  ...
  --nav-item-background-selected: hsla(144, 92%, 38%, 0.15);
  ...
  --pill-color-remove-hover: hsl(144, 92%, 38%);
  ...
  --secondary: var(--text-accent, hsl(144, 92%, 38%));
...
html[saved-theme="light"] body ul.tags > li {
  background-color: rgb(from var(--color-accent) r g b/0.05, color(srgb 0.0304 0.7296 0.31008 / 0.05));
