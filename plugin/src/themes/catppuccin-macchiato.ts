...
export const theme: ThemeData = {
  ...
  --ctp-base: 36, 39, 58;
  --ctp-blockquote: var(--ctp-rosewater);
  --ctp-blue: 138, 173, 244;
  --ctp-bold: var(--ctp-sapphire);
  --ctp-crust: 24, 25, 38;
  --ctp-flamingo: 240, 198, 198;
  --ctp-green: 166, 218, 149;
  --ctp-h1: var(--ctp-accent);
  --ctp-h2: var(--ctp-accent);
  --ctp-h3: var(--ctp-accent);
  --ctp-h4: var(--ctp-accent);
  --ctp-h5: var(--ctp-accent);
  --ctp-h6: var(--ctp-accent);
  --ctp-italic: var(--ctp-green);
