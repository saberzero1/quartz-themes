...
export const theme: ThemeData = {
  ...
  --checkbox-border-color: var(--text-faint, #74593D);
  --checkbox-border-color-hover: var(--text-muted, #a3a5aa);
  ...
  --hr-color: var(--background-modifier-border, #110f10);
  --hr-thickness: 1px;
...
html body blockquote {
  background-color: var(--blockquote-background-color, rgba(176, 167, 158, 0.035));
...
html body .callout .callout-title > .callout-title-inner > p {
  color: var(--callout-title-color, rgb(116, 89, 61));
}
