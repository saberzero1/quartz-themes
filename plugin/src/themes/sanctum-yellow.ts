...
export const theme: ThemeData = {
  ...
  --table-hover-highlight-color: rgba(243, 189, 79, 0.15);
  --table-selection: hsla(24.4, 90.8%, 61.8%, 0.1);
  --table-selection-border-color: rgb(243, 189, 79);
  --table-sticky-height: 600px;
  --tag-background: rgba(243, 189, 79, 0.15);
  --tag-background-hover: rgba(243, 189, 79, 0.25);
  --tag-border-color: rgba(243, 189, 79, 0.15);
  --tag-border-color-hover: rgba(243, 189, 79, 0.25);
