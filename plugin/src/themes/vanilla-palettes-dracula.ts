...
export const theme: ThemeData = {
  ...
  --accent: hsl(265, 89%, 78%) !important;
  --accent-color-dark: #bd93f9 !important;
  --accent-color-hover: #50fa7b !important;
  --accent-color-light: #ff79c6 !important;
  ...
  --background-modifier-hover: #44475a !important;
  ...
  --bases-table-cell-background-selected: #44475a !important;
  --bases-table-cell-shadow-active: 0 0 0 2px #3e4452 !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(265, 89%, 78%) !important;
  --bases-table-header-background: #282a36 !important;
  --bases-table-header-background-hover: #44475a !important;
  --bases-table-header-color: #f8f8f2 !important;
  --bases-table-summary-background: #282a36 !important;
  --bases-table-summary-background-hover: #44475a !important;
  --bg: #282a36 !important;
  --black: #191a21 !important;
  --blockquote-border-color: #bd93f9 !important;
  ...
  --bold-color: #ff79c6 !important;
  --border-color: #4b5263 !important;
  --border-color-primary: #4b5263 !important;
  --border-color-secondary: #3e4452 !important;
  --bright-blue: #d6acff !important;
  --bright-cyan: #a4ffff !important;
  --bright-green: #69ff94 !important;
  --bright-magenta: #ff92df !important;
  --bright-red: #ff6e6e !important;
  --bright-white: #ffffff !important;
  --bright-yellow: #ffffa5 !important;
  ...
  --checkbox-border-color-hover: #50fa7b !important;
  --checkbox-color: #bd93f9 !important;
  --checkbox-color-hover: #50fa7b !important;
  --checkbox-marker-color: #282a36 !important;
  --checklist-done-color: #4b5263 !important;
  --code-background: #21222c !important;
  --code-boolean: #bd93f9 !important;
  --code-border-color: #4b5263 !important;
  --code-bracket-background: #44475a !important;
  --code-builtin: #50fa7b !important;
  --code-comment: #6272a4 !important;
  --code-definition: #f8f8f2 !important;
  --code-function: #f1fa8c !important;
  --code-important: #f1fa8c !important;
  --code-keyword: #ff79c6 !important;
  --code-normal: #f8f8f2 !important;
  --code-operator: #ff79c6 !important;
  --code-parentheses: #8be9fd !important;
  --code-property: #50fa7b !important;
  --code-punctuation: #f8f8f2 !important;
  --code-string: #f1fa8c !important;
  --code-tag: #ff5555 !important;
  --code-value: #bd93f9 !important;
  --code-variable: #bd93f9 !important;
  --collapse-icon-color: #4b5263 !important;
  --collapse-icon-color-collapsed: hsl(265, 89%, 78%) !important;
  --color-accent: hsl(265, 89%, 78%) !important;
  --color-accent-1: hsl(262, 90.78%, 89.7%) !important;
  --color-accent-2: hsl(260, 93.45%, 100.62%) !important;
  --color-accent-hsl: 265, 89%, 78% !important;
  --color-blue: #6272a4 !important;
  ...
  --divider-color-hover: hsl(265, 89%, 78%) !important;
  ...
  --embed-border-start: 2px solid hsl(265, 89%, 78%) !important;
  --fg: #f8f8f2 !important;
  ...
  --footnote-input-background-active: #44475a !important;
  --graph-line: #3e4452 !important;
  --graph-node: hsl(265, 89%, 78%) !important;
  --graph-node-attachment: #bd93f9 !important;
  --graph-node-focused: #50fa7b !important;
  --graph-node-tag: #ff79c6 !important;
  ...
  --h1-color: #bd93f9 !important;
  --h2-color: #ff79c6 !important;
  --h3-color: #50fa7b !important;
  --h4-color: #f1fa8c !important;
  --h5-color: #ffb86c !important;
  --h6-color: #ff5555 !important;
  --heading-formatting: #4b5263 !important;
  --highlight: hsl(265, 89%, 78%) !important;
  --hr-color: #3b4048 !important;
  --icon-color: #f8f8f2 !important;
  --icon-color-active: hsl(265, 89%, 78%) !important;
  ...
  --inline-title-color: #f8f8f2 !important;
  --input-date-separator: #4b5263 !important;
  --input-placeholder-color: #4b5263 !important;
  --interactive-accent: hsl(265, 89%, 78%) !important;
  --interactive-accent-hover: hsl(262, 90.78%, 89.7%) !important;
  --interactive-accent-hsl: 265, 89%, 78% !important;
  --interactive-hover: #4b5263 !important;
  --interactive-normal: #21222c !important;
  --italic-color: #ff79c6 !important;
  --light: #282a36 !important;
  --lightgray: #21222c !important;
  --link-color: #bd93f9 !important;
  --link-color-hover: #50fa7b !important;
  --link-external-color: #bd93f9 !important;
  --link-external-color-hover: #50fa7b !important;
  --link-unresolved-color: #ff5555 !important;
  --link-unresolved-color-hover: #ff5555 !important;
  --link-unresolved-decoration-color: hsla(265, 89%, 78%, 0.3) !important;
  --list-marker-color: #bd93f9 !important;
  --list-marker-color-collapsed: hsl(265, 89%, 78%) !important;
  ...
  --metadata-input-background-active: #44475a !important;
  --metadata-input-text-color: #f8f8f2 !important;
  --metadata-label-background-active: #44475a !important;
  --metadata-label-text-color: #f8f8f2 !important;
  --metadata-label-text-color-hover: #f8f8f2 !important;
  --metadata-property-background-active: #44475a !important;
  ...
  --nav-item-background-active: #bd93f9 !important;
  --nav-item-background-hover: #44475a !important;
  --nav-item-background-selected: red !important;
  --nav-item-color: #f8f8f2 !important;
  --nav-item-color-active: white !important;
  --nav-item-color-highlighted: #ff79c6 !important;
  ...
  --pill-color-remove-hover: hsl(265, 89%, 78%) !important;
  ...
  --secondary: hsl(265, 89%, 78%) !important;
  --selection: #44475a !important;
  --selection-background-color: #44475a !important;
  --selection-border-color: #50fa7b !important;
  --setting-group-heading-color: #f8f8f2 !important;
  --setting-items-border-color: #4b5263 !important;
  --slider-thumb-border-color: #191a21 !important;
  ...
  --sync-avatar-color-6: #6272a4 !important;
  ...
  --tab-divider-color: #44475a !important;
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(265, 89%, 78%) !important;
  ...
  --text-highlight-bg: hsl(265, 89%, 78%) !important;
  --text-muted: #f8f8f2 !important;
  --text-normal: #f8f8f2 !important;
  --text-on-accent-inverted: #282a36 !important;
  --text-selection: #44475a !important;
  --text-success: #50fa7b !important;
  --text-warning: #f1fa8c !important;
  --textHighlight: hsl(265, 89%, 78%) !important;
...
html[saved-theme="dark"] body .text-highlight {
  background-color: rgb(191, 149, 249);
  color: rgb(248, 248, 242);
...
html[saved-theme="dark"] body a.internal.broken {
  ...
  text-decoration-color: rgba(191, 149, 249, 0.3);
}`,
