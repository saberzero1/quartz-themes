...
html body h1 {
  color: rgba(0, 0, 0, 0);
  text-shadow: rgb(0, 255, 170) 0px 0px 7.67494px, rgba(0, 255, 65, 0.14) 0px 0px 3.9082px;
}
...
html body h2.page-title, html h2.page-title a {
  color: rgba(0, 0, 0, 0);
  text-shadow: rgb(0, 255, 170) 0px 0px 7.67482px, rgba(0, 255, 65, 0.14) 0px 0px 3.9079px;
}
