...
export const theme: ThemeData = {
  ...
  --background-modifier-form-field: var(--color-base-25, oklch(25% 0 0));
  ...
  --background-primary: var(--color-base-00, oklch(00% 0 0));
  --background-primary-alt: var(--color-base-10, oklch(15% 0 0));
  --background-secondary: var(--color-base-20, oklch(20% 0 0));
  --background-secondary-alt: var(--color-base-30, oklch(30% 0 0));
  --bases-cards-background: var(--trans-faint-10, oklch(100% 0 0 / 0.05));
  --bases-cards-cover-background: var(--background-primary-alt, oklch(15% 0 0));
  ...
  --bases-group-heading-property-color: var(--text-muted, oklch(70.00% 0 0));
  ...
  --bases-table-border-color: var(--table-border-color, oklch(100% 0 0 / 0.1375));
  --bases-table-cell-background-active: var(--background-primary, transparent);
  --bases-table-cell-background-disabled: var(--background-primary-alt, oklch(15% 0 0));
  --bases-table-cell-background-selected: var(--table-selection, hsla(5, 65%, 45%, 0.1));
  --bases-table-cell-shadow-active: var(--shadow-input-active, 0 0 0 2.5px color-mix(in oklab, hsl(5, 65%, 45%) 50%, transparent 75%));
  --bases-table-container-border-radius: var(--radius-s, 0);
  --bases-table-group-background: var(--background-primary-alt, transparent);
  --bases-table-header-background: var(--background-primary, oklch(00% 0 0));
  ...
  --bases-table-header-color-hover: var(--color-base-80, oklch(76.25% 0 0));
  ...
  --bases-table-summary-background: var(--background-primary, oklch(00% 0 0));
  ...
  --bg-main-inner: oklch(var(--bl-20) var(--bsat-xtr) 0);
  --bg-main-outer: oklch(var(--bl-10) var(--bsat-xtr) 0);
  ...
  --blockquote-color: var(--text-muted, oklch(70.00% 0 0));
  --blur-brightness: 1;
  --blur-radius-m: 12px;
  --blur-radius-s: 8px;
  ...
  --bold-color: var(--color-base-100, oklch(86.25% 0 0));
  --bold-modifier: 250;
  --bsat-low: 0;
  --bsat-med: 0;
  --bsat-modal: 0;
  ...
  --canvas-background: var(--background-primary, oklch(00% 0 0));
  ...
  --canvas-dot-pattern: var(--color-base-30, oklch(30% 0 0));
  --caret-color: var(--text-normal, oklch(80.00% 0 0));
  --checkbox-border-color: var(--color-base-40, oklch(43.75% 0 0));
  --checkbox-border-color-hover: var(--text-muted, oklch(70.00% 0 0));
  --checkbox-color: var(--interactive-accent, hsl(5, 65%, 45%));
  --checkbox-color-hover: var(--interactive-accent-hover, color-mix(in oklab, hsl(5, 65%, 45%) 62.5%, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%)));
  ...
  --code-background-alt: var(--trans-strong-10, oklch(from oklch(05% 0 0) l 0 h / 0.375));
  ...
  --code-normal: var(--text-normal, oklch(80.00% 0 0));
  --code-punctuation: var(--text-muted, oklch(70.00% 0 0));
  --code-radius: var(--radius-xs, 6px);
  --code-special: var(--color-red, #fb464c);
  --collapse-icon-color: var(--text-faint, oklch(52.50% 0 0));
  --collapse-icon-color-collapsed: var(--text-accent, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%));
  ...
  --control-icon-color: var(--color-base-80, oklch(76.25% 0 0));
  --control-icon-shadow: var(--glass-base), 0px 0px 12px 0px var(--trans-strong-10);
  --corner-smoothing: 60%;
  --dark: var(--text-normal, var(--color-base-90, oklch(80.00% 0 0)));
  --darkgray: var(--text-normal, var(--color-base-90, oklch(80.00% 0 0)));
  --dialog-width: 500px;
  --divider-color: var(--background-modifier-border, oklch(100% 0 0 / 0.0625));
  --divider-color-hover: var(--color-accent-3, color-mix(in oklab, hsl(5, 65%, 45%) 50%, transparent 75%));
  --divider-width: 0;
  --drag-ghost-background: var(--color-base-00, oklch(00% 0 0));
  --drag-ghost-text-color: var(--color-base-90, oklch(80.00% 0 0));
  --dropdown-background: var(--interactive-normal, oklch(30% 0 0));
  --dropdown-background-hover: var(--interactive-hover, oklch(36.25% 0 0));
  --fab-bg: var(--background-primary, oklch(00% 0 0));
  --fab-color: var(--icon-color, oklch(63.75% 0 0));
  --fab-color-active: var(--text-normal, oklch(80.00% 0 0));
  --fab-easing-curve: cubic-bezier(0.55, 2, 0.5, 0.97);
  --file-header-background: var(--background-primary, oklch(00% 0 0));
  --file-header-background-focused: var(--background-primary, oklch(00% 0 0));
  ...
  --flair-background: var(--interactive-normal, oklch(30% 0 0));
  --flair-color: var(--text-normal, oklch(80.00% 0 0));
  ...
  --footnote-id-color: var(--text-muted, oklch(70.00% 0 0));
  ...
  --graph-node: var(--text-muted, oklch(70.00% 0 0));
  --graph-node-focused: var(--text-accent, transparent);
  --graph-node-unresolved: var(--text-faint, oklch(52.50% 0 0));
  --graph-text: var(--text-normal, oklch(80.00% 0 0));
  --gray: var(--text-muted, var(--color-base-70, oklch(70.00% 0 0)));
  ...
  --h2-size: 1.5em;
  --h2-weight: 570;
  --h3-color: var(--color-base-90, oklch(80.00% 0 0));
  --h3-size: 1.375em;
  --h3-weight: 570;
  --h4-color: var(--color-base-90, oklch(80.00% 0 0));
  --h4-size: 1.25em;
  --h4-weight: 570;
  --h5-color: var(--color-base-90, oklch(80.00% 0 0));
  --h5-line-height: var(--line-height-normal, 1.6);
  --h5-size: 1.125em;
  --h6-color: var(--color-base-80, oklch(76.25% 0 0));
  ...
  --hr-color: var(--trans-faint-30, oklch(100% 0 0 / 0.1375));
  --icon-color: var(--color-base-60, oklch(63.75% 0 0));
  --icon-color-active: var(--text-accent, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%));
  --icon-color-focused: var(--icon-color-hover, oklch(80.00% 0 0));
  --icon-color-hover: var(--text-normal, oklch(80.00% 0 0));
  ...
  --indent-unit: 0.375em;
  --indentation-guide-color: var(--trans-faint-30, oklch(100% 0 0 / 0.1375));
  --indentation-guide-width: var(--border-width, 0);
  --indentation-guide-width-active: var(--border-width, 0);
  --inline-title-color: var(--h1-color, oklch(82.5% 0 0));
  ...
  --interactive-accent: var(--color-accent, hsl(5, 65%, 45%));
  --interactive-accent-hover: color-mix(in oklab, var(--color-accent) 62.5%, var(--color-accent-1));
  --interactive-accent-hsl: var(--color-accent-hsl, 5, 65%, 45%);
  --interactive-hover: var(--trans-faint-30, oklch(36.25% 0 0));
  --interactive-normal: var(--color-base-30, oklch(30% 0 0));
  --light: var(--background-primary, var(--color-base-00, oklch(00% 0 0)));
  --lightgray: var(--background-secondary, var(--color-base-20, oklch(20% 0 0)));
  --line-height-normal: 1.6;
  --link-color: var(--text-accent, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%));
  --link-color-hover: var(--text-accent-hover, color-mix(in oklab, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%), transparent 8%));
  --link-color-sidebar: var(--color-accent-2, color-mix(in oklab, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%), transparent 8%));
  --link-decoration: none;
  --link-decoration-hover: none;
  --link-external-color: var(--text-accent, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%));
  --link-external-color-hover: var(--text-accent-hover, color-mix(in oklab, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%), transparent 8%));
  ...
  --list-bullet-color: var(--color-base-80, oklch(76.25% 0 0));
  --list-dash-color: var(--trans-faint-60, oklch(100% 0 0 / 0.35));
  --list-marker-color: var(--color-base-50, oklch(52.50% 0 0));
  --list-marker-color-collapsed: var(--text-accent, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%));
  --list-marker-color-hover: var(--text-muted, oklch(70.00% 0 0));
  --list-spacing: 0.125em;
  --math-color: var(--color-base-100, oklch(86.25% 0 0));
  --menu-background: var(--background-primary-alt, oklch(15% 0 0));
  ...
  --metadata-input-text-color: var(--text-normal, oklch(80.00% 0 0));
  ...
  --metadata-property-box-shadow-focus: var(--shadow-input-active, 0 0 0 2.5px color-mix(in oklab, hsl(5, 65%, 45%) 50%, transparent 75%));
  ...
  --modal-background: oklch(21.25% var(--bsat-modal) var(--bhue) / 0.675);
  --modal-border-width: var(--border-width, 0);
  --modal-community-header-bg: var(--trans-strong-20, oklch(from oklch(20% 0 0) l 0 h / 0.5));
  --modal-community-item-bg: var(--trans-strong-40, oklch(from oklch(30% 0 0) l 0 h / 0.5));
  --modal-radius: var(--radius-xxl, 22px);
  --modal-small-background: oklch(21.25% var(--bsat-modal) var(--bhue) / 0.675);
  ...
  --nav-folder-color: var(--color-base-80, oklch(76.25% 0 0));
  --nav-header-bg: var(--divider-color, oklch(100% 0 0 / 0.0625));
  --nav-header-timing: var(--vl-ease-out, cubic-bezier(0.3, 0.75, 0, 1));
  --nav-heading-color: var(--color-base-80, oklch(76.25% 0 0));
  --nav-heading-color-collapsed: var(--text-faint, oklch(52.50% 0 0));
  --nav-heading-color-collapsed-hover: var(--text-muted, oklch(70.00% 0 0));
  --nav-heading-color-hover: var(--text-normal, oklch(80.00% 0 0));
  --nav-heading-weight: var(--font-medium, 520);
  --nav-heading-weight-hover: var(--font-medium, 520);
  --nav-indentation-guide-color: var(--trans-faint-30, oklch(100% 0 0 / 0.1375));
  ...
  --nav-item-color: var(--text-muted, oklch(70.00% 0 0));
  --nav-item-color-active: var(--text-normal, oklch(80.00% 0 0));
  --nav-item-color-highlighted: var(--text-accent, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%));
  --nav-item-color-hover: var(--text-normal, oklch(80.00% 0 0));
  --nav-item-color-selected: var(--text-normal, oklch(80.00% 0 0));
  --nav-item-radius: var(--radius-s, 8px);
  --nav-tag-color: var(--text-faint, oklch(52.50% 0 0));
  --nav-tag-color-active: var(--text-muted, oklch(70.00% 0 0));
  --nav-tag-color-hover: var(--text-muted, oklch(70.00% 0 0));
  --nav-tag-radius: var(--radius-s, 8px);
  --nav-tag-weight: var(--font-semibold, 620);
  --nav-text-color: var(--text-normal, oklch(80.00% 0 0));
  --paint-description: "A zero-frills, borderline spartan paint scheme. Its pitch black high contrast is perfectly suited for power users, as well as OLED screens.";
  ...
  --pdf-background: var(--background-primary, oklch(00% 0 0));
  --pdf-page-background: var(--background-primary, oklch(00% 0 0));
  --pdf-sidebar-background: var(--background-primary, oklch(00% 0 0));
  --pdf-spread-shadow: none;
  --pdf-thumbnail-shadow: var(--shadow-input, 0 0 0 1px oklch(100% 0 0 / 0.0625));
  --pill-background: var(--trans-faint-25, oklch(100% 0 0 / 0.08125));
  --pill-background-hover: var(--trans-faint-25, oklch(100% 0 0 / 0.08125));
  ...
  --pill-color: var(--text-muted, oklch(70.00% 0 0));
  --pill-color-hover: var(--text-muted, oklch(70.00% 0 0));
  ...
  --prompt-background: var(--modal-background, oklch(21.25% 0 0 / 0.675));
  ...
  --radius-xs: 6px;
  --radius-xxl: 22px;
  --raised-background: var(--blur-background, color-mix(in srgb, oklch(30% 0 0) 65%, transparent) linear-gradient(oklch(30% 0 0), color-mix(in srgb, oklch(30% 0 0) 65%, transparent)));
  ...
  --scrollbar-thumb-bg: var(--color-base-25, oklch(25% 0 0));
  ...
  --search-result-background: var(--trans-strong-10, oklch(from oklch(05% 0 0) l 0 h / 0.375));
  --secondary: var(--text-accent, var(--color-accent-1, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%)));
  ...
  --setting-items-background: var(--background-primary, oklch(00% 0 0));
  ...
  --settings-background: var(--color-base-20, oklch(20% 0 0));
  ...
  --shiki-active-tab-border-color: var(--shiki-highlight-neutral, oklch(70.00% 0 0));
  ...
  --shiki-code-normal: var(--text-muted, oklch(70.00% 0 0));
  --shiki-code-punctuation: var(--text-muted, oklch(70.00% 0 0));
  ...
  --shiki-gutter-text-color-highlight: var(--shiki-code-normal, oklch(70.00% 0 0));
  --shiki-highlight-neutral: var(--shiki-code-normal, oklch(70.00% 0 0));
  ...
  --status-bar-text-color: var(--text-muted, oklch(70.00% 0 0));
  --strikethrough-color: var(--text-faint, oklch(52.50% 0 0));
  --suggestion-background: var(--background-primary, oklch(00% 0 0));
  --tab-background-active: var(--background-primary, oklch(00% 0 0));
  ...
  --tab-right-fade-alt: linear-gradient(to left, oklch(var(--bl-20) 0 0) 80%, transparent);
  ...
  --tab-switcher-background: var(--background-secondary, oklch(20% 0 0));
  --tab-switcher-preview-radius: var(--radius-xl, 20px);
  --tab-text-color: var(--icon-color, oklch(63.75% 0 0));
  --tab-text-color-active: var(--color-base-100, oklch(86.25% 0 0));
  --tab-text-color-focused: var(--icon-color, oklch(63.75% 0 0));
  --tab-text-color-focused-active: var(--color-base-100, oklch(86.25% 0 0));
  --tab-text-color-focused-active-current: var(--color-base-100, oklch(86.25% 0 0));
  --tab-text-color-focused-highlighted: var(--text-accent, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%));
  --tab-width: 240px;
  --table-add-button-border-color: var(--background-modifier-border, oklch(100% 0 0 / 0.0625));
  --table-border-color: var(--trans-faint-30, oklch(100% 0 0 / 0.1375));
  --table-drag-handle-background-active: var(--table-selection-border-color, hsl(5, 65%, 45%));
  --table-drag-handle-color: var(--text-faint, oklch(52.50% 0 0));
  --table-header-border-color: var(--table-border-color, oklch(100% 0 0 / 0.1375));
  ...
  --table-row-alt-background: var(--table-row-bg, oklch(100% 0 0 / 0.05));
  --table-row-alt-background-hover: var(--table-row-bg, oklch(100% 0 0 / 0.05));
  --table-row-bg: var(--trans-faint-10, oklch(100% 0 0 / 0.05));
  --table-selection-border-color: var(--interactive-accent, hsl(5, 65%, 45%));
  ...
  --tag-color: var(--text-accent, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%));
  --tag-color-hover: var(--text-accent, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%));
  --tag-padding-x: 0.6875em;
  --tag-padding-y: 0.3125em;
  --tag-size: var(--font-smallest, 0.8em);
  --tag-weight: var(--font-semi-medium, 490);
  --tertiary: var(--text-accent-hover, var(--color-accent-2, color-mix(in oklab, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%), transparent 8%)));
  --text-accent: var(--color-accent-1, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%));
  --text-accent-hover: var(--color-accent-2, color-mix(in oklab, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%), transparent 8%));
  ...
  --text-muted: var(--color-base-70, oklch(70.00% 0 0));
  --text-normal: var(--color-base-90, oklch(80.00% 0 0));
  ...
  --titlebar-text-color-focused: var(--text-muted, oklch(70.00% 0 0));
  ...
  --vault-profile-color-hover: var(--text-muted, oklch(70.00% 0 0));
...
html[saved-theme="dark"] body[data-slug] div#quartz-root.page, html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left, html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left:has(.explorer), html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left .explorer .explorer-content {
  --background-modifier-form-field: var(--search-result-background, oklch(from oklch(05% 0 0) l 0 h / 0.375));
  --background-modifier-form-field-hover: var(--background-modifier-form-field, oklch(from oklch(05% 0 0) l 0 h / 0.375));
  --bases-table-header-background: var(--background-secondary, oklch(20% 0 0));
...
html[saved-theme="dark"] body .page > div#quartz-body div.sidebar.right {
  ...
  --background-modifier-active-hover: hsla(5, 65%, 45%, 0.1);
  ...
  --background-modifier-form-field: oklch(25% 0 0);
  ...
  --background-primary: oklch(00% 0 0);
  --background-primary-alt: oklch(15% 0 0);
  --background-secondary: oklch(20% 0 0);
  --background-secondary-alt: oklch(30% 0 0);
  --bg-checkbox: radial-gradient(transparent 50%, oklch(43.75% 0 0) 55% 60%, transparent 65%);
  --bg-main-inner: oklch(20% 0 0);
  --bg-main-outer: oklch(15% 0 0);
  --bg-main-workspace: radial-gradient(at 50% 50%, oklch(20% 0 0) 0%, oklch(15% 0 0) 200%);
  --blockquote-border-color: oklch(52.50% 0 0);
  --blockquote-color: oklch(70.00% 0 0);
  --blur-background: color-mix(in srgb, oklch(30% 0 0) 65%, transparent) linear-gradient(oklch(30% 0 0), color-mix(in srgb, oklch(30% 0 0) 65%, transparent));
  ...
  --canvas-background: oklch(00% 0 0);
  --canvas-controls-icon-size: 16px;
  --canvas-controls-icon-stroke: 2px;
  --canvas-controls-radius: 8px;
  --canvas-dot-pattern: oklch(30% 0 0);
  --caret-color: oklch(80.00% 0 0);
  --checkbox-border-color: oklch(43.75% 0 0);
  --checkbox-border-color-hover: oklch(70.00% 0 0);
  --checkbox-color: hsl(5, 65%, 45%);
  --checkbox-color-hover: color-mix(in oklab, hsl(5, 65%, 45%) 62.5%, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%));
  ...
  --code-background-alt: oklch(from oklch(05% 0 0) l 0 h / 0.375);
  ...
  --code-keyword: #fa99cd;
  --code-normal: oklch(80.00% 0 0);
  --code-operator: #fb464c;
  --code-property: #53dfdd;
  --code-punctuation: oklch(70.00% 0 0);
  --code-radius: 6px;
  --code-size: 0.875em;
  --code-special: #fb464c;
  --code-string: #44cf6e;
  ...
  --collapse-icon-color-collapsed: color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%);
  --color-accent: hsl(5, 65%, 45%);
  --color-accent-1: color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%);
  --color-accent-2: color-mix(in oklab, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%), transparent 8%);
  --color-accent-3: color-mix(in oklab, hsl(5, 65%, 45%) 50%, transparent 75%);
  --color-accent-4: color-mix(in oklab, oklab(from hsl(5, 65%, 45%) l a b / 0.25) 30%, transparent 70%);
  --color-accent-hsl: 5, 65%, 45%;
  --color-base-00: oklch(00% 0 0);
  --color-base-05: oklch(05% 0 0);
  --color-base-10: oklch(15% 0 0);
  --color-base-100: oklch(86.25% 0 0);
  --color-base-20: oklch(20% 0 0);
  --color-base-25: oklch(25% 0 0);
  --color-base-30: oklch(30% 0 0);
  ...
  --color-base-70: oklch(70.00% 0 0);
  --color-base-80: oklch(76.25% 0 0);
  --color-base-90: oklch(80.00% 0 0);
  --color-highlight: rgb(255, 208, 0);
  --color-highlight-rgb: 255, 208, 0;
  --control-icon-background: oklch(100% 0 0 / 0.0625);
  --control-icon-color: oklch(76.25% 0 0);
  --control-icon-shadow: inset 0.875px 1.625px 2px -1px rgba(255, 255, 255, 0.263), inset -0.875px -1.625px 2px -1px rgba(255, 255, 255, 0.188), inset 0 8px 16px rgba(255, 255, 255, 0.025), 0px 0px 12px 0px oklch(from oklch(05% 0 0) l 0 h / 0.375);
  --divider-color: oklch(100% 0 0 / 0.0625);
  --divider-color-hover: color-mix(in oklab, hsl(5, 65%, 45%) 50%, transparent 75%);
  --divider-vertical-height: 100%;
  --dropdown-background: oklch(30% 0 0);
  ...
  --fab-color-active: oklch(80.00% 0 0);
  --flair-background: oklch(30% 0 0);
  --flair-color: oklch(80.00% 0 0);
  ...
  --glass-button: inset 3px 3px 1.5px -1.25px oklab(from hsl(5, 65%, 45%) calc(l + 0.075) a b / 0.75), inset -3px -3px 1.5px -1.25px oklab(from hsl(5, 65%, 45%) calc(l + 0.075) a b / 0.5);
  ...
  --glass-button-l: inset 3.75px 3.75px 1.5px -1.25px oklab(from hsl(5, 65%, 45%) calc(l + 0.075) a b / 0.75), inset -3.75px -3.75px 1.5px -1.25px oklab(from hsl(5, 65%, 45%) calc(l + 0.075) a b / 0.5);
  --graph-line: oklch(36.25% 0 0);
  --graph-node: oklch(70.00% 0 0);
  --graph-node-attachment: #e0de71;
  --graph-node-focused: transparent;
  --graph-node-tag: #44cf6e;
  --graph-node-unresolved: oklch(52.50% 0 0);
  --graph-text: oklch(80.00% 0 0);
  --h1-color: oklch(82.5% 0 0);
  --h2-color: oklch(81.25% 0 0);
  --h3-color: oklch(80.00% 0 0);
  --h4-color: oklch(80.00% 0 0);
  --h5-color: oklch(80.00% 0 0);
  --h5-line-height: 1.6;
  --h6-color: oklch(76.25% 0 0);
  --h6-line-height: 1.6;
  ...
  --hotkey-gradient: linear-gradient(to top, hsl(5, 65%, 45%) -10%, color-mix(in oklab, oklab(from hsl(5, 65%, 45%) l a b / 0.25) 30%, transparent 70%) 210%);
  --hr-color: oklch(100% 0 0 / 0.1375);
  --hr-spacing: 2.25rem;
  --interactive-accent: hsl(5, 65%, 45%);
  --interactive-accent-hover: color-mix(in oklab, hsl(5, 65%, 45%) 62.5%, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%));
  --interactive-accent-hsl: 5, 65%, 45%;
  --interactive-hover: oklch(36.25% 0 0);
  --interactive-normal: oklch(30% 0 0);
  --left-margin-delay: 150ms;
  --link-color: color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%);
  --link-color-hover: color-mix(in oklab, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%), transparent 8%);
  --link-color-sidebar: color-mix(in oklab, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%), transparent 8%);
  --link-external-color: color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%);
  --link-external-color-hover: color-mix(in oklab, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%), transparent 8%);
  --link-unresolved-color: oklch(from color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%) l c h / 0.75);
  --link-unresolved-decoration-color: hsla(5, 65%, 45%, 0.3);
  --link-weight: 420;
  --list-bullet-color: oklch(76.25% 0 0);
  --list-dash-color: oklch(100% 0 0 / 0.35);
  --list-indent: 1.5em;
  --math-color: oklch(86.25% 0 0);
  --menu-background: oklch(15% 0 0);
  ...
  --p-spacing: 1.125rem;
  --pdf-background: oklch(00% 0 0);
  --pdf-page-background: oklch(00% 0 0);
  --pdf-shadow: none;
  --pdf-sidebar-background: oklch(00% 0 0);
  --pdf-thumbnail-shadow: 0 0 0 1px oklch(100% 0 0 / 0.0625);
  --popover-font-size: 16px;
  --raised-background: color-mix(in srgb, oklch(30% 0 0) 65%, transparent) linear-gradient(oklch(30% 0 0), color-mix(in srgb, oklch(30% 0 0) 65%, transparent));
  ...
  --scrollbar-thumb-bg: oklch(25% 0 0);
  --search-clear-button-color: oklch(52.50% 0 0);
  --search-icon-color: oklch(52.50% 0 0);
  --search-result-background: oklch(from oklch(05% 0 0) l 0 h / 0.375);
  --setting-group-heading-color: oklch(63.75% 0 0);
  --setting-group-heading-size: 18px;
  --setting-group-heading-weight: 520;
  --setting-item-background: color-mix(in oklab, oklch(00% 0 0) 87.5%, oklch(20% 0 0));
  --setting-items-background: oklch(00% 0 0);
  --setting-items-border-color: oklch(100% 0 0 / 0.0625);
  --setting-items-padding: 16px;
  --setting-items-radius: 16px;
  --settings-background: oklch(20% 0 0);
  --shadow-button: inset 3px 3px 1.5px -1.25px oklab(from hsl(5, 65%, 45%) calc(l + 0.075) a b / 0.75), inset -3px -3px 1.5px -1.25px oklab(from hsl(5, 65%, 45%) calc(l + 0.075) a b / 0.5), 0px 3px 15px 0px oklch(from oklch(00% 0 0) l 0 h / 0.75);
  --shadow-button-error: inset 3.25px 3.25px 1.25px -1.25px oklab(from #fb464c calc(l + 0.075) a b / 0.75), inset -3.25px -3.25px 1.25px -1.25px oklab(from #fb464c calc(l + 0.075) a b / 0.5), 0px 3px 15px 0px oklch(from oklch(00% 0 0) l 0 h / 0.75);
  ...
  --shadow-faint: 0px 3px 15px 0px oklch(from oklch(00% 0 0) l 0 h / 0.75);
  --shadow-input: 0 0 0 0.5px oklch(100% 0 0 / 0.125);
  --shadow-input-active: 0 0 0 2.5px color-mix(in oklab, hsl(5, 65%, 45%) 50%, transparent 75%);
  ...
  --shadow-setting-items: 0 4px 12px 0 oklch(from oklch(05% 0 0) l 0 h / 0.375);
  --shadow-setting-items-top: inset 1px 2px 2px 0 oklch(from oklch(05% 0 0) l 0 h / 0.375), 0px 1px 9px oklch(100% 0 0 / 0.025);
  --shadow-sidebar: 0px 0px 12px 0px oklch(from oklch(20% 0 0) l 0 h / 0.5);
  --shadow-strong: 0px 0px 24px 0px oklch(0 0 0 / 0.375);
  --shadow-suggestion-item: inset 3.75px 3.75px 1.5px -1.25px oklab(from hsl(5, 65%, 45%) calc(l + 0.075) a b / 0.75), inset -3.75px -3.75px 1.5px -1.25px oklab(from hsl(5, 65%, 45%) calc(l + 0.075) a b / 0.5), 0px 3px 18px 0px oklch(0 0 0 / 0.1875);
  ...
  --shadow-toggle: inset 1.5px 1.5px 1.5px 0px oklab(from hsl(5, 65%, 45%) calc(l + 0.075) a b / 0.75), inset -1.5px -1.5px 1.5px 0px oklab(from hsl(5, 65%, 45%) calc(l + 0.075) a b / 0.5);
  --shadow-workspace: 0 0 0 0.5px oklch(100% 0 0 / 0.1375), 0 0 20px oklch(from oklch(00% 0 0) l 0 h / 0.75);
  --shadow-workspace-multi: 0 0 0 0.5px oklch(100% 0 0 / 0.1375);
  --shiki-active-tab-border-color: oklch(70.00% 0 0);
  ...
  --shiki-code-normal: oklch(70.00% 0 0);
  --shiki-code-property: #53dfdd;
  --shiki-code-punctuation: oklch(70.00% 0 0);
  ...
  --suggestion-background: oklch(00% 0 0);
  ...
  --tab-background-active: oklch(00% 0 0);
  ...
  --tab-radius: 8px;
  --tab-right-fade: linear-gradient(to left, oklch(25% 0 0) 80%, transparent);
  --tab-right-fade-alt: linear-gradient(to left, oklch(20% 0 0) 80%, transparent);
  ...
  --tab-switcher-background: oklch(20% 0 0);
  --tab-switcher-menubar-background: linear-gradient(to top, oklch(20% 0 0), transparent);
  --tab-switcher-preview-radius: 20px;
  --tab-switcher-preview-shadow: 0 0 0 1px rgba(255, 255, 255, 0.05);
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(5, 65%, 45%);
  --tab-text-color: oklch(63.75% 0 0);
  --tab-text-color-active: oklch(86.25% 0 0);
  --tab-text-color-focused: oklch(63.75% 0 0);
  --tab-text-color-focused-active: oklch(86.25% 0 0);
  --tab-text-color-focused-active-current: oklch(86.25% 0 0);
  --tab-text-color-focused-highlighted: color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%);
  --table-add-button-border-color: oklch(100% 0 0 / 0.0625);
  --table-add-button-border-width: 1px;
  --table-border-color: oklch(100% 0 0 / 0.1375);
  --table-column-first-border-width: 1px;
  --table-column-last-border-width: 1px;
  --table-drag-handle-background-active: hsl(5, 65%, 45%);
  --table-drag-handle-color: oklch(52.50% 0 0);
  --table-drag-handle-color-active: white;
  --table-header-border-color: oklch(100% 0 0 / 0.1375);
  --table-header-border-width: 1px;
  --table-header-color: oklch(63.75% 0 0);
  --table-header-size: 0.90625em;
  --table-header-weight: 520;
  --table-line-height: 1.6;
  --table-row-alt-background: oklch(100% 0 0 / 0.05);
  --table-row-alt-background-hover: oklch(100% 0 0 / 0.05);
  --table-row-bg: oklch(100% 0 0 / 0.05);
  --table-row-last-border-width: 1px;
  --table-selection: hsla(5, 65%, 45%, 0.1);
  --table-selection-blend-mode: lighten;
  --table-selection-border-color: hsl(5, 65%, 45%);
  --table-text-size: 0.90625em;
  --table-text-weight: 420;
  --tag-background: hsla(5, 65%, 45%, 0.1);
  --tag-background-hover: hsla(5, 65%, 45%, 0.2);
  --tag-border-color: oklch(from hsl(5, 65%, 45%) l c h / 0.025);
  --tag-border-color-hover: hsla(5, 65%, 45%, 0.15);
  --tag-color: color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%);
  --tag-color-hover: color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%);
  --tag-size: 0.8em;
  --tag-weight: 490;
  --text-accent: color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%);
  --text-accent-hover: color-mix(in oklab, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%), transparent 8%);
  --text-error: #fb464c;
  ...
  --text-muted: oklch(70.00% 0 0);
  --text-normal: oklch(80.00% 0 0);
  --text-selection: oklab(from hsl(5, 65%, 45%) l a b / 0.25);
  --text-success: #44cf6e;
  --text-warning: #e9973f;
  --touch-radius-l: 52px;
  --touch-radius-m: 44px;
  ...
  --trans-faint-30: oklch(100% 0 0 / 0.1375);
  --trans-faint-40: oklch(100% 0 0 / 0.125);
  --trans-faint-50: oklch(100% 0 0 / 0.2);
  --trans-faint-60: oklch(100% 0 0 / 0.35);
  --trans-strong-00: oklch(from oklch(00% 0 0) l 0 h / 0.75);
  --trans-strong-05: oklch(from oklch(00% 0 0) l 0 h / 0.625);
  --trans-strong-10: oklch(from oklch(05% 0 0) l 0 h / 0.375);
  --trans-strong-20: oklch(from oklch(20% 0 0) l 0 h / 0.5);
  --trans-strong-30: oklch(from oklch(30% 0 0) l 0 h / 0.5);
  --trans-strong-40: oklch(from oklch(30% 0 0) l 0 h / 0.5);
  --trans-white-00: oklch(86.25% 0 0 / 0.75);
  --trans-white-10: oklch(86.25% 0 0 / 0.625);
  --warning-gradient: linear-gradient(to top, #fb464c -30%, oklch(from oklch(20% 0 0) l 0 h / 0.5) 180%);
  background-color: oklch(1 0 0 / 0.1375);
...
html[saved-theme="dark"] body .markdown-rendered p > b, html[saved-theme="dark"] b {
  color: var(--bold-color, oklch(0.8625 0 0));
...
html[saved-theme="dark"] body .markdown-rendered p > em, html[saved-theme="dark"] em {
  color: var(--italic-color, oklch(0.8 0 0));
  font-family: Raveo, Raveo, Inter, ui-sans-serif, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  font-weight: 420;
...
html[saved-theme="dark"] body .text-highlight {
  ...
  color: var(--text-normal, oklch(0.8625 0 0));
  font-family: Raveo, Raveo, Inter, ui-sans-serif, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  font-weight: 420;
  outline: oklch(0.8625 0 0) none 0px;
  text-decoration-color: oklch(0.8625 0 0);
...
html[saved-theme="dark"] body del {
  ...
  --text-highlight-bg: var(--hr-color, oklch(100% 0 0 / 0.1375));
...
html[saved-theme="dark"] body h1.article-title {
  color: var(--text-normal, oklch(0.8 0 0));
  font-weight: 490;
}
...
html[saved-theme="dark"] body li.task-list-item input[type="checkbox"]:checked {
  ...
  background-color: var(--checkbox-color, rgb(189, 53, 40));
  border-color: rgb(255, 255, 255);
}

html[saved-theme="dark"] body p {
  color: var(--text-muted, oklch(0.7 0 0));
  font-family: Raveo, Raveo, Inter, ui-sans-serif, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif, "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  font-weight: 420;
  ...
  color: var(--link-external-color, oklab(0.701721 0.0979667 0.0550956));
  font-family: Raveo, Raveo, Inter, ui-sans-serif, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  font-weight: var(--link-weight, 420);
...
html[saved-theme="dark"] body a.internal-link, html[saved-theme="dark"] .breadcrumb-container .breadcrumb-element > a {
  --font-weight: var(--link-weight, 420);
  color: var(--link-color, oklab(0.701721 0.0979667 0.0550956));
  font-family: Raveo, Raveo, Inter, ui-sans-serif, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  font-weight: var(--link-weight, 420);
  outline: oklab(0.701721 0.0979667 0.0550956) none 0px;
  text-decoration-color: oklab(0.701721 0.0979667 0.0550956);
...
html[saved-theme="dark"] body a.internal-link.broken {
  --font-weight: var(--link-weight, 420);
  color: var(--link-unresolved-color, oklch(0.701721 0.112397 29.353 / 0.75));
  font-family: Raveo, Raveo, Inter, ui-sans-serif, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  font-weight: var(--link-weight, 420);
  outline: oklch(0.701721 0.112397 29.353 / 0.75) none 0px;
  text-decoration: rgba(189, 53, 40, 0.3);
  text-decoration-color: var(--link-unresolved-decoration-color, rgba(189, 53, 40, 0.3));
  transition: opacity 0.15s ease-in-out;
}`,
...
html[saved-theme="dark"] body ol > li {
  --checkbox-color-hover: oklab(from var(--checkbox-color) calc(l * 1.125) a b);
  --list-marker-color: var(--list-bullet-color, oklch(76.25% 0 0));
  color: oklch(0.8 0 0);
}
...
html[saved-theme="dark"] body blockquote {
  --bold-color: var(--blockquote-color, oklch(70.00% 0 0));
  --italic-color: var(--blockquote-color, oklch(70.00% 0 0));
...
html[saved-theme="dark"] body tbody tr:nth-child(odd) {
  background-color: var(--table-row-alt-background, oklch(1 0 0 / 0.05));
}
...
html[saved-theme="dark"] body td {
  ...
  border-top-color: oklch(0.8 0 0);
  border-top-width: 0px;
  color: var(--table-text-color, oklch(0.8 0 0));
  font-weight: var(--font-normal, 420);
  padding-left: 12px;
  padding-right: 12px;
}
...
html[saved-theme="dark"] body th {
  ...
  color: var(--code-normal, oklch(0.8 0 0));
  padding-left: 6px;
  padding-right: 6px;
}
...
html[saved-theme="dark"] body video {
  ...
  background-color: var(--background-primary-alt, oklch(0.15 0 0));
...
html[saved-theme="dark"] body .callout > .callout-content {
  ...
  --blockquote-color: var(--color-base-80, oklch(76.25% 0 0));
  --code-background: var(--code-background-alt, oklch(from oklch(05% 0 0) l 0 h / 0.375));
  color: oklch(0.8 0 0);
  padding-left: 28px;
}
...
html[saved-theme="dark"] body .callout[data-callout="quote"] {
  ...
  --text-normal: var(--blockquote-color, oklch(70.00% 0 0));
  ...
  border-top-left-radius: 10px;
  border-top-right-radius: 10px;
  color: var(--text-normal, oklch(0.7 0 0));
}
...
html[saved-theme="dark"] body .callout[data-callout="warning"] {
  ...
  --shadow-input: var(--shadow-sidebar, 0px 0px 12px 0px oklch(from oklch(20% 0 0) l 0 h / 0.5));
...
html[saved-theme="dark"] body .search > .search-container > .search-space {
  background-color: var(--prompt-background, oklch(0.2125 0 0 / 0.675));
...
html[saved-theme="dark"] body a.internal-link.tag-link, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  --icon-stroke: var(--icon-xs-stroke-width, 2.125px);
  --pill-background: var(--tag-background, hsla(5, 65%, 45%, 0.1));
  --pill-background-hover: var(--tag-background-hover, hsla(5, 65%, 45%, 0.2));
  --pill-border-color: var(--tag-border-color, oklch(from hsl(5, 65%, 45%) l c h / 0.025));
  --pill-border-color-hover: var(--tag-border-color-hover, hsla(5, 65%, 45%, 0.15));
  --pill-color: var(--tag-color, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%));
  --pill-color-hover: var(--tag-color-hover, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%));
  --pill-color-remove: var(--color-accent-2, color-mix(in oklab, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%), transparent 8%));
  --pill-padding-x: var(--tag-padding-x, 0.75em 0.375em);
  --pill-radius: var(--tag-radius, 2em);
  --pill-weight: var(--tag-weight, 490);
  background-color: var(--pill-background, rgba(189, 53, 40, 0.1));
...
html[saved-theme="dark"] body h2 {
  ...
  color: var(--h2-color, oklch(0.8125 0 0));
...
html[saved-theme="dark"] body h3 {
  ...
  --h1-weight: var(--h1-weight-alt, 330);
  color: var(--h3-color, oklch(0.8 0 0));
...
html[saved-theme="dark"] body h4 {
  ...
  --h1-weight: var(--h1-weight-alt, 330);
  color: var(--h4-color, oklch(0.8 0 0));
...
html[saved-theme="dark"] body h5 {
  --h1-weight: var(--h1-weight-alt, 330);
  color: var(--h5-color, oklch(0.8 0 0));
...
html[saved-theme="dark"] body h6 {
  ...
  color: var(--h6-color, oklch(0.7625 0 0));
...
html[saved-theme="dark"] body .nav-files-container li:has(> .folder-outer.open) > .nav-folder-title {
  ...
  --nav-item-color: var(--color-base-80, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%));
  --nav-item-color-active: var(--nav-item-color, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%));
  --nav-item-color-hover: var(--nav-item-color, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%));
  ...
  color: var(--nav-item-color, oklab(0.701721 0.0979667 0.0550956));
  font-family: Raveo, Raveo, Inter, ui-sans-serif, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif, "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
...
html[saved-theme="dark"] body li.depth-0 {
  ...
  border-top-width: 0px;
  color: var(--status-bar-text-color, oklch(0.7 0 0));
  font-family: Raveo, Raveo, Inter, ui-sans-serif, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif, "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
}

html[saved-theme="dark"] body footer ul li a {
  --background-modifier-hover: var(--hr-color, oklch(100% 0 0 / 0.1375));
  color: oklch(0.7 0 0);
}`,
...
html[saved-theme="dark"] body .recent-notes > ul.recent-ul > li .section > .desc > h3 > a {
  --nav-item-background-hover: oklab(from var(--trans-faint-20) l a b / 0.025);
  color: var(--nav-item-color, oklch(0.7 0 0));
}
...
html[saved-theme="dark"] body ul.section-ul {
  ...
  border-top-left-radius: 22px;
  border-top-right-radius: 22px;
  color: var(--icon-color, oklch(0.7625 0 0));
}
...
html[saved-theme="dark"] body .canvas-sidebar {
  background-color: var(--trans-strong-20, oklch(0.2 0 0 / 0.5));
  border-color: oklch(0.8 0 0);
}`,
...
html[saved-theme="dark"] body .note-properties-tags {
  ...
  --pill-weight: var(--tag-weight, 490);
  background-color: var(--pill-background, rgba(189, 53, 40, 0.1));
  color: var(--pill-color, oklab(0.701721 0.0979667 0.0550956));
}
...
html[saved-theme="dark"] body div#quartz-root {
  background-color: var(--background-modifier-cover, oklch(0 0 0));
  color: var(--text-normal, oklch(0.8 0 0));
}
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  background-color: var(--tag-background, rgba(189, 53, 40, 0.1));
  border-bottom-color: oklch(0.533942 0.175592 29.3539 / 0.025);
  border-left-color: oklch(0.533942 0.175592 29.3539 / 0.025);
  border-right-color: oklch(0.533942 0.175592 29.3539 / 0.025);
  border-top-color: oklch(0.533942 0.175592 29.3539 / 0.025);
  color: var(--tag-color, oklab(0.701721 0.0979667 0.0550956));
}`,
  },
  light: {
    base: `:root:root {
