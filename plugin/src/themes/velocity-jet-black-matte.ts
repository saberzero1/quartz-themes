...
export const theme: ThemeData = {
  ...
  --bases-cards-background: oklch(100% 0 0 / 0.05);
  --bases-cards-cover-background: oklch(15% 0 0);
  ...
  --bases-group-heading-property-color: oklch(70.00% 0 0);
  ...
  --bases-table-border-color: oklch(100% 0 0 / 0.1375);
  --bases-table-cell-background-active: transparent;
  --bases-table-cell-background-disabled: oklch(15% 0 0);
  --bases-table-cell-background-selected: hsla(5, 65%, 45%, 0.1);
  --bases-table-cell-shadow-active: 0 0 0 2.5px color-mix(in oklab, hsl(5, 65%, 45%) 50%, transparent 75%);
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(5, 65%, 45%);
  --bases-table-container-border-radius: 0;
  --bases-table-group-background: transparent;
  --bases-table-header-background: oklch(00% 0 0);
  --bases-table-header-background-hover: transparent;
  --bases-table-header-color: oklch(57.50% 0 0);
  --bases-table-header-color-hover: oklch(76.25% 0 0);
  --bases-table-header-weight: 490;
  --bases-table-row-border-width: 0;
  --bases-table-row-height: 32px;
  --bases-table-summary-background: oklch(00% 0 0);
  ...
  --corner-smoothing: 60%;
  --dark: var(--text-normal, oklch(80.00% 0 0));
  --darkgray: var(--text-normal, oklch(80.00% 0 0));
  --dialog-width: 500px;
  --divider-color: oklch(100% 0 0 / 0.0625);
  --divider-color-hover: color-mix(in oklab, hsl(5, 65%, 45%) 50%, transparent 75%);
  --divider-width: 0;
  --drag-ghost-background: oklch(00% 0 0);
  --drag-ghost-text-color: oklch(80.00% 0 0);
  ...
  --file-header-background: oklch(00% 0 0);
  --file-header-background-focused: oklch(00% 0 0);
  ...
  --footnote-id-color: oklch(70.00% 0 0);
  ...
  --gray: var(--text-muted, oklch(70.00% 0 0));
  ...
  --icon-color-active: color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%);
  --icon-color-focused: oklch(80.00% 0 0);
  --icon-color-hover: oklch(80.00% 0 0);
  ...
  --indent-unit: 0.375em;
  --indentation-guide-color: oklch(100% 0 0 / 0.1375);
  --indentation-guide-width: 0;
  --indentation-guide-width-active: 0;
  --inline-title-color: oklch(82.5% 0 0);
  ...
  --light: var(--background-primary, oklch(00% 0 0));
  --lightgray: var(--background-secondary, oklch(20% 0 0));
  ...
  --list-marker-color-collapsed: color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%);
  --list-marker-color-hover: oklch(70.00% 0 0);
  ...
  --metadata-input-text-color: oklch(80.00% 0 0);
  ...
  --metadata-property-box-shadow-focus: 0 0 0 2.5px color-mix(in oklab, hsl(5, 65%, 45%) 50%, transparent 75%);
  --metadata-property-box-shadow-hover: 0 0 0 2.5px oklch(100% 0 0 / 0.05);
  --mobile-nav-fade-bg: linear-gradient(oklch(from oklch(20% 0 0) l c h), transparent 78px);
  --modal-background: oklch(21.25% 0 0 / 0.675);
  --modal-border-color: oklch(43.75% 0 0);
  --modal-border-width: 0;
  --modal-community-header-bg: oklch(from oklch(20% 0 0) l 0 h / 0.5);
  --modal-community-item-bg: oklch(from oklch(30% 0 0) l 0 h / 0.5);
  --modal-radius: 22px;
  --modal-small-background: oklch(21.25% 0 0 / 0.675);
  --nav-collapse-icon-color: oklch(100% 0 0 / 0.35);
  --nav-collapse-icon-color-collapsed: oklch(52.50% 0 0);
  --nav-folder-color: oklch(76.25% 0 0);
  --nav-header-bg: oklch(100% 0 0 / 0.0625);
  --nav-header-timing: cubic-bezier(0.3, 0.75, 0, 1);
  --nav-heading-color: oklch(76.25% 0 0);
  --nav-heading-color-collapsed: oklch(52.50% 0 0);
  --nav-heading-color-collapsed-hover: oklch(70.00% 0 0);
  --nav-heading-color-hover: oklch(80.00% 0 0);
  --nav-heading-weight: 520;
  --nav-heading-weight-hover: 520;
  --nav-indentation-guide-color: oklch(100% 0 0 / 0.1375);
  --nav-indentation-guide-width: 0;
  --nav-item-background-active: oklch(100% 0 0 / 0.05);
  --nav-item-background-hover: oklch(100% 0 0 / 0.05);
  --nav-item-background-selected: hsla(5, 65%, 45%, 0.15);
  --nav-item-color: oklch(70.00% 0 0);
  --nav-item-color-active: oklch(80.00% 0 0);
  --nav-item-color-highlighted: color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%);
  --nav-item-color-hover: oklch(80.00% 0 0);
  --nav-item-color-selected: oklch(80.00% 0 0);
  --nav-item-radius: 8px;
  --nav-tag-color: oklch(52.50% 0 0);
  --nav-tag-color-active: oklch(70.00% 0 0);
  --nav-tag-color-hover: oklch(70.00% 0 0);
  --nav-tag-radius: 8px;
  --nav-tag-weight: 620;
  --nav-text-color: oklch(80.00% 0 0);
  ...
  --pill-background: oklch(100% 0 0 / 0.08125);
  --pill-background-hover: oklch(100% 0 0 / 0.08125);
  --pill-border-color: oklch(100% 0 0 / 0.0625);
  --pill-border-color-hover: oklch(36.25% 0 0);
  --pill-color: oklch(70.00% 0 0);
  --pill-color-hover: oklch(70.00% 0 0);
  ...
  --prompt-background: oklch(21.25% 0 0 / 0.675);
  ...
  --secondary: var(--text-accent, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%));
  ...
  --status-bar-text-color: oklch(70.00% 0 0);
  ...
  --tag-size: 0.8em;
  --tag-weight: 490;
  --tertiary: var(--text-accent-hover, color-mix(in oklab, color-mix(in oklab, hsl(5, 65%, 45%) 64%, #fff 36%), transparent 8%));
  ...
  --titlebar-text-color-focused: oklch(70.00% 0 0);
  --titlebar-text-weight: 620;
  --toggle-border-width: 4px;
  --toggle-gradient: linear-gradient(to bottom, hsl(5, 65%, 45%) -30%, color-mix(in oklab, oklab(from hsl(5, 65%, 45%) l a b / 0.25) 30%, transparent 70%) 180%);
  ...
  --vault-profile-color-hover: oklch(70.00% 0 0);
