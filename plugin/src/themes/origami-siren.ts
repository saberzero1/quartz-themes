...
export const theme: ThemeData = {
  ...
  --aside-border-color: #464278 !important;
  --aside-text-color: #B4ACC3 !important;
  --background-modifier-active-hover: hsla(274, 100%, 60%, 0.15) !important;
  --background-modifier-border: #464278 !important;
  --background-modifier-border-focus: #675C90 !important;
  --background-modifier-border-hover: #8776A8 !important;
  ...
  --background-modifier-form-field: #464278 !important;
  --background-modifier-form-field-hover: #464278 !important;
  ...
  --background-primary: #1E1B3B !important;
  --background-primary-alt: #322F5A !important;
  --background-primary-pre-alt: #28254B !important;
  --background-secondary: #322F5A !important;
  --background-secondary-alt: #464278 !important;
  --background-transparent: #55555599 !important;
  --bases-cards-background: #1E1B3B !important;
  --bases-cards-cover-background: #322F5A !important;
  --bases-cards-shadow: 0 0 0 1px #464278 !important;
  --bases-cards-shadow-hover: 0 0 0 1px #8776A8 !important;
  --bases-embed-border-color: #464278 !important;
  --bases-group-heading-property-color: #B4ACC3 !important;
  --bases-table-border-color: #464278 !important;
  --bases-table-cell-background-active: #1E1B3B !important;
  --bases-table-cell-background-disabled: #322F5A !important;
  --bases-table-cell-background-selected: hsla(274, 100%, 60%, 0.1) !important;
  --bases-table-cell-shadow-active: 0 0 0 2px #675C90 !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(274, 100%, 60%) !important;
  --bases-table-group-background: #322F5A !important;
  --bases-table-header-background: #1E1B3B !important;
  --bases-table-header-background-hover: rgba(255, 255, 255, 0.075) !important;
  --bases-table-header-color: #B4ACC3 !important;
  --bases-table-summary-background: #1E1B3B !important;
  --bases-table-summary-background-hover: rgba(255, 255, 255, 0.075) !important;
  --bb-border: 1px solid #464278 !important;
  --bb-border-alt: 1px solid #464278 !important;
  --bb-border-dashed: 1px dashed #464278 !important;
  --bb-border-high-contrast: 1px solid #B4ACC3 !important;
  ...
  --blur-background: color-mix(in srgb, #464278 65%, transparent) linear-gradient(#464278, color-mix(in srgb, #464278 65%, transparent)) !important;
  ...
  --canvas-background: #1E1B3B !important;
  ...
  --canvas-dot-pattern: #FF9B54 !important;
  ...
  --checkbox-marker-color: #1E1B3B !important;
  --checklist-done-color: #B4ACC3 !important;
  --code-background: #322F5A !important;
  --code-border-color: #464278 !important;
  ...
  --color-accent-3: hsl(99,
        ...
        77.4%) !important;
  --color-accent-hsl: 274, 100%, 60% !important;
  --color-accent-rgb: 189, 147, 249 !important;
  --color-base-00: #1E1B3B !important;
  --color-base-05: #28254B !important;
  --color-base-10: #322F5A !important;
  --color-base-100: #ffffff !important;
  --color-base-20: #322F5A !important;
  --color-base-25: #464278 !important;
  --color-base-30: #464278 !important;
  --color-base-35: #8776A8 !important;
  --color-base-40: #675C90 !important;
  --color-base-50: #FF9B54 !important;
  --color-base-60: #B4ACC3 !important;
  ...
  --divider-color: #464278 !important;
  --divider-color-hover: hsl(274, 100%, 60%) !important;
  --dropdown-background: #464278 !important;
  --dropdown-background-hover: #8776A8 !important;
  --embed-block-shadow-hover: 0 0 0 1px #464278,
        inset 0 0 0 1px #464278 !important;
  --embed-border-start: 2px solid hsl(274, 100%, 60%) !important;
  --file-header-background: #1E1B3B !important;
  --file-header-background-focused: #1E1B3B !important;
  ...
  --flair-background: #464278 !important;
  ...
  --footnote-divider-color: #464278 !important;
  ...
  --interactive-accent-hsl: 274, 100%, 60% !important;
  --interactive-hover: #8776A8 !important;
  --interactive-normal: #464278 !important;
  --light: #1E1B3B !important;
  --lightgray: #322F5A !important;
  ...
  --menu-background: #322F5A !important;
  --menu-border-color: #8776A8 !important;
  --menu-shadow: 0px 10px 21px 13px rgba(0, 0, 0, 0.1) !important;
  --metadata-border-color: #464278 !important;
  --metadata-divider-color: #464278 !important;
  ...
  --metadata-property-box-shadow-focus: 0 0 0 2px #675C90 !important;
  --metadata-property-box-shadow-hover: 0 0 0 1px #8776A8 !important;
  --metadata-sidebar-input-font-size: 14px !important;
  --metadata-sidebar-label-font-size: 14px !important;
  --modal-background: #1E1B3B !important;
  --modal-border-color: #675C90 !important;
  ...
  --o-h1-color: #464278 !important;
  --o-h2-color: #464278 !important;
  --o-h3-color: #464278 !important;
  --o-h4-color: #464278 !important;
  --o-h5-color: #464278 !important;
  --o-h6-color: #464278 !important;
  --pdf-background: #1E1B3B !important;
  --pdf-page-background: #1E1B3B !important;
  --pdf-shadow: 0 0 0 1px #464278 !important;
  --pdf-sidebar-background: #1E1B3B !important;
  --pdf-thumbnail-shadow: 0 0 0 1px #464278 !important;
  --pill-border-color: #464278 !important;
  --pill-border-color-hover: #8776A8 !important;
  ...
  --prompt-background: #1E1B3B !important;
  --prompt-border-color: #675C90 !important;
  --raised-background: color-mix(in srgb, #464278 65%, transparent) linear-gradient(#464278, color-mix(in srgb, #464278 65%, transparent)) !important;
  --ribbon-background: #322F5A !important;
  --ribbon-background-collapsed: #1E1B3B !important;
  ...
  --search-result-background: #1E1B3B !important;
  --secondary: hsl(274, 100%, 60%) !important;
  --setting-group-heading-color: #E0E1DD !important;
  --setting-group-heading-size: 16px !important;
  --setting-items-background: #322F5A !important;
  --setting-items-border-color: #464278 !important;
  ...
  --shiki-code-background: #322F5A !important;
  ...
  --shiki-gutter-border-color: #464278 !important;
  ...
  --slider-thumb-border-color: #8776A8 !important;
  --slider-thumb-radius: 50% !important;
  --slider-track-background: #464278 !important;
  --status-bar-background: #322F5A !important;
  --status-bar-border-color: #464278 !important;
  --status-bar-scroll-padding: 30px !important;
  --status-bar-text-color: #B4ACC3 !important;
  --suggestion-background: #1E1B3B !important;
  ...
  --tab-background-active: #1E1B3B !important;
  --tab-container-background: #322F5A !important;
  --tab-divider-color: #8776A8 !important;
  --tab-font-size: 14px !important;
  --tab-outline-color: #464278 !important;
  --tab-stacked-font-size: 14px !important;
  --tab-switcher-background: #322F5A !important;
  --tab-switcher-menubar-background: linear-gradient(to top, #322F5A, transparent) !important;
  ...
  --table-add-button-border-color: #464278 !important;
  --table-border-color: #464278 !important;
  ...
  --table-header-border-color: #464278 !important;
  ...
  --text-on-button: #1E1B3B !important;
  ...
  --titlebar-background: #322F5A !important;
  --titlebar-background-focused: transparent !important;
  --titlebar-border-color: #464278 !important;
  ...
  --vault-name-color: #E0E1DD !important;
...
html body .breadcrumb-element p {
  ...
  box-shadow: rgb(224, 225, 221) 0px 0px 0px 4px;
}
