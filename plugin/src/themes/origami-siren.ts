...
export const theme: ThemeData = {
  ...
  --aside-border-color: #464278;
  --aside-text-color: #B4ACC3;
  --background-modifier-active-hover: hsla(274, 100%, 60%, 0.15);
  --background-modifier-border: #464278;
  --background-modifier-border-focus: #675C90;
  --background-modifier-border-hover: #8776A8;
  --background-modifier-error: #ff5555;
  --background-modifier-error-hover: #ff5555;
  --background-modifier-error-rgb: 255, 85, 85;
  --background-modifier-form-field: #464278;
  --background-modifier-form-field-hover: #464278;
  --background-modifier-hover: rgba(255, 255, 255, 0.075);
  --background-modifier-success: #50FA7B;
  --background-modifier-success-rgb: 80, 250, 123;
  --background-primary: #1E1B3B;
  --background-primary-alt: #322F5A;
  --background-primary-pre-alt: #28254B;
  --background-secondary: #322F5A;
  --background-secondary-alt: #464278;
  --background-transparent: #55555599;
  --bases-cards-background: #1E1B3B;
  --bases-cards-cover-background: #322F5A;
  --bases-cards-shadow: 0 0 0 1px #464278;
  --bases-cards-shadow-hover: 0 0 0 1px #8776A8;
  --bases-embed-border-color: #464278;
  --bases-group-heading-property-color: #B4ACC3;
  --bases-table-border-color: #464278;
  --bases-table-cell-background-active: #1E1B3B;
  --bases-table-cell-background-disabled: #322F5A;
  --bases-table-cell-background-selected: hsla(274, 100%, 60%, 0.1);
  --bases-table-cell-shadow-active: 0 0 0 2px #675C90;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(274, 100%, 60%);
  --bases-table-group-background: #322F5A;
  --bases-table-header-background: #1E1B3B;
  --bases-table-header-background-hover: rgba(255, 255, 255, 0.075);
  --bases-table-header-color: #B4ACC3;
  --bases-table-summary-background: #1E1B3B;
  --bases-table-summary-background-hover: rgba(255, 255, 255, 0.075);
  --bb-border: 1px solid #464278;
  --bb-border-alt: 1px solid #464278;
  --bb-border-dashed: 1px dashed #464278;
  --bb-border-high-contrast: 1px solid #B4ACC3;
  ...
  --blur-background: color-mix(in srgb, #464278 65%, transparent) linear-gradient(#464278, color-mix(in srgb, #464278 65%, transparent));
  ...
  --checkbox-marker-color: #1E1B3B;
  --checklist-done-color: #B4ACC3;
  --code-background: #322F5A;
  --code-border-color: #464278;
  ...
  --divider-color: #464278;
  --divider-color-hover: hsl(274, 100%, 60%);
  --dropdown-background: #464278;
  --dropdown-background-hover: #8776A8;
  --embed-block-shadow-hover: 0 0 0 1px #464278,
        inset 0 0 0 1px #464278;
  --embed-border-start: 2px solid hsl(274, 100%, 60%);
  --file-header-background: #1E1B3B;
  --file-header-background-focused: #1E1B3B;
  ...
  --interactive-accent-hsl: 274, 100%, 60%;
  --interactive-hover: #8776A8;
  --interactive-normal: #464278;
  --light: var(--background-primary, #1E1B3B);
  --lightgray: var(--background-secondary, #322F5A);
  ...
  --menu-background: #322F5A;
  --menu-border-color: #8776A8;
  --menu-shadow: 0px 10px 21px 13px rgba(0, 0, 0, 0.1);
  --metadata-border-color: #464278;
  --metadata-divider-color: #464278;
  ...
  --metadata-property-box-shadow-focus: 0 0 0 2px #675C90;
  --metadata-property-box-shadow-hover: 0 0 0 1px #8776A8;
  --metadata-sidebar-input-font-size: 14px;
  --metadata-sidebar-label-font-size: 14px;
  --modal-background: #1E1B3B;
  --modal-border-color: #675C90;
  ...
  --o-h5-color: #464278;
  --o-h6-color: #464278;
  --pdf-background: #1E1B3B;
  --pdf-page-background: #1E1B3B;
  --pdf-shadow: 0 0 0 1px #464278;
  --pdf-sidebar-background: #1E1B3B;
  --pdf-thumbnail-shadow: 0 0 0 1px #464278;
  --pill-border-color: #464278;
  --pill-border-color-hover: #8776A8;
  --pill-color: #B4ACC3;
  --pill-color-hover: #E0E1DD;
  --pill-color-remove: #FF9B54;
  --pill-color-remove-hover: hsl(274, 100%, 60%);
  --prompt-background: #1E1B3B;
  --prompt-border-color: #675C90;
  --raised-background: color-mix(in srgb, #464278 65%, transparent) linear-gradient(#464278, color-mix(in srgb, #464278 65%, transparent));
  --ribbon-background: #322F5A;
  --ribbon-background-collapsed: #1E1B3B;
  ...
  --shiki-gutter-border-color: #464278;
  ...
  --slider-thumb-border-color: #8776A8;
  --slider-thumb-radius: 50%;
  --slider-track-background: #464278;
  --status-bar-background: #322F5A;
  --status-bar-border-color: #464278;
  --status-bar-scroll-padding: 30px;
  --status-bar-text-color: #B4ACC3;
  --suggestion-background: #1E1B3B;
  --swatch-height: 24px;
  --swatch-width: 24px;
  ...
  --tab-background-active: #1E1B3B;
  --tab-container-background: #322F5A;
  --tab-divider-color: #8776A8;
  --tab-font-size: 14px;
  --tab-outline-color: #464278;
  --tab-stacked-font-size: 14px;
  --tab-switcher-background: #322F5A;
  --tab-switcher-menubar-background: linear-gradient(to top, #322F5A, transparent);
  ...
  --titlebar-background: #322F5A;
  --titlebar-background-focused: transparent;
  --titlebar-border-color: #464278;
