...
export const theme: ThemeData = {
  ...
  --accent-l: 60%;
  --accent-s: 100%;
  --ancestor-editor-color: var(--text-normal, #E0E1DD);
  --aside-background: transparent;
  --aside-background-hover: var(--background-modifier-hover, rgba(255, 255, 255, 0.075));
  --aside-border-color: var(--background-modifier-border, #464278);
  --aside-text-color: var(--text-muted, #B4ACC3);
  --background-modifier-active-hover: hsla(var(--interactive-accent-hsl), 0.15);
  --background-modifier-border: var(--color-base-30, #464278);
  --background-modifier-border-focus: var(--color-base-40, #675C90);
  --background-modifier-border-hover: var(--color-base-35, #8776A8);
  ...
  --background-modifier-form-field: var(--color-base-00, #464278);
  --background-modifier-form-field-hover: var(--background-modifier-form-field, #464278);
  ...
  --background-primary: var(--color-base-00, #1E1B3B);
  --background-primary-alt: var(--color-base-10, #322F5A);
  --background-primary-pre-alt: var(--color-base-05, #28254B);
  --background-secondary: var(--color-base-20, #322F5A);
  --background-secondary-alt: var(--color-base-30, #464278);
  --background-transparent: #55555599;
  --bases-cards-background: var(--background-primary, #1E1B3B);
  --bases-cards-cover-background: var(--background-primary-alt, #322F5A);
  --bases-embed-border-color: var(--background-modifier-border, #464278);
  --bases-group-heading-property-color: var(--text-muted, #B4ACC3);
  --bases-table-border-color: var(--table-border-color, #464278);
  --bases-table-cell-background-active: var(--background-primary, #1E1B3B);
  --bases-table-cell-background-disabled: var(--background-primary-alt, #322F5A);
  --bases-table-cell-background-selected: var(--table-selection, hsla(274, 100%, 60%, 0.1));
  --bases-table-group-background: var(--background-primary-alt, #322F5A);
  --bases-table-header-background: var(--background-primary, #1E1B3B);
  ...
  --bases-table-summary-background: var(--background-primary, #1E1B3B);
  ...
  --canvas-background: var(--background-primary, #1E1B3B);
  ...
  --canvas-dot-pattern: var(--color-base-50, #FF9B54);
  ...
  --checkbox-marker-color: var(--background-primary, #1E1B3B);
  --checklist-done-color: var(--text-muted, #B4ACC3);
  --code-background: var(--background-primary-alt, #322F5A);
  --code-border-color: var(--background-modifier-border, #464278);
  ...
  --code-normal: var(--text-muted, #B4ACC3);
  ...
  --color-accent-hsl: var(--accent-h),
        var(--accent-s),
        var(--accent-l);
  --color-accent-rgb: var(--color-purple-rgb, 189, 147, 249);
  ...
  --divider-color: var(--background-modifier-border, #464278);
  --divider-color-hover: var(--interactive-accent, hsl(274, 100%, 60%));
  --dropdown-background: var(--interactive-normal, #464278);
  --dropdown-background-hover: var(--interactive-hover, #8776A8);
  --embed-block-shadow-hover: 0 0 0 1px var(--background-modifier-border),
        inset 0 0 0 1px var(--background-modifier-border);
  --file-header-background: var(--background-primary, #1E1B3B);
  --file-header-background-focused: var(--background-primary, #1E1B3B);
  ...
  --flair-background: var(--interactive-normal, #464278);
  --flair-color: var(--text-normal, #E0E1DD);
  --font-interface-theme: "Aspekta", sans-serif;
  --font-ui-medium: 16px;
  --font-ui-small: 14px;
  --footnote-divider-color: var(--metadata-divider-color, #464278);
  ...
  --graph-node-focused: var(--background-modifier-border-focus, #675C90);
  ...
  --gray: var(--text-muted, var(--color-base-60, #B4ACC3));
  ...
  --hr-color: var(--background-modifier-border, #464278);
  ...
  --interactive-hover: var(--color-base-10, #8776A8);
  --interactive-normal: var(--color-base-00, #464278);
  --light: var(--background-primary, var(--color-base-00, #1E1B3B));
  --lightgray: var(--background-secondary, var(--color-base-20, #322F5A));
  ...
  --menu-background: var(--background-secondary, #322F5A);
  --menu-border-color: var(--background-modifier-border-hover, #8776A8);
  --menu-shadow: var(--shadow-s, 0px 10px 21px 13px rgba(0, 0, 0, 0.1));
  --metadata-border-color: var(--background-modifier-border, #464278);
  --metadata-divider-color: var(--background-modifier-border, #464278);
  ...
  --modal-background: var(--background-primary, #1E1B3B);
  ...
  --o-h1-color: var(--background-modifier-border, #464278);
  --o-h2-color: var(--background-modifier-border, #464278);
  --o-h3-color: var(--background-modifier-border, #464278);
  --o-h4-color: var(--background-modifier-border, #464278);
  --o-h5-color: var(--background-modifier-border, #464278);
  --o-h6-color: var(--background-modifier-border, #464278);
  --pdf-background: var(--background-primary, #1E1B3B);
  --pdf-page-background: var(--background-primary, #1E1B3B);
  --pdf-sidebar-background: var(--background-primary, #1E1B3B);
  --pill-border-color: var(--background-modifier-border, #464278);
  --pill-border-color-hover: var(--background-modifier-border-hover, #8776A8);
  ...
  --prompt-background: var(--background-primary, #1E1B3B);
  --raised-background: var(--blur-background, color-mix(in srgb, #464278 65%, transparent) linear-gradient(#464278, color-mix(in srgb, #464278 65%, transparent)));
  --ribbon-background: var(--background-secondary, #322F5A);
  --ribbon-background-collapsed: var(--background-primary, #1E1B3B);
  ...
  --search-result-background: var(--background-primary, #1E1B3B);
  ...
  --setting-items-background: var(--background-primary-alt, #322F5A);
  --setting-items-border-color: var(--background-modifier-border, #464278);
  ...
  --shiki-code-background: var(--code-background, #322F5A);
  ...
  --shiki-gutter-border-color: var(--background-modifier-border, #464278);
  ...
  --slider-thumb-border-color: var(--background-modifier-border-hover, #8776A8);
  --slider-thumb-radius: var(--slider-thumb-height, 50%);
  --slider-track-background: var(--background-modifier-border, #464278);
  --status-bar-background: var(--background-secondary, #322F5A);
  --status-bar-border-color: var(--divider-color, #464278);
  --status-bar-scroll-padding: calc(var(--status-bar-font-size) + 18px);
  --status-bar-text-color: var(--text-muted, #B4ACC3);
  --suggestion-background: var(--background-primary, #1E1B3B);
  --swatch-height: 24px;
  --swatch-width: 24px;
  ...
  --tab-background-active: var(--background-primary, #1E1B3B);
  --tab-container-background: var(--background-secondary, #322F5A);
  --tab-divider-color: var(--background-modifier-border-hover, #8776A8);
  --tab-font-size: var(--font-ui-small, 14px);
  --tab-outline-color: var(--divider-color, #464278);
  --tab-stacked-font-size: var(--font-ui-small, 14px);
  --tab-switcher-background: var(--background-secondary, #322F5A);
  ...
  --table-add-button-border-color: var(--background-modifier-border, #464278);
  --table-border-color: var(--background-modifier-border, #464278);
  ...
  --table-header-border-color: var(--table-border-color, #464278);
  ...
  --text-faint: var(--color-base-50, #FF9B54);
  --text-muted: var(--color-base-60, #B4ACC3);
  --text-normal: var(--color-base-70, #E0E1DD);
  --text-on-accent: var(--color-base-100, #ffffff);
  --text-on-button: var(--color-base-00, #1E1B3B);
  ...
  --titlebar-background: var(--background-secondary, #322F5A);
  --titlebar-background-focused: var(--background-secondary-alt, transparent);
  --titlebar-border-color: var(--background-modifier-border, #464278);
  ...
  --vault-name-color: var(--text-normal, #E0E1DD);
...
html body[data-slug] div#quartz-root.page, html .page > div#quartz-body div.sidebar.left, html .page > div#quartz-body div.sidebar.left:has(.explorer), html .page > div#quartz-body div.sidebar.left .explorer .explorer-content {
  --bases-table-header-background: var(--background-secondary, #322F5A);
  background-color: var(--tab-container-background, rgba(0, 0, 0, 0));
  color: rgb(224, 225, 221);
}

html body[data-slug], html body[data-slug] .page > div#quartz-body, html .page > div#quartz-body div.center, html .page > div#quartz-body footer {
  background-color: var(--background-primary, rgb(30, 27, 59));
  color: rgb(224, 225, 221);
}
...
html body .page > div#quartz-body div.sidebar.left {
  border-right-color: rgb(70, 66, 120);
...
html body .page > div#quartz-body div.sidebar.right {
  --bases-table-header-background: var(--background-secondary, #322F5A);
  background-color: var(--tab-container-background, rgba(0, 0, 0, 0));
  border-left-color: rgb(70, 66, 120);
...
html body li.task-list-item input[type="checkbox"] {
  background-color: rgb(70, 66, 120);
  border-color: rgb(70, 66, 120);
}
...
html body a.internal-link.broken {
  ...
  font-weight: var(--link-weight, 700);
  outline: rgb(180, 172, 195) none 0px;
  text-decoration-color: var(--link-unresolved-decoration-color, rgb(180, 172, 195));
  transition: 0.7s;
}`,
    lists: `html body dd {
...
html body blockquote {
  background-color: var(--blockquote-background-color, rgb(50, 47, 90));
...
html body td {
  border-bottom-color: rgb(70, 66, 120);
  border-bottom-width: 0px;
  border-left-color: rgb(70, 66, 120);
  border-left-width: 0px;
  border-right-color: rgb(70, 66, 120);
  border-right-width: 0px;
  border-top-color: rgb(70, 66, 120);
  border-top-left-radius: var(--radius-l, 0px);
  border-top-right-radius: var(--radius-l, 0px);
  border-top-width: 0px;
  color: var(--table-text-color, rgb(224, 225, 221));
  font-weight: 500;
}
...
html body th {
  ...
  border-top-right-radius: var(--radius-l, 0px);
  border-top-width: 0px;
  color: var(--table-header-color, rgb(224, 225, 221));
}
...
html body pre:has(> code) {
  background-color: var(--code-background, rgb(50, 47, 90));
...
html body figure {
  --code-background: var(--ec-frm-edBg, #322F5A);
  border-bottom-color: rgb(224, 225, 221);
  border-bottom-width: 0px;
  border-left-color: rgb(224, 225, 221);
  border-left-width: 0px;
...
html body video {
  ...
  background-color: var(--background-primary-alt, rgb(50, 47, 90));
  border-bottom-color: rgb(180, 172, 195);
  border-bottom-width: 0px;
  border-left-color: rgb(180, 172, 195);
  border-left-width: 0px;
...
html body .search > .search-container > .search-space {
  background-color: var(--prompt-background, rgb(40, 37, 75));
  border-bottom-color: rgb(70, 66, 120);
  border-bottom-width: 0px;
  border-left-color: rgb(70, 66, 120);
  border-left-width: 0px;
...
html body .search > .search-container > .search-space > .search-layout > .results-container > .result-card:hover, html .search > .search-container > .search-space > .search-layout > .results-container > .result-card:focus, html .search > .search-container > .search-space > .search-layout > .results-container > .result-card.focus:not(:has(~ .result-card:hover, html ~ .result-card:focus)) {
  background-color: var(--background-secondary, rgb(50, 47, 90));
  color: rgb(224, 225, 221);
  font-weight: 500;
}
...
html body h2 {
  ...
  border-top-right-radius: var(--radius-l, 0px);
  border-top-width: 0px;
  color: var(--h2-color, rgb(224, 225, 221));
...
html body h3 {
  ...
  border-top-right-radius: var(--radius-l, 0px);
  border-top-width: 0px;
  color: var(--h3-color, rgb(224, 225, 221));
...
html body h4 {
  ...
  border-top-right-radius: var(--radius-l, 0px);
  border-top-width: 0px;
  color: var(--h4-color, rgb(224, 225, 221));
...
html body h5 {
  ...
  border-top-right-radius: var(--radius-l, 0px);
  border-top-width: 0px;
  color: var(--h5-color, rgb(224, 225, 221));
...
html body h6 {
  ...
  border-top-right-radius: var(--radius-l, 0px);
  border-top-width: 0px;
  color: var(--h6-color, rgb(224, 225, 221));
...
html body .explorer .nav-files-container .collapse-icon svg {
  ...
  background-color: var(--status-bar-background, rgb(50, 47, 90));
  border-bottom-color: rgb(70, 66, 120);
