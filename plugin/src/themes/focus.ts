...
export const theme: ThemeData = {
  ...
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(106.9879518072deg, 62.4060150376%, 73.9215686275%);
  ...
  --blockquote-border-color: hsl(285.3488372093deg, 100%, 83.137254902%);
  ...
  --bodyFont: var(--font-text, JetBrains Mono,
    Menlo,
    SFMono-Regular,
    Consolas,
    "Roboto Mono",
    "Source Code Pro",
    monospace);
  --bold-color: hsl(106.9879518072deg, 62.4060150376%, 73.9215686275%);
  --bold-weight: 700;
  --border-width: 0px;
  --button-radius: 0px;
  ...
  --checkbox-color: hsl(106.9879518072deg, 62.4060150376%, 73.9215686275%);
  ...
  --code-tag: #f5988f;
  --code-value: #ac9df2;
  --codeFont: var(--font-text, JetBrains Mono,
    Menlo,
    SFMono-Regular,
    Consolas,
    "Roboto Mono",
  ...
  --collapse-icon-color-collapsed: hsl(106.9879518072deg, 62.4060150376%, 73.9215686275%);
  --color-accent: hsl(106.9879518072deg, 62.4060150376%, 73.9215686275%);
  --color-accent-1: hsl(106.9879518072deg, 62.4060150376%, 63.92157%);
  ...
  --color-blue-rgb: 151,
    192,
    243;
  --color-complement: hsl(285.3488372093deg, 100%, 83.137254902%);
  --color-complement-1: hsl(285.3488372093deg, 100%, 73.13725%);
  --color-complement-2: hsl(285.3488372093deg, 100%, 93.13725%);
  ...
  --divider-color-hover: hsl(106.9879518072deg, 62.4060150376%, 73.9215686275%);
  --divider-width: 0px;
  ...
  --embed-border-left: 2px solid hsl(106.9879518072deg, 62.4060150376%, 73.9215686275%);
  ...
  --graph-node-focused: hsl(106.9879518072deg, 62.4060150376%, 73.9215686275%);
  ...
  --h6-color: #ffffff;
  --h6-weight: 500;
  --headerFont: var(--font-text, JetBrains Mono,
    Menlo,
    SFMono-Regular,
    Consolas,
    "Roboto Mono",
  ...
  --hr-color: #222222;
  --icon-color: #707070;
  --icon-color-active: hsl(106.9879518072deg, 62.4060150376%, 73.9215686275%);
  ...
  --interactive-accent: hsl(106.9879518072deg, 62.4060150376%, 73.9215686275%);
  ...
  --italic-color: hsl(285.3488372093deg, 100%, 83.137254902%);
  ...
  --link-color-hover: hsl(285.3488372093deg, 100%, 93.13725%);
  --link-external-color: hsl(285.3488372093deg, 100%, 83.137254902%);
  --link-external-color-hover: hsl(285.3488372093deg, 100%, 93.13725%);
  ...
  --list-marker-color-collapsed: hsl(106.9879518072deg, 62.4060150376%, 73.9215686275%);
  ...
  --nav-item-color-highlighted: hsl(106.9879518072deg, 62.4060150376%, 83.92157%);
  ...
  --pill-color-remove-hover: hsl(106.9879518072deg, 62.4060150376%, 73.9215686275%);
  ...
  --secondary: var(--text-accent, hsl(106.9879518072deg, 62.4060150376%, 73.9215686275%));
  ...
  --shiki-code-comment: #505050;
  --shiki-code-function: #a5e693;
  --shiki-code-important: #ffc8a3;
  --shiki-code-keyword: #eaa9ff;
  --shiki-code-normal: #909090;
  --shiki-code-property: #8bf0db;
  --shiki-code-punctuation: #707070;
  --shiki-code-string: #f0e395;
  --shiki-code-value: #ac9df2;
  --shiki-gutter-border-color: #222222;
  --shiki-gutter-border-width: 0px;
  --shiki-gutter-text-color: #505050;
  --shiki-gutter-text-color-highlight: #909090;
  --shiki-highlight-green: rgba(165, 230, 147, 0.5);
  --shiki-highlight-green-background: rgba(165, 230, 147, 0.1);
  --shiki-highlight-neutral: #909090;
  --shiki-highlight-neutral-background: rgba(255, 255, 255, 0.05);
  --shiki-highlight-red: rgba(245, 152, 143, 0.5);
  --shiki-highlight-red-background: rgba(245, 152, 143, 0.1);
  --shiki-terminal-dots-color: #505050;
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(106.9879518072deg, 62.4060150376%, 73.9215686275%);
  ...
  --tab-text-color-focused-highlighted: hsl(106.9879518072deg, 62.4060150376%, 73.9215686275%);
  --table-add-button-border-color: #222222;
  --table-border-color: #222222;
  --table-drag-handle-background-active: hsl(106.9879518072deg, 62.4060150376%, 73.9215686275%);
  ...
  --tag-border-color-hover: hsla(106.9879518072deg,
    62.4060150376%,
    73.9215686275%, 0.15);
  --tag-color: hsl(106.9879518072deg, 62.4060150376%, 73.9215686275%);
  --tag-color-hover: hsl(106.9879518072deg, 62.4060150376%, 73.9215686275%);
  --tertiary: var(--text-accent-hover, hsl(106.9879518072deg, 62.4060150376%, 83.92157%));
  --text-accent: hsl(106.9879518072deg, 62.4060150376%, 73.9215686275%);
  --text-accent-hover: hsl(106.9879518072deg, 62.4060150376%, 83.92157%);
  --text-complement: hsl(285.3488372093deg, 100%, 83.137254902%);
  ...
  --titleFont: var(--font-text, JetBrains Mono,
    Menlo,
    SFMono-Regular,
    Consolas,
    "Roboto Mono",
