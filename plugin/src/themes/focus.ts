...
html body .markdown-rendered p > strong > em, html strong > em {
  color: var(--italic-color, rgb(139, 240, 219));
  font-family: "??", "??", "JetBrains Mono", Menlo, SFMono-Regular, Consolas, "Roboto Mono", "Source Code Pro", monospace;
  font-weight: 700;
  outline: rgb(139, 240, 219) none 0px;
  text-decoration-color: rgb(139, 240, 219);
}
...
html body blockquote {
  ...
  color: var(--blockquote-color, rgb(144, 144, 144));
  font-family: "??", "??", "JetBrains Mono", Menlo, SFMono-Regular, Consolas, "Roboto Mono", "Source Code Pro", monospace;
}`,
...
html body .metadata-property-key {
  color: rgb(112, 112, 112);
  font-family: var(--metadata-label-font, "??", "??", "??", "JetBrains Mono", Menlo, SFMono-Regular, Consolas, "Roboto Mono", "Source Code Pro", monospace);
}

html body .metadata-property-value {
  color: rgb(112, 112, 112);
  font-family: var(--metadata-input-font, "??", "??", "??", "JetBrains Mono", Menlo, SFMono-Regular, Consolas, "Roboto Mono", "Source Code Pro", monospace);
}
