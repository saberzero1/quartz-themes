...
export const theme: ThemeData = {
  ...
  --background-modifier-active-hover: hsla(27, 60%, 44%, 0.1);
  --background-modifier-border: oklch(100% 0.0375 64 / 0.0625);
  --background-modifier-border-focus: transparent;
  --background-modifier-border-hover: oklch(36.25% 0.01000 64);
  --background-modifier-cover: oklch(10% 0 0 / 0.5);
  --background-modifier-error: #df6775;
  --background-modifier-error-hover: #df6775;
  --background-modifier-error-rgb: 223, 103, 117;
  --background-modifier-form-field: oklch(31.25% 0.01000 64);
  --background-modifier-form-field-hover: transparent;
  --background-modifier-hover: oklch(100% 0.0375 64 / 0.05);
  --background-modifier-success: #70ce86;
  --background-modifier-success-rgb: 112, 206, 134;
  --background-primary: oklch(23.75% 0.00750 64);
  --background-primary-alt: color-mix(in oklab, oklch(23.75% 0.00750 64), oklch(27.50% 0.01000 64));
  --background-secondary: oklch(27.50% 0.01000 64);
  --background-secondary-alt: oklch(34.50% 0.01000 64);
  --bases-cards-background: oklch(100% 0.045 64 / 0.025);
  --bases-cards-cover-background: color-mix(in oklab, oklch(23.75% 0.00750 64), oklch(27.50% 0.01000 64));
  --bases-cards-label-color: oklch(63.75% 0.02438 64);
  --bases-cards-line-height: 26px;
  --bases-cards-radius: 12px;
  --bases-cards-shadow: none;
  --bases-cards-shadow-hover: none;
  --bases-embed-border-color: oklch(100% 0.0375 64 / 0.0625);
  --bases-embed-border-radius: 0;
  --bases-group-heading-property-color: oklch(71.25% 0.02438 64);
  ...
  --bases-table-border-color: oklch(100% 0.05625 64 / 0.1);
  --bases-table-cell-background-active: transparent;
  --bases-table-cell-background-disabled: color-mix(in oklab, oklch(23.75% 0.00750 64), oklch(27.50% 0.01000 64));
  --bases-table-cell-background-selected: hsla(27, 60%, 44%, 0.1);
  --bases-table-cell-shadow-active: 0 0 0 2.5px color-mix(in oklab, hsl(27, 60%, 44%) 50%, transparent 75%);
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(27, 60%, 44%);
  --bases-table-container-border-radius: 0;
  --bases-table-group-background: transparent;
  --bases-table-header-background: oklch(23.75% 0.00750 64);
  --bases-table-header-background-hover: transparent;
  --bases-table-header-color: oklch(57.50% 0.01625 64);
  --bases-table-header-color-hover: oklch(77.50% 0.02438 64);
  --bases-table-header-weight: 490;
  --bases-table-row-border-width: 0;
  --bases-table-row-height: 32px;
  --bases-table-summary-background: oklch(23.75% 0.00750 64);
  --bases-table-summary-background-hover: oklch(100% 0.0375 64 / 0.05);
  --bases-table-text-size: 0.90625em;
  --bg-checkbox: radial-gradient(transparent 50%, oklch(43.75% 0.01625 64) 55% 60%, transparent 65%);
  --bg-checkbox-active: radial-gradient(#0000000f 52%, #ffffff20 64%);
  --bg-main-inner: oklch(28.75% 0.0075 64);
  --bg-main-outer: oklch(26.25% 0.0125 64);
  --bg-main-workspace: radial-gradient(at 50% 50%, oklch(28.75% 0.0075 64) 0%, oklch(26.25% 0.0125 64) 200%);
  --bhue: 64;
  --bl-00: 23.75%;
  --bl-05: 24.00%;
  --bl-10: 26.25%;
  ...
  --bl-80: 77.50%;
  --bl-90: 85.00%;
  --blockquote-border-color: oklch(52.50% 0.01625 64);
  --blockquote-border-thickness: 0.1875rem;
  --blockquote-color: oklch(71.25% 0.02438 64);
  --blur-background: color-mix(in srgb, oklch(34.50% 0.01000 64) 65%, transparent) linear-gradient(oklch(34.50% 0.01000 64), color-mix(in srgb, oklch(34.50% 0.01000 64) 65%, transparent));
  --blur-brightness: 1;
  ...
  --bold-color: oklch(93.25% 0.00250 64);
  --bold-modifier: 250;
  --bold-weight: 670;
  --bsat-low: 0.00250;
  --bsat-med: 0.00750;
  ...
  --canvas-background: oklch(23.75% 0.00750 64);
  --canvas-card-label-color: oklch(52.50% 0.01625 64);
  --canvas-color-1: 223, 103, 117;
  --canvas-color-2: 232, 150, 89;
  --canvas-color-3: 240, 200, 129;
  --canvas-color-4: 112, 206, 134;
  --canvas-color-5: 117, 170, 226;
  --canvas-color-6: 162, 145, 213;
  --canvas-controls-radius: 8px;
  --canvas-dot-pattern: oklch(34.50% 0.01000 64);
  --caret-color: oklch(85.00% 0.01000 64);
  --checkbox-border-color: oklch(43.75% 0.01625 64);
  --checkbox-border-color-hover: oklch(71.25% 0.02438 64);
  --checkbox-color: hsl(27, 60%, 44%);
  --checkbox-color-hover: color-mix(in oklab, hsl(27, 60%, 44%) 62.5%, color-mix(in oklab, hsl(27, 60%, 44%) 64%, #fff 36%));
  --checkbox-marker-color: white;
  --checkbox-radius: 50%;
  --checkbox-size: 1.125rem;
  --checklist-done-color: oklch(52.50% 0.01625 64);
  --clickable-icon-radius: 8px;
  --code-background: oklch(100% 0.0375 64 / 0.05);
  --code-background-alt: oklch(from oklch(24.00% 0.00250 64) l 0.01000 h / 0.375);
  --code-border-color: oklch(100% 0.0375 64 / 0.0625);
  --code-border-width: 0;
  --code-bracket-background: oklch(100% 0.0375 64 / 0.05);
  --code-comment: oklch(52.50% 0.01625 64);
  --code-function: #f0c881;
  --code-important: #e89659;
  --code-keyword: #ce93c8;
  --code-normal: oklch(85.00% 0.01000 64);
  --code-operator: #df6775;
  --code-property: #76cdbd;
  --code-punctuation: oklch(71.25% 0.02438 64);
  --code-radius: 6px;
  --code-special: #df6775;
  --code-string: #70ce86;
  --code-tag: #df6775;
  ...
  --collapse-icon-color: oklch(52.50% 0.01625 64);
  --collapse-icon-color-collapsed: color-mix(in oklab, hsl(27, 60%, 44%) 64%, #fff 36%);
  --color-accent: hsl(27, 60%, 44%);
  --color-accent-1: color-mix(in oklab, hsl(27, 60%, 44%) 64%, #fff 36%);
  --color-accent-2: color-mix(in oklab, color-mix(in oklab, hsl(27, 60%, 44%) 64%, #fff 36%), transparent 8%);
  --color-accent-3: color-mix(in oklab, hsl(27, 60%, 44%) 50%, transparent 75%);
  --color-accent-4: color-mix(in oklab, oklab(from hsl(27, 60%, 44%) l a b / 0.25) 30%, transparent 70%);
  --color-accent-hsl: 27, 60%, 44%;
  --color-base-00: oklch(23.75% 0.00750 64);
  --color-base-05: oklch(24.00% 0.00250 64);
  --color-base-10: oklch(26.25% 0.01000 64);
  --color-base-100: oklch(93.25% 0.00250 64);
  --color-base-20: oklch(27.50% 0.01000 64);
  --color-base-25: oklch(31.25% 0.01000 64);
  --color-base-30: oklch(34.50% 0.01000 64);
  --color-base-35: oklch(36.25% 0.01000 64);
  --color-base-40: oklch(43.75% 0.01625 64);
  --color-base-50: oklch(52.50% 0.01625 64);
  --color-base-55: oklch(57.50% 0.01625 64);
  --color-base-60: oklch(63.75% 0.02438 64);
  --color-base-70: oklch(71.25% 0.02438 64);
  --color-base-80: oklch(77.50% 0.02438 64);
  --color-base-90: oklch(85.00% 0.01000 64);
  --color-blue: #75aae2;
  ...
  --color-highlight: rgb(240, 200, 129);
  --color-highlight-rgb: 240, 200, 129;
  --color-orange: #e89659;
  ...
  --control-icon-background: oklch(100% 0.0375 64 / 0.0625);
  --control-icon-color: oklch(77.50% 0.02438 64);
  --control-icon-shadow: inset 0.875px 1.625px 2px -1px rgba(255, 255, 255, 0.263), inset -0.875px -1.625px 2px -1px rgba(255, 255, 255, 0.188), inset 0 8px 16px rgba(255, 255, 255, 0.025), 0px 0px 12px 0px oklch(from oklch(24.00% 0.00250 64) l 0.01000 h / 0.375);
  --corner-smoothing: 60%;
  --dark: var(--text-normal, oklch(85.00% 0.01000 64));
  --darkgray: var(--text-normal, oklch(85.00% 0.01000 64));
  --dialog-width: 500px;
  --divider-color: oklch(100% 0.0375 64 / 0.0625);
  --divider-color-hover: color-mix(in oklab, hsl(27, 60%, 44%) 50%, transparent 75%);
  --divider-width: 0;
  --drag-ghost-background: oklch(23.75% 0.00750 64);
  --drag-ghost-text-color: oklch(85.00% 0.01000 64);
  --dropdown-background: oklch(34.50% 0.01000 64);
  --dropdown-background-hover: oklch(36.25% 0.01000 64);
  --embed-block-shadow-hover: none;
  --embed-border-start: none;
  --embed-padding: 0 1.25em 0 0;
  --fab-bg: oklch(23.75% 0.00750 64);
  --fab-color: oklch(63.75% 0.02438 64);
  --fab-color-active: oklch(85.00% 0.01000 64);
  --fab-easing-curve: cubic-bezier(0.55, 2, 0.5, 0.97);
  --file-header-background: oklch(23.75% 0.00750 64);
  --file-header-background-focused: oklch(23.75% 0.00750 64);
  ...
  --file-margins-x: 5%;
  --file-margins-y: 28px;
  --flair-background: oklch(34.50% 0.01000 64);
  --flair-color: oklch(85.00% 0.01000 64);
  ...
  --font-ui-larger: 24px;
  --font-weight: 420;
  --footnote-divider-color: oklch(100% 0.0375 64 / 0.0625);
  --footnote-id-color: oklch(71.25% 0.02438 64);
  --footnote-id-color-no-occurrences: oklch(52.50% 0.01625 64);
  --footnote-input-background-active: oklch(100% 0.0375 64 / 0.05);
  ...
  --glass-button: inset 3px 3px 1.5px -1.25px oklab(from hsl(27, 60%, 44%) calc(l + 0.075) a b / 0.75), inset -3px -3px 1.5px -1.25px oklab(from hsl(27, 60%, 44%) calc(l + 0.075) a b / 0.5);
  --glass-button-error: inset 3.25px 3.25px 1.25px -1.25px oklab(from #df6775 calc(l + 0.075) a b / 0.75), inset -3.25px -3.25px 1.25px -1.25px oklab(from #df6775 calc(l + 0.075) a b / 0.5);
  --glass-button-l: inset 3.75px 3.75px 1.5px -1.25px oklab(from hsl(27, 60%, 44%) calc(l + 0.075) a b / 0.75), inset -3.75px -3.75px 1.5px -1.25px oklab(from hsl(27, 60%, 44%) calc(l + 0.075) a b / 0.5);
  --graph-controls-width: 232px;
  --graph-line: oklch(36.25% 0.01000 64);
  --graph-node: oklch(71.25% 0.02438 64);
  --graph-node-attachment: #f0c881;
  --graph-node-focused: transparent;
  --graph-node-tag: #70ce86;
  --graph-node-unresolved: oklch(52.50% 0.01625 64);
  --graph-text: oklch(85.00% 0.01000 64);
  --gray: var(--text-muted, oklch(71.25% 0.02438 64));
  --h1-color: oklch(89.5% 0.00250 64);
  --h1-size: 2em;
  --h1-size-alt: 1.625em;
  --h1-weight: 330;
  --h1-weight-alt: 570;
  --h2-color: oklch(88.25% 0.00250 64);
  --h2-size: 1.5em;
  --h2-weight: 570;
  --h3-color: oklch(85.00% 0.01000 64);
  --h3-size: 1.375em;
  --h3-weight: 570;
  --h4-color: oklch(85.00% 0.01000 64);
  --h4-size: 1.25em;
  --h4-weight: 570;
  --h5-color: oklch(85.00% 0.01000 64);
  --h5-line-height: 1.6;
  --h5-size: 1.125em;
  --h6-color: oklch(77.50% 0.02438 64);
  --h6-line-height: 1.6;
  --h6-weight: 670;
  --header-height: 56px;
  ...
  --heading-formatting: oklch(52.50% 0.01625 64);
  --highlight: var(--text-highlight-bg, oklch(from rgb(240, 200, 129) 0.8 calc(c * 1.375) h / 0.33));
  --highlight-blue-rgb: 117, 170, 226;
  --highlight-cyan-rgb: 118, 205, 189;
  --highlight-green-rgb: 112, 206, 134;
  --highlight-orange-rgb: 232, 150, 89;
  --highlight-pink-rgb: 206, 147, 200;
  --highlight-purple-rgb: 162, 145, 213;
  --highlight-red-rgb: 223, 103, 117;
  --highlight-yellow-rgb: 240, 200, 129;
  --hotkey-gradient: linear-gradient(to top, hsl(27, 60%, 44%) -10%, color-mix(in oklab, oklab(from hsl(27, 60%, 44%) l a b / 0.25) 30%, transparent 70%) 210%);
  --hr-color: oklch(100% 0.05625 64 / 0.1);
  --icon-color: oklch(63.75% 0.02438 64);
  --icon-color-active: color-mix(in oklab, hsl(27, 60%, 44%) 64%, #fff 36%);
  --icon-color-focused: oklch(85.00% 0.01000 64);
  --icon-color-hover: oklch(85.00% 0.01000 64);
  ...
  --indent-unit: 0.375em;
  --indentation-guide-color: oklch(100% 0.05625 64 / 0.1);
  --indentation-guide-width: 0;
  --indentation-guide-width-active: 0;
  --inline-title-color: oklch(89.5% 0.00250 64);
  --inline-title-margin-bottom: round(nearest, clamp(0px, 0.5em, 1.5rem), 2px);
  --inline-title-size: 2em;
  --inline-title-weight: 330;
  --input-border-width: 0;
  --input-date-separator: oklch(52.50% 0.01625 64);
  --input-font-weight: 420;
  --input-height: 28px;
  --input-placeholder-color: oklch(52.50% 0.01625 64);
  --input-radius: 8px;
  --input-shadow: none;
  --input-shadow-hover: none;
  --interactive-accent: hsl(27, 60%, 44%);
  --interactive-accent-hover: color-mix(in oklab, hsl(27, 60%, 44%) 62.5%, color-mix(in oklab, hsl(27, 60%, 44%) 64%, #fff 36%));
  --interactive-accent-hsl: 27, 60%, 44%;
  --interactive-hover: oklch(36.25% 0.01000 64);
  --interactive-normal: oklch(34.50% 0.01000 64);
  --light: var(--background-primary, oklch(23.75% 0.00750 64));
  --lightgray: var(--background-secondary, oklch(27.50% 0.01000 64));
  --line-height-normal: 1.6;
  --link-color: color-mix(in oklab, hsl(27, 60%, 44%) 64%, #fff 36%);
  --link-color-hover: color-mix(in oklab, color-mix(in oklab, hsl(27, 60%, 44%) 64%, #fff 36%), transparent 8%);
  --link-color-sidebar: color-mix(in oklab, color-mix(in oklab, hsl(27, 60%, 44%) 64%, #fff 36%), transparent 8%);
  --link-decoration: none;
  --link-decoration-hover: none;
  --link-external-color: color-mix(in oklab, hsl(27, 60%, 44%) 64%, #fff 36%);
  --link-external-color-hover: color-mix(in oklab, color-mix(in oklab, hsl(27, 60%, 44%) 64%, #fff 36%), transparent 8%);
  --link-unresolved-color: oklch(from color-mix(in oklab, hsl(27, 60%, 44%) 64%, #fff 36%) l c h / 0.75);
  --link-unresolved-decoration-color: hsla(27, 60%, 44%, 0.3);
  --link-unresolved-lch: 0.75;
  --link-unresolved-opacity: 1;
  --link-weight: 420;
  --list-bullet-color: oklch(77.50% 0.02438 64);
  --list-dash-color: oklch(100% 0.015 64 / 0.35);
  --list-indent: 1.5em;
  --list-marker-color: oklch(52.50% 0.01625 64);
  --list-marker-color-collapsed: color-mix(in oklab, hsl(27, 60%, 44%) 64%, #fff 36%);
  --list-marker-color-hover: oklch(71.25% 0.02438 64);
  --list-spacing: 0.125em;
  --math-color: oklch(93.25% 0.00250 64);
  --menu-background: color-mix(in oklab, oklch(23.75% 0.00750 64), oklch(27.50% 0.01000 64));
  --menu-border-color: oklch(100% 0.03 64 / 0.125);
  --menu-radius: 14px;
  --menu-shadow: 0px 3px 18px 0px oklch(0 0 0 / 0.1875);
  --metadata-border-color: oklch(100% 0.0375 64 / 0.0625);
  --metadata-border-radius: 12px;
  --metadata-divider-color: oklch(100% 0.0375 64 / 0.0625);
  --metadata-gap: 2px;
  --metadata-input-background-active: oklch(100% 0.0375 64 / 0.05);
  ...
  --metadata-input-text-color: oklch(85.00% 0.01000 64);
  --metadata-label-background-active: oklch(100% 0.0375 64 / 0.05);
  ...
  --metadata-label-text-color: oklch(63.75% 0.02438 64);
  --metadata-label-text-color-hover: oklch(63.75% 0.02438 64);
  --metadata-label-width: 10em;
  --metadata-property-background-active: oklch(100% 0.0375 64 / 0.05);
  --metadata-property-box-shadow-focus: 0 0 0 2.5px color-mix(in oklab, hsl(27, 60%, 44%) 50%, transparent 75%);
  --metadata-property-box-shadow-hover: 0 0 0 2.5px oklch(100% 0.0375 64 / 0.05);
  --mobile-nav-fade-bg: linear-gradient(oklch(from oklch(27.50% 0.01000 64) l c h), transparent 78px);
  --modal-background: oklch(27.75% 0.01 64 / 0.625);
  --modal-border-color: oklch(43.75% 0.01625 64);
  --modal-border-width: 0;
  --modal-community-header-bg: oklch(from oklch(27.50% 0.01000 64) l 0.01000 h / 0.5);
  --modal-community-item-bg: oklch(from oklch(34.50% 0.01000 64) l 0.01000 h / 0.5);
  --modal-radius: 22px;
  --modal-small-background: oklch(27.75% 0.01 64 / 0.625);
  --nav-collapse-icon-color: oklch(100% 0.015 64 / 0.35);
  --nav-collapse-icon-color-collapsed: oklch(52.50% 0.01625 64);
  --nav-folder-color: oklch(77.50% 0.02438 64);
  --nav-header-bg: oklch(100% 0.0375 64 / 0.0625);
  --nav-header-timing: cubic-bezier(0.3, 0.75, 0, 1);
  --nav-heading-color: oklch(77.50% 0.02438 64);
  --nav-heading-color-collapsed: oklch(52.50% 0.01625 64);
  --nav-heading-color-collapsed-hover: oklch(71.25% 0.02438 64);
  --nav-heading-color-hover: oklch(85.00% 0.01000 64);
  --nav-heading-weight: 520;
  --nav-heading-weight-hover: 520;
  --nav-indentation-guide-color: oklch(100% 0.05625 64 / 0.1);
  --nav-indentation-guide-width: 0;
  --nav-item-background-active: oklch(100% 0.0375 64 / 0.05);
  --nav-item-background-hover: oklch(100% 0.0375 64 / 0.05);
  --nav-item-background-selected: hsla(27, 60%, 44%, 0.15);
  --nav-item-color: oklch(71.25% 0.02438 64);
  --nav-item-color-active: oklch(85.00% 0.01000 64);
  --nav-item-color-highlighted: color-mix(in oklab, hsl(27, 60%, 44%) 64%, #fff 36%);
  --nav-item-color-hover: oklch(85.00% 0.01000 64);
  --nav-item-color-selected: oklch(85.00% 0.01000 64);
  --nav-item-radius: 8px;
  --nav-tag-color: oklch(52.50% 0.01625 64);
  --nav-tag-color-active: oklch(71.25% 0.02438 64);
  --nav-tag-color-hover: oklch(71.25% 0.02438 64);
  --nav-tag-radius: 8px;
  --nav-tag-weight: 620;
  --nav-text-color: oklch(85.00% 0.01000 64);
  ...
  --pdf-background: oklch(23.75% 0.00750 64);
  --pdf-page-background: oklch(23.75% 0.00750 64);
  --pdf-shadow: none;
  --pdf-sidebar-background: oklch(23.75% 0.00750 64);
  --pdf-spread-shadow: none;
  --pdf-thumbnail-shadow: 0 0 0 1px oklch(100% 0.0375 64 / 0.0625);
  --pill-background: oklch(100% 0.0375 64 / 0.05);
  --pill-background-hover: oklch(100% 0.0375 64 / 0.05);
  --pill-border-color: oklch(100% 0.0375 64 / 0.0625);
  --pill-border-color-hover: oklch(36.25% 0.01000 64);
  --pill-color: oklch(71.25% 0.02438 64);
  --pill-color-hover: oklch(71.25% 0.02438 64);
  --pill-color-remove: oklch(52.50% 0.01625 64);
  --pill-color-remove-hover: white;
  --pill-radius: 18px;
  --pill-weight: 490;
  --prompt-backdrop-filter: blur(12px) saturate(1.125) brightness(1);
  --prompt-background: oklch(27.75% 0.01 64 / 0.625);
  --prompt-border-color: oklch(100% 0.03 64 / 0.125);
  ...
  --radius-xs: 6px;
  --radius-xxl: 22px;
  --raised-background: color-mix(in srgb, oklch(34.50% 0.01000 64) 65%, transparent) linear-gradient(oklch(34.50% 0.01000 64), color-mix(in srgb, oklch(34.50% 0.01000 64) 65%, transparent));
  ...
  --ribbon-width: 56px;
  --scrollbar-active-thumb-bg: oklch(36.25% 0.01000 64);
  --scrollbar-radius: 18px;
  --scrollbar-thumb-bg: oklch(31.25% 0.01000 64);
  --search-clear-button-color: oklch(52.50% 0.01625 64);
  --search-icon-color: oklch(52.50% 0.01625 64);
  --search-icon-size: 17px;
  --search-result-background: oklch(from oklch(24.00% 0.00250 64) l 0.01000 h / 0.375);
  --secondary: var(--text-accent, color-mix(in oklab, hsl(27, 60%, 44%) 64%, #fff 36%));
  --setting-group-heading-color: oklch(63.75% 0.02438 64);
  --setting-group-heading-size: 18px;
  --setting-group-heading-weight: 520;
  --setting-item-background: color-mix(in oklab, oklch(23.75% 0.00750 64) 87.5%, oklch(27.50% 0.01000 64));
  --setting-items-background: oklch(23.75% 0.00750 64);
  --setting-items-border-color: oklch(100% 0.0375 64 / 0.0625);
  --setting-items-padding: 16px;
  --setting-items-radius: 16px;
  --settings-background: oklch(26.875% 0.0075 64);
  --shadow-button: inset 3px 3px 1.5px -1.25px oklab(from hsl(27, 60%, 44%) calc(l + 0.075) a b / 0.75), inset -3px -3px 1.5px -1.25px oklab(from hsl(27, 60%, 44%) calc(l + 0.075) a b / 0.5), 0px 3px 15px 0px oklch(from oklch(23.75% 0.00750 64) l 0.01000 h / 0.75);
  --shadow-button-error: inset 3.25px 3.25px 1.25px -1.25px oklab(from #df6775 calc(l + 0.075) a b / 0.75), inset -3.25px -3.25px 1.25px -1.25px oklab(from #df6775 calc(l + 0.075) a b / 0.5), 0px 3px 15px 0px oklch(from oklch(23.75% 0.00750 64) l 0.01000 h / 0.75);
  --shadow-canvas-node: 0px 0px 16px 0px oklch(0 0 0 / 0.1875);
  --shadow-fab: 0 0 0 0.5px oklch(100% 0.03 64 / 0.125), 0px 2px 12px 0px oklch(0 0 0 / 0.1875);
  --shadow-faint: 0px 3px 15px 0px oklch(from oklch(23.75% 0.00750 64) l 0.01000 h / 0.75);
  --shadow-input: 0 0 0 0.5px oklch(100% 0.03 64 / 0.125);
  --shadow-input-active: 0 0 0 2.5px color-mix(in oklab, hsl(27, 60%, 44%) 50%, transparent 75%);
  ...
  --shadow-setting-items: 0 4px 12px 0 oklch(from oklch(24.00% 0.00250 64) l 0.01000 h / 0.375);
  --shadow-setting-items-top: inset 1px 2px 2px 0 oklch(from oklch(24.00% 0.00250 64) l 0.01000 h / 0.375), 0px 1px 9px oklch(100% 0.045 64 / 0.025);
  --shadow-sidebar: 0px 0px 12px 0px oklch(from oklch(27.50% 0.01000 64) l 0.01000 h / 0.5);
  --shadow-strong: 0px 0px 24px 0px oklch(0 0 0 / 0.375);
  --shadow-suggestion-item: inset 3.75px 3.75px 1.5px -1.25px oklab(from hsl(27, 60%, 44%) calc(l + 0.075) a b / 0.75), inset -3.75px -3.75px 1.5px -1.25px oklab(from hsl(27, 60%, 44%) calc(l + 0.075) a b / 0.5), 0px 3px 18px 0px oklch(0 0 0 / 0.1875);
  ...
  --shadow-toggle: inset 1.5px 1.5px 1.5px 0px oklab(from hsl(27, 60%, 44%) calc(l + 0.075) a b / 0.75), inset -1.5px -1.5px 1.5px 0px oklab(from hsl(27, 60%, 44%) calc(l + 0.075) a b / 0.5);
  --shadow-workspace: 0 0 0 0.5px oklch(100% 0.05625 64 / 0.1), 0 0 20px oklch(from oklch(23.75% 0.00750 64) l 0.01000 h / 0.75);
  --shadow-workspace-multi: 0 0 0 0.5px oklch(100% 0.05625 64 / 0.1);
  --shiki-active-tab-border-color: oklch(71.25% 0.02438 64);
  --shiki-code-background: oklch(100% 0.0375 64 / 0.05);
  --shiki-code-block-border-radius: 6px;
  --shiki-code-comment: oklch(52.50% 0.01625 64);
  --shiki-code-function: #70ce86;
  --shiki-code-important: #e89659;
  --shiki-code-keyword: #ce93c8;
  --shiki-code-normal: oklch(71.25% 0.02438 64);
  --shiki-code-property: #76cdbd;
  --shiki-code-punctuation: oklch(71.25% 0.02438 64);
  --shiki-code-string: #f0c881;
  --shiki-code-value: #a291d5;
  --shiki-gutter-border-color: oklch(100% 0.0375 64 / 0.0625);
  --shiki-gutter-text-color: oklch(52.50% 0.01625 64);
  --shiki-gutter-text-color-highlight: oklch(71.25% 0.02438 64);
  --shiki-highlight-green: rgba(112, 206, 134, 0.5);
  --shiki-highlight-green-background: rgba(112, 206, 134, 0.1);
  --shiki-highlight-neutral: oklch(71.25% 0.02438 64);
  --shiki-highlight-red: rgba(223, 103, 117, 0.5);
  --shiki-highlight-red-background: rgba(223, 103, 117, 0.1);
  --shiki-terminal-dots-color: oklch(52.50% 0.01625 64);
  --sidebar-left-toggle-inner-width: 12%;
  --sidebar-right-toggle-inner-width: 12%;
  --slider-thumb-border-color: oklch(36.25% 0.01000 64);
  --slider-thumb-border-width: 0;
  --slider-thumb-height: 12px;
  --slider-thumb-radius: 12px;
  --slider-thumb-width: 12px;
  --slider-thumb-y: -3px;
  --slider-track-background: oklch(100% 0.03 64 / 0.125);
  --slider-track-height: 20px;
  --stacked-shadow-color: oklch(0 0 0 / 0.1875);
  --status-bar-background: transparent;
  --status-bar-border-color: oklch(100% 0.0375 64 / 0.0625);
  --status-bar-border-width: 0;
  --status-bar-radius: 18px 0 0 18px;
  --status-bar-text-color: oklch(71.25% 0.02438 64);
  --strikethrough-color: oklch(52.50% 0.01625 64);
  --suggestion-background: oklch(23.75% 0.00750 64);
  --sync-avatar-color-1: #df6775;
  --sync-avatar-color-2: #e89659;
  --sync-avatar-color-3: #f0c881;
  --sync-avatar-color-4: #70ce86;
  --sync-avatar-color-5: #76cdbd;
  --sync-avatar-color-6: #75aae2;
  --sync-avatar-color-7: #a291d5;
  --sync-avatar-color-8: #ce93c8;
  --tab-background-active: oklch(23.75% 0.00750 64);
  --tab-close-bg: oklch(38.25% 0.01000 64 / 0.875);
  --tab-container-background: transparent;
  --tab-divider-color: oklch(36.25% 0.01000 64);
  --tab-font-weight: 420;
  --tab-max-width: 240px;
  --tab-outline-color: oklch(100% 0.0375 64 / 0.0625);
  --tab-outline-width: 0;
  --tab-radius: 8px;
  --tab-right-fade: linear-gradient(to left, oklch(31.25% 0.0125 64) 80%, transparent);
  --tab-right-fade-alt: linear-gradient(to left, oklch(28.5% 0.01000 64) 80%, transparent);
  --tab-sidebar-bg: oklch(100% 0.0375 64 / 0.0625);
  --tab-sidebar-container-bg: oklch(100% 0.045 64 / 0.025);
  ...
  --tab-switcher-background: oklch(27.50% 0.01000 64);
  --tab-switcher-menubar-background: linear-gradient(to top, oklch(27.50% 0.01000 64), transparent);
  --tab-switcher-preview-radius: 20px;
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(27, 60%, 44%);
  --tab-text-color: oklch(63.75% 0.02438 64);
  --tab-text-color-active: oklch(93.25% 0.00250 64);
  --tab-text-color-focused: oklch(63.75% 0.02438 64);
  --tab-text-color-focused-active: oklch(93.25% 0.00250 64);
  --tab-text-color-focused-active-current: oklch(93.25% 0.00250 64);
  --tab-text-color-focused-highlighted: color-mix(in oklab, hsl(27, 60%, 44%) 64%, #fff 36%);
  --tab-width: 240px;
  --table-add-button-border-color: oklch(100% 0.0375 64 / 0.0625);
  --table-border-color: oklch(100% 0.05625 64 / 0.1);
  --table-drag-handle-background-active: hsl(27, 60%, 44%);
  --table-drag-handle-color: oklch(52.50% 0.01625 64);
  --table-header-border-color: oklch(100% 0.05625 64 / 0.1);
  --table-header-color: oklch(63.75% 0.02438 64);
  --table-header-size: 0.90625em;
  --table-header-weight: 520;
  --table-line-height: 1.6;
  --table-row-alt-background: oklch(100% 0.05625 64 / 0.015);
  --table-row-alt-background-hover: oklch(100% 0.05625 64 / 0.015);
  --table-row-bg: oklch(100% 0.05625 64 / 0.015);
  --table-selection: hsla(27, 60%, 44%, 0.1);
  --table-selection-border-color: hsl(27, 60%, 44%);
  --table-text-size: 0.90625em;
  --table-text-weight: 420;
  --tag-background: hsla(27, 60%, 44%, 0.1);
  --tag-background-hover: hsla(27, 60%, 44%, 0.2);
  --tag-border-color: oklch(from hsl(27, 60%, 44%) l c h / 0.025);
  --tag-border-color-hover: hsla(27, 60%, 44%, 0.15);
  --tag-color: color-mix(in oklab, hsl(27, 60%, 44%) 64%, #fff 36%);
  --tag-color-hover: color-mix(in oklab, hsl(27, 60%, 44%) 64%, #fff 36%);
  --tag-padding-x: 0.6875em;
  --tag-padding-y: 0.3125em;
  --tag-size: 0.8em;
  --tag-weight: 490;
  --tertiary: var(--text-accent-hover, color-mix(in oklab, color-mix(in oklab, hsl(27, 60%, 44%) 64%, #fff 36%), transparent 8%));
  --text-accent: color-mix(in oklab, hsl(27, 60%, 44%) 64%, #fff 36%);
  --text-accent-hover: color-mix(in oklab, color-mix(in oklab, hsl(27, 60%, 44%) 64%, #fff 36%), transparent 8%);
  --text-error: #df6775;
  --text-faint: oklch(52.50% 0.01625 64);
  --text-highlight-bg: oklch(from rgb(240, 200, 129) 0.8 calc(c * 1.375) h / 0.33);
  --text-highlight-bg-rgb: 240, 200, 129;
  --text-highlight-bg-search: oklch(from rgb(240, 200, 129) 0.875 calc(c * 1.375) h / 0.625);
  --text-muted: oklch(71.25% 0.02438 64);
  --text-normal: oklch(85.00% 0.01000 64);
  --text-selection: oklab(from hsl(27, 60%, 44%) l a b / 0.25);
  --text-success: #70ce86;
  --text-warning: #e89659;
  --textHighlight: var(--text-highlight-bg, oklch(from rgb(240, 200, 129) 0.8 calc(c * 1.375) h / 0.33));
  ...
  --titlebar-border-color: oklch(100% 0.0375 64 / 0.0625);
  --titlebar-height: 36px;
  --titlebar-text-color: oklch(100% 0.015 64 / 0.35);
  --titlebar-text-color-focused: oklch(71.25% 0.02438 64);
  --titlebar-text-weight: 620;
  --toggle-border-width: 4px;
  --toggle-gradient: linear-gradient(to bottom, hsl(27, 60%, 44%) -30%, color-mix(in oklab, oklab(from hsl(27, 60%, 44%) l a b / 0.25) 30%, transparent 70%) 180%);
  ...
  --toggle-track-bg: oklch(100% 0.015 64 / 0.2);
  --toggle-width: 44px;
  ...
  --trans-faint-00: oklch(100% 0.05625 64 / 0.015);
  --trans-faint-05: oklch(100% 0.045 64 / 0.025);
  --trans-faint-10: oklch(100% 0.0375 64 / 0.05);
  --trans-faint-20: oklch(100% 0.0375 64 / 0.0625);
  --trans-faint-25: oklch(100% 0.0375 64 / 0.08125);
  --trans-faint-30: oklch(100% 0.05625 64 / 0.1);
  --trans-faint-40: oklch(100% 0.03 64 / 0.125);
  --trans-faint-50: oklch(100% 0.015 64 / 0.2);
  --trans-faint-60: oklch(100% 0.015 64 / 0.35);
  --trans-strong-00: oklch(from oklch(23.75% 0.00750 64) l 0.01000 h / 0.75);
  --trans-strong-05: oklch(from oklch(23.75% 0.00750 64) l 0.01000 h / 0.625);
  --trans-strong-10: oklch(from oklch(24.00% 0.00250 64) l 0.01000 h / 0.375);
  --trans-strong-20: oklch(from oklch(27.50% 0.01000 64) l 0.01000 h / 0.5);
  --trans-strong-30: oklch(from oklch(34.50% 0.01000 64) l 0.01000 h / 0.5);
  --trans-strong-40: oklch(from oklch(34.50% 0.01000 64) l 0.01000 h / 0.5);
  --trans-white-00: oklch(93.25% 0 0 / 0.75);
  --trans-white-10: oklch(93.25% 0 0 / 0.625);
  --vault-profile-color: oklch(63.75% 0.02438 64);
  --vault-profile-color-hover: oklch(71.25% 0.02438 64);
  --vault-profile-font-size: 18px;
  --vault-profile-font-weight: 420;
  --vl-ease-out: cubic-bezier(0.3, 0.75, 0, 1);
  --vl-layout-padding: 8px;
  --warning-gradient: linear-gradient(to top, #df6775 -30%, oklch(from oklch(27.50% 0.01000 64) l 0.01000 h / 0.5) 180%);
  --workspace-border-color: oklch(100% 0.0375 64 / 0.08125);
