...
html[saved-theme="dark"] body pre > code > [data-line] {
  border-left-color: rgb(240, 200, 129);
}
...
html[saved-theme="dark"] body pre > code [data-highlighted-chars] {
  border-bottom-color: rgb(240, 200, 129);
  border-left-color: rgb(240, 200, 129);
  border-right-color: rgb(240, 200, 129);
  border-top-color: rgb(240, 200, 129);
}
...
html[saved-theme="dark"] body ::-webkit-scrollbar {
  background: oklch(0.2375 0.0075 64) radial-gradient(oklch(0.2875 0.0075 64) 0%, oklch(0.2625 0.0125 64) 200%) repeat scroll 0% 0% / auto padding-box border-box;
  background-color: oklch(0.2375 0.0075 64);
}
