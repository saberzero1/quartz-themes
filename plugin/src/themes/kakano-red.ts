...
export const theme: ThemeData = {
  ...
  --background-modifier-error: var(--color-red, hsl(from hsl(0, 65%, 50%) 356 s l));
  --background-modifier-error-hover: var(--color-red, hsl(from hsl(0, 65%, 50%) 356 s l));
  --background-modifier-hover: var(--theme-color-base, hsl(0, 65%, 50%));
  --background-modifier-message: var(--theme-color-noticeBg, color-mix(
    in srgb,
    hsl(0, 65%, 50%),
    white 95%
  ));
  --background-modifier-success: var(--color-green, hsl(from hsl(0, 65%, 50%) 124 s l));
  ...
  --bases-table-header-background-hover: var(--background-modifier-hover, hsl(0, 65%, 50%));
  ...
  --bases-table-summary-background-hover: var(--background-modifier-hover, hsl(0, 65%, 50%));
  ...
  --checkbox-border-color: var(--interactive-accent, hsl(0, 65%, 50%));
  --checkbox-border-color-hover: var(--interactive-accent-hover, hsl(255, 89.76%, 75.9%));
  --checkbox-color: var(--interactive-accent, hsl(0, 65%, 50%));
  ...
  --code-bracket-background: var(--background-modifier-hover, hsl(0, 65%, 50%));
  --code-comment: light-dark(
    var(--theme-color-darkenTransparent50),
    var(--theme-color-lightenTransparent50)
  );
  --code-function: var(--color-yellow, hsl(from hsl(0, 65%, 50%) 57 s l));
  --code-important: var(--color-orange, hsl(from hsl(0, 65%, 50%) 27 s l));
  --code-keyword: var(--color-pink, hsl(from hsl(0, 65%, 50%) 331 s l));
  --code-normal: var(--text-normal, color-mix(
    in srgb,
    hsl(0, 65%, 50%),
    white 60%
  ));
  --code-operator: var(--color-red, hsl(from hsl(0, 65%, 50%) 356 s l));
  --code-property: var(--color-cyan, hsl(from hsl(0, 65%, 50%) 179 s l));
  ...
  --code-string: var(--color-green, hsl(from hsl(0, 65%, 50%) 124 s l));
  --code-tag: var(--color-red, hsl(from hsl(0, 65%, 50%) 356 s l));
  --code-value: var(--color-purple, hsl(from hsl(0, 65%, 50%) 253 s l));
  --collapse-icon-color: var(--theme-color-base, hsl(0, 65%, 50%));
  --collapse-icon-color-collapsed: var(--theme-color-base, hsl(0, 65%, 50%));
  ...
  --divider-color-hover: var(--interactive-accent, hsl(0, 65%, 50%));
  --divider-width: 0;
  --embed-background: var(--theme-color-baseTransparent12, hsl(
    from hsl(0, 65%, 50%) h s l / 0.12
  ));
  ...
  --flair-background: var(--theme-color-base, hsl(0, 65%, 50%));
  ...
  --graph-node-attachment: var(--color-yellow, hsl(from hsl(0, 65%, 50%) 57 s l));
  --graph-node-tag: var(--color-green, hsl(from hsl(0, 65%, 50%) 124 s l));
  ...
  --highlight: var(--background-modifier-hover, var(--theme-color-base, hsl(0, 65%, 50%)));
  --hr-color: var(--background-modifier-border, color-mix(
    in srgb,
    hsl(0, 65%, 50%),
    black 25%
  ));
  --icon-color: var(--theme-color-base, hsl(0, 65%, 50%));
  ...
  --interactive-accent: var(--theme-color-base, hsl(0, 65%, 50%));
  ...
  --metadata-property-background-active: var(--background-modifier-hover, hsl(0, 65%, 50%));
  ...
  --nav-indentation-guide-color: var(--theme-color-baseTransparent25, hsl(
    from hsl(0, 65%, 50%) h s l / 0.25
  ));
  --nav-item-background-active: var(--theme-color-base, hsl(0, 65%, 50%));
  ...
  --pill-background-hover: var(--theme-color-base, hsl(0, 65%, 50%));
  ...
  --search-clear-button-color: var(--theme-color-base, hsl(0, 65%, 50%));
  --search-icon-color: var(--theme-color-base, hsl(0, 65%, 50%));
  --search-result-background: var(--background-primary, color-mix(
    in srgb,
    hsl(0, 65%, 50%),
    black 95%
  ));
  --secondary: var(--interactive-accent, var(--theme-color-base, hsl(0, 65%, 50%)));
  ...
  --shiki-code-function: var(--color-green, hsl(from hsl(0, 65%, 50%) 124 s l));
  --shiki-code-important: var(--color-orange, hsl(from hsl(0, 65%, 50%) 27 s l));
  --shiki-code-keyword: var(--color-pink, hsl(from hsl(0, 65%, 50%) 331 s l));
  --shiki-code-normal: var(--text-muted, color-mix(in srgb, color-mix(
    in srgb,
    hsl(0, 65%, 50%),
    white 60%
  ), transparent 30%));
  --shiki-code-property: var(--color-cyan, hsl(from hsl(0, 65%, 50%) 179 s l));
  --shiki-code-punctuation: var(--text-muted, color-mix(in srgb, color-mix(
    in srgb,
    hsl(0, 65%, 50%),
    white 60%
  ), transparent 30%));
  --shiki-code-string: var(--color-yellow, hsl(from hsl(0, 65%, 50%) 57 s l));
  --shiki-code-value: var(--color-purple, hsl(from hsl(0, 65%, 50%) 253 s l));
  ...
  --sync-avatar-color-1: var(--color-red, hsl(from hsl(0, 65%, 50%) 356 s l));
  --sync-avatar-color-2: var(--color-orange, hsl(from hsl(0, 65%, 50%) 27 s l));
  --sync-avatar-color-3: var(--color-yellow, hsl(from hsl(0, 65%, 50%) 57 s l));
  --sync-avatar-color-4: var(--color-green, hsl(from hsl(0, 65%, 50%) 124 s l));
  --sync-avatar-color-5: var(--color-cyan, hsl(from hsl(0, 65%, 50%) 179 s l));
  --sync-avatar-color-6: var(--color-blue, hsl(from hsl(0, 65%, 50%) 219 s l));
  --sync-avatar-color-7: var(--color-purple, hsl(from hsl(0, 65%, 50%) 253 s l));
  --sync-avatar-color-8: var(--color-pink, hsl(from hsl(0, 65%, 50%) 331 s l));
  ...
  --tab-text-color-focused-highlighted: var(--theme-color-base, hsl(0, 65%, 50%));
  ...
  --table-drag-handle-background-active: var(--table-selection-border-color, hsl(0, 65%, 50%));
  ...
  --table-selection-border-color: var(--interactive-accent, hsl(0, 65%, 50%));
  ...
  --tag-weight: 400;
  --text-error: var(--color-red, hsl(from hsl(0, 65%, 50%) 356 s l));
  ...
  --text-success: var(--color-green, hsl(from hsl(0, 65%, 50%) 124 s l));
  --text-warning: var(--color-orange, hsl(from hsl(0, 65%, 50%) 27 s l));
  --textHighlight: var(--background-modifier-hover, var(--theme-color-base, hsl(0, 65%, 50%)));
  ...
  --theme-color-audioRecordingActive: var(--theme-color-redLightened, hsl(
    from hsl(from hsl(0, 65%, 50%) 356 s l) h calc(s * 1.5) calc(l * 1.5)
  ));
  ...
  --theme-color-cardBgHover: var(--theme-color-base, hsl(0, 65%, 50%));
  ...
  --theme-color-communityItemBgActive: var(--theme-color-base, hsl(0, 65%, 50%));
  ...
  --theme-color-contentItemBgActive: var(--theme-color-base, hsl(0, 65%, 50%));
  ...
  --theme-color-controlBgActive: var(--theme-color-base, hsl(0, 65%, 50%));
  ...
  --theme-color-hotkey: var(--theme-color-base, hsl(0, 65%, 50%));
  --theme-color-inputBorder: var(--theme-color-baseLightened25, color-mix(
    in srgb,
    hsl(0, 65%, 50%),
    white 25%
  ));
  --theme-color-inputPlaceholder: var(--theme-color-base, hsl(0, 65%, 50%));
  ...
  --theme-color-jiraIssueDangerBg: var(--theme-color-redTransparent25, hsl(from hsl(from hsl(0, 65%, 50%) 356 s l) h s l / 0.25));
  --theme-color-jiraIssueDeleteBg: var(--color-red, hsl(from hsl(0, 65%, 50%) 356 s l));
  ...
  --theme-color-navigationButtonBgHover: var(--theme-color-base, hsl(0, 65%, 50%));
  ...
  --theme-color-switcherBgActive: var(--theme-color-base, hsl(0, 65%, 50%));
  ...
  --theme-color-textMeta: var(--theme-color-base, hsl(0, 65%, 50%));
...
html[saved-theme="dark"] body[data-slug] div#quartz-root.page, html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left, html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left:has(.explorer), html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left .explorer .explorer-content {
  ...
  color: color(srgb 0.93 0.67 0.67);
}

html[saved-theme="dark"] body[data-slug], html[saved-theme="dark"] body[data-slug] .page > div#quartz-body, html[saved-theme="dark"] .page > div#quartz-body div.center, html[saved-theme="dark"] .page > div#quartz-body footer {
  background-color: var(--background-primary, color(srgb 0.04125 0.00875 0.00875));
  color: color(srgb 0.93 0.67 0.67);
}
...
html[saved-theme="dark"] body .page > div#quartz-body div.sidebar.left {
  border-right-color: color(srgb 0.61875 0.13125 0.13125);
  border-right-width: 0px;
}

html[saved-theme="dark"] body .page > div#quartz-body div.sidebar.right {
  background-color: var(--tab-container-background, rgba(0, 0, 0, 0));
  border-left-color: color(srgb 0.61875 0.13125 0.13125);
  color: color(srgb 0.93 0.67 0.67);
}`,
    typography: `html[saved-theme="dark"] body .markdown-rendered p > b, html[saved-theme="dark"] b {
  color: var(--bold-color, color(srgb 0.93 0.67 0.67));
  ...
  outline: color(srgb 0.93 0.67 0.67) none 0px;
  text-decoration-color: color(srgb 0.93 0.67 0.67);
}

html[saved-theme="dark"] body .markdown-rendered p > em, html[saved-theme="dark"] em {
  color: var(--italic-color, color(srgb 0.93 0.67 0.67));
  font-family: "??", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol";
  outline: color(srgb 0.93 0.67 0.67) none 0px;
  text-decoration-color: color(srgb 0.93 0.67 0.67);
}
...
html[saved-theme="dark"] body .text-highlight {
  color: var(--text-normal, color(srgb 0.93 0.67 0.67));
  font-family: "??", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol";
  outline: color(srgb 0.93 0.67 0.67) none 0px;
  text-decoration-color: color(srgb 0.93 0.67 0.67);
}
...
html[saved-theme="dark"] body h1.article-title {
  color: var(--tab-text-color-focused-active-current, color(srgb 0.93 0.67 0.67));
  font-size: 12.8px;
}

html[saved-theme="dark"] body li.task-list-item input[type="checkbox"] {
  border-color: rgb(210, 45, 45);
}

html[saved-theme="dark"] body li.task-list-item input[type="checkbox"]:checked {
  background-color: var(--checkbox-color, color(srgb 0.93 0.67 0.67));
  border-color: color(srgb 0.93 0.67 0.67);
}

html[saved-theme="dark"] body p {
  color: var(--text-muted, color(srgb 0.93 0.67 0.67 / 0.7));
  font-family: "??", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "??", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol";
  outline: color(srgb 0.93 0.67 0.67 / 0.7) none 0px;
  text-decoration-color: color(srgb 0.93 0.67 0.67 / 0.7);
}`,
  ...
  --background-modifier-error: hsl(from hsl(0, 65%, 50%) 356 s l);
  --background-modifier-error-hover: hsl(from hsl(0, 65%, 50%) 356 s l);
  --background-modifier-error-rgb: 251, 70, 76;
  --background-modifier-form-field: #2a2a2a;
  --background-modifier-form-field-hover: #2a2a2a;
  --background-modifier-hover: hsl(0, 65%, 50%);
  --background-modifier-message: color-mix(
    in srgb,
    hsl(0, 65%, 50%),
    white 95%
  );
  --background-modifier-success: hsl(from hsl(0, 65%, 50%) 124 s l);
  ...
  --checkbox-border-color: hsl(0, 65%, 50%);
  --checkbox-border-color-hover: hsl(255, 89.76%, 75.9%);
  --checkbox-color: hsl(0, 65%, 50%);
  ...
  --code-bracket-background: hsl(0, 65%, 50%);
  --code-comment: light-dark(
    hsl(from black h s l / 0.5),
    hsl(from white h s l / 0.5)
  );
  --code-function: hsl(from hsl(0, 65%, 50%) 57 s l);
  --code-important: hsl(from hsl(0, 65%, 50%) 27 s l);
  --code-keyword: hsl(from hsl(0, 65%, 50%) 331 s l);
  --code-normal: color-mix(
    in srgb,
    hsl(0, 65%, 50%),
    white 60%
  );
  --code-operator: hsl(from hsl(0, 65%, 50%) 356 s l);
  --code-property: hsl(from hsl(0, 65%, 50%) 179 s l);
  ...
  --code-radius: 0.25rem;
  --code-size: 0.875em;
  --code-string: hsl(from hsl(0, 65%, 50%) 124 s l);
  --code-tag: hsl(from hsl(0, 65%, 50%) 356 s l);
  --code-value: hsl(from hsl(0, 65%, 50%) 253 s l);
  --collapse-icon-color: hsl(0, 65%, 50%);
  --collapse-icon-color-collapsed: hsl(0, 65%, 50%);
  --color-accent: hsl(258, 88%, 66%);
  --color-accent-1: hsl(255, 89.76%, 75.9%);
  --color-accent-2: hsl(253, 92.4%, 85.14%);
  --color-accent-hsl: 258, 88%, 66%;
  --color-blue: hsl(from hsl(0, 65%, 50%) 219 s l);
  --color-cyan: hsl(from hsl(0, 65%, 50%) 179 s l);
  --color-green: hsl(from hsl(0, 65%, 50%) 124 s l);
  --color-orange: hsl(from hsl(0, 65%, 50%) 27 s l);
  --color-pink: hsl(from hsl(0, 65%, 50%) 331 s l);
  --color-purple: hsl(from hsl(0, 65%, 50%) 253 s l);
  --color-red: hsl(from hsl(0, 65%, 50%) 356 s l);
  --color-yellow: hsl(from hsl(0, 65%, 50%) 57 s l);
  --divider-color: color-mix(
    in srgb,
    hsl(0, 65%, 50%),
    black 25%
  );
  --divider-color-hover: hsl(0, 65%, 50%);
  ...
  --graph-node-attachment: hsl(from hsl(0, 65%, 50%) 57 s l);
  --graph-node-focused: hsl(255, 89.76%, 75.9%);
  --graph-node-tag: hsl(from hsl(0, 65%, 50%) 124 s l);
  ...
  --interactive-accent: hsl(0, 65%, 50%);
  ...
  --search-clear-button-color: hsl(0, 65%, 50%);
  --search-icon-color: hsl(0, 65%, 50%);
  ...
  --shiki-code-function: hsl(from hsl(0, 65%, 50%) 124 s l);
  --shiki-code-important: hsl(from hsl(0, 65%, 50%) 27 s l);
  --shiki-code-keyword: hsl(from hsl(0, 65%, 50%) 331 s l);
  --shiki-code-normal: color-mix(in srgb, color-mix(
    in srgb,
    hsl(0, 65%, 50%),
    white 60%
  ), transparent 30%);
  --shiki-code-property: hsl(from hsl(0, 65%, 50%) 179 s l);
  --shiki-code-punctuation: color-mix(in srgb, color-mix(
    in srgb,
    hsl(0, 65%, 50%),
    white 60%
  ), transparent 30%);
  --shiki-code-string: hsl(from hsl(0, 65%, 50%) 57 s l);
  --shiki-code-value: hsl(from hsl(0, 65%, 50%) 253 s l);
  ...
  --sync-avatar-color-1: hsl(from hsl(0, 65%, 50%) 356 s l);
  --sync-avatar-color-2: hsl(from hsl(0, 65%, 50%) 27 s l);
  --sync-avatar-color-3: hsl(from hsl(0, 65%, 50%) 57 s l);
  --sync-avatar-color-4: hsl(from hsl(0, 65%, 50%) 124 s l);
  --sync-avatar-color-5: hsl(from hsl(0, 65%, 50%) 179 s l);
  --sync-avatar-color-6: hsl(from hsl(0, 65%, 50%) 219 s l);
  --sync-avatar-color-7: hsl(from hsl(0, 65%, 50%) 253 s l);
  --sync-avatar-color-8: hsl(from hsl(0, 65%, 50%) 331 s l);
  ...
  --tab-text-color-focused-highlighted: hsl(0, 65%, 50%);
  ...
  --table-drag-handle-background-active: hsl(0, 65%, 50%);
  ...
  --table-selection-border-color: hsl(0, 65%, 50%);
  ...
  --text-error: hsl(from hsl(0, 65%, 50%) 356 s l);
  ...
  --text-success: hsl(from hsl(0, 65%, 50%) 124 s l);
  --text-warning: hsl(from hsl(0, 65%, 50%) 27 s l);
  ...
  --theme-color-blueDarkened: hsl(
    from hsl(from hsl(0, 65%, 50%) 219 s l) h calc(s * 1.5) calc(l * 0.5)
  );
  --theme-color-blueLightened: hsl(
    from hsl(from hsl(0, 65%, 50%) 219 s l) h calc(s * 1.5) calc(l * 1.5)
  );
  ...
  --theme-color-cardBgHover: hsl(0, 65%, 50%);
  ...
  --theme-color-communityItemBgActive: hsl(0, 65%, 50%);
  ...
  --theme-color-contentItemBgActive: hsl(0, 65%, 50%);
  --theme-color-control: light-dark(
    color-mix(
    in srgb,
    hsl(0, 65%, 50%),
  ...
  --theme-color-controlBgActive: hsl(0, 65%, 50%);
  ...
  --theme-color-cyanDarkened: hsl(
    from hsl(from hsl(0, 65%, 50%) 179 s l) h calc(s * 1.5) calc(l * 0.5)
  );
  --theme-color-cyanLightened: hsl(
    from hsl(from hsl(0, 65%, 50%) 179 s l) h calc(s * 1.5) calc(l * 1.5)
  );
  --theme-color-dataviewEmpty: light-dark(
    color-mix(
    in srgb,
  ...
  --theme-color-greenDarkened: hsl(
    from hsl(from hsl(0, 65%, 50%) 124 s l) h calc(s * 1.5) calc(l * 0.5)
  );
  --theme-color-greenLightened: hsl(
    from hsl(from hsl(0, 65%, 50%) 124 s l) h calc(s * 1.5) calc(l * 1.5)
  );
  --theme-color-greenTransparent25: hsl(from hsl(from hsl(0, 65%, 50%) 124 s l) h s l / 0.25);
  --theme-color-greenTransparent75: hsl(from hsl(from hsl(0, 65%, 50%) 124 s l) h s l / 0.75);
  --theme-color-hotkey: hsl(0, 65%, 50%);
  --theme-color-inputBorder: color-mix(
    in srgb,
    hsl(0, 65%, 50%),
    white 25%
  );
  --theme-color-inputPlaceholder: hsl(0, 65%, 50%);
  --theme-color-interactiveActive: color-mix(
    in srgb,
    hsl(0, 65%, 50%),
    black 25%
  );
  --theme-color-jiraIssueDangerBg: hsl(from hsl(from hsl(0, 65%, 50%) 356 s l) h s l / 0.25);
  --theme-color-jiraIssueDeleteBg: hsl(from hsl(0, 65%, 50%) 356 s l);
  --theme-color-jiraIssueInfoBg: light-dark(
    hsl(
    from hsl(from hsl(0, 65%, 50%) 219 s l) h calc(s * 1.5) calc(l * 1.5)
  ),
  ...
  --theme-color-jiraIssueWarningBg: light-dark(control
    hsl(
    from hsl(from hsl(0, 65%, 50%) 57 s l) h calc(s * 1.5) calc(l * 1.5)
  ),
    hsl(
    from hsl(from hsl(0, 65%, 50%) 57 s l) h calc(s * 1.5) calc(l * 0.5)
  )
  );
  ...
  --theme-color-navigationButtonBgHover: hsl(0, 65%, 50%);
  ...
  --theme-color-orangeDarkened: hsl(
    from hsl(from hsl(0, 65%, 50%) 27 s l) h calc(s * 1.5) calc(l * 0.5)
  );
  --theme-color-orangeLightened: hsl(
    from hsl(from hsl(0, 65%, 50%) 27 s l) h calc(s * 1.5) calc(l * 1.5)
  );
  --theme-color-orangeTransparent25: hsl(from hsl(from hsl(0, 65%, 50%) 27 s l) h s l / 0.25);
  --theme-color-orangeTransparent75: hsl(from hsl(from hsl(0, 65%, 50%) 27 s l) h s l / 0.75);
  --theme-color-pinkDarkened: hsl(
    from hsl(from hsl(0, 65%, 50%) 331 s l) h calc(s * 1.5) calc(l * 0.5)
  );
  --theme-color-pinkLightened: hsl(
    from hsl(from hsl(0, 65%, 50%) 331 s l) h calc(s * 1.5) calc(l * 1.5)
  );
  ...
  --theme-color-purpleDarkened: hsl(
    from hsl(from hsl(0, 65%, 50%) 253 s l) h calc(s * 1.5) calc(l * 0.5)
  );
  --theme-color-purpleLightened: hsl(
    from hsl(from hsl(0, 65%, 50%) 253 s l) h calc(s * 1.5) calc(l * 1.5)
  );
  --theme-color-queryComponentBg: hsl(
    from hsl(0, 65%, 50%) h s l / 0.12
  );
  --theme-color-redDarkened: hsl(
    from hsl(from hsl(0, 65%, 50%) 356 s l) h calc(s * 1.5) calc(l * 0.5)
  );
  --theme-color-redLightened: hsl(
    from hsl(from hsl(0, 65%, 50%) 356 s l) h calc(s * 1.5) calc(l * 1.5)
  );
  --theme-color-redTransparent25: hsl(from hsl(from hsl(0, 65%, 50%) 356 s l) h s l / 0.25);
  --theme-color-redTransparent75: hsl(from hsl(from hsl(0, 65%, 50%) 356 s l) h s l / 0.75);
  ...
  --theme-color-switcherBgActive: hsl(0, 65%, 50%);
  ...
  --theme-color-textMeta: hsl(0, 65%, 50%);
  ...
  --theme-color-yellowTransparent25: hsl(from hsl(from hsl(0, 65%, 50%) 57 s l) h s l / 0.25);
  --theme-color-yellowTransparent75: hsl(from hsl(from hsl(0, 65%, 50%) 57 s l) h s l / 0.75);
  --theme-gradient-bottomToTop: linear-gradient(
    0deg,
    color-mix(
    in srgb,
  ...
  padding-right: 0px;
  padding-top: 0px;
  scrollbar-color: var(--theme-color-baseTransparent25, color(srgb 0.825 0.175 0.175 / 0.25) rgba(0, 0, 0, 0)) transparent;
...
html[saved-theme="dark"] body ul.overflow {
  border-bottom-color: color(srgb 0.93 0.67 0.67);
  border-left-color: color(srgb 0.93 0.67 0.67);
  border-right-color: color(srgb 0.93 0.67 0.67);
  border-top-color: color(srgb 0.93 0.67 0.67);
}`,
    blockquotes: `html[saved-theme="dark"] body .data-footnote-backref {
  color: var(--text-faint, color(srgb 0.86875 0.38125 0.38125));
}
...
html[saved-theme="dark"] body td {
  border-bottom-color: color(srgb 0.2475 0.0525 0.0525);
  border-left-color: color(srgb 0.2475 0.0525 0.0525);
  border-right-color: color(srgb 0.2475 0.0525 0.0525);
  border-top-color: color(srgb 0.2475 0.0525 0.0525);
  color: var(--table-text-color, color(srgb 0.93 0.67 0.67));
  padding-bottom: 6px;
  padding-left: 12px;
  padding-right: 12px;
  padding-top: 6px;
...
html[saved-theme="dark"] body th {
  background-color: color(srgb 0.825 0.175 0.175 / 0.12);
  border-bottom-color: color(srgb 0.2475 0.0525 0.0525);
  border-left-color: color(srgb 0.2475 0.0525 0.0525);
  border-right-color: color(srgb 0.2475 0.0525 0.0525);
  border-top-color: color(srgb 0.2475 0.0525 0.0525);
  color: var(--table-header-color, color(srgb 0.93 0.67 0.67));
  padding-bottom: 6px;
  padding-left: 12px;
  padding-right: 12px;
  padding-top: 6px;
  ...
  border-bottom-color: color(srgb 0.61875 0.13125 0.13125);
  border-left-color: color(srgb 0.61875 0.13125 0.13125);
  border-right-color: color(srgb 0.61875 0.13125 0.13125);
  border-top-color: color(srgb 0.61875 0.13125 0.13125);
  color: var(--code-normal, color(srgb 0.93 0.67 0.67));
...
html[saved-theme="dark"] body video {
  ...
  border-bottom-color: color(srgb 0.93 0.67 0.67 / 0.7);
  border-left-color: color(srgb 0.93 0.67 0.67 / 0.7);
  border-right-color: color(srgb 0.93 0.67 0.67 / 0.7);
  border-top-color: color(srgb 0.93 0.67 0.67 / 0.7);
}
...
html[saved-theme="dark"] body .transclude {
  background-color: var(--embed-background, color(srgb 0.825 0.175 0.175 / 0.12));
  border-bottom-color: color(srgb 0.93 0.67 0.67);
  border-bottom-left-radius: 8px;
  border-bottom-right-radius: 8px;
  border-left-color: color(srgb 0.93 0.67 0.67);
...
html[saved-theme="dark"] body input[type=checkbox] {
  border-bottom-color: rgb(210, 45, 45);
  border-left-color: rgb(210, 45, 45);
  border-right-color: rgb(210, 45, 45);
  border-top-color: rgb(210, 45, 45);
}
...
html[saved-theme="dark"] body li.task-list-item[data-task="X"] {
  color: color(srgb 0.93 0.67 0.67 / 0.7);
}
...
html[saved-theme="dark"] body li.task-list-item[data-task="-"] input[type="checkbox"]::after {
  ...
  background-color: color(srgb 0.04125 0.00875 0.00875);
}
...
html[saved-theme="dark"] body li.task-list-item[data-task="!"] input[type="checkbox"]::after {
  ...
  mask-repeat: no-repeat;
  -webkit-mask-repeat: no-repeat;
  background-color: color(srgb 0.93 0.67 0.67);
}
...
html[saved-theme="dark"] body li.task-list-item[data-task="*"] input[type="checkbox"]::after {
  ...
  mask-repeat: no-repeat;
  -webkit-mask-repeat: no-repeat;
  background-color: color(srgb 0.825 0.7925 0.175);
}
...
html[saved-theme="dark"] body li.task-list-item[data-task="b"] input[type="checkbox"]::after {
  ...
  mask-repeat: no-repeat;
  -webkit-mask-repeat: no-repeat;
  background-color: color(srgb 0.825 0.175 0.218333);
}
...
html[saved-theme="dark"] body li.task-list-item[data-task="i"] input[type="checkbox"]::after {
  ...
  mask-repeat: no-repeat;
  -webkit-mask-repeat: no-repeat;
  background-color: color(srgb 0.175 0.4025 0.825);
}
...
html[saved-theme="dark"] body li.task-list-item[data-task="l"] input[type="checkbox"]::after {
  ...
  mask-repeat: no-repeat;
  -webkit-mask-repeat: no-repeat;
  background-color: color(srgb 0.315833 0.175 0.825);
}
...
html[saved-theme="dark"] body li.task-list-item[data-task="p"] input[type="checkbox"]::after {
  ...
  mask-repeat: no-repeat;
  -webkit-mask-repeat: no-repeat;
  background-color: color(srgb 0.175 0.825 0.218333);
}
...
html[saved-theme="dark"] body .search > .search-container > .search-space {
  background-color: var(--background-prompt, color(srgb 0.165 0.035 0.035));
  ...
  border-top-width: 0px;
  box-shadow: var(--shadow-l, color(srgb 0.0825 0.0175 0.0175 / 0.02) 0px 0px 3.2px 0px, color(srgb 0.0825 0.0175 0.0175 / 0.04) 0px 3.2px 6.4px 0px, color(srgb 0.0825 0.0175 0.0175 / 0.06) 0px 6.4px 19.2px 0px, color(srgb 0.0825 0.0175 0.0175 / 0.08) 0px 19.2px 32px 0px, color(srgb 0.0825 0.0175 0.0175 / 0.1) 0px 32px 64px 0px);
}
...
html[saved-theme="dark"] body .search > .search-container > .search-space > .search-layout > .results-container {
  color: var(--theme-color-controlActive, color(srgb 0.0825 0.0175 0.0175));
}

html[saved-theme="dark"] body .search > .search-container > .search-space > .search-layout > .results-container .result-card {
  border-bottom-color: color(srgb 0.0825 0.0175 0.0175);
  border-bottom-left-radius: 8px;
  border-bottom-right-radius: 8px;
  border-left-color: color(srgb 0.0825 0.0175 0.0175);
  border-right-color: color(srgb 0.0825 0.0175 0.0175);
  border-top-color: color(srgb 0.0825 0.0175 0.0175);
  border-top-left-radius: 8px;
  border-top-right-radius: 8px;
}
...
html[saved-theme="dark"] body .search > .search-container > .search-space > .search-layout > .results-container > .result-card:hover, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container > .result-card:focus, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container > .result-card.focus:not(:has(~ .result-card:hover, html[saved-theme="dark"] ~ .result-card:focus)) {
  background-color: var(--theme-color-controlBgActive, rgb(210, 45, 45));
  color: var(--theme-color-controlActive, color(srgb 0.0825 0.0175 0.0175));
}
...
html[saved-theme="dark"] body .search > .search-container > .search-space > input {
  background-color: color(srgb 0.2475 0.0525 0.0525);
  border-bottom-color: color(srgb 0.93 0.67 0.67);
  border-bottom-left-radius: 4px;
  border-bottom-right-radius: 4px;
  border-bottom-width: 0px;
...
html[saved-theme="dark"] body h3 {
  color: var(--h3-color, color(srgb 0.93 0.67 0.67));
  font-family: var(--theme-setting-headingFont), var(--font-text-theme);
}

html[saved-theme="dark"] body h4 {
  color: var(--h4-color, color(srgb 0.93 0.67 0.67));
  font-family: var(--theme-setting-headingFont), var(--font-text-theme);
}

html[saved-theme="dark"] body h5 {
  color: var(--h5-color, color(srgb 0.93 0.67 0.67));
  font-family: var(--theme-setting-headingFont), var(--font-text-theme);
}

html[saved-theme="dark"] body h6 {
  color: var(--h6-color, color(srgb 0.93 0.67 0.67));
  font-family: var(--theme-setting-headingFont), var(--font-text-theme);
}
...
html[saved-theme="dark"] body body {
  ...
  border-left-color: color(srgb 0.825 0.175 0.175 / 0.25);
}
...
html[saved-theme="dark"] body li.depth-0 {
  ...
  color: var(--theme-color-control, color(srgb 0.93 0.67 0.67));
}`,
    footer: `html[saved-theme="dark"] body footer {
  background-color: var(--status-bar-background, color(srgb 0.33 0.07 0.07));
  border-bottom-color: color(srgb 0.93 0.67 0.67);
  border-left-color: color(srgb 0.93 0.67 0.67);
  border-left-width: 0px;
  border-right-color: color(srgb 0.93 0.67 0.67);
  ...
  border-top-width: 0px;
  color: var(--status-bar-text-color, color(srgb 0.93 0.67 0.67));
  font-family: "??", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "??", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol";
}
...
html[saved-theme="dark"] body .recent-notes > ul.recent-ul > li .section > .desc > h3 > a {
  color: var(--nav-item-color, color(srgb 0.93 0.67 0.67));
}
...
html[saved-theme="dark"] body .darkmode svg {
  color: color(srgb 0.93 0.67 0.67);
  stroke: color(srgb 0.93 0.67 0.67);
}`,
...
html[saved-theme="dark"] body .canvas-sidebar {
  background-color: var(--background-secondary, color(srgb 0.2475 0.0525 0.0525));
  border-color: color(srgb 0.93 0.67 0.67);
  box-shadow: var(--theme-shadow-input, rgba(17, 9, 9, 0.5) 0px 1px 2px 0px, rgba(21, 4, 4, 0.25) 0px 3.4px 6.7px 0px, rgba(19, 7, 7, 0.15) 0px 15px 30px 0px);
}`,
    bases: `html[saved-theme="dark"] body .bases-table thead th {
  background-color: color(srgb 0.825 0.175 0.175 / 0.12);
  border-color: color(srgb 0.2475 0.0525 0.0525);
  color: var(--table-header-color, color(srgb 0.93 0.67 0.67));
}`,
    properties: `html[saved-theme="dark"] body .metadata {
  background-color: var(--metadata-property-background, color(srgb 0.165 0.035 0.035));
  border-bottom-color: color(srgb 0.93 0.67 0.67 / 0.7);
  border-left-color: color(srgb 0.93 0.67 0.67 / 0.7);
  border-right-color: color(srgb 0.93 0.67 0.67 / 0.7);
  border-top-color: color(srgb 0.93 0.67 0.67 / 0.7);
...
html[saved-theme="dark"] body .note-properties {
  background-color: var(--metadata-property-background, color(srgb 0.165 0.035 0.035));
  border-color: color(srgb 0.93 0.67 0.67 / 0.7);
}
...
html[saved-theme="dark"] body kbd {
  ...
  border-bottom-color: color(srgb 0.165 0.035 0.035);
  border-bottom-style: solid;
  border-bottom-width: 1px;
  border-left-color: color(srgb 0.165 0.035 0.035);
  border-left-style: solid;
  border-left-width: 1px;
  border-right-color: color(srgb 0.165 0.035 0.035);
  border-right-style: solid;
  border-right-width: 1px;
  border-top-color: color(srgb 0.165 0.035 0.035);
  border-top-style: solid;
  border-top-width: 1px;
  color: var(--theme-color-textSelected, color(srgb 0.165 0.035 0.035));
  font-family: var(--font-interface, "??", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "??", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol");
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --background-modifier-border-focus: var(--theme-color-base, hsl(0, 65%, 50%));
  --background-modifier-error: var(--color-red, hsl(from hsl(0, 65%, 50%) 356 s l));
  --background-modifier-error-hover: var(--color-red, hsl(from hsl(0, 65%, 50%) 356 s l));
  --background-modifier-hover: var(--theme-color-base, hsl(0, 65%, 50%));
  --background-modifier-message: var(--theme-color-noticeBg, color-mix(
  ...
  --checkbox-border-color: var(--interactive-accent, hsl(0, 65%, 50%));
  --checkbox-border-color-hover: var(--interactive-accent-hover, hsl(0, 65%, 50%));
  --checkbox-color: var(--interactive-accent, hsl(0, 65%, 50%));
  --checkbox-color-hover: var(--interactive-accent-hover, hsl(0, 65%, 50%));
  ...
  --interactive-accent: var(--theme-color-base, hsl(0, 65%, 50%));
  --interactive-accent-hover: var(--theme-color-base, hsl(0, 65%, 50%));
  ...
  --tag-weight: 400;
  --tertiary: var(--interactive-accent-hover, var(--theme-color-base, hsl(0, 65%, 50%)));
  --text-error: var(--color-red, hsl(from hsl(0, 65%, 50%) 356 s l));
  ...
  --theme-color-controlBgActive: var(--theme-color-base, hsl(0, 65%, 50%));
  --theme-color-controlBgHover: light-dark(var(--theme-color-baseLightened40), var(--theme-color-baseDarkened40));
  --theme-color-controlContentArea: var(--theme-color-base, hsl(0, 65%, 50%));
  ...
  --theme-color-navFileTag: var(--theme-color-base, hsl(0, 65%, 50%));
  --theme-color-navFileTagActive: var(--nav-item-color-active, color-mix(
    in srgb,
    hsl(0, 65%, 50%),
    white 80%
  ...
  --theme-color-navFileTagBorder: var(--theme-color-base, hsl(0, 65%, 50%));
  --theme-color-navigationButtonBgHover: var(--theme-color-base, hsl(0, 65%, 50%));
...
html[saved-theme="light"] body[data-slug] div#quartz-root.page, html[saved-theme="light"] .page > div#quartz-body div.sidebar.left, html[saved-theme="light"] .page > div#quartz-body div.sidebar.left:has(.explorer), html[saved-theme="light"] .page > div#quartz-body div.sidebar.left .explorer .explorer-content {
  background-color: var(--tab-container-background, rgba(0, 0, 0, 0));
  color: color(srgb 0.0825 0.0175 0.0175);
}
...
html[saved-theme="light"] body .page > div#quartz-body div.sidebar.left {
  border-right-color: color(srgb 0.86875 0.38125 0.38125);
  border-right-width: 0px;
}

html[saved-theme="light"] body .page > div#quartz-body div.sidebar.right {
  background-color: var(--tab-container-background, rgba(0, 0, 0, 0));
  border-left-color: color(srgb 0.86875 0.38125 0.38125);
  color: color(srgb 0.0825 0.0175 0.0175);
}`,
    typography: `html[saved-theme="light"] body .markdown-rendered p > b, html[saved-theme="light"] b {
  color: var(--bold-color, color(srgb 0.0825 0.0175 0.0175));
  font-family: "??", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol";
  outline: color(srgb 0.0825 0.0175 0.0175) none 0px;
  text-decoration-color: color(srgb 0.0825 0.0175 0.0175);
}

html[saved-theme="light"] body .markdown-rendered p > em, html[saved-theme="light"] em {
  color: var(--italic-color, color(srgb 0.0825 0.0175 0.0175));
  font-family: "??", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol";
  outline: color(srgb 0.0825 0.0175 0.0175) none 0px;
  text-decoration-color: color(srgb 0.0825 0.0175 0.0175);
}
...
html[saved-theme="light"] body .text-highlight {
  color: var(--text-normal, color(srgb 0.0825 0.0175 0.0175));
  font-family: "??", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol";
  outline: color(srgb 0.0825 0.0175 0.0175) none 0px;
  text-decoration-color: color(srgb 0.0825 0.0175 0.0175);
}
...
html[saved-theme="light"] body h1.article-title {
  color: var(--tab-text-color-focused-active-current, color(srgb 0.0825 0.0175 0.0175));
  font-size: 12.8px;
}
...
html[saved-theme="light"] body li.task-list-item input[type="checkbox"]:checked {
  background-color: var(--checkbox-color, rgb(210, 45, 45));
  border-color: rgb(210, 45, 45);
}

html[saved-theme="light"] body p {
  color: var(--text-muted, color(srgb 0.0825 0.0175 0.0175 / 0.7));
  font-family: "??", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "??", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol";
  outline: color(srgb 0.0825 0.0175 0.0175 / 0.7) none 0px;
  text-decoration-color: color(srgb 0.0825 0.0175 0.0175 / 0.7);
}`,
  ...
  --background-modifier-border-focus: hsl(0, 65%, 50%);
  ...
  --checkbox-border-color: hsl(0, 65%, 50%);
  --checkbox-border-color-hover: hsl(0, 65%, 50%);
  --checkbox-color: hsl(0, 65%, 50%);
  --checkbox-color-hover: hsl(0, 65%, 50%);
  ...
  --interactive-accent: hsl(0, 65%, 50%);
  --interactive-accent-hover: hsl(0, 65%, 50%);
  --interactive-accent-hsl: 258, 88%, 66%;
  ...
  --theme-color-controlContentArea: hsl(0, 65%, 50%);
  --theme-color-controlContentAreaHover: color-mix(
    in srgb,
    hsl(0, 65%, 50%),
    white 80%
  ...
  --theme-color-navFileTag: hsl(0, 65%, 50%);
  --theme-color-navFileTagActive: color-mix(
    in srgb,
    hsl(0, 65%, 50%),
    white 80%
  ...
  --theme-color-navFileTagBorder: hsl(0, 65%, 50%);
  --theme-color-navigationButtonBgHover: hsl(0, 65%, 50%);
  --theme-color-notice: color-mix(
    in srgb,
    hsl(0, 65%, 50%),
...
html[saved-theme="light"] body ul.overflow {
  ...
  color: var(--text-faint, color(srgb 0.2475 0.0525 0.0525));
}
...
html[saved-theme="light"] body td {
  ...
  border-right-color: color(srgb 0.93 0.67 0.67);
  border-top-color: color(srgb 0.93 0.67 0.67);
  color: var(--table-text-color, color(srgb 0.0825 0.0175 0.0175));
  padding-bottom: 6px;
  padding-left: 12px;
  padding-right: 12px;
  padding-top: 6px;
...
html[saved-theme="light"] body th {
  ...
  border-right-color: color(srgb 0.93 0.67 0.67);
  border-top-color: color(srgb 0.93 0.67 0.67);
  color: var(--table-header-color, color(srgb 0.0825 0.0175 0.0175));
  padding-bottom: 6px;
  padding-left: 12px;
  padding-right: 12px;
  padding-top: 6px;
  ...
  border-bottom-color: color(srgb 0.86875 0.38125 0.38125);
  border-left-color: color(srgb 0.86875 0.38125 0.38125);
  border-right-color: color(srgb 0.86875 0.38125 0.38125);
  border-top-color: color(srgb 0.86875 0.38125 0.38125);
  color: var(--code-normal, color(srgb 0.0825 0.0175 0.0175));
  font-family: var(--font-monospace, "??", ui-monospace, Menlo, SFMono-Regular, Consolas, "Roboto Mono", "Source Code Pro", monospace, ui-monospace, Menlo, SFMono-Regular, Consolas, "Roboto Mono", "Source Code Pro", monospace);
  padding-bottom: 3.5px;
  padding-left: 7px;
  padding-right: 7px;
...
html[saved-theme="light"] body video {
  ...
  border-bottom-color: color(srgb 0.0825 0.0175 0.0175 / 0.7);
  border-left-color: color(srgb 0.0825 0.0175 0.0175 / 0.7);
  border-right-color: color(srgb 0.0825 0.0175 0.0175 / 0.7);
  border-top-color: color(srgb 0.0825 0.0175 0.0175 / 0.7);
}
...
html[saved-theme="light"] body li.task-list-item[data-task="X"] {
  color: color(srgb 0.0825 0.0175 0.0175 / 0.7);
}
...
html[saved-theme="light"] body .search > .search-container > .search-space {
  background-color: var(--background-prompt, color(srgb 0.99125 0.95875 0.95875));
  border-bottom-color: rgba(0, 0, 0, 0);
  border-bottom-width: 0px;
  border-left-color: rgba(0, 0, 0, 0);
  border-left-width: 0px;
  ...
  border-top-color: rgba(0, 0, 0, 0);
  border-top-width: 0px;
  box-shadow: var(--shadow-l, color(srgb 0.61875 0.13125 0.13125 / 0.02) 0px 0px 3.2px 0px, color(srgb 0.61875 0.13125 0.13125 / 0.04) 0px 3.2px 6.4px 0px, color(srgb 0.61875 0.13125 0.13125 / 0.06) 0px 6.4px 19.2px 0px, color(srgb 0.61875 0.13125 0.13125 / 0.08) 0px 19.2px 32px 0px, color(srgb 0.61875 0.13125 0.13125 / 0.1) 0px 32px 64px 0px);
}
...
html[saved-theme="light"] body .search > .search-container > .search-space > .search-layout > .results-container {
  color: var(--theme-color-controlActive, color(srgb 0.99125 0.95875 0.95875));
}

html[saved-theme="light"] body .search > .search-container > .search-space > .search-layout > .results-container .result-card {
  border-bottom-color: color(srgb 0.99125 0.95875 0.95875);
  border-bottom-left-radius: 8px;
  border-bottom-right-radius: 8px;
  border-left-color: color(srgb 0.99125 0.95875 0.95875);
  border-right-color: color(srgb 0.99125 0.95875 0.95875);
  border-top-color: color(srgb 0.99125 0.95875 0.95875);
  border-top-left-radius: 8px;
  border-top-right-radius: 8px;
}
...
html[saved-theme="light"] body h1 {
  color: var(--h1-color, color(srgb 0.0825 0.0175 0.0175));
  font-family: var(--theme-setting-headingFont), var(--font-text-theme);
}

html[saved-theme="light"] body h1.article-title {
  color: var(--inline-title-color, color(srgb 0.0825 0.0175 0.0175));
  font-size: var(--inline-title-size, 27.648px);
  font-weight: var(--inline-title-weight, 400);
}

html[saved-theme="light"] body h2 {
  color: var(--h2-color, color(srgb 0.0825 0.0175 0.0175));
  font-family: var(--theme-setting-headingFont), var(--font-text-theme);
}
...
html[saved-theme="light"] body h3 {
  color: var(--h3-color, color(srgb 0.0825 0.0175 0.0175));
  font-family: var(--theme-setting-headingFont), var(--font-text-theme);
}

html[saved-theme="light"] body h4 {
  color: var(--h4-color, color(srgb 0.0825 0.0175 0.0175));
  font-family: var(--theme-setting-headingFont), var(--font-text-theme);
}

html[saved-theme="light"] body h5 {
  color: var(--h5-color, color(srgb 0.0825 0.0175 0.0175));
  font-family: var(--theme-setting-headingFont), var(--font-text-theme);
}

html[saved-theme="light"] body h6 {
  color: var(--h6-color, color(srgb 0.0825 0.0175 0.0175));
  font-family: var(--theme-setting-headingFont), var(--font-text-theme);
}
...
html[saved-theme="light"] body li.depth-0 {
  ...
  border-top-left-radius: 100%;
  border-top-right-radius: 100%;
  color: var(--theme-color-control, color(srgb 0.2475 0.0525 0.0525));
}`,
    footer: `html[saved-theme="light"] body footer {
  background-color: var(--status-bar-background, color(srgb 0.93 0.67 0.67));
...
html[saved-theme="light"] body .recent-notes > ul.recent-ul > li .section > .desc > h3 > a {
  color: var(--nav-item-color, color(srgb 0.165 0.035 0.035));
}

html[saved-theme="light"] body .recent-notes > ul.recent-ul > li .section > .meta {
  color: color(srgb 0.165 0.035 0.035);
  font-family: "??", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "??", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol";
}`,
...
html[saved-theme="light"] body .darkmode svg {
  color: color(srgb 0.2475 0.0525 0.0525);
  stroke: color(srgb 0.2475 0.0525 0.0525);
}`,
...
html[saved-theme="light"] body .breadcrumb-element p {
  ...
  border-color: color(srgb 0.0825 0.0175 0.0175);
}
...
html[saved-theme="light"] body .canvas-sidebar {
  background-color: var(--background-primary, color(srgb 0.965 0.835 0.835));
  border-color: color(srgb 0.0825 0.0175 0.0175);
  box-shadow: var(--theme-shadow-input, rgba(63, 1, 1, 0.2) 0px 1px 2px 0px, rgba(53, 11, 11, 0.15) 0px 3.4px 6.7px 0px, rgba(47, 16, 16, 0.05) 0px 15px 30px 0px);
}`,
  ...
  background-color: var(--metadata-property-background, color(srgb 0.99125 0.95875 0.95875));
  border-bottom-color: color(srgb 0.0825 0.0175 0.0175 / 0.7);
  border-left-color: color(srgb 0.0825 0.0175 0.0175 / 0.7);
  border-right-color: color(srgb 0.0825 0.0175 0.0175 / 0.7);
  border-top-color: color(srgb 0.0825 0.0175 0.0175 / 0.7);
...
html[saved-theme="light"] body .note-properties {
  background-color: var(--metadata-property-background, color(srgb 0.99125 0.95875 0.95875));
  border-color: color(srgb 0.0825 0.0175 0.0175 / 0.7);
}
...
html[saved-theme="light"] body input[type=text] {
  ...
  border-right-color: color(srgb 0.2475 0.0525 0.0525);
  border-top-color: color(srgb 0.2475 0.0525 0.0525);
  color: var(--text-normal, color(srgb 0.2475 0.0525 0.0525));
  font-family: "??", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "??", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol";
  padding-bottom: 0px;
  padding-left: 5.6px;
  padding-right: 5.6px;
...
html[saved-theme="light"] body kbd {
  background-color: var(--code-background, rgba(0, 0, 0, 0));
  border-bottom-color: color(srgb 0.965 0.835 0.835);
  border-bottom-style: solid;
  border-bottom-width: 1px;
  border-left-color: color(srgb 0.965 0.835 0.835);
  border-left-style: solid;
  border-left-width: 1px;
  border-right-color: color(srgb 0.965 0.835 0.835);
  border-right-style: solid;
  border-right-width: 1px;
  border-top-color: color(srgb 0.965 0.835 0.835);
  border-top-style: solid;
  border-top-width: 1px;
  color: var(--theme-color-textSelected, color(srgb 0.965 0.835 0.835));
  font-family: var(--font-interface, "??", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "??", system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol");
  font-size: var(--font-ui-smaller, 11.2px);
  padding-bottom: 2px;
  padding-left: 6px;
