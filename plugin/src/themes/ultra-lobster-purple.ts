...
export const theme: ThemeData = {
  ...
  --bases-table-cell-background-selected: var(--table-selection, hsla(258, 100%, 75%, 0.1));
  ...
  --blockquote-border-color: var(--interactive-accent, hsl(258, 100%, 75%));
  ...
  --checkbox-color: var(--interactive-accent, hsl(258, 100%, 75%));
  --checkbox-color-hover: var(--interactive-accent-hover, #53dfdd);
  ...
  --collapse-icon-color-collapsed: var(--color-accent, hsl(258, 100%, 75%));
  --color-accent: hsl(var(--color-purple-hsl));
  --color-accent-1: var(--color-cyan, #53dfdd);
  --color-accent-1-rgb: var(--color-cyan-rgb, 83, 223, 221);
  --color-accent-2: hsl(
  ...
  --color-accent-hsl: var(--color-purple-hsl, 258, 100%, 75%);
  --color-accent-rgb: var(--color-purple-rgb, 168, 130, 255);
  ...
  --divider-color-hover: var(--interactive-accent, hsl(258, 100%, 75%));
  ...
  --graph-node-focused: var(--color-accent, hsl(258, 100%, 75%));
  --graph-node-tag: var(--color-accent, hsl(258, 100%, 75%));
  ...
  --icon-color-active: var(--color-accent, hsl(258, 100%, 75%));
  ...
  --interactive-accent: var(--color-accent, hsl(258, 100%, 75%));
  --interactive-accent-hover: var(--color-accent-2, #53dfdd);
  --interactive-accent-hsl: var(--color-accent-hsl, 258, 100%, 75%);
  ...
  --link-external-color: var(--color-accent, hsl(258, 100%, 75%));
  ...
  --list-marker-color-collapsed: var(--color-accent, hsl(258, 100%, 75%));
  ...
  --pill-color-remove-hover: var(--text-accent, hsl(258, 100%, 75%));
  ...
  --scrollbar-active-thumb-bg: var(--color-accent, hsl(258, 100%, 75%));
  ...
  --secondary: var(--text-accent, var(--color-accent, hsl(258, 100%, 75%)));
  ...
  --tab-text-color-focused-highlighted: var(--color-accent, hsl(258, 100%, 75%));
  ...
  --table-drag-handle-background-active: var(--table-selection-border-color, hsl(258, 100%, 75%));
  ...
  --table-selection-border-color: var(--interactive-accent, hsl(258, 100%, 75%));
  --tag-color: var(--color-accent, hsl(258, 100%, 75%));
  --tag-color-hover: var(--color-accent, hsl(258, 100%, 75%));
  --tertiary: var(--text-accent-hover, var(--color-accent-2, hsl(
        258 calc(88% + 180) 66%
    )));
  --text-accent: var(--color-accent, hsl(258, 100%, 75%));
  ...
  --text-selection: var(--background-modifier-border, hsla(258, 100%, 75%, 0.33));
...
html[saved-theme="dark"] body li.task-list-item input[type="checkbox"]:checked {
  background-color: var(--color-accent, rgb(166, 128, 255));
...
html[saved-theme="dark"] body p {
  ...
  color: var(--link-external-color, rgb(166, 128, 255));
  font-family: "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  outline: rgb(166, 128, 255) none 0px;
  text-decoration: 13%;
  text-decoration-color: rgb(166, 128, 255);
  text-decoration-thickness: var(--link-decoration-thickness, 13%);
}

html[saved-theme="dark"] body a.internal-link, html[saved-theme="dark"] .breadcrumb-container .breadcrumb-element > a {
  background-color: color(srgb 0.65 0.5 1 / 0.1);
  color: var(--color-accent, rgb(166, 128, 255));
  font-family: "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
...
html[saved-theme="dark"] body .callout-title {
  ...
  --background-modifier-active-hover: hsla(258, 100%, 75%, 0.1);
  ...
  --blockquote-border-color: hsl(258, 100%, 75%);
  ...
  --checkbox-color: hsl(258, 100%, 75%);
  --checkbox-color-hover: #53dfdd;
  ...
  --collapse-icon-color-collapsed: hsl(258, 100%, 75%);
  --color-accent: hsl(258, 100%, 75%);
  --color-accent-1: #53dfdd;
  --color-accent-1-rgb: 83, 223, 221;
  --color-accent-2: hsl(
        258 calc(88% + 180) 66%
    );
  ...
  --graph-node-focused: hsl(258, 100%, 75%);
  --graph-node-tag: hsl(258, 100%, 75%);
  ...
  --hr-color: #313131;
  --interactive-accent: hsl(258, 100%, 75%);
  --interactive-accent-hover: #53dfdd;
  --interactive-accent-hsl: 258, 100%, 75%;
  --interactive-hover: #373737;
  --interactive-normal: #1a1a1a;
  --link-color: #666666;
  --link-color-hover: #bababa;
  --link-external-color: hsl(258, 100%, 75%);
  ...
  --scrollbar-active-thumb-bg: hsl(258, 100%, 75%);
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(258, 100%, 75%);
  ...
  --tab-text-color-focused-highlighted: hsl(258, 100%, 75%);
  ...
  --table-drag-handle-background-active: hsl(258, 100%, 75%);
  ...
  --table-selection: hsla(258, 100%, 75%, 0.1);
  --table-selection-blend-mode: lighten;
  --table-selection-border-color: hsl(258, 100%, 75%);
  --table-text-size: 16px;
  --tag-background: hsla(258, 100%, 75%, 0.1);
  --tag-background-hover: hsla(258, 100%, 75%, 0.2);
  --tag-border-color: hsla(258, 100%, 75%, 0.15);
  --tag-border-color-hover: hsla(258, 100%, 75%, 0.15);
  --tag-color: hsl(258, 100%, 75%);
  --tag-color-hover: hsl(258, 100%, 75%);
  --tag-size: 0.875em;
  --text-accent: hsl(258, 100%, 75%);
  ...
  --text-selection: hsla(258, 100%, 75%, 0.33);
  --text-success: #44cf6e;
  --text-warning: #e9973f;
  --touch-radius-l: 52px;
  --touch-radius-m: 44px;
...
html[saved-theme="dark"] body a.internal-link.tag-link, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  --pill-background: var(--tag-background, hsla(258, 100%, 75%, 0.1));
  --pill-background-hover: var(--tag-background-hover, hsla(258, 100%, 75%, 0.2));
  --pill-border-color: var(--tag-border-color, hsla(258, 100%, 75%, 0.15));
  --pill-border-color-hover: var(--tag-border-color-hover, hsla(258, 100%, 75%, 0.15));
  --pill-color: var(--tag-color, hsl(258, 100%, 75%));
  --pill-color-hover: var(--tag-color-hover, hsl(258, 100%, 75%));
  --pill-color-remove: var(--tag-color, hsl(258, 100%, 75%));
  --pill-color-remove-hover: var(--tag-color-hover, hsl(258, 100%, 75%));
  background-color: var(--pill-background, rgba(0, 0, 0, 0));
  border-bottom-color: color(srgb 0.65 0.5 1 / 0.4);
  border-bottom-left-radius: 8px;
  border-bottom-right-radius: 8px;
  border-bottom-width: 1px;
  border-left-color: color(srgb 0.65 0.5 1 / 0.4);
  border-left-width: 1px;
  border-right-color: color(srgb 0.65 0.5 1 / 0.4);
  border-right-width: 1px;
  border-top-color: color(srgb 0.65 0.5 1 / 0.4);
  border-top-left-radius: 8px;
  border-top-right-radius: 8px;
  border-top-width: 1px;
  color: var(--text-normal, rgb(186, 186, 186));
...
html[saved-theme="dark"] body h2 {
  ...
  border-bottom-color: rgb(166, 128, 255);
  border-left-color: rgb(166, 128, 255);
  border-right-color: rgb(166, 128, 255);
  border-top-color: rgb(166, 128, 255);
...
html[saved-theme="dark"] body h2::after {
  --font-weight: var(--h2-weight, 600);
  background: rgba(0, 0, 0, 0) linear-gradient(90deg, rgb(166, 128, 255) 0%, color(srgb 0.65 0.5 1 / 0.2) 60%, rgba(0, 0, 0, 0) 100%) repeat scroll 0% 0% / auto padding-box border-box;
  background-color: rgba(0, 0, 0, 0);
  background-image: linear-gradient(90deg, rgb(166, 128, 255) 0%, color(srgb 0.65 0.5 1 / 0.2) 60%, rgba(0, 0, 0, 0) 100%);
  border-bottom-color: rgb(166, 128, 255);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
  border-bottom-width: 0px;
...
html[saved-theme="dark"] body kbd {
  background-color: var(--code-background, color(srgb 0.65 0.5 1 / 0.7));
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  border-bottom-color: color(srgb 0.65 0.5 1 / 0.3);
  border-bottom-left-radius: 8px;
  border-bottom-right-radius: 8px;
  border-bottom-width: 1px;
  border-left-color: color(srgb 0.65 0.5 1 / 0.3);
  border-left-width: 1px;
  border-right-color: color(srgb 0.65 0.5 1 / 0.3);
  border-right-width: 1px;
  border-top-color: color(srgb 0.65 0.5 1 / 0.3);
  border-top-left-radius: 8px;
  border-top-right-radius: 8px;
  border-top-width: 1px;
  color: var(--color-accent, rgb(166, 128, 255));
  ...
  --bases-table-cell-background-selected: var(--table-selection, hsla(255, 82%, 63%, 0.1));
  ...
  --blockquote-border-color: var(--interactive-accent, hsl(255, 82%, 63%));
  --bodyFont: var(--font-text-theme, var(--ulu-font-general, "Instrument", sans-serif));
  --callout-blend-mode: var(--highlight-mix-blend-mode, normal);
  ...
  --checkbox-color: var(--interactive-accent, hsl(255, 82%, 63%));
  ...
  --collapse-icon-color-collapsed: var(--color-accent, hsl(255, 82%, 63%));
  --color-accent: hsl(var(--color-purple-hsl));
  --color-accent-1: var(--color-cyan, #00bfbc);
  --color-accent-1-rgb: var(--color-cyan-rgb, 0, 191, 188);
  --color-accent-2: hsl(
  ...
  --color-accent-hsl: var(--color-purple-hsl, 255, 82%, 63%);
  --color-accent-rgb: var(--color-purple-rgb, 120, 82, 238);
  ...
  --divider-color-hover: var(--interactive-accent, hsl(255, 82%, 63%));
  ...
  --graph-node-focused: var(--color-accent, hsl(255, 82%, 63%));
  --graph-node-tag: var(--color-accent, hsl(255, 82%, 63%));
  ...
  --icon-color-active: var(--color-accent, hsl(255, 82%, 63%));
  ...
  --interactive-accent: var(--color-accent, hsl(255, 82%, 63%));
  --interactive-accent-hover: var(--color-accent-2, hsl(
        258 88% 71%
    ));
  --interactive-accent-hsl: var(--color-accent-hsl, 255, 82%, 63%);
  ...
  --link-decoration-hover: none;
  --link-decoration-thickness: 13%;
  --link-external-color: var(--color-accent, hsl(255, 82%, 63%));
  --link-external-color-hover: var(--color-accent-hover, hsl(
        258 88% 71%
    ));
  --link-external-decoration: none;
  ...
  --list-marker-color-collapsed: var(--color-accent, hsl(255, 82%, 63%));
  ...
  --pill-color-remove-hover: var(--text-accent, hsl(255, 82%, 63%));
  ...
  --scrollbar-active-thumb-bg: var(--color-accent, hsl(255, 82%, 63%));
  --scrollbar-bg: rgb(from var(--mono-rgb-100) r g b / 0.1);
  ...
  --secondary: var(--text-accent, var(--color-accent, hsl(255, 82%, 63%)));
  ...
  --tab-text-color-focused-highlighted: var(--color-accent, hsl(255, 82%, 63%));
  ...
  --table-drag-handle-background-active: var(--table-selection-border-color, hsl(255, 82%, 63%));
  ...
  --table-selection-border-color: var(--interactive-accent, hsl(255, 82%, 63%));
  --tag-color: var(--color-accent, hsl(255, 82%, 63%));
  --tag-color-hover: var(--color-accent, hsl(255, 82%, 63%));
  --tertiary: var(--text-accent-hover, var(--color-accent-2, hsl(
        258 88% 71%
    )));
  --text-accent: var(--color-accent, hsl(255, 82%, 63%));
  --text-accent-hover: var(--color-accent-2, hsl(
        258 88% 71%
    ));
...
html[saved-theme="light"] body li.task-list-item input[type="checkbox"]:checked {
  background-color: var(--color-accent, rgb(122, 83, 238));
  border-color: rgba(0, 0, 0, 0);
}
...
html[saved-theme="light"] body p {
  ...
  color: var(--link-external-color, rgb(122, 83, 238));
  font-family: "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  outline: rgb(122, 83, 238) none 0px;
  text-decoration: 13%;
  text-decoration-color: rgb(122, 83, 238);
  text-decoration-thickness: var(--link-decoration-thickness, 13%);
}

html[saved-theme="light"] body a.internal-link, html[saved-theme="light"] .breadcrumb-container .breadcrumb-element > a {
  background-color: color(srgb 0.4783 0.3266 0.9334 / 0.1);
  color: var(--color-accent, rgb(122, 83, 238));
  font-family: "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  font-weight: var(--link-weight, 500);
  outline: rgb(122, 83, 238) none 0px;
  text-decoration-color: rgb(122, 83, 238);
...
html[saved-theme="light"] body .callout-title {
  ...
  --background-modifier-active-hover: hsla(255, 82%, 63%, 0.1);
  ...
  --blockquote-border-color: hsl(255, 82%, 63%);
  ...
  --collapse-icon-color-collapsed: hsl(255, 82%, 63%);
  --color-accent: hsl(255, 82%, 63%);
  --color-accent-1: #00bfbc;
  --color-accent-1-rgb: 0, 191, 188;
  --color-accent-2: hsl(
        258 88% 71%
    );
  --color-accent-hover: hsl(
  ...
  --color-accent-hsl: 255, 82%, 63%;
  --color-accent-rgb: 120, 82, 238;
  --color-base-00: #fff;
  --color-base-10: #ededed;
  --color-base-20: #f3f3f3;
  --divider-color: #c7c7c7;
  --divider-color-hover: hsl(255, 82%, 63%);
  --divider-vertical-height: 100%;
  ...
  --graph-node-focused: hsl(255, 82%, 63%);
  --graph-node-tag: hsl(255, 82%, 63%);
  ...
  --heading-spacing: 2.5rem;
  --hr-color: #c7c7c7;
  --interactive-accent: hsl(255, 82%, 63%);
  ...
  --link-external-color: hsl(255, 82%, 63%);
  --link-external-color-hover: hsl(
        258 88% 71%
    );
  ...
  --raised-blur: blur(6px) saturate(1.5) brightness(1.15);
  --scrollbar-active-thumb-bg: hsl(255, 82%, 63%);
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(255, 82%, 63%);
  ...
  --tab-text-color-focused-highlighted: hsl(255, 82%, 63%);
  ...
  --table-column-first-border-width: 1px;
  --table-column-last-border-width: 1px;
  --table-drag-handle-background-active: hsl(255, 82%, 63%);
  ...
  --table-row-background-hover: transparent;
  --table-row-last-border-width: 1px;
  --table-selection: hsla(255, 82%, 63%, 0.1);
  --table-selection-blend-mode: darken;
  --table-selection-border-color: hsl(255, 82%, 63%);
  --table-text-size: 16px;
  --tag-background: hsla(255, 82%, 63%, 0.1);
  --tag-background-hover: hsla(255, 82%, 63%, 0.2);
  --tag-border-color: hsla(255, 82%, 63%, 0.15);
  --tag-border-color-hover: hsla(255, 82%, 63%, 0.15);
  --tag-color: hsl(255, 82%, 63%);
  --tag-color-hover: hsl(255, 82%, 63%);
  --tag-size: 0.875em;
  --text-accent: hsl(255, 82%, 63%);
  --text-accent-hover: hsl(
        258 88% 71%
    );
  --text-error: #e93147;
...
html[saved-theme="light"] body a.internal-link.tag-link, html[saved-theme="light"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  --pill-background: var(--tag-background, hsla(255, 82%, 63%, 0.1));
  --pill-background-hover: var(--tag-background-hover, hsla(255, 82%, 63%, 0.2));
  --pill-border-color: var(--tag-border-color, hsla(255, 82%, 63%, 0.15));
  --pill-border-color-hover: var(--tag-border-color-hover, hsla(255, 82%, 63%, 0.15));
  --pill-color: var(--tag-color, hsl(255, 82%, 63%));
  --pill-color-hover: var(--tag-color-hover, hsl(255, 82%, 63%));
  --pill-color-remove: var(--tag-color, hsl(255, 82%, 63%));
  --pill-color-remove-hover: var(--tag-color-hover, hsl(255, 82%, 63%));
  background-color: var(--pill-background, rgba(0, 0, 0, 0));
  border-bottom-color: color(srgb 0.4783 0.3266 0.9334 / 0.4);
  border-bottom-left-radius: 8px;
  border-bottom-right-radius: 8px;
  border-bottom-width: 1px;
  border-left-color: color(srgb 0.4783 0.3266 0.9334 / 0.4);
  border-left-width: 1px;
  border-right-color: color(srgb 0.4783 0.3266 0.9334 / 0.4);
  border-right-width: 1px;
  border-top-color: color(srgb 0.4783 0.3266 0.9334 / 0.4);
  border-top-left-radius: 8px;
  border-top-right-radius: 8px;
  border-top-width: 1px;
  color: var(--text-normal, rgb(90, 90, 90));
...
html[saved-theme="light"] body h2 {
  --font-weight: var(--h2-weight, 600);
  border-bottom-color: rgb(122, 83, 238);
  border-left-color: rgb(122, 83, 238);
  border-right-color: rgb(122, 83, 238);
  border-top-color: rgb(122, 83, 238);
  color: var(--ulu-h2-text-color, var(--h2-color, var(--color-accent)));
  font-family: var(--h2-font, "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  font-size: var(--h2-size, 24px);
  font-weight: var(--font-weight, 600);
...
html[saved-theme="light"] body h2::after {
  --font-weight: var(--h2-weight, 600);
  background: rgba(0, 0, 0, 0) linear-gradient(90deg, rgb(122, 83, 238) 0%, color(srgb 0.4783 0.3266 0.9334 / 0.2) 60%, rgba(0, 0, 0, 0) 100%) repeat scroll 0% 0% / auto padding-box border-box;
  background-color: rgba(0, 0, 0, 0);
  background-image: linear-gradient(90deg, rgb(122, 83, 238) 0%, color(srgb 0.4783 0.3266 0.9334 / 0.2) 60%, rgba(0, 0, 0, 0) 100%);
  border-bottom-color: rgb(122, 83, 238);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
  border-bottom-width: 0px;
...
html[saved-theme="light"] body kbd {
  background-color: var(--code-background, color(srgb 0.4783 0.3266 0.9334 / 0.7));
  border-bottom-color: rgb(255, 255, 255);
  border-left-color: rgb(255, 255, 255);
  border-right-color: rgb(255, 255, 255);
  border-top-color: rgb(255, 255, 255);
...
html[saved-theme="light"] body ul.tags > li {
  background-color: rgb(from var(--color-accent) r g b/0.05);
  border-bottom-color: color(srgb 0.4783 0.3266 0.9334 / 0.3);
  border-bottom-left-radius: 8px;
  border-bottom-right-radius: 8px;
  border-bottom-width: 1px;
  border-left-color: color(srgb 0.4783 0.3266 0.9334 / 0.3);
  border-left-width: 1px;
  border-right-color: color(srgb 0.4783 0.3266 0.9334 / 0.3);
  border-right-width: 1px;
  border-top-color: color(srgb 0.4783 0.3266 0.9334 / 0.3);
  border-top-left-radius: 8px;
  border-top-right-radius: 8px;
  border-top-width: 1px;
  color: var(--color-accent, rgb(122, 83, 238));
