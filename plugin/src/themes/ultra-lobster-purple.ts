...
export const theme: ThemeData = {
  ...
  --background-modifier-active-hover: hsla(258, 100%, 75%, 0.1) !important;
  ...
  --bases-table-cell-background-selected: hsla(258, 100%, 75%, 0.1) !important;
  --bases-table-cell-shadow-active: 0 0 0 2px #414141 !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(258, 100%, 75%) !important;
  ...
  --blockquote-border-color: hsl(258, 100%, 75%) !important;
  ...
  --checkbox-color: hsl(258, 100%, 75%) !important;
  --checkbox-color-hover: #53dfdd !important;
  ...
  --collapse-icon-color-collapsed: hsl(258, 100%, 75%) !important;
  --color-accent: hsl(258, 100%, 75%) !important;
  --color-accent-1: #53dfdd !important;
  --color-accent-1-rgb: 83, 223, 221 !important;
  --color-accent-2: hsl(
        258 calc(88% + 180) 66%
    ) !important;
  ...
  --color-accent-hsl: 258, 100%, 75% !important;
  --color-accent-rgb: 168, 130, 255 !important;
  ...
  --divider-color-hover: hsl(258, 100%, 75%) !important;
  ...
  --embed-border-start: 2px solid hsl(258, 100%, 75%) !important;
  ...
  --graph-node-focused: hsl(258, 100%, 75%) !important;
  --graph-node-tag: hsl(258, 100%, 75%) !important;
  ...
  --icon-color-active: hsl(258, 100%, 75%) !important;
  ...
  --interactive-accent: hsl(258, 100%, 75%) !important;
  --interactive-accent-hover: #53dfdd !important;
  --interactive-accent-hsl: 258, 100%, 75% !important;
  ...
  --link-external-color: hsl(258, 100%, 75%) !important;
  ...
  --list-marker-color-collapsed: hsl(258, 100%, 75%) !important;
  ...
  --nav-item-background-selected: hsla(258, 100%, 75%, 0.15) !important;
  ...
  --pill-color-remove-hover: hsl(258, 100%, 75%) !important;
  ...
  --scrollbar-active-thumb-bg: hsl(258, 100%, 75%) !important;
  ...
  --secondary: hsl(258, 100%, 75%) !important;
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(258, 100%, 75%) !important;
  ...
  --tab-text-color-focused-highlighted: hsl(258, 100%, 75%) !important;
  --table-add-button-border-color: #313131 !important;
  --table-border-color: #313131 !important;
  --table-drag-handle-background-active: hsl(258, 100%, 75%) !important;
  --table-drag-handle-color: #999999 !important;
  --table-header-border-color: #313131 !important;
  --table-header-color: #bababa !important;
  --table-selection: hsla(258, 100%, 75%, 0.1) !important;
  --table-selection-border-color: hsl(258, 100%, 75%) !important;
  --tag-background: hsla(258, 100%, 75%, 0.1) !important;
  --tag-background-hover: hsla(258, 100%, 75%, 0.2) !important;
  --tag-border-color: hsla(258, 100%, 75%, 0.15) !important;
  --tag-border-color-hover: hsla(258, 100%, 75%, 0.15) !important;
  --tag-color: hsl(258, 100%, 75%) !important;
  --tag-color-hover: hsl(258, 100%, 75%) !important;
  --tertiary: hsl(
        258 calc(88% + 180) 66%
    ) !important;
  --text-accent: hsl(258, 100%, 75%) !important;
  ...
  --text-selection: hsla(258, 100%, 75%, 0.33) !important;
...
html[saved-theme="dark"] body li.task-list-item input[type="checkbox"]:checked {
  background-color: rgb(166, 128, 255);
  border-color: rgba(0, 0, 0, 0);
}
...
html[saved-theme="dark"] body kbd {
  background-color: color(srgb 0.65 0.5 1 / 0.7);
...
html[saved-theme="dark"] body ul.tags > li {
  background-color: color(srgb 0.65 0.5 1 / 0.05);
  ...
  --background-modifier-active-hover: hsla(255, 82%, 63%, 0.1) !important;
  ...
  --bases-table-cell-background-selected: hsla(255, 82%, 63%, 0.1) !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(255, 82%, 63%) !important;
  ...
  --blockquote-border-color: hsl(255, 82%, 63%) !important;
  ...
  --checkbox-color: hsl(255, 82%, 63%) !important;
  ...
  --collapse-icon-color-collapsed: hsl(255, 82%, 63%) !important;
  --color-accent: hsl(255, 82%, 63%) !important;
  --color-accent-1: #00bfbc !important;
  --color-accent-1-rgb: 0, 191, 188 !important;
  --color-accent-2: hsl(
        258 88% 71%
    ) !important;
  --color-accent-hover: hsl(
  ...
  --color-accent-hsl: 255, 82%, 63% !important;
  --color-accent-rgb: 120, 82, 238 !important;
  ...
  --divider-color-hover: hsl(255, 82%, 63%) !important;
  ...
  --embed-border-start: 2px solid hsl(255, 82%, 63%) !important;
  ...
  --graph-node-focused: hsl(255, 82%, 63%) !important;
  --graph-node-tag: hsl(255, 82%, 63%) !important;
  ...
  --icon-color-active: hsl(255, 82%, 63%) !important;
  ...
  --interactive-accent: hsl(255, 82%, 63%) !important;
  ...
  --link-decoration-hover: none !important;
  --link-decoration-thickness: 13% !important;
  --link-external-color: hsl(255, 82%, 63%) !important;
  --link-external-color-hover: hsl(
        258 88% 71%
    ) !important;
  --link-external-decoration: none !important;
  ...
  --list-marker-color-collapsed: hsl(255, 82%, 63%) !important;
  ...
  --nav-item-background-selected: hsla(255, 82%, 63%, 0.15) !important;
  ...
  --pill-color-remove-hover: hsl(255, 82%, 63%) !important;
  ...
  --scrollbar-active-thumb-bg: hsl(255, 82%, 63%) !important;
  ...
  --secondary: hsl(255, 82%, 63%) !important;
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(255, 82%, 63%) !important;
  ...
  --tab-text-color-focused-highlighted: hsl(255, 82%, 63%) !important;
  --table-add-button-border-color: #c7c7c7 !important;
  --table-border-color: #c7c7c7 !important;
  --table-drag-handle-background-active: hsl(255, 82%, 63%) !important;
  --table-drag-handle-color: #707070 !important;
  --table-header-border-color: #c7c7c7 !important;
  --table-header-color: #5a5a5a !important;
  --table-selection: hsla(255, 82%, 63%, 0.1) !important;
  --table-selection-border-color: hsl(255, 82%, 63%) !important;
  --tag-background: hsla(255, 82%, 63%, 0.1) !important;
  --tag-background-hover: hsla(255, 82%, 63%, 0.2) !important;
  --tag-border-color: hsla(255, 82%, 63%, 0.15) !important;
  --tag-border-color-hover: hsla(255, 82%, 63%, 0.15) !important;
  --tag-color: hsl(255, 82%, 63%) !important;
  --tag-color-hover: hsl(255, 82%, 63%) !important;
  --tertiary: hsl(
        258 88% 71%
    ) !important;
  --text-accent: hsl(255, 82%, 63%) !important;
  --text-accent-hover: hsl(
        258 88% 71%
    ) !important;
...
html[saved-theme="light"] body li.task-list-item input[type="checkbox"]:checked {
  background-color: rgb(122, 83, 238);
  border-color: rgba(0, 0, 0, 0);
}
...
html[saved-theme="light"] body kbd {
  background-color: color(srgb 0.4783 0.3266 0.9334 / 0.7);
  border-bottom-color: rgb(255, 255, 255);
  border-left-color: rgb(255, 255, 255);
  border-right-color: rgb(255, 255, 255);
  border-top-color: rgb(255, 255, 255);
...
html[saved-theme="light"] body ul.tags > li {
  background-color: color(srgb 0.4783 0.3266 0.9334 / 0.05);
