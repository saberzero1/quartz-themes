...
export const theme: ThemeData = {
  ...
  --link-color: var(--text-normal, #dadada);
  --link-color-hover: var(--text-accent-hover, #dadada);
  --link-external-color: var(--text-normal, #dadada);
  --link-external-color-hover: var(--text-accent-hover, #dadada);
  --link-unresolved-color: var(--accent-color, #8a5cf5);
  --link-unresolved-filter: brightness(120%);
  --link-unresolved-opacity: 1;
  --quietus-checkbox-checked-border-color: var(--checklist-done-color, #b3b3b3);
  --quietus-checkbox-checked-hover-border-color: var(--text-normal, #dadada);
  --quietus-checkbox-checked-svg-bg-color: var(--text-normal, #dadada);
  --quietus-inline-code-background: var(--text-highlight-bg, color-mix(
		in srgb,
		#8a5cf5 45%,
		transparent
	));
  --tertiary: var(--text-accent-hover, var(--text-normal, #dadada));
  --text-accent-hover: var(--text-normal, #dadada);
...
html[saved-theme="dark"] body {
  ...
  background-color: var(--text-highlight-bg, color(srgb 0.541176 0.360784 0.960784 / 0.45));
}
...
html[saved-theme="dark"] body .callout[data-callout="warning"] {
  ...
  --link-unresolved-color: var(--accent-color, #8a5cf5);
  --link-unresolved-opacity: 1;
  --quietus-checkbox-checked-border-color: var(--checklist-done-color, #5c5c5c);
  --quietus-checkbox-checked-hover-border-color: var(--checkbox-color-hover, hsl(255, 89.76%, 75.9%));
  --quietus-checkbox-checked-svg-bg-color: var(--text-normal, #222222);
  --quietus-inline-code-background: var(--text-highlight-bg, color-mix(
		in srgb,
		#8a5cf5 25%,
		transparent
...
html[saved-theme="light"] body {
  ...
  background-color: var(--text-highlight-bg, color(srgb 0.541176 0.360784 0.960784 / 0.25));
}
