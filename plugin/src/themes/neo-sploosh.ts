...
html[saved-theme="dark"] body sup {
  ...
  --bases-table-cell-background-selected: rgba(0, 139, 204, 0.1) !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px #008dc9 !important;
  ...
  --collapse-icon-color-collapsed: #2f8fb5 !important;
  --color-accent: rgb(0, 139, 204) !important;
  ...
  --link-unresolved-color: #2f8fb5 !important;
  --link-unresolved-decoration-color: rgba(0, 139, 204, 0.3) !important;
  --list-marker-color-collapsed: #2f8fb5 !important;
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px rgb(0, 139, 204) !important;
  ...
  --table-selection: rgba(0, 139, 204, 0.1) !important;
  --table-selection-border-color: #008dc9 !important;
  --tag-background: rgba(0, 139, 204, 0.1) !important;
  --tag-background-hover: rgba(0, 139, 204, 0.2) !important;
  --tag-border-color: rgba(0, 139, 204, 0.15) !important;
  --tag-border-color-hover: rgba(0, 139, 204, 0.15) !important;
  --tag-color: #2f8fb5 !important;
  --tag-color-hover: #2f8fb5 !important;
