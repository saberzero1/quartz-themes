...
export const theme: ThemeData = {
  ...
  --blockquote-border-color: var(--interactive-accent, #703333);
  ...
  --checkbox-color: var(--interactive-accent, #703333);
  --collapse-icon-color-collapsed: var(--text-accent, #db4040);
  ...
  --divider-color-hover: var(--interactive-accent, #703333);
  ...
  --graph-node-focused: var(--text-accent, #db4040);
  --header-font: 'Caveat Brush';
  --icon-color-active: var(--text-accent, #db4040);
  --interactive-accent: var(--color-accent, #703333);
  --link-color: var(--text-accent, #db4040);
  --link-external-color: var(--text-accent, #db4040);
  --link-unresolved-color: var(--text-accent, #db4040);
  --list-marker-color-collapsed: var(--text-accent, #db4040);
  ...
  --nav-item-color-highlighted: var(--text-accent, #db4040);
  --pill-color-remove-hover: var(--text-accent, #db4040);
  --secondary: var(--text-accent, var(--color-accent-1, #db4040));
  --spoiler-bg: #EEE;
  --tab-text-color-focused-highlighted: var(--text-accent, #db4040);
  --table-drag-handle-background-active: var(--table-selection-border-color, #703333);
  --table-selection-border-color: var(--interactive-accent, #703333);
  --tag-color: var(--text-accent, #db4040);
  --tag-color-hover: var(--text-accent, #db4040);
  --tertiary: var(--text-accent, var(--color-accent-1, #db4040));
  --text-accent: var(--color-accent-1, #db4040);
...
html[saved-theme="dark"] body a.internal-link, html[saved-theme="dark"] .breadcrumb-container .breadcrumb-element > a {
  color: var(--link-color, rgb(206, 92, 92));
  outline: rgb(206, 92, 92) none 0px;
  text-decoration-color: rgb(206, 92, 92);
}

html[saved-theme="dark"] body a.internal-link.broken {
  color: var(--link-unresolved-color, rgb(219, 64, 64));
  outline: rgb(219, 64, 64) none 0px;
}`,
    blockquotes: `html[saved-theme="dark"] body .data-footnote-backref {
  color: var(--text-faint, rgb(173, 216, 230));
}`,
    tables: `html[saved-theme="dark"] body th {
  background-color: var(--background-table-header, rgb(112, 51, 51));
  ...
  border-left-color: rgb(112, 51, 51);
...
html[saved-theme="dark"] body .search > .search-container > .search-space > .search-layout > .results-container > .result-card:hover, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container > .result-card:focus, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container > .result-card.focus:not(:has(~ .result-card:hover, html[saved-theme="dark"] ~ .result-card:focus)) {
  background-color: var(--background-suggestion, rgb(112, 51, 51));
  color: rgb(255, 255, 255);
}
...
html[saved-theme="dark"] body .nav-files-container li:has(> .folder-outer:not(.open)) > .nav-folder-title {
  ...
  background-color: var(--background-statusbar, rgb(112, 51, 51));
  font-family: "??", "??", "Dank Mono", Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Microsoft YaHei Light", sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
}
...
html[saved-theme="light"] body a.internal-link, html[saved-theme="light"] .breadcrumb-container .breadcrumb-element > a {
  ...
  background-color: var(--background-table-header, rgb(206, 92, 92));
  color: var(--table-header-color, rgb(255, 255, 255));
}`,
...
html[saved-theme="light"] body .search > .search-container > .search-space > .search-layout > .results-container > .result-card:hover, html[saved-theme="light"] .search > .search-container > .search-space > .search-layout > .results-container > .result-card:focus, html[saved-theme="light"] .search > .search-container > .search-space > .search-layout > .results-container > .result-card.focus:not(:has(~ .result-card:hover, html[saved-theme="light"] ~ .result-card:focus)) {
  background-color: var(--background-suggestion, rgba(206, 92, 92, 0.75));
  color: rgb(255, 255, 255);
}
...
html[saved-theme="light"] body .nav-files-container li:has(> .folder-outer:not(.open)) > .nav-folder-title {
  ...
  background-color: var(--background-statusbar, rgb(206, 92, 92));
  font-family: "??", "??", "Dank Mono", Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Microsoft YaHei Light", sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
}
