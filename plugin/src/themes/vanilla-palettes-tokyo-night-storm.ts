...
export const theme: ThemeData = {
  ...
  --bases-table-cell-background-active: #24283b;
  ...
  --bases-table-header-background: #24283b;
  --bases-table-header-background-hover: #363a4a;
  --bases-table-header-color: #c0caf5;
  --bases-table-summary-background: #24283b;
  ...
  --blue6: #b4f9f8;
  --blue7: #394b70;
  --blur-background: color-mix(in srgb, #1f2335 65%, transparent) linear-gradient(#1f2335, color-mix(in srgb, #1f2335 65%, transparent));
  --bold-color: #7aa2f7;
  --border-color: #3b4261;
  --border-color-primary: #3b4261;
  --border-color-secondary: #3b4261;
  --canvas-background: #24283b;
  ...
  --fg-dark: #a9b1d6;
  --fg-gutter: #3b4261;
  --file-header-background: #24283b;
  --file-header-background-focused: #24283b;
  --flair-background: #1f2335;
  --flair-color: #c0caf5;
  ...
  --interactive-normal: #1f2335;
  --italic-color: #7aa2f7;
  --light: var(--background-primary, #24283b);
  --lightgray: var(--background-secondary, #1f2335);
  --link-color: #9d7cd8;
  ...
  --orange: #ff9e64;
  --pdf-background: #24283b;
  --pdf-page-background: #24283b;
  --pdf-shadow: 0 0 0 1px #3b4261;
  --pdf-sidebar-background: #24283b;
  ...
  --prompt-background: #24283b;
  --prompt-border-color: #3b4261;
  --purple: #9d7cd8;
  --raised-background: color-mix(in srgb, #1f2335 65%, transparent) linear-gradient(#1f2335, color-mix(in srgb, #1f2335 65%, transparent));
  --red: #f7768e;
  --red1: #db4b4b;
  --ribbon-background: #1f2335;
  --ribbon-background-collapsed: #24283b;
  --search-clear-button-color: #c0caf5;
  --search-icon-color: #c0caf5;
  --search-result-background: #24283b;
  ...
  --slider-track-background: #1f2335;
  --status-bar-background: #1f2335;
  --status-bar-border-color: #3b4261;
  --status-bar-text-color: #c0caf5;
  --suggestion-background: #24283b;
  ...
  --tab-background-active: #24283b;
  --tab-container-background: #1f2335;
  --tab-divider-color: #363a4a;
  --tab-outline-color: #3b4261;
  --tab-switcher-background: #1f2335;
  --tab-switcher-menubar-background: linear-gradient(to top, #1f2335, transparent);
  ...
  --text-muted: #c0caf5;
  --text-normal: #c0caf5;
  --text-on-accent-inverted: #24283b;
