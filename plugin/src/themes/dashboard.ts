...
export const theme: ThemeData = {
  ...
  --dark: var(--text-normal, #222);
  --darkgray: var(--text-normal, #222);
  ...
  --lightgray: var(--background-secondary, #fafafa);
  --link-color: #7e9573;
  ...
  --secondary: var(--text-accent, #7e9573);
  --setting-group-heading-color: #222;
  --setting-items-border-color: #acb7a7;
  --setting-items-radius: 5px;
  --shiki-active-tab-border-color: #434B56;
  --shiki-code-background: #F5F4F4;
  --shiki-code-block-border-radius: 5px;
  --shiki-code-comment: #4E4D49;
  --shiki-code-normal: #434B56;
  --shiki-code-punctuation: #434B56;
  --shiki-gutter-border-color: #acb7a7;
  --shiki-gutter-text-color: #4E4D49;
  --shiki-gutter-text-color-highlight: #434B56;
  --shiki-highlight-neutral: #434B56;
  --shiki-terminal-dots-color: #4E4D49;
  ...
  --tertiary: var(--text-accent-hover, #c7c7c7);
  --text-accent: #7e9573;
