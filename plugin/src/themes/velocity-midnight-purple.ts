...
export const theme: ThemeData = {
  ...
  --background-modifier-active-hover: hsla(256, 75%, 62%, 0.1) !important;
  --background-modifier-border: oklch(100% 0.0625 318 / 0.0625) !important;
  --background-modifier-border-focus: transparent !important;
  --background-modifier-border-hover: oklch(36.25% 0.0125 318) !important;
  --background-modifier-cover: oklch(10% 0 0 / 0.5) !important;
  --background-modifier-error: #ff5853 !important;
  --background-modifier-error-hover: #ff5853 !important;
  --background-modifier-error-rgb: 255, 88, 83 !important;
  --background-modifier-form-field: oklch(31.25% 0.0125 318) !important;
  --background-modifier-form-field-hover: transparent !important;
  --background-modifier-hover: oklch(100% 0.0625 318 / 0.05) !important;
  --background-modifier-success: #77cb4d !important;
  --background-modifier-success-rgb: 119, 203, 77 !important;
  --background-primary: oklch(22.50% 0.0175 318) !important;
  --background-primary-alt: color-mix(in oklab, oklch(22.50% 0.0175 318), oklch(27.50% 0.0125 318)) !important;
  --background-secondary: oklch(27.50% 0.0125 318) !important;
  --background-secondary-alt: oklch(34.50% 0.0125 318) !important;
  --bases-cards-background: oklch(100% 0.075 318 / 0.025) !important;
  --bases-cards-cover-background: color-mix(in oklab, oklch(22.50% 0.0175 318), oklch(27.50% 0.0125 318)) !important;
  --bases-cards-label-color: oklch(63.75% 0.0225 318) !important;
  ...
  --bases-embed-border-color: oklch(100% 0.0625 318 / 0.0625) !important;
  --bases-embed-border-radius: 0 !important;
  --bases-group-heading-property-color: oklch(71.25% 0.0125 318) !important;
  ...
  --bases-table-border-color: oklch(100% 0.09375 318 / 0.1) !important;
  --bases-table-cell-background-active: transparent !important;
  --bases-table-cell-background-disabled: color-mix(in oklab, oklch(22.50% 0.0175 318), oklch(27.50% 0.0125 318)) !important;
  --bases-table-cell-background-selected: hsla(256, 75%, 62%, 0.1) !important;
  --bases-table-cell-shadow-active: 0 0 0 2.5px color-mix(in oklab, hsl(256, 75%, 62%) 50%, transparent 75%) !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(256, 75%, 62%) !important;
  --bases-table-container-border-radius: 0 !important;
  --bases-table-group-background: transparent !important;
  --bases-table-header-background: oklch(22.50% 0.0175 318) !important;
  --bases-table-header-background-hover: transparent !important;
  --bases-table-header-color: oklch(57.50% 0.0225 318) !important;
  --bases-table-header-color-hover: oklch(77.50% 0.0125 318) !important;
  --bases-table-header-weight: 490 !important;
  --bases-table-row-border-width: 0 !important;
  --bases-table-row-height: 32px !important;
  --bases-table-summary-background: oklch(22.50% 0.0175 318) !important;
  --bases-table-summary-background-hover: oklch(100% 0.0625 318 / 0.05) !important;
  --bases-table-text-size: 0.90625em !important;
  --bg-checkbox: radial-gradient(transparent 50%, oklch(43.75% 0.0225 318) 55% 60%, transparent 65%) !important;
  --bg-checkbox-active: radial-gradient(#0000000f 52%, #ffffff20 64%) !important;
  --bg-main-drawer-left: radial-gradient(at 100% 50%, oklch(28.50% 0.0225 288) 0%, oklch(24.75% 0.0225 348) 200%) !important;
  --bg-main-drawer-right: radial-gradient(at 0% 50%, oklch(28.50% 0.0225 288) 0%, oklch(24.75% 0.0225 348) 200%) !important;
  --bg-main-inner: oklch(28.50% 0.0225 288) !important;
  --bg-main-outer: oklch(24.75% 0.0225 348) !important;
  --bg-main-workspace: radial-gradient(at 50% 50%, oklch(28.50% 0.0225 288) 0%, oklch(24.75% 0.0225 348) 200%) !important;
  --bhue: 318 !important;
  --bl-00: 22.50% !important;
  ...
  --blockquote-border-color: oklch(52.50% 0.0225 318) !important;
  --blockquote-border-thickness: 0.1875rem !important;
  --blockquote-color: oklch(71.25% 0.0125 318) !important;
  --blur-background: color-mix(in srgb, oklch(34.50% 0.0125 318) 65%, transparent) linear-gradient(oklch(34.50% 0.0125 318), color-mix(in srgb, oklch(34.50% 0.0125 318) 65%, transparent)) !important;
  ...
  --bold-color: oklch(93.25% 0.0005 318) !important;
  ...
  --canvas-background: oklch(22.50% 0.0175 318) !important;
  --canvas-card-label-color: oklch(52.50% 0.0225 318) !important;
  --canvas-color-1: 255, 88, 83 !important;
  --canvas-color-2: 229, 164, 74 !important;
  --canvas-color-3: 208, 203, 105 !important;
  --canvas-color-4: 119, 203, 77 !important;
  --canvas-color-5: 0, 155, 255 !important;
  --canvas-color-6: 203, 116, 228 !important;
  --canvas-controls-radius: 8px !important;
  --canvas-dot-pattern: oklch(34.50% 0.0125 318) !important;
  --caret-color: oklch(85.00% 0.0125 318) !important;
  --checkbox-border-color: oklch(43.75% 0.0225 318) !important;
  --checkbox-border-color-hover: oklch(71.25% 0.0125 318) !important;
  --checkbox-color: hsl(256, 75%, 62%) !important;
  --checkbox-color-hover: color-mix(in oklab, hsl(256, 75%, 62%) 62.5%, color-mix(in oklab, hsl(256, 75%, 62%) 64%, #fff 36%)) !important;
  --checkbox-marker-color: white !important;
  --checkbox-radius: 50% !important;
  --checkbox-size: 1.125rem !important;
  --checklist-done-color: oklch(52.50% 0.0225 318) !important;
  --clickable-icon-radius: 8px !important;
  --code-background: oklch(100% 0.0625 318 / 0.05) !important;
  --code-background-alt: oklch(from oklch(24.00% 0.0005 318) l 0.0125 h / 0.375) !important;
  --code-border-color: oklch(100% 0.0625 318 / 0.0625) !important;
  --code-border-width: 0 !important;
  --code-bracket-background: oklch(100% 0.0625 318 / 0.05) !important;
  --code-comment: oklch(52.50% 0.0225 318) !important;
  --code-function: #d0cb69 !important;
  --code-important: #e5a44a !important;
  --code-keyword: #ff98b9 !important;
  --code-normal: oklch(85.00% 0.0125 318) !important;
  --code-operator: #ff5853 !important;
  --code-property: #63d5cd !important;
  --code-punctuation: oklch(71.25% 0.0125 318) !important;
  --code-radius: 6px !important;
  --code-special: #ff5853 !important;
  --code-string: #77cb4d !important;
  --code-tag: #ff5853 !important;
  --code-value: #cb74e4 !important;
  ...
  --collapse-icon-color: oklch(52.50% 0.0225 318) !important;
  --collapse-icon-color-collapsed: color-mix(in oklab, hsl(256, 75%, 62%) 64%, #fff 36%) !important;
  --color-accent: hsl(256, 75%, 62%) !important;
  --color-accent-1: color-mix(in oklab, hsl(256, 75%, 62%) 64%, #fff 36%) !important;
  --color-accent-2: color-mix(in oklab, color-mix(in oklab, hsl(256, 75%, 62%) 64%, #fff 36%), transparent 8%) !important;
  --color-accent-3: color-mix(in oklab, hsl(256, 75%, 62%) 50%, transparent 75%) !important;
  --color-accent-4: color-mix(in oklab, oklab(from hsl(256, 75%, 62%) l a b / 0.25) 30%, transparent 70%) !important;
  --color-accent-hsl: 256, 75%, 62% !important;
  --color-base-00: oklch(22.50% 0.0175 318) !important;
  --color-base-05: oklch(24.00% 0.0005 318) !important;
  --color-base-10: oklch(26.25% 0.0125 318) !important;
  --color-base-100: oklch(93.25% 0.0005 318) !important;
  --color-base-20: oklch(27.50% 0.0125 318) !important;
  --color-base-25: oklch(31.25% 0.0125 318) !important;
  --color-base-30: oklch(34.50% 0.0125 318) !important;
  --color-base-35: oklch(36.25% 0.0125 318) !important;
  --color-base-40: oklch(43.75% 0.0225 318) !important;
  --color-base-50: oklch(52.50% 0.0225 318) !important;
  --color-base-55: oklch(57.50% 0.0225 318) !important;
  --color-base-60: oklch(63.75% 0.0225 318) !important;
  --color-base-70: oklch(71.25% 0.0125 318) !important;
  --color-base-80: oklch(77.50% 0.0125 318) !important;
  --color-base-90: oklch(85.00% 0.0125 318) !important;
  --color-blue: #009bff !important;
  --color-blue-rgb: 0, 155, 255 !important;
  --color-cyan: #63d5cd !important;
  --color-cyan-rgb: 99, 213, 205 !important;
  --color-green: #77cb4d !important;
  --color-green-rgb: 119, 203, 77 !important;
  --color-highlight: rgb(239, 211, 0) !important;
  --color-highlight-rgb: 239, 211, 0 !important;
  --color-orange: #e5a44a !important;
  --color-orange-rgb: 229, 164, 74 !important;
  --color-pink: #ff98b9 !important;
  --color-pink-rgb: 255, 152, 185 !important;
  --color-purple: #cb74e4 !important;
  --color-purple-rgb: 203, 116, 228 !important;
  --color-red: #ff5853 !important;
  --color-red-rgb: 255, 88, 83 !important;
  --color-yellow: #d0cb69 !important;
  --color-yellow-rgb: 208, 203, 105 !important;
  --control-icon-background: oklch(100% 0.0625 318 / 0.0625) !important;
  --control-icon-color: oklch(77.50% 0.0125 318) !important;
  --control-icon-shadow: inset 0.875px 1.625px 2px -1px rgba(255, 255, 255, 0.263), inset -0.875px -1.625px 2px -1px rgba(255, 255, 255, 0.188), inset 0 8px 16px rgba(255, 255, 255, 0.025), 0px 0px 12px 0px oklch(from oklch(24.00% 0.0005 318) l 0.0125 h / 0.375) !important;
  --corner-smoothing: 60% !important;
  --dark: oklch(85.00% 0.0125 318) !important;
  --darkgray: oklch(85.00% 0.0125 318) !important;
  --dialog-width: 500px !important;
  --divider-color: oklch(100% 0.0625 318 / 0.0625) !important;
  --divider-color-hover: color-mix(in oklab, hsl(256, 75%, 62%) 50%, transparent 75%) !important;
  --divider-width: 0 !important;
  --drag-ghost-background: oklch(22.50% 0.0175 318) !important;
  --drag-ghost-text-color: oklch(85.00% 0.0125 318) !important;
  --dropdown-background: oklch(34.50% 0.0125 318) !important;
  --dropdown-background-hover: oklch(36.25% 0.0125 318) !important;
  --embed-block-shadow-hover: none !important;
  --embed-border-start: none !important;
  --embed-padding: 0 1.25em 0 0 !important;
  --fab-bg: oklch(22.50% 0.0175 318) !important;
  --fab-color: oklch(63.75% 0.0225 318) !important;
  --fab-color-active: oklch(85.00% 0.0125 318) !important;
  --fab-easing-curve: cubic-bezier(0.55, 2, 0.5, 0.97) !important;
  --file-header-background: oklch(22.50% 0.0175 318) !important;
  --file-header-background-focused: oklch(22.50% 0.0175 318) !important;
  ...
  --flair-background: oklch(34.50% 0.0125 318) !important;
  --flair-color: oklch(85.00% 0.0125 318) !important;
  ...
  --footnote-divider-color: oklch(100% 0.0625 318 / 0.0625) !important;
  --footnote-id-color: oklch(71.25% 0.0125 318) !important;
  --footnote-id-color-no-occurrences: oklch(52.50% 0.0225 318) !important;
  --footnote-input-background-active: oklch(100% 0.0625 318 / 0.05) !important;
  ...
  --glass-button: inset 3px 3px 1.5px -1.25px oklab(from hsl(256, 75%, 62%) calc(l + 0.075) a b / 0.75), inset -3px -3px 1.5px -1.25px oklab(from hsl(256, 75%, 62%) calc(l + 0.075) a b / 0.5) !important;
  --glass-button-error: inset 3.25px 3.25px 1.25px -1.25px oklab(from #ff5853 calc(l + 0.075) a b / 0.75), inset -3.25px -3.25px 1.25px -1.25px oklab(from #ff5853 calc(l + 0.075) a b / 0.5) !important;
  --glass-button-l: inset 3.75px 3.75px 1.5px -1.25px oklab(from hsl(256, 75%, 62%) calc(l + 0.075) a b / 0.75), inset -3.75px -3.75px 1.5px -1.25px oklab(from hsl(256, 75%, 62%) calc(l + 0.075) a b / 0.5) !important;
  --graph-controls-width: 232px !important;
  --graph-line: oklch(36.25% 0.0125 318) !important;
  --graph-node: oklch(71.25% 0.0125 318) !important;
  --graph-node-attachment: #d0cb69 !important;
  --graph-node-focused: transparent !important;
  --graph-node-tag: #77cb4d !important;
  --graph-node-unresolved: oklch(52.50% 0.0225 318) !important;
  --graph-text: oklch(85.00% 0.0125 318) !important;
  --gray: oklch(71.25% 0.0125 318) !important;
  --h1-color: oklch(89.5% 0.0005 318) !important;
  --h1-size: 2em !important;
  --h1-size-alt: 1.625em !important;
  --h1-weight: 330 !important;
  --h1-weight-alt: 570 !important;
  --h2-color: oklch(88.25% 0.0005 318) !important;
  --h2-size: 1.5em !important;
  --h2-weight: 570 !important;
  --h3-color: oklch(85.00% 0.0125 318) !important;
  --h3-size: 1.375em !important;
  --h3-weight: 570 !important;
  --h4-color: oklch(85.00% 0.0125 318) !important;
  --h4-size: 1.25em !important;
  --h4-weight: 570 !important;
  --h5-color: oklch(85.00% 0.0125 318) !important;
  --h5-line-height: 1.6 !important;
  --h5-size: 1.125em !important;
  --h6-color: oklch(77.50% 0.0125 318) !important;
  ...
  --heading-formatting: oklch(52.50% 0.0225 318) !important;
  --highlight: oklch(from rgb(239, 211, 0) 0.8 calc(c * 1.375) h / 0.33) !important;
  --highlight-blue-rgb: 0, 155, 255 !important;
  --highlight-cyan-rgb: 99, 213, 205 !important;
  --highlight-green-rgb: 119, 203, 77 !important;
  --highlight-orange-rgb: 229, 164, 74 !important;
  --highlight-pink-rgb: 255, 152, 185 !important;
  --highlight-purple-rgb: 203, 116, 228 !important;
  --highlight-red-rgb: 255, 88, 83 !important;
  --highlight-yellow-rgb: 239, 211, 0 !important;
  --hotkey-gradient: linear-gradient(to top, hsl(256, 75%, 62%) -10%, color-mix(in oklab, oklab(from hsl(256, 75%, 62%) l a b / 0.25) 30%, transparent 70%) 210%) !important;
  --hr-color: oklch(100% 0.09375 318 / 0.1) !important;
  --icon-color: oklch(63.75% 0.0225 318) !important;
  --icon-color-active: color-mix(in oklab, hsl(256, 75%, 62%) 64%, #fff 36%) !important;
  --icon-color-focused: oklch(85.00% 0.0125 318) !important;
  --icon-color-hover: oklch(85.00% 0.0125 318) !important;
  ...
  --indentation-guide-color: oklch(100% 0.09375 318 / 0.1) !important;
  --indentation-guide-width: 0 !important;
  --indentation-guide-width-active: 0 !important;
  --inline-title-color: oklch(89.5% 0.0005 318) !important;
  ...
  --input-date-separator: oklch(52.50% 0.0225 318) !important;
  --input-font-weight: 420 !important;
  --input-height: 28px !important;
  --input-placeholder-color: oklch(52.50% 0.0225 318) !important;
  --input-radius: 8px !important;
  --input-shadow: none !important;
  --input-shadow-hover: none !important;
  --interactive-accent: hsl(256, 75%, 62%) !important;
  --interactive-accent-hover: color-mix(in oklab, hsl(256, 75%, 62%) 62.5%, color-mix(in oklab, hsl(256, 75%, 62%) 64%, #fff 36%)) !important;
  --interactive-accent-hsl: 256, 75%, 62% !important;
  --interactive-hover: oklch(36.25% 0.0125 318) !important;
  --interactive-normal: oklch(34.50% 0.0125 318) !important;
  --light: oklch(22.50% 0.0175 318) !important;
  --lightgray: oklch(27.50% 0.0125 318) !important;
  --line-height-normal: 1.6 !important;
  --link-color: color-mix(in oklab, hsl(256, 75%, 62%) 64%, #fff 36%) !important;
  --link-color-hover: color-mix(in oklab, color-mix(in oklab, hsl(256, 75%, 62%) 64%, #fff 36%), transparent 8%) !important;
  --link-color-sidebar: color-mix(in oklab, color-mix(in oklab, hsl(256, 75%, 62%) 64%, #fff 36%), transparent 8%) !important;
  --link-decoration: none !important;
  --link-decoration-hover: none !important;
  --link-external-color: color-mix(in oklab, hsl(256, 75%, 62%) 64%, #fff 36%) !important;
  --link-external-color-hover: color-mix(in oklab, color-mix(in oklab, hsl(256, 75%, 62%) 64%, #fff 36%), transparent 8%) !important;
  --link-unresolved-color: oklch(from color-mix(in oklab, hsl(256, 75%, 62%) 64%, #fff 36%) l c h / 0.75) !important;
  --link-unresolved-decoration-color: hsla(256, 75%, 62%, 0.3) !important;
  --link-unresolved-lch: 0.75 !important;
  --link-unresolved-opacity: 1 !important;
  --link-weight: 420 !important;
  --list-bullet-color: oklch(77.50% 0.0125 318) !important;
  --list-dash-color: oklch(100% 0.025 318 / 0.35) !important;
  --list-indent: 1.5em !important;
  --list-marker-color: oklch(52.50% 0.0225 318) !important;
  --list-marker-color-collapsed: color-mix(in oklab, hsl(256, 75%, 62%) 64%, #fff 36%) !important;
  --list-marker-color-hover: oklch(71.25% 0.0125 318) !important;
  --list-spacing: 0.125em !important;
  --math-color: oklch(93.25% 0.0005 318) !important;
  --menu-background: color-mix(in oklab, oklch(22.50% 0.0175 318), oklch(27.50% 0.0125 318)) !important;
  --menu-border-color: oklch(100% 0.05 318 / 0.125) !important;
  --menu-radius: 14px !important;
  --menu-shadow: 0px 3px 18px 0px oklch(0 0 0 / 0.1875) !important;
  --metadata-border-color: oklch(100% 0.0625 318 / 0.0625) !important;
  --metadata-border-radius: 12px !important;
  --metadata-divider-color: oklch(100% 0.0625 318 / 0.0625) !important;
  --metadata-gap: 2px !important;
  --metadata-input-background-active: oklch(100% 0.0625 318 / 0.05) !important;
  ...
  --metadata-input-text-color: oklch(85.00% 0.0125 318) !important;
  --metadata-label-background-active: oklch(100% 0.0625 318 / 0.05) !important;
  ...
  --metadata-label-text-color: oklch(63.75% 0.0225 318) !important;
  --metadata-label-text-color-hover: oklch(63.75% 0.0225 318) !important;
  --metadata-label-width: 10em !important;
  --metadata-property-background-active: oklch(100% 0.0625 318 / 0.05) !important;
  --metadata-property-box-shadow-focus: 0 0 0 2.5px color-mix(in oklab, hsl(256, 75%, 62%) 50%, transparent 75%) !important;
  --metadata-property-box-shadow-hover: 0 0 0 2.5px oklch(100% 0.0625 318 / 0.05) !important;
  --mobile-nav-fade-bg: linear-gradient(oklch(from oklch(27.50% 0.0125 318) l c h), transparent 78px) !important;
  --modal-background: oklch(27.75% 0.0175 318 / 0.625) !important;
  --modal-border-color: oklch(43.75% 0.0225 318) !important;
  --modal-border-width: 0 !important;
  --modal-community-header-bg: oklch(from oklch(27.50% 0.0125 318) l 0.0125 h / 0.5) !important;
  --modal-community-item-bg: oklch(from oklch(34.50% 0.0125 318) l 0.0125 h / 0.5) !important;
  --modal-radius: 22px !important;
  --modal-small-background: oklch(27.75% 0.0175 318 / 0.625) !important;
  --nav-collapse-icon-color: oklch(100% 0.025 318 / 0.35) !important;
  --nav-collapse-icon-color-collapsed: oklch(52.50% 0.0225 318) !important;
  --nav-folder-color: oklch(77.50% 0.0125 318) !important;
  --nav-header-bg: oklch(100% 0.0625 318 / 0.0625) !important;
  --nav-header-timing: cubic-bezier(0.3, 0.75, 0, 1) !important;
  --nav-heading-color: oklch(77.50% 0.0125 318) !important;
  --nav-heading-color-collapsed: oklch(52.50% 0.0225 318) !important;
  --nav-heading-color-collapsed-hover: oklch(71.25% 0.0125 318) !important;
  --nav-heading-color-hover: oklch(85.00% 0.0125 318) !important;
  --nav-heading-weight: 520 !important;
  --nav-heading-weight-hover: 520 !important;
  --nav-indentation-guide-color: oklch(100% 0.09375 318 / 0.1) !important;
  --nav-indentation-guide-width: 0 !important;
  --nav-item-background-active: oklch(100% 0.0625 318 / 0.05) !important;
  --nav-item-background-hover: oklch(100% 0.0625 318 / 0.05) !important;
  --nav-item-background-selected: hsla(256, 75%, 62%, 0.15) !important;
  --nav-item-color: oklch(71.25% 0.0125 318) !important;
  --nav-item-color-active: oklch(85.00% 0.0125 318) !important;
  --nav-item-color-highlighted: color-mix(in oklab, hsl(256, 75%, 62%) 64%, #fff 36%) !important;
  --nav-item-color-hover: oklch(85.00% 0.0125 318) !important;
  --nav-item-color-selected: oklch(85.00% 0.0125 318) !important;
  --nav-item-radius: 8px !important;
  --nav-tag-color: oklch(52.50% 0.0225 318) !important;
  --nav-tag-color-active: oklch(71.25% 0.0125 318) !important;
  --nav-tag-color-hover: oklch(71.25% 0.0125 318) !important;
  --nav-tag-radius: 8px !important;
  --nav-tag-weight: 620 !important;
  --nav-text-color: oklch(85.00% 0.0125 318) !important;
  --paint-description: "A stunning iridescent purple paint scheme inspired by a rare factory option for the Nissan GT-R. Its dynamic colors shift based on your notes' layout." !important;
  ...
  --pdf-background: oklch(22.50% 0.0175 318) !important;
  --pdf-page-background: oklch(22.50% 0.0175 318) !important;
  --pdf-shadow: none !important;
  --pdf-sidebar-background: oklch(22.50% 0.0175 318) !important;
  --pdf-spread-shadow: none !important;
  --pdf-thumbnail-shadow: 0 0 0 1px oklch(100% 0.0625 318 / 0.0625) !important;
  --pill-background: oklch(100% 0.0625 318 / 0.05) !important;
  --pill-background-hover: oklch(100% 0.0625 318 / 0.05) !important;
  --pill-border-color: oklch(100% 0.0625 318 / 0.0625) !important;
  --pill-border-color-hover: oklch(36.25% 0.0125 318) !important;
  --pill-color: oklch(71.25% 0.0125 318) !important;
  --pill-color-hover: oklch(71.25% 0.0125 318) !important;
  --pill-color-remove: oklch(52.50% 0.0225 318) !important;
  ...
  --prompt-background: oklch(27.75% 0.0175 318 / 0.625) !important;
  --prompt-border-color: oklch(100% 0.05 318 / 0.125) !important;
  ...
  --raised-background: color-mix(in srgb, oklch(34.50% 0.0125 318) 65%, transparent) linear-gradient(oklch(34.50% 0.0125 318), color-mix(in srgb, oklch(34.50% 0.0125 318) 65%, transparent)) !important;
  ...
  --scrollbar-active-thumb-bg: oklch(36.25% 0.0125 318) !important;
  --scrollbar-radius: 18px !important;
  --scrollbar-thumb-bg: oklch(31.25% 0.0125 318) !important;
  --search-clear-button-color: oklch(52.50% 0.0225 318) !important;
  --search-icon-color: oklch(52.50% 0.0225 318) !important;
  --search-icon-size: 17px !important;
  --search-result-background: oklch(from oklch(24.00% 0.0005 318) l 0.0125 h / 0.375) !important;
  --secondary: color-mix(in oklab, hsl(256, 75%, 62%) 64%, #fff 36%) !important;
  --setting-group-heading-color: oklch(63.75% 0.0225 318) !important;
  --setting-group-heading-size: 18px !important;
  --setting-group-heading-weight: 520 !important;
  --setting-item-background: color-mix(in oklab, oklch(22.50% 0.0175 318) 87.5%, oklch(27.50% 0.0125 318)) !important;
  --setting-items-background: oklch(22.50% 0.0175 318) !important;
  --setting-items-border-color: oklch(100% 0.0625 318 / 0.0625) !important;
  --setting-items-padding: 16px !important;
  --setting-items-radius: 16px !important;
  --settings-background: radial-gradient(at -100% 50%, oklch(28.50% 0.0225 288) 0%, oklch(24.75% 0.0225 348) 200%) !important;
  --shadow-button: inset 3px 3px 1.5px -1.25px oklab(from hsl(256, 75%, 62%) calc(l + 0.075) a b / 0.75), inset -3px -3px 1.5px -1.25px oklab(from hsl(256, 75%, 62%) calc(l + 0.075) a b / 0.5), 0px 3px 15px 0px oklch(from oklch(22.50% calc(0.0225 - 0.005) 318) l 0.0125 h / 0.75) !important;
  --shadow-button-error: inset 3.25px 3.25px 1.25px -1.25px oklab(from #ff5853 calc(l + 0.075) a b / 0.75), inset -3.25px -3.25px 1.25px -1.25px oklab(from #ff5853 calc(l + 0.075) a b / 0.5), 0px 3px 15px 0px oklch(from oklch(22.50% calc(0.0225 - 0.005) 318) l 0.0125 h / 0.75) !important;
  --shadow-canvas-node: 0px 0px 16px 0px oklch(0 0 0 / 0.1875) !important;
  --shadow-fab: 0 0 0 0.5px oklch(100% 0.05 318 / 0.125), 0px 2px 12px 0px oklch(0 0 0 / 0.1875) !important;
  --shadow-faint: 0px 3px 15px 0px oklch(from oklch(22.50% 0.0175 318) l 0.0125 h / 0.75) !important;
  --shadow-input: 0 0 0 0.5px oklch(100% 0.05 318 / 0.125) !important;
  --shadow-input-active: 0 0 0 2.5px color-mix(in oklab, hsl(256, 75%, 62%) 50%, transparent 75%) !important;
  ...
  --shadow-setting-items: 0 4px 12px 0 oklch(from oklch(24.00% 0.0005 318) l 0.0125 h / 0.375) !important;
  --shadow-setting-items-top: inset 1px 2px 2px 0 oklch(from oklch(24.00% 0.0005 318) l 0.0125 h / 0.375), 0px 1px 9px oklch(100% 0.075 318 / 0.025) !important;
  --shadow-sidebar: 0px 0px 12px 0px oklch(from oklch(27.50% 0.0125 318) l 0.0125 h / 0.5) !important;
  --shadow-strong: 0px 0px 24px 0px oklch(0 0 0 / 0.375) !important;
  --shadow-suggestion-item: inset 3.75px 3.75px 1.5px -1.25px oklab(from hsl(256, 75%, 62%) calc(l + 0.075) a b / 0.75), inset -3.75px -3.75px 1.5px -1.25px oklab(from hsl(256, 75%, 62%) calc(l + 0.075) a b / 0.5), 0px 3px 18px 0px oklch(0 0 0 / 0.1875) !important;
  ...
  --shadow-toggle: inset 1.5px 1.5px 1.5px 0px oklab(from hsl(256, 75%, 62%) calc(l + 0.075) a b / 0.75), inset -1.5px -1.5px 1.5px 0px oklab(from hsl(256, 75%, 62%) calc(l + 0.075) a b / 0.5) !important;
  --shadow-workspace: 0 0 0 0.5px oklch(100% 0.09375 318 / 0.1), 0 0 20px oklch(from oklch(22.50% 0.0175 318) l 0.0125 h / 0.75) !important;
  --shadow-workspace-multi: 0 0 0 0.5px oklch(100% 0.09375 318 / 0.1) !important;
  --shiki-active-tab-border-color: oklch(71.25% 0.0125 318) !important;
  --shiki-code-background: oklch(100% 0.0625 318 / 0.05) !important;
  --shiki-code-block-border-radius: 6px !important;
  --shiki-code-comment: oklch(52.50% 0.0225 318) !important;
  --shiki-code-function: #77cb4d !important;
  --shiki-code-important: #e5a44a !important;
  --shiki-code-keyword: #ff98b9 !important;
  --shiki-code-normal: oklch(71.25% 0.0125 318) !important;
  --shiki-code-property: #63d5cd !important;
  --shiki-code-punctuation: oklch(71.25% 0.0125 318) !important;
  --shiki-code-string: #d0cb69 !important;
  --shiki-code-value: #cb74e4 !important;
  --shiki-gutter-border-color: oklch(100% 0.0625 318 / 0.0625) !important;
  --shiki-gutter-text-color: oklch(52.50% 0.0225 318) !important;
  --shiki-gutter-text-color-highlight: oklch(71.25% 0.0125 318) !important;
  --shiki-highlight-green: rgba(119, 203, 77, 0.5) !important;
  --shiki-highlight-green-background: rgba(119, 203, 77, 0.1) !important;
  --shiki-highlight-neutral: oklch(71.25% 0.0125 318) !important;
  --shiki-highlight-red: rgba(255, 88, 83, 0.5) !important;
  --shiki-highlight-red-background: rgba(255, 88, 83, 0.1) !important;
  --shiki-terminal-dots-color: oklch(52.50% 0.0225 318) !important;
  --sidebar-left-toggle-inner-width: 12% !important;
  --sidebar-right-toggle-inner-width: 12% !important;
  --slider-thumb-border-color: oklch(36.25% 0.0125 318) !important;
  ...
  --slider-track-background: oklch(100% 0.05 318 / 0.125) !important;
  ...
  --status-bar-border-color: oklch(100% 0.0625 318 / 0.0625) !important;
  --status-bar-border-width: 0 !important;
  --status-bar-radius: 18px 0 0 18px !important;
  --status-bar-text-color: oklch(71.25% 0.0125 318) !important;
  --strikethrough-color: oklch(52.50% 0.0225 318) !important;
  --suggestion-background: oklch(22.50% 0.0175 318) !important;
  --sync-avatar-color-1: #ff5853 !important;
  --sync-avatar-color-2: #e5a44a !important;
  --sync-avatar-color-3: #d0cb69 !important;
  --sync-avatar-color-4: #77cb4d !important;
  --sync-avatar-color-5: #63d5cd !important;
  --sync-avatar-color-6: #009bff !important;
  --sync-avatar-color-7: #cb74e4 !important;
  --sync-avatar-color-8: #ff98b9 !important;
  --tab-background-active: oklch(22.50% 0.0175 318) !important;
  --tab-close-bg: oklch(38.25% 0.0125 318 / 0.875) !important;
  --tab-container-background: transparent !important;
  --tab-divider-color: oklch(36.25% 0.0125 318) !important;
  --tab-font-weight: 420 !important;
  --tab-max-width: 240px !important;
  --tab-outline-color: oklch(100% 0.0625 318 / 0.0625) !important;
  --tab-outline-width: 0 !important;
  --tab-radius: 8px !important;
  --tab-right-fade: linear-gradient(to left, oklch(31.25% 0.01563 318) 80%, transparent) !important;
  --tab-right-fade-alt: linear-gradient(to left, oklch(28.5% 0.0225 318) 80%, transparent) !important;
  --tab-sidebar-bg: oklch(100% 0.0625 318 / 0.0625) !important;
  --tab-sidebar-container-bg: oklch(100% 0.075 318 / 0.025) !important;
  ...
  --tab-switcher-background: oklch(27.50% 0.0125 318) !important;
  --tab-switcher-menubar-background: linear-gradient(to top, oklch(27.50% 0.0125 318), transparent) !important;
  --tab-switcher-preview-radius: 20px !important;
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(256, 75%, 62%) !important;
  --tab-text-color: oklch(63.75% 0.0225 318) !important;
  --tab-text-color-active: oklch(93.25% 0.0005 318) !important;
  --tab-text-color-focused: oklch(63.75% 0.0225 318) !important;
  --tab-text-color-focused-active: oklch(93.25% 0.0005 318) !important;
  --tab-text-color-focused-active-current: oklch(93.25% 0.0005 318) !important;
  --tab-text-color-focused-highlighted: color-mix(in oklab, hsl(256, 75%, 62%) 64%, #fff 36%) !important;
  --tab-width: 240px !important;
  --table-add-button-border-color: oklch(100% 0.0625 318 / 0.0625) !important;
  --table-border-color: oklch(100% 0.09375 318 / 0.1) !important;
  --table-drag-handle-background-active: hsl(256, 75%, 62%) !important;
  --table-drag-handle-color: oklch(52.50% 0.0225 318) !important;
  --table-header-border-color: oklch(100% 0.09375 318 / 0.1) !important;
  --table-header-color: oklch(63.75% 0.0225 318) !important;
  --table-header-size: 0.90625em !important;
  --table-header-weight: 520 !important;
  --table-line-height: 1.6 !important;
  --table-row-alt-background: oklch(100% 0.09375 318 / 0.015) !important;
  --table-row-alt-background-hover: oklch(100% 0.09375 318 / 0.015) !important;
  --table-row-bg: oklch(100% 0.09375 318 / 0.015) !important;
  --table-selection: hsla(256, 75%, 62%, 0.1) !important;
  --table-selection-border-color: hsl(256, 75%, 62%) !important;
  --table-text-size: 0.90625em !important;
  --table-text-weight: 420 !important;
  --tag-background: hsla(256, 75%, 62%, 0.1) !important;
  --tag-background-hover: hsla(256, 75%, 62%, 0.2) !important;
  --tag-border-color: oklch(from hsl(256, 75%, 62%) l c h / 0.025) !important;
  --tag-border-color-hover: hsla(256, 75%, 62%, 0.15) !important;
  --tag-color: color-mix(in oklab, hsl(256, 75%, 62%) 64%, #fff 36%) !important;
  --tag-color-hover: color-mix(in oklab, hsl(256, 75%, 62%) 64%, #fff 36%) !important;
  --tag-padding-x: 0.6875em !important;
  --tag-padding-y: 0.3125em !important;
  --tag-size: 0.8em !important;
  --tag-weight: 490 !important;
  --tertiary: color-mix(in oklab, color-mix(in oklab, hsl(256, 75%, 62%) 64%, #fff 36%), transparent 8%) !important;
  --text-accent: color-mix(in oklab, hsl(256, 75%, 62%) 64%, #fff 36%) !important;
  --text-accent-hover: color-mix(in oklab, color-mix(in oklab, hsl(256, 75%, 62%) 64%, #fff 36%), transparent 8%) !important;
  --text-error: #ff5853 !important;
  --text-faint: oklch(52.50% 0.0225 318) !important;
  --text-highlight-bg: oklch(from rgb(239, 211, 0) 0.8 calc(c * 1.375) h / 0.33) !important;
  --text-highlight-bg-rgb: 239, 211, 0 !important;
  --text-highlight-bg-search: oklch(from rgb(239, 211, 0) 0.875 calc(c * 1.375) h / 0.625) !important;
  --text-muted: oklch(71.25% 0.0125 318) !important;
  --text-normal: oklch(85.00% 0.0125 318) !important;
  --text-selection: oklab(from hsl(256, 75%, 62%) l a b / 0.25) !important;
  --text-success: #77cb4d !important;
  --text-warning: #e5a44a !important;
  --textHighlight: oklch(from rgb(239, 211, 0) 0.8 calc(c * 1.375) h / 0.33) !important;
  ...
  --titlebar-border-color: oklch(100% 0.0625 318 / 0.0625) !important;
  --titlebar-height: 36px !important;
  --titlebar-text-color: oklch(100% 0.025 318 / 0.35) !important;
  --titlebar-text-color-focused: oklch(71.25% 0.0125 318) !important;
  --titlebar-text-weight: 620 !important;
  --toggle-border-width: 4px !important;
  --toggle-gradient: linear-gradient(to bottom, hsl(256, 75%, 62%) -30%, color-mix(in oklab, oklab(from hsl(256, 75%, 62%) l a b / 0.25) 30%, transparent 70%) 180%) !important;
  ...
  --toggle-track-bg: oklch(100% 0.025 318 / 0.2) !important;
  ...
  --trans-faint-00: oklch(100% 0.09375 318 / 0.015) !important;
  --trans-faint-05: oklch(100% 0.075 318 / 0.025) !important;
  --trans-faint-10: oklch(100% 0.0625 318 / 0.05) !important;
  --trans-faint-20: oklch(100% 0.0625 318 / 0.0625) !important;
  --trans-faint-25: oklch(100% 0.0625 318 / 0.08125) !important;
  --trans-faint-30: oklch(100% 0.09375 318 / 0.1) !important;
  --trans-faint-40: oklch(100% 0.05 318 / 0.125) !important;
  --trans-faint-50: oklch(100% 0.025 318 / 0.2) !important;
  --trans-faint-60: oklch(100% 0.025 318 / 0.35) !important;
  --trans-strong-00: oklch(from oklch(22.50% 0.0175 318) l 0.0125 h / 0.75) !important;
  --trans-strong-05: oklch(from oklch(22.50% 0.0175 318) l 0.0125 h / 0.625) !important;
  --trans-strong-10: oklch(from oklch(24.00% 0.0005 318) l 0.0125 h / 0.375) !important;
  --trans-strong-20: oklch(from oklch(27.50% 0.0125 318) l 0.0125 h / 0.5) !important;
  --trans-strong-30: oklch(from oklch(34.50% 0.0125 318) l 0.0125 h / 0.5) !important;
  --trans-strong-40: oklch(from oklch(34.50% 0.0125 318) l 0.0125 h / 0.5) !important;
  --trans-white-00: oklch(93.25% 0 0 / 0.75) !important;
  --trans-white-10: oklch(93.25% 0 0 / 0.625) !important;
  --vault-profile-color: oklch(63.75% 0.0225 318) !important;
  --vault-profile-color-hover: oklch(71.25% 0.0125 318) !important;
  ...
  --warning-gradient: linear-gradient(to top, #ff5853 -30%, oklch(from oklch(27.50% 0.0125 318) l 0.0125 h / 0.5) 180%) !important;
  --workspace-border-color: oklch(100% 0.0625 318 / 0.08125) !important;
...
html[saved-theme="dark"] body .text-highlight {
  background-color: oklch(0.8 0.246563 99.5478 / 0.33);
  color: oklch(0.9325 0.0005 318);
  font-family: Raveo, Raveo, Inter, ui-sans-serif, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  font-weight: 420;
  outline: oklch(0.9325 0.0005 318) none 0px;
...
html[saved-theme="dark"] body li.task-list-item input[type="checkbox"]:checked {
  background-color: rgb(124, 85, 231);
  border-color: rgb(255, 255, 255);
}
...
html[saved-theme="dark"] body tbody tr:nth-child(odd) {
  background-color: oklch(1 0.09375 318 / 0.015);
}
...
html[saved-theme="dark"] body th {
  ...
  border-top-width: 0px;
  color: oklch(0.6375 0.0225 318);
  font-weight: 520;
  padding-left: 12px;
  padding-right: 12px;
}`,
    code: `html[saved-theme="dark"] body code {
  background-color: oklch(1 0.0625 318 / 0.05);
  border-bottom-color: oklch(0.85 0.0125 318);
...
html[saved-theme="dark"] body video {
  ...
  background-color: oklab(0.25 0.0111472 -0.010037);
...
html[saved-theme="dark"] body .search > .search-container > .search-space {
  background-color: oklch(0.2775 0.0175 318 / 0.625);
...
html[saved-theme="dark"] body a.internal-link.tag-link, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  background-color: rgba(124, 85, 231, 0.1);
...
html[saved-theme="dark"] body .canvas-sidebar {
  background-color: oklch(0.275 0.0125 318 / 0.5);
  border-color: oklch(0.85 0.0125 318);
}`,
...
html[saved-theme="dark"] body div#quartz-root {
  background-color: oklch(0.225 0.0175 318);
  color: oklch(0.85 0.0125 318);
}
