...
export const theme: ThemeData = {
  ...
  --bases-cards-background: oklch(100% 0.075 318 / 0.025);
  --bases-cards-cover-background: color-mix(in oklab, oklch(22.50% 0.0175 318), oklch(27.50% 0.0125 318));
  --bases-cards-label-color: oklch(63.75% 0.0225 318);
  --bases-cards-line-height: 26px;
  --bases-cards-radius: 12px;
  --bases-cards-shadow: none;
  --bases-cards-shadow-hover: none;
  --bases-embed-border-color: oklch(100% 0.0625 318 / 0.0625);
  --bases-embed-border-radius: 0;
  --bases-group-heading-property-color: oklch(71.25% 0.0125 318);
  ...
  --bases-table-border-color: oklch(100% 0.09375 318 / 0.1);
  --bases-table-cell-background-active: transparent;
  --bases-table-cell-background-disabled: color-mix(in oklab, oklch(22.50% 0.0175 318), oklch(27.50% 0.0125 318));
  --bases-table-cell-background-selected: hsla(256, 75%, 62%, 0.1);
  --bases-table-cell-shadow-active: 0 0 0 2.5px color-mix(in oklab, hsl(256, 75%, 62%) 50%, transparent 75%);
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(256, 75%, 62%);
  --bases-table-container-border-radius: 0;
  --bases-table-group-background: transparent;
  --bases-table-header-background: oklch(22.50% 0.0175 318);
  --bases-table-header-background-hover: transparent;
  --bases-table-header-color: oklch(57.50% 0.0225 318);
  --bases-table-header-color-hover: oklch(77.50% 0.0125 318);
  --bases-table-header-weight: 490;
  --bases-table-row-border-width: 0;
  --bases-table-row-height: 32px;
  --bases-table-summary-background: oklch(22.50% 0.0175 318);
  --bases-table-summary-background-hover: oklch(100% 0.0625 318 / 0.05);
  ...
  --canvas-card-label-color: oklch(52.50% 0.0225 318);
  --canvas-color-1: 255, 88, 83;
  --canvas-color-2: 229, 164, 74;
  --canvas-color-3: 208, 203, 105;
  --canvas-color-4: 119, 203, 77;
  --canvas-color-5: 0, 155, 255;
  --canvas-color-6: 203, 116, 228;
  ...
  --corner-smoothing: 60%;
  --dark: var(--text-normal, oklch(85.00% 0.0125 318));
  --darkgray: var(--text-normal, oklch(85.00% 0.0125 318));
  --dialog-width: 500px;
  --divider-color: oklch(100% 0.0625 318 / 0.0625);
  --divider-color-hover: color-mix(in oklab, hsl(256, 75%, 62%) 50%, transparent 75%);
  --divider-width: 0;
  --drag-ghost-background: oklch(22.50% 0.0175 318);
  --drag-ghost-text-color: oklch(85.00% 0.0125 318);
  ...
  --file-header-background: oklch(22.50% 0.0175 318);
  --file-header-background-focused: oklch(22.50% 0.0175 318);
  ...
  --font-ui-larger: 24px;
  --font-weight: 420;
  --footnote-divider-color: oklch(100% 0.0625 318 / 0.0625);
  --footnote-id-color: oklch(71.25% 0.0125 318);
  --footnote-id-color-no-occurrences: oklch(52.50% 0.0225 318);
  --footnote-input-background-active: oklch(100% 0.0625 318 / 0.05);
  ...
  --gray: var(--text-muted, oklch(71.25% 0.0125 318));
  ...
  --highlight: var(--text-highlight-bg, oklch(from rgb(239, 211, 0) 0.8 calc(c * 1.375) h / 0.33));
  ...
  --icon-color: oklch(63.75% 0.0225 318);
  --icon-color-active: color-mix(in oklab, hsl(256, 75%, 62%) 64%, #fff 36%);
  --icon-color-focused: oklch(85.00% 0.0125 318);
  --icon-color-hover: oklch(85.00% 0.0125 318);
  ...
  --light: var(--background-primary, oklch(22.50% 0.0175 318));
  --lightgray: var(--background-secondary, oklch(27.50% 0.0125 318));
  ...
  --list-indent: 1.5em;
  --list-marker-color: oklch(52.50% 0.0225 318);
  --list-marker-color-collapsed: color-mix(in oklab, hsl(256, 75%, 62%) 64%, #fff 36%);
  --list-marker-color-hover: oklch(71.25% 0.0125 318);
  ...
  --metadata-border-color: oklch(100% 0.0625 318 / 0.0625);
  --metadata-border-radius: 12px;
  --metadata-divider-color: oklch(100% 0.0625 318 / 0.0625);
  --metadata-gap: 2px;
  --metadata-input-background-active: oklch(100% 0.0625 318 / 0.05);
  ...
  --metadata-input-text-color: oklch(85.00% 0.0125 318);
  --metadata-label-background-active: oklch(100% 0.0625 318 / 0.05);
  ...
  --metadata-label-text-color: oklch(63.75% 0.0225 318);
  --metadata-label-text-color-hover: oklch(63.75% 0.0225 318);
  --metadata-label-width: 10em;
  --metadata-property-background-active: oklch(100% 0.0625 318 / 0.05);
  --metadata-property-box-shadow-focus: 0 0 0 2.5px color-mix(in oklab, hsl(256, 75%, 62%) 50%, transparent 75%);
  --metadata-property-box-shadow-hover: 0 0 0 2.5px oklch(100% 0.0625 318 / 0.05);
  --mobile-nav-fade-bg: linear-gradient(oklch(from oklch(27.50% 0.0125 318) l c h), transparent 78px);
  --modal-background: oklch(27.75% 0.0175 318 / 0.625);
  --modal-border-color: oklch(43.75% 0.0225 318);
  --modal-border-width: 0;
  --modal-community-header-bg: oklch(from oklch(27.50% 0.0125 318) l 0.0125 h / 0.5);
  --modal-community-item-bg: oklch(from oklch(34.50% 0.0125 318) l 0.0125 h / 0.5);
  --modal-radius: 22px;
  --modal-small-background: oklch(27.75% 0.0175 318 / 0.625);
  --nav-collapse-icon-color: oklch(100% 0.025 318 / 0.35);
  --nav-collapse-icon-color-collapsed: oklch(52.50% 0.0225 318);
  --nav-folder-color: oklch(77.50% 0.0125 318);
  --nav-header-bg: oklch(100% 0.0625 318 / 0.0625);
  --nav-header-timing: cubic-bezier(0.3, 0.75, 0, 1);
  --nav-heading-color: oklch(77.50% 0.0125 318);
  --nav-heading-color-collapsed: oklch(52.50% 0.0225 318);
  --nav-heading-color-collapsed-hover: oklch(71.25% 0.0125 318);
  --nav-heading-color-hover: oklch(85.00% 0.0125 318);
  --nav-heading-weight: 520;
  --nav-heading-weight-hover: 520;
  --nav-indentation-guide-color: oklch(100% 0.09375 318 / 0.1);
  --nav-indentation-guide-width: 0;
  --nav-item-background-active: oklch(100% 0.0625 318 / 0.05);
  --nav-item-background-hover: oklch(100% 0.0625 318 / 0.05);
  --nav-item-background-selected: hsla(256, 75%, 62%, 0.15);
  --nav-item-color: oklch(71.25% 0.0125 318);
  --nav-item-color-active: oklch(85.00% 0.0125 318);
  --nav-item-color-highlighted: color-mix(in oklab, hsl(256, 75%, 62%) 64%, #fff 36%);
  --nav-item-color-hover: oklch(85.00% 0.0125 318);
  --nav-item-color-selected: oklch(85.00% 0.0125 318);
  --nav-item-radius: 8px;
  --nav-tag-color: oklch(52.50% 0.0225 318);
  --nav-tag-color-active: oklch(71.25% 0.0125 318);
  --nav-tag-color-hover: oklch(71.25% 0.0125 318);
  --nav-tag-radius: 8px;
  --nav-tag-weight: 620;
  --nav-text-color: oklch(85.00% 0.0125 318);
  ...
  --pill-background: oklch(100% 0.0625 318 / 0.05);
  --pill-background-hover: oklch(100% 0.0625 318 / 0.05);
  --pill-border-color: oklch(100% 0.0625 318 / 0.0625);
  --pill-border-color-hover: oklch(36.25% 0.0125 318);
  --pill-color: oklch(71.25% 0.0125 318);
  --pill-color-hover: oklch(71.25% 0.0125 318);
  --pill-color-remove: oklch(52.50% 0.0225 318);
  --pill-color-remove-hover: white;
  --pill-radius: 18px;
  --pill-weight: 490;
  --prompt-backdrop-filter: blur(12px) saturate(1.125) brightness(1);
  --prompt-background: oklch(27.75% 0.0175 318 / 0.625);
  --prompt-border-color: oklch(100% 0.05 318 / 0.125);
  ...
  --secondary: var(--text-accent, color-mix(in oklab, hsl(256, 75%, 62%) 64%, #fff 36%));
  ...
  --tag-size: 0.8em;
  --tag-weight: 490;
  --tertiary: var(--text-accent-hover, color-mix(in oklab, color-mix(in oklab, hsl(256, 75%, 62%) 64%, #fff 36%), transparent 8%));
  ...
  --text-success: #77cb4d;
  --text-warning: #e5a44a;
  --textHighlight: var(--text-highlight-bg, oklch(from rgb(239, 211, 0) 0.8 calc(c * 1.375) h / 0.33));
  ...
  --titlebar-border-color: oklch(100% 0.0625 318 / 0.0625);
  --titlebar-height: 36px;
  --titlebar-text-color: oklch(100% 0.025 318 / 0.35);
  --titlebar-text-color-focused: oklch(71.25% 0.0125 318);
  --titlebar-text-weight: 620;
  --toggle-border-width: 4px;
  --toggle-gradient: linear-gradient(to bottom, hsl(256, 75%, 62%) -30%, color-mix(in oklab, oklab(from hsl(256, 75%, 62%) l a b / 0.25) 30%, transparent 70%) 180%);
  ...
  --toggle-track-bg: oklch(100% 0.025 318 / 0.2);
  --toggle-width: 44px;
  ...
  --vault-profile-color: oklch(63.75% 0.0225 318);
  --vault-profile-color-hover: oklch(71.25% 0.0125 318);
  ...
  --workspace-border-color: oklch(100% 0.0625 318 / 0.08125);
