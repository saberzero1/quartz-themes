...
html[saved-theme="dark"] body pre > code > [data-line] {
  border-left-color: rgb(208, 203, 105);
}
...
html[saved-theme="dark"] body pre > code [data-highlighted-chars] {
  border-bottom-color: rgb(208, 203, 105);
  border-left-color: rgb(208, 203, 105);
  border-right-color: rgb(208, 203, 105);
  border-top-color: rgb(208, 203, 105);
}
...
html[saved-theme="dark"] body ::-webkit-scrollbar {
  background: oklch(0.225 0.0175 318) radial-gradient(oklch(0.285 0.0225 288) 0%, oklch(0.2475 0.0225 348) 200%) repeat scroll 0% 0% / auto padding-box border-box;
  background-color: oklch(0.225 0.0175 318);
}
