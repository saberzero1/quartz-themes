...
export const theme: ThemeData = {
  ...
  --activeline: #4e2d3896 !important;
  --background-modifier-border: #773d477e !important;
  --background-modifier-border-focus: #c2937b !important;
  --background-modifier-border-hover: #773d477e !important;
  --background-modifier-form-field: #4d2d38 !important;
  --background-modifier-form-field-hover: #4d2d38 !important;
  --background-modifier-message: #28171d !important;
  --background-primary: #3b252d !important;
  --background-primary-alt: #35242a !important;
  --background-secondary: #412730 !important;
  --background-secondary-alt: #773d477e !important;
  --bases-cards-background: #3b252d !important;
  --bases-cards-cover-background: #35242a !important;
  --bases-cards-shadow: 0 0 0 1px #773d477e !important;
  --bases-cards-shadow-hover: 0 0 0 1px #773d477e !important;
  --bases-embed-border-color: #773d477e !important;
  --bases-group-heading-property-color: #c2937b !important;
  --bases-group-heading-property-size: 13px !important;
  --bases-table-border-color: #773d477e !important;
  --bases-table-cell-background-active: #3b252d !important;
  --bases-table-cell-background-disabled: #35242a !important;
  --bases-table-cell-shadow-active: 0 0 0 2px #c2937b !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px #b884c4 !important;
  --bases-table-group-background: #35242a !important;
  --bases-table-header-background: #3b252d !important;
  --bases-table-header-color: #c2937b !important;
  --bases-table-summary-background: #3b252d !important;
  --blockquote-border-color: #b884c4 !important;
  --blur-background: color-mix(in srgb, #773d477e 65%, transparent) linear-gradient(#773d477e, color-mix(in srgb, #773d477e 65%, transparent)) !important;
  --bodyFont: "CMU Typewriter Text" !important;
  --canvas-background: #3b252d !important;
  --canvas-card-label-color: #b3826a !important;
  --canvas-dot-pattern: #773d477e !important;
  --caret-color: #d3a590 !important;
  --checkbox-border-color: #b3826a !important;
  --checkbox-border-color-hover: #c2937b !important;
  --checkbox-color: #b884c4 !important;
  --checkbox-color-hover: #b884c4 !important;
  --checkbox-marker-color: #3b252d !important;
  --checklist-done-color: #c2937b !important;
  --clickable-icon-radius: 0px !important;
  --code-background: #35242a !important;
  --code-border-color: #773d477e !important;
  --code-comment: #b3826a !important;
  --code-normal: #d3a590 !important;
  --code-punctuation: #c2937b !important;
  --codeFont: "JetBrains Mono" !important;
  --collapse-icon-color: #b3826a !important;
  --collapse-icon-color-collapsed: #b884c4 !important;
  --color-accent: #b884c4 !important;
  --color-accent-1: #b884c4 !important;
  --color-accent-2: #c693d1 !important;
  --color-base-00: #3b252d !important;
  --color-base-05: #773d477e !important;
  --color-base-10: #35242a !important;
  --color-base-100: #d3a590 !important;
  --color-base-20: #412730 !important;
  --color-base-25: #4d2d38 !important;
  --color-base-30: #773d477e !important;
  --color-base-35: #773d477e !important;
  --color-base-40: #c2937b !important;
  --color-base-50: #b3826a !important;
  --color-base-70: #c2937b !important;
  --color-bold: #fccab1 !important;
  --color-italic: #eccfe8 !important;
  --cubic-animation: cubic-bezier(0.175, 0.9, 0.3, 1.1) !important;
  --dark: #d3a590 !important;
  --darkgray: #d3a590 !important;
  --default-animation-duration: 150ms !important;
  --default-border-radius: 4px !important;
  --divider-color: #773d477e !important;
  --divider-color-hover: #b884c4 !important;
  --dropdown-background: #773d477e !important;
  --dropdown-background-hover: #773d477e !important;
  --embed-block-shadow-hover: 0 0 0 1px #773d477e, inset 0 0 0 1px #773d477e !important;
  --embed-border-start: 2px solid #b884c4 !important;
  --file-header-background: #3b252d !important;
  --file-header-background-focused: #3b252d !important;
  --file-header-font: "CMU Typewriter Text" !important;
  --file-header-font-size: 14px !important;
  --file-line-width: 900px !important;
  --flair-background: #773d477e !important;
  --flair-color: #d3a590 !important;
  ...
  --footnote-divider-color: #773d477e !important;
  --footnote-id-color: #c2937b !important;
  --footnote-id-color-no-occurrences: #b3826a !important;
  --graph-line: #773d477e !important;
  --graph-node: #c2937b !important;
  --graph-node-focused: #b884c4 !important;
  --graph-node-unresolved: #b3826a !important;
  --graph-text: #d3a590 !important;
  --gray: #c2937b !important;
  --header-height: 30px !important;
  --headerFont: "CMU Typewriter Text" !important;
  --heading-formatting: #b3826a !important;
  --heading-formatting-color: #d12e6d !important;
  --highlight: #b053bc2e !important;
  --hover-animation-duration: 100ms !important;
  --hover-faster-animation-duration: 75ms !important;
  --hr-color: #773d477e !important;
  --icon-color: #c2937b !important;
  --icon-color-active: #b884c4 !important;
  --icon-color-focused: #d3a590 !important;
  --icon-color-hover: #c2937b !important;
  --in-between-background: #321e25 !important;
  --input-date-separator: #b3826a !important;
  --input-placeholder-color: #b3826a !important;
  --interactive-accent: #b884c4 !important;
  --interactive-accent-hover: #b884c4 !important;
  --interactive-hover: #773d477e !important;
  --interactive-normal: #773d477e !important;
  --light: #3b252d !important;
  --lightgray: #412730 !important;
  --link-color: #b884c4 !important;
  --link-color-hover: #c693d1 !important;
  --link-external-color: #b884c4 !important;
  --link-external-color-hover: #c693d1 !important;
  --link-unresolved-color: #b884c4 !important;
  --list-indent: 1.4em !important;
  --list-marker-color: #b3826a !important;
  --list-marker-color-collapsed: #b884c4 !important;
  --list-marker-color-hover: #c2937b !important;
  --menu-background: #412730 !important;
  --menu-border-color: #773d477e !important;
  --metadata-border-color: #773d477e !important;
  --metadata-divider-color: #773d477e !important;
  --metadata-input-font: "CMU Typewriter Text" !important;
  --metadata-input-text-color: #d3a590 !important;
  --metadata-label-font: "CMU Typewriter Text" !important;
  --metadata-label-text-color: #c2937b !important;
  --metadata-label-text-color-hover: #c2937b !important;
  --metadata-property-box-shadow-focus: 0 0 0 2px #c2937b !important;
  --metadata-property-box-shadow-hover: 0 0 0 1px #773d477e !important;
  --metadata-sidebar-input-font-size: 14px !important;
  --metadata-sidebar-label-font-size: 14px !important;
  --modal-background: #3b252d !important;
  --modal-border-color: #c2937b !important;
  --nav-collapse-icon-color: #b3826a !important;
  --nav-collapse-icon-color-collapsed: #b3826a !important;
  --nav-heading-color: #d3a590 !important;
  --nav-heading-color-collapsed: #b3826a !important;
  --nav-heading-color-collapsed-hover: #c2937b !important;
  --nav-heading-color-hover: #d3a590 !important;
  --nav-item-color: #c2937b !important;
  --nav-item-color-active: #d3a590 !important;
  --nav-item-color-highlighted: #b884c4 !important;
  --nav-item-color-hover: #d3a590 !important;
  --nav-item-color-selected: #d3a590 !important;
  --nav-item-size: 14px !important;
  --nav-tag-color: #b3826a !important;
  --nav-tag-color-active: #c2937b !important;
  --nav-tag-color-hover: #c2937b !important;
  --pdf-background: #3b252d !important;
  --pdf-page-background: #3b252d !important;
  --pdf-shadow: 0 0 0 1px #773d477e !important;
  --pdf-sidebar-background: #3b252d !important;
  --pdf-thumbnail-shadow: 0 0 0 1px #773d477e !important;
  --pill-border-color: #773d477e !important;
  --pill-border-color-hover: #773d477e !important;
  --pill-color: #c2937b !important;
  --pill-color-hover: #d3a590 !important;
  --pill-color-remove: #b3826a !important;
  --pill-color-remove-hover: #b884c4 !important;
  --pop-callout-slide-out-duration: 0ms !important;
  --pop-callout-width: 20px !important;
  --prompt-background: #3b252d !important;
  --prompt-border-color: #c2937b !important;
  --raised-background: color-mix(in srgb, #773d477e 65%, transparent) linear-gradient(#773d477e, color-mix(in srgb, #773d477e 65%, transparent)) !important;
  --ribbon-background: #412730 !important;
  --ribbon-background-collapsed: #3b252d !important;
  --ribbon-padding: 0px !important;
  --ribbon-width: 40px !important;
  --search-clear-button-color: #c2937b !important;
  --search-icon-color: #c2937b !important;
  --search-result-background: #3b252d !important;
  --secondary: #b884c4 !important;
  --setting-group-heading-color: #d3a590 !important;
  --setting-group-heading-size: 16px !important;
  --setting-items-background: #35242a !important;
  --setting-items-border-color: #773d477e !important;
  --shiki-active-tab-border-color: #c2937b !important;
  --shiki-code-background: #35242a !important;
  --shiki-code-comment: #b3826a !important;
  --shiki-code-normal: #c2937b !important;
  --shiki-code-punctuation: #c2937b !important;
  --shiki-gutter-border-color: #773d477e !important;
  --shiki-gutter-text-color: #b3826a !important;
  --shiki-gutter-text-color-highlight: #c2937b !important;
  --shiki-highlight-neutral: #c2937b !important;
  --shiki-terminal-dots-color: #b3826a !important;
  --shiki-tooltip-background: #28171d !important;
  --slider-thumb-border-color: #773d477e !important;
  --slider-track-background: #773d477e !important;
  --status-bar-background: #412730 !important;
  --status-bar-border-color: #773d477e !important;
  --status-bar-font-size: 13px !important;
  --status-bar-text-color: #c2937b !important;
  --suggestion-background: #3b252d !important;
  --tab-background-active: #3b252d !important;
  --tab-container-background: #412730 !important;
  --tab-divider-color: #773d477e !important;
  --tab-font-size: 14px !important;
  --tab-outline-color: #773d477e !important;
  --tab-stacked-font-size: 14px !important;
  --tab-stacked-header-width: 30px !important;
  --tab-switcher-background: #412730 !important;
  --tab-switcher-menubar-background: linear-gradient(to top, #412730, transparent) !important;
  --tab-switcher-preview-shadow-active: 0 0 0 2px #b884c4 !important;
  --tab-text-color: #b3826a !important;
  --tab-text-color-active: #c2937b !important;
  --tab-text-color-focused: #c2937b !important;
  --tab-text-color-focused-active: #c2937b !important;
  --tab-text-color-focused-active-current: #d3a590 !important;
  --tab-text-color-focused-highlighted: #b884c4 !important;
  --table-add-button-border-color: #773d477e !important;
  --table-border-color: #773d477e !important;
  --table-drag-handle-background-active: #b884c4 !important;
  --table-drag-handle-color: #b3826a !important;
  --table-header-border-color: #773d477e !important;
  --table-header-color: #d3a590 !important;
  --table-selection-border-color: #b884c4 !important;
  --tag-color: #b884c4 !important;
  --tag-color-hover: #b884c4 !important;
  --tag-radius: 4px !important;
  --tertiary: #c693d1 !important;
  --text-accent: #b884c4 !important;
  --text-accent-hover: #c693d1 !important;
  --text-faint: #b3826a !important;
  --text-highlight-bg: #b053bc2e !important;
  --text-highlight-bg-active: #b053bc2e !important;
  --text-muted: #c2937b !important;
  --text-normal: #d3a590 !important;
  --text-selection: #6e425296 !important;
  --textHighlight: #b053bc2e !important;
  --titleFont: "CMU Typewriter Text" !important;
  --titlebar-background: #412730 !important;
  --titlebar-background-focused: #412730 !important;
  --titlebar-border-color: #773d477e !important;
  --titlebar-text-color: #c2937b !important;
  --titlebar-text-color-focused: #d3a590 !important;
  --traffic-lights-offset-x: 30px !important;
  --traffic-lights-offset-y: 30px !important;
  --vault-profile-color: #d3a590 !important;
  --vault-profile-color-hover: #d3a590 !important;
...
html[saved-theme="dark"] body .text-highlight {
  background-color: rgba(176, 83, 188, 0.18);
  color: rgb(211, 165, 144);
  font-family: "??", "??", "CMU Typewriter Text";
...
html[saved-theme="dark"] body li.task-list-item input[type="checkbox"]:checked {
  background-color: rgb(184, 132, 196);
