...
export const theme: ThemeData = {
  ...
  --bodyFont: var(--font-interface, "Slasher Regular");
  ...
  --codeFont: var(--font-interface, "Slasher Regular");
  --col-accent: #D92926;
  ...
  --dark: var(--text-normal, #83888C);
  --darkgray: var(--text-normal, #83888C);
  ...
  --graph-text: #83888C;
  --gray: var(--text-muted, #83888C);
  --headerFont: var(--font-interface, "Slasher Regular");
  --heading-formatting: #83888C;
  --highlight: var(--background-modifier-hover, #D8B131);
  --hr-color: #232221;
  --icon-color: #83888C;
  ...
  --light: var(--background-primary, #030308);
  --lightgray: var(--background-secondary, #030308);
  ...
  --secondary: var(--text-accent, #FF4949);
  --setting-group-heading-color: #83888C;
  --setting-items-background: black;
  --setting-items-border-color: #232221;
  --shiki-active-tab-border-color: #83888C;
  --shiki-code-background: black;
  --shiki-code-comment: #83888C;
  --shiki-code-normal: #83888C;
  --shiki-code-punctuation: #83888C;
  --shiki-gutter-border-color: #232221;
  --shiki-gutter-text-color: #83888C;
  --shiki-gutter-text-color-highlight: #83888C;
  --shiki-highlight-neutral: #83888C;
  --shiki-terminal-dots-color: #83888C;
  --shiki-tooltip-background: #D92926;
  ...
  --tertiary: var(--text-accent-hover, #FFD059);
  --text-accent: #FF4949;
  ...
  --text-success: #D92926;
  --textHighlight: var(--background-modifier-hover, #D8B131);
  --titleFont: var(--font-interface, "Slasher Regular");
