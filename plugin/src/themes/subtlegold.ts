...
export const theme: ThemeData = {
  ...
  --accent-h: 41;
  --accent-s: 52%;
  --background-modifier-active-hover: rgba(213, 185, 123, 0.15);
  ...
  --bases-table-cell-background-selected: rgba(213, 185, 123, 0.1);
  ...
  --color-accent: rgb(213, 185, 123);
  --color-accent-1: rgb(226, 202, 161);
  --color-accent-2: rgb(238, 221, 196);
  ...
  --link-unresolved-decoration-color: rgba(213, 185, 123, 0.3);
  ...
  --nav-item-background-selected: rgba(213, 185, 123, 0.2);
  --nav-item-color: #888;
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px rgb(213, 185, 123);
  --tab-text-color: #555;
  ...
  --table-selection: rgba(213, 185, 123, 0.1);
  --table-selection-border-color: #d6ba7c;
  --table-white-space: normal;
  --tag-background: rgba(213, 185, 123, 0.1);
  --tag-background-hover: rgba(213, 185, 123, 0.2);
  --tag-border-color: rgba(213, 185, 123, 0.15);
  --tag-border-color-hover: rgba(213, 185, 123, 0.15);
  --tag-color: #d6ba7c;
  ...
  --text-selection: rgba(213, 185, 123, 0.33);
...
body sup {
  ...
  --collapse-icon-color-collapsed: #d6ba7c;
  --color-accent: rgb(213, 185, 123);
  --color-accent-1: rgb(220, 194, 142);
  --color-accent-2: rgb(226, 202, 161);
  --color-accent-hsl: 41, 52%, 66%;
  --dark: var(--text-normal);
  --darkgray: var(--text-normal);
  --divider-color-hover: #d6ba7c;
  ...
  --text-selection: rgba(213, 185, 123, 0.2);
  --textHighlight: var(--text-highlight-bg);
  --titleFont: var(--font-text);
