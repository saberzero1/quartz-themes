...
export const theme: ThemeData = {
  ...
  --background-modifier-active-hover: hsla(358, 96%, 63%, 0.1) !important;
  ...
  --bases-table-cell-background-selected: hsla(358, 96%, 63%, 0.1) !important;
  --bases-table-cell-shadow-active: 0 0 0 2px #414141 !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(358, 96%, 63%) !important;
  ...
  --blockquote-border-color: hsl(358, 96%, 63%) !important;
  ...
  --checkbox-color: hsl(358, 96%, 63%) !important;
  --checkbox-color-hover: #027aff !important;
  ...
  --collapse-icon-color-collapsed: hsl(358, 96%, 63%) !important;
  --color-accent: hsl(358, 96%, 63%) !important;
  --color-accent-1: #027aff !important;
  --color-accent-1-rgb: 2, 122, 255 !important;
  --color-accent-2: hsl(
        258 calc(88% + 180) 66%
    ) !important;
  ...
  --divider-color-hover: hsl(358, 96%, 63%) !important;
  ...
  --embed-border-start: 2px solid hsl(358, 96%, 63%) !important;
  ...
  --graph-node-focused: hsl(358, 96%, 63%) !important;
  --graph-node-tag: hsl(358, 96%, 63%) !important;
  ...
  --icon-color-active: hsl(358, 96%, 63%) !important;
  ...
  --interactive-accent: hsl(358, 96%, 63%) !important;
  --interactive-accent-hover: #027aff !important;
  --interactive-accent-hsl: 358, 96%, 63% !important;
  ...
  --link-external-color: hsl(358, 96%, 63%) !important;
  ...
  --list-marker-color-collapsed: hsl(358, 96%, 63%) !important;
  ...
  --nav-item-background-selected: hsla(358, 96%, 63%, 0.15) !important;
  ...
  --pill-color-remove-hover: hsl(358, 96%, 63%) !important;
  ...
  --scrollbar-active-thumb-bg: hsl(358, 96%, 63%) !important;
  ...
  --secondary: hsl(358, 96%, 63%) !important;
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(358, 96%, 63%) !important;
  ...
  --tab-text-color-focused-highlighted: hsl(358, 96%, 63%) !important;
  --table-add-button-border-color: #313131 !important;
  --table-border-color: #313131 !important;
  --table-drag-handle-background-active: hsl(358, 96%, 63%) !important;
  --table-drag-handle-color: #999999 !important;
  --table-header-border-color: #313131 !important;
  --table-header-color: #bababa !important;
  --table-selection: hsla(358, 96%, 63%, 0.1) !important;
  --table-selection-border-color: hsl(358, 96%, 63%) !important;
  --tag-background: hsla(358, 96%, 63%, 0.1) !important;
  --tag-background-hover: hsla(358, 96%, 63%, 0.2) !important;
  --tag-border-color: hsla(358, 96%, 63%, 0.15) !important;
  --tag-border-color-hover: hsla(358, 96%, 63%, 0.15) !important;
  --tag-color: hsl(358, 96%, 63%) !important;
  --tag-color-hover: hsl(358, 96%, 63%) !important;
  --tertiary: hsl(
        258 calc(88% + 180) 66%
    ) !important;
  --text-accent: hsl(358, 96%, 63%) !important;
  ...
  --text-selection: hsla(358, 96%, 63%, 0.33) !important;
...
html[saved-theme="dark"] body kbd {
  background-color: color(srgb 0.9852 0.2748 0.29848 / 0.7);
...
html[saved-theme="dark"] body ul.tags > li {
  background-color: color(srgb 0.9852 0.2748 0.29848 / 0.05);
  ...
  --background-modifier-active-hover: hsla(353, 81%, 55%, 0.1) !important;
  ...
  --bases-table-cell-background-selected: hsla(353, 81%, 55%, 0.1) !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(353, 81%, 55%) !important;
  ...
  --blockquote-border-color: hsl(353, 81%, 55%) !important;
  ...
  --checkbox-color: hsl(353, 81%, 55%) !important;
  ...
  --collapse-icon-color-collapsed: hsl(353, 81%, 55%) !important;
  --color-accent: hsl(353, 81%, 55%) !important;
  --color-accent-1: #5bcefa !important;
  --color-accent-1-rgb: 91, 206, 250 !important;
  --color-accent-2: hsl(
        258 88% 71%
    ) !important;
  --color-accent-hover: hsl(
  ...
  --divider-color-hover: hsl(353, 81%, 55%) !important;
  ...
  --embed-border-start: 2px solid hsl(353, 81%, 55%) !important;
  ...
  --graph-node-focused: hsl(353, 81%, 55%) !important;
  --graph-node-tag: hsl(353, 81%, 55%) !important;
  ...
  --icon-color-active: hsl(353, 81%, 55%) !important;
  ...
  --interactive-accent: hsl(353, 81%, 55%) !important;
  ...
  --link-decoration-hover: none !important;
  --link-decoration-thickness: 13% !important;
  --link-external-color: hsl(353, 81%, 55%) !important;
  --link-external-color-hover: hsl(
        258 88% 71%
    ) !important;
  --link-external-decoration: none !important;
  ...
  --list-marker-color-collapsed: hsl(353, 81%, 55%) !important;
  ...
  --nav-item-background-selected: hsla(353, 81%, 55%, 0.15) !important;
  ...
  --pill-color-remove-hover: hsl(353, 81%, 55%) !important;
  ...
  --scrollbar-active-thumb-bg: hsl(353, 81%, 55%) !important;
  ...
  --secondary: hsl(353, 81%, 55%) !important;
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(353, 81%, 55%) !important;
  ...
  --tab-text-color-focused-highlighted: hsl(353, 81%, 55%) !important;
  --table-add-button-border-color: #c7c7c7 !important;
  --table-border-color: #c7c7c7 !important;
  --table-drag-handle-background-active: hsl(353, 81%, 55%) !important;
  --table-drag-handle-color: #707070 !important;
  --table-header-border-color: #c7c7c7 !important;
  --table-header-color: #5a5a5a !important;
  --table-selection: hsla(353, 81%, 55%, 0.1) !important;
  --table-selection-border-color: hsl(353, 81%, 55%) !important;
  --tag-background: hsla(353, 81%, 55%, 0.1) !important;
  --tag-background-hover: hsla(353, 81%, 55%, 0.2) !important;
  --tag-border-color: hsla(353, 81%, 55%, 0.15) !important;
  --tag-border-color-hover: hsla(353, 81%, 55%, 0.15) !important;
  --tag-color: hsl(353, 81%, 55%) !important;
  --tag-color-hover: hsl(353, 81%, 55%) !important;
  --tertiary: hsl(
        258 88% 71%
    ) !important;
  --text-accent: hsl(353, 81%, 55%) !important;
  --text-accent-hover: hsl(
        258 88% 71%
    ) !important;
...
html[saved-theme="light"] body li.task-list-item input[type="checkbox"]:checked {
  background-color: rgb(233, 47, 69);
  border-color: rgba(0, 0, 0, 0);
}
...
html[saved-theme="light"] body kbd {
  background-color: color(srgb 0.9145 0.1855 0.27055 / 0.7);
  border-bottom-color: rgb(255, 255, 255);
  border-left-color: rgb(255, 255, 255);
  border-right-color: rgb(255, 255, 255);
  border-top-color: rgb(255, 255, 255);
...
html[saved-theme="light"] body ul.tags > li {
  background-color: color(srgb 0.9145 0.1855 0.27055 / 0.05);
