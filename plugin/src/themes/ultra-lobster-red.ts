...
export const theme: ThemeData = {
  ...
  --bases-table-cell-background-selected: hsla(358, 96%, 63%, 0.1);
  --bases-table-cell-shadow-active: 0 0 0 2px #414141;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(358, 96%, 63%);
  ...
  --embed-border-start: 2px solid hsl(358, 96%, 63%);
  ...
  --hr-color: #313131;
  --icon-color: #666666;
  --icon-color-active: hsl(358, 96%, 63%);
  ...
  --list-marker-color-collapsed: hsl(358, 96%, 63%);
  ...
  --nav-item-background-selected: hsla(358, 96%, 63%, 0.15);
  ...
  --pill-color-remove-hover: hsl(358, 96%, 63%);
  ...
  --secondary: var(--text-accent, hsl(358, 96%, 63%));
...
html[saved-theme="dark"] body ul.tags > li {
  background-color: rgb(from var(--color-accent) r g b/0.05, color(srgb 0.9852 0.2748 0.29848 / 0.05));
  ...
  --bases-table-cell-background-selected: hsla(353, 81%, 55%, 0.1);
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(353, 81%, 55%);
  ...
  --embed-border-start: 2px solid hsl(353, 81%, 55%);
  ...
  --hr-color: #c7c7c7;
  --icon-color: #ababab;
  --icon-color-active: hsl(353, 81%, 55%);
  ...
  --list-marker-color-collapsed: hsl(353, 81%, 55%);
  ...
  --nav-item-background-selected: hsla(353, 81%, 55%, 0.15);
  ...
  --pill-color-remove-hover: hsl(353, 81%, 55%);
  ...
  --secondary: var(--text-accent, hsl(353, 81%, 55%));
...
html[saved-theme="light"] body ul.tags > li {
  background-color: rgb(from var(--color-accent) r g b/0.05, color(srgb 0.9145 0.1855 0.27055 / 0.05));
