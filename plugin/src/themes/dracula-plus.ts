...
export const theme: ThemeData = {
  ...
  --background-modifier-hover: var(--color-user-request, #ffffff13);
  --background-modifier-success: var(--color-green, #50fa7b);
  --background-primary: var(--color-base-00, #020517);
  --background-primary-alt: var(--color-base-10, #44475a);
  --background-secondary: var(--color-base-20, #020517);
  --background-secondary-alt: var(--color-base-30, #282a36);
  --bases-cards-background: var(--background-primary, #020517);
  --bases-cards-cover-background: var(--background-primary-alt, #44475a);
  --bases-group-heading-property-color: var(--text-muted, #f8f8f2);
  --bases-table-cell-background-active: var(--background-primary, #020517);
  ...
  --bases-table-header-background: var(--background-primary, #020517);
  --bases-table-header-background-hover: var(--background-modifier-hover, #ffffff13);
  --bases-table-header-color: var(--text-muted, #f8f8f2);
  --bases-table-summary-background: var(--background-primary, #020517);
  --bases-table-summary-background-hover: var(--background-modifier-hover, #ffffff13);
  ...
  --canvas-background: var(--background-primary, #020517);
  --canvas-card-label-color: var(--text-faint, #bd93f9);
  --caret-color: var(--text-normal, #f8f8f2);
  --checkbox-border-color: var(--text-faint, #bd93f9);
  --checkbox-border-color-hover: var(--text-muted, #f8f8f2);
  --checkbox-color: var(--interactive-accent, #bd93f9);
  --checkbox-marker-color: var(--background-primary, #020517);
  --checklist-done-color: var(--text-muted, #f8f8f2);
  ...
  --code-background: var(--background-primary-alt, #1d1c39);
  --code-block: #8be9fd;
  --code-bracket-background: var(--background-modifier-hover, #ffffff13);
  --code-comment: var(--text-faint, #bd93f9);
  --code-function: var(--color-yellow, #e9e90c);
  --code-keyword: var(--color-pink, #ff22b1);
  --code-normal: var(--text-normal, #f8f8f2);
  --code-property: var(--color-cyan, #00ffff);
  --code-punctuation: var(--text-muted, #f8f8f2);
  --collapse-icon-color: var(--text-faint, #bd93f9);
  --collapse-icon-color-collapsed: var(--text-accent, #ffb86c);
  --color-cyan: #00ffff;
  --color-pink: #ff22b1;
  ...
  --divider-color: var(--background-modifier-border, white);
  --dropdown-background: var(--interactive-normal, #44475a);
  --dropdown-background-hover: var(--interactive-hover, #ff5555);
  --empty-line-height: 1em;
  --file-header-background: var(--background-primary, #020517);
  --file-header-background-focused: var(--background-primary, #020517);
  ...
  --flair-background: var(--interactive-normal, #44475a);
  ...
  --footnote-id-color: var(--text-muted, #f8f8f2);
  --footnote-id-color-no-occurrences: var(--text-faint, #bd93f9);
  --footnote-input-background-active: var(--metadata-input-background-active, #ffffff13);
  --graph-node: var(--text-muted, #f8f8f2);
  --graph-node-attachment: var(--color-yellow, #e9e90c);
  --graph-node-focused: var(--text-accent, #ffb86c);
  --graph-node-unresolved: var(--text-faint, #bd93f9);
  --graph-text: var(--text-normal, #f8f8f2);
  --gray: var(--text-muted, var(--color-base-70, #f8f8f2));
  --heading-formatting: var(--text-faint, #bd93f9);
  --highlight: var(--background-modifier-hover, var(--color-user-request, #ffffff13));
  --hr-color: var(--background-modifier-border, white);
  --icon-color: var(--text-muted, #f8f8f2);
  --icon-color-active: var(--text-accent, #ffb86c);
  --icon-color-focused: var(--text-normal, #f8f8f2);
  --icon-color-hover: var(--text-muted, #f8f8f2);
  ...
  --inline-code: #e9e90c;
  --input-date-separator: var(--text-faint, #bd93f9);
  --input-placeholder-color: var(--text-faint, #bd93f9);
  --interactive-accent-rgb: 123, 108, 217;
  --interactive-hover: var(--color-base-35, #ff5555);
  --interactive-normal: var(--color-base-30, #44475a);
  --light: var(--background-primary, var(--color-base-00, #020517));
  --lightgray: var(--background-secondary, var(--color-base-20, #020517));
  --link-color: var(--text-accent, #ffb86c);
  --link-color-hover: var(--text-accent-hover, #8be9fd);
  --link-external-color: var(--text-accent, #ffb86c);
  --link-external-color-hover: var(--text-accent-hover, #8be9fd);
  --link-unresolved-color: var(--text-accent, #ffb86c);
  --list-marker-color: var(--text-faint, #bd93f9);
  --list-marker-color-collapsed: var(--text-accent, #ffb86c);
  --list-marker-color-hover: var(--text-muted, #f8f8f2);
  --menu-background: var(--background-secondary, #020517);
  --metadata-input-background-active: var(--background-modifier-hover, #ffffff13);
  --metadata-input-text-color: var(--text-normal, #f8f8f2);
  --metadata-label-background-active: var(--background-modifier-hover, #ffffff13);
  --metadata-label-text-color: var(--text-muted, #f8f8f2);
  --metadata-label-text-color-hover: var(--text-muted, #f8f8f2);
  --metadata-property-background-active: var(--background-modifier-hover, #ffffff13);
  --modal-background: var(--background-primary, #020517);
  --nav-collapse-icon-color: var(--collapse-icon-color, #bd93f9);
  --nav-collapse-icon-color-collapsed: var(--text-faint, #bd93f9);
  --nav-heading-color: var(--text-normal, #f8f8f2);
  --nav-heading-color-collapsed: var(--text-faint, #bd93f9);
  --nav-heading-color-collapsed-hover: var(--text-muted, #f8f8f2);
  --nav-heading-color-hover: var(--text-normal, #f8f8f2);
  --nav-indentation-guide-color: var(--indentation-guide-color, #ffffff30);
  --nav-item-background-active: var(--color-user-request, #ffffff13);
  --nav-item-background-hover: var(--color-user-request, #ffffff13);
  --nav-item-color: var(--text-muted, #f8f8f2);
  --nav-item-color-active: var(--text-normal, #f8f8f2);
  --nav-item-color-highlighted: var(--text-accent, #ffb86c);
  --nav-item-color-hover: var(--text-normal, #f8f8f2);
  --nav-item-color-selected: var(--text-normal, #f8f8f2);
  --nav-tag-color: var(--text-faint, #bd93f9);
  --nav-tag-color-active: var(--text-muted, #f8f8f2);
  --nav-tag-color-hover: var(--text-muted, #f8f8f2);
  ...
  --pdf-background: var(--background-primary, #020517);
  --pdf-page-background: var(--background-primary, #020517);
  --pdf-sidebar-background: var(--background-primary, #020517);
  --pill-color: var(--text-muted, #f8f8f2);
  --pill-color-hover: var(--text-normal, #f8f8f2);
  --pill-color-remove: var(--text-faint, #bd93f9);
  --pill-color-remove-hover: var(--text-accent, #ffb86c);
  --pre-code: #1d1c39;
  --prompt-background: var(--background-primary, #020517);
  --raised-background: var(--blur-background, color-mix(in srgb, #44475a 65%, transparent) linear-gradient(#44475a, color-mix(in srgb, #44475a 65%, transparent)));
  --ribbon-background: var(--background-secondary, #020517);
  --ribbon-background-collapsed: var(--background-primary, #020517);
  --search-clear-button-color: var(--text-muted, #f8f8f2);
  --search-icon-color: var(--text-muted, #f8f8f2);
  --search-result-background: var(--background-primary, #020517);
  --secondary: var(--text-accent, var(--color-accent-1, #ffb86c));
  --setting-group-heading-color: var(--text-normal, #f8f8f2);
  --setting-items-background: var(--background-primary-alt, #44475a);
  --shiki-active-tab-border-color: var(--shiki-highlight-neutral, #f8f8f2);
  --shiki-code-background: var(--code-background, #1d1c39);
  --shiki-code-comment: var(--text-faint, #bd93f9);
  --shiki-code-keyword: var(--color-pink, #ff22b1);
  --shiki-code-normal: var(--text-muted, #f8f8f2);
  --shiki-code-property: var(--color-cyan, #00ffff);
  --shiki-code-punctuation: var(--text-muted, #f8f8f2);
  --shiki-code-string: var(--color-yellow, #e9e90c);
  --shiki-gutter-text-color: var(--text-faint, #bd93f9);
  --shiki-gutter-text-color-highlight: var(--shiki-code-normal, #f8f8f2);
  --shiki-highlight-neutral: var(--shiki-code-normal, #f8f8f2);
  --shiki-terminal-dots-color: var(--text-faint, #bd93f9);
  --status-bar-background: var(--background-secondary, #020517);
  --status-bar-border-color: var(--divider-color, white);
  --status-bar-text-color: var(--text-muted, #f8f8f2);
  --suggestion-background: var(--background-primary, #020517);
  --sync-avatar-color-3: var(--color-yellow, #e9e90c);
  --sync-avatar-color-5: var(--color-cyan, #00ffff);
  --sync-avatar-color-8: var(--color-pink, #ff22b1);
  --tab-background-active: var(--background-primary, #020517);
  --tab-container-background: var(--background-secondary, #020517);
  --tab-outline-color: var(--divider-color, white);
  --tab-switcher-background: var(--background-secondary, #020517);
  --tab-text-color: var(--text-faint, #bd93f9);
  --tab-text-color-active: var(--text-muted, #f8f8f2);
  --tab-text-color-focused: var(--text-muted, #f8f8f2);
  --tab-text-color-focused-active: var(--text-muted, #f8f8f2);
  --tab-text-color-focused-active-current: var(--text-normal, #f8f8f2);
  --tab-text-color-focused-highlighted: var(--text-accent, #ffb86c);
  --table-drag-handle-color: var(--text-faint, #bd93f9);
  --table-header-color: var(--text-normal, #f8f8f2);
  --tag-color: var(--text-accent, #ffb86c);
  --tag-color-hover: var(--text-accent, #ffb86c);
  --tertiary: var(--text-accent-hover, var(--color-accent-2, #8be9fd));
  --text-accent: var(--color-accent-1, #ffb86c);
  --text-accent-hover: var(--color-accent-2, #8be9fd);
  --text-error: var(--color-red, #ff79c6);
  --text-error-hover: #ff79c6;
  --text-faint: var(--color-base-50, #bd93f9);
  --text-muted: var(--color-base-70, #f8f8f2);
  ...
  --textHighlight: var(--background-modifier-hover, var(--color-user-request, #ffffff13));
  --titlebar-background: var(--background-secondary, #020517);
  --titlebar-background-focused: var(--background-secondary-alt, #282a36);
  --titlebar-text-color: var(--text-muted, #f8f8f2);
...
html body[data-slug] div#quartz-root.page, html .page > div#quartz-body div.sidebar.left, html .page > div#quartz-body div.sidebar.left:has(.explorer), html .page > div#quartz-body div.sidebar.left .explorer .explorer-content {
  --bases-table-header-background: var(--background-secondary, #020517);
  background-color: var(--tab-container-background, rgb(2, 5, 23));
  color: rgb(248, 248, 242);
}

html body[data-slug], html body[data-slug] .page > div#quartz-body, html .page > div#quartz-body div.center, html .page > div#quartz-body footer {
  background-color: var(--background-primary, rgb(2, 5, 23));
  color: rgb(248, 248, 242);
}

html body .page > div#quartz-body div.sidebar {
  background-color: var(--background-secondary, rgb(2, 5, 23));
  color: rgb(248, 248, 242);
}
...
html body .text-highlight {
  background-color: var(--text-highlight-bg, rgba(255, 85, 85, 0.808));
...
html body li.task-list-item input[type="checkbox"]:checked {
  background-color: var(--checkbox-color, rgb(189, 147, 249));
  border-color: rgb(189, 147, 249);
}

html body p {
  color: var(--text-muted, rgb(248, 248, 242));
  font-family: Avenir, "Avenir Next", sans-serif;
  outline: rgb(248, 248, 242) none 0px;
  text-decoration-color: rgb(248, 248, 242);
}`,
    links: `html body a.external-link, html footer a {
  color: var(--link-external-color, rgb(255, 184, 108));
  outline: rgb(255, 184, 108) none 0px;
  text-decoration-color: rgb(255, 184, 108);
}

html body a.internal-link, html .breadcrumb-container .breadcrumb-element > a {
  color: var(--link-color, rgb(255, 184, 108));
  outline: rgb(255, 184, 108) none 0px;
  text-decoration-color: rgb(255, 184, 108);
}

html body a.internal-link.broken {
  color: var(--link-unresolved-color, rgb(255, 184, 108));
  outline: rgb(255, 184, 108) none 0px;
  text-decoration-color: var(--link-unresolved-decoration-color, rgb(255, 184, 108));
}`,
    lists: `html body dd {
...
html body ol > li {
  color: rgb(248, 248, 242);
  margin-bottom: 0px;
  margin-left: 36.2651px;
  margin-right: 0px;
  margin-top: 0px;
  padding-bottom: var(--list-spacing, 1.425px);
  padding-left: 0px;
  padding-right: 0px;
  padding-top: var(--list-spacing, 1.425px);
}
...
html body ul.overflow {
  ...
  color: var(--text-faint, rgb(189, 147, 249));
}

html body blockquote {
  background-color: var(--pre-code, rgb(29, 28, 57));
  color: var(--blockquote-color, rgb(248, 248, 242));
...
html body tr {
  ...
  border-top-width: 0px;
  color: var(--code-block, rgb(139, 233, 253));
  font-family: var(--ec-codeFontFml, "??", "JetBrains Mono", "Fira Code", Menlo, SFMono-Regular, Consolas, "Roboto Mono", monospace, ui-monospace, SFMono-Regular, "Cascadia Mono", "Roboto Mono", "DejaVu Sans Mono", "Liberation Mono", Menlo, Monaco, Consolas, "Source Code Pro", monospace);
  padding-bottom: 6px;
  padding-left: 6px;
  padding-right: 6px;
  padding-top: 6px;
...
html body .search > .search-container > .search-space {
  background-color: var(--prompt-background, rgb(2, 5, 23));
}
...
html body a.internal-link.tag-link, html .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  --pill-color: var(--tag-color, #ffb86c);
  --pill-color-hover: var(--tag-color-hover, #ffb86c);
  --pill-color-remove: var(--tag-color, #ffb86c);
  --pill-color-remove-hover: var(--tag-color-hover, #ffb86c);
  ...
  color: var(--pill-color, rgb(255, 184, 108));
  font-size: 16.625px;
  line-height: var(--line-height-tight, 16.625px);
}
...
html body h1 {
  ...
  border-top-width: 0px;
  color: var(--text-title-h1, rgb(255, 121, 198));
  font-family: var(--font-family-editor, Avenir, "Avenir Next", sans-serif);
  font-size: var(--font-size-h1, 30px);
...
html body h1.article-title {
  ...
  font-size: var(--inline-title-size, 30.742px);
}
...
html body h2 {
  ...
  border-top-color: rgb(189, 147, 249);
  border-top-width: 0px;
  color: var(--text-title-h2, rgb(189, 147, 249));
  font-family: var(--font-family-editor, Avenir, "Avenir Next", sans-serif);
...
html body h2.page-title, html h2.page-title a {
  ...
  line-height: var(--inline-title-line-height, 36.8904px);
...
html body h3 {
  ...
  border-top-width: 0px;
  color: var(--text-title-h3, rgb(255, 85, 85));
  font-family: var(--font-family-editor, Avenir, "Avenir Next", sans-serif);
...
html body h4 {
  ...
  border-top-width: 0px;
  color: var(--text-title-h4, rgb(255, 184, 108));
  font-family: var(--font-family-editor, Avenir, "Avenir Next", sans-serif);
  font-size: var(--font-size-h4, 21px);
  font-weight: var(--font-weight, 500);
  letter-spacing: var(--h4-letter-spacing, -0.105px);
  line-height: var(--h4-line-height, 29.4px);
}
...
html body h5 {
  ...
  border-top-width: 0px;
  color: var(--text-title-h5, rgb(80, 250, 123));
  font-family: var(--font-family-editor, Avenir, "Avenir Next", sans-serif);
...
html body h6 {
  ...
  border-top-color: rgb(139, 233, 253);
  border-top-width: 0px;
  color: var(--text-title-h6, rgb(139, 233, 253));
  font-family: var(--font-family-editor, Avenir, "Avenir Next", sans-serif);
  font-size: var(--font-size-h6, 19px);
  font-weight: var(--font-weight, 500);
  line-height: var(--h6-line-height, 28.5px);
}
...
html body .nav-files-container li:has(> .folder-outer.open) > .nav-folder-title {
  color: var(--nav-item-color, rgb(248, 248, 242));
  font-family: Avenir, "Avenir Next", sans-serif;
}
...
html body .explorer .nav-files-container .folder-outer > ul {
  ...
  border-top-color: rgb(248, 248, 242);
  border-top-width: 0px;
  color: var(--icon-color, rgb(248, 248, 242));
}`,
  ...
  border-top-color: rgb(248, 248, 242);
  border-top-width: 0px;
  color: var(--status-bar-text-color, rgb(248, 248, 242));
  font-family: Avenir, "Avenir Next", sans-serif;
...
html body kbd {
  background-color: var(--code-background, rgb(29, 28, 57));
  border-bottom-color: rgb(248, 248, 242);
  border-bottom-width: 0px;
  border-left-color: rgb(248, 248, 242);
  border-left-width: 0px;
  ...
  font-size: var(--code-size, 16.625px);
