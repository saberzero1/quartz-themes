...
export const theme: ThemeData = {
  ...
  --table-hover-highlight-color: rgb(141, 147, 25 0.15) !important;
  ...
  --tag-background: rgb(141, 147, 25 0.15) !important;
  --tag-background-hover: rgb(141, 147, 25 0.25) !important;
  --tag-border-color: rgb(141, 147, 25 0.15) !important;
  --tag-border-color-hover: rgb(141, 147, 25 0.25) !important;
...
html[saved-theme="dark"] body a.internal-link.tag-link, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  background-color: rgba(0, 0, 0, 0);
  border-bottom-color: rgb(141, 147, 25);
  border-left-color: rgb(141, 147, 25);
  border-right-color: rgb(141, 147, 25);
  border-top-color: rgb(141, 147, 25);
  font-family: "??", inter, sans-serif, "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
}
