...
export const theme: ThemeData = {
  ...
  --bases-table-cell-background-selected: var(--table-selection, hsla(59, 64%, 66%, 0.1));
  ...
  --blockquote-border-color: var(--interactive-accent, hsl(59, 64%, 66%));
  ...
  --checkbox-color: var(--interactive-accent, hsl(59, 64%, 66%));
  --checkbox-color-hover: var(--interactive-accent-hover, #fb464c);
  ...
  --collapse-icon-color-collapsed: var(--color-accent, hsl(59, 64%, 66%));
  --color-accent: hsl(var(--color-yellow-hsl));
  --color-accent-1: var(--color-red, #fb464c);
  --color-accent-1-rgb: var(--color-red-rgb, 251, 70, 76);
  --color-accent-2: hsl(
  ...
  --color-accent-hsl: var(--color-yellow-hsl, 59, 64%, 66%);
  --color-accent-rgb: var(--color-yellow-rgb, 224, 222, 113);
  ...
  --divider-color-hover: var(--interactive-accent, hsl(59, 64%, 66%));
  ...
  --graph-node-focused: var(--color-accent, hsl(59, 64%, 66%));
  --graph-node-tag: var(--color-accent, hsl(59, 64%, 66%));
  ...
  --icon-color-active: var(--color-accent, hsl(59, 64%, 66%));
  ...
  --interactive-accent: var(--color-accent, hsl(59, 64%, 66%));
  --interactive-accent-hover: var(--color-accent-2, #fb464c);
  --interactive-accent-hsl: var(--color-accent-hsl, 59, 64%, 66%);
  ...
  --link-external-color: var(--color-accent, hsl(59, 64%, 66%));
  ...
  --list-marker-color-collapsed: var(--color-accent, hsl(59, 64%, 66%));
  ...
  --pill-color-remove-hover: var(--text-accent, hsl(59, 64%, 66%));
  ...
  --scrollbar-active-thumb-bg: var(--color-accent, hsl(59, 64%, 66%));
  ...
  --secondary: var(--text-accent, var(--color-accent, hsl(59, 64%, 66%)));
  ...
  --tab-text-color-focused-highlighted: var(--color-accent, hsl(59, 64%, 66%));
  ...
  --table-drag-handle-background-active: var(--table-selection-border-color, hsl(59, 64%, 66%));
  ...
  --table-selection-border-color: var(--interactive-accent, hsl(59, 64%, 66%));
  --tag-color: var(--color-accent, hsl(59, 64%, 66%));
  --tag-color-hover: var(--color-accent, hsl(59, 64%, 66%));
  --tertiary: var(--text-accent-hover, var(--color-accent-2, hsl(
        258 calc(88% + 180) 66%
    )));
  --text-accent: var(--color-accent, hsl(59, 64%, 66%));
  ...
  --text-selection: var(--background-modifier-border, hsla(59, 64%, 66%, 0.33));
...
html[saved-theme="dark"] body li.task-list-item input[type="checkbox"]:checked {
  background-color: var(--color-accent, rgb(224, 222, 113));
...
html[saved-theme="dark"] body p {
  ...
  color: var(--link-external-color, rgb(224, 222, 113));
  font-family: "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  outline: rgb(224, 222, 113) none 0px;
  text-decoration: 13%;
...
html[saved-theme="dark"] body a.internal-link, html[saved-theme="dark"] .breadcrumb-container .breadcrumb-element > a {
  background-color: color(srgb 0.8776 0.870347 0.4424 / 0.1);
  color: var(--color-accent, rgb(224, 222, 113));
  font-family: "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
...
html[saved-theme="dark"] body blockquote {
  ...
  color: var(--blockquote-color, rgb(186, 186, 186));
  font-family: "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  line-height: 26.4px;
  padding-bottom: 16px;
  padding-left: 0px;
...
html[saved-theme="dark"] body figure {
  --code-background: var(--ec-frm-edBg, #1b1b1b);
  border-bottom-color: rgb(186, 186, 186);
  border-bottom-width: 0px;
  border-left-color: rgb(186, 186, 186);
  border-left-width: 0px;
...
html[saved-theme="dark"] body .callout-title {
  ...
  --background-modifier-active-hover: hsla(59, 64%, 66%, 0.1);
  ...
  --blockquote-border-color: hsl(59, 64%, 66%);
  ...
  --checkbox-color: hsl(59, 64%, 66%);
  --checkbox-color-hover: #fb464c;
  ...
  --collapse-icon-color-collapsed: hsl(59, 64%, 66%);
  --color-accent: hsl(59, 64%, 66%);
  --color-accent-1: #fb464c;
  --color-accent-1-rgb: 251, 70, 76;
  --color-accent-2: hsl(
        258 calc(88% + 180) 66%
    );
  ...
  --graph-node-focused: hsl(59, 64%, 66%);
  --graph-node-tag: hsl(59, 64%, 66%);
  ...
  --hr-color: #313131;
  --interactive-accent: hsl(59, 64%, 66%);
  --interactive-accent-hover: #fb464c;
  --interactive-accent-hsl: 59, 64%, 66%;
  --interactive-hover: #373737;
  --interactive-normal: #1a1a1a;
  --link-color: #666666;
  --link-color-hover: #bababa;
  --link-external-color: hsl(59, 64%, 66%);
  ...
  --scrollbar-active-thumb-bg: hsl(59, 64%, 66%);
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(59, 64%, 66%);
  ...
  --tab-text-color-focused-highlighted: hsl(59, 64%, 66%);
  ...
  --table-drag-handle-background-active: hsl(59, 64%, 66%);
  ...
  --table-selection: hsla(59, 64%, 66%, 0.1);
  --table-selection-blend-mode: lighten;
  --table-selection-border-color: hsl(59, 64%, 66%);
  --table-text-size: 16px;
  --tag-background: hsla(59, 64%, 66%, 0.1);
  --tag-background-hover: hsla(59, 64%, 66%, 0.2);
  --tag-border-color: hsla(59, 64%, 66%, 0.15);
  --tag-border-color-hover: hsla(59, 64%, 66%, 0.15);
  --tag-color: hsl(59, 64%, 66%);
  --tag-color-hover: hsl(59, 64%, 66%);
  --tag-size: 0.875em;
  --text-accent: hsl(59, 64%, 66%);
  ...
  --text-selection: hsla(59, 64%, 66%, 0.33);
  --text-success: #44cf6e;
  --text-warning: #e9973f;
  --touch-radius-l: 52px;
  --touch-radius-m: 44px;
...
html[saved-theme="dark"] body a.internal-link.tag-link, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  --pill-background: var(--tag-background, hsla(59, 64%, 66%, 0.1));
  --pill-background-hover: var(--tag-background-hover, hsla(59, 64%, 66%, 0.2));
  --pill-border-color: var(--tag-border-color, hsla(59, 64%, 66%, 0.15));
  --pill-border-color-hover: var(--tag-border-color-hover, hsla(59, 64%, 66%, 0.15));
  --pill-color: var(--tag-color, hsl(59, 64%, 66%));
  --pill-color-hover: var(--tag-color-hover, hsl(59, 64%, 66%));
  --pill-color-remove: var(--tag-color, hsl(59, 64%, 66%));
  --pill-color-remove-hover: var(--tag-color-hover, hsl(59, 64%, 66%));
  background-color: var(--pill-background, rgba(0, 0, 0, 0));
  border-bottom-color: color(srgb 0.8776 0.870347 0.4424 / 0.4);
  border-bottom-left-radius: 8px;
  border-bottom-right-radius: 8px;
  border-bottom-width: 1px;
  border-left-color: color(srgb 0.8776 0.870347 0.4424 / 0.4);
  border-left-width: 1px;
  border-right-color: color(srgb 0.8776 0.870347 0.4424 / 0.4);
  border-right-width: 1px;
  border-top-color: color(srgb 0.8776 0.870347 0.4424 / 0.4);
  border-top-left-radius: 8px;
  border-top-right-radius: 8px;
  border-top-width: 1px;
  color: var(--text-normal, rgb(186, 186, 186));
...
html[saved-theme="dark"] body h2::after {
  --font-weight: var(--h2-weight, 600);
  background: rgba(0, 0, 0, 0) linear-gradient(90deg, rgb(224, 222, 113) 0%, color(srgb 0.8776 0.870347 0.4424 / 0.2) 60%, rgba(0, 0, 0, 0) 100%) repeat scroll 0% 0% / auto padding-box border-box;
  background-color: rgba(0, 0, 0, 0);
  background-image: linear-gradient(90deg, rgb(224, 222, 113) 0%, color(srgb 0.8776 0.870347 0.4424 / 0.2) 60%, rgba(0, 0, 0, 0) 100%);
  border-bottom-color: rgb(224, 222, 113);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
  border-bottom-width: 0px;
...
html[saved-theme="dark"] body kbd {
  background-color: var(--code-background, color(srgb 0.8776 0.870347 0.4424 / 0.7));
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  border-bottom-color: color(srgb 0.8776 0.870347 0.4424 / 0.3);
  border-bottom-left-radius: 8px;
  border-bottom-right-radius: 8px;
  border-bottom-width: 1px;
  border-left-color: color(srgb 0.8776 0.870347 0.4424 / 0.3);
  border-left-width: 1px;
  border-right-color: color(srgb 0.8776 0.870347 0.4424 / 0.3);
  border-right-width: 1px;
  border-top-color: color(srgb 0.8776 0.870347 0.4424 / 0.3);
  border-top-left-radius: 8px;
  border-top-right-radius: 8px;
  border-top-width: 1px;
  color: var(--color-accent, rgb(224, 222, 113));
  ...
  --bases-table-cell-background-selected: var(--table-selection, hsla(46, 100%, 44%, 0.1));
  ...
  --blockquote-border-color: var(--interactive-accent, hsl(46, 100%, 44%));
  --bodyFont: var(--font-text-theme, var(--ulu-font-general, "Instrument", sans-serif));
  --callout-blend-mode: var(--highlight-mix-blend-mode, normal);
  ...
  --checkbox-color: var(--interactive-accent, hsl(46, 100%, 44%));
  ...
  --collapse-icon-color-collapsed: var(--color-accent, hsl(46, 100%, 44%));
  --color-accent: hsl(var(--color-yellow-hsl));
  --color-accent-1: var(--color-red, #e93147);
  --color-accent-1-rgb: var(--color-red-rgb, 233, 49, 71);
  --color-accent-2: hsl(
  ...
  --color-accent-hsl: var(--color-yellow-hsl, 46, 100%, 44%);
  --color-accent-rgb: var(--color-yellow-rgb, 224, 172, 0);
  ...
  --divider-color-hover: var(--interactive-accent, hsl(46, 100%, 44%));
  ...
  --graph-node-focused: var(--color-accent, hsl(46, 100%, 44%));
  --graph-node-tag: var(--color-accent, hsl(46, 100%, 44%));
  ...
  --icon-color-active: var(--color-accent, hsl(46, 100%, 44%));
  ...
  --interactive-accent: var(--color-accent, hsl(46, 100%, 44%));
  --interactive-accent-hover: var(--color-accent-2, hsl(
        258 88% 71%
    ));
  --interactive-accent-hsl: var(--color-accent-hsl, 46, 100%, 44%);
  ...
  --link-decoration-hover: none;
  --link-decoration-thickness: 13%;
  --link-external-color: var(--color-accent, hsl(46, 100%, 44%));
  --link-external-color-hover: var(--color-accent-hover, hsl(
        258 88% 71%
    ));
  --link-external-decoration: none;
  ...
  --list-marker-color-collapsed: var(--color-accent, hsl(46, 100%, 44%));
  ...
  --pill-color-remove-hover: var(--text-accent, hsl(46, 100%, 44%));
  ...
  --scrollbar-active-thumb-bg: var(--color-accent, hsl(46, 100%, 44%));
  --scrollbar-bg: rgb(from var(--mono-rgb-100) r g b / 0.1);
  ...
  --secondary: var(--text-accent, var(--color-accent, hsl(46, 100%, 44%)));
  ...
  --tab-text-color-focused-highlighted: var(--color-accent, hsl(46, 100%, 44%));
  ...
  --table-drag-handle-background-active: var(--table-selection-border-color, hsl(46, 100%, 44%));
  ...
  --table-selection-border-color: var(--interactive-accent, hsl(46, 100%, 44%));
  --tag-color: var(--color-accent, hsl(46, 100%, 44%));
  --tag-color-hover: var(--color-accent, hsl(46, 100%, 44%));
  --tertiary: var(--text-accent-hover, var(--color-accent-2, hsl(
        258 88% 71%
    )));
  --text-accent: var(--color-accent, hsl(46, 100%, 44%));
  --text-accent-hover: var(--color-accent-2, hsl(
        258 88% 71%
    ));
...
html[saved-theme="light"] body li.task-list-item input[type="checkbox"]:checked {
  background-color: var(--color-accent, rgb(224, 172, 0));
  border-color: rgba(0, 0, 0, 0);
}
...
html[saved-theme="light"] body p {
  ...
  color: var(--link-external-color, rgb(224, 172, 0));
  font-family: "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  outline: rgb(224, 172, 0) none 0px;
  text-decoration: 13%;
...
html[saved-theme="light"] body a.internal-link, html[saved-theme="light"] .breadcrumb-container .breadcrumb-element > a {
  background-color: color(srgb 0.88 0.674666 0 / 0.1);
  color: var(--color-accent, rgb(224, 172, 0));
  font-family: "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  font-weight: var(--link-weight, 500);
  outline: rgb(224, 172, 0) none 0px;
  text-decoration-color: rgb(224, 172, 0);
...
html[saved-theme="light"] body blockquote {
  background-color: rgb(from var(--color-base-00) r g b/0.3);
  color: var(--blockquote-color, rgb(90, 90, 90));
  font-family: "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  line-height: 26.4px;
  padding-bottom: 16px;
  padding-left: 0px;
...
html[saved-theme="light"] body figure {
  --code-background: var(--ec-frm-edBg, #ededed);
  border-bottom-color: rgb(90, 90, 90);
  border-bottom-width: 0px;
  border-left-color: rgb(90, 90, 90);
  border-left-width: 0px;
...
html[saved-theme="light"] body .callout-title {
  ...
  --background-modifier-active-hover: hsla(46, 100%, 44%, 0.1);
  ...
  --blockquote-border-color: hsl(46, 100%, 44%);
  ...
  --collapse-icon-color-collapsed: hsl(46, 100%, 44%);
  --color-accent: hsl(46, 100%, 44%);
  --color-accent-1: #e93147;
  --color-accent-1-rgb: 233, 49, 71;
  --color-accent-2: hsl(
        258 88% 71%
    );
  --color-accent-hover: hsl(
  ...
  --graph-node-focused: hsl(46, 100%, 44%);
  --graph-node-tag: hsl(46, 100%, 44%);
  ...
  --heading-spacing: 2.5rem;
  --hr-color: #c7c7c7;
  --interactive-accent: hsl(46, 100%, 44%);
  ...
  --link-external-color: hsl(46, 100%, 44%);
  --link-external-color-hover: hsl(
        258 88% 71%
    );
  ...
  --raised-blur: blur(6px) saturate(1.5) brightness(1.15);
  --scrollbar-active-thumb-bg: hsl(46, 100%, 44%);
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(46, 100%, 44%);
  ...
  --tab-text-color-focused-highlighted: hsl(46, 100%, 44%);
  ...
  --table-column-first-border-width: 1px;
  --table-column-last-border-width: 1px;
  --table-drag-handle-background-active: hsl(46, 100%, 44%);
  ...
  --table-row-background-hover: transparent;
  --table-row-last-border-width: 1px;
  --table-selection: hsla(46, 100%, 44%, 0.1);
  --table-selection-blend-mode: darken;
  --table-selection-border-color: hsl(46, 100%, 44%);
  --table-text-size: 16px;
  --tag-background: hsla(46, 100%, 44%, 0.1);
  --tag-background-hover: hsla(46, 100%, 44%, 0.2);
  --tag-border-color: hsla(46, 100%, 44%, 0.15);
  --tag-border-color-hover: hsla(46, 100%, 44%, 0.15);
  --tag-color: hsl(46, 100%, 44%);
  --tag-color-hover: hsl(46, 100%, 44%);
  --tag-size: 0.875em;
  --text-accent: hsl(46, 100%, 44%);
  --text-accent-hover: hsl(
        258 88% 71%
    );
  --text-error: #e93147;
...
html[saved-theme="light"] body a.internal-link.tag-link, html[saved-theme="light"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  --pill-background: var(--tag-background, hsla(46, 100%, 44%, 0.1));
  --pill-background-hover: var(--tag-background-hover, hsla(46, 100%, 44%, 0.2));
  --pill-border-color: var(--tag-border-color, hsla(46, 100%, 44%, 0.15));
  --pill-border-color-hover: var(--tag-border-color-hover, hsla(46, 100%, 44%, 0.15));
  --pill-color: var(--tag-color, hsl(46, 100%, 44%));
  --pill-color-hover: var(--tag-color-hover, hsl(46, 100%, 44%));
  --pill-color-remove: var(--tag-color, hsl(46, 100%, 44%));
  --pill-color-remove-hover: var(--tag-color-hover, hsl(46, 100%, 44%));
  background-color: var(--pill-background, rgba(0, 0, 0, 0));
  border-bottom-color: color(srgb 0.88 0.674666 0 / 0.4);
  border-bottom-left-radius: 8px;
  border-bottom-right-radius: 8px;
  border-bottom-width: 1px;
  border-left-color: color(srgb 0.88 0.674666 0 / 0.4);
  border-left-width: 1px;
  border-right-color: color(srgb 0.88 0.674666 0 / 0.4);
  border-right-width: 1px;
  border-top-color: color(srgb 0.88 0.674666 0 / 0.4);
  border-top-left-radius: 8px;
  border-top-right-radius: 8px;
  border-top-width: 1px;
  color: var(--text-normal, rgb(90, 90, 90));
...
html[saved-theme="light"] body h2::after {
  --font-weight: var(--h2-weight, 600);
  background: rgba(0, 0, 0, 0) linear-gradient(90deg, rgb(224, 172, 0) 0%, color(srgb 0.88 0.674666 0 / 0.2) 60%, rgba(0, 0, 0, 0) 100%) repeat scroll 0% 0% / auto padding-box border-box;
  background-color: rgba(0, 0, 0, 0);
  background-image: linear-gradient(90deg, rgb(224, 172, 0) 0%, color(srgb 0.88 0.674666 0 / 0.2) 60%, rgba(0, 0, 0, 0) 100%);
  border-bottom-color: rgb(224, 172, 0);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
  border-bottom-width: 0px;
...
html[saved-theme="light"] body kbd {
  background-color: var(--code-background, color(srgb 0.88 0.674666 0 / 0.7));
  border-bottom-color: rgb(255, 255, 255);
  border-bottom-width: 0px;
  border-left-color: rgb(255, 255, 255);
  border-left-width: 0px;
...
html[saved-theme="light"] body ul.tags > li {
  background-color: rgb(from var(--color-accent) r g b/0.05);
  border-bottom-color: color(srgb 0.88 0.674666 0 / 0.3);
  border-bottom-left-radius: 8px;
  border-bottom-right-radius: 8px;
  border-bottom-width: 1px;
  border-left-color: color(srgb 0.88 0.674666 0 / 0.3);
  border-left-width: 1px;
  border-right-color: color(srgb 0.88 0.674666 0 / 0.3);
  border-right-width: 1px;
  border-top-color: color(srgb 0.88 0.674666 0 / 0.3);
  border-top-left-radius: 8px;
  border-top-right-radius: 8px;
  border-top-width: 1px;
  color: var(--color-accent, rgb(224, 172, 0));
