...
export const theme: ThemeData = {
  ...
  --background-modifier-active-hover: hsla(59, 64%, 66%, 0.1) !important;
  ...
  --bases-table-cell-background-selected: hsla(59, 64%, 66%, 0.1) !important;
  --bases-table-cell-shadow-active: 0 0 0 2px #414141 !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(59, 64%, 66%) !important;
  ...
  --blockquote-border-color: hsl(59, 64%, 66%) !important;
  ...
  --checkbox-color: hsl(59, 64%, 66%) !important;
  --checkbox-color-hover: #fb464c !important;
  ...
  --collapse-icon-color-collapsed: hsl(59, 64%, 66%) !important;
  --color-accent: hsl(59, 64%, 66%) !important;
  --color-accent-1: #fb464c !important;
  --color-accent-1-rgb: 251, 70, 76 !important;
  --color-accent-2: hsl(
        258 calc(88% + 180) 66%
    ) !important;
  ...
  --color-accent-hsl: 59, 64%, 66% !important;
  --color-accent-rgb: 224, 222, 113 !important;
  ...
  --divider-color-hover: hsl(59, 64%, 66%) !important;
  ...
  --embed-border-start: 2px solid hsl(59, 64%, 66%) !important;
  ...
  --graph-node-focused: hsl(59, 64%, 66%) !important;
  --graph-node-tag: hsl(59, 64%, 66%) !important;
  ...
  --icon-color-active: hsl(59, 64%, 66%) !important;
  ...
  --interactive-accent: hsl(59, 64%, 66%) !important;
  --interactive-accent-hover: #fb464c !important;
  --interactive-accent-hsl: 59, 64%, 66% !important;
  ...
  --link-external-color: hsl(59, 64%, 66%) !important;
  ...
  --list-marker-color-collapsed: hsl(59, 64%, 66%) !important;
  ...
  --nav-item-background-selected: hsla(59, 64%, 66%, 0.15) !important;
  ...
  --pill-color-remove-hover: hsl(59, 64%, 66%) !important;
  ...
  --scrollbar-active-thumb-bg: hsl(59, 64%, 66%) !important;
  ...
  --secondary: hsl(59, 64%, 66%) !important;
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(59, 64%, 66%) !important;
  ...
  --tab-text-color-focused-highlighted: hsl(59, 64%, 66%) !important;
  --table-add-button-border-color: #313131 !important;
  --table-border-color: #313131 !important;
  --table-drag-handle-background-active: hsl(59, 64%, 66%) !important;
  --table-drag-handle-color: #999999 !important;
  --table-header-border-color: #313131 !important;
  --table-header-color: #bababa !important;
  --table-selection: hsla(59, 64%, 66%, 0.1) !important;
  --table-selection-border-color: hsl(59, 64%, 66%) !important;
  --tag-background: hsla(59, 64%, 66%, 0.1) !important;
  --tag-background-hover: hsla(59, 64%, 66%, 0.2) !important;
  --tag-border-color: hsla(59, 64%, 66%, 0.15) !important;
  --tag-border-color-hover: hsla(59, 64%, 66%, 0.15) !important;
  --tag-color: hsl(59, 64%, 66%) !important;
  --tag-color-hover: hsl(59, 64%, 66%) !important;
  --tertiary: hsl(
        258 calc(88% + 180) 66%
    ) !important;
  --text-accent: hsl(59, 64%, 66%) !important;
  ...
  --text-selection: hsla(59, 64%, 66%, 0.33) !important;
...
html[saved-theme="dark"] body kbd {
  background-color: color(srgb 0.8776 0.870347 0.4424 / 0.7);
...
html[saved-theme="dark"] body ul.tags > li {
  background-color: color(srgb 0.8776 0.870347 0.4424 / 0.05);
  ...
  --background-modifier-active-hover: hsla(46, 100%, 44%, 0.1) !important;
  ...
  --bases-table-cell-background-selected: hsla(46, 100%, 44%, 0.1) !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(46, 100%, 44%) !important;
  ...
  --blockquote-border-color: hsl(46, 100%, 44%) !important;
  ...
  --checkbox-color: hsl(46, 100%, 44%) !important;
  ...
  --collapse-icon-color-collapsed: hsl(46, 100%, 44%) !important;
  --color-accent: hsl(46, 100%, 44%) !important;
  --color-accent-1: #e93147 !important;
  --color-accent-1-rgb: 233, 49, 71 !important;
  --color-accent-2: hsl(
        258 88% 71%
    ) !important;
  --color-accent-hover: hsl(
  ...
  --color-accent-hsl: 46, 100%, 44% !important;
  --color-accent-rgb: 224, 172, 0 !important;
  ...
  --divider-color-hover: hsl(46, 100%, 44%) !important;
  ...
  --embed-border-start: 2px solid hsl(46, 100%, 44%) !important;
  ...
  --graph-node-focused: hsl(46, 100%, 44%) !important;
  --graph-node-tag: hsl(46, 100%, 44%) !important;
  ...
  --icon-color-active: hsl(46, 100%, 44%) !important;
  ...
  --interactive-accent: hsl(46, 100%, 44%) !important;
  ...
  --link-decoration-hover: none !important;
  --link-decoration-thickness: 13% !important;
  --link-external-color: hsl(46, 100%, 44%) !important;
  --link-external-color-hover: hsl(
        258 88% 71%
    ) !important;
  --link-external-decoration: none !important;
  ...
  --list-marker-color-collapsed: hsl(46, 100%, 44%) !important;
  ...
  --nav-item-background-selected: hsla(46, 100%, 44%, 0.15) !important;
  ...
  --pill-color-remove-hover: hsl(46, 100%, 44%) !important;
  ...
  --scrollbar-active-thumb-bg: hsl(46, 100%, 44%) !important;
  ...
  --secondary: hsl(46, 100%, 44%) !important;
  ...
  --shiki-active-tab-border-color: #ababab !important;
  --shiki-code-background: #ededed !important;
  --shiki-code-comment: #707070 !important;
  --shiki-code-keyword: #f5a9b8 !important;
  --shiki-code-normal: #ababab !important;
  --shiki-code-punctuation: #ababab !important;
  --shiki-gutter-border-color: #c7c7c7 !important;
  --shiki-gutter-text-color: #707070 !important;
  --shiki-gutter-text-color-highlight: #ababab !important;
  --shiki-highlight-neutral: #ababab !important;
  --shiki-highlight-neutral-background: rgba(#000000, .05) !important;
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(46, 100%, 44%) !important;
  ...
  --tab-text-color-focused-highlighted: hsl(46, 100%, 44%) !important;
  --table-add-button-border-color: #c7c7c7 !important;
  --table-border-color: #c7c7c7 !important;
  --table-drag-handle-background-active: hsl(46, 100%, 44%) !important;
  --table-drag-handle-color: #707070 !important;
  --table-header-border-color: #c7c7c7 !important;
  --table-header-color: #5a5a5a !important;
  --table-selection: hsla(46, 100%, 44%, 0.1) !important;
  --table-selection-border-color: hsl(46, 100%, 44%) !important;
  --tag-background: hsla(46, 100%, 44%, 0.1) !important;
  --tag-background-hover: hsla(46, 100%, 44%, 0.2) !important;
  --tag-border-color: hsla(46, 100%, 44%, 0.15) !important;
  --tag-border-color-hover: hsla(46, 100%, 44%, 0.15) !important;
  --tag-color: hsl(46, 100%, 44%) !important;
  --tag-color-hover: hsl(46, 100%, 44%) !important;
  --tertiary: hsl(
        258 88% 71%
    ) !important;
  --text-accent: hsl(46, 100%, 44%) !important;
  --text-accent-hover: hsl(
        258 88% 71%
    ) !important;
...
html[saved-theme="light"] body kbd {
  background-color: color(srgb 0.88 0.674666 0 / 0.7);
  border-bottom-color: rgb(255, 255, 255);
  border-left-color: rgb(255, 255, 255);
  border-right-color: rgb(255, 255, 255);
  border-top-color: rgb(255, 255, 255);
...
html[saved-theme="light"] body ul.tags > li {
  background-color: color(srgb 0.88 0.674666 0 / 0.05);
