...
export const theme: ThemeData = {
  ...
  --banner-image-radius: 8px !important;
  ...
  --input-shadow: inset 0 0 0 1px #363636 !important;
  ...
  --prompt-border-color: #363636 !important;
  ...
  --shiki-code-function: rgb(72, 196, 90) !important;
  --shiki-code-important: rgb(219, 134, 80) !important;
  --shiki-code-keyword: rgb(222, 103, 147) !important;
  --shiki-code-property: rgb(63, 186, 182) !important;
  --shiki-code-string: rgb(196, 180, 94) !important;
  --shiki-code-value: rgb(142, 125, 194) !important;
  --shiki-highlight-green: rgba(72, 196, 90, 0.5) !important;
  --shiki-highlight-green-background: rgba(72, 196, 90, 0.1) !important;
  --shiki-highlight-red: rgba(217, 90, 95, 0.5) !important;
  --shiki-highlight-red-background: rgba(217, 90, 95, 0.1) !important;
  ...
  --tertiary: rgb(from #dadada r g b / 80%) !important;
...
html[saved-theme="dark"] body li.task-list-item[data-task="Z"] input[type="checkbox"]::after {
  ...
  color: rgb(86, 148, 218);
  gap: 8px;
}

html[saved-theme="dark"] body .callout .callout-title > .callout-title-inner > p {
  color: color(srgb 0.414902 0.621569 0.854902);
  font-weight: 700;
}
...
html[saved-theme="dark"] body .callout[data-callout="banner-icon"] {
  ...
  --callout-color: 86, 148, 218;
  --table-border-color: color-mix(in srgb, rgb(86, 148, 218) 25%, #1e1e1e 50%);
...
html[saved-theme="dark"] body .breadcrumb-element p {
  ...
  box-shadow: rgb(54, 54, 54) 0px 0px 0px 1px inset;
}`,
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --list-spacing: 0.175em !important;
  --media-radius: 8px !important;
  --menu-border-color: #e0e0e0 !important;
  --menu-corner-shape: superellipse(1.1) !important;
  --menu-padding: 4px !important;
  --menu-radius: 12px !important;
  --menu-shadow: rgba(0, 0, 0, 0.08) 0px 12px 24px -4px, rgba(0, 0, 0, 0.04) 0px 8px 16px -4px !important;
  ...
  --modal-border-color: #e0e0e0 !important;
  --modal-radius: 20px !important;
  --nav-indentation-guide-width: 0px !important;
  --nav-item-children-margin-start: 20px !important;
  --nav-item-padding: 8px 16px 8px 32px !important;
  ...
  --p-spacing: 1.75rem !important;
  --prompt-border-color: #e0e0e0 !important;
  --prompt-input-height: 64px !important;
  --radius-l: 20px !important;
  --radius-m: 12px !important;
  --radius-modifier: 1 !important;
  ...
  --shiki-code-block-border-radius: 8px !important;
  --shiki-code-block-spacing: 1.75rem !important;
  --shiki-code-function: rgb(74, 213, 95) !important;
  --shiki-code-important: rgb(242, 154, 100) !important;
  --shiki-code-keyword: rgb(243, 125, 183) !important;
  --shiki-code-property: rgb(56, 219, 214) !important;
  --shiki-code-string: rgb(224, 205, 99) !important;
  --shiki-code-value: rgb(187, 158, 245) !important;
  --shiki-highlight-green: rgba(74, 213, 95, 0.5) !important;
  --shiki-highlight-green-background: rgba(74, 213, 95, 0.1) !important;
  --shiki-highlight-red: rgba(254, 112, 112, 0.5) !important;
  --shiki-highlight-red-background: rgba(254, 112, 112, 0.1) !important;
  --status-bar-font-size: 12px !important;
  --status-bar-radius: 12px 0 0 0 !important;
  ...
  --tag-radius: 8px !important;
  --tag-weight: 500 !important;
  --tertiary: rgb(from #222222 r g b / 80%) !important;
...
html[saved-theme="light"] body li.task-list-item[data-task="Z"] input[type="checkbox"]::after {
  ...
  color: rgb(106, 173, 250);
  gap: 8px;
}

html[saved-theme="light"] body .callout .callout-title > .callout-title-inner > p {
  color: color(srgb 0.373333 0.596667 0.853333);
  font-weight: 700;
}
...
html[saved-theme="light"] body .callout[data-callout="banner-icon"] {
  ...
  --banner-image-height: 0px;
  --callout-color: 106, 173, 250;
  --table-border-color: color-mix(in srgb, rgb(106, 173, 250) 25%, #ffffff 50%);
