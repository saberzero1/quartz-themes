...
export const theme: ThemeData = {
  ...
  --shiki-active-tab-border-color: hsl(240, 10%, 72%) !important;
  --shiki-code-background: hsl(340, 10%, 18%) !important;
  --shiki-code-block-spacing: 0rem !important;
  --shiki-code-comment: hsl(240, 10%, 72%) !important;
  --shiki-code-normal: hsl(240, 10%, 72%) !important;
  --shiki-code-punctuation: hsl(240, 10%, 72%) !important;
  --shiki-gutter-text-color: hsl(240, 10%, 72%) !important;
  --shiki-gutter-text-color-highlight: hsl(240, 10%, 72%) !important;
  --shiki-highlight-neutral: hsl(240, 10%, 72%) !important;
  --shiki-terminal-dots-color: hsl(240, 10%, 72%) !important;
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --shadow-s: none !important;
  --shadow-xs: none !important;
  --shiki-active-tab-border-color: hsl(340, 10%, 24%) !important;
  --shiki-code-background: hsl(240, 10%, 84%) !important;
  --shiki-code-block-spacing: 0rem !important;
  --shiki-code-comment: hsl(340, 10%, 24%) !important;
  --shiki-code-normal: hsl(340, 10%, 24%) !important;
  --shiki-code-punctuation: hsl(340, 10%, 24%) !important;
  --shiki-gutter-text-color: hsl(340, 10%, 24%) !important;
  --shiki-gutter-text-color-highlight: hsl(340, 10%, 24%) !important;
  --shiki-highlight-neutral: hsl(340, 10%, 24%) !important;
  --shiki-terminal-dots-color: hsl(340, 10%, 24%) !important;
  --slider-thumb-y: -7px !important;
