...
export const theme: ThemeData = {
  ...
  --shiki-gutter-border-color: #423c39 !important;
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --shiki-active-tab-border-color: #504945 !important;
  --shiki-code-background: #e4d7ae !important;
