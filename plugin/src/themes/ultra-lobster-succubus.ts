...
export const theme: ThemeData = {
  ...
  --ancestor-editor-color: #e0e1dd !important;
  --background-modifier-active-hover: hsla(208.9, 96.6%, 76.9%, 0.1) !important;
  --background-modifier-border: #28264d !important;
  --background-modifier-border-alt: #33305c !important;
  --background-modifier-border-focus: #8405ec !important;
  --background-modifier-border-hover: #c78cd9 !important;
  ...
  --background-modifier-form-field: #33305c !important;
  --background-modifier-form-field-hover: #33305c !important;
  ...
  --background-primary: #2a2754 !important;
  --background-primary-alt: #222047 !important;
  --background-secondary: #222047 !important;
  --background-secondary-alt: #28264d !important;
  --bases-cards-background: #2a2754 !important;
  --bases-cards-cover-background: #222047 !important;
  --bases-cards-shadow: 0 0 0 1px #28264d !important;
  --bases-cards-shadow-hover: 0 0 0 1px #c78cd9 !important;
  --bases-embed-border-color: #28264d !important;
  --bases-group-heading-property-color: #b4acc3 !important;
  --bases-table-border-color: #28264d !important;
  --bases-table-cell-background-active: #2a2754 !important;
  --bases-table-cell-background-disabled: #222047 !important;
  --bases-table-cell-background-selected: hsla(208.9, 96.6%, 76.9%, 0.1) !important;
  --bases-table-cell-shadow-active: 0 0 0 2px #8405ec !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(208.9, 96.6%, 76.9%) !important;
  --bases-table-group-background: #222047 !important;
  --bases-table-header-background: #2a2754 !important;
  --bases-table-header-background-hover: rgba(#ffffff, 0.067) !important;
  --bases-table-header-color: #b4acc3 !important;
  --bases-table-summary-background: #2a2754 !important;
  --bases-table-summary-background-hover: rgba(#ffffff, 0.067) !important;
  --blockquote-border-color: hsl(208.9, 96.6%, 76.9%) !important;
  --blur-background: color-mix(in srgb, #222047 65%, transparent) linear-gradient(#222047, color-mix(in srgb, #222047 65%, transparent)) !important;
  ...
  --canvas-background: #2a2754 !important;
  --canvas-card-label-color: #ff9b54 !important;
  --canvas-color: #28264d !important;
  ...
  --canvas-dot-pattern: #28264d !important;
  --caret-color: #e0e1dd !important;
  --checkbox-border-color: #ff9b54 !important;
  --checkbox-border-color-hover: #b4acc3 !important;
  --checkbox-color: hsl(208.9, 96.6%, 76.9%) !important;
  --checkbox-color-hover: #ff79c6 !important;
  --checkbox-marker-color: #2a2754 !important;
  --checklist-done-color: #b4acc3 !important;
  --code-background: #222047 !important;
  --code-border-color: #28264d !important;
  --code-bracket-background: rgba(#ffffff, 0.067) !important;
  --code-comment: #ff9b54 !important;
  --code-function: #f1fa8c !important;
  --code-important: #ffb86c !important;
  --code-keyword: #ff79c6 !important;
  --code-normal: #e0e1dd !important;
  --code-operator: #ff5555 !important;
  --code-property: #8be9fd !important;
  --code-punctuation: #b4acc3 !important;
  --code-string: #50fa7b !important;
  --code-tag: #ff5555 !important;
  --code-value: #bd93f9 !important;
  --codeFont: "Monaspace", monospace !important;
  --collapse-icon-color: #ff9b54 !important;
  ...
  --color-base-00: #2a2754 !important;
  --color-base-10: #222047 !important;
  --color-base-100: #ffffff !important;
  --color-base-20: #222047 !important;
  --color-base-25: #33305c !important;
  --color-base-30: #28264d !important;
  --color-base-35: #c78cd9 !important;
  --color-base-40: #8405ec !important;
  --color-base-50: #b4acc3 !important;
  --color-base-60: #ff9b54 !important;
  --color-base-70: #e0e1dd !important;
  ...
  --dark: #e0e1dd !important;
  --darkgray: #e0e1dd !important;
  --divider-color: #28264d !important;
  --divider-color-hover: hsl(208.9, 96.6%, 76.9%) !important;
  --dropdown-background: #222047 !important;
  --dropdown-background-hover: #c78cd9 !important;
  --embed-block-shadow-hover: 0 0 0 1px #28264d, inset 0 0 0 1px #28264d !important;
  --embed-border-start: 2px solid hsl(208.9, 96.6%, 76.9%) !important;
  --file-header-background: #2a2754 !important;
  --file-header-background-focused: #2a2754 !important;
  ...
  --flair-background: #222047 !important;
  --flair-color: #e0e1dd !important;
  ...
  --footnote-divider-color: #28264d !important;
  --footnote-id-color: #b4acc3 !important;
  --footnote-id-color-no-occurrences: #ff9b54 !important;
  --footnote-input-background-active: rgba(#ffffff, 0.067) !important;
  --footnote-line-height: 1.65 !important;
  --glass-border-dark: #33305c !important;
  --glass-border-light: #e0e1dd !important;
  ...
  --graph-node-unresolved: #ff9b54 !important;
  --graph-text: #e0e1dd !important;
  --gray: #b4acc3 !important;
  ...
  --heading-formatting: #ff9b54 !important;
  --highlight: rgba(#ffffff, 0.067) !important;
  --hr-color: #28264d !important;
  --icon-color: #b4acc3 !important;
  --icon-color-active: hsl(208.9, 96.6%, 76.9%) !important;
  --icon-color-focused: #e0e1dd !important;
  --icon-color-hover: #b4acc3 !important;
  ...
  --input-date-separator: #ff9b54 !important;
  --input-placeholder-color: #ff9b54 !important;
  --interactive-accent: hsl(208.9, 96.6%, 76.9%) !important;
  --interactive-accent-hover: #ff79c6 !important;
  --interactive-accent-hsl: 208.9, 96.6%, 76.9% !important;
  --interactive-hover: #c78cd9 !important;
  --interactive-normal: #222047 !important;
  --lbs: 0px 20px 30px rgba(0, 0, 5, 0.15) !important;
  --light: #2a2754 !important;
  --lightgray: #222047 !important;
  --line-height-normal: 1.65 !important;
  --link-color: #b4acc3 !important;
  --link-color-hover: #e0e1dd !important;
  ...
  --link-unresolved-color: #b4acc3 !important;
  --link-unresolved-decoration-color: transparent !important;
  --list-marker-color: #ff9b54 !important;
  --list-marker-color-collapsed: hsl(208.9, 96.6%, 76.9%) !important;
  --list-marker-color-hover: #b4acc3 !important;
  --menu-background: #222047 !important;
  --menu-border-color: #c78cd9 !important;
  --menu-shadow: 0px 1px 4px rgba(0, 0, 0, 0.16) !important;
  --metadata-border-color: #28264d !important;
  --metadata-divider-color: #28264d !important;
  ...
  --metadata-input-text-color: #e0e1dd !important;
  ...
  --metadata-label-text-color: #b4acc3 !important;
  --metadata-label-text-color-hover: #b4acc3 !important;
  --metadata-property-background-active: rgba(#ffffff, 0.067) !important;
  --metadata-property-box-shadow-focus: 0 0 0 2px #8405ec !important;
  --metadata-property-box-shadow-hover: 0 0 0 1px #c78cd9 !important;
  --modal-background: #2a2754 !important;
  --modal-border-color: #8405ec !important;
  --mono-rgb-0: #0d0d29 !important;
  --mono-rgb-100: #ffffff !important;
  --nav-collapse-icon-color: #ff9b54 !important;
  --nav-collapse-icon-color-collapsed: #ff9b54 !important;
  --nav-heading-color: #e0e1dd !important;
  --nav-heading-color-collapsed: #ff9b54 !important;
  --nav-heading-color-collapsed-hover: #b4acc3 !important;
  --nav-heading-color-hover: #e0e1dd !important;
  ...
  --nav-item-color: #b4acc3 !important;
  --nav-item-color-active: #e0e1dd !important;
  --nav-item-color-highlighted: hsl(
        1 calc(71.2% + 180) 52.4%
    ) !important;
  --nav-item-color-hover: #e0e1dd !important;
  --nav-item-color-selected: #e0e1dd !important;
  --nav-tag-color: #ff9b54 !important;
  --nav-tag-color-active: #b4acc3 !important;
  --nav-tag-color-hover: #b4acc3 !important;
  --pdf-background: #2a2754 !important;
  --pdf-page-background: #2a2754 !important;
  --pdf-shadow: 0 0 0 1px #28264d !important;
  --pdf-sidebar-background: #2a2754 !important;
  --pdf-thumbnail-shadow: 0 0 0 1px #28264d !important;
  --pill-border-color: #28264d !important;
  --pill-border-color-hover: #c78cd9 !important;
  --pill-color: #b4acc3 !important;
  --pill-color-hover: #e0e1dd !important;
  --pill-color-remove: #ff9b54 !important;
  --pill-color-remove-hover: hsl(208.9, 96.6%, 76.9%) !important;
  --prompt-background: #2a2754 !important;
  --prompt-border-color: #8405ec !important;
  --proxy-00: #2a2754 !important;
  --proxy-10: #222047 !important;
  --proxy-20: #222047 !important;
  --radius-xl: 24px !important;
  --raised-background: color-mix(in srgb, #222047 65%, transparent) linear-gradient(#222047, color-mix(in srgb, #222047 65%, transparent)) !important;
  --ribbon-background: #222047 !important;
  --ribbon-background-collapsed: #2a2754 !important;
  ...
  --search-clear-button-color: #b4acc3 !important;
  --search-icon-color: #b4acc3 !important;
  --search-result-background: #2a2754 !important;
  --secondary: hsl(208.9, 96.6%, 76.9%) !important;
  --setting-group-heading-color: #e0e1dd !important;
  --setting-items-background: #222047 !important;
  --setting-items-border-color: #28264d !important;
  ...
  --shiki-active-tab-border-color: #b4acc3 !important;
  --shiki-code-background: #222047 !important;
  --shiki-code-comment: #ff9b54 !important;
  --shiki-code-function: #50fa7b !important;
  --shiki-code-important: #ffb86c !important;
  --shiki-code-keyword: #ff79c6 !important;
  --shiki-code-normal: #b4acc3 !important;
  --shiki-code-property: #8be9fd !important;
  --shiki-code-punctuation: #b4acc3 !important;
  --shiki-code-string: #f1fa8c !important;
  --shiki-code-value: #bd93f9 !important;
  --shiki-gutter-border-color: #28264d !important;
  --shiki-gutter-text-color: #ff9b54 !important;
  --shiki-gutter-text-color-highlight: #b4acc3 !important;
  --shiki-highlight-green: rgba(80, 250, 123, 0.5) !important;
  --shiki-highlight-green-background: rgba(80, 250, 123, 0.1) !important;
  --shiki-highlight-neutral: #b4acc3 !important;
  ...
  --shiki-terminal-dots-color: #ff9b54 !important;
  --slider-thumb-border-color: #c78cd9 !important;
  --slider-track-background: #28264d !important;
  --status-bar-background: #222047 !important;
  --status-bar-border-color: #28264d !important;
  --status-bar-text-color: #b4acc3 !important;
  --suggestion-background: #2a2754 !important;
  ...
  --tab-background-active: #2a2754 !important;
  --tab-container-background: #222047 !important;
  --tab-divider-color: #c78cd9 !important;
  --tab-outline-color: #28264d !important;
  --tab-switcher-background: #222047 !important;
  --tab-switcher-menubar-background: linear-gradient(to top, #222047, transparent) !important;
  ...
  --tab-text-color: #ff9b54 !important;
  --tab-text-color-active: #b4acc3 !important;
  --tab-text-color-focused: #b4acc3 !important;
  --tab-text-color-focused-active: #b4acc3 !important;
  --tab-text-color-focused-active-current: #e0e1dd !important;
  --tab-text-color-focused-highlighted: hsl(208.9, 96.6%, 76.9%) !important;
  --table-add-button-border-color: #28264d !important;
  --table-border-color: #28264d !important;
  --table-drag-handle-background-active: hsl(208.9, 96.6%, 76.9%) !important;
  --table-drag-handle-color: #ff9b54 !important;
  --table-header-border-color: #28264d !important;
  --table-header-color: #e0e1dd !important;
  ...
  --text-faint: #ff9b54 !important;
  --text-highlight-bg-active: rgba(255, 128, 0, 0.4) !important;
  --text-muted: #b4acc3 !important;
  --text-normal: #e0e1dd !important;
  ...
  --titlebar-border-color: #28264d !important;
  --titlebar-text-color: #b4acc3 !important;
  --titlebar-text-color-focused: #e0e1dd !important;
  ...
  --vault-profile-color: #e0e1dd !important;
  --vault-profile-color-hover: #e0e1dd !important;
  --view-bottom-fade-mask: none !important;
  --workspace-background-translucent: rgba(#0d0d29, 0.6) !important;
...
html body blockquote {
  background-color: color(srgb 0.164706 0.152941 0.329412 / 0.3);
  font-family: "??", Instrument, sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  padding-bottom: 16px;
  padding-top: 16px;
}`,
...
html body video {
  ...
  background-color: color(srgb 0.2 0.188235 0.360784 / 0.6);
...
html body .search > .search-container > .search-space {
  ...
  box-shadow: color(srgb 0.0509804 0.0509804 0.160784 / 0.6) 0px 40px 80px -20px, color(srgb 1 1 1 / 0.1) 0px 1px 0px 0px inset;
}
...
html body .search > .search-container > .search-space > .search-layout > .results-container > .result-card:hover, html .search > .search-container > .search-space > .search-layout > .results-container > .result-card:focus, html .search > .search-container > .search-space > .search-layout > .results-container > .result-card.focus:not(:has(~ .result-card:hover, html ~ .result-card:focus)) {
  background-color: rgb(199, 140, 217);
  color: rgb(224, 225, 221);
}
