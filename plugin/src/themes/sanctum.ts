...
export const theme: ThemeData = {
  ...
  --background-modifier-border-focus: hsl(199.5, 38.8%, 40.4%);
  --background-modifier-border-hover: rgb(58, 56, 56);
  --background-modifier-cover: rgba(142, 140, 139, 0.16);
  --background-modifier-error: hsl(9.6, 66.2%, 46.5%);
  --background-modifier-error-hover: hsl(9.6, 66.2%, 46.5%);
  ...
  --background-modifier-success: hsl(114.6, 22.4%, 49%);
  ...
  --bases-table-cell-background-selected: hsla(24.4, 90.8%, 61.8%, 0.1);
  --bases-table-cell-shadow-active: 0 0 0 2px hsl(199.5, 38.8%, 40.4%);
  ...
  --bodyFont: var(--font-text, Inter,sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  --bold-weight: 600;
  ...
  --button-radius: 4px;
  --calendar-dot: hsl(24.4, 90.8%, 61.8%);
  --calendar-dot-hover: hsl(9.6, 66.2%, 46.5%);
  ...
  --checkbox-color-hover: rgba(102, 153, 97, 0.5);
  ...
  --code-function: hsl(30.2, 98.6%, 72%);
  --code-important: hsl(268deg, 57%, 66%);
  --code-keyword: hsl(348.5, 79.3%, 63.9%);
  --code-normal: rgb(199, 197, 194);
  --code-normal-inline: hsl(348.5, 79.3%, 63.9%);
  --code-property: hsl(187.4, 22.4%, 50%);
  --code-punctuation: rgb(199, 197, 194);
  --code-string: hsl(96.9, 31.8%, 56.9%);
  --code-tag: hsl(11.2, 88.7%, 58.4%);
  --code-value: hsl(268deg, 57%, 66%);
  --codeFont: var(--font-monospace, Menlo,SFMono-Regular,Consolas,"Roboto Mono",monospace, ui-monospace, SFMono-Regular, "Cascadia Mono", "Roboto Mono", "DejaVu Sans Mono", "Liberation Mono", Menlo, Monaco, "Consolas", "Source Code Pro", monospace);
  ...
  --dark: var(--text-normal, rgb(244, 244, 240));
  --darkgray: var(--text-normal, rgb(244, 244, 240));
  ...
  --graph-node-attachment: hsl(40.2, 87.2%, 63.1%);
  --graph-node-focused: rgb(102, 153, 97);
  --graph-node-tag: hsl(9.6, 66.2%, 46.5%);
  --graph-node-unresolved: rgb(112, 110, 109);
  --graph-text: rgb(244, 244, 240);
  --gray: var(--text-muted, rgb(199, 197, 194));
  --gray-10: 244,
    244,
    240;
  --gray-100: 22,
  ...
  --headerFont: var(--font-text, Inter,sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
  --heading-counter: " ";
  ...
  --indentation-guide: rgba(255, 255, 255, 0.15);
  --indentation-guide-active: rgba(255, 255, 255, 0.3);
  ...
  --input-shadow: inset 0 0.5px 0.5px 0.5px rgba(255, 255, 255, 0.09),
    ...
    0.1px 9.4px 8.4px -4.1px hsl(0deg 0% 1% / 0.18);
  --input-shadow-hover: inset 0 0.5px 0.5px 0.5px rgba(255, 255, 255, 0.09),
    ...
    0.1px 9.4px 8.5px -4px hsl(0deg 0% 1% / 0.19);
  ...
  --lightgray: var(--background-secondary, rgb(22, 22, 22));
  ...
  --metadata-property-box-shadow-focus: 0 0 0 2px hsl(199.5, 38.8%, 40.4%);
  ...
  --nav-item-background-selected: hsla(24.4, 90.8%, 61.8%, 0.2);
  ...
  --secondary: var(--text-accent, rgb(102, 153, 97));
  ...
  --shiki-active-tab-border-color: rgb(199, 197, 194);
  --shiki-code-background: rgb(38, 38, 37);
  --shiki-code-comment: rgb(112, 110, 109);
  --shiki-code-normal: rgb(199, 197, 194);
  --shiki-code-punctuation: rgb(199, 197, 194);
  --shiki-gutter-border-color: rgb(58, 56, 56);
  --shiki-gutter-text-color: rgb(112, 110, 109);
  --shiki-gutter-text-color-highlight: rgb(199, 197, 194);
  --shiki-highlight-green: rgba(102, 153, 97, 0.5);
  --shiki-highlight-green-background: rgba(102, 153, 97, 0.1);
  --shiki-highlight-neutral: rgb(199, 197, 194);
  --shiki-highlight-red: rgba(197, 65, 40, 0.5);
  --shiki-highlight-red-background: rgba(197, 65, 40, 0.1);
  --shiki-terminal-dots-color: rgb(112, 110, 109);
  --shiki-tooltip-background: rgb(38, 38, 37);
  ...
  --table-hover-highlight-color: rgba(102, 153, 97, 0.15);
  --table-selection: hsla(24.4, 90.8%, 61.8%, 0.1);
  --table-selection-border-color: rgb(102, 153, 97);
  --table-sticky-height: 600px;
  --tag-background: rgba(102, 153, 97, 0.15);
  --tag-background-hover: rgba(102, 153, 97, 0.25);
  --tag-border-color: rgba(102, 153, 97, 0.15);
  --tag-border-color-hover: rgba(102, 153, 97, 0.25);
  --tag-color: rgb(102, 153, 97);
  --tag-color-hover: rgb(102, 153, 97);
  --tertiary: var(--text-accent-hover, rgb(102, 153, 97));
  --text-accent: rgb(102, 153, 97);
  --text-accent-hover: rgb(102, 153, 97);
  --text-code: hsl(348.5, 79.3%, 63.9%);
  --text-error: hsl(9.6, 66.2%, 46.5%);
  ...
  --text-success: hsl(114.6, 22.4%, 49%);
  --textHighlight: var(--text-highlight-bg, rgba(102, 153, 97, 0.7));
  --titleFont: var(--font-text, Inter,sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
...
html[saved-theme="dark"] body .callout[data-callout="alarm"] {
  --callout-color: 184,
    131,
    0;
  --table-border-color: color-mix(in srgb, rgb(184, 131, 0) 25%, rgb(22, 22, 22) 50%);
...
html[saved-theme="dark"] body .callout[data-callout="annotation"] {
  --callout-color: 104,
    145,
    181;
  --table-border-color: color-mix(in srgb, rgb(104, 145, 181) 25%, rgb(22, 22, 22) 50%);
  background-color: rgba(104, 145, 181, 0.2);
  border-bottom-color: rgba(104, 145, 181, 0.3);
  border-bottom-left-radius: 4px;
  border-bottom-right-radius: 4px;
...
html[saved-theme="dark"] body .callout[data-callout="aside"] {
  --callout-color: 0,
    ...
    0;
  --move: 0;
  --table-border-color: color-mix(in srgb, rgb(0, 0, 0) 25%, rgb(22, 22, 22) 50%);
...
html[saved-theme="dark"] body .callout[data-callout="bookmark"] {
  --callout-color: 243,
    90,
    55;
  --table-border-color: color-mix(in srgb, rgb(243, 90, 55) 25%, rgb(22, 22, 22) 50%);
...
html[saved-theme="dark"] body .callout[data-callout="cue"] {
  --callout-color: 141,
    147,
    25;
  --table-border-color: color-mix(in srgb, rgb(141, 147, 25) 25%, rgb(22, 22, 22) 50%);
...
html[saved-theme="dark"] body .callout[data-callout="debug"] {
  --callout-color: 236,
    90,
    118;
  --table-border-color: color-mix(in srgb, rgb(236, 90, 118) 25%, rgb(22, 22, 22) 50%);
  background-color: rgba(236, 90, 118, 0.2);
  border-bottom-color: rgba(236, 90, 118, 0.3);
  border-bottom-left-radius: 4px;
  border-bottom-right-radius: 4px;
...
html[saved-theme="dark"] body .callout[data-callout="event"] {
  --callout-color: 165,
    119,
    218;
  --table-border-color: color-mix(in srgb, rgb(165, 119, 218) 25%, rgb(22, 22, 22) 50%);
...
html[saved-theme="dark"] body .callout[data-callout="grid"] {
  ...
  --table-border-color: color-mix(in srgb, rgb(2, 122, 255) 25%, rgb(22, 22, 22) 50%);
  background-color: rgba(0, 0, 0, 0);
  border-bottom-color: rgb(244, 244, 240);
  border-bottom-left-radius: 4px;
  border-bottom-right-radius: 4px;
...
html[saved-theme="dark"] body .callout[data-callout="location"] {
  --callout-color: 102,
    153,
    97;
  --table-border-color: color-mix(in srgb, rgb(102, 153, 97) 25%, rgb(22, 22, 22) 50%);
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --code-function: hsl(24.4, 90.8%, 61.8%);
  --code-important: hsl(268deg, 57%, 66%);
  --code-keyword: hsl(348.5, 79.3%, 63.9%);
  ...
  --code-string: hsl(114.6, 22.4%, 49%);
  --code-tag: hsl(9.6, 66.2%, 46.5%);
  --code-value: hsl(268deg, 57%, 66%);
  --codeFont: var(--font-monospace, Menlo,SFMono-Regular,Consolas,"Roboto Mono",monospace, ui-monospace, SFMono-Regular, "Cascadia Mono", "Roboto Mono", "DejaVu Sans Mono", "Liberation Mono", Menlo, Monaco, "Consolas", "Source Code Pro", monospace);
  ...
  --cyan-80: hsl(200.9, 100%, 18%);
  --cyan-90: hsl(206.1, 100%, 13.5%);
  --dark: var(--text-normal, rgb(22, 22, 22));
  --darkgray: var(--text-normal, rgb(22, 22, 22));
  ...
  --gray: var(--text-muted, rgb(84, 81, 81));
  --gray-10: 244,
    244,
    240;
  --gray-100: 22,
  ...
  --icon-xs: 16px;
  --icon-xs-stroke-width: 1px;
  --indentation-guide: rgba(0, 0, 0, 0.15);
  --indentation-guide-active: rgba(0, 0, 0, 0.3);
  --inline-title-font: Inter,sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  --inline-title-size: 2em;
  --inline-title-weight: 600;
  ...
  --input-shadow: inset 0 0 0 1px rgba(0, 0, 0, 0.12),
    ...
    0.1px 9.4px 8.4px -4.1px hsl(0deg 5% 59% / 0.18);
  --input-shadow-hover: inset 0 0 0 1px rgba(0, 0, 0, 0.17),
    ...
    0.1px 9.4px 8.5px -4px hsl(0deg 5% 59% / 0.19);
  ...
  --leading-8: 2.25em;
  --leading-9: 2.5em;
  --light: var(--background-primary, rgb(244, 244, 240));
  --lightgray: var(--background-secondary, rgb(244, 244, 240));
  ...
  --secondary: var(--text-accent, rgb(246, 141, 69));
  ...
  --shiki-active-tab-border-color: rgb(84, 81, 81);
  --shiki-code-background: rgba(226, 224, 220, 0.5);
  --shiki-code-comment: rgb(169, 168, 165);
  --shiki-code-normal: rgb(84, 81, 81);
  --shiki-code-punctuation: rgb(84, 81, 81);
  --shiki-gutter-border-color: rgb(226, 224, 220);
  --shiki-gutter-text-color: rgb(169, 168, 165);
  --shiki-gutter-text-color-highlight: rgb(84, 81, 81);
  --shiki-highlight-green: rgba(102, 153, 97, 0.5);
  --shiki-highlight-green-background: rgba(102, 153, 97, 0.1);
  --shiki-highlight-neutral: rgb(84, 81, 81);
  --shiki-highlight-red: rgba(197, 65, 40, 0.5);
  --shiki-highlight-red-background: rgba(197, 65, 40, 0.1);
  --shiki-terminal-dots-color: rgb(169, 168, 165);
  --shiki-tooltip-background: rgb(253, 254, 254);
  --sidebar-markdown-font-size: 0.933em;
  --size-0: 0px;
  --size-1: 2px;
  --size-10: 64px;
  ...
  --table-header-size: 0.875em;
  --table-header-weight: 600;
  --table-hover-highlight-color: rgba(246, 141, 69, 0.15);
  --table-selection: hsla(24.4, 90.8%, 61.8%, 0.1);
  --table-selection-border-color: rgb(246, 141, 69);
  --table-sticky-height: 600px;
  --tag-background: rgba(246, 141, 69, 0.15);
  --tag-background-hover: rgba(246, 141, 69, 0.25);
  --tag-border-color: rgba(246, 141, 69, 0.15);
  --tag-border-color-hover: rgba(246, 141, 69, 0.25);
  --tag-color: rgb(246, 141, 69);
  --tag-color-hover: rgb(246, 141, 69);
  --tertiary: var(--text-accent-hover, rgb(246, 141, 69));
  --text-accent: rgb(246, 141, 69);
  --text-accent-hover: rgb(246, 141, 69);
  --text-code: hsl(343.4, 62.8%, 49.6%);
  --text-error: hsl(9.6, 66.2%, 46.5%);
  ...
  --text-success: hsl(114.6, 22.4%, 49%);
  --textHighlight: var(--text-highlight-bg, rgba(246, 141, 69, 0.7));
  --titleFont: var(--font-text, Inter,sans-serif, ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", "Inter", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif);
...
html[saved-theme="light"] body .callout[data-callout="alarm"] {
  --callout-color: 184,
    131,
    0;
  --table-border-color: color-mix(in srgb, rgb(184, 131, 0) 25%, rgb(244, 244, 240) 50%);
  background-color: rgba(184, 131, 0, 0.2);
  border-bottom-color: rgba(184, 131, 0, 0.3);
  border-bottom-left-radius: 4px;
  border-bottom-right-radius: 4px;
...
html[saved-theme="light"] body .callout[data-callout="annotation"] {
  --callout-color: 104,
    145,
    181;
  --table-border-color: color-mix(in srgb, rgb(104, 145, 181) 25%, rgb(244, 244, 240) 50%);
  background-color: rgba(104, 145, 181, 0.2);
  border-bottom-color: rgba(104, 145, 181, 0.3);
  border-bottom-left-radius: 4px;
  border-bottom-right-radius: 4px;
...
html[saved-theme="light"] body .callout[data-callout="aside"] {
  --callout-color: 0,
    ...
    0;
  --move: 0;
  --table-border-color: color-mix(in srgb, rgb(0, 0, 0) 25%, rgb(244, 244, 240) 50%);
  background-color: rgba(0, 0, 0, 0);
  border-bottom-color: rgba(0, 0, 0, 0.3);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
...
html[saved-theme="light"] body .callout[data-callout="bookmark"] {
  --callout-color: 243,
    90,
    55;
  --table-border-color: color-mix(in srgb, rgb(243, 90, 55) 25%, rgb(244, 244, 240) 50%);
  background-color: rgba(243, 90, 55, 0.2);
  border-bottom-color: rgba(243, 90, 55, 0.3);
  border-bottom-left-radius: 4px;
  border-bottom-right-radius: 4px;
...
html[saved-theme="light"] body .callout[data-callout="cue"] {
  --callout-color: 141,
    147,
    25;
  --table-border-color: color-mix(in srgb, rgb(141, 147, 25) 25%, rgb(244, 244, 240) 50%);
  background-color: rgba(141, 147, 25, 0.2);
  border-bottom-color: rgba(141, 147, 25, 0.3);
  border-bottom-left-radius: 4px;
  border-bottom-right-radius: 4px;
...
html[saved-theme="light"] body .callout[data-callout="debug"] {
  --callout-color: 236,
    90,
    118;
  --table-border-color: color-mix(in srgb, rgb(236, 90, 118) 25%, rgb(244, 244, 240) 50%);
  background-color: rgba(236, 90, 118, 0.2);
  border-bottom-color: rgba(236, 90, 118, 0.3);
  border-bottom-left-radius: 4px;
  border-bottom-right-radius: 4px;
...
html[saved-theme="light"] body .callout[data-callout="event"] {
  --callout-color: 165,
    119,
    218;
  --table-border-color: color-mix(in srgb, rgb(165, 119, 218) 25%, rgb(244, 244, 240) 50%);
  background-color: rgba(165, 119, 218, 0.2);
  border-bottom-color: rgba(165, 119, 218, 0.3);
  border-bottom-left-radius: 4px;
  border-bottom-right-radius: 4px;
...
html[saved-theme="light"] body .callout[data-callout="grid"] {
  ...
  --table-border-color: color-mix(in srgb, rgb(8, 109, 221) 25%, rgb(244, 244, 240) 50%);
  background-color: rgba(0, 0, 0, 0);
  border-bottom-color: rgb(22, 22, 22);
  border-bottom-left-radius: 4px;
  border-bottom-right-radius: 4px;
...
html[saved-theme="light"] body .callout[data-callout="location"] {
  --callout-color: 102,
    153,
    97;
  --table-border-color: color-mix(in srgb, rgb(102, 153, 97) 25%, rgb(244, 244, 240) 50%);
  background-color: rgba(102, 153, 97, 0.2);
  border-bottom-color: rgba(102, 153, 97, 0.3);
  border-bottom-left-radius: 4px;
  border-bottom-right-radius: 4px;
