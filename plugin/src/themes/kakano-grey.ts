...
html[saved-theme="dark"] body pre > code > [data-line] {
  border-left-color: color(srgb 0.525 0.5225 0.475);
}
...
html[saved-theme="dark"] body pre > code [data-highlighted-chars] {
  border-bottom-color: color(srgb 0.525 0.5225 0.475);
  border-left-color: color(srgb 0.525 0.5225 0.475);
  border-right-color: color(srgb 0.525 0.5225 0.475);
  border-top-color: color(srgb 0.525 0.5225 0.475);
}
...
html[saved-theme="dark"] body ::-webkit-scrollbar {
  background: color(srgb 0.02625 0.0254167 0.02375) none repeat scroll 0% 0% / auto padding-box border-box;
  background-color: color(srgb 0.02625 0.0254167 0.02375);
}
