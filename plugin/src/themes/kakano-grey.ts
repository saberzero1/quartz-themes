...
export const theme: ThemeData = {
  ...
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(40, 5%, 50%);
  ...
  --bases-table-header-background-hover: hsl(40, 5%, 50%);
  ...
  --bases-table-summary-background-hover: hsl(40, 5%, 50%);
  ...
  --highlight: var(--background-modifier-hover, hsl(40, 5%, 50%));
  --hr-color: color-mix(
    in srgb,
    hsl(40, 5%, 50%),
    black 25%
  );
  --icon-color: hsl(40, 5%, 50%);
  ...
  --metadata-property-background-active: hsl(40, 5%, 50%);
  ...
  --nav-item-background-active: hsl(40, 5%, 50%);
  ...
  --pill-background-hover: hsl(40, 5%, 50%);
  ...
  --secondary: var(--interactive-accent, hsl(40, 5%, 50%));
  ...
  --textHighlight: var(--background-modifier-hover, hsl(40, 5%, 50%));
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --bases-table-cell-shadow-active: 0 0 0 2px hsl(40, 5%, 50%);
  --bases-table-cell-shadow-focus: 0 0 0 2px hsl(40, 5%, 50%);
  --bases-table-container-border-radius: 0.25rem;
  ...
  --metadata-property-box-shadow-focus: 0 0 0 2px hsl(40, 5%, 50%);
  --metadata-property-box-shadow-hover: none;
  --metadata-sidebar-input-font-size: 0.8rem;
  --metadata-sidebar-label-font-size: 0.8rem;
  --modal-background: color-mix(
  ...
  --tag-weight: 400;
  --tertiary: var(--interactive-accent-hover, hsl(40, 5%, 50%));
  --text-error: hsl(from hsl(40, 5%, 50%) 356 s l);
  --text-faint: color-mix(
    in srgb,
    hsl(40, 5%, 50%),
