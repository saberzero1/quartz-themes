...
html[saved-theme="dark"] body[data-slug] div#quartz-root.page, html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left, html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left:has(.explorer), html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left .explorer .explorer-content {
  --bases-table-header-background: var(--background-secondary, #232433);
...
html[saved-theme="dark"] body blockquote {
  color: var(--blockquote-color, rgb(145, 152, 199));
}`,
...
html[saved-theme="dark"] body video {
  ...
  color: var(--color-main-alart, rgb(255, 76, 48));
}
...
html[saved-theme="dark"] body li.task-list-item[data-task="I"] {
  ...
  border-top-style: solid;
  border-top-width: 10px;
  box-shadow: rgb(0, 221, 255) 0px 0px 1.60385px 0px, oklab(0.825339 -0.120173 -0.0813295 / 0.3) 0px 0px 12.2053px 0px;
  color: var(--color-main-holo, rgb(0, 221, 255));
  content: "";
  font-family: "??", "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  line-height: 24px;
...
html[saved-theme="dark"] body li.task-list-item[data-task="b"] {
  ...
  border-top-style: solid;
  border-top-width: 10px;
  box-shadow: rgb(0, 221, 255) 0px 0px 1.58155px 0px, oklab(0.825339 -0.120173 -0.0813295 / 0.3) 0px 0px 12.1746px 0px;
  color: var(--color-main-holo, rgb(0, 221, 255));
  content: "";
  font-family: "??", "??", ui-sans-serif, -apple-system, BlinkMacSystemFont, system-ui, "Segoe UI", "Google Sans Flex", Roboto, "Inter Variable", Inter, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
  line-height: 24px;
...
html[saved-theme="dark"] body a.internal-link.tag-link, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  --pill-background: var(--tag-background, #232433);
  --pill-color: var(--tag-color, #afb2c7);
  --pill-color-hover: var(--tag-color-hover, #e0e0ff);
  --pill-color-remove: var(--tag-color, #afb2c7);
  --pill-color-remove-hover: var(--tag-color-hover, #e0e0ff);
...
html[saved-theme="dark"] body h1::after {
  ...
  background: color(srgb 0 0.866667 1) none repeat scroll 0% 0% / auto padding-box border-box;
...
html[saved-theme="dark"] body h2::after {
  ...
  background: color(srgb 1 0.239216 0.388235) none repeat scroll 0% 0% / auto padding-box border-box;
...
html[saved-theme="dark"] body h3::after {
  ...
  background: color(srgb 1 0.784314 0.239216) none repeat scroll 0% 0% / auto padding-box border-box;
...
html[saved-theme="dark"] body h4::after {
  ...
  background: color(srgb 0.643137 0.392157 0.988235) none repeat scroll 0% 0% / auto padding-box border-box;
...
html[saved-theme="dark"] body h5::after {
  ...
  background: color(srgb 0 1 0.415686) none repeat scroll 0% 0% / auto padding-box border-box;
...
html[saved-theme="dark"] body h6::after {
  ...
  background: color(srgb 0.686275 0.698039 0.780392) none repeat scroll 0% 0% / auto padding-box border-box;
...
html[saved-theme="light"] body footer {
  opacity: 0.4;
    ...
    links: `html[saved-theme="light"] body li.task-list-item[data-task=", html[saved-theme="light"] "] {
  text-decoration-line: line-through;
}
...
html[saved-theme="light"] body pre:has(> code) {
  ...
  border-top-left-radius: 10px;
  border-top-right-radius: 10px;
  color: var(--color-main-alart, rgb(34, 34, 34));
}`,
