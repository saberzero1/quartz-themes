...
export const theme: ThemeData = {
  ...
  --background-modifier-active-hover: rgba(83, 112, 159, 0.15);
  ...
  --bases-table-cell-shadow-focus: 0 0 0 2px rgb(83, 112, 159);
  ...
  --collapse-icon-color-collapsed: rgb(83, 112, 159);
  --color-accent: rgb(83, 112, 159);
  --color-accent-1: rgb(83, 112, 159);
  --color-accent-2: rgb(83, 112, 159);
  ...
  --divider-color-hover: rgb(83, 112, 159);
  ...
  --embed-border-color: rgb(83, 112, 159);
  --embed-border-left: 1px solid rgb(83, 112, 159);
  --embed-border-right: none;
  --embed-border-start: 2px solid rgb(83, 112, 159);
  ...
  --graph-node-focused: rgb(83, 112, 159);
  ...
  --highlight: rgba(83, 112, 159, 0.7);
  --hr-color: rgb(58, 56, 56);
  --hr-thickness: 1.5px;
  --icon-color: rgb(112, 110, 109);
  --icon-color-active: rgb(83, 112, 159);
  ...
  --interactive: rgb(83, 112, 159);
  --interactive-accent: rgb(83, 112, 159);
  --interactive-accent-hover: rgb(83, 112, 159);
  ...
  --link-color: rgb(83, 112, 159);
  --link-color-hover: rgb(83, 112, 159);
  --link-external-color: rgb(83, 112, 159);
  --link-external-color-hover: rgb(83, 112, 159);
  --link-external-style: normal;
  --link-style: normal;
  --link-text-transform: none;
  --link-unresolved-color: rgb(83, 112, 159);
  ...
  --list-marker-color-collapsed: rgb(83, 112, 159);
  ...
  --nav-item-color-highlighted: rgb(83, 112, 159);
  ...
  --pill-color-remove-hover: rgb(83, 112, 159);
  ...
  --secondary: var(--text-accent, rgb(83, 112, 159));
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px rgb(83, 112, 159);
  ...
  --tab-text-color-focused-highlighted: rgb(83, 112, 159);
  --table-add-button-border-color: rgb(58, 56, 56);
  --table-border-color: rgb(58, 56, 56);
  --table-drag-handle-background-active: rgb(83, 112, 159);
  ...
  --table-hover-highlight-color: rgb(83, 112, 159 0.15);
  --table-selection: hsla(24.4, 90.8%, 61.8%, 0.1);
  --table-selection-border-color: rgb(83, 112, 159);
  --table-sticky-height: 600px;
  --tag-background: rgb(83, 112, 159 0.15);
  --tag-background-hover: rgb(83, 112, 159 0.25);
  --tag-border-color: rgb(83, 112, 159 0.15);
  --tag-border-color-hover: rgb(83, 112, 159 0.25);
  --tag-color: rgb(83, 112, 159);
  --tag-color-hover: rgb(83, 112, 159);
  --tertiary: var(--text-accent-hover, rgb(83, 112, 159));
  --text-accent: rgb(83, 112, 159);
  --text-accent-hover: rgb(83, 112, 159);
  --text-code: hsl(348.5deg, 79.3%, 63.9%);
  --text-error: hsl(9.6deg, 66.2%, 46.5%);
  --text-faint: rgb(112, 110, 109);
  --text-highlight-bg: rgba(83, 112, 159, 0.7);
  --text-highlight-bg-active: rgba(83, 112, 159, 0.7);
  ...
  --text-selection: rgba(83, 112, 159, 0.5);
  --text-success: hsl(114.6deg, 22.4%, 49%);
  --textHighlight: var(--text-highlight-bg, rgba(83, 112, 159, 0.7));
  ...
  --titlebar-text-color-highlighted: rgb(83, 112, 159);
