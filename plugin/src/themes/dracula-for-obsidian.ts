...
export const theme: ThemeData = {
  ...
  --highlight: var(--text-highlight-bg, #ff5555);
  --hr-color: #f8f8f2;
  --icon-color: #f8f8f2;
  ...
  --lightgray: var(--background-secondary, #44475a);
  --link-color: #ffb86c;
  ...
  --shiki-gutter-border-color: #f8f8f2;
  ...
  --textHighlight: var(--text-highlight-bg, #ff5555);
