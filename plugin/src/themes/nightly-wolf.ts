...
export const theme: ThemeData = {
  ...
  --accent-l: 69%;
  --accent-s: 83%;
  --background-modifier-border: var(--color-base-30, rgb(24, 20, 33));
  ...
  --background-primary: var(--color-base-00, rgb(19, 16, 26));
  --background-primary-alt: var(--color-base-10, rgb(27, 27, 27));
  --background-secondary: var(--color-base-20, rgb(24, 20, 33));
  --background-secondary-alt: var(--color-base-30, rgb(24, 20, 33));
  --bases-cards-background: var(--background-primary, rgb(19, 16, 26));
  --bases-cards-cover-background: var(--background-primary-alt, rgb(27, 27, 27));
  --bases-embed-border-color: var(--background-modifier-border, rgb(24, 20, 33));
  --bases-group-heading-property-color: var(--text-muted, rgb(200, 200, 200));
  --bases-table-border-color: var(--table-border-color, rgb(24, 20, 33));
  --bases-table-cell-background-active: var(--background-primary, rgb(19, 16, 26));
  ...
  --bases-table-header-background: var(--background-primary, rgb(19, 16, 26));
  --bases-table-header-color: var(--text-muted, rgb(200, 200, 200));
  --bases-table-summary-background: var(--background-primary, rgb(19, 16, 26));
  ...
  --canvas-background: var(--background-primary, rgb(19, 16, 26));
  --canvas-card-label-color: var(--text-faint, rgb(135, 135, 135));
  --canvas-dot-pattern: var(--color-base-30, rgb(24, 20, 33));
  ...
  --checkbox-marker-color: var(--background-primary, rgb(19, 16, 26));
  --checklist-done-color: var(--color-base-50, rgb(135, 135, 135));
  --checklist-done-decoration: none;
  --code-background: var(--background-primary-alt, rgb(27, 27, 27));
  --code-border-color: var(--background-modifier-border, rgb(24, 20, 33));
  ...
  --divider-color: var(--background-modifier-border, rgb(24, 20, 33));
  --divider-color-hover: var(--interactive-accent, hsl(262, 83%, 69%));
  --dropdown-background: var(--interactive-normal, rgb(24, 20, 33));
  --dropdown-background-hover: var(--interactive-hover, rgb(75, 75, 75));
  --en-acrylic: blur(8px);
  --en-acrylic-opacity: 0.66;
  --en-modal-backdrop: blur(25px);
  --en-opacity: 1;
  --file-header-background: var(--background-primary, rgb(19, 16, 26));
  --file-header-background-focused: var(--background-primary, rgb(19, 16, 26));
  --flair-background: var(--interactive-normal, rgb(24, 20, 33));
  --flair-color: var(--text-normal, rgb(245, 245, 245));
  --footnote-divider-color: var(--metadata-divider-color, rgb(24, 20, 33));
  ...
  --highlight-hue: 37;
  --hr-color: var(--background-modifier-border, #6a6161b3);
  --hr-thickness: 1px;
  ...
  --interactive-normal: var(--color-base-30, rgb(24, 20, 33));
  --light: var(--background-primary, var(--color-base-00, rgb(19, 16, 26)));
  --lightgray: var(--background-secondary, var(--color-base-20, rgb(24, 20, 33)));
  ...
  --list-marker-color: var(--text-faint, #992929);
  ...
  --menu-background: var(--background-secondary, rgb(24, 20, 33));
  --menu-border-color: var(--background-modifier-border-hover, rgb(75, 75, 75));
  --metadata-border-color: var(--background-modifier-border, rgb(24, 20, 33));
  --metadata-divider-color: var(--background-modifier-border, rgb(24, 20, 33));
  ...
  --modal-background: var(--background-primary, rgb(19, 16, 26));
  ...
  --pdf-background: var(--background-primary, rgb(19, 16, 26));
  --pdf-page-background: var(--background-primary, rgb(19, 16, 26));
  --pdf-sidebar-background: var(--background-primary, rgb(19, 16, 26));
  --pill-border-color: var(--background-modifier-border, rgb(24, 20, 33));
  ...
  --prompt-background: var(--background-primary, rgb(19, 16, 26));
  --raised-background: var(--blur-background, color-mix(in srgb, rgb(24, 20, 33) 65%, transparent) linear-gradient(rgb(24, 20, 33), color-mix(in srgb, rgb(24, 20, 33) 65%, transparent)));
  --ribbon-background: var(--background-secondary, rgb(24, 20, 33));
  --ribbon-background-collapsed: var(--background-primary, rgb(19, 16, 26));
  --search-clear-button-color: var(--text-muted, rgb(200, 200, 200));
  --search-icon-color: var(--text-muted, rgb(200, 200, 200));
  --search-result-background: var(--background-primary, rgb(19, 16, 26));
  ...
  --setting-items-border-color: var(--background-modifier-border, rgb(24, 20, 33));
  ...
  --shiki-gutter-border-color: var(--background-modifier-border, rgb(24, 20, 33));
  ...
  --slider-track-background: var(--background-modifier-border, rgb(24, 20, 33));
  --status-bar-background: var(--background-secondary, rgb(24, 20, 33));
  --status-bar-border-color: var(--divider-color, rgb(24, 20, 33));
  --status-bar-text-color: var(--text-muted, rgb(200, 200, 200));
  --suggestion-background: var(--background-primary, rgb(19, 16, 26));
  --tab-background-active: var(--background-primary, rgb(19, 16, 26));
  ...
  --tab-height: 38px;
  --tab-outline-color: var(--divider-color, rgb(24, 20, 33));
  --tab-radius: var(--radius-s, 6px);
  --tab-stacked-header-width: var(--header-height, 44px);
  --tab-switcher-background: var(--background-secondary, rgb(24, 20, 33));
  ...
  --table-add-button-border-color: var(--background-modifier-border, rgb(24, 20, 33));
  --table-border-color: var(--background-modifier-border, rgb(24, 20, 33));
  ...
  --table-header-border-color: var(--table-border-color, rgb(24, 20, 33));
  ...
  --titlebar-background: var(--background-secondary, rgb(24, 20, 33));
  --titlebar-background-focused: var(--background-secondary-alt, rgb(24, 20, 33));
  --titlebar-border-color: var(--background-modifier-border, rgb(24, 20, 33));
  ...
  --workspace-background-translucent: rgba(var(--grey-900-rgb), 1);
...
html[saved-theme="dark"] body[data-slug] div#quartz-root.page, html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left, html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left:has(.explorer), html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left .explorer .explorer-content {
  --bases-table-header-background: var(--background-secondary, rgb(24, 20, 33));
...
html[saved-theme="dark"] body video {
  ...
  border-top-color: var(--color-base-30, rgb(24, 20, 33));
...
html[saved-theme="dark"] body .canvas-sidebar {
  background-color: var(--background-secondary, rgb(24, 20, 33));
  border-color: rgb(245, 245, 245);
}`,
...
html[saved-theme="dark"] body div#quartz-root {
  background-color: var(--icon-color, rgba(0, 0, 0, 0));
  color: var(--text-normal, rgb(245, 245, 245));
}
