...
export const theme: ThemeData = {
  ...
  --background-primary-alt-1: var(--background-primary-alt, hsl(187, 10%, 15%));
  --background-search: hsl(calc(var(--accent-h) - 10), calc(var(--accent-s) - 55%), calc(var(--accent-l) - 35%));
  ...
  --bases-cards-background: var(--background-primary, hsl(177, 15%, 10%));
  --bases-cards-cover-background: var(--background-primary-alt, hsl(187, 10%, 15%));
  --bases-group-heading-property-color: var(--text-muted, white);
  --bases-table-cell-background-active: var(--background-primary, hsl(177, 15%, 10%));
  --bases-table-cell-background-disabled: var(--background-primary-alt, hsl(187, 10%, 15%));
  --bases-table-cell-background-selected: var(--table-selection, hsla(187, 80%, 65%, 0.1));
  --bases-table-group-background: var(--background-primary-alt, hsl(187, 10%, 15%));
  --bases-table-header-background: var(--background-primary, hsl(177, 15%, 10%));
  ...
  --bases-table-summary-background: var(--background-primary, hsl(177, 15%, 10%));
  --bases-table-summary-background-hover: var(--background-modifier-hover, rgba(255, 255, 255, 0.075));
  --blockquote-border-color: var(--interactive-accent, hsl(187, 80%, 65%));
  ...
  --canvas-background: var(--background-primary, hsl(177, 15%, 10%));
  --canvas-card-label-color: var(--text-faint, hsl(267, 30%, 75%));
  ...
  --checkbox-border-color: var(--text-faint, hsl(267, 30%, 75%));
  --checkbox-border-color-hover: var(--text-muted, white);
  --checkbox-color: var(--interactive-accent, hsl(187, 80%, 65%));
  --checkbox-color-hover: var(--interactive-accent-hover, hsl(184, 81.6%, 74.75%));
  --checkbox-marker-color: var(--background-primary, hsl(177, 15%, 10%));
  --checklist-done-color: var(--text-muted, white);
  --code-background: var(--background-primary-alt, hsl(187, 10%, 15%));
  --code-bracket-background: var(--background-modifier-hover, rgba(255, 255, 255, 0.075));
  --code-comment: var(--text-faint, hsl(267, 30%, 75%));
  --code-normal: var(--text-muted, white);
  --code-punctuation: var(--text-muted, white);
  --collapse-icon-color: var(--text-faint, hsl(267, 30%, 75%));
  --collapse-icon-color-collapsed: var(--text-accent, hsl(184, 81.6%, 74.75%));
  ...
  --divider-color-hover: var(--interactive-accent, hsl(187, 80%, 65%));
  ...
  --file-header-background: var(--background-primary, hsl(177, 15%, 10%));
  --file-header-background-focused: var(--background-primary, hsl(177, 15%, 10%));
  --file-margins: var(--size-4-8, 32px);
  --footnote-id-color: var(--text-muted, white);
  --footnote-id-color-no-occurrences: var(--text-faint, hsl(267, 30%, 75%));
  --footnote-input-background-active: var(--metadata-input-background-active, rgba(255, 255, 255, 0.075));
  --graph-line: var(--text-accent, hsl(184, 81.6%, 74.75%));
  --graph-node: var(--text-accent, hsl(184, 81.6%, 74.75%));
  --graph-node-focused: var(--text-accent, hsl(184, 81.6%, 74.75%));
  --graph-node-unresolved: var(--text-faint, hsl(267, 30%, 75%));
  ...
  --h6-color: #ffafc8;
  --h6-size: 1.2rem;
  --heading-formatting: var(--text-faint, hsl(267, 30%, 75%));
  ...
  --icon-color-active: var(--text-accent, hsl(184, 81.6%, 74.75%));
  --icon-color-hover: var(--text-muted, white);
  --indentation-guide-color: var(--background-secondary, hsl(197, 5%, 30%));
  ...
  --input-date-separator: var(--text-faint, hsl(267, 30%, 75%));
  --input-placeholder-color: var(--text-faint, hsl(267, 30%, 75%));
  --interactive-accent: var(--color-accent-1, hsl(187, 80%, 65%));
  --interactive-accent-hover: var(--color-accent-2, hsl(184, 81.6%, 74.75%));
  --interactive-accent-hsl: var(--color-accent-hsl, 187, 80%, 65%);
  ...
  --link-external-color: var(--text-accent, hsl(184, 81.6%, 74.75%));
  --link-external-color-hover: var(--text-accent-hover, hsl(182, 84%, 83.85%));
  --link-unresolved-color: var(--text-accent, hsl(184, 81.6%, 74.75%));
  --list-bullet-size: 0.3rem;
  --list-marker-color: hsl(var(--accent-h), var(--accent-s), calc(var(--accent-l) + 35%));
  --list-marker-color-collapsed: var(--text-accent, hsl(184, 81.6%, 74.75%));
  --list-marker-color-hover: var(--text-accent, hsl(184, 81.6%, 74.75%));
  --list-spacing: 0.2em;
  --mcc-img-snw-display: none;
  --menu-background: var(--background-secondary, hsl(197, 5%, 30%));
  ...
  --modal-background: var(--background-primary, hsl(177, 15%, 10%));
  --nav-collapse-icon-color: var(--collapse-icon-color, hsl(267, 30%, 75%));
  --nav-collapse-icon-color-collapsed: var(--text-faint, hsl(267, 30%, 75%));
  --nav-heading-color-collapsed: var(--text-faint, hsl(267, 30%, 75%));
  ...
  --nav-item-color-highlighted: var(--text-accent-hover, hsl(182, 84%, 83.85%));
  --nav-item-white-space: nowrap;
  --nav-tag-color: var(--text-faint, hsl(267, 30%, 75%));
  --nav-tag-color-active: var(--text-muted, white);
  --nav-tag-color-hover: var(--text-muted, white);
  --pdf-background: var(--background-primary, hsl(177, 15%, 10%));
  --pdf-page-background: var(--background-primary, hsl(177, 15%, 10%));
  --pdf-sidebar-background: var(--background-primary, hsl(177, 15%, 10%));
  --pill-color: var(--text-muted, white);
  --pill-color-remove: var(--text-faint, hsl(267, 30%, 75%));
  --pill-color-remove-hover: var(--text-accent, hsl(184, 81.6%, 74.75%));
  --popover-max-height: 70vh;
  --popover-pdf-height: 800px;
  --popover-pdf-width: 600px;
  --prompt-background: var(--background-primary, hsl(177, 15%, 10%));
  --red: hsla(var(--interactive-accent-hsl), 0.9);
  --ribbon-background: var(--background-secondary, hsl(197, 5%, 30%));
  --ribbon-background-collapsed: var(--background-secondary, hsl(197, 5%, 30%));
  ...
  --search-result-background: var(--background-primary, hsl(177, 15%, 10%));
  --secondary: var(--text-accent, var(--color-accent, hsl(184, 81.6%, 74.75%)));
  --setting-items-background: var(--background-primary-alt, hsl(187, 10%, 15%));
  --shiki-active-tab-border-color: var(--shiki-highlight-neutral, white);
  --shiki-code-background: var(--code-background, hsl(187, 10%, 15%));
  --shiki-code-comment: var(--text-faint, hsl(267, 30%, 75%));
  --shiki-code-normal: var(--text-muted, white);
  --shiki-code-punctuation: var(--text-muted, white);
  --shiki-gutter-text-color: var(--text-faint, hsl(267, 30%, 75%));
  --shiki-gutter-text-color-highlight: var(--shiki-code-normal, white);
  --shiki-highlight-neutral: var(--shiki-code-normal, white);
  --shiki-terminal-dots-color: var(--text-faint, hsl(267, 30%, 75%));
  --slider-thumb-radius: var(--slider-thumb-height, 50%);
  --status-bar-background: var(--background-tertiary, hsl(167, 10%, 20%));
  --status-bar-border-color: var(--text-accent, hsl(184, 81.6%, 74.75%));
  ...
  --suggestion-background: var(--background-primary, hsl(177, 15%, 10%));
  --swatch-height: 24px;
  --swatch-width: 24px;
  --tab-background-active: var(--background-primary, transparent);
  --tab-container-background: var(--background-primary, hsl(177, 15%, 10%));
  --tab-outline-color: var(--divider-color, transparent);
  --tab-stacked-text-align: left;
  --tab-switcher-background: var(--background-secondary, hsl(197, 5%, 30%));
  --tab-text-color: var(--text-faint, hsl(267, 30%, 75%));
  ...
  --tab-text-color-focused-highlighted: var(--text-accent, hsl(184, 81.6%, 74.75%));
  --table-drag-handle-background-active: var(--table-selection-border-color, hsl(187, 80%, 65%));
  --table-drag-handle-color: var(--text-faint, hsl(267, 30%, 75%));
  --table-drag-padding: var(--table-drag-space, 16px);
  --table-drag-space: 16px;
  --table-selection-border-color: var(--interactive-accent, hsl(187, 80%, 65%));
  --tag-color: var(--text-accent, hsl(184, 81.6%, 74.75%));
  --tag-color-hover: var(--text-accent, hsl(184, 81.6%, 74.75%));
  --tertiary: var(--text-accent-hover, var(--color-accent-2, hsl(182, 84%, 83.85%)));
  --text-accent: var(--color-accent, hsl(184, 81.6%, 74.75%));
  --text-accent-hover: var(--color-accent-2, hsl(182, 84%, 83.85%));
  ...
  --titlebar-background: var(--background-primary, hsl(177, 15%, 10%));
  --titlebar-background-focused: var(--background-primary, hsl(177, 15%, 10%));
...
html[saved-theme="dark"] body[data-slug] div#quartz-root.page, html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left, html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left:has(.explorer), html[saved-theme="dark"] .page > div#quartz-body div.sidebar.left .explorer .explorer-content {
  background-color: var(--tab-container-background, rgb(22, 29, 29));
}

html[saved-theme="dark"] body[data-slug], html[saved-theme="dark"] body[data-slug] .page > div#quartz-body, html[saved-theme="dark"] .page > div#quartz-body div.center, html[saved-theme="dark"] .page > div#quartz-body footer {
  background-color: var(--background-primary, rgb(22, 29, 29));
}
...
html[saved-theme="dark"] body html {
  ...
  color: var(--bold-color, rgb(140, 182, 217));
  outline: rgb(140, 182, 217) none 0px;
  text-decoration-color: rgb(140, 182, 217);
}

html[saved-theme="dark"] body .markdown-rendered p > em, html[saved-theme="dark"] em {
  color: var(--italic-color, rgb(167, 159, 223));
  outline: rgb(167, 159, 223) none 0px;
  text-decoration-color: rgb(167, 159, 223);
}
...
html[saved-theme="dark"] body .text-highlight {
  background-color: var(--text-highlight-bg, rgb(53, 38, 89));
}

html[saved-theme="dark"] body li.task-list-item input[type="checkbox"] {
  border-color: rgb(189, 172, 210);
}

html[saved-theme="dark"] body li.task-list-item input[type="checkbox"]:checked {
  background-color: var(--checkbox-color, rgb(94, 220, 237));
  border-color: rgb(94, 220, 237);
}
...
html[saved-theme="dark"] body p {
  ...
  color: var(--link-external-color, rgb(138, 236, 243));
  outline: rgb(138, 236, 243) none 0px;
  text-decoration-color: rgb(138, 236, 243);
}

html[saved-theme="dark"] body a.internal-link, html[saved-theme="dark"] .breadcrumb-container .breadcrumb-element > a {
  color: var(--link-color, rgb(172, 237, 246));
  outline: rgb(172, 237, 246) none 0px;
  text-decoration-color: rgb(172, 237, 246);
}

html[saved-theme="dark"] body a.internal-link.broken {
  color: var(--link-unresolved-color, rgb(138, 236, 243));
  outline: rgb(138, 236, 243) none 0px;
  text-decoration-color: var(--link-unresolved-decoration-color, rgb(138, 236, 243));
}`,
    blockquotes: `html[saved-theme="dark"] body .data-footnote-backref {
  color: var(--text-faint, rgb(189, 172, 210));
}

html[saved-theme="dark"] body blockquote {
  background-color: var(--blockquote-background-color, rgb(46, 56, 54));
...
html[saved-theme="dark"] body pre:has(> code) {
  background-color: var(--code-background, rgb(34, 41, 42));
  ...
  background-color: var(--background-primary-alt, rgb(34, 41, 42));
  border-bottom-color: rgb(255, 255, 255);
  border-left-color: rgb(255, 255, 255);
  border-right-color: rgb(255, 255, 255);
  border-top-color: rgb(255, 255, 255);
...
html[saved-theme="dark"] body .transclude {
  ...
  border-bottom-color: rgb(189, 172, 210);
  border-left-color: rgb(189, 172, 210);
  border-right-color: rgb(189, 172, 210);
  border-top-color: rgb(189, 172, 210);
}
...
html[saved-theme="dark"] body .callout[data-callout="anki"] {
  ...
  --A10: hsl(207, 15%, 25%);
  --A11: hsl(197, 15%, 25%);
  --background-highlight: hsl(257, 40%, 25%);
  --background-modifier-active-hover: hsla(187, 80%, 65%, 0.15);
  ...
  --background-primary: hsl(177, 15%, 10%);
  --background-primary-alt: hsl(187, 10%, 15%);
  --background-primary-alt-1: hsl(187, 10%, 15%);
  --background-search: hsl(177, 25%, 30%);
  --background-secondary: hsl(197, 5%, 30%);
  --background-secondary-alt: #363636;
  --background-table: hsl(157, -5%, 30%);
  --background-tertiary: hsl(167, 10%, 20%);
  --blockquote-border-color: hsl(187, 80%, 65%);
  ...
  --canvas-background: hsl(177, 15%, 10%);
  ...
  --caret-color: #dadada;
  --checkbox-border-color: hsl(267, 30%, 75%);
  --checkbox-border-color-hover: white;
  --checkbox-color: hsl(187, 80%, 65%);
  --checkbox-color-hover: hsl(184, 81.6%, 74.75%);
  --checkbox-marker-color: hsl(177, 15%, 10%);
  --checkbox-radius: 4px;
  --checkbox-size: 16px;
  --checklist-done-color: white;
  --clickable-icon-radius: 4px;
  --code-background: hsl(187, 10%, 15%);
  --code-border-color: #363636;
  --code-bracket-background: rgba(255, 255, 255, 0.075);
  --code-comment: hsl(267, 30%, 75%);
  ...
  --code-tag: #fb464c;
  --code-value: #a882ff;
  --collapse-icon-color: hsl(267, 30%, 75%);
  --collapse-icon-color-collapsed: hsl(184, 81.6%, 74.75%);
  --color-accent: hsl(187, 80%, 65%);
  --color-accent-1: hsl(184, 81.6%, 74.75%);
  --color-accent-2: hsl(182, 84%, 83.85%);
  --color-accent-hsl: 187, 80%, 65%;
  --divider-color: transparent;
  --divider-color-hover: hsl(187, 80%, 65%);
  ...
  --font-weight: 400;
  --graph-line: hsl(184, 81.6%, 74.75%);
  --graph-node: hsl(184, 81.6%, 74.75%);
  --graph-node-attachment: #e0de71;
  --graph-node-focused: hsl(184, 81.6%, 74.75%);
  --graph-node-tag: #44cf6e;
  --graph-node-unresolved: hsl(267, 30%, 75%);
  --graph-text: #dadada;
  --h5-line-height: 1.5;
  --h6-line-height: 1.5;
  --heading-formatting: hsl(267, 30%, 75%);
  --heading-spacing: 2.5rem;
  --hr-color: #363636;
  --interactive-accent: hsl(187, 80%, 65%);
  --interactive-accent-hover: hsl(184, 81.6%, 74.75%);
  --interactive-accent-hsl: 187, 80%, 65%;
  --interactive-hover: #3f3f3f;
  --interactive-normal: #363636;
  --italic-color: hsl(247, 50%, 75%);
  --link-color: hsl(187, 80%, 82%);
  --link-color-hover: hsl(187, 80%, 87%);
  --link-external-color: hsl(184, 81.6%, 74.75%);
  --link-external-color-hover: hsl(182, 84%, 83.85%);
  --link-unresolved-color: hsl(184, 81.6%, 74.75%);
  --link-unresolved-decoration-color: hsla(187, 80%, 65%, 0.3);
  --link-weight: 400;
  --list-indent: 3em;
  --menu-background: hsl(197, 5%, 30%);
  ...
  --pdf-background: hsl(177, 15%, 10%);
  --pdf-page-background: hsl(177, 15%, 10%);
  --pdf-shadow: 0 0 0 1px #363636;
  --pdf-sidebar-background: hsl(177, 15%, 10%);
  ...
  --shiki-gutter-text-color: hsl(267, 30%, 75%);
  ...
  --shiki-terminal-dots-color: hsl(267, 30%, 75%);
  --shiki-tooltip-background: rgba(0, 0, 0, 0.9);
  --suggestion-background: hsl(177, 15%, 10%);
  ...
  --tab-switcher-background: hsl(197, 5%, 30%);
  --tab-switcher-menubar-background: linear-gradient(to top, hsl(197, 5%, 30%), transparent);
  --tab-switcher-preview-radius: 16px;
  --tab-switcher-preview-shadow: 0 0 0 1px rgba(255, 255, 255, 0.05);
  --tab-switcher-preview-shadow-active: 0 0 0 2px hsl(187, 80%, 65%);
  --tab-text-color: hsl(267, 30%, 75%);
  ...
  --tab-text-color-focused-highlighted: hsl(184, 81.6%, 74.75%);
  ...
  --table-drag-handle-background-active: hsl(187, 80%, 65%);
  --table-drag-handle-color: hsl(267, 30%, 75%);
  ...
  --table-selection: hsla(187, 80%, 65%, 0.1);
  --table-selection-blend-mode: lighten;
  --table-selection-border-color: hsl(187, 80%, 65%);
  --table-text-size: 16px;
  --tag-background: hsla(187, 80%, 65%, 0.1);
  --tag-background-hover: hsla(187, 80%, 65%, 0.2);
  --tag-border-color: hsla(187, 80%, 65%, 0.15);
  --tag-border-color-hover: hsla(187, 80%, 65%, 0.15);
  --tag-color: hsl(184, 81.6%, 74.75%);
  --tag-color-hover: hsl(184, 81.6%, 74.75%);
  --tag-size: 0.875em;
  --text-accent: hsl(184, 81.6%, 74.75%);
  --text-accent-hover: hsl(182, 84%, 83.85%);
  --text-error: #fb464c;
  --text-faint: hsl(267, 30%, 75%);
  --text-highlight-bg: rgba(255, 208, 0, 0.4);
  --text-important: hsl(197, 80%, 95%);
  --text-muted: white;
  --text-normal: #dadada;
  --text-selection: hsla(187, 80%, 65%, 0.33);
  --text-success: #44cf6e;
  --text-title: hsl(187, 60%, 85%);
  --text-warning: #e9973f;
  --touch-radius-l: 52px;
  --touch-radius-m: 44px;
  --touch-radius-s: 40px;
...
html[saved-theme="dark"] body .callout[data-callout="warning"] {
  ...
  background-color: rgb(22, 29, 29);
  border-bottom-color: rgb(138, 236, 243);
  border-left-color: rgb(138, 236, 243);
  border-right-color: rgb(138, 236, 243);
  border-top-color: rgb(138, 236, 243);
}

html[saved-theme="dark"] body .search > .search-container > .search-space {
  background-color: var(--prompt-background, rgb(22, 29, 29));
...
html[saved-theme="dark"] body .search > .search-container > .search-space > .search-layout > .results-container > .result-card:hover, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container > .result-card:focus, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container > .result-card.focus:not(:has(~ .result-card:hover, html[saved-theme="dark"] ~ .result-card:focus)) {
  background-color: var(--background-secondary, rgb(73, 78, 80));
}
...
html[saved-theme="dark"] body .search > .search-container > .search-space > input {
  border-bottom-color: rgb(73, 78, 80);
...
html[saved-theme="dark"] body a.internal-link.tag-link, html[saved-theme="dark"] .search > .search-container > .search-space > .search-layout > .results-container .result-card > ul > li > .match-tag {
  background-color: var(--pill-background, rgba(94, 220, 237, 0.1));
  border-bottom-color: rgba(94, 220, 237, 0.15);
  border-left-color: rgba(94, 220, 237, 0.15);
  border-right-color: rgba(94, 220, 237, 0.15);
  border-top-color: rgba(94, 220, 237, 0.15);
}

html[saved-theme="dark"] body a.internal-link.tag-link::before {
  color: rgb(138, 236, 243);
}
...
html[saved-theme="dark"] body .nav-files-container li:has(> .folder-outer.open) > .nav-folder-title {
  color: var(--text-important, rgb(232, 247, 252));
}
...
html[saved-theme="dark"] body .nav-files-container li:has(> .folder-outer:not(.open)) > .nav-folder-title {
  ...
  border-bottom-color: rgb(209, 245, 250);
  border-left-color: rgb(209, 245, 250);
  border-right-color: rgb(209, 245, 250);
  border-top-color: rgb(209, 245, 250);
  color: var(--icon-color, rgb(209, 245, 250));
}`,
    footer: `html[saved-theme="dark"] body footer {
  background-color: var(--status-bar-background, rgb(46, 56, 54));
  border-bottom-color: rgb(138, 236, 243);
  border-left-color: rgb(138, 236, 243);
  border-left-width: 0px;
  border-right-color: rgb(138, 236, 243);
...
html[saved-theme="dark"] body footer ul li a {
  ...
  background-color: var(--colorful, rgb(54, 71, 73));
...
html[saved-theme="dark"] body .darkmode svg {
  color: var(--icon-color, rgb(209, 245, 250));
  stroke: rgb(209, 245, 250);
}`,
    breadcrumbs: `html[saved-theme="dark"] body .breadcrumb-container {
  border-bottom-color: rgb(194, 234, 240);
  border-left-color: rgb(194, 234, 240);
  border-right-color: rgb(194, 234, 240);
  border-top-color: rgb(194, 234, 240);
  color: rgb(194, 234, 240);
}
...
html[saved-theme="dark"] body .note-properties-tags {
  background-color: var(--pill-background, rgba(94, 220, 237, 0.1));
  color: var(--pill-color, rgb(138, 236, 243));
}
...
html[saved-theme="dark"] body input[type=text] {
  border-bottom-color: rgb(232, 247, 252);
  border-left-color: rgb(232, 247, 252);
  border-right-color: rgb(232, 247, 252);
  border-top-color: rgb(232, 247, 252);
  color: var(--text-important, rgb(232, 247, 252));
}
...
html[saved-theme="dark"] body ul.tags > li {
  background-color: var(--tag-background, rgb(46, 56, 54));
  border-bottom-color: rgba(94, 220, 237, 0.15);
  border-left-color: rgba(94, 220, 237, 0.15);
  border-right-color: rgba(94, 220, 237, 0.15);
  border-top-color: rgba(94, 220, 237, 0.15);
  ...
  --accent-l: 70%;
  --accent-s: 70%;
  --background-highlight: hsl(calc(var(--accent-h) + 40), calc(var(--accent-s) - 60%), calc(var(--accent-l) + 21%));
  --background-modifier-active-hover: hsla(var(--interactive-accent-hsl), 0.15);
  --background-modifier-hover: rgba(var(--mono-rgb-100), 0.075);
  ...
  --background-search: hsl(calc(var(--accent-h) + 10), calc(var(--accent-s) - 40%), calc(var(--accent-l) + 15%));
  ...
  --text-important: hsl(calc(var(--accent-h) + 30), calc(var(--accent-s) - 10%), calc(var(--accent-l) - 40%));
...
html[saved-theme="light"] body .text-highlight {
  background-color: var(--text-highlight-bg, rgb(234, 234, 230));
}
...
html[saved-theme="light"] body .callout[data-callout="anki"] {
  ...
  --A10: hsl(48, 30%, 86%);
  --A11: hsl(38, 30%, 86%);
  --background-highlight: hsl(68, 10%, 91%);
  ...
  --background-search: hsl(38, 30%, 85%);
...
html[saved-theme="light"] body .nav-files-container li:has(> .folder-outer.open) > .nav-folder-title {
  color: var(--text-important, rgb(122, 119, 31));
}
...
html[saved-theme="light"] body input[type=text] {
  border-bottom-color: rgb(122, 119, 31);
  border-left-color: rgb(122, 119, 31);
  border-right-color: rgb(122, 119, 31);
  border-top-color: rgb(122, 119, 31);
  color: var(--text-important, rgb(122, 119, 31));
}
