...
export const theme: ThemeData = {
  meta: {
    ...
    variations: [],
    fonts: [],
    styleSettingsId: "mvahaste-meridian",
  },
  dark: {
  ...
  --blockquote-border-color: var(--text-muted, #707070);
  ...
  --checkbox-marker-color: var(--background-secondary, #141414);
  ...
  --titlebar-background-focused: var(--background-primary, transparent);
...
html[saved-theme="dark"] body .search > .search-container > .search-space {
  background-color: var(--modal-background, rgb(20, 20, 20));
}
...
html[saved-theme="dark"] body sup {
  ...
  --blockquote-border-color: var(--text-muted, #b5b3b1);
  --blockquote-color: var(--text-muted, #b5b3b1);
  ...
  --checkbox-marker-color: var(--background-secondary, #fcfcfc);
  ...
  --titlebar-background-focused: var(--background-primary, #f7f7f7);
...
html[saved-theme="light"] body ul.overflow {
  ...
  color: var(--blockquote-color, rgb(181, 179, 177));
  line-height: 25.6px;
}`,
...
html[saved-theme="light"] body .search > .search-container > .search-space {
  background-color: var(--modal-background, rgb(252, 252, 252));
}
...
.hide-tab-bar-dynamic .mod-root .workspace-tabs:not(.mod-stacked):not( :has(.workspace-tab-header:nth-of-type(2)) ) .workspace-tab-header-container {
max-height: 0;
opacity: 0;
}`,
    },
...
.hide-file-explorer-nav-header-dynamic .workspace-leaf-content[data-type="file-explorer"]:hover .nav-header {
max-height: 2.5em;
opacity: 1;
}`,
    },
...
.deemphasize-status-bar .status-bar:hover, .deemphasize-status-bar .status-bar:focus-within {
filter: saturate(1);
opacity: 1;
}`,
    },
...
.deemphasize-file-properties .metadata-container:hover, .deemphasize-file-properties .metadata-container:focus-within {
filter: grayscale(0);
opacity: 1;
}`,
    },
...
.deemphasize-embedded-backlinks .embedded-backlinks:hover, .deemphasize-embedded-backlinks .embedded-backlinks:focus-within {
filter: grayscale(0);
opacity: 1;
}`,
    },
