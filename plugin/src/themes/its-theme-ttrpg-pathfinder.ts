...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --shiki-active-tab-border-color: #5C1C16 !important;
  --shiki-code-background: #E0DACB !important;
  --shiki-code-block-border-radius: 0 !important;
  --shiki-code-comment: #4e5b6f !important;
  --shiki-code-normal: #5C1C16 !important;
  --shiki-code-punctuation: #5C1C16 !important;
  --shiki-gutter-border-color: #00000060 !important;
  --shiki-gutter-text-color: #4e5b6f !important;
  --shiki-gutter-text-color-highlight: #5C1C16 !important;
  --shiki-highlight-neutral: #5C1C16 !important;
  --shiki-terminal-dots-color: #4e5b6f !important;
  --shiki-tooltip-background: #800008 !important;
...
html[saved-theme="light"] body .callout[data-callout="aside"] {
  ...
  border-top-style: solid;
  border-top-width: 0px;
  box-shadow: rgb(128, 0, 8) 4.8px 4.8px 0px 0px, rgb(128, 0, 8) 0px 0px 0px 1px;
  color: rgb(57, 54, 54);
  font-family: "??", Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Microsoft YaHei Light", sans-serif;
  line-height: 24px;
  margin-bottom: 5px;
