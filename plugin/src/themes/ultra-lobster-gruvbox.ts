...
html[saved-theme="light"] body figure[data-rehype-pretty-code-figure] {
  background-color: rgba(0, 0, 0, 0);
  border-bottom-color: color(srgb 0.235294 0.219608 0.211765 / 0.08);
  border-bottom-left-radius: 12px;
  border-bottom-right-radius: 12px;
  border-bottom-width: 1px;
  border-left-color: color(srgb 0.235294 0.219608 0.211765 / 0.08);
  border-left-width: 1px;
  border-right-color: color(srgb 0.235294 0.219608 0.211765 / 0.08);
  border-right-width: 1px;
  border-top-color: color(srgb 0.235294 0.219608 0.211765 / 0.08);
  border-top-left-radius: 12px;
  border-top-right-radius: 12px;
  border-top-width: 1px;
}
