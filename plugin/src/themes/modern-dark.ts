...
export const theme: ThemeData = {
  ...
  --background-modifier-border: #6a6a6a !important;
  ...
  --background-secondary: #252526 !important;
  --background-secondary-alt: #353535 !important;
  --bases-cards-cover-background: #1e1e1e !important;
  --bases-cards-shadow: 0 0 0 1px #6a6a6a !important;
  --bases-embed-border-color: #6a6a6a !important;
  --bases-table-border-color: #6a6a6a !important;
  ...
  --code-blue: #569cd6 !important;
  --code-border-color: #6a6a6a !important;
  --code-bright-orange: #ff2d00 !important;
  --code-comment: rgb(81, 86, 99) !important;
  --code-green: #6a9955 !important;
  --code-light-blue: #9cdcfe !important;
  --code-light-green: #4ec9b0 !important;
  --code-orange: #ce9178 !important;
  --code-pink: #c586c0 !important;
  --code-yellow: #dcdcaa !important;
  --collapse-icon-color: rgb(81, 86, 99) !important;
  --collapse-icon-color-collapsed: #569cd6 !important;
  --content-code-line: #00b0ff !important;
  --content-font-family: "Helvetica Neue", Helvetica, Avenir, Avenir Next, Arial, "Lucida Grande", sans-serif !important;
  --content-font-family-code: Consolas, monaco, monospace !important;
  --content-font-size-normal: 18px !important;
  --content-search-result: rgba(0, 127, 212, 0.4) !important;
  --content-tab-border: #6a6a6a !important;
  --content-text-bold: #4ec9b0 !important;
  --content-text-highlighted: #353535 !important;
  --content-text-highlighted-bg: #dfe14d !important;
  --content-text-italic: #dcdcaa !important;
  --content-text-normal: #dedede !important;
  --content-text-selection: rgba(0, 127, 212, 0.4) !important;
  --content-text-strikethrough: #b0b0b0 !important;
  --content-title-font-weight: 600 !important;
  --content-title-h1: #569cd6 !important;
  --content-title-h2: #dcdcaa !important;
  --content-title-h3: #9cdcfe !important;
  --content-title-h4: #c586c0 !important;
  --content-title-h5: #ce9178 !important;
  --content-title-h6: #4ec9b0 !important;
  --content-title-line-height: 1 !important;
  --cyan: #00b0ff !important;
  --divider-color: #6a6a6a !important;
  --divider-color-hover: #4c78cc !important;
  --dropdown-background: #20242b !important;
  --dropdown-background-hover: #353b47 !important;
  --embed-block-shadow-hover: 0 0 0 1px #6a6a6a, inset 0 0 0 1px #6a6a6a !important;
  --embed-border-start: 2px solid #4c78cc !important;
  --file-browser-lines: #252526 !important;
  --file-browser-lines-hover: #569cd6 !important;
  --file-color: #b0b0b0 !important;
  --file-hover: #569cd6 !important;
  --flair-background: #20242b !important;
  --folder-color: #569cd6 !important;
  --folder-hover: #569cd6 !important;
  --font-weight-title: 600 !important;
  --footnote-divider-color: #6a6a6a !important;
  --footnote-id-color-no-occurrences: rgb(81, 86, 99) !important;
  --graph-node-focused: #569cd6 !important;
  --graph-node-unresolved: rgb(81, 86, 99) !important;
  --gray: rgb(81, 86, 99) !important;
  --heading-formatting: rgb(81, 86, 99) !important;
  --hr-color: #6a6a6a !important;
  --icon-color-active: #569cd6 !important;
  ...
  --lightgray: #252526 !important;
  --line-height-headers: 1 !important;
  --link-color: #569cd6 !important;
  --link-color-hover: #ff5555 !important;
  --link-external-color: #569cd6 !important;
  --link-external-color-hover: #ff5555 !important;
  --link-unresolved-color: #569cd6 !important;
  --list-marker-color: rgb(81, 86, 99) !important;
  --list-marker-color-collapsed: #569cd6 !important;
  --menu-background: #252526 !important;
  --metadata-border-color: #6a6a6a !important;
  --metadata-divider-color: #6a6a6a !important;
  ...
  --nav-item-color-highlighted: #569cd6 !important;
  --nav-tag-color: rgb(81, 86, 99) !important;
  --panel-border-color: #18191e !important;
  --pdf-shadow: 0 0 0 1px #6a6a6a !important;
  --pdf-thumbnail-shadow: 0 0 0 1px #6a6a6a !important;
  --pill-border-color: #6a6a6a !important;
  --pill-color-remove: rgb(81, 86, 99) !important;
  --pill-color-remove-hover: #569cd6 !important;
  ...
  --ribbon-background: #252526 !important;
  --secondary: #569cd6 !important;
  --setting-items-background: #1e1e1e !important;
  --setting-items-border-color: #6a6a6a !important;
  --slider-track-background: #6a6a6a !important;
  --special-file-color: #569cd6 !important;
  --status-bar-background: #252526 !important;
  --status-bar-border-color: #6a6a6a !important;
  --tab-container-background: #252526 !important;
  --tab-outline-color: #6a6a6a !important;
  --tab-switcher-background: #252526 !important;
  --tab-switcher-menubar-background: linear-gradient(to top, #252526, transparent) !important;
  --tab-text-color: rgb(81, 86, 99) !important;
  --tab-text-color-focused-highlighted: #569cd6 !important;
  --table-add-button-border-color: #6a6a6a !important;
  --table-border-color: #6a6a6a !important;
  ...
  --table-header-border-color: #6a6a6a !important;
  --table-selection-border-color: #4c78cc !important;
  --tag-color: #569cd6 !important;
  --tag-color-hover: #569cd6 !important;
  --tertiary: #ff5555 !important;
  --text-accent: #569cd6 !important;
  --text-accent-hover: #ff5555 !important;
  ...
  --text-selection: rgba(0, 127, 212, 0.4) !important;
  --theme-accent-color: #569cd6 !important;
  --theme-accent-contrast: #000000 !important;
  --theme-active-tab: #1e1e1e !important;
  --theme-inactive-tab: #2d2d2d !important;
  --theme-side-panel-background: #252526 !important;
  --theme-side-panel-contrast: #37373d !important;
  --theme-side-panel-text: #b0b0b0 !important;
  --theme-text-background: #1e1e1e !important;
  --theme-text-input: #1e1e1e !important;
  --theme-window-background: #353535 !important;
  --theme-window-light: #3f3f3f !important;
  --theme-window-text: #fcfcfc !important;
  --titlebar-background: #252526 !important;
  --titlebar-background-focused: #353535 !important;
  --titlebar-border-color: #6a6a6a !important;
  --window-manager-titlebar: #3f3f3f !important;
...
html body html {
  ...
  --content-search-result: rgba(0, 127, 212, 0.4);
  --content-tab-border: #6a6a6a;
  --content-text-bold: #4ec9b0;
  --content-text-highlighted: #353535;
  --content-text-highlighted-bg: #dfe14d;
  --content-text-italic: #dcdcaa;
  ...
  --content-title-h1: #569cd6;
  --content-title-h2: #dcdcaa;
  --content-title-h3: #9cdcfe;
  --content-title-h4: #c586c0;
  --content-title-h5: #ce9178;
  --content-title-h6: #4ec9b0;
  --content-title-line-height: 1;
  --cyan: #00b0ff;
  --file-hover: #569cd6;
  --folder-hover: #569cd6;
  --theme-accent-color: #569cd6;
  ...
  outline: rgb(78, 201, 176) none 0px;
  text-decoration-color: rgb(78, 201, 176);
}
...
html body .text-highlight {
  background-color: rgb(223, 225, 77);
  color: rgb(53, 53, 53);
  font-family: "Helvetica Neue", Helvetica, Avenir, "Avenir Next", Arial, "Lucida Grande", sans-serif;
...
html body p {
  ...
  text-decoration-color: rgb(86, 156, 214);
}
...
html body th {
  ...
  border-top-color: rgb(106, 106, 106);
    ...
    code: `html body code {
  border-bottom-color: rgb(0, 176, 255);
  border-left-color: rgb(0, 176, 255);
  border-right-color: rgb(0, 176, 255);
  border-top-color: rgb(0, 176, 255);
  color: rgb(0, 176, 255);
}
