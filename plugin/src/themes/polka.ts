...
html[saved-theme="dark"] body blockquote {
  color: var(--blockquote-color, rgb(250, 247, 245));
  font-family: "??", "??", "Franklin Gothic Book", Rubik, "Helvetica Neue", ui-sans-serif, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif;
  line-height: 20px;
}`,
...
html[saved-theme="dark"] body .metadata-property-key {
  color: rgb(250, 247, 245);
  font-family: var(--metadata-label-font, "??", "Franklin Gothic Book", Rubik, "Helvetica Neue", ui-sans-serif, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif, "??", "Franklin Gothic Book", Rubik, "Helvetica Neue", ui-sans-serif, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif);
}

html[saved-theme="dark"] body .metadata-property-value {
  color: rgb(250, 247, 245);
  font-family: var(--metadata-input-font, "??", "Franklin Gothic Book", Rubik, "Helvetica Neue", ui-sans-serif, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif, "??", "Franklin Gothic Book", Rubik, "Helvetica Neue", ui-sans-serif, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif);
}
