...
export const theme: ThemeData = {
  ...
  --nav-item-background-selected: var(--text-selection, oklch(from oklch(from oklch(from hsl(258, 88%, 66%) l c h) l c calc(h + 5)) 45% c h / 75%));
...
html[saved-theme="dark"] body .metadata-container .metadata-property {
  background-color: var(--metadata-property-background, oklch(0.24 0.0651659 297.489));
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  --nav-indentation-guide-width: var(--indentation-guide-width, 2px);
  --nav-item-background-selected: var(--text-selection, oklch(from oklch(from oklch(from hsl(calc(258 - 1), calc(88% * 1.01), calc(66% * 1.075)) l c h) l c calc(h + 5)) 80% 30% h / 75%));
  --nav-item-radius: var(--button-border-radius, 8px);
...
html[saved-theme="light"] body .metadata-container .metadata-property {
  background-color: var(--metadata-property-background, oklch(0.98 0.0756873 298.559));
