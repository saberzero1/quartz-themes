...
export const theme: ThemeData = {
  ...
  --accent: #378876 !important;
  --accent-color: 55, 136, 118 !important;
  --accent-h: 0 !important;
  --accent-l: 49% !important;
  --accent-s: 49% !important;
  --accent-text: #dcddde !important;
  --accent2: #5cb2d6 !important;
  --accent2-lite: #49d8e2 !important;
  --aside-bg: #11151d !important;
  --background-modifier-active-hover: #216565 !important;
  --background-modifier-border: #2b4448 !important;
  --background-modifier-border-focus: #378876 !important;
  --background-modifier-border-hover: #1e2f33 !important;
  --background-modifier-cover: rgba(6, 12, 12, 0.38) !important;
  --background-modifier-error: #772d2d !important;
  --background-modifier-form-field: rgba(6, 12, 12, 0.38) !important;
  --background-modifier-form-field-hover: rgba(6, 12, 12, 0.38) !important;
  --background-modifier-hover: rgba(52, 237, 181, 0.13) !important;
  --background-modifier-message: #216565 !important;
  --background-modifier-success: #32603e !important;
  --background-primary: #1a1e24 !important;
  --background-primary-alt: #103F3D !important;
  --background-secondary: #1a1e24 !important;
  --background-secondary-alt: #0b0f13 !important;
  --bases-cards-background: #1a1e24 !important;
  --bases-cards-cover-background: #103F3D !important;
  --bases-cards-font-size: .90em !important;
  --bases-cards-radius: 0 !important;
  --bases-cards-shadow: 0 0 0 1px #2b4448 !important;
  --bases-cards-shadow-hover: 0 0 0 1px #1e2f33 !important;
  --bases-embed-border-color: #2b4448 !important;
  ...
  --bases-table-cell-background-disabled: #103F3D !important;
  --bases-table-cell-background-selected: hsla(0, 49%, 49%, 0.1) !important;
  --bases-table-cell-shadow-active: 0 0 0 2px #378876 !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px #216565 !important;
  --bases-table-container-border-radius: 0 !important;
  --bases-table-font-size: .90em !important;
  --bases-table-group-background: #103F3D !important;
  --bases-table-header-background: #1a1e24 !important;
  --bases-table-header-background-hover: rgba(52, 237, 181, 0.13) !important;
  --bases-table-header-color: #97a1b9 !important;
  --bases-table-row-background-hover: rgba(60, 168, 131, 0.25) !important;
  --bases-table-summary-background: #1a1e24 !important;
  --bases-table-summary-background-hover: rgba(52, 237, 181, 0.13) !important;
  --bg: #1e2f33 !important;
  --blockquote-background-color: #0d1014 !important;
  --blockquote-border-color: #1e2f33 !important;
  ...
  --bttn: #216565 !important;
  --bullet: "\\e802" !important;
  --bullet-font: "its" !important;
  --button-background: #216565 !important;
  --button-background-hover: #2b5b77 !important;
  --button-border: #216565 !important;
  ...
  --checkbox-border-color: #378876 !important;
  --checkbox-border-color-hover: #216565 !important;
  --checkbox-color: #378876 !important;
  --checkbox-color-hover: #216565 !important;
  --checkbox-marker-color: #1a1e24 !important;
  --checkbox-radius: 0 !important;
  --checklist-done-color: #2b5b77 !important;
  ...
  --dark-accent: #216565 !important;
  --dark-sidebar: #0d1014 !important;
  --darkgray: #bccad8 !important;
  --dataview-table-width: 100% !important;
  --dataview-th-alt-color: rgba(55, 136, 118, 0.1) !important;
  --dataview-th-background: #0b0f13 !important;
  --dataview-th-border-bottom: 2px solid #399F94 !important;
  --dataview-th-color: #399F94 !important;
  --dataview-th-count-color: #399F94 !important;
  ...
  --embed-border-left: 2px solid #399F94 !important;
  --embed-border-left-color: #399F94 !important;
  --embed-border-left-color-hover: #399F94 !important;
  ...
  --embed-border-start: 2px solid #216565 !important;
  ...
  --file-header-breadcrumb-color: #2b5b77 !important;
  --file-header-breadcrumb-font-size: 13.5px !important;
  --file-header-color: #2b5b77 !important;
  ...
  --folder: #399F94 !important;
  --folder-font: "its" !important;
  --folder-icon: "\\e801" !important;
  --folder-icon-color: #399F94 !important;
  --folder-icon-open-color: #58c8e0 !important;
  --folder-open: #58c8e0 !important;
  --folder-open-text-color: #bccad8 !important;
  --folder-text-color: #71a6b7 !important;
  ...
  --graph-fill: #6CE0D3 !important;
  --graph-focused: #49d8e2 !important;
  --graph-img: #5cb2d6 !important;
  --graph-line: #04303d !important;
  --graph-line-hover: #378876 !important;
  --graph-lines: #04303d !important;
  --graph-node: #bccad8 !important;
  --graph-node-attachment: #5cb2d6 !important;
  --graph-node-focused: #49d8e2 !important;
  --graph-node-hover-fill: #6CE0D3 !important;
  --graph-node-hover-outline: #e5ebee !important;
  --graph-node-tag: #216565 !important;
  --graph-node-unresolved: #2b5b77 !important;
  --graph-tag: #216565 !important;
  --graph-text: #bccad8 !important;
  --gray: #97a1b9 !important;
  --h1-background: transparent !important;
  --h1-border-color: #399F94 !important;
  --h1-border-left-color: #2b4448 !important;
  --h1-border-line-color: #2b4448 !important;
  --h1-border-line-height: 4px !important;
  --h1-border-line-width: 100% !important;
  --h1-border-right-color: #2b4448 !important;
  --h1-border-width: 0 !important;
  --h1-color: #399F94 !important;
  ...
  --h2-border-color: #378876 !important;
  --h2-border-left-color: #2b4448 !important;
  --h2-border-line-color: #2b4448 !important;
  --h2-border-line-height: 4px !important;
  --h2-border-line-width: 85% !important;
  --h2-border-right-color: #2b4448 !important;
  --h2-border-width: 0 !important;
  --h2-color: #399F94 !important;
  ...
  --h3-border-color: #2b5b77 !important;
  --h3-border-left-color: #2b4448 !important;
  --h3-border-line-color: #2b4448 !important;
  --h3-border-line-height: 4px !important;
  --h3-border-line-width: 65% !important;
  --h3-border-right-color: #2b4448 !important;
  --h3-border-width: 0 !important;
  --h3-color: #399F94 !important;
  ...
  --h4-border-color: #204c5d !important;
  --h4-border-left-color: #2b4448 !important;
  --h4-border-line-color: #2b4448 !important;
  --h4-border-line-height: 4px !important;
  --h4-border-line-width: 44% !important;
  --h4-border-right-color: #2b4448 !important;
  --h4-border-width: 0 !important;
  --h4-color: #399F94 !important;
  ...
  --h5-border-color: #2b4448 !important;
  --h5-border-left-color: #2b4448 !important;
  --h5-border-line-color: #2b4448 !important;
  --h5-border-line-height: 4px !important;
  --h5-border-line-width: 25% !important;
  --h5-border-right-color: #2b4448 !important;
  --h5-border-width: 0 !important;
  --h5-color: #399F94 !important;
  ...
  --h6-border-color: #232831 !important;
  --h6-border-left-color: #2b4448 !important;
  --h6-border-line-color: #2b4448 !important;
  --h6-border-line-height: 4px !important;
  --h6-border-line-width: 0 !important;
  --h6-border-right-color: #2b4448 !important;
  --h6-border-width: 0 !important;
  --h6-color: #399F94 !important;
  ...
  --he-text-on-accent-active: #399F94 !important;
  --he-text-on-accent-inactive: #bccad8 !important;
  --he-title-bar-active-action: #6CE0D3 !important;
  ...
  --he-title-bar-inactive-fg: #2b5b77 !important;
  ...
  --header-border-line-color: #2b4448 !important;
  ...
  --headers: #399F94 !important;
  --heading-formatting: #2b5b77 !important;
  --heading-spacing: 10px !important;
  --heading-spacing-bottom: 10px !important;
  --heading-spacing-top: 10px !important;
  --highlight: rgba(60, 168, 131, 0.25) !important;
  --hr: #0f465d !important;
  --hr-alignment: -50%, -50% !important;
  --hr-color: #0f465d !important;
  --hr-icon-background: #1a1e24 !important;
  --hr-icon-color: #399F94 !important;
  --hr-icon-font: "Material Icons Sharp" !important;
  --hr-icon-padding-x: 4px !important;
  --hr-icon-symbol: "\\f1cd" !important;
  --hr-text-offset: 12px !important;
  --hr-width: auto !important;
  --hvr: rgba(115, 253, 190, 0.25) !important;
  --hvr-active: rgba(52, 237, 181, 0.13) !important;
  --hvr2: rgba(60, 168, 131, 0.25) !important;
  ...
  --illusion-h1-background: #399F94 !important;
  --illusion-h2-background: #378876 !important;
  --illusion-h3-background: #2b5b77 !important;
  --illusion-h4-background: #204c5d !important;
  --illusion-h5-background: #2b4448 !important;
  --illusion-h6-background: #232831 !important;
  ...
  --image-border-background: rgba(6, 12, 12, 0.38) !important;
  --image-border-color: #2b4448 !important;
  --image-border-padding: 8px !important;
  --image-border-width: 1px !important;
  --inactive: #2b5b77 !important;
  --indentation-guide-color: #1e4765 !important;
  --indentation-guide-color-active: #378876 !important;
  ...
  --initiative-tracker-border: #1e4765 !important;
  --initiative-xp: sandybrown !important;
  --inline-title-color: #399F94 !important;
  ...
  --interactive-accent: #216565 !important;
  --interactive-accent-hover: #2b5b77 !important;
  --interactive-accent-hsl: 0, 49%, 49% !important;
  --interactive-hover: #2b5b77 !important;
  ...
  --kanban-link-color: #49d8e2 !important;
  --kanban-tag-background: #1A5753 !important;
  --latex-color: #6CE0D3 !important;
  --latex-format-color: #2b5b77 !important;
  --latex-syntax-color: #97a1b9 !important;
  --light: #1a1e24 !important;
  --lightgray: #1a1e24 !important;
  --line-height-tight: 1.3em !important;
  --lines: #1e4765 !important;
  --link-background: transparent !important;
  --link-background-hover: transparent !important;
  --link-border: none !important;
  --link-color: #49d8e2 !important;
  --link-color-hover: #6CE0D3 !important;
  --link-decoration: none !important;
  --link-decoration-hover: none !important;
  --link-external-color: #49d8e2 !important;
  --link-external-color-hover: #5cb2d6 !important;
  --link-external-decoration: none !important;
  --link-transform: none !important;
  --link-unresolved-color: #2b5b77 !important;
  --link-unresolved-decoration-color: hsla(0, 49%, 49%, 0.3) !important;
  --link-unresolved-opacity: 1 !important;
  --list-bullet-box-shadow-color: #2b4448 !important;
  --list-bullet-radius: 0 !important;
  --list-bullet-size: 6.4px !important;
  --list-bullet-transform: rotate(45deg) !important;
  --list-color-1: #1e4765 !important;
  --list-color-2: #1e4765 !important;
  --list-color-3: #1e4765 !important;
  --list-color-4: #1e4765 !important;
  --list-color-5: #1e4765 !important;
  --list-color-6: #1e4765 !important;
  --list-indent: 25px !important;
  --list-marker-color: #378876 !important;
  --list-marker-color-collapsed: #2b5b77 !important;
  --list-marker-color-hover: #97a1b9 !important;
  --list-marker-color-other: #5cb2d6 !important;
  --list-marker-min-width: 0 !important;
  --list-numbered-color: #6CE0D3 !important;
  --list-spacing: 1px !important;
  --lite-accent: #6CE0D3 !important;
  ...
  --menu-border-color: #1e2f33 !important;
  ...
  --metadata-border-color: #2b4448 !important;
  --metadata-button-text-color: #2b5b77 !important;
  --metadata-divider-color: #2b4448 !important;
  --metadata-icon-color: #97a1b9 !important;
  --metadata-input-background-active: rgba(6, 12, 12, 0.38) !important;
  ...
  --metadata-label-background-active: rgba(6, 12, 12, 0.38) !important;
  ...
  --metadata-property-background-active: rgba(52, 237, 181, 0.13) !important;
  --metadata-property-box-shadow-focus: 0 0 0 2px #378876 !important;
  --metadata-property-box-shadow-hover: 0 0 0 1px #1e2f33 !important;
  ...
  --modal-nav-item-background-hover: rgba(6, 12, 12, 0.38) !important;
  ...
  --nav-indentation-guide-color: #1e4765 !important;
  --nav-indentation-guide-width: 2px !important;
  --nav-item-background-active: #216565 !important;
  --nav-item-background-border-color-hover: #216565 !important;
  --nav-item-background-hover: #216565 !important;
  --nav-item-background-selected: rgba(115, 253, 190, 0.25) !important;
  --nav-item-border-color: #6CE0D3 !important;
  ...
  --note-title-border-color: #399F94 !important;
  ...
  --pdf-shadow: 0 0 0 1px #2b4448 !important;
  --pdf-sidebar-background: #1a1e24 !important;
  --pdf-thumbnail-shadow: 0 0 0 1px #2b4448 !important;
  --pill-border-color: #2b4448 !important;
  --pill-border-color-hover: #1e2f33 !important;
  --pill-color: #97a1b9 !important;
  --pill-color-hover: #bccad8 !important;
  --pill-color-remove: #4e5b6f !important;
  --pill-color-remove-hover: #49d8e2 !important;
  ...
  --r-progress-color: #6CE0D3 !important;
  ...
  --scrollbar-active-thumb-bg: #6CE0D3 !important;
  --scrollbar-bg: #1e2f33 !important;
  --scrollbar-border-width: 0 !important;
  --scrollbar-radius: 0 !important;
  --scrollbar-thumb-bg: #1A5753 !important;
  ...
  --secondary: #49d8e2 !important;
  --setting-group-heading-color: #bccad8 !important;
  --setting-item-alt-background-hover: rgba(6, 12, 12, 0.38) !important;
  --setting-item-background-hover: rgba(115, 253, 190, 0.25) !important;
  --setting-item-border-color: #2b4448 !important;
  --setting-item-heading-background: transparent !important;
  --setting-item-heading-border: 2px solid #399F94 !important;
  --setting-item-padding: 10px 15px !important;
  --setting-items-alt-background: transparent !important;
  --setting-items-alt-background-hover: rgba(6, 12, 12, 0.38) !important;
  --setting-items-background: transparent !important;
  --setting-items-border-color: #2b4448 !important;
  ...
  --shiki-gutter-border-color: #2b4448 !important;
  ...
  --shiki-tooltip-background: #216565 !important;
  ...
  --sidebar-tab-background-color: #216565 !important;
  --sidebar-tab-background-color-hover: #378876 !important;
  --sidebar-tab-border-color: transparent !important;
  --sidebar-tab-border-color-active: #216565 !important;
  ...
  --statblock-heading-font-color: #399F94 !important;
  ...
  --statblock-image-border-color: #0f465d !important;
  --statblock-primary-color: #bccad8 !important;
  --statblock-property-font-color: #bccad8 !important;
  --statblock-property-name-font-color: #399F94 !important;
  --statblock-rule-color: #378876 !important;
  --statblock-section-heading-border-color: #2b4448 !important;
  ...
  --status-bar-border-color: #378876 !important;
  ...
  --style-settings-heading-background-hover: #216565 !important;
  ...
  --tab-switcher-preview-shadow-active: 0 0 0 2px #6CE0D3, 5px 5px 0 #0b0f13 !important;
  --tab-text-color: #2b5b77 !important;
  --tab-text-color-active: #bccad8 !important;
  --tab-text-color-focused: #2b5b77 !important;
  --tab-text-color-focused-active: #bccad8 !important;
  --tab-text-color-focused-active-current: #bccad8 !important;
  --tab-text-color-focused-highlighted: #49d8e2 !important;
  --tab-text-color-hover: #bccad8 !important;
  --tab-top-outline-width: 0 !important;
  --table: #2b4448 !important;
  --table-add-button-background: #216565 !important;
  ...
  --table-column-alt-background: rgba(6, 12, 12, 0.38) !important;
  --table-column-min-width: 3ch !important;
  --table-drag-handle-background-active: #216565 !important;
  --table-drag-handle-color: #4e5b6f !important;
  --table-drag-handle-color-active: #e5ebee !important;
  --table-header-background: #216565 !important;
  --table-header-background-hover: #378876 !important;
  ...
  --table-header-text-color: #6CE0D3 !important;
  --table-header-weight: 700 !important;
  --table-line-height: 1.3em !important;
  --table-row-alt-background: rgba(6, 12, 12, 0.38) !important;
  --table-row-alt-background-hover: rgba(60, 168, 131, 0.25) !important;
  --table-row-background-hover: rgba(60, 168, 131, 0.25) !important;
  --table-row-edit-font-size: .95em !important;
  --table-selection: hsla(0, 49%, 49%, 0.1) !important;
  --table-selection-border-color: #216565 !important;
  --table-selection-border-radius: 0 !important;
  --tag: #1A5753 !important;
  --tag-background: #1A5753 !important;
  --tag-background-color: #1A5753 !important;
  --tag-background-hover: #378876 !important;
  --tag-border-color: #1A5753 !important;
  --tag-border-color-hover: #378876 !important;
  ...
  --tag-text: #58c8e0 !important;
  --tall: 700px !important;
  --td: rgba(6, 12, 12, 0.38) !important;
  --tertiary: #5cb2d6 !important;
  --text: #bccad8 !important;
  --text-accent: #49d8e2 !important;
  --text-accent-hover: #5cb2d6 !important;
  --text-dl: #e5ebee !important;
  --text-faint: #4e5b6f !important;
  --text-highlight-bg: rgba(115, 253, 190, 0.25) !important;
  --text-highlight-bg-active: rgba(52, 237, 181, 0.13) !important;
  --text-muted: #97a1b9 !important;
  --text-normal: #bccad8 !important;
  --text-on-accent: #e5ebee !important;
  --text-selection: rgba(60, 168, 131, 0.25) !important;
  --textHighlight: rgba(115, 253, 190, 0.25) !important;
  --th: #216565 !important;
  --th-text: #e5ebee !important;
  --theme-rainbow-1: #399F94 !important;
  --theme-rainbow-2: #378876 !important;
  --theme-rainbow-3: #2b5b77 !important;
  --theme-rainbow-4: #204c5d !important;
  --theme-rainbow-5: #2b4448 !important;
  --theme-rainbow-6: #232831 !important;
  ...
  --titlebar-border-color: #2b4448 !important;
  ...
  --vault-name-color: #399F94 !important;
...
html[saved-theme="dark"] body .page > div#quartz-body div.sidebar.right {
  ...
  --font-weight: 700;
  background-color: rgb(43, 68, 72);
  border-bottom-color: rgb(57, 159, 148);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
  border-bottom-width: 0px;
  border-left-color: rgb(57, 159, 148);
  border-left-width: 0px;
  border-right-color: rgb(57, 159, 148);
  border-right-width: 0px;
  border-top-color: rgb(57, 159, 148);
...
html[saved-theme="dark"] body p {
  ...
  --zoom-multiplier: 1;
  background-color: rgba(0, 0, 0, 0);
  border-bottom-color: rgb(73, 216, 226);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
  border-bottom-width: 0px;
  border-left-color: rgb(73, 216, 226);
  border-left-width: 0px;
  border-right-color: rgb(73, 216, 226);
  border-right-width: 0px;
  border-top-color: rgb(73, 216, 226);
  border-top-left-radius: 0px;
  border-top-right-radius: 0px;
  border-top-width: 0px;
...
html[saved-theme="dark"] body .callout[data-callout="aside"] {
  ...
  border-top-style: solid;
  border-top-width: 0px;
  box-shadow: rgb(55, 136, 118) 4.8px 4.8px 0px 0px, rgb(55, 136, 118) 0px 0px 0px 1px;
  color: rgb(188, 202, 216);
  font-family: "??", Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Microsoft YaHei Light", sans-serif;
  line-height: 24px;
  margin-bottom: 5px;
...
html[saved-theme="dark"] body hr {
  ...
  border-left-color: rgb(30, 71, 101);
  border-left-width: 2px;
}
...
html[saved-theme="dark"] body ul.tags > li {
  ...
  light: {
    base: `:root:root {
  --accent: #43C1A5 !important;
  --accent-color: 67, 193, 165 !important;
  --accent-h: 0 !important;
  --accent-l: 49% !important;
  --accent-s: 49% !important;
  --accent-text: #dcddde !important;
  --accent2: #D6EAE3 !important;
  --accent2-lite: #75c8b9 !important;
  --aside-bg: #e8f9f7 !important;
  --background-modifier-active-hover: #25a99e !important;
  --background-modifier-border: #CCEBE2 !important;
  --background-modifier-border-focus: #43C1A5 !important;
  --background-modifier-border-hover: #CCEBE2 !important;
  --background-modifier-cover: rgba(145, 212, 199, 0.27) !important;
  --background-modifier-error: #772d2d !important;
  --background-modifier-form-field: rgba(145, 212, 199, 0.27) !important;
  --background-modifier-form-field-hover: rgba(145, 212, 199, 0.27) !important;
  --background-modifier-hover: rgba(119, 220, 193, 0.5) !important;
  --background-modifier-message: #25a99e !important;
  --background-modifier-success: #599049 !important;
  --background-primary: #f8fbff !important;
  --background-primary-alt: #102F26 !important;
  --background-secondary: #f8fbff !important;
  --background-secondary-alt: #eef3fd !important;
  --bases-cards-background: #f8fbff !important;
  --bases-cards-cover-background: #102F26 !important;
  --bases-cards-font-size: .90em !important;
  --bases-cards-radius: 0 !important;
  --bases-cards-shadow: 0 0 0 1px #CCEBE2 !important;
  --bases-cards-shadow-hover: 0 0 0 1px #CCEBE2 !important;
  --bases-embed-border-color: #CCEBE2 !important;
  --bases-embed-border-radius: 0 !important;
  --bases-group-heading-property-color: #4ED0B8 !important;
  --bases-group-heading-property-size: 13.5px !important;
  --bases-group-heading-value-size: .90em !important;
  --bases-table-border-color: #f8fbff !important;
  --bases-table-cell-background-active: #f8fbff !important;
  --bases-table-cell-background-disabled: #102F26 !important;
  --bases-table-cell-background-selected: hsla(0, 49%, 49%, 0.1) !important;
  --bases-table-cell-shadow-active: 0 0 0 2px #43C1A5 !important;
  --bases-table-cell-shadow-focus: 0 0 0 2px #25a99e !important;
  --bases-table-container-border-radius: 0 !important;
  --bases-table-font-size: .90em !important;
  --bases-table-group-background: #102F26 !important;
  --bases-table-header-background: #f8fbff !important;
  --bases-table-header-background-hover: rgba(119, 220, 193, 0.5) !important;
  --bases-table-header-color: #4ED0B8 !important;
  --bases-table-row-background-hover: rgba(144, 237, 231, 0.5) !important;
  --bases-table-summary-background: #f8fbff !important;
  --bases-table-summary-background-hover: rgba(119, 220, 193, 0.5) !important;
  --bg: #CCEBE2 !important;
  --blockquote-background-color: #f1f5ff !important;
  --blockquote-border-color: #CCEBE2 !important;
  --blockquote-border-thickness: 7px !important;
  ...
  --bold-modifier: 500 !important;
  --bold-weight: 900 !important;
  --box-border: 2px solid #CCEBE2 !important;
  --box-border-m: 3px solid #CCEBE2 !important;
  --box-border-s: 1px solid #CCEBE2 !important;
  --bttn: #40B1A4 !important;
  --bullet: "\\e802" !important;
  --bullet-font: "its" !important;
  --button-background: #40B1A4 !important;
  --button-background-hover: #A6DED4 !important;
  --button-border: #40B1A4 !important;
  --button-border-radius: 0 !important;
  --button-radius: 0 !important;
  --button-text: #e5ebee !important;
  --callout-margin: 5px 0;
  ...
  --chbx-q: 253, 175, 0 !important;
  --chbx-r: 249, 190, 123 !important;
  --checkbox-border-color: #43C1A5 !important;
  --checkbox-border-color-hover: #25a99e !important;
  --checkbox-color: #43C1A5 !important;
  --checkbox-color-hover: #25a99e !important;
  --checkbox-marker-color: #f8fbff !important;
  --checkbox-radius: 0 !important;
  --checklist-done-color: #A6DED4 !important;
  --checklist-done-decoration: none !important;
  --checklist-done-weight: 900 !important;
  --clickable-icon-radius: 0 !important;
  --code-background: #f1f5ff !important;
  --code-bg: #f1f5ff !important;
  --code-border-color: #CCEBE2 !important;
  --code-bracket-background: rgba(119, 220, 193, 0.5) !important;
  --code-comment: #4e5b6f !important;
  --code-normal: #69cfd2 !important;
  --code-punctuation: #4ED0B8 !important;
  --code-radius: 0 !important;
  --code-shadow: 0 2px 0 #CCEBE2 !important;
  --code-size: .90em !important;
  --code-text: #69cfd2 !important;
  --codeFont: "Fira Code", "Fira Code Medium", "Source Code Pro", monospace !important;
  --collapse-icon-color: #4e5b6f !important;
  --collapse-icon-color-collapsed: #A6DED4 !important;
  --color-accent: hsl(0, 49%, 49%) !important;
  ...
  --dark-accent: #25a99e !important;
  --dark-sidebar: #e8f9f7 !important;
  --darkgray: #697580 !important;
  --dataview-table-width: 100% !important;
  --dataview-th-alt-color: rgba(67, 193, 165, 0.1) !important;
  --dataview-th-background: #eef3fd !important;
  --dataview-th-border-bottom: 2px solid #40B1A4 !important;
  --dataview-th-color: #40B1A4 !important;
  --dataview-th-count-color: #40B1A4 !important;
  --dataview-th-count-font-size: 16px !important;
  --dataview-th-font: "Calisto MT", "Palatino Black", "Book Antiqua", "Georgia", "Suez One", serif !important;
  --dataview-th-font-size: larger !important;
  --dataview-th-font-weight: 700 !important;
  --deep-dark-accent: #102F26 !important;
  --divider-color: #eef3fd !important;
  --divider-color-hover: #43C1A5 !important;
  --divider-width: 2px !important;
  --divider-width-hover: 5px !important;
  --drag-ghost-background: #25a99e !important;
  --drag-ghost-text-color: #e5ebee !important;
  --drop-shadow: rgba(0, 74, 52, 0.08) !important;
  --dropdown-background: #eef3fd !important;
  --dropdown-background-hover: #A6DED4 !important;
  --embed-bg: #f1f5ff !important;
  --embed-block-shadow-hover: 2px 2px 0 #CCEBE2 !important;
  --embed-border: 2px solid transparent !important;
  --embed-border-bottom: 2px solid transparent !important;
  --embed-border-bottom-color: transparent !important;
  --embed-border-bottom-color-hover: #CCEBE2 !important;
  --embed-border-color: transparent !important;
  --embed-border-color-hover: #CCEBE2 !important;
  --embed-border-left: 2px solid #40B1A4 !important;
  --embed-border-left-color: #40B1A4 !important;
  --embed-border-left-color-hover: #40B1A4 !important;
  --embed-border-right: 2px solid transparent !important;
  --embed-border-right-color: transparent !important;
  --embed-border-right-color-hover: #CCEBE2 !important;
  --embed-border-start: 2px solid #25a99e !important;
  --embed-border-top: 2px solid transparent !important;
  --embed-border-top-color: transparent !important;
  --embed-border-top-color-hover: #CCEBE2 !important;
  --embed-border-type: solid !important;
  --embed-header-size: 18px !important;
  --embed-padding: 0 10px 0 24px !important;
  --embed-thickness: 2px !important;
  ...
  --file-header-breadcrumb-color: #A6DED4 !important;
  --file-header-breadcrumb-font-size: 13.5px !important;
  --file-header-color: #A6DED4 !important;
  --file-header-color-active: #697580 !important;
  --file-header-font: "Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Microsoft YaHei Light", sans-serif !important;
  --file-header-font-size: 15px !important;
  --file-header-font-weight: 600 !important;
  --file-header-left-color: #25a99e !important;
  --file-header-parent-font-weight: 600 !important;
  --file-header-right-color: #eef3fd !important;
  --file-icon: "\\e800" !important;
  --file-icon-color: #A6DED8 !important;
  --file-icon-margin: 6px !important;
  --file-text-color: #697580 !important;
  --flair-background: #eef3fd !important;
  --flair-color: #697580 !important;
  --folder: #40B1A4 !important;
  --folder-font: "its" !important;
  --folder-icon: "\\e801" !important;
  --folder-icon-color: #40B1A4 !important;
  --folder-icon-open-color: #a1d9ff !important;
  --folder-open: #a1d9ff !important;
  --folder-open-text-color: #697580 !important;
  --folder-text-color: #7EA3A2 !important;
  --folder-weight: 700 !important;
  --folder-weight-hover: 700 !important;
  --font: "Calisto MT", "Palatino Black", "Book Antiqua", "Georgia", "Suez One", serif !important;
  --font-default: "Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Microsoft YaHei Light", sans-serif !important;
  ...
  --font-ui-small: 14px !important;
  --font-ui-smaller: 13.5px !important;
  --footnote: #89A09E !important;
  --footnote-divider-color: #CCEBE2 !important;
  --footnote-id-color: #4ED0B8 !important;
  --footnote-id-color-no-occurrences: #4e5b6f !important;
  --footnote-input-background-active: rgba(145, 212, 199, 0.27) !important;
  --footnote-radius: 0 !important;
  --footnote-size: .90em !important;
  --graph-404: #A6DED4 !important;
  --graph-arrow: #4ED0B8 !important;
  --graph-background: #f8fbff !important;
  --graph-bg: #f8fbff !important;
  --graph-controls-section-header-padding: 4px 8px !important;
  --graph-fill: #51a38e !important;
  --graph-focused: #75c8b9 !important;
  --graph-img: #D6EAE3 !important;
  --graph-line: rgba(144, 237, 231, 0.5) !important;
  --graph-line-hover: #43C1A5 !important;
  --graph-lines: rgba(144, 237, 231, 0.5) !important;
  --graph-node: #697580 !important;
  --graph-node-attachment: #D6EAE3 !important;
  --graph-node-focused: #75c8b9 !important;
  --graph-node-hover-fill: #51a38e !important;
  --graph-node-hover-outline: #e5ebee !important;
  --graph-node-tag: #25a99e !important;
  --graph-node-unresolved: #A6DED4 !important;
  --graph-tag: #25a99e !important;
  --graph-text: #697580 !important;
  --gray: #4ED0B8 !important;
  --h1-background: transparent !important;
  --h1-border-color: #69cfd2 !important;
  --h1-border-left-color: #CCEBE2 !important;
  --h1-border-line-color: #CCEBE2 !important;
  --h1-border-line-height: 4px !important;
  --h1-border-line-width: 100% !important;
  --h1-border-right-color: #CCEBE2 !important;
  --h1-border-width: 0 !important;
  --h1-color: #40B1A4 !important;
  --h1-font: "Calisto MT", "Palatino Black", "Book Antiqua", "Georgia", "Suez One", serif !important;
  --h1-padding: 0 !important;
  --h1-shadow: transparent !important;
  --h1-size: 34px !important;
  --h1-text-align: start !important;
  --h2-background: transparent !important;
  --h2-border-color: #75c8b9 !important;
  --h2-border-left-color: #CCEBE2 !important;
  --h2-border-line-color: #CCEBE2 !important;
  --h2-border-line-height: 4px !important;
  --h2-border-line-width: 85% !important;
  --h2-border-right-color: #CCEBE2 !important;
  --h2-border-width: 0 !important;
  --h2-color: #40B1A4 !important;
  --h2-font: "Calisto MT", "Palatino Black", "Book Antiqua", "Georgia", "Suez One", serif !important;
  --h2-padding: 0 !important;
  --h2-shadow: transparent !important;
  --h2-size: 30px !important;
  ...
  --h2-weight: 700 !important;
  --h3-background: transparent !important;
  --h3-border-color: #43C1A5 !important;
  --h3-border-left-color: #CCEBE2 !important;
  --h3-border-line-color: #CCEBE2 !important;
  --h3-border-line-height: 4px !important;
  --h3-border-line-width: 65% !important;
  --h3-border-right-color: #CCEBE2 !important;
  --h3-border-width: 0 !important;
  --h3-color: #40B1A4 !important;
  --h3-font: "Calisto MT", "Palatino Black", "Book Antiqua", "Georgia", "Suez One", serif !important;
  --h3-padding: 0 !important;
  --h3-shadow: transparent !important;
  --h3-size: 26px !important;
  ...
  --h3-weight: 700 !important;
  --h4-background: transparent !important;
  --h4-border-color: #51a38e !important;
  --h4-border-left-color: #CCEBE2 !important;
  --h4-border-line-color: #CCEBE2 !important;
  --h4-border-line-height: 4px !important;
  --h4-border-line-width: 44% !important;
  --h4-border-right-color: #CCEBE2 !important;
  --h4-border-width: 0 !important;
  --h4-color: #40B1A4 !important;
  --h4-font: "Calisto MT", "Palatino Black", "Book Antiqua", "Georgia", "Suez One", serif !important;
  --h4-padding: 0 !important;
  --h4-shadow: transparent !important;
  --h4-size: 22px !important;
  ...
  --h4-weight: 700 !important;
  --h5-background: transparent !important;
  --h5-border-color: #2E918A !important;
  --h5-border-left-color: #CCEBE2 !important;
  --h5-border-line-color: #CCEBE2 !important;
  --h5-border-line-height: 4px !important;
  --h5-border-line-width: 25% !important;
  --h5-border-right-color: #CCEBE2 !important;
  --h5-border-width: 0 !important;
  --h5-color: #40B1A4 !important;
  --h5-font: "Calisto MT", "Palatino Black", "Book Antiqua", "Georgia", "Suez One", serif !important;
  --h5-padding: 0 !important;
  --h5-shadow: transparent !important;
  --h5-size: 20px !important;
  ...
  --h5-weight: 700 !important;
  --h6-background: transparent !important;
  --h6-border-color: #102F26 !important;
  --h6-border-left-color: #CCEBE2 !important;
  --h6-border-line-color: #CCEBE2 !important;
  --h6-border-line-height: 4px !important;
  --h6-border-line-width: 0 !important;
  --h6-border-right-color: #CCEBE2 !important;
  --h6-border-width: 0 !important;
  --h6-color: #40B1A4 !important;
  --h6-font: "Calisto MT", "Palatino Black", "Book Antiqua", "Georgia", "Suez One", serif !important;
  --h6-padding: 0 !important;
  --h6-shadow: transparent !important;
  --h6-size: 18px !important;
  ...
  --h6-weight: 700 !important;
  --he-popover-border-radius: 0 !important;
  --he-text-on-accent-active: #40B1A4 !important;
  --he-text-on-accent-inactive: #697580 !important;
  --he-title-bar-active-action: #51a38e !important;
  ...
  --he-title-bar-inactive-action: #4ED0B8 !important;
  --he-title-bar-inactive-bg: #f8fbff !important;
  --he-title-bar-inactive-fg: #A6DED4 !important;
  --he-title-bar-inactive-pinned-bg: #f8fbff !important;
  --header-arrow-icon-color: #4e5b6f !important;
  --header-arrow-icon-size: 10px !important;
  --header-background: transparent !important;
  --header-border-line-align: none !important;
  --header-border-line-color: #CCEBE2 !important;
  --header-border-line-height: 4px !important;
  --header-border-line-left: none !important;
  --header-border-line-width: 100% !important;
  --header-padding: 0 !important;
  ...
  --header-weight: 700 !important;
  --headerFont: "Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Microsoft YaHei Light", sans-serif !important;
  --headers: #40B1A4 !important;
  --heading-formatting: #A6DED4 !important;
  --heading-spacing: 10px !important;
  --heading-spacing-bottom: 10px !important;
  --heading-spacing-top: 10px !important;
  --highlight: rgba(144, 237, 231, 0.5) !important;
  --hr: #D6EAE9 !important;
  --hr-alignment: -50%, -50% !important;
  --hr-color: #D6EAE9 !important;
  --hr-icon-background: #f8fbff !important;
  --hr-icon-color: #40B1A4 !important;
  --hr-icon-font: "Material Icons Sharp" !important;
  --hr-icon-padding-x: 4px !important;
  --hr-icon-symbol: "\\f1cd" !important;
  --hr-text-offset: 12px !important;
  --hr-width: auto !important;
  --hvr: rgba(131, 240, 207, 0.3) !important;
  --hvr-active: rgba(119, 220, 193, 0.5) !important;
  --hvr2: rgba(144, 237, 231, 0.5) !important;
  --i-at: #43C1AE !important;
  --icon-btn-radius: 0 !important;
  --icon-color: #4ED0B8 !important;
  --icon-color-active: #e5ebee !important;
  ...
  --illusion-border-line-height: 0 !important;
  --illusion-box-shadow: 5px 5px 0 #CCEBE2 !important;
  --illusion-h1-background: #69cfd2 !important;
  --illusion-h2-background: #75c8b9 !important;
  --illusion-h3-background: #43C1A5 !important;
  --illusion-h4-background: #51a38e !important;
  --illusion-h5-background: #2E918A !important;
  --illusion-h6-background: #102F26 !important;
  --illusion-header-arrow-color: #e5ebee !important;
  --illusion-header-arrow-icon-size: 13px !important;
  --illusion-header-padding: 5px 25px !important;
  --illusion-header-text: #e5ebee !important;
  --image-border-background: rgba(145, 212, 199, 0.27) !important;
  --image-border-color: #CCEBE2 !important;
  --image-border-padding: 8px !important;
  --image-border-width: 1px !important;
  --inactive: #A6DED4 !important;
  --indentation-guide-color: #b8e5e7 !important;
  --indentation-guide-color-active: #43C1A5 !important;
  --indentation-guide-editing-indent: 5.33333px !important;
  --indentation-guide-reading-indent: -14px !important;
  --indentation-guide-source-indent: 1.06667px !important;
  --indentation-guide-width: 2px !important;
  --indentation-guide-width-active: 2px !important;
  --initiative-tracker-border: #b8e5e7 !important;
  --initiative-xp: sandybrown !important;
  --inline-title-color: #40B1A4 !important;
  --inline-title-font: "Calisto MT", "Palatino Black", "Book Antiqua", "Georgia", "Suez One", serif !important;
  --inline-title-position: left !important;
  --inline-title-size: 34px !important;
  --input-bg: rgba(145, 212, 199, 0.27) !important;
  --input-date-separator: #4e5b6f !important;
  --input-placeholder-color: #4e5b6f !important;
  --input-radius: 0 !important;
  --input-shadow: 2px 2px 0 #CCEBE2 !important;
  --input-shadow-hover: 3px 3px 0 #CCEBE2 !important;
  --interactive-accent: #25a99e !important;
  --interactive-accent-hover: #A6DED4 !important;
  --interactive-accent-hsl: 0, 49%, 49% !important;
  --interactive-hover: #A6DED4 !important;
  --interactive-normal: #eef3fd !important;
  --its: "its" !important;
  --kanban-button-background: #f1f5ff !important;
  --kanban-button-shadow: 2px 2px 0 #CCEBE2 !important;
  --kanban-card-border: 2px solid #CCEBE2 !important;
  --kanban-card-margin: 2px 0 !important;
  ...
  --kanban-card-title-border: 0 1px 0 #CCEBE2 !important;
  --kanban-lane-background: #f1f5ff !important;
  --kanban-lane-border: 3px solid #CCEBE2 !important;
  --kanban-lane-box-shadow: 2px 2px 0 #CCEBE2 !important;
  --kanban-lane-padding: 0 4px !important;
  --kanban-link-color: #75c8b9 !important;
  --kanban-tag-background: #49b99d !important;
  --latex-color: #51a38e !important;
  --latex-format-color: #A6DED4 !important;
  --latex-syntax-color: #4ED0B8 !important;
  --light: #f8fbff !important;
  --lightgray: #f8fbff !important;
  --line-height-tight: 1.3em !important;
  --lines: #b8e5e7 !important;
  --link-background: transparent !important;
  --link-background-hover: transparent !important;
  --link-border: none !important;
  --link-color: #75c8b9 !important;
  --link-color-hover: #51a38e !important;
  --link-decoration: none !important;
  --link-decoration-hover: none !important;
  --link-external-color: #75c8b9 !important;
  --link-external-color-hover: #D6EAE3 !important;
  --link-external-decoration: none !important;
  --link-transform: none !important;
  --link-unresolved-color: #A6DED4 !important;
  --link-unresolved-decoration-color: hsla(0, 49%, 49%, 0.3) !important;
  --link-unresolved-opacity: 1 !important;
  --list-bullet-box-shadow-color: #CCEBE2 !important;
  --list-bullet-radius: 0 !important;
  --list-bullet-size: 6.4px !important;
  --list-bullet-transform: rotate(45deg) !important;
  --list-color-1: #b8e5e7 !important;
  --list-color-2: #b8e5e7 !important;
  --list-color-3: #b8e5e7 !important;
  --list-color-4: #b8e5e7 !important;
  --list-color-5: #b8e5e7 !important;
  --list-color-6: #b8e5e7 !important;
  --list-indent: 25px !important;
  --list-marker-color: #43C1A5 !important;
  --list-marker-color-collapsed: #A6DED4 !important;
  --list-marker-color-hover: #4ED0B8 !important;
  --list-marker-color-other: #D6EAE3 !important;
  --list-marker-min-width: 0 !important;
  --list-numbered-color: #51a38e !important;
  --list-spacing: 1px !important;
  --lite-accent: #51a38e !important;
  --mdi: "Material Icons Sharp" !important;
  --med-small: 400px !important;
  --med-tall: 600px !important;
  --medium: 500px !important;
  --menu-background: #f8fbff !important;
  --menu-border-color: #CCEBE2 !important;
  --menu-radius: 0 !important;
  --menu-shadow: 2px 2px 0 #CCEBE2 !important;
  --message-border-color: #CCEBE2 !important;
  --message-border-width: 0px !important;
  --message-box-shadow: 2px 2px 0 #CCEBE2 !important;
  --message-color: #e5ebee !important;
  --metadata-border-color: #CCEBE2 !important;
  --metadata-button-text-color: #A6DED4 !important;
  --metadata-divider-color: #CCEBE2 !important;
  --metadata-icon-color: #4ED0B8 !important;
  --metadata-input-background-active: rgba(145, 212, 199, 0.27) !important;
  --metadata-input-font: "Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Microsoft YaHei Light", sans-serif !important;
  --metadata-input-font-size: .90em !important;
  --metadata-input-text-color: #697580 !important;
  --metadata-label-background-active: rgba(145, 212, 199, 0.27) !important;
  --metadata-label-font: "Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Microsoft YaHei Light", sans-serif !important;
  --metadata-label-font-size: .90em !important;
  --metadata-label-text-color: #4ED0B8 !important;
  --metadata-label-text-color-hover: #4ED0B8 !important;
  --metadata-property-background-active: rgba(119, 220, 193, 0.5) !important;
  --metadata-property-box-shadow-focus: 0 0 0 2px #43C1A5 !important;
  --metadata-property-box-shadow-hover: 0 0 0 1px #CCEBE2 !important;
  --metadata-property-radius: 0 !important;
  --metadata-property-radius-focus: 0 !important;
  --metadata-property-radius-hover: 0 !important;
  --metadata-remove-color: #dcddde !important;
  ...
  --metadata-sidebar-label-font-size: 14px !important;
  --metadata-title-align: center !important;
  --metadata-title-color: #4ED0B8 !important;
  --metadata-title-icon: "\\e805" !important;
  --metadata-title-icon-font: "its" !important;
  --metadata-title-icon-padding: 5px !important;
  --metadata-title-size: 16px !important;
  ...
  --modal-border-color: #CCEBE2 !important;
  --modal-border-width: 3px !important;
  --modal-community-sidebar-width: 310px !important;
  --modal-nav-item-background: transparent !important;
  --modal-nav-item-background-hover: rgba(145, 212, 199, 0.27) !important;
  --modal-radius: 0 !important;
  --modal-sidebar-background: #e8f9f7 !important;
  --nav-collapse-icon-color: #4e5b6f !important;
  --nav-collapse-icon-color-collapsed: #4e5b6f !important;
  --nav-heading-color: #697580 !important;
  --nav-heading-color-collapsed: #4e5b6f !important;
  --nav-heading-color-collapsed-hover: #4ED0B8 !important;
  --nav-heading-color-hover: #697580 !important;
  --nav-indentation-guide-color: #b8e5e7 !important;
  --nav-indentation-guide-width: 2px !important;
  --nav-item-background-active: #25a99e !important;
  --nav-item-background-border-color-hover: #25a99e !important;
  --nav-item-background-hover: #25a99e !important;
  --nav-item-background-selected: rgba(131, 240, 207, 0.3) !important;
  --nav-item-border-color: #51a38e !important;
  --nav-item-border-width: 0px !important;
  --nav-item-children-margin-left: 15px !important;
  --nav-item-children-padding-left: 2px !important;
  ...
  --nav-item-white-space: wrap !important;
  --nav-tag-color: #4e5b6f !important;
  --nav-tag-color-active: #4ED0B8 !important;
  --nav-tag-color-hover: #4ED0B8 !important;
  --nav-tag-radius: 0 !important;
  --navbar-radius: 0 !important;
  --note: #f8fbff !important;
  --note-rgb: 248, 251, 255 !important;
  --note-title-border-color: #40B1A4 !important;
  --outer-bar: #eef3fd !important;
  --outline: #CCEBE2 !important;
  --outline-arrow-display: none !important;
  --outline-arrow-margin: -16px !important;
  --outline-arrow-visibility: hidden !important;
  --outline-symbol: "H" !important;
  ...
  --pill-border-color: #CCEBE2 !important;
  --pill-border-color-hover: #CCEBE2 !important;
  --pill-color: #4ED0B8 !important;
  --pill-color-hover: #697580 !important;
  --pill-color-remove: #4e5b6f !important;
  --pill-color-remove-hover: #75c8b9 !important;
  --pill-radius: 0 !important;
  --popover-background: #f8fbff !important;
  --popover-border: 3px solid #CCEBE2 !important;
  --popover-max-height: 600px !important;
  --popover-width: 650px !important;
  --progress: #43C1A5 !important;
  --progress-bg: #CCEBE2 !important;
  --prompt-background: #f8fbff !important;
  --prompt-border-color: #CCEBE2 !important;
  --prompt-border-width: 3px !important;
  --r-heading-color: #40B1A4 !important;
  --r-heading-font: "Calisto MT", "Palatino Black", "Book Antiqua", "Georgia", "Suez One", serif !important;
  --r-heading-font-weight: 700 !important;
  --r-heading-text-transform: capitalize !important;
  --r-main-font: "Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Microsoft YaHei Light", sans-serif !important;
  --r-progress-color: #51a38e !important;
  --radius-h: 0 !important;
  --radius-l: 0 !important;
  --radius-m: 0 !important;
  --radius-s: 0 !important;
  ...
  --rpg: "rpg-awesome" !important;
  --scroll-size: 7px !important;
  --scrollbar-active-thumb-bg: #51a38e !important;
  --scrollbar-bg: #CCEBE2 !important;
  --scrollbar-border-width: 0 !important;
  --scrollbar-radius: 0 !important;
  --scrollbar-thumb-bg: #49b99d !important;
  --scrollbar-track-bg: #f8fbff !important;
  --search-border: 2px solid #CCEBE2 !important;
  --search-box-shadow: 2px 2px 0 #CCEBE2 !important;
  --search-clear-button-color: #4ED0B8 !important;
  --search-icon-color: #4ED0B8 !important;
  --search-result-background: #f8fbff !important;
  --secondary: #75c8b9 !important;
  --setting-group-heading-color: #697580 !important;
  --setting-item-alt-background-hover: rgba(145, 212, 199, 0.27) !important;
  --setting-item-background-hover: rgba(131, 240, 207, 0.3) !important;
  --setting-item-border-color: #CCEBE2 !important;
  --setting-item-heading-background: transparent !important;
  --setting-item-heading-border: 2px solid #40B1A4 !important;
  --setting-item-padding: 10px 15px !important;
  --setting-items-alt-background: transparent !important;
  --setting-items-alt-background-hover: rgba(145, 212, 199, 0.27) !important;
  --setting-items-background: transparent !important;
  --setting-items-border-color: #CCEBE2 !important;
  --setting-items-radius: 0 !important;
  --shadow-l: 5px 5px 0 #CCEBE2 !important;
  --shadow-m: 3px 3px 0 #CCEBE2 !important;
  --shadow-ml: 4px 4px 0 #CCEBE2 !important;
  --shadow-s: 2px 2px 0 #CCEBE2 !important;
  --shiki-active-tab-border-color: #4ED0B8 !important;
  --shiki-code-background: #f1f5ff !important;
  --shiki-code-block-border-radius: 0 !important;
  --shiki-code-comment: #4e5b6f !important;
  --shiki-code-normal: #4ED0B8 !important;
  --shiki-code-punctuation: #4ED0B8 !important;
  --shiki-gutter-border-color: #CCEBE2 !important;
  --shiki-gutter-text-color: #4e5b6f !important;
  --shiki-gutter-text-color-highlight: #4ED0B8 !important;
  --shiki-highlight-neutral: #4ED0B8 !important;
  --shiki-terminal-dots-color: #4e5b6f !important;
  --shiki-tooltip-background: #25a99e !important;
  --side-bar: #f8fbff !important;
  --side-bar-bg: #eef3fd !important;
  --sidebar-icon-color: #697580 !important;
  --sidebar-icon-color-active: #e5ebee !important;
  --sidebar-markdown-font-size: 16px !important;
  --sidebar-tab-background-color: #40B1A4 !important;
  --sidebar-tab-background-color-hover: #43C1A5 !important;
  --sidebar-tab-border-color: transparent !important;
  --sidebar-tab-border-color-active: #40B1A4 !important;
  --sidebar-tab-border-width: 0 !important;
  --sidebar-tab-color-hover: #e5ebee !important;
  --sidebar-tab-icon-size: 18px !important;
  --sidebar-tab-icon-stroke: 1.75px !important;
  ...
  --slider-thumb-border-color: #CCEBE2 !important;
  --slider-thumb-radius: 0 !important;
  --slider-track-background: #CCEBE2 !important;
  --slider-track-radius: 0 !important;
  --small: 200px !important;
  --small-med: 300px !important;
  --soft-text: #4ED0B8 !important;
  --statblock-alt: rgba(145, 212, 199, 0.27) !important;
  --statblock-alt-padding: 0.25em 0.3em !important;
  --statblock-background-color: #f8fbff !important;
  --statblock-bar-border-color: #43C1A5 !important;
  --statblock-bar-border-size: 0 !important;
  --statblock-bar-color: #43C1A5 !important;
  --statblock-border-color: #b8e5e7 !important;
  --statblock-border-size: 0 !important;
  --statblock-box-shadow-blur: 20px !important;
  --statblock-box-shadow-color: #CCEBE2 !important;
  --statblock-box-shadow-x-offset: 0 !important;
  --statblock-box-shadow-y-offset: 0 !important;
  --statblock-content-font: "Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Microsoft YaHei Light", sans-serif !important;
  --statblock-content-font-size: 16px !important;
  ...
  --statblock-heading-font: "Calisto MT", "Palatino Black", "Book Antiqua", "Georgia", "Suez One", serif !important;
  --statblock-heading-font-color: #40B1A4 !important;
  --statblock-heading-font-variant: normal !important;
  --statblock-heading-font-weight: 700 !important;
  --statblock-heading-line-height: 28px !important;
  --statblock-image-border-color: #D6EAE9 !important;
  --statblock-primary-color: #697580 !important;
  --statblock-property-font-color: #697580 !important;
  --statblock-property-name-font-color: #40B1A4 !important;
  --statblock-rule-color: #43C1A5 !important;
  --statblock-section-heading-border-color: #CCEBE2 !important;
  --statblock-section-heading-border-size: 4px !important;
  --statblock-section-heading-font: "Calisto MT", "Palatino Black", "Book Antiqua", "Georgia", "Suez One", serif !important;
  --statblock-section-heading-font-color: #89A09E !important;
  --statblock-section-heading-font-size: 26px !important;
  --statblock-section-heading-font-variant: normal !important;
  --statblock-section-heading-font-weight: 700 !important;
  --statblock-subheading-font-size: .95em !important;
  ...
  --status-bar-border-color: #43C1A5 !important;
  --status-bar-font-size: 13.5px !important;
  --status-bar-gap: 4px !important;
  --status-bar-padding: 4px !important;
  --status-bar-radius: 0 0 0 0 !important;
  --status-bar-text-color: #4ED0B8 !important;
  --strikethrough-line-thickness: 1px !important;
  --style-settings-background-color: transparent !important;
  --style-settings-border-bottom-color: transparent !important;
  --style-settings-border-top-color: transparent !important;
  --style-settings-heading-background-hover: #25a99e !important;
  --style-settings-heading-border-bottom-color: transparent !important;
  --style-settings-heading-border-top-color: transparent !important;
  --style-settings-heading-color: #e5ebee !important;
  --style-settings-heading-color-hover: #e5ebee !important;
  ...
  --tab-curve: 0 !important;
  --tab-divider-color: #D6EAE9 !important;
  --tab-font-weight: 500 !important;
  --tab-font-weight-active: 900 !important;
  --tab-min-width: min-content !important;
  --tab-outline-color: #43C1A5 !important;
  --tab-outline-width: 2px !important;
  --tab-radius: 0 !important;
  --tab-radius-active: 0 !important;
  --tab-stacked-font-size: 15px !important;
  --tab-stacked-font-weight: 700 !important;
  --tab-stacked-shadow: -10px 0 10px rgba(0, 74, 52, 0.08) !important;
  --tab-stacked-shadow-color: rgba(0, 74, 52, 0.08) !important;
  ...
  --tab-switcher-preview-background-shadow: 3px 3px 0 #CCEBE2 !important;
  --tab-switcher-preview-radius: 0 !important;
  --tab-switcher-preview-shadow: 2px 2px 0 #CCEBE2 !important;
  --tab-switcher-preview-shadow-active: 0 0 0 2px #51a38e, 5px 5px 0 #CCEBE2 !important;
  --tab-text-color: #A6DED4 !important;
  --tab-text-color-active: #697580 !important;
  --tab-text-color-focused: #A6DED4 !important;
  --tab-text-color-focused-active: #697580 !important;
  --tab-text-color-focused-active-current: #697580 !important;
  --tab-text-color-focused-highlighted: #75c8b9 !important;
  --tab-text-color-hover: #697580 !important;
  --tab-top-outline-width: 0 !important;
  --table: #CCEBE2 !important;
  --table-add-button-background: #40B1A4 !important;
  ...
  --table-cell-padding-x: 8px !important;
  --table-cell-padding-y: 4px !important;
  --table-column-alt-background: rgba(145, 212, 199, 0.27) !important;
  --table-column-min-width: 3ch !important;
  --table-drag-handle-background-active: #25a99e !important;
  --table-drag-handle-color: #4e5b6f !important;
  --table-drag-handle-color-active: #e5ebee !important;
  --table-header-background: #40B1A4 !important;
  --table-header-background-hover: #43C1A5 !important;
  --table-header-border-color: #f8fbff !important;
  --table-header-color: #e5ebee !important;
  --table-header-padding-x: 8px !important;
  --table-header-padding-y: 4px !important;
  --table-header-size: "Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Microsoft YaHei Light", sans-serif !important;
  --table-header-text-color: #51a38e !important;
  --table-header-weight: 700 !important;
  --table-line-height: 1.3em !important;
  --table-row-alt-background: rgba(145, 212, 199, 0.27) !important;
  --table-row-alt-background-hover: rgba(144, 237, 231, 0.5) !important;
  --table-row-background-hover: rgba(144, 237, 231, 0.5) !important;
  --table-row-edit-font-size: .95em !important;
  --table-selection: hsla(0, 49%, 49%, 0.1) !important;
  --table-selection-border-color: #25a99e !important;
  --table-selection-border-radius: 0 !important;
  --tag: #49b99d !important;
  --tag-background: #49b99d !important;
  --tag-background-color: #49b99d !important;
  --tag-background-hover: #43C1A5 !important;
  --tag-border-color: #49b99d !important;
  --tag-border-color-hover: #43C1A5 !important;
  --tag-color: #e5ebee !important;
  --tag-color-hover: #e5ebee !important;
  --tag-decoration-hover: underline !important;
  --tag-font: "Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Microsoft YaHei Light", sans-serif !important;
  ...
  --tag-radius: 0 !important;
  --tag-size: .90em !important;
  --tag-text: #43C1A5 !important;
  --tall: 700px !important;
  --td: rgba(145, 212, 199, 0.27) !important;
  --tertiary: #D6EAE3 !important;
  --text: #697580 !important;
  --text-accent: #75c8b9 !important;
  --text-accent-hover: #D6EAE3 !important;
  --text-dl: #e5ebee !important;
  --text-faint: #4e5b6f !important;
  --text-highlight-bg: rgba(131, 240, 207, 0.3) !important;
  --text-highlight-bg-active: rgba(119, 220, 193, 0.5) !important;
  --text-muted: #4ED0B8 !important;
  --text-normal: #697580 !important;
  --text-on-accent: #e5ebee !important;
  --text-selection: rgba(144, 237, 231, 0.5) !important;
  --textHighlight: rgba(131, 240, 207, 0.3) !important;
  --th: #40B1A4 !important;
  --th-text: #e5ebee !important;
  --theme-rainbow-1: #69cfd2 !important;
  --theme-rainbow-2: #75c8b9 !important;
  --theme-rainbow-3: #43C1A5 !important;
  --theme-rainbow-4: #51a38e !important;
  --theme-rainbow-5: #2E918A !important;
  --theme-rainbow-6: #102F26 !important;
  --tiny: 100px !important;
  --titleFont: "Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Microsoft YaHei Light", sans-serif !important;
  --titlebar-background: #f8fbff !important;
  --titlebar-background-focused: #eef3fd !important;
  --titlebar-border-color: #CCEBE2 !important;
  ...
  --tooltip-color: #e5ebee !important;
  --vault-font: "Calisto MT", "Palatino Black", "Book Antiqua", "Georgia", "Suez One", serif !important;
  --vault-name-color: #40B1A4 !important;
  --vault-name-font-size: 20px !important;
  --vault-name-font-weight: 700 !important;
...
html[saved-theme="light"] body .page > div#quartz-body div.sidebar.right {
  ...
  --font-weight: 700;
  background-color: rgb(204, 235, 226);
  border-bottom-color: rgb(64, 177, 164);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
  border-bottom-width: 0px;
  border-left-color: rgb(64, 177, 164);
  border-left-width: 0px;
  border-right-color: rgb(64, 177, 164);
  border-right-width: 0px;
  border-top-color: rgb(64, 177, 164);
  border-top-left-radius: 0px;
  border-top-right-radius: 0px;
  border-top-width: 0px;
...
html[saved-theme="light"] body p {
  ...
  --zoom-multiplier: 1;
  background-color: rgba(0, 0, 0, 0);
  border-bottom-color: rgb(117, 200, 185);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
  border-bottom-width: 0px;
  border-left-color: rgb(117, 200, 185);
  border-left-width: 0px;
  border-right-color: rgb(117, 200, 185);
  border-right-width: 0px;
  border-top-color: rgb(117, 200, 185);
  border-top-left-radius: 0px;
  border-top-right-radius: 0px;
  border-top-width: 0px;
...
html[saved-theme="light"] body .callout[data-callout="aside"] {
  ...
  background-color: rgb(232, 249, 247);
  border-bottom-color: rgb(105, 117, 128);
  border-bottom-left-radius: 0px;
  border-bottom-right-radius: 0px;
  border-bottom-style: solid;
  ...
  border-top-style: solid;
  border-top-width: 0px;
  box-shadow: rgb(67, 193, 165) 4.8px 4.8px 0px 0px, rgb(67, 193, 165) 0px 0px 0px 1px;
  color: rgb(105, 117, 128);
  font-family: "??", Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Microsoft YaHei Light", sans-serif;
  line-height: 24px;
  margin-bottom: 5px;
...
html[saved-theme="light"] body .callout[data-callout="metadata"] {
  ...
  --callout-purple: 153, 97, 218;
  --callout-red: 193, 67, 67;
  --callout-shadow: 0px 0px 0px 1px #CCEBE2;
  --callout-small: 30%;
  --callout-small-med: 40%;
  --callout-tall: 95%;
  --callout-tiny: 20%;
...
html[saved-theme="light"] body .callout[data-callout="recite"] {
  ...
  border-top-style: solid;
  border-top-width: 11px;
  box-shadow: rgb(204, 235, 226) 0px 0px 10px 0px;
  color: rgb(105, 117, 128);
  font-family: "??", Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Microsoft YaHei Light", sans-serif;
  line-height: 24px;
  margin-bottom: 10px;
...
html[saved-theme="light"] body .callout[data-callout="statblocks"] {
  ...
  border-top-style: solid;
  border-top-width: 5px;
  box-shadow: rgb(204, 235, 226) 5px 5px 0px 0px, rgb(204, 235, 226) 0px 0px 20px 0px;
  color: rgb(105, 117, 128);
  font-family: "??", Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Microsoft YaHei Light", sans-serif;
  line-height: 24px;
  margin-bottom: 10px;
...
html[saved-theme="light"] body hr {
  ...
  border-left-color: rgb(184, 229, 231);
  border-left-width: 2px;
}
...
html[saved-theme="light"] body .canvas-sidebar {
  background-color: rgb(248, 251, 255);
  border-color: rgb(204, 235, 226);
  box-shadow: rgb(204, 235, 226) 2px 2px 0px 0px;
}`,
