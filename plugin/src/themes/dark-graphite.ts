...
export const theme: ThemeData = {
  ...
  --highlight: var(--text-highlight-bg, rgba(42, 48, 56, 0.5));
  --hr-color: hsl(0, 0%, 39%);
  --icon-color: #949594;
  ...
  --light: var(--background-primary, #161719);
  --lightgray: var(--background-secondary, #202123);
  ...
  --secondary: var(--text-accent, #3c95fa);
  ...
  --tertiary: var(--text-accent-hover, #949594);
  --text-accent: #3c95fa;
  ...
  --textHighlight: var(--text-highlight-bg, rgba(42, 48, 56, 0.5));
