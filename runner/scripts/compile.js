...
`;
  ...
  blockquote.callout {
    &[data-callout] {
      --callout-color: rgb(var(--callout-todo));
    }
    &[data-callout="note"] {
      --callout-color: rgb(var(--callout-note));
    }
    &[data-callout="abstract"] {
      --callout-color: rgb(var(--callout-abstract));
    }
    &[data-callout="info"] {
      --callout-color: rgb(var(--callout-info));
    }
    &[data-callout="todo"] {
      --callout-color: rgb(var(--callout-todo));
    }
    &[data-callout="tip"] {
      --callout-color: rgb(var(--callout-tip));
    }
    &[data-callout="success"] {
      --callout-color: rgb(var(--callout-success));
    }
    &[data-callout="question"] {
      --callout-color: rgb(var(--callout-question));
    }
    &[data-callout="warning"] {
      --callout-color: rgb(var(--callout-warning));
    }
    &[data-callout="failure"] {
      --callout-color: rgb(var(--callout-failure));
    }
    &[data-callout="danger"] {
      --callout-color: rgb(var(--callout-danger));
    }
    &[data-callout="bug"] {
      --callout-color: rgb(var(--callout-bug));
    }
    &[data-callout="example"] {
      --callout-color: rgb(var(--callout-example));
    }
    &[data-callout="quote"] {
      --callout-color: rgb(var(--callout-quote));
    }
  }
}
