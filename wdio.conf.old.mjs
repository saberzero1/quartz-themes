...
import * as driver from "./runner/scripts/database/driver.js";
...
export const config = {
  ...
  /*
  after: async function (test, result) {
    if (browser && browser.styles && browser.styles.length > 0) {
      driver.preparedStatements.bulkInsertStylesTransaction.run(browser.styles);
      browser.styles = [];
    }
  },
  */
